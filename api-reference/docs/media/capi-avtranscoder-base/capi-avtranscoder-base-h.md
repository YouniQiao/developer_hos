...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [OH_AVTranscoder](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-avtranscoder-oh-avtranscoder) | OH_AVTranscoder | 初始化AVTranscoder。 |
| [OH_AVTranscoder_Config](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-avtranscoder-oh-avtranscoder-config) | OH_AVTranscoder_Config | 初始化AVTranscoder_Config。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH_AVTranscoder](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-avtranscoder-oh-avtranscoder) *transcoder | OH_AVTranscoder实例的指针。 |
