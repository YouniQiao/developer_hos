...
| 类型 | 说明 |
| --- | --- |
| Promise | 异步方法返回PixelMap的Promise实例。 |
...
| 类型 | 说明 |
| --- | --- |
| [image.PixelMap](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-image-pixelmap) | 成功同步返回PixelMap对象。 |
