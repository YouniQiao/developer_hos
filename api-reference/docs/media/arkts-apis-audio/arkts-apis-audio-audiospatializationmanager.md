...
content_hash: "ba82f5f0ff10"
synced_at: "2026-08-29T18:17:18.535685"
---
...
| callback | Callback | 否 | 回调函数。传入回调函数时，仅取消该回调对应的监听事件，需与[on('spatializationEnabledChangeForCurrentDevice')](#onspatializationenabledchangeforcurrentdevice18)绑定同一回调函数；不传参数时，取消此事件类型下所有已订阅的监听事件。 |
