...
content_hash: "7e4069ec0675"
synced_at: "2026-07-28T16:51:25.183370"
---
...
| callback | AsyncCallback | 是 | 回调函数。当创建音频渲染器成功，err为undefined，data为创建的音频渲染器对象；否则为错误对象。 |
...
| callback | AsyncCallback | 是 | 回调函数。当创建音频采集器成功，err为undefined，data为创建的音频采集器对象；否则为错误对象。 异常将返回error对象： 返回错误码6800301：表示参数校验异常、权限校验异常或系统处理异常（具体错误查看系统日志）。 返回错误码6800101：表示必选参数为空或参数类型错误。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，成功将返回音频采集器对象，异常将返回error对象。 返回错误码6800301：表示参数校验异常、权限校验异常或系统处理异常（具体错误查看系统日志）。 返回错误码6800101：表示必选参数为空或参数类型错误。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，成功将返回音频返听器对象，异常将返回error对象。 |
