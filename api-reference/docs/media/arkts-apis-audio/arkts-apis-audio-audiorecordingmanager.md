...
| config | [SystemRecordControllerConfig](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-audio-i#systemrecordcontrollerconfig) | 是 | 系统录音控制面板的配置信息。 |
