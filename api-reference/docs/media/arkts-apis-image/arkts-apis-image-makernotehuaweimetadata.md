...
content_hash: "20779dbc5c75"
synced_at: "2026-07-28T16:51:48.265751"
---
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| records | Record | 是 | 包含要修改的MakerNoteHuaweiMetadata对象属性键值对的数组。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise> | Promise对象，返回元数据中定义的所有键值对。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，当成功获取元数据时返回MakerNoteHuaweiMetadata元数据实例。 |
