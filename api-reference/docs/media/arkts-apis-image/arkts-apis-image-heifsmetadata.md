...
content_hash: "2caed29e1627"
synced_at: "2026-07-28T16:51:48.199793"
---
...
| 类型 | 说明 |
| --- | --- |
| Promise> | Promise对象，返回元数据要获取的属性的值，如果获取失败则返回错误码。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| records | Record | 是 | 用户要修改HeifsMetadata对象的属性和值的键值对集合。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，成功返回Heifs元数据实例。 |
