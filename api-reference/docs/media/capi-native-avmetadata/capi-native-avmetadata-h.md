...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [OH_AVMetadataBuilderStruct](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-ohavsession-oh-avmetadatabuilderstruct) | OH_AVMetadataBuilder | 会话元数据构造器。用于构造会话元数据。 |
| [OH_AVMetadataStruct](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-ohavsession-oh-avmetadatastruct) | OH_AVMetadata | 会话元数据。用于存储媒体资源元数据的结构体定义。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH_AVMetadataBuilder](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-ohavsession-oh-avmetadatabuilderstruct)** builder | 指向创建的构造器实例。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH_AVMetadata](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-ohavsession-oh-avmetadatastruct)* avMetadata | 指向元数据实例的指针。 |
