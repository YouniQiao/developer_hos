---
title: "ringtone（铃声服务）"
upstream_id: "harmonyos-references/ringtone-ringtone"
catalog: "harmonyos-references"
content_hash: "ed43f8033e10"
synced_at: "2026-07-28T16:52:05.693341"
---
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| mediaType | [uniformTypeDescriptor.UniformDataType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-data-uniformtypedescriptor#uniformdatatype) | 是 | 待查询的文件类型。 |
...
| callback | AsyncCallback | 是 | 回调函数。返回用户选择设置的铃声类型。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象。返回用户选择设置的铃声类型。 |
