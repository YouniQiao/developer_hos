...
content_hash: "2a7ef9327269"
synced_at: "2026-07-28T16:51:49.480252"
---
...
![](./img/caution_3.0-zh-cn.png) 此接口需要在[on](#on)回调触发后调用，才能正常的接收到数据。且此接口返回的[Image](#image)对象使用完毕后需要调用[release](#release-2)方法释放，释放后才可以继续接收新的数据。
