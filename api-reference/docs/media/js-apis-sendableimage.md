...
content_hash: "1c2ce8a6b8a5"
synced_at: "2026-08-07T15:58:52.788908"
---
...
| 类型 | 说明 |
| --- | --- |
| Promise | 返回PixelMap。 当创建的PixelMap大小超过原图大小时，返回原图PixelMap大小。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | 成功同步返回PixelMap对象，失败抛出异常。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise实例，用于异步获取结果，失败时返回错误信息。 |
