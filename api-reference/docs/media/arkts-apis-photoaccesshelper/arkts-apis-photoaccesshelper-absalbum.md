...
content_hash: "5501308f8f0b"
synced_at: "2026-08-29T18:17:46.331231"
---
...
| callback | AsyncCallback> | 是 | 回调函数。当获取相册中的文件成功，err为undefined，data为获取到的图片和视频数据结果集[FetchResult](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-photoaccesshelper-fetchresult)；失败时err为错误对象，data为undefined。 |
...
参考[photoAccessHelper.getPhotoAccessHelper](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-photoaccesshelper-f#photoaccesshelpergetphotoaccesshelper)的示例创建phAccessHelper。
