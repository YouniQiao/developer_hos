...
upstream_id: "harmonyos-references/capi-native-audio-debugging-manager-h"
catalog: "harmonyos-references"
content_hash: "8588a7ef9bc7"
synced_at: "2026-07-28T16:51:28.137630"
---
...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [OH_AudioDebuggingManager](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-ohaudio-oh-audiodebuggingmanager) | OH_AudioDebuggingManager | 声明音频调试管理器。用于音频运行时调试，包括获取快照信息等功能。 |
...
#### [h2]OH_AudioManager_GetAudioDebuggingManager()
...
| 参数项 | 描述 |
| --- | --- |
| [OH_AudioDebuggingManager](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-ohaudio-oh-audiodebuggingmanager) **manager | 输出参数，用于接收OH_AudioDebuggingManager实例。 |

返回：

| 类型 | 说明 |
| --- | --- |
| OH_AudioCommon_Result | - - AUDIOCOMMON_RESULT_SUCCESS：函数执行成功。 - - - AUDIOCOMMON_RESULT_ERROR_INVALID_PARAM：参数manager为nullptr。 - - |

#### [h2]OH_AudioDebuggingManager_PrintAppInfo()
...
![](./img/note_3.0-zh-cn.png) 快照信息的内容和格式随版本迭代发生变化，仅供人工调试参考，不建议开发者依据快照信息开发功能逻辑。
...
| 参数项 | 描述 |
| --- | --- |
| [OH_AudioDebuggingManager](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-ohaudio-oh-audiodebuggingmanager) *manager | 通过[OH_AudioManager_GetAudioDebuggingManager](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-native-audio-debugging-manager-h#oh_audiomanager_getaudiodebuggingmanager)获取的音频调试管理器实例。 |
...
#### [h2]OH_AudioDebuggingManager_PrintRendererInfo()
...
| 类型 | 说明 |
| --- | --- |
| OH_AudioCommon_Result | - - AUDIOCOMMON_RESULT_SUCCESS：函数执行成功。 - - - AUDIOCOMMON_RESULT_ERROR_INVALID_PARAM：参数manager或renderer为nullptr。 - - |

#### [h2]OH_AudioDebuggingManager_PrintCapturerInfo()
...
| 类型 | 说明 |
| --- | --- |
| OH_AudioCommon_Result | - - AUDIOCOMMON_RESULT_SUCCESS：函数执行成功。 - - - AUDIOCOMMON_RESULT_ERROR_INVALID_PARAM：参数manager或capturer为nullptr。 - - |

#### [h2]OH_AudioDebuggingManager_PrintSessionInfo()
...
| --- | --- |
| [OH_AudioDebuggingManager](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-ohaudio-oh-audiodebuggingmanager) *manager | 通过[OH_AudioManager_GetAudioDebuggingManager](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-native-audio-debugging-manager-h#oh_audiomanager_getaudiodebuggingmanager)获取的音频调试管理器实例。 |
| [OH_AudioSessionManager](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-ohaudio-oh-audiosessionmanager) *session | 指向目标会话管理器实例的指针，用于打印快照信息。 |
| int32_t fd | 文件描述符。当fd小于0或不可写时，快照信息将输出到运行日志，否则输出到fd指向的文件。 |
...
| 类型 | 说明 |
| --- | --- |
| OH_AudioCommon_Result | - - AUDIOCOMMON_RESULT_SUCCESS：函数执行成功。 - - - AUDIOCOMMON_RESULT_ERROR_INVALID_PARAM：参数manager或session为nullptr。 - - |
