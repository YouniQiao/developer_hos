...
content_hash: "664d597ff56b"
synced_at: "2026-08-29T18:17:33.677563"
---
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| configName | string | 是 | 配置属性名，不能为空，长度不能超过4096字节。 如果参数长度超过4096字节，会抛出错误码401。 属性名参考[PreDefinedConfigName](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-drm-e#predefinedconfigname)，具体支持的属性名由设备上DRM解决方案决定。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，mediaKeySystem设备证书的请求。设备上如果已存在设备证书，会返回失败。 |
...
| callback | (eventInfo: [EventInfo](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-drm-i#eventinfo)) => void | 是 | 回调函数，返回事件信息。当收到该事件时，表示需要请求设备证书。 |
