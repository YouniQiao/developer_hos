...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| mediaKeyRequestType | [MediaKeyRequestType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-drm-e#mediakeyrequesttype) | 否 | 否 | 媒体密钥请求类型。用于指定请求密钥的场景，包括初始请求、续订请求、释放请求、更新请求等不同类型。 |
