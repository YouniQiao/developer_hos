...
content_hash: "d7a6b331e0c7"
synced_at: "2026-08-29T18:17:31.100563"
---
...
| [Camera_ErrorCode OH_CaptureSession_GetSupportedPhysicalApertures(const Camera_CaptureSession* session, OH_Camera_PhysicalAperture** apertures, uint32_t* size)](#oh_capturesession_getsupportedphysicalapertures) | - | 获取支持的物理光圈列表。调用[OH_CaptureSession_DeletePhysicalApertures](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-capture-session-h#oh_capturesession_deletephysicalapertures)删除支持的物理光圈列表。 |
...
| [Camera_ErrorCode OH_CaptureSession_SetPhysicalAperture(const Camera_CaptureSession* session, double aperture)](#oh_capturesession_setphysicalaperture) | - | 设置物理光圈值。设置前，建议通过[OH_CaptureSession_GetSupportedPhysicalApertures](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-capture-session-h#oh_capturesession_getsupportedphysicalapertures)获取支持的物理光圈列表。 |
...
| [Camera_ErrorCode OH_CaptureSession_SetExposureBias(Camera_CaptureSession* session, float exposureBias)](#oh_capturesession_setexposurebias) | - | 设置曝光补偿。设置前，建议通过[OH_CaptureSession_GetExposureBiasRange](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-capture-session-h#oh_capturesession_getexposurebiasrange)获取支持配置的曝光补偿范围。 |
...
| [Camera_ErrorCode OH_CaptureSession_SetExposureDuration(const Camera_CaptureSession* session, int32_t exposureDuration)](#oh_capturesession_setexposureduration) | - | 设置曝光时间。单位：微秒。若传感器无法精确使用该曝光时间，系统会自动调整为最近的支持值，并通过[OH_CaptureSession_OnExposureDurationChange](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-capture-session-h#oh_capturesession_onexposuredurationchange)回调通知。仅在[ExposureMode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-camera-h#camera_exposuremode).EXPOSURE_MODE_MANUAL手动曝光模式下设置生效。 |
...
| [Camera_ErrorCode OH_CaptureSession_SetZoomRatio(Camera_CaptureSession* session, float zoom)](#oh_capturesession_setzoomratio) | - | 设置缩放比例。设置前，建议通过[OH_CaptureSession_GetZoomRatioRange](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-capture-session-h#oh_capturesession_getzoomratiorange)获取支持的缩放比例范围。 |
...
| [Camera_ErrorCode OH_CaptureSession_SetActiveColorSpace(Camera_CaptureSession* session, OH_NativeBuffer_ColorSpace colorSpace)](#oh_capturesession_setactivecolorspace) | - | 设置当前色彩空间。设置的值需在[OH_CaptureSession_GetSupportedColorSpaces](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-capture-session-h#oh_capturesession_getsupportedcolorspaces)获取的支持列表中。 |
...
| [Camera_ErrorCode OH_CaptureSession_SetColorTint(Camera_CaptureSession* session, int32_t colorTint)](#oh_capturesession_setcolortint) | - | 设置白平衡的色调调节值。设置前，建议通过[OH_CaptureSession_GetColorTintRange](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-capture-session-h#oh_capturesession_getcolortintrange)获取支持配置的白平衡色调调节范围。 |
...
| [Camera_ErrorCode OH_CaptureSession_GetZoomPointInfos(const Camera_CaptureSession* session, uint32_t* size, OH_Camera_ZoomPointInfo** zoomPointInfo)](#oh_capturesession_getzoompointinfos) | - | 获取变焦点信息。 需要通过调用[OH_CaptureSession_DeleteZoomPointInfos](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-capture-session-h#oh_capturesession_deletezoompointinfos)来释放变焦点信息的内存。 |
...
#### [h2]OH_CaptureSession_OnAutoDeviceSwitchStatusChange()
...
#### [h2]OH_CaptureSession_RegisterCallback()
...
#### [h2]OH_CaptureSession_OnFlashStateChange()
...
| 参数项 | 描述 |
| --- | --- |
| const [Camera_CaptureSession](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-oh-camera-camera-capturesession)* session | 传递回调的Camera_CaptureSession指针。 |
| [OH_Camera_FlashState](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-camera-h#oh_camera_flashstate) flashState | 回调传递的闪光灯状态。 |

#### [h2]OH_CaptureSession_RegisterFlashStateChangeCallback()
...
| 参数项 | 描述 |
| --- | --- |
| const [Camera_CaptureSession](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-oh-camera-camera-capturesession)* session | Camera_CaptureSession实例指针。 |
| [OH_CaptureSession_OnFlashStateChange](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-capture-session-h#oh_capturesession_onflashstatechange) flashStateChange | 待注册的闪光灯状态变更回调。 |
...
#### [h2]OH_CaptureSession_UnregisterFlashStateChangeCallback()
...
| --- | --- |
| const [Camera_CaptureSession](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-oh-camera-camera-capturesession)* session | Camera_CaptureSession实例指针。 |
| [OH_CaptureSession_OnFlashStateChange](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-capture-session-h#oh_capturesession_onflashstatechange) flashStateChange | 待注销的闪光灯状态变更回调。 |
...
#### [h2]OH_CaptureSession_IsExposureMeteringModeSupported()
...
| --- | --- |
| const [Camera_CaptureSession](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-oh-camera-camera-capturesession)* session | Camera_CaptureSession实例指针。 |
| [OH_Camera_ExposureMeteringMode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-camera-h#oh_camera_exposuremeteringmode) exposureMeteringMode | 待检查的曝光测光模式。 |
...
#### [h2]OH_CaptureSession_GetExposureMeteringMode()
...
| --- | --- |
| const [Camera_CaptureSession](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-oh-camera-camera-capturesession)* session | Camera_CaptureSession实例指针。 |
| [OH_Camera_ExposureMeteringMode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-camera-h#oh_camera_exposuremeteringmode)* exposureMeteringMode | 输出参数，返回当前曝光测光模式。 |

返回：

| 类型 | 说明 |
| --- | --- |
| [Camera_ErrorCode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-camera-h#camera_errorcode) | CAMERA_OK：方法调用成功。 CAMERA_INVALID_ARGUMENT：参数丢失或参数类型不正确。 CAMERA_OPERATION_NOT_ALLOWED：操作不允许，会话或相机状态异常。 CAMERA_SESSION_NOT_CONFIG：捕获会话未配置。 |

#### [h2]OH_CaptureSession_SetExposureMeteringMode()
...
| --- | --- |
| const [Camera_CaptureSession](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-oh-camera-camera-capturesession)* session | Camera_CaptureSession实例指针。 |
| [OH_Camera_ExposureMeteringMode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-camera-h#oh_camera_exposuremeteringmode) exposureMeteringMode | 待设置的目标曝光测光模式。 |
...
#### [h2]OH_CaptureSession_GetSupportedISORange()
...
#### [h2]OH_CaptureSession_GetSupportedPhysicalApertures()
...
| --- | --- |
| const [Camera_CaptureSession](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-oh-camera-camera-capturesession)* session | Camera_CaptureSession实例。 |
| [OH_Camera_PhysicalAperture](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-oh-camera-oh-camera-physicalaperture)** apertures | 用于存储物理光圈值的数组指针。 |
...
#### [h2]OH_CaptureSession_DeletePhysicalApertures()
...
| --- | --- |
| const [Camera_CaptureSession](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-oh-camera-camera-capturesession)* session | Camera_CaptureSession实例指针。 |
| [OH_Camera_PhysicalAperture](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-oh-camera-oh-camera-physicalaperture)* apertures | 待删除的物理光圈数组指针。 |
...
#### [h2]OH_CaptureSession_GetPhysicalAperture()
...
#### [h2]OH_CaptureSession_SetPhysicalAperture()
...
设置前，建议通过[OH_CaptureSession_GetSupportedPhysicalApertures](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-capture-session-h#oh_capturesession_getsupportedphysicalapertures)获取支持的物理光圈列表。
...
设置前，建议通过[OH_CaptureSession_GetExposureBiasRange](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-capture-session-h#oh_capturesession_getexposurebiasrange)获取支持配置的曝光补偿范围。
...
#### [h2]OH_CaptureSession_GetSupportedExposureDurationRange()
...
| 类型 | 说明 |
| --- | --- |
| [Camera_ErrorCode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-camera-h#camera_errorcode) | CAMERA_OK：方法调用成功。 CAMERA_INVALID_ARGUMENT：参数丢失或者参数不正确。 CAMERA_OPERATION_NOT_ALLOWED：操作不允许。 CAMERA_SESSION_NOT_CONFIG：捕获会话未配置。 |

#### [h2]OH_CaptureSession_SetExposureDuration()
...
| 类型 | 说明 |
| --- | --- |
| [Camera_ErrorCode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-camera-h#camera_errorcode) | CAMERA_OK：方法调用成功。 CAMERA_INVALID_ARGUMENT：参数丢失或者参数不正确。 CAMERA_OPERATION_NOT_ALLOWED：操作不允许，会话或相机状态异常。 CAMERA_SESSION_NOT_CONFIG：捕获会话未配置。 |

#### [h2]OH_CaptureSession_GetExposureDuration()
...
#### [h2]OH_CaptureSession_OnExposureDurationChange()
...
#### [h2]OH_CaptureSession_RegisterExposureInfoChangeCallback()
...
| --- | --- |
| const [Camera_CaptureSession](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-oh-camera-camera-capturesession)* session | Camera_CaptureSession实例指针。 |
| [OH_CaptureSession_OnExposureDurationChange](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-capture-session-h#oh_capturesession_onexposuredurationchange) exposureDurationChange | 待注册的曝光时间变更回调。 |
...
#### [h2]OH_CaptureSession_UnregisterExposureInfoChangeCallback()
...
| --- | --- |
| const [Camera_CaptureSession](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-oh-camera-camera-capturesession)* session | Camera_CaptureSession实例指针。 |
| [OH_CaptureSession_OnExposureDurationChange](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-capture-session-h#oh_capturesession_onexposuredurationchange) exposureDurationChange | 待注销的曝光时间变更回调。 |
...
设置前，建议通过[OH_CaptureSession_GetZoomRatioRange](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-capture-session-h#oh_capturesession_getzoomratiorange)获取支持的缩放比例范围。
...
#### [h2]OH_CaptureSession_GetFocusDistance()
...
| 类型 | 说明 |
| --- | --- |
| [Camera_ErrorCode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-camera-h#camera_errorcode) | CAMERA_OK：方法调用成功。 CAMERA_INVALID_ARGUMENT：参数丢失或者参数不正确。 CAMERA_OPERATION_NOT_ALLOWED：操作不允许，会话或输入设备可能异常。 CAMERA_SESSION_NOT_CONFIG：捕获会话未配置。 |

#### [h2]OH_CaptureSession_SetFocusDistance()
...
#### [h2]OH_CaptureSession_IsFocusDistanceSupported()
...
| 类型 | 说明 |
| --- | --- |
| [Camera_ErrorCode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-camera-h#camera_errorcode) | CAMERA_OK：方法调用成功。 CAMERA_INVALID_ARGUMENT：参数丢失或者参数不正确。 CAMERA_SESSION_NOT_CONFIG：捕获会话未配置。 |
...
| --- | --- |
| [Camera_CaptureSession](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-oh-camera-camera-capturesession)* session | Camera_CaptureSession实例。 |
| float targetZoom | 要设置的目标变焦比。取值范围需通过[OH_CaptureSession_GetZoomRatioRange](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-capture-session-h#oh_capturesession_getzoomratiorange)获取。 |
...
设置的值需在[OH_CaptureSession_GetSupportedColorSpaces](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-capture-session-h#oh_capturesession_getsupportedcolorspaces)获取的支持列表中。
...
#### [h2]OH_CaptureSession_GetColorTintRange()
...
| 类型 | 说明 |
| --- | --- |
| [Camera_ErrorCode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-camera-h#camera_errorcode) | CAMERA_OK：方法调用成功。 CAMERA_INVALID_ARGUMENT：参数丢失或参数类型不正确。 CAMERA_SESSION_NOT_CONFIG：当调用该方法时，捕获会话未配置。 |

#### [h2]OH_CaptureSession_GetColorTint()
...
#### [h2]OH_CaptureSession_SetColorTint()
...
#### [h2]OH_CaptureSession_RegisterMacroStatusChangeCallback()
...
#### [h2]OH_CaptureSession_RegisterIsoChangeCallback()
...
#### [h2]OH_CaptureSession_GetRAWCaptureZoomRatioRange()
...
#### [h2]OH_CaptureSession_IsOISModeSupported()
...
| --- | --- |
| const [Camera_CaptureSession](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-oh-camera-camera-capturesession)* session | Camera_CaptureSession实例指针。 |
| [OH_Camera_OISMode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-camera-h#oh_camera_oismode) oisMode | 待检查的光学防抖模式。 |
...
#### [h2]OH_CaptureSession_GetSupportedOISBiasRange()
...
| --- | --- |
| const [Camera_CaptureSession](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-oh-camera-camera-capturesession)* session | Camera_CaptureSession实例指针。 |
| [OH_Camera_OISAxes](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-camera-h#oh_camera_oisaxes) oisAxis | 光学防抖轴。 |
...
#### [h2]OH_CaptureSession_GetCurrentOISMode()
...
| --- | --- |
| const [Camera_CaptureSession](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-oh-camera-camera-capturesession)* session | Camera_CaptureSession实例指针。 |
| [OH_Camera_OISMode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-camera-h#oh_camera_oismode)* oisMode | 输出参数，返回当前光学防抖模式。 |
...
#### [h2]OH_CaptureSession_GetCurrentCustomOISBias()
...
#### [h2]OH_CaptureSession_SetOISMode()
...
| --- | --- |
| const [Camera_CaptureSession](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-oh-camera-camera-capturesession)* session | Camera_CaptureSession实例指针。 |
| [OH_Camera_OISMode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-camera-h#oh_camera_oismode) oisMode | 待设置的光学防抖模式。 |
...
#### [h2]OH_CaptureSession_SetOISModeCustom()
...
设置前，建议通过[OH_CaptureSession_GetSupportedOISBiasRange](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-capture-session-h#oh_capturesession_getsupportedoisbiasrange)获取对应轴支持的偏移范围。
...
#### [h2]OH_CaptureSession_OnExposureStateChange()
...
| [const Camera_CaptureSession](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-oh-camera-camera-capturesession)* session | Camera_CaptureSession实例。 |
| void* context | 指向自定义上下文的指针。 |
| [OH_CaptureSession_OnExposureStateChange](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-capture-session-h#oh_capturesession_onexposurestatechange) callback | 表示曝光状态改变的回调函数。 |

返回：

| 类型 | 说明 |
| --- | --- |
| [Camera_ErrorCode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-camera-h#camera_errorcode) | CAMERA_OK：方法调用成功。 CAMERA_INVALID_ARGUMENT：参数缺失或参数类型不正确。 |

#### [h2]OH_CaptureSession_UnregisterExposureStateChangeCallback()
...
#### [h2]OH_CaptureSession_GetZoomPointInfos()
...
| 参数项 | 描述 |
| --- | --- |
| [const Camera_CaptureSession](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-oh-camera-camera-capturesession)* session | 捕获会话对象的实例指针。 |
| uint32_t* size | 输出参数，返回查询到的变焦点信息数量。 |
| [OH_Camera_ZoomPointInfo](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-oh-camera-oh-camera-zoompointinfo)** zoomPointInfo | 输出参数，返回查询到的变焦点信息数组。 |
...
#### [h2]OH_CaptureSession_DeleteZoomPointInfos()
...
| --- | --- |
| [const Camera_CaptureSession](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-oh-camera-camera-capturesession)* session | 捕获会话对象的实例指针。 |
| [OH_Camera_ZoomPointInfo](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-oh-camera-oh-camera-zoompointinfo)* zoomPointInfo | 待删除的变焦点信息数组，方法调用成功后该内存将被释放。 |
...
#### [h2]OH_CaptureSession_IsLockFocusTrackingSupported()
...
#### [h2]OH_CaptureSession_LockFocusTracking()
...
| --- | --- |
| [Camera_CaptureSession](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-oh-camera-camera-capturesession)* session | 指向Camera_CaptureSession实例的指针。 |
| [Camera_Point](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-oh-camera-camera-point) focusPoint | 锁定焦点跟踪的追踪点。 |
...
#### [h2]OH_CaptureSession_UnlockFocusTracking()
