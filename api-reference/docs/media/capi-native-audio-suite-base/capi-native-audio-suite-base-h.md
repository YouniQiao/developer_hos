...
content_hash: "8edcb34b29ae"
synced_at: "2026-07-09T01:00:10.943575"
---
...
| [OH_AudioSuite_SpaceRenderExtensionParams](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-ohaudiosuite-oh-audiosuite-spacerenderextensionparams) | OH_AudioSuite_SpaceRenderExtensionParams | 定义空间渲染效果节点扩展模式配置参数。 |
| [OH_AudioSuite_PureVoiceChangeOption](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-ohaudiosuite-oh-audiosuite-purevoicechangeoption) | OH_AudioSuite_PureVoiceChangeOption | 定义音频编创传统变声选项。 |
...
| OH_PURE_VOICE_DEFAULT_PITCH (0.0f) | 使用系统推荐的音调。用于[OH_AudioSuite_PureVoiceChangeOption](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-ohaudiosuite-oh-audiosuite-purevoicechangeoption)。 **起始版本：** 23 |
...
| AUDIOSUITE_PIPELINE_REALTIME_MODE = 2 | 实时预览模式，即在音频处理过程中实时预览已处理的音频。 在API version 23之前，实时预览模式下管线仅支持均衡器效果节点； 在API version 23及以后，实时预览模式下管线支持所有效果节点。 |
...
#### [h2]OH_AudioSuite_SurroundDirection
...
#### [h2]OH_AudioSuite_PureVoiceChangeGenderOption
...
#### [h2]OH_AudioSuite_PureVoiceChangeType
...
#### [h2]OH_AudioSuite_GeneralVoiceChangeType
