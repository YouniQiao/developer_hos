...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [OH_Camera_MetadataObjectExt](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-oh-camera-oh-camera-metadataobjectext) | OH_Camera_MetadataObjectExt | 元数据对象扩展结构体。 |
...
#### [h2]OH_MetadataObjectExt_GetMetadataObjectType()
...
#### [h2]OH_MetadataObjectExt_GetTimestamp()
...
#### [h2]OH_MetadataObjectExt_GetBoundingBox()
...
#### [h2]OH_MetadataObjectExt_GetPitchAngle()
...
| 类型 | 说明 |
| --- | --- |
| [Camera_ErrorCode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-camera-h#camera_errorcode) | CAMERA_OK：操作成功。 CAMERA_INVALID_ARGUMENT：参数缺失或参数类型错误。 CAMERA_ERROR_OPTIONAL_PROPERTY_NOT_EXIST：可选属性不存在。 |

#### [h2]OH_MetadataObjectExt_GetYawAngle()
...
#### [h2]OH_MetadataObjectExt_GetRollAngle()
...
#### [h2]OH_MetadataObjectExt_GetLeftEyeBoundingBox()
...
#### [h2]OH_MetadataObjectExt_GetRightEyeBoundingBox()
...
#### [h2]OH_MetadataObjectExt_GetEmotion()
...
#### [h2]OH_MetadataObjectExt_Destroy()
...
| 参数项 | 描述 |
| --- | --- |
| [OH_Camera_MetadataObjectExt](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-oh-camera-oh-camera-metadataobjectext)** metadataObjectExt | OH_Camera_MetadataObjectExt实例数组的指针。 |
| uint32_t objectCount | 要销毁的元数据对象数量。 |

#### [h2]OH_MetadataObjectExt_IsLockFocusTracked()
...
| 参数项 | 描述 |
| --- | --- |
| const [OH_Camera_MetadataObjectExt](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-oh-camera-oh-camera-metadataobjectext)* metadataObjectExt | OH_Camera_MetadataObjectExt实例指针。 |
