...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| source | [MediaSource](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-media-mediasource) | 是 | 媒体资源描述，至少包含资源URL。 值不能为null。 |
...
| 类型 | 说明 |
| --- | --- |
| Array | 若任务管理器中存在任务，返回任务ID数组；否则返回空数组。 |
...
获取指定离线下载任务的状态。状态类型详见[AVDownloadTaskState](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-media-t#avdownloadtaskstate)。
...
| 类型 | 说明 |
| --- | --- |
| [AVDownloadTaskState](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-media-t#avdownloadtaskstate) | 指定任务的下载状态。 |
...
| 类型 | 说明 |
| --- | --- |
| number | 下载进度比例值。 - 取值范围：[0.0, 1.0] - 若返回值为-1，表示资源大小未知。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [OnAVDownloadTaskStateHandle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-media-t#onavdownloadtaskstatehandle) | 是 | 状态变化事件的处理函数。由应用实现。 第一个参数为状态变化的任务ID，第二个参数为任务的新状态。 |
