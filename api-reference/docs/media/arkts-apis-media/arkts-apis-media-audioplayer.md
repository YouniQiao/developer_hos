...
synced_at: "2026-06-24T20:52:34.763639"
---
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| src | string | 否 | 否 | 音频媒体URI，支持当前主流的音频格式(m4a、aac、mp3、ogg、wav、amr)。 **支持路径示例**： 1. fd类型播放：fd://xx ![](./img/zh-cn_image_0000002626231556.png) 2. http网络播放: http://xx 3. https网络播放: https://xx 4. hls网络播放路径：http://xx或者https://xx **需要权限：** ohos.permission.READ_MEDIA 或 ohos.permission.INTERNET。 |
