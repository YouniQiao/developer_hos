...
content_hash: "2af77279da38"
synced_at: "2026-07-28T16:51:56.673479"
---
...
| err | BusinessError | 否 | 获取缩略图时发生错误，默认值为null。 |
...
![](./img/caution_3.0-zh-cn.png) 客户端在处理完请求后应立刻返回。
...
| 类型 | 说明 |
| --- | --- |
| Record | 表示值类型为键值对，其中key和value的类型与范围请参考[PlaybackMetricsKey](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-media-e#playbackmetricskey23)。 |
...
![](./img/note_3.0-zh-cn.png) 从API version 6开始支持，从API version 9开始废弃，建议使用[AVPlayerState](#avplayerstate9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8开始支持，从API version 9开始废弃，建议使用[AVPlayerState](#avplayerstate9)替代。
