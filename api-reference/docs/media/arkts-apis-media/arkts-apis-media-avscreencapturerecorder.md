...
content_hash: "7fbb76048619"
synced_at: "2026-07-28T16:51:56.417514"
---
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回所添加水印的编号ID表示添加水印成功，失败时返回错误码。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| windowIDs | Array | 是 | 需要豁免隐私的窗口列表，包括主窗口id和子窗口id，窗口属性获取方法可以参考[getWindowProperties](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-window-window#getwindowproperties9)。 |
...
- 需在[startRecording](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-media-avscreencapturerecorder#startrecording12)接口调用前调用此接口。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| excludedWindows | Array | 是 | 需要在Picker中隐藏的窗口列表，窗口属性获取方法可以参考[getWindowProperties](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-window-window#getwindowproperties9)。 |
...
![](./img/note_3.0-zh-cn.png) 需在[startRecording](#startrecording12)接口调用前调用此接口。
...
| callback | Callback | 是 | 状态切换事件回调方法，[AVScreenCaptureStateCode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-media-e#avscreencapturestatecode12)表示切换到的状态。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 状态切换事件回调类型，支持的事件：'stateChange'。 |
| callback | Callback | 否 | 状态切换事件回调方法，[AVScreenCaptureStateCode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-media-e#avscreencapturestatecode12)表示切换到的状态，不填此参数则会取消最后一次订阅事件。 |
