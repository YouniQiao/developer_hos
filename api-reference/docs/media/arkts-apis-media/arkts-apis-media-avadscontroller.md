...
content_hash: "269765528e5c"
synced_at: "2026-07-28T16:51:55.437156"
---
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| src | [MediaSource](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-media-mediasource) | 是 | 要插入到主内容中播放的视频源。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回添加到广告控制器中的媒体源ID。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [OnAdsEventAdsStartedHandle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-media-t#onadseventadsstartedhandle) | 是 | 广告内容开始播放时的处理函数。常用于切换播放页面的逻辑。 第一个参数表示正在播放的广告ID，第二个参数表示广告的时长。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback | 是 | 广告跳过的处理函数。参数为被跳过的广告ID。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback | 是 | 广告播放完成的处理函数。参数为播放完成的广告ID。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [OnAdsEventLoadingErrorHandle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-media-t#onadseventloadingerrorhandle) | 否 | 广告内容加载失败的处理函数。 默认值为取消订阅该事件的所有回调函数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [OnAdsEventAdsStartedHandle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-media-t#onadseventadsstartedhandle) | 否 | 广告内容开始播放时的处理函数。常用于切换播放页面的逻辑。 默认值为取消订阅该事件的所有回调函数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback | 否 | 广告跳过的处理函数。 默认值为取消订阅该事件的所有回调函数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback | 否 | 广告播放完成的处理函数。 默认值为取消订阅该事件的所有回调函数。 |
