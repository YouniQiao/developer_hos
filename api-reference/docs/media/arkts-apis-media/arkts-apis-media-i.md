...
synced_at: "2026-06-24T20:52:34.572107"
---
...
| url | string | 否 | 否 | 录制输出URL：fd://xx (fd number) ![](./img/zh-cn_image_0000002626231556.png)，必要参数。 **元服务API：** 从API version 12 开始，该接口支持在元服务中使用。 |
...
| aacProfile22+ | [AacProfile](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-media-e#aacprofile22) | 否 | 是 | 音频编码扩展格式，默认为AAC_LC格式。 当前支持类型：AAC_LC、AAC_HE和AAC_HE_V2。 **元服务API：** 从API version 22 开始，该接口支持在元服务中使用。 |
...
| uri | string | 否 | 否 | 音频输出URI：fd://xx (fd number) ![](./img/zh-cn_image_0000002626231556.png) 文件需要由调用者创建，并赋予适当的权限。 **说明：** 从API version 6开始支持，从API version 9开始废弃，建议使用[AVRecorderConfig](#avrecorderconfig9)中的url替代。 |
