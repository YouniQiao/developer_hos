...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback | 是 | 回调函数。异步返回AVPlayer实例，失败时返回null。可用于音视频播放。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象。成功时异步返回AVPlayer实例，可用于音视频播放。失败时返回null。 |
...
![](./img/note_3.0-zh-cn.png) 应用可创建多个音视频录制实例，但由于设备共用音频通路，一个设备仅能有一个实例进行音频录制。创建第二个实例录制音频时，将会因为音频通路冲突导致创建失败。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback | 是 | 回调函数，返回AVRecorder实例，可用于录制音视频媒体。失败时返回null。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回AVRecorder实例，可用于录制音视频媒体。失败时返回null。 |
...
![](./img/note_3.0-zh-cn.png) 可创建的视频转码实例不能超过2个。
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象。异步返回AVTranscoder实例，失败时返回null。可用于视频转码。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback | 是 | 回调函数。当创建AVMetadataExtractor实例成功，err为undefined，data为获取到的AVMetadataExtractor实例，否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象。异步返回元数据获取类对象（AVMetadataExtractor）。 |
...
| callback | AsyncCallback | 是 | 回调函数。异步返回SoundPool实例，失败时返回null。用于音频池实例的加载播放功能。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象。异步返回SoundPool实例，失败时返回null。用于音频池实例的加载播放功能。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回AVScreenCaptureRecorder实例，失败时返回null。可用于进行屏幕录制。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback | 是 | 回调函数。异步返回AVImageGenerator实例，失败时返回null。可用于获取视频缩略图。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象。异步返回AVImageGenerator实例，失败时返回null。可用于获取视频缩略图。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| streams | Array | 是 | 可设置MediaStream数组，支持的流媒体格式：HTTP-FLV。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| fdSrc | [AVFileDescriptor](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-media-i#avfiledescriptor9) | 是 | 媒体文件描述符。 |

返回值：

| 类型 | 说明 |
| --- | --- |
| [MediaSource](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-media-mediasource) | undefined | 返回MediaSource，用于媒体资源设置。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| dataSrc | [AVDataSrcDescriptor](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-media-i#avdatasrcdescriptor10) | 是 | 流式媒体资源描述符。 |
...
![](./img/note_3.0-zh-cn.png) 从API version 6开始支持，从API version 9开始废弃，建议使用[createAVPlayer](#mediacreateavplayer9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8开始支持，从API version 9开始废弃，建议使用[createAVPlayer](#mediacreateavplayer9)替代。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback | 是 | 回调函数。创建VideoPlayer实例成功时，err为undefined，data为获取到的VideoPlayer实例，否则为错误对象。 |
...
![](./img/note_3.0-zh-cn.png) 从API version 8开始支持，从API version 9开始废弃，建议使用[createAVPlayer](#mediacreateavplayer9-1)替代。
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象。异步返回VideoPlayer实例，失败时返回null。可用于管理和播放视频媒体。 |
...
![](./img/note_3.0-zh-cn.png) 从API version 6开始支持，从API version 9开始废弃，建议使用[createAVRecorder](#mediacreateavrecorder9)替代。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| player | [AVPlayer](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-media-avplayer) | 是 | 已创建的播放器实例。 |

返回值：

| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象。成功时返回广告播放控制器实例，失败时返回undefined。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象。成功时返回MediaSource实例，失败时返回undefined。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象。返回离线下载任务管理器实例。 |
