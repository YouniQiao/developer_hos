...
upstream_id: "harmonyos-references/capi-native-audio-accessory-input-stream-manager-h"
catalog: "harmonyos-references"
content_hash: "1d6782998646"
synced_at: "2026-08-29T18:17:20.608382"
---
...
#### [h2]OH_AudioAccessory_OpenInputStreamCallback()
...
| 名称 | 描述 |
| --- | --- |
| [OH_AudioAccessory](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-ohaudio-oh-audioaccessory) *accessory | 正在打开输入流的音频配件。 |
| [OH_AudioAccessoryInputStream](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-ohaudio-oh-audioaccessoryinputstream) *stream | 新创建的输入流句柄。使用此句柄注册输入流相关回调。 |
| [OH_AudioStreamInfo](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-ohaudio-oh-audiostreaminfo) *streamInfo | 正在打开的输入流的音频流信息指针。此参数描述请求的流格式， 配件可使用此信息配置音频数据传输通道。 |
...
#### [h2]OH_AudioAccessoryInputStream_StartCallback()
...
| 名称 | 描述 |
| --- | --- |
| [OH_AudioAccessory](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-ohaudio-oh-audioaccessory) *accessory | 该输入流所属的音频配件。 |
| [OH_AudioAccessoryInputStream](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-ohaudio-oh-audioaccessoryinputstream) *stream | 已启动的输入流句柄。 |
...
#### [h2]OH_AudioAccessoryInputStream_StopCallback()
...
| --- | --- |
| [OH_AudioAccessory](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-ohaudio-oh-audioaccessory) *accessory | 该输入流所属的音频配件。 |
| [OH_AudioAccessoryInputStream](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-ohaudio-oh-audioaccessoryinputstream) *stream | 已停止的输入流句柄。 |
...
#### [h2]OH_AudioAccessoryInputStream_ReleaseCallback()
...
| --- | --- |
| [OH_AudioAccessory](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-ohaudio-oh-audioaccessory) *accessory | 该输入流所属的音频配件。 |
| [OH_AudioAccessoryInputStream](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-ohaudio-oh-audioaccessoryinputstream) *stream | 即将释放的输入流（录音/采集流）句柄。 |
...
#### [h2]OH_AudioAccessoryInputStream_GetLatencyCallback()
...
| --- | --- |
| [OH_AudioAccessory](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-ohaudio-oh-audioaccessory) *accessory | 该输入流所属的音频配件。 |
| [OH_AudioAccessoryInputStream](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-ohaudio-oh-audioaccessoryinputstream) *stream | 输入流句柄。 |
...
#### [h2]OH_AudioAccessoryInputStream_GetFramePositionCallback()
...
| 名称 | 描述 |
| --- | --- |
| [OH_AudioAccessory](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-ohaudio-oh-audioaccessory) *accessory | 该输入流所属的音频配件（外部音频设备）。 |
| [OH_AudioAccessoryInputStream](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-ohaudio-oh-audioaccessoryinputstream) *stream | 输入流句柄。 |
| int64_t *framePosition | 输出参数，返回自该输入流最近一次成功启动以来已采集的音频帧总数。 |
| int64_t *timestamp | 输出参数，返回与framePosition对应的采集时间戳。 时间戳需使用CLOCK_MONOTONIC时间基准，单位为纳秒（ns）， 表示采集到该音频帧时的时间点。 |
...
#### [h2]OH_AudioAccessoryInputStreamManager_RegisterStartCallback()
...
| 名称 | 描述 |
| --- | --- |
| [OH_AudioAccessoryInputStream](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-ohaudio-oh-audioaccessoryinputstream) *stream | 输入流句柄指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH_AudioCommon_Result](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-native-audio-common-h#oh_audiocommon_result) | AUDIOCOMMON_RESULT_SUCCESS：函数执行成功。 AUDIOCOMMON_RESULT_ERROR_INVALID_PARAM：参数为空。 AUDIOCOMMON_RESULT_ERROR_ILLEGAL_STATE：未在OH_AudioAccessory_OpenInputStreamCallback执行期间调用，或输入流已经释放。 |

#### [h2]OH_AudioAccessoryInputStreamManager_RegisterStopCallback()
...
#### [h2]OH_AudioAccessoryInputStreamManager_RegisterReleaseCallback()
...
#### [h2]OH_AudioAccessoryInputStreamManager_RegisterLatencyCallback()
...
#### [h2]OH_AudioAccessoryInputStreamManager_RegisterFramePositionCallback()
...
#### [h2]OH_AudioAccessoryInputStreamManager_Write()
...
| 类型 | 说明 |
| --- | --- |
| [OH_AudioCommon_Result](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-native-audio-common-h#oh_audiocommon_result) | AUDIOCOMMON_RESULT_SUCCESS：函数执行成功。 AUDIOCOMMON_RESULT_ERROR_INVALID_PARAM：参数为空。 AUDIOCOMMON_RESULT_ERROR_FRAME_LENGTH_MISMATCH：音频数据帧长度与当前输入流配置不匹配。 AUDIOCOMMON_RESULT_ERROR_ILLEGAL_STATE：输入流未启动或需注册的流回调未全部注册。 AUDIOCOMMON_RESULT_ERROR_SYSTEM：音频服务进程死亡。 |

#### [h2]OH_AudioAccessoryInputStreamManager_GetWritableSize()
...
| 类型 | 说明 |
| --- | --- |
| [OH_AudioCommon_Result](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-native-audio-common-h#oh_audiocommon_result) | AUDIOCOMMON_RESULT_SUCCESS：函数执行成功。 AUDIOCOMMON_RESULT_ERROR_INVALID_PARAM：参数为空。 AUDIOCOMMON_RESULT_ERROR_ILLEGAL_STATE：输入流已经释放。 |
