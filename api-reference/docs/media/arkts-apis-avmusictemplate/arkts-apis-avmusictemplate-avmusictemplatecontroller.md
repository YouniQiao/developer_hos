...
upstream_id: "harmonyos-references/arkts-apis-avmusictemplate-avmusictemplatecontroller"
catalog: "harmonyos-references"
content_hash: "2d62c81f12c9"
synced_at: "2026-07-09T01:00:19.666946"
---
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回查询的媒体实体分页对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回查询的合集的分页对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回查询的播放列表的分页对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回与该关键字相关的媒体实体分页对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回清除搜索历史的操作结果。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回报告问题和建议的操作结果。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回下载媒体实体的操作结果。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| command | [SearchPlayInfoType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-avmusictemplate-e#searchplayinfotype) | 是 | 搜播的信息类型。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback | 是 | 回调函数，参数为用户信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback | 否 | 回调函数，返回用户信息。不填该参数则注销该类型对应的所有回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback | 是 | 回调函数，返回当前单曲的信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback | 否 | 回调函数，返回当前单曲的信息。不填该参数则注销该类型对应的所有回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback | 是 | 回调函数，返回媒体实体数组。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback | 否 | 回调函数，返回媒体实体数组。不填该参数则注销该类型对应的所有回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback | 是 | 回调函数，返回标签页媒体实体信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback | 否 | 回调函数，返回标签页媒体实体信息。不填该参数则注销该类型对应的所有回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback | 是 | 回调函数，返回媒体实体信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback | 否 | 回调函数，返回媒体实体信息。不填该参数则注销该类型对应的所有回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback | 是 | 回调函数，返回设置项数组。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback | 否 | 回调函数，用于接收并处理设置项数组。不填该参数则注销该类型对应的所有回调。 |
