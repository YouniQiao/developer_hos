...
| 名称 | 描述 |
| --- | --- |
| [spatial_recon_interface.h](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-spatial-recon-interface-h) | 3D空间重建任务设计模块，通过处理多视角图像输入来生成三维场景。 |
