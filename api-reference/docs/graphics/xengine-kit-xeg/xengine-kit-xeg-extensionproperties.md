...
| 名称 | 描述 |
| --- | --- |
| char [extensionName](#extensionname) [[XEG_MAX_EXTENSION_NAME_SIZE](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/xengine-kit-xengine#xeg_max_extension_name_size)] | XEngine支持的扩展特性名称。 |
| uint32_t [version](#version) | XEngine支持的扩展特性版本号。 |
