...
content_hash: "7740992aa6f2"
synced_at: "2026-08-14T15:55:39.882927"
---
...
| [AREngine_ARMeshMode](#arengine_armeshmode) { ARENGINE_MESH_MODE_DISABLED = 0, ARENGINE_MESH_MODE_ENABLED=1 } | Mesh启用模式。 |
...
| [AREngine_ARType](#arengine_artype) { ARENGINE_TYPE_WORLD = 0x01, ARENGINE_TYPE_BODY = 0x2, ARENGINE_TYPE_FACE = 0x10, ARENGINE_TYPE_IMAGE = 0x80 } | AR能力类型。 |
...
| [AREngine_ARStatus](#arengine_arstatus) [HMS_AREngine_ARConfig_GetRemoteSensorMode](#hms_arengine_arconfig_getremotesensormode)(const [AREngine_ARSession](#arengine_arsession) *session, const [AREngine_ARConfig](#arengine_arconfig) *config, [AREngine_RemoteSensorMode](#arengine_remotesensormode) *remoteSensorMode) | 获取当前配置的远程传感器模式。 |
| [AREngine_ARStatus](#arengine_arstatus) [HMS_AREngine_ARConfig_SetRemoteSensorMode](#hms_arengine_arconfig_setremotesensormode)(const [AREngine_ARSession](#arengine_arsession) *session, [AREngine_ARConfig](#arengine_arconfig) *config, [AREngine_RemoteSensorMode](#arengine_remotesensormode) remoteSensorMode) | 设置远程传感器模式。 |
...
| [AREngine_ARStatus](#arengine_arstatus) [HMS_AREngine_ARSession_OpenFlash](#hms_arengine_arsession_openflash)(const [AREngine_ARSession](#arengine_arsession) *session) | 打开设备的闪光灯。 |
| [AREngine_ARStatus](#arengine_arstatus) [HMS_AREngine_ARSession_CloseFlash](#hms_arengine_arsession_closeflash)(const [AREngine_ARSession](#arengine_arsession) *session) | 关闭设备的闪光灯。 |
...
| ARENGINE_FEATURE_TYPE_SEMANTIC_DENSE | 高精几何重建特性。 |
| ARENGINE_FEATURE_TYPE_SEMANTIC | 平面语义及物体语义特性。 |
...
| ARENGINE_ERROR_NOT_SYSTEM_APP | 非系统应用状态。 **起始版本：** 26.0.0 |
...
#### [h2]HMS_AREngine_ARConfig_GetRemoteSensorMode
...
| session | 与AR Engine服务交互的[AREngine_ARSession](#arengine_arsession)对象。 |
| config | 指向待获取配置信息的配置对象，参见[AREngine_ARConfig](#arengine_arconfig)。 |
| remoteSensorMode | 返回当前远程传感器模式，参见[AREngine_RemoteSensorMode](#arengine_remotesensormode)。 |
...
#### [h2]HMS_AREngine_ARConfig_SetRemoteSensorMode
...
| session | 与AR Engine服务交互的[AREngine_ARSession](#arengine_arsession)对象。 |
| config | 指向待获取配置信息的配置对象，参见[AREngine_ARConfig](#arengine_arconfig)。 |
| remoteSensorMode | 预览更新模式，参见[AREngine_RemoteSensorMode](#arengine_remotesensormode)。 |
...
| height | 拍照流图像分辨率的高，以Pixel为单位。可调用[OH_CameraManager_GetSupportedCameraOutputCapability](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-camera-manager-h#oh_cameramanager_getsupportedcameraoutputcapability)查询设备支持的数值。 |
...
| session | 与AR Engine服务交互的[AREngine_ARSession](#arengine_arsession)对象。 |
| hitResult | 命中检测结果对象，参见[AREngine_ARHitResult](#arengine_arhitresult)。 |
| outTrackable | 返回被命中的可追踪对象，参见[AREngine_ARTrackable](#arengine_artrackable)。 |
...
设备行为差异： 该接口在部分Phone、部分Tablet、TV中可正常调用，在不支持的设备中返回801错误码，可使用[HMS_AREngine_CheckSupported](#hms_arengine_checksupported)接口查询能力是否支持。
...
#### [h2]HMS_AREngine_ARSession_OpenFlash
...
#### [h2]HMS_AREngine_ARSession_CloseFlash
