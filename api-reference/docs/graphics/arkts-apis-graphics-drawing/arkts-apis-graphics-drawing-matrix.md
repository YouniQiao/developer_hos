...
content_hash: "80a76701b04c"
synced_at: "2026-08-29T18:17:50.528194"
---
...
![](./img/zh-cn_image_0000002731520111.png)
...
![](./img/zh-cn_image_0000002701640914.png)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| values | Array | 是 | 长度为9的浮点数组，表示矩阵对象的各项参数。数组中的值按下标从小到大分别表示水平缩放因子、水平倾斜系数、水平位移系数（单位为物理像素px）、垂直倾斜系数、垂直缩放因子、垂直位移系数（单位为物理像素px）、x轴透视系数、y轴透视系数和透视缩放因子。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| matrix | [Matrix](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-graphics-drawing-matrix) | 是 | 表示用于运算的矩阵，位于乘法表达式右侧。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| matrix | Array | [Matrix](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-graphics-drawing-matrix) | 是 | 用于更新的数组或矩阵。当类型为数组时，长度固定为9。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| matrixA | [Matrix](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-graphics-drawing-matrix) | 是 | 用于运算的矩阵A，位于乘法表达式左侧。 |
| matrixB | [Matrix](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-graphics-drawing-matrix) | 是 | 用于运算的矩阵B，位于乘法表达式右侧。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| matrix | [Matrix](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-graphics-drawing-matrix) | 是 | 表示用于运算的矩阵，位于乘法表达式左侧。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| matrix | [Matrix](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-graphics-drawing-matrix) | 是 | 另一个矩阵，用来与当前矩阵比较是否相等。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| src | Array | 是 | 源点数组，作为矩阵变换的输入点。 |

返回值：

| 类型 | 说明 |
| --- | --- |
| Array | 源点数组经矩阵变换后的点数组。 |
...
![](./img/zh-cn_image_0000002731360131.png)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| src | [common2D.Rect](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-graphics-common2d#rect) | 是 | 源矩形，用于指定映射的源区域。 |
| dst | [common2D.Rect](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-graphics-common2d#rect) | 是 | 目标矩形，用于指定映射的目标区域。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| src | Array | 是 | 源点数组，长度必须为count。 |
| dst | Array | 是 | 目标点数组，长度必须为count。 |
