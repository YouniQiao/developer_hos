...
content_hash: "8c9930a1782d"
synced_at: "2026-08-29T18:17:54.974848"
---
...
| 参数项 | 描述 |
| --- | --- |
| const [OH_Drawing_RoundRect](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-drawing-oh-drawing-roundrect)* roundRect | 指向圆角矩形对象OH_Drawing_RoundRect的指针 |
...
| [OH_Drawing_Corner_Radii](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-drawing-oh-drawing-point2d) radii | 圆角半径结构体OH_Drawing_Corner_Radii，其中包含x轴方向和y轴方向上的半径，单位为物理像素px，半径小于等于0时无效。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH_Drawing_ErrorCode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-drawing-error-code-h#oh_drawing_errorcode) | 函数返回执行错误码。 返回OH_DRAWING_SUCCESS，表示执行成功。 返回OH_DRAWING_ERROR_INVALID_PARAMETER，表示参数roundRect为NULL。 |
