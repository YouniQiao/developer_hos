...
| [OH_Drawing_BlendMode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-drawing-types-h#oh_drawing_blendmode) blendMode | 表示混合模式。支持可选的混合模式具体可见[OH_Drawing_BlendMode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-drawing-types-h#oh_drawing_blendmode)枚举。 |

返回：

| 类型 | 说明 |
| --- | --- |
| [OH_Drawing_ColorFilter](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-drawing-oh-drawing-colorfilter)* | 返回创建的颜色滤波器对象的指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH_Drawing_ColorFilter](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-drawing-oh-drawing-colorfilter)* outerColorFilter | 指向颜色滤波器对象一的指针。 |
| [OH_Drawing_ColorFilter](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-drawing-oh-drawing-colorfilter)* innerColorFilter | 指向颜色滤波器对象二的指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH_Drawing_ColorFilter](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-drawing-oh-drawing-colorfilter)* colorFilter | 表示指向颜色滤波器对象的指针。 |
