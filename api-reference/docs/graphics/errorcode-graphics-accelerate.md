...
![](./img/note_3.0-zh-cn.png) 以下仅介绍Graphics Accelerate Kit特有错误码，通用错误码请参考[通用错误码](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/errorcode-universal)。
...
Service error. 1. Connect to system service failed; 2.System service failed to communicate with dependency module.
...
#### 1019400002 游戏不在预启动状态

错误信息

The app is not in a preloading state.
...
开发者可在UIAbility的[onCreate](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-app-ability-uiability#oncreate)生命周期回调中通过[want.parameters](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-app-ability-want#want)获取启动原因，若参数ohos.params.gamePrelaunch为true时，则表示当前UIAbility是由游戏预启动运行的。
