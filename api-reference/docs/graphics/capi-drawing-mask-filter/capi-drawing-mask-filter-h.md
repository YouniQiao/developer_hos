...
| 类型 | 说明 |
| --- | --- |
| [OH_Drawing_MaskFilter](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-drawing-oh-drawing-maskfilter)* | 返回创建的蒙版滤波器对象的指针。 |

#### [h2]OH_Drawing_MaskFilterDestroy()
...
| 参数项 | 描述 |
| --- | --- |
| [OH_Drawing_MaskFilter](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-drawing-oh-drawing-maskfilter)* maskFilter | 表示指向蒙版滤波器对象的指针。 |
