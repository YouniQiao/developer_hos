...
| Authorization | 是 | String | 通过[获取用户级凭证](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/account-api-obtain-user-token)获取的Access Token。获取凭证时Authorization Code需包含realNameAgeRange scope的授权。 传参格式：Bearer ${Access Token} 样例：Bearer DgEEn******Y+Aj== |
...
| 参数 | 参数位置 | 参数类型 | 描述 |
| --- | --- | --- | --- |
| resultCode | body | Int | 错误码，详见本章节[错误码](#错误码)。 |
