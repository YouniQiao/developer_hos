...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回显示升级弹框获取结果。 |
...
![](./img/note_3.0-zh-cn.png) 同一设备下元服务的更新检查监听次数不超过6次/天、每30分钟监听次数不超过1次。
...
| callback | Callback | 是 | 回调函数，使用Callback方式获取结果。 |
