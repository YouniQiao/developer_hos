...
content_hash: "282c2b575881"
synced_at: "2026-07-28T16:52:46.872791"
---
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| notificationInfo | [NotificationInfo](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-inner-notification-notificationinfo) | 是 | 通知订阅扩展能力中收到通知的回调信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| hashCodes | Array | 是 | 要取消的通知的哈希码列表。通过[onReceiveMessage](#onreceivemessage)获取。 |
