...
content_hash: "42d903dc8a09"
synced_at: "2026-07-28T16:53:03.282612"
---
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| inputType | [InputType](#inputtype) | 否 | 否 | Input组件功能场景类型。默认值：SELECT_DISTRICT。 |
...
| iconSymbolModifier | [SymbolGlyphModifier](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-attribute-modifier#自定义modifier) | 否 | 是 | 当“icon”设置为symbol时，可使用该参数进行图标的事件和样式设置。 iconSymbolModifier .fontColor([$r('sys.color.ohos_id_color_fourth')]) .margin({ start: 8, end: 16 }) |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback | 是 | 回调函数。当区域选择操作成功，err为undefined，data为获取到的区域选择请求的结果；否则为错误对象。 |

返回值：

| 类型 | 说明 |
| --- | --- |
| [FunctionalInputController](#functionalinputcontroller) | [FunctionalInput](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/scenario-fusion-functionalinput)组件控制器。 |
