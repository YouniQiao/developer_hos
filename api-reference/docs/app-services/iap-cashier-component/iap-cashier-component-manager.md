...
upstream_id: "harmonyos-references/iap-cashier-component-manager"
catalog: "harmonyos-references"
content_hash: "48dca2004166"
synced_at: "2026-07-09T01:01:21.242512"
---
...
| purchaseResult | [iap.CreatePurchaseResult](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/iap-iap#createpurchaseresult) | 是 | 支付成功回调获取到的[iap.CreatePurchaseResult](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/iap-iap#createpurchaseresult)对象。 |
...
| error | [BusinessError](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#businesserror) | 是 | 支付失败回调获取到的[iap.CreatePurchaseResult](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/iap-iap#createpurchaseresult)对象。 |
...
| 名称 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| backgroundColor | [ResourceColor](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-types#resourcecolor) | 否 | 收银台背景颜色。 |
