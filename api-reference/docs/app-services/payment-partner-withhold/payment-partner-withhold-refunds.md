---
title: "申请退款"
upstream_id: "harmonyos-references/payment-partner-withhold-refunds"
catalog: "harmonyos-references"
content_hash: "855f9bea2289"
synced_at: "2026-07-09T01:01:33.681425"
---
...
1. 不支持对同一笔交易单进行并发退款。 一笔普通收单多次退款，时间间隔要在1分钟以上。
2. 合单多笔子单退款，时间间隔要在1分钟以上。
3. 订单退款只支持180天内的订单。
4. 申请退款成功不代表退款成功，退款场景是异步处理，需收到退款成功的异步回调通知才表示退款成功。
5. 服务商代特约商户退款，需要服务商在[华为支付商户平台](https://petalpay-merchant.cloud.huawei.com/)上[申请API退款授权](https://developer.huawei.com/consumer/cn/doc/pay-docs/hwzf-apituikuan-0000002371871965)。
...
| 参数 | 是否必选 | 类型 | 说明 |
| --- | --- | --- | --- |
| mercOrderNo | 否 | String | 商户订单号，由商户自己生成，商户需保证订单信息唯一性。最小长度1，最大长度46。sysTransOrderNo与该参数必选其一。 |
...
| 400000 | OPERATION_NOT_AUTHORIZED | 操作未授权 | 检查是否已[申请API退款授权](https://developer.huawei.com/consumer/cn/doc/pay-docs/hwzf-apituikuan-0000002371871965)。 |
