---
title: "查询结算账单"
upstream_id: "harmonyos-references/payment-query-settle-bill"
catalog: "harmonyos-references"
content_hash: "962c6438c6bf"
synced_at: "2026-07-09T01:01:32.238918"
---
...
1. 获取结算账单API接口能力需要管理员先在“[华为支付商户平台](https://petalpay-merchant.cloud.huawei.com/)”的“功能设置”中开启“结算单接口获取开关”，开启后**次日开始生成**前一日的账单。 ![](./img/zh-cn_image_0000002631254620.png)
...
| billDownloadParam | 否 | [BillDownloadParam](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/payment-model#billdownloadparam) | 账单下载请求信息。有生成账单数据时返回。 |
...
| 400000 | BILL_SWITCH_NOT_TURN_ON | 账单开关没有打开 | 请检查并[打开账单开关](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/payment-partner-agent-query-settle-bill#功能介绍)。 |
