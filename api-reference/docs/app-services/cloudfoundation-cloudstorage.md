...
| 类型 | 说明 |
| --- | --- |
| [StorageBucket](#storagebucket) | 云存储实例。 |
...
| parameters | [UploadParams](#uploadparams) | 是 | 上传相关参数。 |

返回值：

| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回上传任务。 |
...
| context | common.[BaseContext](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-inner-application-basecontext) | 是 | 应用上下文。 |
| parameters | [UploadParams](#uploadparams) | 是 | 上传相关参数。 |
| callback | AsyncCallback | 是 | 回调函数。当上传文件成功，err为undefined，data为获取到的request.agent.Task；否则为错误对象。 |
...
| --- | --- | --- | --- |
| context | common.[BaseContext](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-inner-application-basecontext) | 是 | 应用上下文。 |
| parameters | [DownloadParams](#downloadparams) | 是 | 下载相关参数。 |

返回值：

| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回下载任务。 |
...
| context | common.[BaseContext](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-inner-application-basecontext) | 是 | 应用上下文。 |
| parameters | [DownloadParams](#downloadparams) | 是 | 下载相关参数。 |
| callback | AsyncCallback | 是 | 回调函数。当下载文件成功，err为undefined，data为获取到的request.agent.Task；否则为错误对象。 |
...
| --- | --- | --- | --- |
| cloudPath | string | 是 | 云侧文件路径。支持传入“文件目录/文件名”（如“image/demo.jpg”），或仅传入文件名。 |
| callback | AsyncCallback | 是 | 回调函数。当获取云侧文件下载地址成功，err为undefined，data为获取到的云侧文件下载地址；否则为错误对象。 |
...
| --- | --- | --- | --- |
| cloudPath | string | 是 | 云侧文件路径。支持传入“文件目录/文件名”（如“image/demo.jpg”），或仅传入文件名。 |
| callback | AsyncCallback | 是 | 回调函数。当删除云侧文件成功，err为undefined，否则为错误对象。 |
...
| options | [ListOptions](#listoptions) | 否 | 列举操作的相关参数。 |

返回值：

| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回列举操作的结果。 |
...
| --- | --- | --- | --- |
| cloudPath | string | 是 | 云侧文件路径。 传入''（空字符串）表示获取云侧根路径下的文件列表；传入'some_directory/'表示获取指定文件夹some_directory下的文件列表。 |
| options | [ListOptions](#listoptions) | 是 | 列举操作的相关参数。 |
| callback | AsyncCallback | 是 | 回调函数。当获取云侧文件列表成功，err为undefined，data为获取到的ListResults；否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回云侧文件的元数据信息。 |
...
| --- | --- | --- | --- |
| cloudPath | string | 是 | 云侧文件路径。支持传入“文件目录/文件名”（如“image/demo.jpg”），或仅传入文件名。 |
| callback | AsyncCallback | 是 | 回调函数。当获取云侧文件的元数据成功，err为undefined，data为获取到的Metadata；否则为错误对象。 |
...
| --- | --- | --- | --- |
| cloudPath | string | 是 | 云侧文件路径。支持传入“文件目录/文件名”（如“image/demo.jpg”），或仅传入文件名。 |
| metadata | [MetadataUpdatable](#metadataupdatable) | 是 | 可更新参数的元数据信息。 |

返回值：

| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回云侧文件更新后的完整元数据信息。 |
...
| cloudPath | string | 是 | 云侧文件路径。支持传入“文件目录/文件名”（如“image/demo.jpg”），或仅传入文件名。 |
| metadata | [MetadataUpdatable](#metadataupdatable) | 是 | 可更新参数的元数据信息。 |
| callback | AsyncCallback | 是 | 回调函数。当设置云侧文件的元数据成功，err为undefined，data为设置的Metadata；否则为错误对象。 |
...
| metadata | [MetadataUpdatable](#metadataupdatable) | 否 | 是 | 文件元数据信息。 |
...
| customMetadata | Record | 否 | 是 | 自定义的云侧文件属性，不区分大小写，并且需要符合标准HTTP头部的规范。 |
