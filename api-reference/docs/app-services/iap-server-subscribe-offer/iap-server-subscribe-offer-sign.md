...
| kid | 是 | String | 密钥ID，获取方式请参见[配置密钥](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/iap-set-necessary-parameters#配置密钥)。如果有多个密钥，请使用对JWT进行签名的同一私钥的密钥ID。 |
...
| data | 是 | String | 优惠信息扩展信息，为[PurchaseReservedInfo](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/iap-server-data-model#purchasereservedinfo)结构的Json字符串。 |
