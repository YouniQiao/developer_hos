...
| 类型 | **说明** |
| --- | --- |
| Promise | Promise对象，返回一个CardMetadataInDevice元数据数组，包含设备信息和卡的元数据。 |
...
| 类型 | **说明** |
| --- | --- |
| Promise | Promise对象，返回cardNumber指定卡的详细信息。 |
...
| 类型 | **说明** |
| --- | --- |
| Promise | Promise对象，返回一个用于添加卡片的token令牌。 |
