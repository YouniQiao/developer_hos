...
![](./img/note_3.0-zh-cn.png) 除Lite Wearable外，从API version 9开始废弃，建议使用[geoLocationManager.getCurrentLocation](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-geolocationmanager#geolocationmanagergetcurrentlocation)替代。
...
![](./img/note_3.0-zh-cn.png) 除Lite Wearable外，从API version 9开始废弃。位置服务子系统仅支持gnss和network两种定位类型，后续不再提供接口查询支持的定位类型。
...
![](./img/note_3.0-zh-cn.png) 除Lite Wearable外，从API version 9开始废弃，建议使用[geoLocationManager.on('locationChange')](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-geolocationmanager#geolocationmanageronlocationchange)替代。
...
![](./img/note_3.0-zh-cn.png) 除Lite Wearable外，从API version 9开始废弃，建议使用[geoLocationManager.off('locationChange')](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-geolocationmanager#geolocationmanagerofflocationchange)替代。
...
![](./img/note_3.0-zh-cn.png) 除Lite Wearable外，从API version 9开始废弃。位置服务子系统仅支持WGS-84坐标系，后续不再提供接口查询支持的坐标系类型。
...
![](./img/note_3.0-zh-cn.png) 除Lite Wearable外，从API version 9开始废弃，建议使用[geoLocationManager.CurrentLocationRequest](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-geolocationmanager#currentlocationrequest)替代。
...
![](./img/note_3.0-zh-cn.png) 除Lite Wearable外，从API version 9开始废弃，建议使用[geoLocationManager.Location](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-geolocationmanager#location)替代。
...
![](./img/note_3.0-zh-cn.png) 除Lite Wearable外，从API version 9开始废弃。
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| types | Array | 否 | 否 | 可选的定位类型['gps', 'network']。 |
