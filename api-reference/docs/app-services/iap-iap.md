...
synced_at: "2026-06-24T20:53:28.091483"
---
...
| --- | --- | --- | --- |
| context | common.[Context](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-inner-application-context) | 是 | 上下文。建议使用[UIAbilityContext](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-inner-application-uiabilitycontext)。 |
| callback | AsyncCallback | 是 | 回调函数。当用户登录的账号服务地在IAP Kit支持结算的国家/地区中时，err为undefined，否则为错误对象。 |
...
| context | common.[UIAbilityContext](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-inner-application-uiabilitycontext) | 是 | [UIAbility](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-app-ability-uiability)上下文。 |
| parameter | [QueryProductsParameter](#queryproductsparameter) | 是 | 包含请求信息的[QueryProductsParameter](#queryproductsparameter)对象。 |
| callback | AsyncCallback> | 是 | 回调函数。当查询成功时，err为undefined，data为获取到的Array；否则为错误对象。 |
...
| --- | --- | --- | --- |
| context | common.[UIAbilityContext](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-inner-application-uiabilitycontext) | 是 | [UIAbility](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-app-ability-uiability)上下文。 |
| productIds | string[] | 是 | 待查询商品ID列表。商品ID必须已经在当前应用中创建且唯一。 商品ID来源于开发者在[AppGallery Connect](https://developer.huawei.com/consumer/cn/service/josp/agc/index.html)中配置商品信息时设置的商品ID，请参见[配置商品信息](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/iap-config-product)。 **说明：** 一次最多可查询200个商品，商品数量较多时建议分批查询。 |
...
| context | common.[UIAbilityContext](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-inner-application-uiabilitycontext) | 是 | [UIAbility](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-app-ability-uiability)上下文。 |
| parameter | [PurchaseParameter](#purchaseparameter) | 是 | 包含请求信息的[PurchaseParameter](#purchaseparameter)对象。 |
| callback | AsyncCallback | 是 | 回调函数。当购买成功时，err为undefined，data为获取到的[PurchaseResult](#purchaseresultdeprecated)对象；否则为错误对象。 |
...
| context | common.[UIAbilityContext](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-inner-application-uiabilitycontext) | 是 | [UIAbility](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-app-ability-uiability)上下文。 |
| parameter | [PurchaseParameter](#purchaseparameter) | 是 | 包含请求信息的[PurchaseParameter](#purchaseparameter)对象。 |
| callback | AsyncCallback | 是 | 回调函数。当购买成功时，err为undefined，data为获取到的[CreatePurchaseResult](#createpurchaseresult)对象；否则为错误对象。 |
...
| context | common.[UIAbilityContext](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-inner-application-uiabilitycontext) | 是 | [UIAbility](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-app-ability-uiability)上下文。 |
| parameter | [ConsumePurchaseParameter](#consumepurchaseparameterdeprecated) | 是 | 包含请求信息的[ConsumePurchaseParameter](#consumepurchaseparameterdeprecated)对象。 |
| callback | AsyncCallback | 是 | 回调函数。当消耗成功时，err为undefined，data为获取到的[ConsumeResult](#consumeresultdeprecated)对象；否则为错误对象。 |
...
| context | common.[UIAbilityContext](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-inner-application-uiabilitycontext) | 是 | [UIAbility](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-app-ability-uiability)上下文。 |
| parameter | [FinishPurchaseParameter](#finishpurchaseparameter) | 是 | 包含请求信息的[FinishPurchaseParameter](#finishpurchaseparameter)对象。 |
| callback | AsyncCallback | 是 | 回调函数。当确认发货成功时，err为undefined，否则为错误对象。 |
...
| context | common.[UIAbilityContext](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-inner-application-uiabilitycontext) | 是 | [UIAbility](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-app-ability-uiability)上下文。 |
| parameter | [QueryPurchasesParameter](#querypurchasesparameter) | 是 | 包含请求信息的[QueryPurchasesParameter](#querypurchasesparameter)对象。 |
| callback | AsyncCallback | 是 | 回调函数。当查询成功时，err为undefined，data为获取到[QueryPurchasesResult](#querypurchasesresultdeprecated)对象；否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回已执行过消耗操作的消耗型商品的购买数据。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回已购商品的订单信息。在沙盒场景下，已发货状态的非消耗型商品订单信息将不返回。 |
...
| context | common.[UIAbilityContext](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-inner-application-uiabilitycontext) | 是 | [UIAbility](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-app-ability-uiability)上下文。 |
| parameter | [QueryPurchasesParameter](#querypurchasesparameter) | 是 | 包含请求信息的[QueryPurchasesParameter](#querypurchasesparameter)对象。 |
| callback | AsyncCallback | 是 | 回调函数。当查询成功时，err为undefined，data为获取到[QueryPurchaseResult](#querypurchaseresult)对象，否则为错误对象。同时，在沙盒场景下，已发货状态的非消耗型商品订单信息将不返回。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象。返回true表示沙盒测试能力生效；返回false表示沙盒测试能力未生效，可根据返回的错误码检查未生效原因。 |
...
| groupLevel | number | 否 | 否 | 商品的[订阅等级](https://developer.huawei.com/consumer/cn/doc/app/non-subscription-0000001958955109#section16510205212316)。 |
