...
| 参数 | 是否必选 | 类型 | 说明 |
| --- | --- | --- | --- |
| verifyResultId | 是 | String | 验证结果ID。[应用端接口](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/payment-realnameservice#startfaceverification)返回的验证结果ID。 |
