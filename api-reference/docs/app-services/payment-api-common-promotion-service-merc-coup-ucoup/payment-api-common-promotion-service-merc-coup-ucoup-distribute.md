...
| coupons | 是 | List | 待发券的批次信息和券码。列表最小长度为1，最大长度为10。 |
| deviceInfo | 否 | [DeviceInfo](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/payment-model#deviceinfo) | 用户的设备信息，风控时使用，提升风控的准确度。 |
...
| succResults | 否 | List | 成功发券的结果信息。 |
| failResults | 否 | List | 失败发券的结果信息。 |
