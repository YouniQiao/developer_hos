---
title: "查询用户优惠券列表"
upstream_id: "harmonyos-references/payment-api-common-promotion-service-merc-coup-ucoup-query"
catalog: "harmonyos-references"
content_hash: "93e79a38e696"
synced_at: "2026-07-09T01:01:35.837043"
---
...
| 参数 | 是否必选 | 类型 | 说明 |
| --- | --- | --- | --- |
| appid | 是 | String | 当前调用接口商户号有绑定关系的[AppID](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/payment-binding-appid-to-merc)。最小长度为1，最大长度为32。 |
| batchNo | 否 | String | 批次号，是否指定批次号查询。最小长度为1，最大长度为40。 |
...
| coupons | 否 | List | 给用户呈现的优惠券信息，返回信息不包含展现信息中的详情信息(富文本)。 |
