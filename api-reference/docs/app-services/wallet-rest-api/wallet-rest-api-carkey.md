...
content_hash: "617b81cd87da"
synced_at: "2026-08-29T18:18:36.479400"
---
...
- **承载协议**：HTTPS POST
- **接口方向**：DK业务管理服务->钱包云服务
- **接口URL**：https://wallet-passentrust-drcn.cloud.huawei.com.cn/hmspass/v2/{cardType}/model cardType取值如下： key_stdcar：汽车钥匙 key_stdbike：两轮车钥匙
...
模板预置成功，即http响应为200时，钱包云服务会将DK业务管理服务请求的数据原样返回，即和请求体中的数据一致；其他错误情况，可见[REST API错误码](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/wallet-rest-api-error-code)。
...
- **承载协议**：HTTPS POST
- **接口方向**：DK业务管理服务->钱包云服务
- **接口URL**：https://wallet-passentrust-drcn.cloud.huawei.com.cn/hmspass/v2/{cardType}/instance cardType取值如下： key_stdcar：汽车钥匙 key_stdbike：两轮车钥匙
- **数据格式**： 请求消息：Content-Type: application/json;charset=UTF-8 响应消息：Content-Type: application/json;charset=UTF-8
...
| token | 是 | String | 认证信息，DK业务管理服务自行生成，没有格式要求，用于开通激活过程中钱包向DK业务管理服务进行“[设备认证](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/wallet-rest-api-public#设备认证)”和“[获取个人化数据Token](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/wallet-rest-api-public#获取个人化数据token)”请求头中携带的Authorization信息。 |
...
- **接口方向**：DK业务管理服务->钱包云服务
- **接口URL**：https://wallet-passentrust-drcn.cloud.huawei.com.cn/hmspass/v2/{cardType}/instance/{instanceId} cardType取值如下： key_stdcar：汽车钥匙 key_stdbike：两轮车钥匙
- **数据格式**： 请求消息：Content-Type: application/json;charset=UTF-8 响应消息：Content-Type: application/json;charset=UTF-8
