...
| targetType | [TargetType](#targettype) | 否 | 否 | 文件类型枚举。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| sourceFileUris | Array | 是 | 待转换文件uri信息列表。列表数量范围：[1,100]，范围越界错误码：401 parameter error。 |

返回值：

| 类型 | 说明 |
| --- | --- |
| Promise> | Promise对象，返回[FileUriResult](#fileuriresult)对象数组。 |
