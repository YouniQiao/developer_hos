...
upstream_id: "harmonyos-references/payment-withhold-query-sys-order"
catalog: "harmonyos-references"
content_hash: "c4573bc480e7"
synced_at: "2026-07-09T01:01:31.484862"
---
...
![](./img/note_3.0-zh-cn.png) resultCode返回“000000”表示查询支付订单成功，不代表支付订单成功，订单状态需根据orderStatus字段判断。
...
| promotionDetail | 否 | List | 营销信息。 **说明：** 当用户支付时参与过营销活动，此字段才会返回。 |
