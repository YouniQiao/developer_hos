...
- **承载协议：** HTTPS POST
- **接口方向：** 开发者服务器 -> IAP服务器
- **接口URL：** {rootUrl}/order/harmony/v1/application/trade/orders/query 说明：rootUrl具体请参见[站点信息](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/iap-rest-common-statement#站点信息)。
...
| orderInfoList | 否 | List | 订单信息列表，其中每个JSONObject表示一个订单信息，订单信息格式参见[OrderInfo](#orderinfo)。 |
