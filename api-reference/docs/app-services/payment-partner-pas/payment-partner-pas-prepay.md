---
title: "预下单"
upstream_id: "harmonyos-references/payment-partner-pas-prepay"
catalog: "harmonyos-references"
content_hash: "fa7ff60a10bf"
synced_at: "2026-07-09T01:01:32.520910"
---
...
- **承载协议：** HTTPS POST
- **接口方向：** 开发者服务器 -> 华为支付服务器
- **接口URL：** https://petalpay-developer.cloud.huawei.com.cn/api/v1/partner/aggr/pay-and-sign/preorder/create/app 说明：元服务预下单接口请使用[https://petalpay-developer.cloud.huawei.com.cn/api/v1/partner/aggr/pay-and-sign/preorder/create/fa](https://petalpay-developer.cloud.huawei.com.cn/api/v1/partner/aggr/pay-and-sign/preorder/create/fa)
...
| 参数 | 是否必选 | 类型 | 说明 |
| --- | --- | --- | --- |
| spAppId | 是 | String | 平台类商户/服务商关联的应用ID（参考[商户号绑定AppID](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/payment-binding-appid-to-merc)）。 |
| spMercNo | 是 | String | 合平台类商户/服务商商户号。最大长度12。 |
| subAppId | 否 | String | 特约商户关联的应用ID（参考[商户号绑定AppID](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/payment-binding-appid-to-merc#服务商邀请特约商户绑定)）。 **说明：** 平台子商户当前不支持绑定AppID，平台类商户请求传递该入参可能导致校验异常。 |
