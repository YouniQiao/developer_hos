...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| adId | string | 否 | 否 | 广告位ID。 说明：[getAdRequestBody](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-advertising#advertisinggetadrequestbody12)接口可以不传该参数。 |
