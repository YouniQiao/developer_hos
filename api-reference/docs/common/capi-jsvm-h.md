...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。 [JSVM_OK](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示执行成功。 [JSVM_BIGINT_EXPECTED](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示传入的参数不是BitInt类型。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用JSVM-API的环境。 |
| [JSVM_Deferred](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-deferred--8h)* deferred | 一个新创建的延迟对象，后续可以传递给OH_JSVM_ResolveDeferred()或OH_JSVM_RejectDeferred()以解析resp。或拒绝相关的Promise。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。 [JSVM_OK](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示执行成功。 [JSVM_BIGINT_EXPECTED](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 如果传入的JavaScript值无法转换成BitInt。 |
