...
content_hash: "6e4d21a3587d"
synced_at: "2026-09-17T18:55:00.715221"
---
...
| **EXTERN_C_START** | 用于告知编译器按C Code编译以下代码段的段起始标识： 当预处理指令__cplusplus检查到C++编译器正在进行编译时：EXTERN_C_START被赋值为"extern "C" {" ，表示其后代码为C代码。当预处理指令__cplusplus检查到不是C++编译器时，无须标记。 |
| **EXTERN_C_END** | 用于告知编译器按C Code编译以下代码段的段终止标识： 当使用预处理指令__cplusplus检查到C++编译器正在编译时：EXTERN_C_START被赋值为"}" ，表示C代码到此为止。当预处理指令__cplusplus检查到不是C++编译器时，无须标记。 |
...
| [JSVM_EXTERN JSVM_Status OH_JSVM_SetNamedProperty(JSVM_Env env,JSVM_Value object,const char* utf8name,JSVM_Value value)](#oh_jsvm_setnamedproperty) | 此方法等效于object调用OH_JSVM_SetProperty设置名为utf8Name的属性。 |
| [JSVM_EXTERN JSVM_Status OH_JSVM_GetNamedProperty(JSVM_Env env,JSVM_Value object,const char* utf8name,JSVM_Value* result)](#oh_jsvm_getnamedproperty) | 此方法等效于object调用OH_JSVM_GetProperty获取名为utf8Name的属性对象。 |
| [JSVM_EXTERN JSVM_Status OH_JSVM_HasNamedProperty(JSVM_Env env,JSVM_Value object,const char* utf8name,bool* result)](#oh_jsvm_hasnamedproperty) | 此方法等效于object对象调用OH_JSVM_HasProperty查询其内部是否存在名为utf8Name的属性。 |
...
| [JSVM_EXTERN JSVM_Status OH_JSVM_IsUndefined(JSVM_Env env,JSVM_Value value,bool* isUndefined)](#oh_jsvm_isundefined) | 此API检查传入的值是否为Undefined。这相当于JS中的value === undefined。 |
| [JSVM_EXTERN JSVM_Status OH_JSVM_IsNull(JSVM_Env env,JSVM_Value value,bool* isNull)](#oh_jsvm_isnull) | 此API检查传入的值是否为Null对象。这相当于JS中的value === null。 |
| [JSVM_EXTERN JSVM_Status OH_JSVM_IsNullOrUndefined(JSVM_Env env,JSVM_Value value,bool* isNullOrUndefined)](#oh_jsvm_isnullorundefined) | 此API检查传入的值是否为Null或Undefined。这相当于JS中的value == null。 |
| [JSVM_EXTERN JSVM_Status OH_JSVM_IsBoolean(JSVM_Env env,JSVM_Value value,bool* isBoolean)](#oh_jsvm_isboolean) | 此API检查传入的值是否为Boolean。这相当于JS中的typeof value === 'boolean'。 |
| [JSVM_EXTERN JSVM_Status OH_JSVM_IsNumber(JSVM_Env env,JSVM_Value value,bool* isNumber)](#oh_jsvm_isnumber) | 此API检查传入的值是否为Number。这相当于JS中的typeof value === 'number'。 |
| [JSVM_EXTERN JSVM_Status OH_JSVM_IsString(JSVM_Env env,JSVM_Value value,bool* isString)](#oh_jsvm_isstring) | 此API检查传入的值是否为String。这相当于JS中的typeof value === 'string'。 |
| [JSVM_EXTERN JSVM_Status OH_JSVM_IsSymbol(JSVM_Env env,JSVM_Value value,bool* isSymbol)](#oh_jsvm_issymbol) | 此API检查传入的值是否为Symbol。这相当于JS中的typeof value === 'symbol'。 |
| [JSVM_EXTERN JSVM_Status OH_JSVM_IsFunction(JSVM_Env env,JSVM_Value value,bool* isFunction)](#oh_jsvm_isfunction) | 此API检查传入的值是否为Function。这相当于JS中的typeof value === 'function'。 |
...
| [JSVM_EXTERN JSVM_Status OH_JSVM_IsBigInt(JSVM_Env env,JSVM_Value value,bool* isBigInt)](#oh_jsvm_isbigint) | 此API检查传入的值是否为BigInt。这相当于JS中的typeof value === 'bigint'。 |
...
| [JSVM_EXTERN JSVM_Status OH_JSVM_CoerceToBigInt(JSVM_Env env,JSVM_Value value,JSVM_Value* result)](#oh_jsvm_coercetobigint) | 实现抽象操作ToBigInt()。 |
...
| 参数项 | 描述 |
| --- | --- |
| const [JSVM_InitOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-initoptions)* options | 用于初始化JavaScript虚拟机的选项。 |

返回：

| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。 [JSVM_OK](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示执行成功。 [JSVM_GENERIC_FAILURE](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示执行失败，说明当前进程已完成JSVM初始化，无需重复执行。 |
...
| 参数项 | 描述 |
| --- | --- |
| const [JSVM_CreateVMOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-createvmoptions)* options | 用于创建虚拟机实例的选项。 |
| [JSVM_VM](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-vm--8h)* result | 新的虚拟机实例。 |

返回：

| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。 [JSVM_OK](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示执行成功。 [JSVM_INVALID_ARG](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示传入的参数不合法。 |
...
| 参数项 | 描述 |
| --- | --- |
| [JSVM_VM](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-vm--8h) vm | 用于设置微任务执行策略的虚拟机实例。 |
| [JSVM_MicrotaskPolicy](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_microtaskpolicy) policy | 执行微任务的策略。 |

返回：

| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 如果接口调用成功，返回 JSVM_OK。 [JSVM_OK](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示执行成功。 [JSVM_INVALID_ARG](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示传入参数不合法。 |
...
| 参数项 | 描述 |
| --- | --- |
| [JSVM_VM](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-vm--8h) vm | 待销毁的虚拟机实例。 |

返回：

| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。 [JSVM_OK](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示执行成功。 [JSVM_INVALID_ARG](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示传入参数不合法。 |
...
| 参数项 | 描述 |
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用 JSVM-API 的环境。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) target | 表示用于创建代理的 JavaScript 对象 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) handler | 表示定义了拦截什么操作及如何处理被拦截操作的 JavaScript 对象。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h)* result | 表示创建的 JavaScript 代理。 |

返回：

| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码。 [JSVM_OK](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示接口调用成功。 [JSVM_INVALID_ARG](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示传入参数不合法。 [JSVM_PENDING_EXCEPTION](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示执行的过程中产生了JS异常。 [JSVM_OBJECT_EXPECTED](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 如果 target 或 handler 非 JS 对象。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用 JSVM-API 的环境。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) value | 需要检查的值。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码。 [JSVM_OK](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示接口调用成功。 [JSVM_INVALID_ARG](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示传入参数不合法。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用 JSVM-API 的环境。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) value | 需要获取目标对象的代理。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h)* result | 代理的目标对象。 |

返回：

| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码。 [JSVM_OK](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示接口调用成功。 [JSVM_INVALID_ARG](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示传入参数不合法。 [JSVM_INVALID_TYPE](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 如果 value 非 JavaScript Proxy。 |
...
| 参数项 | 描述 |
| --- | --- |
| [JSVM_VM](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-vm--8h) vm | 目标虚拟机实例。 |
| [JSVM_VMScope](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-vmscope--8h)* result | 新的虚拟机作用域。 |

返回：

| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。 [JSVM_OK](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示执行成功。 |
...
| --- | --- |
| [JSVM_VM](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-vm--8h) vm | 目标虚拟机实例。 |
| [JSVM_VMScope](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-vmscope--8h) scope | 将要关闭的虚拟机作用域。 |
...
| 参数项 | 描述 |
| --- | --- |
| [JSVM_VM](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-vm--8h) vm | 虚拟机实例，新环境将在该实例中创建。 |
| size_t propertyCount | 属性数组中元素的个数。 |
| const [JSVM_PropertyDescriptor](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-propertydescriptor)* properties | 属性描述符的数组。 |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h)* result | 创建的新环境。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。 [JSVM_OK](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示执行成功。 [JSVM_GENERIC_FAILURE](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示有未知的原因导致执行失败。 |
...
| 参数项 | 描述 |
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 待销毁的环境。 |
...
| 参数项 | 描述 |
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 目标环境，JSVM-API接口将在该环境下调用。 |
| [JSVM_EnvScope](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-envscope--8h)* result | 新的环境作用域。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 目标环境，JSVM-API接口将在该环境下调用。 |
| [JSVM_EnvScope](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-envscope--8h) scope | 将要关闭的环境作用域。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 目标环境，JSVM-API接口将在该环境下调用。 |
| [JSVM_VM](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-vm--8h)* result | 给定环境的虚拟机实例。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 目标环境，JSVM-API接口将在该环境下调用。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) script | 包含要编译的脚本的JavaScript代码。 |
...
| [JSVM_Script](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-script--8h)* result | 编译后的脚本。 |

返回：

| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。 [JSVM_OK](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示执行成功。 [JSVM_INVALID_ARG](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示传入的 data 是空指针。 [JSVM_STRING_EXPECTED](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示传入的参数不是string类型。 [JSVM_GENERIC_FAILURE](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示有未知的原因导致执行失败。 [JSVM_CANNOT_RUN_JS](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 不能执行JS。 [JSVM_PENDING_EXCEPTION](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示执行的过程中产生了JS异常。 |
...
| bool eagerCompile | 是否立即编译脚本，true为是，false为否。 |
| bool* cacheRejected | 代码缓存是否被编译拒绝，true为是，false为否。 |
| [JSVM_ScriptOrigin](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-scriptorigin)* origin | 源代码信息，包括 source map 的位置和源代码文件名等信息。 |
| [JSVM_Script](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-script--8h)* result | 编译后的脚本。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。 [JSVM_OK](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示执行成功。 [JSVM_INVALID_ARG](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示传入的 data 是空指针。 [JSVM_STRING_EXPECTED](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示传入的参数不是string类型。 [JSVM_GENERIC_FAILURE](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示执行失败。 [JSVM_CANNOT_RUN_JS](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 不能执行JS。 [JSVM_PENDING_EXCEPTION](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示执行的过程中产生了JS异常。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。 [JSVM_OK](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示执行成功。 [JSVM_INVALID_ARG](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示传入参数无效。 [JSVM_STRING_EXPECTED](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示传入的参数不是string类型。 [JSVM_GENERIC_FAILURE](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示有未知的原因导致执行失败。 [JSVM_PENDING_EXCEPTION](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示执行的过程中产生了JS异常。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 目标环境，JSVM-API接口将在该环境下调用。 |
| [JSVM_Script](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-script--8h) script | 目标编译脚本。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。 [JSVM_OK](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示执行成功。 [JSVM_GENERIC_FAILURE](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示执行失败。 |
...
| 参数项 | 描述 |
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用JSVM-API的环境。 |
| [JSVM_Script](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-script--8h) script | 包含要执行的脚本的JavaScript字符串。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h)* result | 执行脚本产生的值。 |

返回：

| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。 [JSVM_OK](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示执行成功。 [JSVM_GENERIC_FAILURE](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示执行失败。 [JSVM_PENDING_EXCEPTION](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示执行的过程中产生了JS异常。 |
...
| [JSVM_Finalize](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_finalize) finalizeCb | 销毁环境时调用的函数，该函数接收data以便释放它。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用JSVM-API的环境。 |
| const [JSVM_ExtendedErrorInfo](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-extendederrorinfo)** result | 包含有关错误的更多信息的JSVM_ExtendedErrorInfo结构。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用JSVM-API的环境。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) error | 要抛出的JavaScript值。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用JSVM-API的环境。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) value | 待检查的JSVM_Value。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用JSVM-API的环境。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) code | 可选的JSVM_Value，带有与错误关联的错误代码的字符串。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) msg | 引用JavaScript string用作Error的消息。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h)* result | 表示创建的错误。 |

返回：

| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。 [JSVM_OK](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示执行成功。 [JSVM_STRING_EXPECTED](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示传入的参数不是string类型。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用JSVM-API的环境。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h)* result | 如果出现挂起则返回异常，否则为NULL。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用JSVM-API的环境。 |
| [JSVM_HandleScope](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-handlescope--8h)* result | 代表新作用域。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用JSVM-API的环境。 |
| [JSVM_HandleScope](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-handlescope--8h) scope | 表示要关闭的作用域。 |

返回：

| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。 [JSVM_OK](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示执行成功。 [JSVM_HANDLE_SCOPE_MISMATCH](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示执行失败。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用JSVM-API的环境。 |
| [JSVM_EscapableHandleScope](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-escapablehandlescope--8h)* result | 代表新作用域。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用JSVM-API的环境。 |
| [JSVM_EscapableHandleScope](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-escapablehandlescope--8h) scope | 表示要关闭的作用域。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用JSVM-API的环境。 |
| [JSVM_EscapableHandleScope](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-escapablehandlescope--8h) scope | 表示当前的作用域。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) escapee | 表示要提升的JavaScript Object。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h)* result | 被提升的Object在外部作用域中的句柄。 |

返回：

| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。 [JSVM_OK](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示执行成功。 [JSVM_ESCAPE_CALLED_TWICE](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示scope对象已被关闭。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用JSVM-API的环境。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) value | 正在为其创建引用的JSVM_Value。 |
| uint32_t initialRefcount | 新引用的初始引用计数。 |
| [JSVM_Ref](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-ref--8h)* result | 指向新的引用。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用JSVM-API的环境。 |
| [JSVM_Ref](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-ref--8h) ref | 需删除的JSVM_Ref。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用JSVM-API的环境。 |
| [JSVM_Ref](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-ref--8h) ref | 传入的引用，其引用计数将增加。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用JSVM-API的环境。 |
| [JSVM_Ref](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-ref--8h) ref | 将减少其引用计数的JSVM_Ref。 |
| uint32_t* result | 新的引用计数。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用JSVM-API的环境。 |
| [JSVM_Ref](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-ref--8h) ref | 请求相应值的JSVM_Ref。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h)* result | JSVM_Ref引用的JSVM_Value。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用JSVM-API的环境。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h)* result | 代表JavaScript Array的JSVM_Value。 |
...
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h)* result | 代表JavaScript ArrayBuffer的JSVM_Value。 |

返回：

| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。 [JSVM_OK](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示执行成功。 [JSVM_PENDING_EXCEPTION](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示执行的过程中产生了JS异常。 |
...
| [JSVM_InitializedFlag](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_initializedflag) initialized | BackingStore 内存初始化的方式。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。 [JSVM_OK](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示执行成功。 [JSVM_INVALID_ARG](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示传入的 data 是空指针。 [JSVM_GENERIC_FAILURE](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示内存申请失败。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。 [JSVM_OK](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示执行成功。 [JSVM_INVALID_ARG](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示传入的 data 是空指针。 |
...
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) *result | 接收 array buffer 地址的指针。 |

返回：

| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。 [JSVM_OK](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示执行成功。 [JSVM_INVALID_ARG](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示触发了下面描述的异常情况之一： 1. offset + arrayBufferSize > backingStoreSize。 2. backingStoreSize 或者 arrayBufferSize 为 0。 3. data 或者 result 为空。 |

#### [h2]OH_JSVM_CreateArrayBufferFromExternalMemory()
...
![](./img/caution_3.0-zh-cn.png) 此接口是实验性接口，需定义JSVM_EXPERIMENTAL宏后方可使用。

从外部内存创建ArrayBuffer对象。接口注意事项及使用示例请参考[使用JSVM-API接口从外部内存创建ArrayBuffer](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/use-jsvm-about-external-arraybuffer)。
...
| [JSVM_FinalizeArrayBuffer](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_finalizearraybuffer) finalizeCb | 可选参数。当ArrayBuffer被GC回收时调用的callback。回调签名含bool copied参数，指示是否发生了拷贝。 |
| void* finalizeHint | 可选参数。传递给finalizeCb的自定义提示数据。 |
| bool* copied | 可选输出参数。为true表示数据被拷贝，为false表示零拷贝 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) *result | 输出参数。创建的ArrayBuffer对象。 |

返回：

| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。 [JSVM_OK](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示执行成功。 [JSVM_INVALID_ARG](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示触发了下面描述的异常情况之一： 1. 传入的result参数为NULL。 2. byteLength>0但externalData为NULL。 3. externalData未8字节对齐。 4. byteLength超过引擎最大限制。 5. byteLength==0但finalizeCb不为NULL。 |
...
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h)* result | 表示JavaScript Date对象的JSVM_Value。 |
...
| [JSVM_Finalize](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_finalize) finalizeCb | 收集外部值时调用的可选回调。JSVM_Finalize提供了更多详细信息。 |
| void* finalizeHint | 在收集期间传递给最终回调的可选提示。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h)* result | 表示外部值的JSVM_Value。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用JSVM-API的环境。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h)* result | 表示JavaScript对象的JSVM_Value。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用JSVM-API的环境。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) description | 可选的JSVM_Value，它指的是要设置为符号描述的JavaScript string。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h)* result | 代表JavaScript symbol的JSVM_Value。 |
...
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h)* result | 表示JavaScript 符号的JSVM_Value。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用JSVM-API的环境。 |
| [JSVM_TypedarrayType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_typedarraytype) type | TypedArray中元素的标量数据类型。 |
| size_t length | TypedArray中的元素个数。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) arraybuffer | ArrayBuffer是类型化数组的基础。 |
| size_t byteOffset | ArrayBuffer中开始投影TypedArray的字节偏移量。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h)* result | 表示JavaScript TypedArray的JSVM_Value。 |

返回：

| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。 [JSVM_OK](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示执行成功。 [JSVM_INVALID_ARG](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示传入的参数不合法。 [JSVM_PENDING_EXCEPTION](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示执行的过程中产生了JS异常。 |
...
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) arraybuffer | 位于DataView底层的ArrayBuffer。 |
| size_t byteOffset | ArrayBuffer中的字节偏移量，指示投影DataView的开始位置。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h)* result | 表示JavaScript DataView对象的JSVM_Value。 |
...
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h)* result | 表示JavaScript number类型的JSVM_Value。 |
...
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h)* result | 代表JavaScript number类型的JSVM_Value。 |
...
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h)* result | 表示JavaScript BigInt类型的JSVM_Value。 |
...
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h)* result | 代表JavaScript BigInt类型的JSVM_Value。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。 [JSVM_OK](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示执行成功。 [JSVM_INVALID_ARG](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示传入的参数不合法。 [JSVM_GENERIC_FAILURE](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示有未知的原因导致执行失败。 |
...
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h)* result | 表示JavaScript字符串的JSVM_Value。 |
...
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h)* result | 代表JavaScript string的JSVM_Value。 |
...
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h)* result | 代表JavaScript字符串的JSVM_Value。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用JSVM-API的环境。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) value | 代表查询长度的JavaScript Array。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。 [JSVM_OK](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示执行成功。 [JSVM_ARRAY_EXPECTED](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示传入的参数不是Array类型。 [JSVM_PENDING_EXCEPTION](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示执行的过程中产生了JS异常。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用JSVM-API的环境。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) arraybuffer | 代表被查询的ArrayBuffer。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用JSVM-API的环境。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) object | 表示待返回其原型的JavaScript object。这将返回Object.getPrototypeOf的等价值（与函数的prototype属性不同）。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h)* result | 表示给定对象的原型。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用JSVM-API的环境。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) typedarray | 表示要查询其属性的TypedArray。 |
| [JSVM_TypedarrayType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_typedarraytype)* type | TypedArray中元素的标量数据类型。 |
...
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h)* arraybuffer | 位于TypedArray下的ArrayBuffer。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用JSVM-API的环境。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) dataview | 表示要查询其属性的DataView。 |
| size_t* bytelength | DataView中的字节个数。 |
| void** data | DataView下的数据缓冲区。如果bytelength是0则可能是NULL或任何其他指针值。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h)* arraybuffer | ArrayBuffer是DataView的基础。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。 [JSVM_OK](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示执行成功。 [JSVM_INVALID_ARG](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示传入参数非外部的JSVM_Value。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用JSVM-API的环境。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) value | 代表一个JavaScript Date。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。 [JSVM_OK](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示执行成功。 [JSVM_DATE_EXPECTED](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示传入参数不是Date类型。 [JSVM_PENDING_EXCEPTION](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示执行的过程中产生了JS异常。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用JSVM-API的环境。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) value | 代表输入的JavaScript Boolean对象。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。 [JSVM_OK](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示执行成功。 [JSVM_BOOLEAN_EXPECTED](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示传入的参数不是boolean类型。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用JSVM-API的环境。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) value | 代表JavaScript number。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。 [JSVM_OK](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示执行成功。 [JSVM_NUMBER_EXPECTED](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示传入的参数不是number类型。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用JSVM-API的环境。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) value | 代表JavaScript BigInt。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。 [JSVM_OK](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示执行成功。 [JSVM_BIGINT_EXPECTED](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示传入的参数不是BigInt类型。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用JSVM-API的环境。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) value | 代表JavaScript外部值。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用JSVM-API的环境。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) value | 代表JavaScript字符串。 |
...
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h)* result | 表示待检索的JavaScript Boolean单例。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用JSVM-API的环境。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h)* result | 代表JavaScript global对象。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用JSVM-API的环境。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h)* result | 代表JavaScript null对象。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用JSVM-API的环境。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h)* result | 代表JavaScript undefined值。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用JSVM-API的环境。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) value | 要强制转换的JavaScript值。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h)* result | 代表强制的JavaScript Boolean。 |
...
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用JSVM-API的环境。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) value | 要强制转换的JavaScript值。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h)* result | 代表强制的JavaScript number。 |

返回：

| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。 [JSVM_OK](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示执行成功。 [JSVM_NUMBER_EXPECTED](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 如果传入的JavaScript值无法转换成Number。 |
...
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用JSVM-API的环境。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) value | 要强制转换的JavaScript值。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h)* result | 代表强制的JavaScript object。 |

返回：

| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。 [JSVM_OK](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示执行成功。 [JSVM_OBJECT_EXPECTED](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 如果传入的JavaScript值无法转换成Object。 |
...
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用JSVM-API的环境。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) value | 要强制转换的JavaScript值。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h)* result | 代表强制的JavaScript string。 |

返回：

| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。 [JSVM_OK](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示执行成功。 [JSVM_STRING_EXPECTED](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 如果传入的JavaScript值无法转换成String。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用JSVM-API的环境。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) value | 要查询其类型的JavaScript值。 |
| [JSVM_ValueType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_valuetype)* result | JavaScript值的类型。 |
...
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) constructor | 要检查的构造函数的JavaScript函数对象。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。 [JSVM_OK](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示执行成功。 [JSVM_FUNCTION_EXPECTED](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示传入的参数不是Function类型。 [JSVM_GENERIC_FAILURE](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示有未知的原因导致执行失败。 [JSVM_PENDING_EXCEPTION](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示执行的过程中产生了JS异常。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用JSVM-API的环境。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) value | 待检查的JavaScript值。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用JSVM-API的环境。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) lhs | 待检查的JavaScript值。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) rhs | 要检查的JavaScript值。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用JSVM-API的环境。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) arraybuffer | 待分离的JavaScript ArrayBuffer。 |

返回：

| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。 如果[JSVM_OK](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示执行成功。 [JSVM_DETACHABLE_ARRAYBUFFER_EXPECTED](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示传入的参数不是可分离的ArrayBuffer。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用JSVM-API的环境。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) value | 待检查的JavaScript ArrayBuffer。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用JSVM-API的环境。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) object | 待进行属性检索的对象。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h)* result | 表示一个JavaScript值的数组，这些值表示对象的属性名称。可以使用OH_JSVM_GetArrayLength以及OH_JSVM_GetElement对结果进行迭代。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用JSVM-API的环境。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) object | 从中检索属性的对象。 |
| [JSVM_KeyCollectionMode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_keycollectionmode) keyMode | 是否也检索原型属性。 |
| [JSVM_KeyFilter](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_keyfilter) keyFilter | 要检索哪些属性（可枚举/可读/可写）。 |
| [JSVM_KeyConversion](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_keyconversion) keyConversion | 表示是否将编号的属性键转换为字符串。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h)* result | 表示JavaScript值的数组，这些值表示对象的属性名称。可以使用OH_JSVM_GetArrayLength和OH_JSVM_GetElement对结果进行迭代。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用JSVM-API的环境。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) object | 将进行属性设置的对象。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) key | 待设置的属性名。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) value | 属性值。 |
...
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用JSVM-API的环境。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) object | 从中检索属性的对象。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) key | 要检索的属性的名称。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h)* result | 属性值。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用JSVM-API的环境。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) object | 待查询的对象。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) key | 要检查其存在的属性的名称。 |
...
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用JSVM-API的环境。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) object | 待查询的对象。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) key | 待删除的属性名。 |
...
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用JSVM-API的环境。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) object | 待查询的对象。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) key | 要检查的是否存在的属性名称。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。 [JSVM_OK](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示执行成功。 [JSVM_GENERIC_FAILURE](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示有未知的原因导致执行失败。 [JSVM_NAME_EXPECTED](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示期望传入名字不合法。 [JSVM_PENDING_EXCEPTION](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示执行的过程中产生了JS异常。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用JSVM-API的环境。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) object | 要对其设置属性的对象。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用JSVM-API的环境。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) object | 待进行属性设置的对象。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。 [JSVM_OK](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示执行成功。 [JSVM_INVALID_ARG](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示传入的参数不合法。 [JSVM_GENERIC_FAILURE](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示有未知的原因导致执行失败。 [JSVM_PENDING_EXCEPTION](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示执行的过程中产生了JS异常。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用JSVM-API的环境。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) object | 待冻结的对象。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用JSVM-API的环境。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) object | 待封装的对象。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用JSVM-API的环境。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) recv | 传递给被调用函数的this值。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) func | 表示将调用的JavaScript函数。 |
| size_t argc | argv数组中的元素个数。 |
| const [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h)* argv | JSVM_values数组，表示将作为参数传递给函数的JavaScript值。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h)* result | 表示返回的JavaScript对象。 |

返回：

| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。 [JSVM_OK](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示执行成功。 [JSVM_PENDING_EXCEPTION](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示执行的过程中产生了JS异常。 [JSVM_GENERIC_FAILURE](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示有未知的原因导致执行失败。 |
...
| [JSVM_Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-callbackstruct) cb | 调用此函数对象时应调用的native函数。详情请参考[JSVM_Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-callbackstruct)。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h)* result | 表示新创建函数的JavaScript函数对象。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用JSVM-API的环境。 |
| [JSVM_CallbackInfo](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-callbackinfo--8h) cbinfo | 传入回调函数的回调信息。 |
| size_t* argc | 指定所提供的argv数组的长度并接收参数的实际数量，可以通过传递NULL来选择性地忽略。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h)* argv | JSVM_Value的C数组，用于存储复制的参数。如果参数数量超过提供的数量，则只复制请求数量的参数。如果提供的参数比声明的少，则argv的其余部分将由代表undefined的JSVM_Value值填充。可以通过传递NULL来忽略argv。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h)* thisArg | 接收调用的JavaScript this参数。thisArg可以通过传递NULL来进行忽略。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用JSVM-API的环境。 |
| [JSVM_CallbackInfo](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-callbackinfo--8h) cbinfo | 传递给回调函数的回调信息。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h)* result | 构造函数调用的new target。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用JSVM-API的环境。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) constructor | 表示将作为构造函数调用的JavaScript函数。 |
| size_t argc | argv数组中的元素个数。 |
| const [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h)* argv | JavaScript值数组。其中JSVM_Value表示构造函数的参数。如果argc为零，则可以通过传入NULL来忽略此参数。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h)* result | 表示返回的JavaScript对象，在本例中是构造的对象。 |
...
| size_t length | utf8name的长度（以字节为单位）或JSVM_AUTO_LENGTH（如果以 null 结尾）。 |
| [JSVM_Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-callbackstruct) constructor | 用于创建类的构造函数的回调函数。包装C++类时，此方法必须是符合JSVM_Callback。callback签名的静态成员。不能使用C++类构造函数。详情请参考[JSVM_Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-callbackstruct)。 |
| size_t propertyCount | properties数组参数中的项数。 |
| const [JSVM_PropertyDescriptor](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-propertydescriptor)* properties | 类的属性描述符，用于定义类的属性和方法。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h)* result | 表示类的构造函数的JSVM_Value。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用JSVM-API的环境。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) jsObject | 将成为原生对象封装器的JavaScript对象。 |
| void* nativeObject | 将封装在JavaScript对象中的native实例。 |
| [JSVM_Finalize](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_finalize) finalizeCb | 可选的原生回调，可用于在 JavaScript 对象被垃圾回收时释放native实例。 |
| void* finalizeHint | 传递给完成回调的可选上下文提示。 |
| [JSVM_Ref](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-ref--8h)* result | 对封装对象的可选引用。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用JSVM-API的环境。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) jsObject | 与native实例关联的对象。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用JSVM-API的环境。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) value | 要标记的JavaScript对象或外部值。 |
| const [JSVM_TypeTag](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-typetag)* typeTag | 要标记对象的标签。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用JSVM-API的环境。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) value | 待检查类型标记的JavaScript对象或外部值。 |
| const [JSVM_TypeTag](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-typetag)* typeTag | 用于比较在对象上找到的任何标签的标签。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用JSVM-API的环境。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) jsObject | 关联native数据的JavaScript对象。 |
| void* finalizeData | 要传递给finalizeCb的可选数据。 |
| [JSVM_Finalize](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_finalize) finalizeCb | 当JavaScript对象被垃圾回收时，将用于释放native数据的原生回调。JSVM_Finalize提供了更多详细信息。 |
| void* finalizeHint | 传递给finalize回调的可选上下文提示。 |
| [JSVM_Ref](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-ref--8h)* result | 可选的对JavaScript对象的引用。 |
...
| 参数项 | 描述 |
| --- | --- |
| [JSVM_VMInfo](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-vminfo)* result | 虚拟机的信息。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用JSVM-API的环境。 |
| [JSVM_MemoryPressureLevel](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_memorypressurelevel) level | 要为当前虚拟机设置的内存压力等级。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用JSVM-API的环境。 |
| [JSVM_Deferred](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-deferred--8h)* deferred | 一个新创建的延迟对象，后续可以传递给OH_JSVM_ResolveDeferred()或OH_JSVM_RejectDeferred()以解析或拒绝相关的Promise。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h)* promise | 与延迟对象关联的JavaScript Promise。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用JSVM-API的环境。 |
| [JSVM_Deferred](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-deferred--8h) deferred | 要解析其关联promise的延迟对象。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) resolution | 用来解决Promise的值。 |
...
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用JSVM-API的环境。 |
| [JSVM_Deferred](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-deferred--8h) deferred | 要解析其关联promise的延迟对象。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) rejection | 用来拒绝Promise的值。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用JSVM-API的环境。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) value | 待检查的值。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用 JSVM-API 的环境。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) promise | 需要注册回调的 promise。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) onFulfilled | 该函数在 promise 兑现后调用。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) onRejected | 该函数在 promise 拒绝后调用。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h)* result | 输出参数，返回 promise 调用 then/catch 接口后生成的新的 promise。 |

返回：

| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码。 [JSVM_OK](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示执行成功。 [JSVM_INVALID_ARG](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 如果 env 或 promise 为空，或 onFulfilled 和 onRejected 同时为空。 [JSVM_INVALID_TYPE](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 如果 promise 非 JS 的 Promise 类型，或 onFulfilled、onRejected 非 JS 的 Function 类型。 [JSVM_PENDING_EXCEPTION](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 如果存在 JS 异常待处理。 [JSVM_GENERIC_FAILURE](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 如果 API 执行错误。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用JSVM-API的环境。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) jsonString | 待解析的字符串。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h)* result | 成功解析的值。 |

返回：

| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。 [JSVM_OK](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示执行成功。 [JSVM_STRING_EXPECTED](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示传入的参数不是string类型。 [JSVM_GENERIC_FAILURE](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示有未知的原因导致执行失败。 [JSVM_PENDING_EXCEPTION](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示执行的过程中产生了JS异常。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用JSVM-API的环境。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) jsonObject | 待字符串化的对象。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h)* result | 成功转换后返回的字符串。 |
...
| 参数项 | 描述 |
| --- | --- |
| [JSVM_VM](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-vm--8h) vm | 目标环境，API接口将在该环境下调用。 |
| size_t contextCount | 上下文个数。 |
| const [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h)* contexts | 要添加到快照的上下文数组。 |
...
| 参数项 | 描述 |
| --- | --- |
| [JSVM_VM](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-vm--8h) vm | 返回堆统计信息的虚拟机。 |
| [JSVM_HeapStatistics](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-heapstatistics)* result | 堆统计数据。 |
...
| 参数项 | 描述 |
| --- | --- |
| [JSVM_VM](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-vm--8h) vm | 启动CPU profiler的虚拟机。 |
| [JSVM_CpuProfiler](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-cpuprofiler--8h)* result | 指向CPU profiler的指针。 |
...
| --- | --- |
| [JSVM_VM](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-vm--8h) vm | 启动CPU profiler的虚拟机。 |
| [JSVM_CpuProfiler](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-cpuprofiler--8h) profiler | 要停止的CPU profiler。 |
| [JSVM_OutputStream](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_outputstream) stream | 接收数据的输出流回调。 |
...
| 参数项 | 描述 |
| --- | --- |
| [JSVM_VM](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-vm--8h) vm | 将被获取堆快照的虚拟机。 |
| [JSVM_OutputStream](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_outputstream) stream | 接收数据的输出流回调。 |
| void* streamData | 传递给输出流回调的可选数据。例如，可以是一个文件流，用来将输出流回调中传递的采样数据写入文件。 |
...
#### [h2]OH_JSVM_TakeRawHeapSnapshot()
...
| --- | --- |
| [JSVM_VM](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-vm--8h) vm | 将被获取堆快照的虚拟机。 |
| [JSVM_OutputStream](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_outputstream) stream | 接收二进制数据的输出流回调。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。 如果vm或stream为NULL，返回JSVM_INVALID_ARG。 其他情况返回JSVM_OK。 |

#### [h2]OH_JSVM_SetHeapThresholdCallback()
...
| 参数项 | 描述 |
| --- | --- |
| [JSVM_VM](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-vm--8h) vm | 将被监控堆内存使用量的虚拟机。 |
| uint64_t threshold | 堆内存使用量阈值（字节）。该值必须大于0且不超过heapSizeLimit，其中heapSizeLimit是JSVM_HeapStatistics中的一个字段。 |
| [JSVM_HandlerForHeapThreshold](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_handlerforheapthreshold) callback | 当阈值检查观察到堆使用量大于或等于阈值时将被调用的回调函数。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。 如果函数执行成功，返回JSVM_OK。 如果vm或callback为NULL，或threshold为零或超过heapSizeLimit， 或虚拟机已注册了堆内存阈值回调，返回JSVM_INVALID_ARG。 |

#### [h2]OH_JSVM_ClearHeapThresholdCallback()
...
| 参数项 | 描述 |
| --- | --- |
| [JSVM_VM](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-vm--8h) vm | 将被清除堆内存阈值回调的虚拟机。 |
| uint64_t threshold | 先前注册的堆内存使用量阈值（字节）。 |
| [JSVM_HandlerForHeapThreshold](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_handlerforheapthreshold) callback | 先前由OH_JSVM_SetHeapThresholdCallback注册的回调函数。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。 如果函数执行成功，返回JSVM_OK。 如果vm或callback为NULL，或(threshold, callback, data) 与注册的回调不匹配，返回JSVM_INVALID_ARG。 |
...
| size_t length | utf8name的长度（以字节为单位）或JSVM_AUTO_LENGTH（如果以 null 结尾）。 |
| [JSVM_Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-callbackstruct) constructor | 用于创建类的构造函数的回调函数。此方法必须是JSVM_Callback类型。constructor中callback回调需为静态成员。不能使用C++类构造函数。详情请参考[JSVM_Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-callbackstruct)。 |
| size_t propertyCount | properties数组参数中的项数。 |
| const [JSVM_PropertyDescriptor](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-propertydescriptor)* properties | 描述静态数据和实例数据的属性描述符数组类上的属性、访问器和方法请参考JSVM_PropertyDescriptor。 |
| [JSVM_PropertyHandlerCfg](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-propertyhandlerconfigurationstruct8h) propertyHandlerCfg | 访问实例对象属性触发相应的回调函数。 |
| [JSVM_Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-callbackstruct) callAsFunctionCallback | 将实例对象作为函数调用将触发此回调。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h)* result | 表示JavaScript类的构造函数的JSVM_Value。 |
...
| 参数项 | 描述 |
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用该API的环境。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码JSVM_Status。 [JSVM_OK](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status)表示执行成功。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。 [JSVM_OK](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示执行成功，这个API不会触发任何异常。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用JSVM-API的环境。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h)* result | 代表JavaScript Map的JSVM_Value。 |

返回：

| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码JSVM_Status。 [JSVM_OK](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示执行成功。 [JSVM_INVALID_ARG](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示输入参数不合法。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。 [JSVM_OK](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示执行成功。 [JSVM_INVALID_ARG](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示输入参数不合法。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用JSVM-API的环境。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) value | 要转换为正则表达式的JavaScript字符串。 |
| [JSVM_RegExpFlags](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_regexpflags) flags | 正则表达式标志位。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h)* result | 代表JavaScript RegExp的JSVM_Value。 |

返回：

| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。 [JSVM_OK](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示执行成功。 [JSVM_INVALID_ARG](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示输入参数不合法。 [JSVM_STRING_EXPECTED](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示传入的参数不是string类型。 [JSVM_GENERIC_FAILURE](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示有未知的原因导致执行失败。 [JSVM_PENDING_EXCEPTION](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示API在运行时抛出异常。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用JSVM-API的环境。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) object | 表示待返回其原型的JavaScript object。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h)* result | 表示给定对象的原型。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。 [JSVM_OK](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示执行成功。 [JSVM_INVALID_ARG](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示输入参数不合法。 [JSVM_PENDING_EXCEPTION](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示API在运行时抛出异常。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用JSVM-API的环境。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) object | 表示需要设置原型的JavaScript object。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) prototype | 对象原型。 |

返回：

| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。 [JSVM_OK](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示执行成功。 [JSVM_INVALID_ARG](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示输入参数不合法。 [JSVM_GENERIC_FAILURE](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示设置原型失败。如循环设置原型时，会触发该失败。 [JSVM_PENDING_EXCEPTION](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示API在运行时抛出异常。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用JSVM-API的环境。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h)* result | 表示已经创建的JavaScript Set对象。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用JSVM-API的环境。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) value | 待检查的对象。 |
...
| 参数项 | 描述 |
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用该JSVM-API的环境。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) value | 要进行强制转换的JavaScript值。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h)* result | 表示成功转换成BigInt后的JavaScript值。 |

返回：

| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。 [JSVM_OK](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示执行成功。 [JSVM_INVALID_ARG](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示输入参数不合法。 [JSVM_BIGINT_EXPECTED](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 如果传入的JavaScript值无法转换成BigInt。 |
...
| size_t argc | argv数组中的元素个数。 |
| const [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h)* argv | JSVM_values数组，表示将作为参数传递给函数的JavaScript值。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) script | 包含作为函数体的JavaScript字符串。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h)* result | 表示新创建函数的JavaScript函数对象的JSVM_Value。 |

返回：

| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。 [JSVM_OK](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示执行成功。 [JSVM_INVALID_ARG](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示输入参数不合法。 [JSVM_GENERIC_FAILURE](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示输入的JavaScript无法编译成功。 |
...
| 参数项 | 描述 |
| --- | --- |
| [JSVM_VM](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-vm--8h) vm | 启动任务队列的虚拟机实例。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回JSVM函数结果代码。 [JSVM_OK](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示执行成功。 |
...
| 参数项 | 描述 |
| --- | --- |
| [JSVM_VM](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-vm--8h) vm | 要检查微任务的虚拟机实例。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用该API的环境。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) value | 要检查的JavaScript值。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用该API的环境。 |
| [JSVM_Script](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-script--8h) script | 包含要持久化保存脚本的JavaScript字符串。 |

返回：

| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。 [JSVM_OK](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示执行成功。 [JSVM_INVALID_ARG](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示脚本为空或已被保存过。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用该API的环境。 |
| [JSVM_Script](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-script--8h) script | 包含要释放的脚本的JavaScript字符串。 |

返回：

| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。 [JSVM_OK](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示执行成功。 [JSVM_INVALID_ARG](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示脚本为空或未被保存过。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。 [JSVM_OK](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示执行成功。 [JSVM_PENDING_EXCEPTION](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示发生了异常。 |
...
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) *wasmModule | 输出参数，表示生成的 WebAssembly 模块。 |

返回：

| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。 [JSVM_OK](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示执行成功。 [JSVM_INVALID_ARG](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示 env 或 wasmBytecode 参数为空，或传入的数据长度参数无效。 [JSVM_GENERIC_FAILURE](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示编译失败。 [JSVM_PENDING_EXCEPTION](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示发生了异常。 [JSVM_JIT_MODE_EXPECTED](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示无JIT权限。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用 JSVM-API 的环境。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) wasmModule | 待编译函数所在的 WebAssembly 模块。 |
| uint32_t functionIndex | 待编译函数的索引，索引必须位于合法范围。 |
| [JSVM_WasmOptLevel](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_wasmoptlevel) optLevel | 优化等级，当前只支持高优化等级。 |

返回：

| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。 [JSVM_OK](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示执行成功。 [JSVM_INVALID_ARG](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示 env 或 wasmModule 参数为空，或 wasmModule 不是一个真正的 WebAssembly 模块。 [JSVM_GENERIC_FAILURE](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示函数索引越界，或编译失败。 [JSVM_PENDING_EXCEPTION](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示发生了异常。 [JSVM_JIT_MODE_EXPECTED](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示无JIT权限。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用 JSVM-API 的环境。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) value | 待检查的 JavaScript 值。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。 [JSVM_OK](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示执行成功。 [JSVM_INVALID_ARG](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示传入了空指针参数。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用 JSVM-API 的环境。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) wasmModule | 编译好的 WebAssembly 模块。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。 [JSVM_OK](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示执行成功。 [JSVM_INVALID_ARG](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示传入了空指针参数。 [JSVM_GENERIC_FAILURE](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示缓存生成失败。 [JSVM_JIT_MODE_EXPECTED](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示无JIT权限。 |
...
| [JSVM_CacheType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_cachetype) cacheType | 缓存的类型，缓存的生成和释放必须一一对应。 |

返回：

| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。 [JSVM_OK](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示执行成功。 [JSVM_INVALID_ARG](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示传入了空指针参数，或 cacheType 参数不合法。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用 JSVM-API 的环境。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h)* result | 输出参数，Well-Known symbol里的Symbol.AsyncIterator。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用 JSVM-API 的环境。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h)* result | 输出参数，Well-Known symbol里的Symbol.HasInstance。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用 JSVM-API 的环境。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h)* result | 输出参数，Well-Known symbol里的Symbol.IsConcatSpreadable。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用 JSVM-API 的环境。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h)* result | 输出参数，Well-Known symbol里的Symbol.Match。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用 JSVM-API 的环境。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h)* result | 输出参数，Well-Known symbol里的Symbol.Replace。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用 JSVM-API 的环境。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h)* result | 输出参数，Well-Known symbol里的Symbol.Search。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用 JSVM-API 的环境。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h)* result | 输出参数，Well-Known symbol里的Symbol.Split。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用 JSVM-API 的环境。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h)* result | 输出参数，Well-Known symbol里的Symbol.ToPrimitive。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用 JSVM-API 的环境。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h)* result | 输出参数，Well-Known symbol里的Symbol.Unscopables。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用 JSVM-API 的环境。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h)* result | 输出参数，Well-Known symbol里的Symbol.ToStringTag。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用 JSVM-API 的环境。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h)* result | 输出参数，Well-Known symbol里的Symbol.Iterator。 |
...
| const [JSVM_TraceCategory](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_tracecategory)* categories | 进行 Trace 采集的具体分类数组。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。 [JSVM_OK](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示执行成功。 [JSVM_INVALID_ARG](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) categories 或者 count 输入不合法。 |
...
| 参数项 | 描述 |
| --- | --- |
| [JSVM_OutputStream](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_outputstream) stream | 输出流回调函数，实现接收 Trace 数据功能。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。 [JSVM_OK](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示执行成功。 [JSVM_INVALID_ARG](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) stream 或者 streamData 为空。 |
...
| 参数项 | 描述 |
| --- | --- |
| [JSVM_VM](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-vm--8h) vm | 调用JSVM-API的环境。 |
| [JSVM_CBTriggerTimeForGC](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_cbtriggertimeforgc) triggerTime | 触发GC回调函数的时机。 |
| [JSVM_HandlerForGC](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_handlerforgc) handler | 当触发GC时，传入的回调函数会被调用。 |
| [JSVM_GCType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_gctype) gcType | GC类型。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。 [JSVM_OK](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示函数执行成功。 [JSVM_INVALID_ARG](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示传入的vm或者handler为空或者handler已经被添加过了。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。 [JSVM_OK](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示函数执行成功。 [JSVM_INVALID_ARG](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示传入的vm或者handler为空或者handler已经被删除过了或者 这个handler从来没有被添加过。 |
...
| --- | --- |
| [JSVM_VM](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-vm--8h) vm | 调用JSVM-API的环境。 |
| [JSVM_HandlerForOOMError](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_handlerforoomerror) handler | OOM错误的处理器。 |

返回：

| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。 [JSVM_OK](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示函数执行成功。 [JSVM_INVALID_ARG](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示vm为空。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用JSVM-API的环境。 |
| [JSVM_DebugOption](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_debugoption) debugOption | 需要更改的调试选项。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。 [JSVM_OK](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示函数执行成功。 [JSVM_INVALID_ARG](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 如果传入的env为空指针，返回此错误码。 |
...
| --- | --- |
| [JSVM_VM](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-vm--8h) vm | 调用JSVM-API的环境。 |
| [JSVM_HandlerForFatalError](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_handlerforfatalerror) handler | Fatal错误的处理器。 |
...
| --- | --- |
| [JSVM_VM](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-vm--8h) vm | 调用JSVM-API的环境。 |
| [JSVM_HandlerForPromiseReject](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_handlerforpromisereject) handler | PromiseReject错误的处理器。 |
...
| const char* utf8name | JavaScript构造函数的名称，建议在包装C++类时使用C++类名。 |
| size_t length | utf8name的长度（以字节为单位）或JSVM_AUTO_LENGTH（如果以 null 结尾）。 |
| [JSVM_Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-callbackstruct) constructor | 用于创建类的构造函数的回调函数。包装C++类时，此方法必须是符合JSVM_Callback签名的静态成员。不能使用C++类构造函数。详情请参考[JSVM_Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-callbackstruct)。 |
| size_t propertyCount | properties数组参数中的项目数量。 |
| const [JSVM_PropertyDescriptor](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-propertydescriptor)* properties | 类的属性描述符，用于定义类的属性和方法。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) parentClass | 当前所定义的class的父类class。 |
| size_t option_count | options数组参数中的项目数量。 |
| [JSVM_DefineClassOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-defineclassoptions) options[] | 传入的用于定义class的选项数组。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h)* result | 表示类的构造函数的JSVM_Value。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。 [JSVM_OK](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示执行成功。 [JSVM_INVALID_ARG](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示传入的指针参数里面存在空指针。 [JSVM_GENERIC_FAILURE](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示传入的utf8name | constructor | properties无效，导致执行失败。 |
...
| [JSVM_Finalize](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_finalize) finalizeCallback | 可选项，是当创建的字符串被 GC 回收时会触发的回调函数。更多细节详见 JSVM_Finalize 类型说明。 |
| void* finalizeHint | 可选项，当字符串被回收时会传递给触发的 finalize callback。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h)* result | 接收创建完成的 JavaScript 外部字符串，表示为 JSVM_Value 类型。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。 [JSVM_OK](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示执行成功。 [JSVM_INVALID_ARG](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示传入参数中 env, str 和 copied 中任一值为空。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用 JSVM-API 的环境。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) description | 可选项，它指的是要作为 private key 描述的 JavaScript 字符串。 |
| [JSVM_Data](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-data--8h)* result | 接收创建成功的 JavaScript private key 对象的指针。 |

返回：

| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。 [JSVM_OK](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示执行成功。 [JSVM_INVALID_ARG](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示传入参数中 env 和 result 中任一值为空。 [JSVM_STRING_EXPECTED](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示传入的 description 不是字符串。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用 JSVM-API 的环境。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) object | 将要进行 private 属性设置的对象。 |
| [JSVM_Data](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-data--8h) key | private 属性的 private key 对象。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) value | private 属性值。 |

返回：

| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。 [JSVM_OK](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示执行成功。 [JSVM_INVALID_ARG](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示任一传入参数为空或者 key 不是一个 private key 对象。 [JSVM_OBJECT_EXPECTED](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示传入的 object 不是一个真正的 JavaScript object。 [JSVM_GENERIC_FAILURE](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示设置 private 属性失败，同时没有异常产生。 [JSVM_PENDING_EXCEPTION](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示发生了异常。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用 JSVM-API 的环境。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) object | 获取 private 属性的对象。 |
| [JSVM_Data](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-data--8h) key | private 属性的 private key 对象。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) *result | private 属性值。 |

返回：

| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。 [JSVM_OK](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示执行成功。 [JSVM_INVALID_ARG](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示任一传入参数为空或者 key 不是一个 private key 对象。 [JSVM_OBJECT_EXPECTED](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示传入的 object 不是一个真正的 JavaScript object。 [JSVM_GENERIC_FAILURE](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示获取 private 属性失败，同时没有异常产生。 [JSVM_PENDING_EXCEPTION](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示发生了异常。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用 JSVM-API 的环境。 |
| [JSVM_Value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h) object | 删除 private 属性的对象。 |
| [JSVM_Data](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-data--8h) key | private 属性的 private key 对象。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。 [JSVM_OK](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示执行成功。 [JSVM_INVALID_ARG](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示任一传入参数为空或者 key 不是一个 private key 对象。 [JSVM_OBJECT_EXPECTED](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示传入的 object 不是一个真正的 JavaScript object。 [JSVM_GENERIC_FAILURE](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示删除 private 属性失败，同时没有异常产生。 [JSVM_PENDING_EXCEPTION](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示发生了异常。 |
...
| --- | --- |
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用 JSVM-API 的环境。 |
| [JSVM_Data](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-data--8h) data | 将要创建引用的 JSVM_Data 对象。 |
| uint32_t initialRefcount | 初始引用计数值。 |
| [JSVM_Ref](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-ref--8h)* result | 接收新创建的对象引用，表示为 JSVM_Ref 类型。 |

返回：

| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。 [JSVM_OK](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示执行成功。 [JSVM_INVALID_ARG](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) 表示任一传入参数为空或者 key 不是一个 private key 对象。 |
...
| [JSVM_Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-env--8h) env | 调用JSVM-API的环境。 |
| [JSVM_Ref](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-ref--8h) ref | 请求相应值的JSVM_Ref。 |
| [JSVM_Data](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-data--8h)* result | JSVM_Ref 引用的 JSVM_Data。 |
...
#### [h2]OH_JSVM_BackgroundDeserialize()
...
| --- | --- |
| [JSVM_VM](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-vm--8h) vm | 调用JSVM-API的环境。 |
| [JSVM_CodeCache](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-codecache) cacheData | 需要进行反序列化的字节码缓存数据。 |
| [JSVM_DeserializeResult](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-deserializeresult)* result | 后台反序列化结果。 |
...
#### [h2]OH_JSVM_ReleaseDeserializeResult()
...
| 参数项 | 描述 |
| --- | --- |
| [JSVM_DeserializeResult](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-deserializeresult) result | 需要进行释放的后台反序列化结果。 |
