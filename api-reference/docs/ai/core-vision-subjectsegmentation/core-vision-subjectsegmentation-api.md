...
synced_at: "2026-06-24T20:53:56.651710"
---
...
| subjectDetails | Array | 否 | 是 | 每个主体的详细信息列表，按主体面积降序排列，长度受maxCount限制。当enableSubjectDetails为true时返回，否则不返回，使用前需进行非空判断。 |
