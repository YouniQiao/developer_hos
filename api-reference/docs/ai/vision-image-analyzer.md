...
| action | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback) | 否 | 否 | 菜单结果回调，包含文字选中结果和抠图结果。 |
...
| boundingBox | [Rect](#rect) | 否 | 否 | 主体识别图片结果的外接矩形框。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| visibility | [ImageAnalyzerVisibility](#imageanalyzervisibility) | 是 | AI识图控件的可见性。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| position | [Rect](#rect) | 是 | AIButton区域距离AI识图控件四边的位置（vp）。默认展示在右下角 。 当传入部分参数时，优先按照传入的参数匹配，如果位置参数异常，使用默认位置展示。 同时设置top及bottom参数，调setAIButtonPosition接口仅top参数生效。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| menus | [Menu](#menu)[] | 是 | 选中文字时，支持在文字菜单上增加自定义菜单项，回调中包含当前选中的文字结果。 最多只展示三个，超过三个时取前三个。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| menus | [Menu](#menu)[] | 是 | 选中主体时，支持在主体菜单上增加自定义菜单项，回调中包含当前选中的主体结果。 最多只展示三个，超过部分取前三个。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| subjectIds | number[] | 是 | 要选中的主体id列表。通过[getSubject](#getsubject)获取，只有图片识别结果中包含的主体id才有效。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，point点位所在的主体。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| subjectIds | number[] | 是 | 主体id列表。通过[getSubject](#getsubject)获取。 |

返回值：

| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，对应id列表组装成的图片。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回是否开启视觉搜索。true表示开启视觉搜索，false表示关闭视觉搜索。在文字选择或主体识别状态时拉起会返回false。 **说明：** 视觉搜索若在[Swiper](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper)容器切换图场景下无法生效，则需要在图片切换的[onAnimationStart](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#onanimationstart9)中置空一下当前选中图片的index，再由[onAnimationEnd](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#onanimationend9)时将当前选中index置成当前index，以此实现overlay跟随图片变动而变动。 |
...
| callback | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback) | 是 | 回调函数。返回AIButton展示状态。 |
...
| callback | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback) | 否 | 回调函数，返回AIButton展示状态。需与订阅时传入的回调函数是同一个。若无此参数，则取消注册所有的回调函数。 |
...
| callback | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback) | 是 | 回调函数。返回AI识图控件可见状态。 |
...
| callback | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback) | 否 | 回调函数。返回AI识图控件可见状态。需与订阅时传入的回调函数是同一个。若无此参数，则取消注册所有的回调函数。 |
...
| callback | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback) | 是 | 回调函数。返回文字分析结果。 |
...
| callback | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback) | 否 | 回调函数。返回文字分析结果。需与订阅时传入的回调函数是同一个。若无此参数，则取消注册所有的回调函数。 |
...
| callback | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback) | 是 | 回调函数。返回文字选中结果。 |
...
| callback | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback) | 否 | 回调函数。返回文字选中结果。需与订阅时传入的回调函数是同一个。若无此参数，则取消注册所有的回调函数。 |
...
| callback | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback) | 是 | 回调函数。返回主体分析结果对象数组。 |
...
| callback | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback) | 否 | 回调函数。返回主体分析结果对象数组。需与订阅时传入的回调函数是同一个。若无此参数，则取消注册所有的回调函数。 |
...
| callback | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback) | 是 | 回调函数。返回选中的主体信息对象数组。 |
...
| callback | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback) | 否 | 回调函数。返回选中的主体信息对象数组。需与订阅时传入的回调函数是同一个。若无此参数，则取消注册所有的回调函数。 |
...
| callback | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback) | 是 | 回调函数。返回图片搜索事件信息。 |
...
| callback | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback) | 否 | 回调函数。返回图片搜索事件信息。需与订阅时传入的回调函数是同一个。若无此参数，则取消注册所有的回调函数。 |
...
| callback | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback) | 是 | 回调函数。返回为空，表示光标移入图片内文字区域。 |
...
| callback | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback) | 否 | 回调函数。返回为空，表示光标移入图片内文字区域。需与订阅时传入的回调函数是同一个。若无此参数，则取消注册所有的回调函数。 |
...
| callback | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback) | 是 | 回调函数。返回为空。表示光标移出图片内文字区域事件。 |
...
| callback | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback) | 否 | 回调函数。返回为空。需与订阅时传入的回调函数是同一个。若无此参数，则取消注册所有的回调函数。 |
