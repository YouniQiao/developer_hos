---
title: "@ohos.bundle.pluginBundleManager (pluginBundleManager模块)"
upstream_id: "harmonyos-references/js-apis-pluginbundlemanager"
catalog: "harmonyos-references"
content_hash: "73219bb5c6e4"
synced_at: "2026-07-28T16:40:37.059984"
---
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| pluginFilePaths | Array | 是 | 插件文件路径数组，表示要安装的插件文件的路径列表。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise> | Promise对象，返回当前应用已安装的所有本地插件信息列表。 |
...
| 类型 | 说明 |
| --- | --- |
| [_PluginBundleInfo](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-bundlemanager-pluginbundleinfo#pluginbundleinfo-1) | 插件信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [_PluginModuleInfo](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-bundlemanager-pluginbundleinfo#pluginmoduleinfo) | 插件的模块信息。 |
