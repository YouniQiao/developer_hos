...
content_hash: "9ca6b74d976c"
synced_at: "2026-07-28T16:50:10.924360"
---
...
| 参数项 | 描述 |
| --- | --- |
| [OHIPCParcel](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-ohipcparcel) *parcel | parcel需要销毁OHIPCParcel对象的指针，不能为空。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OHIPCParcel](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-ohipcparcel) *parcel | parcel OHIPCParcel对象的指针，不能为空。必须先通过[OH_IPCParcel_Create()](#oh_ipcparcel_create)创建。 |
...
| --- | --- |
| [OHIPCParcel](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-ohipcparcel) *parcel | parcel OHIPCParcel对象的指针，不能为空。 |
| const [OHIPCRemoteStub](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-ohipcparcel-ohipcremotestub) *stub | stub需要写入的OHIPCRemoteStub对象指针，不能为空。 |
...
| --- | --- |
| [OHIPCParcel](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-ohipcparcel) *parcel | parcel OHIPCParcel对象的指针，不能为空。 |
| const [OHIPCRemoteProxy](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-ohipcparcel-ohipcremoteproxy) *proxy | proxy需要写入的OHIPCRemoteProxy对象指针，不能为空。 |
