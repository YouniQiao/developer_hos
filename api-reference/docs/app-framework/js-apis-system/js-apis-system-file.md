...
![](./img/note_3.0-zh-cn.png) 除Lite Wearable外，从API version 10开始废弃，请使用[fileIo.moveFile](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fileiomovefile)替代。
...
![](./img/note_3.0-zh-cn.png) 除Lite Wearable外，从API version 10开始废弃，请使用[fileIo.copyFile](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fileiocopyfile)替代。
...
![](./img/note_3.0-zh-cn.png) 除Lite Wearable外，从API version 10开始废弃，请使用[fileIo.listFile](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fileiolistfile)替代。
...
![](./img/note_3.0-zh-cn.png) 除Lite Wearable外，从API version 10开始废弃，请使用[fileIo.stat](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fileiostat)替代。
...
![](./img/note_3.0-zh-cn.png) 除Lite Wearable外，从API version 10开始废弃，请使用[fileIo.unlink](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fileiounlink)替代。
...
![](./img/note_3.0-zh-cn.png) 除Lite Wearable外，从API version 10开始废弃，请使用[fileIo.write](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fileiowrite)替代。
...
![](./img/note_3.0-zh-cn.png) 除Lite Wearable外，从API version 10开始废弃，请使用[fileIo.readText](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fileioreadtext)替代。
...
![](./img/note_3.0-zh-cn.png) 除Lite Wearable外，从API version 10开始废弃，请使用[fileIo.read](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fileioread)替代。
...
![](./img/note_3.0-zh-cn.png) 除Lite Wearable外，从API version 10开始废弃，请使用[fileIo.access](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fileioaccess)替代。
...
![](./img/note_3.0-zh-cn.png) 除Lite Wearable外，从API version 10开始废弃，请使用[fileIo.mkdir](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fileiomkdir)替代。
...
![](./img/note_3.0-zh-cn.png) 除Lite Wearable外，从API version 10开始废弃，请使用[fileIo.rmdir](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fileiormdir)替代。
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| fileList | Array | 否 | 否 | 获取的文件列表，其中每个文件的信息的格式为： { uri:'file1', lastModifiedTime:1589965924479, length:10240, type: 'file' } |
