...
content_hash: "3db15ac17e22"
synced_at: "2026-08-29T18:12:03.080846"
---
...
| isSplitScreenMode | boolean | 否 | 否 | 应用是否处于分屏模式。 true: 应用处于分屏模式。 false: 应用不处于分屏模式。 |
| isFloatingWindowMode | boolean | 否 | 否 | 应用是否处于悬浮窗模式。 true: 应用处于悬浮窗模式。 false: 应用不处于悬浮窗模式。 |
