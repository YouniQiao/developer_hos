...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | Array | 是 | RelativeContainer容器内的辅助线。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | Array | 是 | RelativeContainer容器内的屏障。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| barrierStyle | Array | 是 | RelativeContainer容器内的屏障。 |
...
| referencedId | Array | 否 | 否 | 指定生成barrier所依赖的组件。 |
