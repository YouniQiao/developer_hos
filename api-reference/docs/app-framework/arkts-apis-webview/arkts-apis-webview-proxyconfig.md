...
content_hash: "fac576ab97ae"
synced_at: "2026-08-29T18:15:57.438502"
---
...
- [https://example.com](https://example.com) scheme: https host: example.com
- example.com:8888 host: example.com port: 8888
- [https://example.com:8888](https://example.com:8888) scheme: https host: example.com port: 8888
...
| 类型 | 说明 |
| --- | --- |
| Array | 代理规则，每个ProxyRule对象表示一条已配置的代理规则。 |
