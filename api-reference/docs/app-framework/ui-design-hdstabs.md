...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Optional](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-custom-property#optionalt) | 是 | 分割线样式，默认跟手渐变。 mode：分割线模式，可以设置为常隐，常显和跟手渐变显隐（当内容区超过页签栏）。 style：分割线的样式。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| barFloatingStyle | [Optional](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-custom-property#optionalt) | 否 | 设置页签为悬浮样式。 |
...
![](./img/note_3.0-zh-cn.png) 迷你栏和页签栏处于左右布局场景时：
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| event | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-types#callback12) | 是 | 底部页签切换时触发该事件，获取切换后的页签下标。 |
