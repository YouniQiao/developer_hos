...
content_hash: "7ffd2fe8cd0b"
synced_at: "2026-07-09T17:23:04.811785"
---
...
| ABILITY_RUNTIME_AREA_MODE_EL2 = 1 | 用户级加密区，设备开机，首次输入密码后才能够访问的数据区。 对于需要用户解锁后才能安全使用的个人敏感数据，应用可以将这些文件放到用户级加密区（EL2）中，以保证在用户输入密码前就可以被访问。 |
