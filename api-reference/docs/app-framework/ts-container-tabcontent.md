...
synced_at: "2026-06-24T20:48:03.281772"
---
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [SubTabBarStyle](#subtabbarstyle9) | [BottomTabBarStyle](#bottomtabbarstyle9) | 是 | TabBar上显示内容。 SubTabBarStyle： 子页签样式。 BottomTabBarStyle： 底部页签和侧边页签样式。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [SelectedMode](#selectedmode10枚举说明) | 是 | 选中子页签的显示方式。 默认值：SelectedMode.INDICATOR |
...
```
 ![](./img/zh-cn_image_0000002626230368.gif)
...
```
 ![](./img/zh-cn_image_0000002626070458.gif)
...
```
 ![](./img/zh-cn_image_0000002656469735.jpeg)
...
```
 ![](./img/zh-cn_image_0000002656349783.gif)
...
```
 ![](./img/zh-cn_image_0000002626230370.png)
...
```
 ![](./img/zh-cn_image_0000002626070460.gif)
...
```
 ![](./img/zh-cn_image_0000002656469737.gif)
...
```
 ![](./img/zh-cn_image_0000002656349785.gif)
...
```
 ![](./img/zh-cn_image_0000002626230372.gif)
...
```
 ![](./img/zh-cn_image_0000002626070462.gif)
...
```
 ![](./img/zh-cn_image_0000002656469739.png)
