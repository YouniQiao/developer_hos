...
content_hash: "bb08bc1f367a"
synced_at: "2026-08-29T18:16:01.658702"
---
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| sslErrorEvent | [SslErrorEvent](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-basic-components-web-i#sslerrorevent12) | 是 | 用户加载资源时发生SSL错误时传递的详细信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| nativeEmbedVisibilityInfo | [NativeEmbedVisibilityInfo](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-basic-components-web-i#nativeembedvisibilityinfo12) | 是 | 提供同层标签可见性变化的信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| state | [AISessionResultType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-basic-components-web-e#aisessionresulttype) | 是 | AI会话创建或执行的状态结果。 |
...
完整示例代码参考[onInputmethodAttached](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-basic-components-web-events#oninputmethodattached)。
