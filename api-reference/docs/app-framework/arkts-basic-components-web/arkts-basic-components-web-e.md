...
![](./img/note_3.0-zh-cn.png) 从API version 9开始支持，从API version 21开始废弃。建议使用[WebHitTestType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-webview-e#webhittesttype)替代。
