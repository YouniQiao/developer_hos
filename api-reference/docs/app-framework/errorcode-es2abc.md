...
content_hash: "1f7824bb7da1"
synced_at: "2026-08-03T17:09:34.363745"
---

# es2abc编译器错误码

![](./img/note_3.0-zh-cn.png) 本节列出 es2abc（ECMAScript to Ark Bytecode）编译器模块的专有错误码说明。通用错误码请参考[通用错误码说明文档](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/errorcode-universal)。
