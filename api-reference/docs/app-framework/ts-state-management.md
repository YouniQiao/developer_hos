...
| 类型 | 说明 |
| --- | --- |
| [AbstractProperty](#abstractpropertyt12) | AbstractProperty的实例，为AppStorage中propName对应属性的引用。 |
...
| 类型 | 说明 |
| --- | --- |
| IterableIterator | AppStorage中所有的属性名。 |
...
![](./img/note_3.0-zh-cn.png) 从API version 7开始支持，从API version 10开始废弃，建议使用[link](#link10)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7开始支持，从API version 10开始废弃，建议使用[setAndLink](#setandlink10)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7开始支持，从API version 10开始废弃，建议使用[has](#has10)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7开始支持，从API version 10开始废弃，建议使用[get](#get10)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7开始支持，从API version 10开始废弃，建议使用[keys](#keys10)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 9开始支持，从API version 10开始废弃，建议使用[clear](#clear10)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7开始支持，从API version 10开始废弃，建议使用[size](#size10)替代。
...
| 类型 | 说明 |
| --- | --- |
| [AbstractProperty](#abstractpropertyt12) | AbstractProperty的实例，为LocalStorage中propName对应属性的引用。 |
...
| 类型 | 说明 |
| --- | --- |
| IterableIterator | LocalStorage中所有的属性名。 |
...
![](./img/note_3.0-zh-cn.png) 从API version 7开始支持，从API version 10开始废弃，建议使用[keys](#keys10-1)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7开始支持，从API version 10开始废弃，建议使用[keys](#keys10-2)替代。
