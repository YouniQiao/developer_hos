...
content_hash: "0bf9d1d1947e"
synced_at: "2026-08-29T18:16:07.852444"
---
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回当前应用的存储空间大小（单位为Byte）。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback | 是 | 回调函数，获取当前应用的存储空间大小之后的回调。 回调参数包括： err：错误信息，调用成功时为undefined。 bundleStats：当前应用的存储空间统计信息。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回内置存储的总空间大小（单位为Byte）。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback | 是 | 回调函数，获取内置存储的总空间大小之后的回调。 回调参数包括： err：错误信息，调用成功时为undefined。 number：内置存储的总空间大小，单位为Byte。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回内置存储的可用空间大小（单位为Byte）。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback | 是 | 回调函数，获取内置存储的可用空间大小之后的回调。 回调参数包括： err：错误信息，调用成功时为undefined。 number：内置存储的可用空间大小，单位为Byte。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回文件系统inode资源总量。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回文件系统inode资源剩余量。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回当前应用的inode占用量。 |
