...
content_hash: "17fd0527d412"
synced_at: "2026-07-28T16:43:25.316161"
---
...
- 当ArcListItem配合[LazyForEach](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-rendering-control-lazyforeach)使用时，其子组件在ArcListItem创建时创建；配合[if/else](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-rendering-control-ifelse)或[ForEach](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-rendering-control-foreach)使用时，或直接作为[ArcList](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-arclist)组件的子组件使用时，其子组件在ArcListItem布局时创建。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| enable | [Optional](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-custom-property#optionalt) | 是 | ArcListItem是否支持自动缩放显示，true表示支持，false表示不支持。 默认值：true，支持自动缩放显示。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [Optional](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-custom-property#optionalt) | 是 | ArcListItem划出操作的配置选项，具体配置请参考SwipeActionOptions对象说明。未设置时，不配置划出操作。 |
...
```
 ![](./img/zh-cn_image_0000002656008410.png)
