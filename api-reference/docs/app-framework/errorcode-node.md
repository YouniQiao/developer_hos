...
content_hash: "5fb69aace3b1"
synced_at: "2026-07-28T16:49:49.668556"
---
...
避免对不支持设置跨ArkTS语言访问选项的FrameNode节点调用[setCrossLanguageOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-arkui-framenode#setcrosslanguageoptions15)接口调整跨语言访问权限。可参考setCrossLanguageOptions接口说明，确认目标节点类型是否支持设置跨ArkTS语言访问选项。
...
开发者在当前接口调用前，使用该实例对象调用了[dispose](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-arkui-framenode#dispose12)接口，例如：item.dispose()。
...
BuilderNode中，[状态管理V2](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-state-management-overview#状态管理v2)暂不支持[reuse](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-arkui-buildernode#reuse12)。
...
2. 确认节点是由多线程[createNode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-nativenodeapi-1#createnode)接口创建的。
3. 参考[多线程NDK接口调用规范](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ndk-build-on-multi-thread#多线程ndk接口调用规范)，将组件所在组件树中所有不可转换的Attached组件移除。
