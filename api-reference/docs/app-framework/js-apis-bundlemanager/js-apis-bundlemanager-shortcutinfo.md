---
title: "ShortcutInfo"
upstream_id: "harmonyos-references/js-apis-bundlemanager-shortcutinfo"
catalog: "harmonyos-references"
content_hash: "0df89744a1f6"
synced_at: "2026-07-09T00:57:10.964612"
---
...
![](./img/note_3.0-zh-cn.png) 本模块首批接口从API version 20 开始支持。后续版本的新增接口，采用上角标单独标记接口的起始版本。
...
| parameters | Array | 否 | 是 | 拉起快捷方式时的自定义数据，仅支持配置字符串类型的数据。其中键值均最大支持1024长度的字符串。 |
...
| wants | Array | 否 | 是 | 快捷方式内定义的目标wants信息集合。 |
