...
| description | string | 是 | 是 | 技能的描述信息。当应用调用[skillManager](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-skillmanager)接口，传入的[SkillInfoFlag](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-skillmanager#skillinfoflag)不包含GET_SKILL_INFO_WITH_DESCRIPTION时，该字段将返回默认值为undefined，开发者使用时需要进行有效值判断以防代码异常。 |
