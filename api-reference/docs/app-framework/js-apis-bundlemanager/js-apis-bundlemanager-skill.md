---
title: "Skill"
upstream_id: "harmonyos-references/js-apis-bundlemanager-skill"
catalog: "harmonyos-references"
content_hash: "a79550af8c6d"
synced_at: "2026-07-09T00:57:10.437976"
---
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| actions | Array | 是 | 否 | Skill接收的[Action集合](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-ability-wantconstant#action)。 |
| entities | Array | 是 | 否 | Skill接收的[Entity集合](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-ability-wantconstant#entity)。 |
| uris | Array | 是 | 否 | Want匹配的Uri集合。 |
