...
upstream_id: "harmonyos-references/ts-container-lazycolumnlayout"
catalog: "harmonyos-references"
content_hash: "0ae2270151c0"
synced_at: "2026-07-28T16:43:38.518032"
---
...
![](./img/note_3.0-zh-cn.png) 由于浮点数计算精度，设置sticky后，在滚动过程中小概率产生缝隙，可以通过[pixelRound](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-pixelroundforcomponent#pixelround)指定当前组件向下像素取整解决该问题。
...
![](./img/note_3.0-zh-cn.png) 当父组件设置主轴方向尺寸且懒加载功能生效时，LazyColumnLayout按照父组件可视区域进行懒加载。此时onVisibleIndexesChange回调中start返回当前可视区域起始位置子组件的索引值，end返回当前可视区域结束位置子组件的索引值。
...
```
 ![](./img/zh-cn_image_0000002686087955.png)
...
```
 ![](./img/zh-cn_image_0000002685928127.gif)
