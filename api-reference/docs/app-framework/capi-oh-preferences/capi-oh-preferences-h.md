...
synced_at: "2026-06-24T20:47:05.689356"
---
...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [OH_Preferences](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-preferences-oh-preferences) | OH_Preferences | 定义Preferences对象类型。 |
...
| [OH_Preferences *OH_Preferences_Open(OH_PreferencesOption *option, int *errCode)](#oh_preferences_open) | - | 打开一个Preferences实例对象并创建指向它的指针。 当不再需要使用指针时，请使用[OH_Preferences_Close](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-oh-preferences-h#oh_preferences_close)关闭实例对象。 |
...
| [int OH_Preferences_SetValue(OH_Preferences *preference, const char *key, OH_PreferencesValue *value)](#oh_preferences_setvalue) | - | 在Preferences对象中设置值[OH_PreferencesValue](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-preferences-oh-preferencesvalue)。 |
...
| [int OH_Preferences_Flush(OH_Preferences *preference)](#oh_preferences_flush) | - | 将[OH_Preferences](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-preferences-oh-preferences)对象的缓存保存到xml文件中。 |
| [int OH_Preferences_ClearCache(OH_Preferences *preference)](#oh_preferences_clearcache) | - | 清除[OH_Preferences](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-preferences-oh-preferences)对象缓存中的所有值。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH_PreferencesOption](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-preferences-oh-preferencesoption) *option | 指向Preferences配置选项[OH_PreferencesOption](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-preferences-oh-preferencesoption)的指针。 |
| int *errCode | 该参数作为出参使用，表示指向返回错误码的指针，详见[OH_Preferences_ErrCode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-oh-preferences-err-code-h#oh_preferences_errcode)。 若错误码为PREFERENCES_OK，表示操作成功。 若错误码为PREFERENCES_ERROR_INVALID_PARAM，表示参数不合法。 若错误码为PREFERENCES_ERROR_NOT_SUPPORTED，表示系统能力不支持。 若错误码为PREFERENCES_ERROR_DELETE_FILE，表示删除文件失败。 若错误码为PREFERENCES_ERROR_STORAGE，表示存储异常。 若错误码为PREFERENCES_ERROR_MALLOC，表示内存分配失败。 |

返回：

| 类型 | 说明 |
| --- | --- |
| [OH_Preferences](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-preferences-oh-preferences) | 当操作成功时，返回指向打开的Preferences对象[OH_Preferences](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-preferences-oh-preferences)实例对象的指针，失败返回空指针。 |

#### [h2]OH_Preferences_Close()
...
| 参数项 | 描述 |
| --- | --- |
| [OH_Preferences](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-preferences-oh-preferences) *preference | 指向需要关闭的Preferences[OH_Preferences](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-preferences-oh-preferences)实例对象的指针。 |

返回：

| 类型 | 说明 |
| --- | --- |
| int | 返回执行的错误码，详见[OH_Preferences_ErrCode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-oh-preferences-err-code-h#oh_preferences_errcode)。 若错误码为PREFERENCES_OK，表示操作成功。 若错误码为PREFERENCES_ERROR_INVALID_PARAM，表示参数不合法。 若错误码为PREFERENCES_ERROR_STORAGE，表示存储异常。 若错误码为PREFERENCES_ERROR_MALLOC，表示内存分配失败。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH_Preferences](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-preferences-oh-preferences) *preference | 指向目标[OH_Preferences](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-preferences-oh-preferences)实例对象的指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| [Preferences_StorageType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-oh-preferences-option-h#preferences_storagetype) type | 要校验是否支持的存储模式。 |
...
| 类型 | 说明 |
| --- | --- |
| int | 返回接口操作执行的状态码。 返回结果为PREFERENCES_OK，表示操作成功。 返回结果为PREFERENCES_ERROR_INVALID_PARAM，表示参数不合法。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH_Preferences](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-preferences-oh-preferences) *preference | 指向目标[OH_Preferences](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-preferences-oh-preferences)实例的指针。 |
| const char *key | 指向需要设置的Key的指针。 |
| [OH_PreferencesValue](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-preferences-oh-preferencesvalue) *value | 指向需要设置的[OH_PreferencesValue](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-preferences-oh-preferencesvalue)值的指针。 |
...
| [OH_PreferencesValue](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-preferences-oh-preferencesvalue) **value | 指向获取到的[OH_PreferencesValue](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-preferences-oh-preferencesvalue)值的二级指针。 |
...
| --- | --- |
| [OH_Preferences](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-preferences-oh-preferences) *preference | 指向目标[OH_Preferences](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-preferences-oh-preferences)实例的指针。 |
| [OH_PreferencesPair](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-preferences-oh-preferencespair) **pairs | 指向要获取的KV数据的指针。当不再需要此KV数据时，用户需要调用[OH_Preferences_FreeString](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-oh-preferences-h#oh_preferences_freestring)释放内存。 |
...
| 类型 | 说明 |
| --- | --- |
| int | 返回执行的错误码。 若错误码为PREFERENCES_OK，表示操作成功。 若错误码为PREFERENCES_ERROR_INVALID_PARAM，表示参数不合法。 若错误码为PREFERENCES_ERROR_NOT_SUPPORTED，表示系统能力不支持。 |
...
| [OH_PreferencesDataObserver](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-oh-preferences-h#oh_preferencesdataobserver) observer | 要注册的[OH_PreferencesDataObserver](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-oh-preferences-h#oh_preferencesdataobserver)回调函数。 |
...
| [OH_Preferences](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-preferences-oh-preferences) *preference | 指向目标[OH_Preferences](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-preferences-oh-preferences)实例的指针。 |
| void *context | 指向数据观察者上下文的指针。 |
| [OH_PreferencesDataObserver](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-oh-preferences-h#oh_preferencesdataobserver) observer | 要取消注册的[OH_PreferencesDataObserver](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-oh-preferences-h#oh_preferencesdataobserver)回调函数。 |
