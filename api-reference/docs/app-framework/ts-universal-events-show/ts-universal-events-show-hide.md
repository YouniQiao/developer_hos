...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-types#callback12) | 是 | onAttach事件的回调函数，表示组件已经挂载至组件树。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-types#callback12) | 是 | onDetach事件的回调函数，表示组件已经从组件树卸载。 |
...
![](./img/note_3.0-zh-cn.png) 回调的调用时机有可能发生在组件布局渲染后。
