...
content_hash: "50e6f0219778"
synced_at: "2026-08-03T17:09:34.052256"
---

# 编译工具链错误码

![](./img/note_3.0-zh-cn.png) 编译工具链错误码用于标识ArkTS编译过程中的各类错误，涵盖文件导入限制、模块解析、Kit配置与导入、编译执行及懒加载导入等场景，帮助开发者快速定位并解决编译相关问题。
...
2. 有关Kit API的更多详细信息，请参考[开发说明](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/development-intro-api)。
...
请移除导入语句，或将文件扩展名更改为.ets。例如，将文件example.ts重命名为example.ets。
...
1. 请确保Kit的API与SDK一致。
2. 请确保Kit的API没有被本地修改。
3. 有关Kit API的更多详细信息，请参考[开发说明](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/development-intro-api)。
...
请参考[es2abc编译器错误码](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/errorcode-es2abc)进行处理。
