...
| 类型 | 说明 |
| --- | --- |
| import('../api/@ohos.arkui.node').[Content](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-arkui-content) | 定义ComponentContent和NodeContent的基类。 |
