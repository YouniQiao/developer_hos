...
content_hash: "84af19640681"
synced_at: "2026-07-09T00:58:01.144615"
---
...
![](./img/note_3.0-zh-cn.png) SVG图片最终显示效果受Image组件的'objectFit'参数值影响，为了确保SVG图形完整且正确的显示，文档中用例图片都配置了'objectFit(ImageFit.Contain)'，开发者需要根据实际显示效果正确配置[objectFit](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ohos-multimedia-movingphotoview#objectfit)参数。
...
| 提升前 | 提升后 |
| --- | --- |
| 系统会把8位的十六进制颜色当#ARGB格式解析并显示。 例如fill="#ff000030"的矩形显示效果。 ![](./img/zh-cn_image_0000002631253538.png) | 系统会把8位的十六进制颜色当#RGBA格式解析并显示。 例如fill="#ff000030"的矩形显示效果。 ![](./img/zh-cn_image_0000002661612721.png) |
...
| 提升前 | 提升后 |
| --- | --- |
| 系统会把7位的十六进制颜色当#ARGB格式解析并显示。 例如fill="#BB88990"的矩形显示效果。 ![](./img/zh-cn_image_0000002631413432.png) | 系统会把7位十六进制颜色解析成默认黑色并显示。 例如fill="#BB88990"的矩形显示效果。 ![](./img/zh-cn_image_0000002661732661.png) |
...
| 提升前 | 提升后 |
| --- | --- |
| 系统会把4位的十六进制颜色当#ARGB格式解析并显示。 例如fill="#8888"的矩形显示效果。 ![](./img/zh-cn_image_0000002631253540.png) | 系统会把4位的十六进制颜色当#RGBA解析并显示。 例如fill="#0000"的矩形显示效果（全透明）。 ![](./img/zh-cn_image_0000002661612723.png) |

#### [h2]引用国际化资源标识（IRI）类型严格校验

严格校验filter滤镜/clip-path裁剪路径/mask遮罩引用的URL类型，避免引用类型不匹配。

![](./img/note_3.0-zh-cn.png) SVG图片最终显示效果受Image组件的'objectFit'参数值影响，为了确保SVG图形完整且正确的显示，文档中用例图片都配置了'objectFit(ImageFit.Contain)'，开发者需要根据实际显示效果正确配置objectFit参数。
...
| 原始图源 | 提升前 | 提升后 |
| --- | --- | --- |
| ![](./img/zh-cn_image_0000002631413434.png) | Image组件的colorFilter属性只对图源的stroke边框起作用。 ![](./img/zh-cn_image_0000002661732663.png) | Image组件的colorFilter属性对整个SVG图源起作用。 ![](./img/zh-cn_image_0000002631253542.png) |
...
| 提升前 | 提升后 |
| --- | --- |
| Image组件的fillColor属性只对SVG图源中fill='none'的元素仍然填充颜色。 ![](./img/zh-cn_image_0000002661612725.png) | Image组件的fillColor属性对SVG图源中fill='none'的元素不填充颜色。 ![](./img/zh-cn_image_0000002631413436.png) |
...
![](./img/note_3.0-zh-cn.png) SVG图片最终显示效果受Image组件的'[objectFit](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-image#objectfit)'参数值影响，为了确保SVG图形完整且正确的显示，文档中用例图片都配置了'objectFit(ImageFit.Contain)'，开发者需要根据实际显示效果正确配置objectFit参数。
...
| transform属性设置rotate旋转功能，同时配置transform-origin属性。 全局中心点值为图形元素右下角，如:'transform="rotate(30)" transform-origin="150 150"'。 | ![](./img/zh-cn_image_0000002661732665.png) | ![](./img/zh-cn_image_0000002631253544.png) |
| transform属性设置scale缩放功能，同时配置transform-origin属性。 全局中心点值为图形元素右下角，如:'transform="scale(0.77)" transform-origin="150 150"'。 | ![](./img/zh-cn_image_0000002661612727.png) | ![](./img/zh-cn_image_0000002631413438.png) |
| transform属性设置skewX按x轴倾斜的功能，同时配置transform-origin属性。 全局中心点值为图形元素右下角，如:'transform="skewX(30)" transform-origin="150 150"'。 | ![](./img/zh-cn_image_0000002661732667.png) | ![](./img/zh-cn_image_0000002631253546.png) |
| transform属性设置skewY按y轴倾斜的功能，同时配置transform-origin属性。 全局中心点值为图形元素右下角，如:'transform="skewY(30)" transform-origin="150 150"'。 | ![](./img/zh-cn_image_0000002661612729.png) | ![](./img/zh-cn_image_0000002631413440.png) |
| transform属性设置translate平移功能，同时配置transform-origin属性。 全局中心点值为图形元素右下角，如:'transform="translate(30,30)" transform-origin="150 150"'。 | ![](./img/zh-cn_image_0000002661732669.png) | ![](./img/zh-cn_image_0000002631253548.png) |
| transform属性链式调用多个功能，同时配置transform-origin属性。 全局中心点值为图形元素右下角，如:transform='"translate(10,10) rotate(10) scale(0.5) skewX(10)" transform-origin="150 150"'。 | ![](./img/zh-cn_image_0000002661612731.png) | ![](./img/zh-cn_image_0000002631413442.png) |
...
| SVG场景 | 扩展前 | 扩展后 |
| --- | --- | --- |
| SVG基本图形同时配置两个属性： 局部中心点和transform-origin，如'transform="rotate(30, -10, -10)" transform-origin="150 150"'。 | 按照局部中心点：rotate功能的最后2个参数指定的坐标偏移(x,y)作为变换中心点进行旋转。 ![](./img/zh-cn_image_0000002661732671.png) | 按照全局中心点transform-origin属性指定的坐标偏移(x,y)加局部中心点坐标偏移的和作为变换中心点进行旋转。 ![](./img/zh-cn_image_0000002631253550.png) |
...
| SVG场景 | 扩展前 | 扩展后 |
| --- | --- | --- |
| transform属性设置matrix矩阵变换，同时配置transform-origin属性。 全局中心点值为图形元素右下角，如:'transform="matrix(0.812,0.278,0.139,0.763,5.000,5.000" transform-origin="150 150"')。 | ![](./img/zh-cn_image_0000002661612733.png) | ![](./img/zh-cn_image_0000002631413444.png) |
...
| SVG场景 | 扩展前 | 扩展后 |
| --- | --- | --- |
| 当变形功能参数为非法值，如rotate旋转功能的角度参数为非法值：'transform="rotate(30deg)"'。 | 按照第一个参数可解析出的数值(30)作为旋转角度进行旋转。 ![](./img/zh-cn_image_0000002661732673.png) | 不做旋转。 ![](./img/zh-cn_image_0000002631253552.png) |
| 当变形功能参数为非法值，如rotate旋转功能的局部中心点参数为非法：'transform="rotate(30,abc,abc)"'。 | 按照SVG的ViewPort左上角坐标点(0,0)作为变换中心点，并根据旋转角度30度进行旋转。 ![](./img/zh-cn_image_0000002661612735.png) | 不做旋转。 ![](./img/zh-cn_image_0000002631413446.png) |
| 当变形功能参数数量为非法时，如scale功能的参数个数为非法：'transform="scale(0.5, 0.5, 0.5)"'。 | 取前2个合法参数作为x轴和y轴的缩放比例(0.5,0.5)缩放。 ![](./img/zh-cn_image_0000002661732675.png) | 不做变形。 ![](./img/zh-cn_image_0000002631253554.png) |
| 当链式调用多个变形功能，其中某个功能参数为非法，如'transform="rotate(30) skewX(abc) scale(0.5, 0.5)"'。 | 不处理非法的变形功能skewX，处理合法的变形功能rotate和scale。 ![](./img/zh-cn_image_0000002661612737.png) | 所有的变形功能均不处理。 ![](./img/zh-cn_image_0000002631413448.png) |
...
| 扩展前 | 扩展后 |
| --- | --- |
| ![](./img/zh-cn_image_0000002661732677.png) | ![](./img/zh-cn_image_0000002631253556.png) |
...
| 扩展前 | 扩展后 |
| --- | --- |
| ![](./img/zh-cn_image_0000002661612739.png) | ![](./img/zh-cn_image_0000002631413450.png) |
...
| 扩展前 | 扩展后 |
| --- | --- |
| ![](./img/zh-cn_image_0000002661732679.png) | ![](./img/zh-cn_image_0000002631253558.png) |
...
| 参数值 | 扩展前 | 扩展后 |
| --- | --- | --- |
| none | 按宽高比最小值进行统一缩放。 同时将SVG元素的viewBox属性的X的中点值与视图的X的中点值对齐， 将SVG元素的viewBox属性的Y的中点值与视图的Y的中点值对齐。 ![](./img/zh-cn_image_0000002661612741.png) | 缩放元素的图形内容，使元素的边界完全匹配视图矩形。 ![](./img/zh-cn_image_0000002631413452.png) |
...
| 参数值 | 扩展前 | 扩展后 |
| --- | --- | --- |
| xMinYMin meet | 按宽高比最小值进行统一缩放。 SVG元素的viewBox属性的X的中点值与视图的X的中点值对齐， SVG元素的viewBox属性的Y的中点值与视图的Y的中点值对齐。 ![](./img/zh-cn_image_0000002661732681.png) | 按宽高比最小值进行统一缩放。 SVG元素的viewBox属性的X的最小值与视图的X的最小值对齐， SVG元素的viewBox属性的Y的最小值与视图的Y的最小值对齐。 ![](./img/zh-cn_image_0000002631253562.png) |
| xMaxYMin meet | 按宽高比最小值进行统一缩放。 SVG元素的viewBox属性的X的中点值与视图的X的中点值对齐， SVG元素的viewBox属性的Y的中点值与视图的Y的中点值对齐。 ![](./img/zh-cn_image_0000002661612743.png) | 按宽高比最小值进行统一缩放。 SVG元素的viewBox属性的X的最小值+元素的宽度与视图的X的最大值对齐， SVG元素的viewBox属性的Y的最小值与视图的Y的最小值对齐。 ![](./img/zh-cn_image_0000002631413454.png) |
| xMinYMid meet | 按宽高比最小值进行统一缩放。 SVG元素的viewBox属性的X的中点值与视图的X的中点值对齐， SVG元素的viewBox属性的Y的中点值与视图的Y的中点值对齐。 ![](./img/zh-cn_image_0000002661732683.png) | 按宽高比最小值进行统一缩放。 SVG元素的viewBox属性的X的最小值与视图的X的最小值对齐， SVG元素的viewBox属性的Y的中点值与视图的Y的中点值对齐。 ![](./img/zh-cn_image_0000002631253564.png) |
| xMaxYMid meet | 按宽高比最小值进行统一缩放。 SVG元素的viewBox属性的X的中点值与视图的X的中点值对齐， SVG元素的viewBox属性的Y的中点值与视图的Y的中点值对齐。 ![](./img/zh-cn_image_0000002661612745.png) | 按宽高比最小值进行统一缩放。 SVG元素的viewBox属性的X的最小值+元素的宽度与视图的X的最大值对齐， SVG元素的viewBox属性的Y的中点值与视图的Y的中点值对齐。 ![](./img/zh-cn_image_0000002631413456.png) |
| xMinYMax meet | 按宽高比最小值进行统一缩放。 SVG元素的viewBox属性的X的中点值与视图的X的中点值对齐， SVG元素的viewBox属性的Y的中点值与视图的Y的中点值对齐。 ![](./img/zh-cn_image_0000002661732685.png) | 按宽高比最小值进行统一缩放。 SVG元素的viewBox属性的X的最小值与视图的X的最小值对齐， SVG元素的viewBox属性的Y的最小值+元素的高度与视图的Y的最大值对齐。 ![](./img/zh-cn_image_0000002631253566.png) |
| xMaxYMax meet | 按宽高比最小值进行统一缩放。 SVG元素的viewBox属性的X的中点值与视图的X的中点值对齐， SVG元素的viewBox属性的Y的中点值与视图的Y的中点值对齐。 ![](./img/zh-cn_image_0000002661612747.png) | 按宽高比最小值进行统一缩放。 SVG元素的viewBox属性的X的最小值+元素的宽度与视图的X的最大值对齐， SVG元素的viewBox属性的Y的最小值+元素的高度与视图的Y的最大值对齐。 ![](./img/zh-cn_image_0000002631413458.png) |
| xMinYMin slice | 按宽高比最小值进行统一缩放。 SVG元素的viewBox属性的X的中点值与视图的X的中点值对齐， SVG元素的viewBox属性的Y的中点值与视图的Y的中点值对齐。 ![](./img/zh-cn_image_0000002661732687.png) | 按宽高比最大值进行统一缩放。 SVG元素的viewBox属性的X的最小值与视图的X的最小值对齐， SVG元素的viewBox属性的Y的最小值与视图的Y的最小值对齐。 ![](./img/zh-cn_image_0000002631253568.png) |
| xMidYMin slice | 按宽高比最小值进行统一缩放。 SVG元素的viewBox属性的X的中点值与视图的X的中点值对齐， SVG元素的viewBox属性的Y的中点值与视图的Y的中点值对齐。 ![](./img/zh-cn_image_0000002661612749.png) | 按宽高比最大值进行统一缩放。 SVG元素的viewBox属性的X的中点值与视图的X的中点值对齐， SVG元素的viewBox属性的Y的最小值与视图的Y的最小值对齐。 ![](./img/zh-cn_image_0000002631413460.png) |
| xMaxYMin slice | 按宽高比最小值进行统一缩放。 SVG元素的viewBox属性的X的中点值与视图的X的中点值对齐， SVG元素的viewBox属性的Y的中点值与视图的Y的中点值对齐。 ![](./img/zh-cn_image_0000002661732689.png) | 按宽高比最大值进行统一缩放。 SVG元素的viewBox属性的X的最小值+元素的宽度与视图的X的最大值对齐， SVG元素的viewBox属性的Y的最小值与视图的Y的最小值对齐。 ![](./img/zh-cn_image_0000002631253570.png) |
| xMinYMid slice | 按宽高比最小值进行统一缩放。 SVG元素的viewBox属性的X的中点值与视图的X的中点值对齐， SVG元素的viewBox属性的Y的中点值与视图的Y的中点值对齐。 ![](./img/zh-cn_image_0000002661612751.png) | 按宽高比最大值进行统一缩放。 SVG元素的viewBox属性的X的最小值与视图的X的最小值对齐， SVG元素的viewBox属性的Y的中点值与视图的Y的中点值对齐。 ![](./img/zh-cn_image_0000002631413462.png) |
| xMidYMid slice | 按宽高比最小值进行统一缩放。 SVG元素的viewBox属性的X的中点值与视图的X的中点值对齐， SVG元素的viewBox属性的Y的中点值与视图的Y的中点值对齐。 ![](./img/zh-cn_image_0000002661732691.png) | 按宽高比最大值进行统一缩放。 SVG元素的viewBox属性的X的中点值与视图的X的中点值对齐， SVG元素的viewBox属性的Y的中点值与视图的Y的中点值对齐。 ![](./img/zh-cn_image_0000002631253572.png) |
| xMaxYMid slice | 按宽高比最小值进行统一缩放。 SVG元素的viewBox属性的X的中点值与视图的X的中点值对齐， SVG元素的viewBox属性的Y的中点值与视图的Y的中点值对齐。 ![](./img/zh-cn_image_0000002661612751.png) | 按宽高比最大值进行统一缩放。 SVG元素的viewBox属性的X的最小值+元素的宽度与视图的X的最大值对齐， SVG元素的viewBox属性的Y的中点值与视图的Y的中点值对齐。 ![](./img/zh-cn_image_0000002661612753.png) |
| xMinYMax slice | 按宽高比最小值进行统一缩放。 SVG元素的viewBox属性的X的中点值与视图的X的中点值对齐， SVG元素的viewBox属性的Y的中点值与视图的Y的中点值对齐。 ![](./img/zh-cn_image_0000002631413464.png) | 按宽高比最大值进行统一缩放。 SVG元素的viewBox属性的X的最小值与视图的X的最小值对齐， SVG元素的viewBox属性的Y的最小值+元素的高度与视图的Y的最大值对齐。 ![](./img/zh-cn_image_0000002661732693.png) |
| xMidYMax slice | 按宽高比最小值进行统一缩放。 SVG元素的viewBox属性的X的中点值与视图的X的中点值对齐， SVG元素的viewBox属性的Y的中点值与视图的Y的中点值对齐。 ![](./img/zh-cn_image_0000002631253574.png) | 按宽高比最大值进行统一缩放。 SVG元素的viewBox属性的X的中点值与视图的X的中点值对齐， SVG元素的viewBox属性的Y的最小值+元素的高度与视图的Y的最大值对齐。 ![](./img/zh-cn_image_0000002661612755.png) |
| xMaxYMax slice | 按宽高比最小值进行统一缩放。 SVG元素的viewBox属性的X的中点值与视图的X的中点值对齐， SVG元素的viewBox属性的Y的中点值与视图的Y的中点值对齐。 ![](./img/zh-cn_image_0000002631413466.png) | 按宽高比最大值进行统一缩放。 将SVG元素的viewBox属性的X的最小值+元素的宽度与视图的X的最大值对齐， SVG元素的viewBox属性的Y的最小值+元素的高度与视图的Y的最大值对齐。 ![](./img/zh-cn_image_0000002661732695.png) |
...
| 扩展前 | 扩展后 |
| --- | --- |
| ![](./img/zh-cn_image_0000002631253576.png) | ![](./img/zh-cn_image_0000002661612757.png) |
...
| 扩展前 | 扩展后 |
| --- | --- |
| ![](./img/zh-cn_image_0000002631413468.png) | ![](./img/zh-cn_image_0000002661732697.png) |
...
| 扩展前 | 扩展后 |
| --- | --- |
| ![](./img/zh-cn_image_0000002631253578.png) | ![](./img/zh-cn_image_0000002661612759.png) |
...
| 扩展前 | 扩展后 |
| --- | --- |
| ![](./img/zh-cn_image_0000002631413470.png) | ![](./img/zh-cn_image_0000002661732699.png) |
...
| 扩展前 | 扩展后 |
| --- | --- |
| ![](./img/zh-cn_image_0000002631253580.png) | ![](./img/zh-cn_image_0000002661612761.png) |
...
| 扩展前 | 扩展后 |
| --- | --- |
| ![](./img/zh-cn_image_0000002631413472.png) | ![](./img/zh-cn_image_0000002661732701.png) |
...
| 扩展前 | 扩展后 |
| --- | --- |
| ![](./img/zh-cn_image_0000002631253582.png) | ![](./img/zh-cn_image_0000002661612763.png) |
...
| 扩展前 | 扩展后 |
| --- | --- |
| ![](./img/zh-cn_image_0000002631413474.png) | ![](./img/zh-cn_image_0000002661732703.png) |
...
| 扩展前 | 扩展后 |
| --- | --- |
| 图案不支持重复平铺。 ![](./img/zh-cn_image_0000002631253584.png) | 图案支持重复平铺 ![](./img/zh-cn_image_0000002661612765.png) |
...
| 扩展前 | 扩展后 |
| --- | --- |
| ![](./img/zh-cn_image_0000002631413476.png) | ![](./img/zh-cn_image_0000002661732705.png) |
...
| 扩展前 | 扩展后 |
| --- | --- |
| ![](./img/zh-cn_image_0000002631253586.png) | ![](./img/zh-cn_image_0000002661612767.png) |
...
| 扩展前 | 扩展后 |
| --- | --- |
| ![](./img/zh-cn_image_0000002631413478.png) | ![](./img/zh-cn_image_0000002661732707.png) |
...
| 扩展前 | 扩展后 |
| --- | --- |
| ![](./img/zh-cn_image_0000002631253588.png) | ![](./img/zh-cn_image_0000002661612769.png) |
...
| 扩展前 | 扩展后 |
| --- | --- |
| ![](./img/zh-cn_image_0000002631413480.png) | ![](./img/zh-cn_image_0000002661732709.png) |
