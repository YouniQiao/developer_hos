...
content_hash: "d3f71221b076"
synced_at: "2026-07-09T17:24:19.825056"
---
...
| 提升前 | 提升后 |
| --- | --- |
| 系统会把8位的十六进制颜色当#ARGB格式解析并显示。 例如fill="#ff000030"的矩形显示效果。 ![](./img/zh-cn_image_0000002634010670.png) | 系统会把8位的十六进制颜色当#RGBA格式解析并显示。 例如fill="#ff000030"的矩形显示效果。 ![](./img/zh-cn_image_0000002664209819.png) |
...
| 提升前 | 提升后 |
| --- | --- |
| 系统会把7位的十六进制颜色当#ARGB格式解析并显示。 例如fill="#BB88990"的矩形显示效果。 ![](./img/zh-cn_image_0000002664329879.png) | 系统会把7位十六进制颜色解析成默认黑色并显示。 例如fill="#BB88990"的矩形显示效果。 ![](./img/zh-cn_image_0000002633850768.png) |
...
| 提升前 | 提升后 |
| --- | --- |
| 系统会把4位的十六进制颜色当#ARGB格式解析并显示。 例如fill="#8888"的矩形显示效果。 ![](./img/zh-cn_image_0000002634010672.png) | 系统会把4位的十六进制颜色当#RGBA解析并显示。 例如fill="#0000"的矩形显示效果（全透明）。 ![](./img/zh-cn_image_0000002664209821.png) |
...
| 原始图源 | 提升前 | 提升后 |
| --- | --- | --- |
| ![](./img/zh-cn_image_0000002664329881.png) | Image组件的colorFilter属性只对图源的stroke边框起作用。 ![](./img/zh-cn_image_0000002633850770.png) | Image组件的colorFilter属性对整个SVG图源起作用。 ![](./img/zh-cn_image_0000002634010674.png) |
...
| 提升前 | 提升后 |
| --- | --- |
| Image组件的fillColor属性只对SVG图源中fill='none'的元素仍然填充颜色。 ![](./img/zh-cn_image_0000002664209823.png) | Image组件的fillColor属性对SVG图源中fill='none'的元素不填充颜色。 ![](./img/zh-cn_image_0000002664329883.png) |
...
| transform属性设置rotate旋转功能，同时配置transform-origin属性。 全局中心点值为图形元素右下角，如:'transform="rotate(30)" transform-origin="150 150"'。 | ![](./img/zh-cn_image_0000002633850772.png) | ![](./img/zh-cn_image_0000002634010676.png) |
| transform属性设置scale缩放功能，同时配置transform-origin属性。 全局中心点值为图形元素右下角，如:'transform="scale(0.77)" transform-origin="150 150"'。 | ![](./img/zh-cn_image_0000002664209825.png) | ![](./img/zh-cn_image_0000002664329885.png) |
| transform属性设置skewX按x轴倾斜的功能，同时配置transform-origin属性。 全局中心点值为图形元素右下角，如:'transform="skewX(30)" transform-origin="150 150"'。 | ![](./img/zh-cn_image_0000002633850774.png) | ![](./img/zh-cn_image_0000002634010678.png) |
| transform属性设置skewY按y轴倾斜的功能，同时配置transform-origin属性。 全局中心点值为图形元素右下角，如:'transform="skewY(30)" transform-origin="150 150"'。 | ![](./img/zh-cn_image_0000002664209827.png) | ![](./img/zh-cn_image_0000002664329887.png) |
| transform属性设置translate平移功能，同时配置transform-origin属性。 全局中心点值为图形元素右下角，如:'transform="translate(30,30)" transform-origin="150 150"'。 | ![](./img/zh-cn_image_0000002633850776.png) | ![](./img/zh-cn_image_0000002634010680.png) |
| transform属性链式调用多个功能，同时配置transform-origin属性。 全局中心点值为图形元素右下角，如:transform='"translate(10,10) rotate(10) scale(0.5) skewX(10)" transform-origin="150 150"'。 | ![](./img/zh-cn_image_0000002664209829.png) | ![](./img/zh-cn_image_0000002664329889.png) |
...
| SVG场景 | 扩展前 | 扩展后 |
| --- | --- | --- |
| SVG基本图形同时配置两个属性： 局部中心点和transform-origin，如'transform="rotate(30, -10, -10)" transform-origin="150 150"'。 | 按照局部中心点：rotate功能的最后2个参数指定的坐标偏移(x,y)作为变换中心点进行旋转。 ![](./img/zh-cn_image_0000002633850778.png) | 按照全局中心点transform-origin属性指定的坐标偏移(x,y)加局部中心点坐标偏移的和作为变换中心点进行旋转。 ![](./img/zh-cn_image_0000002634010682.png) |
...
| SVG场景 | 扩展前 | 扩展后 |
| --- | --- | --- |
| transform属性设置matrix矩阵变换，同时配置transform-origin属性。 全局中心点值为图形元素右下角，如:'transform="matrix(0.812,0.278,0.139,0.763,5.000,5.000" transform-origin="150 150"')。 | ![](./img/zh-cn_image_0000002664209831.png) | ![](./img/zh-cn_image_0000002664329891.png) |
...
| SVG场景 | 扩展前 | 扩展后 |
| --- | --- | --- |
| 当变形功能参数为非法值，如rotate旋转功能的角度参数为非法值：'transform="rotate(30deg)"'。 | 按照第一个参数可解析出的数值(30)作为旋转角度进行旋转。 ![](./img/zh-cn_image_0000002633850780.png) | 不做旋转。 ![](./img/zh-cn_image_0000002634010684.png) |
| 当变形功能参数为非法值，如rotate旋转功能的局部中心点参数为非法：'transform="rotate(30,abc,abc)"'。 | 按照SVG的ViewPort左上角坐标点(0,0)作为变换中心点，并根据旋转角度30度进行旋转。 ![](./img/zh-cn_image_0000002664209833.png) | 不做旋转。 ![](./img/zh-cn_image_0000002664329893.png) |
| 当变形功能参数数量为非法时，如scale功能的参数个数为非法：'transform="scale(0.5, 0.5, 0.5)"'。 | 取前2个合法参数作为x轴和y轴的缩放比例(0.5,0.5)缩放。 ![](./img/zh-cn_image_0000002633850782.png) | 不做变形。 ![](./img/zh-cn_image_0000002634010686.png) |
| 当链式调用多个变形功能，其中某个功能参数为非法，如'transform="rotate(30) skewX(abc) scale(0.5, 0.5)"'。 | 不处理非法的变形功能skewX，处理合法的变形功能rotate和scale。 ![](./img/zh-cn_image_0000002664209835.png) | 所有的变形功能均不处理。 ![](./img/zh-cn_image_0000002664329895.png) |
...
| 扩展前 | 扩展后 |
| --- | --- |
| ![](./img/zh-cn_image_0000002633850784.png) | ![](./img/zh-cn_image_0000002634010688.png) |
...
| 扩展前 | 扩展后 |
| --- | --- |
| ![](./img/zh-cn_image_0000002664209837.png) | ![](./img/zh-cn_image_0000002664329897.png) |
...
| 扩展前 | 扩展后 |
| --- | --- |
| ![](./img/zh-cn_image_0000002633850786.png) | ![](./img/zh-cn_image_0000002634010690.png) |
...
| 参数值 | 扩展前 | 扩展后 |
| --- | --- | --- |
| none | 按宽高比最小值进行统一缩放。 同时将SVG元素的viewBox属性的X的中点值与视图的X的中点值对齐， 将SVG元素的viewBox属性的Y的中点值与视图的Y的中点值对齐。 ![](./img/zh-cn_image_0000002664209839.png) | 缩放元素的图形内容，使元素的边界完全匹配视图矩形。 ![](./img/zh-cn_image_0000002664329899.png) |
...
| 参数值 | 扩展前 | 扩展后 |
| --- | --- | --- |
| xMinYMin meet | 按宽高比最小值进行统一缩放。 SVG元素的viewBox属性的X的中点值与视图的X的中点值对齐， SVG元素的viewBox属性的Y的中点值与视图的Y的中点值对齐。 ![](./img/zh-cn_image_0000002633850788.png) | 按宽高比最小值进行统一缩放。 SVG元素的viewBox属性的X的最小值与视图的X的最小值对齐， SVG元素的viewBox属性的Y的最小值与视图的Y的最小值对齐。 ![](./img/zh-cn_image_0000002634010692.png) |
| xMaxYMin meet | 按宽高比最小值进行统一缩放。 SVG元素的viewBox属性的X的中点值与视图的X的中点值对齐， SVG元素的viewBox属性的Y的中点值与视图的Y的中点值对齐。 ![](./img/zh-cn_image_0000002664209841.png) | 按宽高比最小值进行统一缩放。 SVG元素的viewBox属性的X的最小值+元素的宽度与视图的X的最大值对齐， SVG元素的viewBox属性的Y的最小值与视图的Y的最小值对齐。 ![](./img/zh-cn_image_0000002664329901.png) |
| xMinYMid meet | 按宽高比最小值进行统一缩放。 SVG元素的viewBox属性的X的中点值与视图的X的中点值对齐， SVG元素的viewBox属性的Y的中点值与视图的Y的中点值对齐。 ![](./img/zh-cn_image_0000002633850790.png) | 按宽高比最小值进行统一缩放。 SVG元素的viewBox属性的X的最小值与视图的X的最小值对齐， SVG元素的viewBox属性的Y的中点值与视图的Y的中点值对齐。 ![](./img/zh-cn_image_0000002634010694.png) |
| xMaxYMid meet | 按宽高比最小值进行统一缩放。 SVG元素的viewBox属性的X的中点值与视图的X的中点值对齐， SVG元素的viewBox属性的Y的中点值与视图的Y的中点值对齐。 ![](./img/zh-cn_image_0000002664209843.png) | 按宽高比最小值进行统一缩放。 SVG元素的viewBox属性的X的最小值+元素的宽度与视图的X的最大值对齐， SVG元素的viewBox属性的Y的中点值与视图的Y的中点值对齐。 ![](./img/zh-cn_image_0000002664329903.png) |
| xMinYMax meet | 按宽高比最小值进行统一缩放。 SVG元素的viewBox属性的X的中点值与视图的X的中点值对齐， SVG元素的viewBox属性的Y的中点值与视图的Y的中点值对齐。 ![](./img/zh-cn_image_0000002633850792.png) | 按宽高比最小值进行统一缩放。 SVG元素的viewBox属性的X的最小值与视图的X的最小值对齐， SVG元素的viewBox属性的Y的最小值+元素的高度与视图的Y的最大值对齐。 ![](./img/zh-cn_image_0000002634010696.png) |
| xMaxYMax meet | 按宽高比最小值进行统一缩放。 SVG元素的viewBox属性的X的中点值与视图的X的中点值对齐， SVG元素的viewBox属性的Y的中点值与视图的Y的中点值对齐。 ![](./img/zh-cn_image_0000002664209845.png) | 按宽高比最小值进行统一缩放。 SVG元素的viewBox属性的X的最小值+元素的宽度与视图的X的最大值对齐， SVG元素的viewBox属性的Y的最小值+元素的高度与视图的Y的最大值对齐。 ![](./img/zh-cn_image_0000002664329905.png) |
| xMinYMin slice | 按宽高比最小值进行统一缩放。 SVG元素的viewBox属性的X的中点值与视图的X的中点值对齐， SVG元素的viewBox属性的Y的中点值与视图的Y的中点值对齐。 ![](./img/zh-cn_image_0000002633850794.png) | 按宽高比最大值进行统一缩放。 SVG元素的viewBox属性的X的最小值与视图的X的最小值对齐， SVG元素的viewBox属性的Y的最小值与视图的Y的最小值对齐。 ![](./img/zh-cn_image_0000002634010698.png) |
| xMidYMin slice | 按宽高比最小值进行统一缩放。 SVG元素的viewBox属性的X的中点值与视图的X的中点值对齐， SVG元素的viewBox属性的Y的中点值与视图的Y的中点值对齐。 ![](./img/zh-cn_image_0000002664209847.png) | 按宽高比最大值进行统一缩放。 SVG元素的viewBox属性的X的中点值与视图的X的中点值对齐， SVG元素的viewBox属性的Y的最小值与视图的Y的最小值对齐。 ![](./img/zh-cn_image_0000002664329907.png) |
| xMaxYMin slice | 按宽高比最小值进行统一缩放。 SVG元素的viewBox属性的X的中点值与视图的X的中点值对齐， SVG元素的viewBox属性的Y的中点值与视图的Y的中点值对齐。 ![](./img/zh-cn_image_0000002633850796.png) | 按宽高比最大值进行统一缩放。 SVG元素的viewBox属性的X的最小值+元素的宽度与视图的X的最大值对齐， SVG元素的viewBox属性的Y的最小值与视图的Y的最小值对齐。 ![](./img/zh-cn_image_0000002634010700.png) |
| xMinYMid slice | 按宽高比最小值进行统一缩放。 SVG元素的viewBox属性的X的中点值与视图的X的中点值对齐， SVG元素的viewBox属性的Y的中点值与视图的Y的中点值对齐。 ![](./img/zh-cn_image_0000002664209849.png) | 按宽高比最大值进行统一缩放。 SVG元素的viewBox属性的X的最小值与视图的X的最小值对齐， SVG元素的viewBox属性的Y的中点值与视图的Y的中点值对齐。 ![](./img/zh-cn_image_0000002664329909.png) |
| xMidYMid slice | 按宽高比最小值进行统一缩放。 SVG元素的viewBox属性的X的中点值与视图的X的中点值对齐， SVG元素的viewBox属性的Y的中点值与视图的Y的中点值对齐。 ![](./img/zh-cn_image_0000002633850798.png) | 按宽高比最大值进行统一缩放。 SVG元素的viewBox属性的X的中点值与视图的X的中点值对齐， SVG元素的viewBox属性的Y的中点值与视图的Y的中点值对齐。 ![](./img/zh-cn_image_0000002634010702.png) |
| xMaxYMid slice | 按宽高比最小值进行统一缩放。 SVG元素的viewBox属性的X的中点值与视图的X的中点值对齐， SVG元素的viewBox属性的Y的中点值与视图的Y的中点值对齐。 ![](./img/zh-cn_image_0000002664209849.png) | 按宽高比最大值进行统一缩放。 SVG元素的viewBox属性的X的最小值+元素的宽度与视图的X的最大值对齐， SVG元素的viewBox属性的Y的中点值与视图的Y的中点值对齐。 ![](./img/zh-cn_image_0000002664209851.png) |
| xMinYMax slice | 按宽高比最小值进行统一缩放。 SVG元素的viewBox属性的X的中点值与视图的X的中点值对齐， SVG元素的viewBox属性的Y的中点值与视图的Y的中点值对齐。 ![](./img/zh-cn_image_0000002664329911.png) | 按宽高比最大值进行统一缩放。 SVG元素的viewBox属性的X的最小值与视图的X的最小值对齐， SVG元素的viewBox属性的Y的最小值+元素的高度与视图的Y的最大值对齐。 ![](./img/zh-cn_image_0000002633850800.png) |
| xMidYMax slice | 按宽高比最小值进行统一缩放。 SVG元素的viewBox属性的X的中点值与视图的X的中点值对齐， SVG元素的viewBox属性的Y的中点值与视图的Y的中点值对齐。 ![](./img/zh-cn_image_0000002634010704.png) | 按宽高比最大值进行统一缩放。 SVG元素的viewBox属性的X的中点值与视图的X的中点值对齐， SVG元素的viewBox属性的Y的最小值+元素的高度与视图的Y的最大值对齐。 ![](./img/zh-cn_image_0000002664209853.png) |
| xMaxYMax slice | 按宽高比最小值进行统一缩放。 SVG元素的viewBox属性的X的中点值与视图的X的中点值对齐， SVG元素的viewBox属性的Y的中点值与视图的Y的中点值对齐。 ![](./img/zh-cn_image_0000002664329913.png) | 按宽高比最大值进行统一缩放。 将SVG元素的viewBox属性的X的最小值+元素的宽度与视图的X的最大值对齐， SVG元素的viewBox属性的Y的最小值+元素的高度与视图的Y的最大值对齐。 ![](./img/zh-cn_image_0000002633850802.png) |
...
| 扩展前 | 扩展后 |
| --- | --- |
| ![](./img/zh-cn_image_0000002634010706.png) | ![](./img/zh-cn_image_0000002664209855.png) |
...
| 扩展前 | 扩展后 |
| --- | --- |
| ![](./img/zh-cn_image_0000002664329915.png) | ![](./img/zh-cn_image_0000002633850804.png) |
...
| 扩展前 | 扩展后 |
| --- | --- |
| ![](./img/zh-cn_image_0000002634010708.png) | ![](./img/zh-cn_image_0000002664209857.png) |
...
| 扩展前 | 扩展后 |
| --- | --- |
| ![](./img/zh-cn_image_0000002664329917.png) | ![](./img/zh-cn_image_0000002633850806.png) |
...
| 扩展前 | 扩展后 |
| --- | --- |
| ![](./img/zh-cn_image_0000002634010710.png) | ![](./img/zh-cn_image_0000002664209859.png) |
...
| 扩展前 | 扩展后 |
| --- | --- |
| ![](./img/zh-cn_image_0000002664329919.png) | ![](./img/zh-cn_image_0000002633850808.png) |
...
| 扩展前 | 扩展后 |
| --- | --- |
| ![](./img/zh-cn_image_0000002634010712.png) | ![](./img/zh-cn_image_0000002664209861.png) |
...
| 扩展前 | 扩展后 |
| --- | --- |
| ![](./img/zh-cn_image_0000002664329921.png) | ![](./img/zh-cn_image_0000002633850810.png) |
...
| 扩展前 | 扩展后 |
| --- | --- |
| 图案不支持重复平铺。 ![](./img/zh-cn_image_0000002634010714.png) | 图案支持重复平铺 ![](./img/zh-cn_image_0000002664209863.png) |
...
| 扩展前 | 扩展后 |
| --- | --- |
| ![](./img/zh-cn_image_0000002664329923.png) | ![](./img/zh-cn_image_0000002633850812.png) |
...
| 扩展前 | 扩展后 |
| --- | --- |
| ![](./img/zh-cn_image_0000002634010716.png) | ![](./img/zh-cn_image_0000002664209865.png) |
...
| 扩展前 | 扩展后 |
| --- | --- |
| ![](./img/zh-cn_image_0000002664329925.png) | ![](./img/zh-cn_image_0000002633850814.png) |
...
| 扩展前 | 扩展后 |
| --- | --- |
| ![](./img/zh-cn_image_0000002634010718.png) | ![](./img/zh-cn_image_0000002664209867.png) |
...
| 扩展前 | 扩展后 |
| --- | --- |
| ![](./img/zh-cn_image_0000002664329927.png) | ![](./img/zh-cn_image_0000002633850816.png) |
