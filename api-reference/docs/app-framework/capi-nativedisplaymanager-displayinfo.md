...
content_hash: "dfc7e30087a7"
synced_at: "2026-07-28T16:49:40.131885"
---
...
| uint32_t availableWidth | 显示设备屏幕的可用区域宽度，单位为px，该参数为非负整数。 **设备行为差异：** 在搭载HarmonyOS 7.0.0及以上版本的设备上，该接口可正常调用。 针对低于该版本的设备，该接口在PC/2in1设备、Tablet设备中可正常调用；在其他设备中不可用，请通过width属性获取当前设备屏幕的可用区域宽度。 |
| uint32_t availableHeight | 显示设备屏幕的可用区域高度，单位为px，该参数为非负整数。 **设备行为差异：** 在搭载HarmonyOS 7.0.0及以上版本的设备上，该接口可正常调用。 针对低于该版本的设备，该接口在PC/2in1设备、Tablet设备中可正常调用；在其他设备中不可用，请通过height属性获取当前设备屏幕的可用区域高度。 |
