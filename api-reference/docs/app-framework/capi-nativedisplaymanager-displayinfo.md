...
content_hash: "9f310dcb0fa5"
synced_at: "2026-07-09T00:58:46.309030"
---
...
| uint32_t availableWidth | 显示设备屏幕的可用区域宽度，单位为px，该参数为非负整数。 |
| uint32_t availableHeight | 显示设备屏幕的可用区域高度，单位为px，该参数为非负整数。 |
