...
upstream_id: "harmonyos-references/capi-nativedisplaymanager-displayinfo"
catalog: "harmonyos-references"
content_hash: "8b2a1c111840"
synced_at: "2026-08-29T18:15:52.127333"
---
...
| int32_t width | 显示设备的屏幕宽度，单位为px，该参数为非负整数。 |
| int32_t height | 显示设备的屏幕高度，单位为px，该参数为非负整数。 |
...
| uint32_t availableWidth | 显示设备屏幕的可用区域宽度，单位为px，该参数为非负整数。 **设备行为差异：** 在搭载HarmonyOS 7.0.0及以上版本的设备上，该接口可正常调用。 针对HarmonyOS 7.0.0以下版本的设备，该接口在PC/2in1设备、Tablet设备中可正常调用；在其他设备中不可用，请通过width属性获取当前设备屏幕的可用区域宽度。 |
| uint32_t availableHeight | 显示设备屏幕的可用区域高度，单位为px，该参数为非负整数。 **设备行为差异：** 在搭载HarmonyOS 7.0.0及以上版本的设备上，该接口可正常调用。 针对HarmonyOS 7.0.0以下版本的设备，该接口在PC/2in1设备、Tablet设备中可正常调用；在其他设备中不可用，请通过height属性获取当前设备屏幕的可用区域高度。 |
