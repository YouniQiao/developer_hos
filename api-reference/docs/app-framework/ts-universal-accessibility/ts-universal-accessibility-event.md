...
content_hash: "8f8dc1c4664a"
synced_at: "2026-07-28T16:41:57.499625"
---
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [AccessibilityActionInterceptCallback](#accessibilityactioninterceptcallback20) | 是 | 在无障碍模式且组件支持点击的前提下，在无障碍控制操作触发前通知注册方该次无障碍控制操作，由注册方决定是否拦截该操作。未开启无障碍模式或组件不支持点击时，回调均不会触发。 入参设置undefined时取消回调注册。 |
