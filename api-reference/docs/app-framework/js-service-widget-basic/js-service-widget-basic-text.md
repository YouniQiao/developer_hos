---
title: "text"
upstream_id: "harmonyos-references/js-service-widget-basic-text"
catalog: "harmonyos-references"
content_hash: "038aad7d11d5"
synced_at: "2026-07-09T00:58:32.043641"
---
...
支持<[span](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-service-widget-basic-span)>。
...
| font-family | string | sans-serif | 否 | 设置文本的字体列表，用逗号分隔，每个字体用字体名或者字体族名设置。列表中第一个系统中存在的或者通过[自定义字体](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-service-widget-common-customizing-font)指定的字体，会被选中作为文本的字体。 |
...
![](./img/zh-cn_image_0000002661613317.png)
