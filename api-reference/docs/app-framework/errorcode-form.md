...
检查[半模态卡片编辑页](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-ui-widget-event-formeditextensionability-overview#半模态卡片编辑)是否已打开。
...
检查入参卡片位置是否在[FormLocation](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-app-form-forminfo#formlocation20)配置列表。
...
4. 空参数错误，比如传入空字符串（''）。
5. 参数格式错误。
6. 参数值错误。输入参数需要与[app.json5](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/app-configuration-file)和[配置ArkTS卡片的配置文件](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-ui-widget-configuration)中对应的配置保持一致。
