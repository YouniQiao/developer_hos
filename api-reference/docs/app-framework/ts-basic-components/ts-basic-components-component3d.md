...
| 类型 | 说明 |
| --- | --- |
| import('../api/@ohos.graphics.scene').[Scene](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-inner-scene#scene-1) | 用于设置场景。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| buffer | Array | 是 | 自定义渲染用到的动效参数，数组长度范围为[0, 1048576]。 |
