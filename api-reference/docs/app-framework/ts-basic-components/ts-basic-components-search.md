...
content_hash: "cb447702a55b"
synced_at: "2026-07-09T00:57:56.633030"
---
...
| controller8+ | [SearchController](#searchcontroller) | 否 | 是 | 设置Search组件控制器。 **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | number | 是 | 文本的最大输入字符数。 当value元服务API： 从API version 12开始，该接口支持在元服务中使用。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| enable | boolean | undefined | 是 | 开启选中文本实体识别。 true：开启识别，false：关闭识别。默认值为：true。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| color | [Optional](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-custom-property#optionalt) | 是 | 设置分割线颜色。 默认使用系统的主题色：浅色模式下为0x33000000，显示为浅黑色，深色模式下为0x33FFFFFF，显示为浅白色。 |
...
![](./img/note_3.0-zh-cn.png) 如果selectionStart或selectionEnd被赋值为undefined时，当作0处理。
...
```
 ![](./img/zh-cn_image_0000002661732603.gif)
...
```
 ![](./img/zh-cn_image_0000002631253482.gif)
...
```
 ![](./img/zh-cn_image_0000002661612665.gif)
...
```
 ![](./img/zh-cn_image_0000002631413374.gif)
...
```
 ![](./img/zh-cn_image_0000002661732605.png)
...
```
 ![](./img/zh-cn_image_0000002631253484.png)
...
```
 ![](./img/zh-cn_image_0000002661612667.gif)
...
```
 ![](./img/zh-cn_image_0000002631413376.png)
...
```
 ![](./img/zh-cn_image_0000002661732607.png)
...
```
 ![](./img/zh-cn_image_0000002631253486.png)
...
```
 ![](./img/zh-cn_image_0000002661612669.png)
...
```
 ![](./img/zh-cn_image_0000002631413378.gif)
...
```
 ![](./img/zh-cn_image_0000002661732609.gif)
...
```
 ![](./img/zh-cn_image_0000002631253488.gif)
...
```
 ![](./img/zh-cn_image_0000002661612671.gif)
...
```
 ![](./img/zh-cn_image_0000002631413380.gif)
...
```
 ![](./img/zh-cn_image_0000002661732611.png)
...
```
 ![](./img/zh-cn_image_0000002631253490.gif)
...
```
 ![](./img/zh-cn_image_0000002661612673.png) ![](./img/zh-cn_image_0000002631413382.png)
...
```
 ![](./img/zh-cn_image_0000002661732613.png)
...
```
 ![](./img/zh-cn_image_0000002631253492.png)
...
```
 ![](./img/zh-cn_image_0000002661612675.jpg)
...
```
 ![](./img/zh-cn_image_0000002631413384.jpg)
...
```
 ![](./img/zh-cn_image_0000002661732615.gif)
...
```
 ![](./img/zh-cn_image_0000002631253494.gif)
...
```
 ![](./img/zh-cn_image_0000002661612677.png)
...
```
 ![](./img/zh-cn_image_0000002631413386.gif)
...
```
 ![](./img/zh-cn_image_0000002661732617.png)
...
```
 ![](./img/zh-cn_image_0000002631253496.gif)
...
```
 ![](./img/zh-cn_image_0000002661612679.gif)
