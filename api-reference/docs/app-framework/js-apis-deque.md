...
upstream_id: "harmonyos-references/js-apis-deque"
catalog: "harmonyos-references"
content_hash: "c3cb1f2a8dd9"
synced_at: "2026-07-28T16:40:57.406592"
---
...
| deque | [Deque](#deque) | 否 | 当前调用forEach方法的实例对象，即正在遍历的Deque实例。 |
...
| 类型 | 说明 |
| --- | --- |
| IterableIterator | 返回一个迭代器，用于遍历Deque实例中的所有元素。 |
