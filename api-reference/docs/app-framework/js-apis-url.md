...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| init | string[][] | Record | string | URLParams | 否 | 入参对象。 - string[][]：字符串二维数组。 - Record：对象列表。 - string：URL查询参数字符串。 - URLParams：URLParams实例对象。 - 默认值：null。 |
...
| 类型 | 说明 |
| --- | --- |
| IterableIterator | 返回一个迭代器，迭代器的每一项为包含name和value的[string, string]数组。 |
...
![](./img/note_3.0-zh-cn.png) 若查找一个不存在的键值对名称时返回值为undefined。
...
| 类型 | 说明 |
| --- | --- |
| IterableIterator | 返回一个包含所有键值对的name的迭代器。 |
...
| 类型 | 说明 |
| --- | --- |
| IterableIterator | 返回一个包含所有键值对的value的迭代器。 |
...
![](./img/note_3.0-zh-cn.png) 当入参url是相对URL时，调用该接口解析后的URL并不是简单地将入参url和base直接拼接。url内容为相对路径格式时，会相对于base的当前目录进行解析，包括base中path字段最后一个斜杠前的所有路径片段，但不包括其后的部分（参照示例中url1）。url内容为指向根目录的格式时，会相对于 base 的原始地址（origin）进行解析（参照示例中url2）。
...
![](./img/note_3.0-zh-cn.png) 从API version 7开始支持，从API version 9开始废弃，建议使用[URLParams](#urlparams9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7开始支持，从API version 9开始废弃，建议使用[URLParams.constructor9+](#constructor9)替代。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| init | string[][] | Record | string | URLSearchParams | 否 | 入参对象。 - string[][]：字符串二维数组，每个内部数组包含两个元素，分别为键名和键值。 - Record：对象列表。 - string：字符串，需遵循URL查询参数格式，如'key=value&key2=value2'。 - URLSearchParams：对象。 - 默认值：undefined。 |
...
![](./img/note_3.0-zh-cn.png) 从API version 7开始支持，从API version 9开始废弃，建议使用[URLParams.append9+](#append9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7开始支持，从API version 9开始废弃，建议使用[URLParams.delete9+](#delete9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7开始支持，从API version 9开始废弃，建议使用[URLParams.getAll9+](#getall9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7开始支持，从API version 9开始废弃，建议使用[URLParams.entries9+](#entries9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7开始支持，从API version 9开始废弃，建议使用[URLParams.forEach9+](#foreach9)替代。
...
![](./img/note_3.0-zh-cn.png) 若查找一个不存在的键值对名称时返回值为undefined。从API version 7开始支持，从API version 9开始废弃，建议使用[URLParams.get9+](#get9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7开始支持，从API version 9开始废弃，建议使用[URLParams.has9+](#has9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7开始支持，从API version 9开始废弃，建议使用[URLParams.set9+](#set9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7开始支持，从API version 9开始废弃，建议使用[URLParams.sort9+](#sort9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7开始支持，从API version 9开始废弃，建议使用[URLParams.keys9+](#keys9)替代。
...
| 类型 | 说明 |
| --- | --- |
| IterableIterator | 返回一个所有键值对的name的迭代器。 |
...
![](./img/note_3.0-zh-cn.png) 从API version 7开始支持，从API version 9开始废弃，建议使用[URLParams.values9+](#values9)替代。
...
| 类型 | 说明 |
| --- | --- |
| IterableIterator | 返回一个所有键值对的value的迭代器。 |
...
![](./img/note_3.0-zh-cn.png) 从API version 7开始支持，从API version 9开始废弃，建议使用[URLParams.[Symbol.iterator]9+](#symboliterator9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7开始支持，从API version 9开始废弃，建议使用[URLParams.toString9+](#tostring9)替代。
