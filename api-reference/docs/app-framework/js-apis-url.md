...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| init | string[][] | Record | string | URLParams | 否 | 入参对象。 - string[][]：字符串二维数组。 - Record：对象列表。 - string：字符串。 - URLParams：对象。 - 默认值：null。 |
...
| 类型 | 说明 |
| --- | --- |
| IterableIterator | 返回一个包含所有键值对的name的ES6迭代器。 |
...
| 类型 | 说明 |
| --- | --- |
| IterableIterator | 返回一个包含所有键值对的value的ES6迭代器。 |
...
| searchParams(deprecated) | [URLSearchParams](#urlsearchparamsdeprecated) | 是 | 否 | 获取URLSearchParams表示URL查询参数的对象。 - **说明：** 此属性从API version 7开始支持，从API version 9开始被废弃。建议使用params9+替代。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| init | string[][] | Record | string | URLSearchParams | 否 | 入参对象。 - string[][]：字符串二维数组。 - Record：对象列表。 - string：字符串。 - URLSearchParams：对象。 - 默认值：undefined。 |
