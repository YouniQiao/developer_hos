...
| callback | AsyncCallback | 是 | 回调函数。当操作成功，err为undefined，data为RdbStore对象；否则为错误对象。 |
...
![](./img/note_3.0-zh-cn.png) 其中devices通过调用deviceManager.getTrustedDeviceListSync方法得到。deviceManager模块的接口均为系统接口，仅系统应用可用。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| devices | Array | 是 | 指定的组网内的远程设备ID，不能为空字符串。 |

返回值：

| 类型 | 说明 |
| --- | --- |
| [RdbPredicates](#rdbpredicates) | 返回配置了指定远程设备同步条件的谓词。 |
...
| 类型 | 说明 |
| --- | --- |
| [RdbPredicates](#rdbpredicates) | 返回配置了所有远程设备同步条件的谓词。 |
...
| 类型 | 说明 |
| --- | --- |
| [RdbPredicates](#rdbpredicates) | 返回配置了等于指定值条件的谓词。 |
...
| 类型 | 说明 |
| --- | --- |
| [RdbPredicates](#rdbpredicates) | 返回配置了不等于指定值条件的谓词。 |
...
| 类型 | 说明 |
| --- | --- |
| [RdbPredicates](#rdbpredicates) | 返回配置了包含指定值条件的谓词。 |
...
| 类型 | 说明 |
| --- | --- |
| [RdbPredicates](#rdbpredicates) | 返回配置了以指定字符串开头条件的谓词。 |
...
| 类型 | 说明 |
| --- | --- |
| [RdbPredicates](#rdbpredicates) | 返回配置了以指定字符串结尾条件的谓词。 |
...
| 类型 | 说明 |
| --- | --- |
| [RdbPredicates](#rdbpredicates) | 返回配置了值不为null条件的谓词。 |
...
| 类型 | 说明 |
| --- | --- |
| [RdbPredicates](#rdbpredicates) | 返回配置了类似指定字符串条件的谓词。 |
...
| 类型 | 说明 |
| --- | --- |
| [RdbPredicates](#rdbpredicates) | 返回配置了匹配指定通配符模式条件的谓词。 |
...
| 类型 | 说明 |
| --- | --- |
| [RdbPredicates](#rdbpredicates) | 返回配置了在给定范围内条件的谓词。 |
...
配置RdbPredicates以匹配数据字段为ValueType值超出给定范围的指定字段。该方法等同于SQL语句中的"NOT BETWEEN"。
...
| 类型 | 说明 |
| --- | --- |
| [RdbPredicates](#rdbpredicates) | 返回配置了超出给定范围条件的谓词。 |
...
| 类型 | 说明 |
| --- | --- |
| [RdbPredicates](#rdbpredicates) | 返回配置了大于指定值条件的谓词。 |
...
| 类型 | 说明 |
| --- | --- |
| [RdbPredicates](#rdbpredicates) | 返回配置了小于指定值条件的谓词。 |
...
| 类型 | 说明 |
| --- | --- |
| [RdbPredicates](#rdbpredicates) | 返回配置了大于或等于指定值条件的谓词。 |
...
| 类型 | 说明 |
| --- | --- |
| [RdbPredicates](#rdbpredicates) | 返回配置了小于或等于指定值条件的谓词。 |
...
| 类型 | 说明 |
| --- | --- |
| [RdbPredicates](#rdbpredicates) | 返回配置了按升序排序条件的谓词。 |
...
| 类型 | 说明 |
| --- | --- |
| [RdbPredicates](#rdbpredicates) | 返回配置了按降序排序条件的谓词。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| fields | Array | 是 | 指定分组依赖的列名，不能为空字符串。 |
...
| 类型 | 说明 |
| --- | --- |
| [RdbPredicates](#rdbpredicates) | 返回配置了值在给定范围内条件的谓词。 |
...
| --- | --- | --- | --- |
| field | string | 是 | 数据库表中的列名，不能为空字符串。 |
| value | Array | 是 | 以ValueType数组形式指定的要匹配的值。 |

返回值：

| 类型 | 说明 |
| --- | --- |
| [RdbPredicates](#rdbpredicates) | 返回配置了值超出给定范围内条件的谓词。 |
...
| callback | AsyncCallback | 是 | 回调函数。当操作成功，err为undefined，data为行ID；否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象。如果操作成功，返回行ID；否则返回-1。 |
...
| callback | AsyncCallback | 是 | 回调函数。当操作成功，err为undefined，data为插入的数据个数；否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象。如果操作成功，返回插入的数据个数，否则返回-1。 |
...
| callback | AsyncCallback | 是 | 回调函数。当操作成功，err为undefined，data为受影响的行数；否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象。如果操作成功，则返回ResultSet对象。 |
...
#### [h2]obtainDistributedTableName8+

obtainDistributedTableName(device: string, table: string, callback: AsyncCallback<string>): void

根据远程设备的本地表名获取指定远程设备的分布式表名。在查询远程设备数据库时，需要使用分布式表名，使用callback异步回调。

![](./img/note_3.0-zh-cn.png) 其中device通过调用deviceManager.getTrustedDeviceListSync方法得到。deviceManager模块的接口均为系统接口，仅系统应用可用。
...
| callback | AsyncCallback | 是 | 回调函数。当操作成功，err为undefined，data为远程设备的分布式表名；否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象。如果操作成功，返回远程设备的分布式表名。 |
...
| callback | AsyncCallback> | 是 | 回调函数。当操作成功，err为undefined，data为同步结果，其中string为设备ID，number为每个设备同步状态，0表示成功，其他值表示失败；否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise> | Promise对象，用于向调用者发送同步结果。string：设备ID；number：每个设备同步状态，0表示成功，其他值表示失败。 |
