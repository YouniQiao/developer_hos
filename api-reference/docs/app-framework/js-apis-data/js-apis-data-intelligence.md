...
| 类型 | 说明 |
| --- | --- |
| Promise> | Promise对象，返回向量化结果的数组对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| batchTexts | Array | 是 | 嵌入模型的文本输入批次。单个文本长度上限为512个字符。 |
