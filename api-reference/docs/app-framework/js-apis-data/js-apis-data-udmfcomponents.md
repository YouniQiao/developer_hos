...
content_hash: "25b96b6c36ab"
synced_at: "2026-07-28T16:40:50.551580"
---
...
![](./img/note_3.0-zh-cn.png) 该组件从API version 20开始支持。后续版本如有新增内容，则采用上角标单独标记该内容的起始版本。
...
| 名称 | 类型 | 必填 | 装饰器类型 | 说明 |
| --- | --- | --- | --- | --- |
| contentFormData | [uniformDataStruct.ContentForm](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-data-uniformdatastruct#contentform14) | 是 | - | 内容卡片数据，用于设置卡片展示的标题、描述、应用图标、应用名称、跳转链接或内容图片等信息。 |
...
![](./img/zh-cn_image_0000002686087671.jpeg)
