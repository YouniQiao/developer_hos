---
title: "oh_archive.h"
upstream_id: "harmonyos-references/capi-oh-archive-h"
catalog: "harmonyos-references"
content_hash: "aa61645c79f2"
synced_at: "2026-07-28T16:50:04.066085"
---
...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [OH_Archive_StreamInfo](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-archive-oh-archive-streaminfo) | OH_Archive_StreamInfo | 流式压缩/解压缩信息结构体。 |
| [OH_Archive_Stream_Config](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-archive-oh-archive-stream-config) | OH_Archive_Stream_Config | 流式压缩配置结构体。 |
| [ArchiveWriteCtx*](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-archive-archivewritectx) | OH_Archive_Writer_Ctx | 文件压缩器的上下文结构体指针。 |
| [ArchiveReadCtx*](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-archive-archivereadctx) | OH_Archive_Reader_Ctx | 文件解压缩器的上下文结构体指针。 |
| [ArchiveStreamWriteCtx*](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-archive-archivestreamwritectx) | OH_Archive_StreamWrite_Ctx | 流式压缩器的上下文结构体指针。 |
| [ArchiveStreamReadCtx*](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-archive-archivestreamreadctx) | OH_Archive_StreamRead_Ctx | 流式解压缩器的上下文结构体指针。 |
...
| [OH_Archive_CompressMethod](#oh_archive_compressmethod) | OH_Archive_CompressMethod | 压缩算法枚举。 |
...
| [OH_Archive_ErrCode OH_Archive_Reader_SetProgressHandlerWithData(OH_Archive_Reader_Ctx arc, OH_Archive_ProgressHandlerWithData progressHandler, void *userData)](#oh_archive_reader_setprogresshandlerwithdata) | - | 设置文件解压缩器的进度回调函数及用户数据。 |
| [OH_Archive_ErrCode OH_Archive_Reader_ExtractAllFile(OH_Archive_Reader_Ctx arc, const char *outDir)](#oh_archive_reader_extractallfile) | - | 从压缩包中提取所有文件。 |
...
| [OH_Archive_ErrCode OH_Archive_StreamWrite_SetCompressLevel(OH_Archive_StreamWrite_Ctx ctx, int32_t compressLevel)](#oh_archive_streamwrite_setcompresslevel) | - | 设置流式压缩的压缩级别。 |
...
| [OH_Archive_StreamRead_Ctx OH_Archive_StreamRead_Create(OH_Archive_Stream_Config config)](#oh_archive_streamread_create) | - | 创建流式解压缩的上下文结构体。 |
...
| [OH_Archive_ErrCode OH_Archive_StreamRead_Cancel(OH_Archive_StreamRead_Ctx ctx)](#oh_archive_streamread_cancel) | - | 强制取消当前解压缩操作。 |
...
| 枚举项 | 描述 |
| --- | --- |
| OH_ARCHIVE_FMT_ZIP = 0 | ZIP格式。 **起始版本：** 26.0.0 |

#### [h2]OH_Archive_CompressMethod
...
| 枚举项 | 描述 |
| --- | --- |
| OH_ARCHIVE_NO_COMPRESSION = 0 | 不压缩。 **起始版本：** 26.0.0 |
| OH_ARCHIVE_COMPRESS_DEFLATE = 8 | DEFLATE压缩算法。 **起始版本：** 26.0.0 |

#### [h2]OH_Archive_OpenMode
...
| 枚举项 | 描述 |
| --- | --- |
| OH_ARCHIVE_OPEN_MODE_CREATE = 0 | 创建模式。新建一个文件，如果文件已存在，则覆盖。 **起始版本：** 26.0.0 |

#### [h2]OH_Archive_ProgressType
...
| 枚举项 | 描述 |
| --- | --- |
| OH_ARCHIVE_PROGRESS_CONTINUE = 0 | 继续压缩/解压缩操作。 **起始版本：** 26.0.0 |
| OH_ARCHIVE_PROGRESS_CANCEL = 1 | 取消压缩/解压缩操作。 **起始版本：** 26.0.0 |

#### [h2]OH_Archive_StreamChecksumAlg
...
| 枚举项 | 描述 |
| --- | --- |
| OH_ARCHIVE_NO_CHECKSUM = 0 | 不额外计算哈希值。 **起始版本：** 26.0.0 |
| OH_ARCHIVE_CRC32 = 1 | 使用CRC32（Cyclic Redundancy Check，循环冗余校验）计算校验和。 **起始版本：** 26.0.0 |

#### 函数说明

#### [h2]OH_Archive_ProgressHandlerWithData()
...
| 类型 | 说明 |
| --- | --- |
| [OH_Archive_ProgressType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-oh-archive-h#oh_archive_progresstype) | OH_ARCHIVE_PROGRESS_CONTINUE - 继续当前压缩/解压缩操作。 OH_ARCHIVE_PROGRESS_CANCEL - 取消当前压缩/解压缩操作。 |

#### [h2]OH_Archive_Stream_OutputHandler()
...
| 类型 | 说明 |
| --- | --- |
| [OH_Archive_Reader_Ctx](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-archive-archivereadctx) | 返回文件读取器的上下文结构体，操作失败时返回NULL。 |

#### [h2]OH_Archive_Reader_SetProgressHandlerWithData()
...
| 参数项 | 描述 |
| --- | --- |
| [OH_Archive_Reader_Ctx](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-archive-archivereadctx) arc | 文件解压缩器上下文句柄。 |
| [OH_Archive_ProgressHandlerWithData](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-oh-archive-h#oh_archive_progresshandlerwithdata) progressHandler | 用于处理进度更新的回调函数。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH_Archive_ErrCode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-oh-archive-errcode-h#oh_archive_errcode) | 返回接口执行的结果。成功返回OH_ARCHIVE_OK，失败返回对应错误码。 |

#### [h2]OH_Archive_Reader_ExtractAllFile()
...
| [OH_Archive_OpenMode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-oh-archive-h#oh_archive_openmode) openMode | 文件打开模式。 |
| [OH_Archive_Format](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-oh-archive-h#oh_archive_format) fmt | 压缩包格式。 |

返回：

| 类型 | 说明 |
| --- | --- |
| [OH_Archive_Writer_Ctx](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-archive-archivewritectx) | 返回文件压缩器上下文句柄，操作失败时返回NULL。 |

#### [h2]OH_Archive_Writer_SetCompressMethod()
...
| 参数项 | 描述 |
| --- | --- |
| [OH_Archive_Writer_Ctx](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-archive-archivewritectx) arc | 文件压缩器的上下文句柄。 |
| [OH_Archive_CompressMethod](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-oh-archive-h#oh_archive_compressmethod) method | 压缩算法。 |
...
#### [h2]OH_Archive_Writer_SetProgressHandlerWithData()
...
| 参数项 | 描述 |
| --- | --- |
| [OH_Archive_Writer_Ctx](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-archive-archivewritectx) arc | 文件压缩器上下文句柄。 |
| [OH_Archive_ProgressHandlerWithData](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-oh-archive-h#oh_archive_progresshandlerwithdata) progressHandler | 用于处理进度更新的回调函数。 |
| void *userData | 用户处理进度回调时自定义的上下文数据。 |
...
#### [h2]OH_Archive_BufferWriteCompressBound()
...
| 参数项 | 描述 |
| --- | --- |
| [OH_Archive_CompressMethod](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-oh-archive-h#oh_archive_compressmethod) method | 压缩算法类型。当前仅支持OH_ARCHIVE_COMPRESS_DEFLATE。 |
...
| 类型 | 说明 |
| --- | --- |
| uint64_t | 返回压缩后数据大小的最大值，单位为bytes。 |

#### [h2]OH_Archive_BufferWrite()
...
| uint64_t *dstSize | 指向目标缓冲区大小的指针，传入缓冲区大小，输出实际写入的大小，单位为bytes。 |
...
| uint64_t *dstSize | 指向目标缓冲区大小的指针，传入缓冲区大小，输出实际解压缩后的大小，单位为bytes。 |
| const uint8_t *srcBuffer | 指向包含待解压缩数据的源缓冲区的指针。 |
| uint64_t srcSize | 源缓冲区数据的大小，单位为bytes。 |
| [OH_Archive_CompressMethod](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-oh-archive-h#oh_archive_compressmethod) method | 解压缩算法类型。当前仅支持OH_ARCHIVE_COMPRESS_DEFLATE。 |
...
#### [h2]OH_Archive_StreamWrite_Create()
...
| 参数项 | 描述 |
| --- | --- |
| [OH_Archive_Stream_Config](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-archive-oh-archive-stream-config) config | 压缩配置。 |

返回：

| 类型 | 说明 |
| --- | --- |
| [OH_Archive_StreamWrite_Ctx](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-archive-archivestreamwritectx) | 返回流式压缩的上下文结构体。创建失败时返回NULL。 |

#### [h2]OH_Archive_StreamWrite_Start()
...
| 参数项 | 描述 |
| --- | --- |
| [OH_Archive_StreamWrite_Ctx](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-archive-archivestreamwritectx) ctx | 流式压缩的上下文结构体。 |
| [OH_Archive_Stream_OutputHandler](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-oh-archive-h#oh_archive_stream_outputhandler) outputHandler | 用户自定义的压缩数据回调函数。 |
| void* userData | 用户自定义上下文，将在回调中传回。userData由调用方持有，在[OH_Archive_StreamWrite_End](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-oh-archive-h#oh_archive_streamwrite_end)完成前必须保持有效。 |
...
#### [h2]OH_Archive_StreamWrite_SetCompressLevel()
...
#### [h2]OH_Archive_StreamWrite_Cancel()
...
| 类型 | 说明 |
| --- | --- |
| [OH_Archive_ErrCode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-oh-archive-errcode-h#oh_archive_errcode) | 返回接口执行的结果。取消成功返回OH_ARCHIVE_OK，失败返回对应错误码。 |

#### [h2]OH_Archive_StreamWrite_Update()
...
| 类型 | 说明 |
| --- | --- |
| [OH_Archive_ErrCode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-oh-archive-errcode-h#oh_archive_errcode) | 返回接口执行的结果。压缩成功返回OH_ARCHIVE_OK，失败返回对应错误码。 |

#### [h2]OH_Archive_StreamWrite_End()
...
| --- | --- |
| [OH_Archive_StreamWrite_Ctx](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-archive-archivestreamwritectx) ctx | 流式压缩的上下文结构体。 |
| [OH_Archive_StreamInfo](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-archive-oh-archive-streaminfo) *streamInfo | 压缩信息，包括原始数据大小、压缩后数据大小和CRC32值。 |
...
#### [h2]OH_Archive_StreamWrite_Destroy()
...
#### [h2]OH_Archive_StreamRead_Create()
...
| 参数项 | 描述 |
| --- | --- |
| [OH_Archive_Stream_Config](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-archive-oh-archive-stream-config) config | 解压缩配置信息。 |

返回：

| 类型 | 说明 |
| --- | --- |
| [OH_Archive_StreamRead_Ctx](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-archive-archivestreamreadctx) | 返回流式解压缩的上下文结构体。创建失败时返回NULL。 |

#### [h2]OH_Archive_StreamRead_Start()
...
| 参数项 | 描述 |
| --- | --- |
| [OH_Archive_StreamRead_Ctx](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-archive-archivestreamreadctx) ctx | 流式解压缩的上下文结构体。 |
| [OH_Archive_Stream_OutputHandler](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-oh-archive-h#oh_archive_stream_outputhandler) outputHandler | 用户自定义的解压缩数据回调函数。 |
| void* userData | 用户自定义上下文数据，将在回调中传回。userData由调用方拥有，在[OH_Archive_StreamRead_End](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-oh-archive-h#oh_archive_streamread_end)完成前必须保持有效。 |
...
#### [h2]OH_Archive_StreamRead_Cancel()
...
#### [h2]OH_Archive_StreamRead_Update()
...
| --- | --- |
| [OH_Archive_StreamRead_Ctx](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-archive-archivestreamreadctx) ctx | 流式解压缩的上下文结构体。 |
| [OH_Archive_StreamInfo](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-archive-oh-archive-streaminfo) *streamInfo | 解压缩信息，包括原始数据大小、压缩后数据大小和CRC32值。 |
...
#### [h2]OH_Archive_StreamRead_Destroy()
