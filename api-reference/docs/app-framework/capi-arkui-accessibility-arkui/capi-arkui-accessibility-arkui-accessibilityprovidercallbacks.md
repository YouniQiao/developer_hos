...
| int32_t requestId | 表示请求ID。 |
| [ArkUI_AccessibilityElementInfo](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-accessibility-arkui-accessibilityelementinfo)* elementInfo | 表示查询到的无障碍元素信息。 |
