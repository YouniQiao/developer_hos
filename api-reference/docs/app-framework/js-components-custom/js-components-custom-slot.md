---
title: "slot插槽"
upstream_id: "harmonyos-references/js-components-custom-slot"
catalog: "harmonyos-references"
content_hash: "74f947ef4c5e"
synced_at: "2026-07-09T00:58:25.899984"
---

# slot插槽

![](./img/note_3.0-zh-cn.png) 从API version 7 开始支持。后续版本如有新增内容，则采用上角标单独标记该内容的起始版本。
...
```
 ![](./img/note_3.0-zh-cn.png) name 和 slot 属性不支持绑定动态数据。
