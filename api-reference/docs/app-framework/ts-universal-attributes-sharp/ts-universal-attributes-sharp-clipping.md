...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [CircleShape](#circleshape12) | [EllipseShape](#ellipseshape12) | [PathShape](#pathshape12) | [RectShape](#rectshape12) | 是 | 参数为相应类型的组件，按指定的形状（形状中可包含位置信息）对当前组件进行裁剪。 **说明：** 裁剪不会导致被裁剪区域无法响应绑定的手势事件。 |
...
| 类型 | 说明 |
| --- | --- |
| import('../api/@ohos.arkui.shape').[CircleShape](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-arkui-shape#circleshape) | 圆形形状。 |
...
| 类型 | 说明 |
| --- | --- |
| import('../api/@ohos.arkui.shape').[EllipseShape](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-arkui-shape#ellipseshape) | 椭圆形状。 |
...
| 类型 | 说明 |
| --- | --- |
| import('../api/@ohos.arkui.shape').[PathShape](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-arkui-shape#pathshape) | 路径形状。 |
...
| 类型 | 说明 |
| --- | --- |
| import('../api/@ohos.arkui.shape').[RectShape](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-arkui-shape#rectshape) | 矩形形状。 |
