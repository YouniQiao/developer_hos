...
content_hash: "61047c00fca4"
synced_at: "2026-07-28T16:49:11.631360"
---
...
1. 逻辑像素px（文档中以表示）： 默认卡片具有的逻辑宽度为150px，实际显示时会将页面布局缩放至屏幕实际宽度，如100px在宽度为300的卡片上，实际渲染为200物理像素（从150px向300物理像素，所有尺寸放大2倍）。
