...
| 名称 | 类型 | 默认值 | 必填 | 描述 |
| --- | --- | --- | --- | --- |
| color | | #ffffff | 否 | 候选项字体颜色。 |
| font-size | | 16px | 否 | 候选项字体尺寸，类型length，单位px。 |
| selected-color | | #ff0a69f7 | 否 | 选中项字体颜色。 |
| selected-font-size | | 20px | 否 | 选中项字体尺寸，类型length，单位px。 |
| disappear-color5+ | | #ffffff | 否 | 渐变消失项的字体颜色。消失项是在一列中有五个选项场景下最上和最下的两个选项。 |
| disappear-font-size5+ | | 14px | 否 | 渐变消失项的字体尺寸。消失项是在一列中有五个选项场景下最上和最下的两个选项。 |
