...
content_hash: "01506c01548e"
synced_at: "2026-09-04T18:11:41.876348"
---
...
```
// 在元服务中，本示例仅用于说明writeInt()接口的使用方法，示例中rpc.MessageSequence.create()暂不支持在元服务中调用。
import { rpc } from '@kit.IPCKit';
import { hilog } from '@kit.PerformanceAnalysisKit';
import { BusinessError } from '@kit.BasicServicesKit';
...
```
// 在元服务中，本示例仅用于说明readInt()接口的使用方法，示例中rpc.MessageSequence.create()暂不支持在元服务中调用。
import { rpc } from '@kit.IPCKit';
import { hilog } from '@kit.PerformanceAnalysisKit';
import { BusinessError } from '@kit.BasicServicesKit';
...
```
// 在元服务中，本示例仅用于说明writeString()接口的使用方法，示例中rpc.MessageSequence.create()暂不支持在元服务中调用。
import { rpc } from '@kit.IPCKit';
import { hilog } from '@kit.PerformanceAnalysisKit';
import { BusinessError } from '@kit.BasicServicesKit';
...
```
// 在元服务中，本示例仅用于说明readString()接口的使用方法，示例中rpc.MessageSequence.create()暂不支持在元服务中调用。
import { rpc } from '@kit.IPCKit';
import { hilog } from '@kit.PerformanceAnalysisKit';
import { BusinessError } from '@kit.BasicServicesKit';
...
![](./img/note_3.0-zh-cn.png) 在本文档的示例中，通过this.getUIContext().getHostContext()来获取UIAbilityContext，其中this代表继承自UIAbility的UIAbility实例。如需要在页面中使用UIAbilityContext提供的能力，请参见[获取UIAbility的上下文信息](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/uiability-usage#获取uiability的上下文信息)。
...
![](./img/note_3.0-zh-cn.png) 从API version 9 开始支持，API version 11 开始废弃，建议使用[writeRawDataBuffer](#writerawdatabuffer11)替代。
...
![](./img/note_3.0-zh-cn.png) 该接口是一次性接口，不允许在一次parcel通信中多次调用该接口。
...
![](./img/note_3.0-zh-cn.png) 从API version 9 开始支持，API version 11 开始废弃，建议使用[readRawDataBuffer](#readrawdatabuffer11)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7 开始支持，API version 9 开始废弃，建议使用[MessageSequence](#messagesequence9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7 开始支持，API version 9 开始废弃，建议使用[create](#create9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7 开始支持，API version 9 开始废弃，建议使用[reclaim](#reclaim9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7 开始支持，API version 9 开始废弃，建议使用[writeRemoteObject](#writeremoteobject9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7 开始支持，API version 9 开始废弃，建议使用[readRemoteObject](#readremoteobject9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7 开始支持，API version 9 开始废弃，建议使用[writeInterfaceToken](#writeinterfacetoken9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7 开始支持，API version 9 开始废弃，建议使用[readInterfaceToken](#readinterfacetoken9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7 开始支持，API version 9 开始废弃，建议使用[getSize](#getsize9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7 开始支持，API version 9 开始废弃，建议使用[getCapacity](#getcapacity9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7 开始支持，API version 9 开始废弃，建议使用[setSize](#setsize9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7 开始支持，API version 9 开始废弃，建议使用[setCapacity](#setcapacity9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7 开始支持，API version 9 开始废弃，建议使用[getWritableBytes](#getwritablebytes9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7 开始支持，API version 9 开始废弃，建议使用[getReadableBytes](#getreadablebytes9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7 开始支持，API version 9 开始废弃，建议使用[getReadPosition](#getreadposition9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7 开始支持，API version 9 开始废弃，建议使用[getWritePosition](#getwriteposition9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7 开始支持，API version 9 开始废弃，建议使用[rewindRead](#rewindread9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7 开始支持，API version 9 开始废弃，建议使用[rewindWrite](#rewindwrite9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7 开始支持，API version 9 开始废弃，建议使用[writeByte](#writebyte9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7 开始支持，API version 9 开始废弃，建议使用[readByte](#readbyte9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7 开始支持，API version 9 开始废弃，建议使用[writeShort](#writeshort9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7 开始支持，API version 9 开始废弃，建议使用[readShort](#readshort9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7 开始支持，API version 9 开始废弃，建议使用[writeInt](#writeint9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7 开始支持，API version 9 开始废弃，建议使用[readInt](#readint9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7 开始支持，API version 9 开始废弃，建议使用[writeLong](#writelong9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7 开始支持，API version 9 开始废弃，建议使用[readLong](#readlong9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7 开始支持，API version 9 开始废弃，建议使用[writeFloat](#writefloat9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7 开始支持，API version 9 开始废弃，建议使用[readFloat](#readfloat9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7 开始支持，API version 9 开始废弃，建议使用[writeDouble](#writedouble9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7 开始支持，API version 9 开始废弃，建议使用[readDouble](#readdouble9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7 开始支持，API version 9 开始废弃，建议使用[writeBoolean](#writeboolean9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7 开始支持，API version 9 开始废弃，建议使用[readBoolean](#readboolean9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7 开始支持，API version 9 开始废弃，建议使用[writeChar](#writechar9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7 开始支持，API version 9 开始废弃，建议使用[readChar](#readchar9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7 开始支持，API version 9 开始废弃，建议使用[writeString](#writestring9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7 开始支持，API version 9 开始废弃，建议使用[readString](#readstring9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7 开始支持，API version 9 开始废弃，建议使用[writeParcelable](#writeparcelable9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7 开始支持，API version 9 开始废弃，建议使用[readParcelable](#readparcelable9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7 开始支持，API version 9 开始废弃，建议使用[writeByteArray](#writebytearray9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7 开始支持，API version 9 开始废弃，建议使用[readByteArray](#readbytearray9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7 开始支持，API version 9 开始废弃，建议使用[readByteArray](#readbytearray9-1)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7 开始支持，API version 9 开始废弃，建议使用[writeShortArray](#writeshortarray9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7 开始支持，API version 9 开始废弃，建议使用[readShortArray](#readshortarray9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7 开始支持，API version 9 开始废弃，建议使用[readShortArray](#readshortarray9-1)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7 开始支持，API version 9 开始废弃，建议使用[writeIntArray](#writeintarray9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7 开始支持，API version 9 开始废弃，建议使用[readIntArray](#readintarray9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7 开始支持，API version 9 开始废弃，建议使用[readIntArray](#readintarray9-1)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7 开始支持，API version 9 开始废弃，建议使用[writeLongArray](#writelongarray9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7 开始支持，API version 9 开始废弃，建议使用[readLongArray](#readlongarray9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7 开始支持，API version 9 开始废弃，建议使用[readLongArray](#readlongarray9-1)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7 开始支持，API version 9 开始废弃，建议使用[writeFloatArray](#writefloatarray9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7 开始支持，API version 9 开始废弃，建议使用[readFloatArray](#readfloatarray9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7 开始支持，API version 9 开始废弃，建议使用[readFloatArray](#readfloatarray9-1)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7 开始支持，API version 9 开始废弃，建议使用[writeDoubleArray](#writedoublearray9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7 开始支持，API version 9 开始废弃，建议使用[readDoubleArray](#readdoublearray9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7 开始支持，API version 9 开始废弃，建议使用[readDoubleArray](#readdoublearray9-1)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7 开始支持，API version 9 开始废弃，建议使用[writeBooleanArray](#writebooleanarray9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7 开始支持，API version 9 开始废弃，建议使用[readBooleanArray](#readbooleanarray9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7 开始支持，API version 9 开始废弃，建议使用[readBooleanArray](#readbooleanarray9-1)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7 开始支持，API version 9 开始废弃，建议使用[writeCharArray](#writechararray9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7 开始支持，API version 9 开始废弃，建议使用[readCharArray](#readchararray9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7 开始支持，API version 9 开始废弃，建议使用[readCharArray](#readchararray9-1)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7 开始支持，API version 9 开始废弃，建议使用[writeStringArray](#writestringarray9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7 开始支持，API version 9 开始废弃，建议使用[readStringArray](#readstringarray9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7 开始支持，API version 9 开始废弃，建议使用[readStringArray](#readstringarray9-1)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8 开始支持，API version 9 开始废弃，建议使用[writeNoException](#writenoexception9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8 开始支持，API version 9 开始废弃，建议使用[readException](#readexception9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7 开始支持，API version 9 开始废弃，建议使用[writeParcelableArray](#writeparcelablearray9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8 开始支持，API version 9 开始废弃，建议使用[readParcelableArray](#readparcelablearray9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8 开始支持，API version 9 开始废弃，建议使用[writeRemoteObjectArray](#writeremoteobjectarray9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8 开始支持，API version 9 开始废弃，建议使用[readRemoteObjectArray](#readremoteobjectarray9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8 开始支持，API version 9 开始废弃，建议使用[closeFileDescriptor](#closefiledescriptor9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8 开始支持，API version 9 开始废弃，建议使用[dupFileDescriptor](#dupfiledescriptor9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8 开始支持，API version 9 开始废弃，建议使用[containFileDescriptors](#containfiledescriptors9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8 开始支持，API version 9 开始废弃，建议使用[writeFileDescriptor](#writefiledescriptor9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8 开始支持，API version 9 开始废弃，建议使用[readFileDescriptor](#readfiledescriptor9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8 开始支持，API version 9 开始废弃，建议使用[writeAshmem](#writeashmem9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8 开始支持，API version 9 开始废弃，建议使用[readAshmem](#readashmem9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8 开始支持，API version 9 开始废弃，建议使用[getRawDataCapacity](#getrawdatacapacity9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8 开始支持，API version 9 开始废弃，建议使用[writeRawDataBuffer](#writerawdatabuffer11)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8 开始支持，API version 9 开始废弃，建议使用[readRawDataBuffer](#readrawdatabuffer11)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7 开始支持，API version 9 开始废弃，建议使用[Parcelable](#parcelable9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7 开始支持，API version 9 开始废弃，建议使用[marshalling](#marshalling9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7 开始支持，API version 9 开始废弃，建议使用[unmarshalling](#unmarshalling9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8 开始支持，API version 9 开始废弃，建议使用[RequestResult](#requestresult9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7 开始支持，API version 9 开始废弃，建议使用[getLocalInterface](#getlocalinterface9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7 开始支持，API version 9 开始废弃，建议使用[sendMessageRequest](#sendmessagerequest9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8 开始支持，API version 9 开始废弃，建议使用[sendMessageRequest](#sendmessagerequest9)替代。
...
| options | [MessageOption](#messageoption) | 是 | 本次请求的同异步模式，默认同步调用。 |
| callback | AsyncCallback | 是 | 回调函数。当消息发送成功时，可从RequestResult中读取服务端返回的数据。 |
...
![](./img/note_3.0-zh-cn.png) 从API version 8 开始支持，API version 9 开始废弃，建议使用[sendMessageRequest](#sendmessagerequest9-1)替代。
...
| reply | [MessageParcel](#messageparceldeprecated) | 是 | 接收应答数据的MessageParcel对象。 |
| options | [MessageOption](#messageoption) | 是 | 本次请求的同异步模式，默认同步调用。 |
| callback | AsyncCallback | 是 | 接收发送结果的回调。 |
...
![](./img/note_3.0-zh-cn.png) 从API version 7 开始支持，API version 9 开始废弃，建议使用[registerDeathRecipient](#registerdeathrecipient9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7 开始支持，API version 9 开始废弃，建议使用[unregisterDeathRecipient](#unregisterdeathrecipient9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7 开始支持，API version 9 开始废弃，建议使用[getDescriptor](#getdescriptor9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7 开始支持，API version 8 开始废弃，建议使用[sendMessageRequest](#sendmessagerequest9-2)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8 开始支持，API version 9 开始废弃，建议使用[sendMessageRequest](#sendmessagerequest9-2)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8 开始支持，API version 9 开始废弃，建议使用[sendMessageRequest](#sendmessagerequest9-3)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7 开始支持，API version 9 开始废弃，建议使用[getLocalInterface](#getlocalinterface9-1)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7 开始支持，API version 9 开始废弃，建议使用[registerDeathRecipient](#registerdeathrecipient9-1)类替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7 开始支持，API version 9 开始废弃，建议使用[unregisterDeathRecipient](#unregisterdeathrecipient9-1)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7 开始支持，API version 9 开始废弃，建议使用[getDescriptor](#getdescriptor9-1)替代。
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| TF_SYNC | number | 是 | 否 | 同步调用标识。 **元服务API：** 从API版本26.0.0开始，该接口支持在元服务中使用。 |
| TF_ASYNC | number | 是 | 否 | 异步调用标识。 **元服务API：** 从API版本26.0.0开始，该接口支持在元服务中使用。 |
| TF_ACCEPT_FDS | number | 是 | 否 | 指示[sendMessageRequest](#sendmessagerequest9-2)接口可以传递文件描述符。 **元服务API：** 从API版本26.0.0开始，该接口支持在元服务中使用。 |
| TF_WAIT_TIME | number | 是 | 否 | RPC等待时间（单位：秒），IPC场景下无效。默认等待为8秒（不建议修改等待时间）。 **元服务API：** 从API版本26.0.0开始，该接口支持在元服务中使用。 |
...
![](./img/note_3.0-zh-cn.png) 从API version 7 开始支持，API version 9 开始废弃，建议使用[flushCmdBuffer](#flushcmdbuffer9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7 开始支持，API version 9 开始废弃，建议使用[restoreCallingIdentity](#restorecallingidentity9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7 开始支持，API version 8 开始废弃，建议使用[sendMessageRequest](#sendmessagerequest9-4)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8 开始支持，API version 9 开始废弃，建议使用[sendMessageRequest](#sendmessagerequest9-4)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8 开始支持，API version 9 开始废弃，建议使用[sendMessageRequest](#sendmessagerequest9-5)替代。
...
![](./img/note_3.0-zh-cn.png) 开发者应优先选择重写带有CallingInfo参数的onRemoteMessageRequest方法，其中可以自由实现同步和异步的消息处理。
...
| 类型 | 说明 |
| --- | --- |
| boolean | Promise | - 若在onRemoteMessageRequest中同步处理请求，则返回一个布尔值。返回true表示操作成功，返回false表示操作失败。 - 若在onRemoteMessageRequest中异步处理请求，则返回一个Promise对象。返回true表示操作成功，返回false表示操作失败。 |
...
![](./img/note_3.0-zh-cn.png) 开发者应优先选择重写onRemoteMessageRequest方法，其中可以自由实现同步和异步的消息处理。
...
![](./img/note_3.0-zh-cn.png) 从API version 7 开始支持，API version 9 开始废弃，建议使用[onRemoteMessageRequest](#onremotemessagerequest9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7 开始支持，API version 9 开始废弃，建议使用[getLocalInterface](#getlocalinterface9-2)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7 开始支持，API version 9 开始废弃，建议使用[getDescriptor](#getdescriptor9-2)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7 开始支持，API version 9 开始废弃，建议使用[modifyLocalInterface](#modifylocalinterface9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8 开始支持，API version 9 开始废弃，建议使用[create](#create9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8 开始支持，API version 9 开始废弃，建议使用[create](#create9-1)替代。
...
![](./img/note_3.0-zh-cn.png) 关闭Ashmem对象前需要先解除地址映射。
...
![](./img/note_3.0-zh-cn.png) 从API version 8 开始支持，API version 9 开始废弃，建议使用[mapTypedAshmem](#maptypedashmem9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8 开始支持，API version 9 开始废弃，建议使用[mapReadWriteAshmem](#mapreadwriteashmem9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8 开始支持，API version 9 开始废弃，建议使用[mapReadonlyAshmem](#mapreadonlyashmem9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8 开始支持，API version 9 开始废弃，建议使用[setProtectionType](#setprotectiontype9)替代。
...
![](./img/note_3.0-zh-cn.png) 对Ashmem对象进行写操作时，需要先调用[mapReadWriteAshmem](#mapreadwriteashmem9)进行映射。
...
![](./img/note_3.0-zh-cn.png) 从API version 9 开始支持，API version 11 开始废弃，建议使用[writeDataToAshmem](#writedatatoashmem11)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8 开始支持，API version 9 开始废弃，建议使用[writeDataToAshmem](#writedatatoashmem11)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 9 开始支持，API version 11 开始废弃，建议使用[readDataFromAshmem](#readdatafromashmem11)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8 开始支持，API version 9 开始废弃，建议使用[readDataFromAshmem](#readdatafromashmem11)替代。
