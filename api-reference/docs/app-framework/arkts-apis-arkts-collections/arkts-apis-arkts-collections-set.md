...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| iterable | Iterable | 是 | 用于构造ArkTS Set的可迭代对象。 |
...
| 类型 | 说明 |
| --- | --- |
| IterableIterator | 返回一个Set迭代器对象，该对象包含了此Set中每个元素的键值对。 |
...
| 类型 | 说明 |
| --- | --- |
| IterableIterator | 返回一个Set迭代器对象，该对象包含了此Set中每个元素的键。 |
...
| 类型 | 说明 |
| --- | --- |
| IterableIterator | 返回一个Set迭代器对象，该对象包含了此Set中每个元素的值。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callbackFn | (value: T, value2: T, set: Set) => void | 是 | 回调函数。回调执行期间不应修改当前Set对象，否则会触发并发修改错误。 |
...
| 类型 | 说明 |
| --- | --- |
| IterableIterator | 包含Set中所有元素的迭代器。 |
