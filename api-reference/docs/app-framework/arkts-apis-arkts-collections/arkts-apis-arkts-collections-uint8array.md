...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| elements | Iterable | 是 | 可迭代数字集合，用于构造ArkTS Uint8Array对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| array | ArrayLike | ArrayBuffer | 是 | 用于构造ArkTS Uint8Array的对象。当参数类型是ArrayBuffer时buffer所占的字节数须是4的整数倍。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| arrayLike | ArrayLike | 是 | 用于构造ArkTS Uint8Array的ArrayLike对象。 |
