...
upstream_id: "harmonyos-references/js-apis-launcherbundlemanager"
catalog: "harmonyos-references"
content_hash: "254836818fe6"
synced_at: "2026-07-09T00:57:07.804079"
---
...
| userId | number | 是 | 被查询的用户ID，可以通过[getOsAccountLocalId](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-osaccount#getosaccountlocalid9)接口获取。 |

返回值：

| 类型 | 说明 |
| --- | --- |
| Array | Array形式返回bundle包含的[LauncherAbilityInfo](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-bundlemanager-launcherabilityinfo)信息。 |
