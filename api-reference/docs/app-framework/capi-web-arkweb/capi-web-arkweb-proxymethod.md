...
content_hash: "1f32e4357972"
synced_at: "2026-08-29T18:16:03.455484"
---
...
| [ArkWeb_OnJavaScriptProxyCallback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkweb-type-h#arkweb_onjavascriptproxycallback) callback | JavaScript通过Proxy对象调用该方法时触发的回调函数，用于处理来自JavaScript的方法调用。回调函数中可以访问JavaScript传入的参数（dataArray）并执行相应的Native逻辑。 |
