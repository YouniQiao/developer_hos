...
| 名称 | 描述 |
| --- | --- |
| ArkWeb_BlanklessErrorCode errCode | 无白屏加载的错误码，见[ArkWeb_BlanklessErrorCode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkweb-error-code-h#arkweb_blanklesserrorcode)定义。 |
