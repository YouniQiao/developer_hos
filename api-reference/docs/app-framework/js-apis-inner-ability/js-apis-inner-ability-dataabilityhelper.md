...
| callback | AsyncCallback | 是 | 回调函数，返回文件描述符。 |
...
| callback | AsyncCallback | 是 | 回调函数。当注册观察者以监听uri指定数据的数据变化通知成功，err为undefined，否则为错误对象。 |
...
| callback | AsyncCallback | 否 | 回调函数。当注销观察者以停止监听uri指定数据的数据变化通知成功，err为undefined，否则为错误对象。 |
...
| callback | AsyncCallback | 是 | 回调函数，返回与uri指向数据匹配的媒体资源类型。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回与uri指向数据匹配的媒体资源类型。 |
...
| callback | AsyncCallback> | 是 | 回调函数，返回匹配的媒体资源类型数组。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise> | Promise对象，返回匹配的媒体资源类型数组。 |
...
| callback | AsyncCallback | 是 | 回调函数，如果数据功能支持uri规范化，则返回规范化uri对象；否则返回null。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，如果数据功能支持uri规范化，则返回规范化uri对象；否则返回null。 |
...
| callback | AsyncCallback | 是 | 回调函数，返回反规范化uri对象。 |
...
| callback | AsyncCallback | 是 | 回调函数。当通知注册的观察者成功，err为undefined，否则为错误对象。 |
...
| callback | AsyncCallback | 是 | 回调函数，返回插入数据记录的索引。 |
...
| --- | --- | --- | --- |
| uri | string | 是 | 表示要插入数据的uri。 |
| valuesBuckets | Array | 是 | 表示要插入的数据记录数组。 |
| callback | AsyncCallback | 是 | 回调函数，返回插入的数据记录数。 |
...
| callback | AsyncCallback | 是 | 回调函数，返回已删除的数据记录数。 |
...
| predicates | dataAbility.DataAbilityPredicates | 是 | 表示筛选条件。当此参数为null时，应定义处理逻辑。 |
| callback | AsyncCallback | 是 | 回调函数，返回更新的数据记录数。 |
...
| --- | --- | --- | --- |
| uri | string | 是 | 表示要查询数据的uri。 |
| columns | Array | 否 | 表示要查询的列。如果此参数为空，则查询所有列。 |
...
| callback | AsyncCallback | 是 | 回调函数，返回扩展的键值对参数。 |
...
| --- | --- | --- | --- |
| uri | string | 是 | 表示待处理的DataAbility。例：'dataability:///com.example.xxx.xxxx'。 |
| operations | Array | 是 | 表示数据操作数组，其中可以包含对数据库的多个不同操作。 |
| callback | AsyncCallback> | 是 | 回调函数，在DataAbilityResult数组中返回每个操作的结果。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise> | Promise对象，在DataAbilityResult数组中返回每个操作的结果。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| [key: string] | number | string | boolean | Array | null | 否 | 是 | 数据存储在键值对中。 |
