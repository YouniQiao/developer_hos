...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| gesture | [GestureHandler](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-gesturehandler#gesturehandlert) | 是 | 手势处理器对象。 |
| priority | [GesturePriority](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-gesturehandler#gesturepriority枚举说明) | 否 | 绑定手势的优先级。 默认值：GesturePriority.NORMAL |
