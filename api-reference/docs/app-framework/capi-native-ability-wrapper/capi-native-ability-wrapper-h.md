...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [AbilityRuntime_NativeAbilityWrapper](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-abilityruntime-nativeabilitywrapper) | AbilityRuntime_NativeAbilityWrapper | NativeAbility数据信息结构体类型。 |
...
#### [h2]OH_AbilityRuntime_GetAbilityInstanceId()
...
| 参数项 | 描述 |
| --- | --- |
| [AbilityRuntime_NativeAbilityWrapper](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-abilityruntime-nativeabilitywrapper)* nativeAbilityWrapper | NativeAbility数据信息指针。 |
...
#### [h2]OH_AbilityRuntime_GetAbilityName()
