...
1. 缺失必要字段（没有field且没有fields；没有value且没有range；没有op）。
...
参照[知识schema规格及约束限制](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/data-augmentation-knowledge-processing#约束限制)修改其中内容。
