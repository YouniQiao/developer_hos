...
content_hash: "3b16765770af"
synced_at: "2026-07-28T16:49:22.175496"
---
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 字体样式，具体枚举值请参考[ArkUI_FontStyle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-text-h#arkui_fontstyle)。默认值为ARKUI_FONT_STYLE_NORMAL。 |

返回：

| 类型 | 说明 |
| --- | --- |
| .value[0].i32 | 字体样式[ArkUI_FontStyle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-text-h#arkui_fontstyle)。 |
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 字体粗细样式[ArkUI_FontWeight](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-text-h#arkui_fontweight)。取值越大字体越粗。默认值为ARKUI_FONT_WEIGHT_NORMAL。 |

返回：

| 类型 | 说明 |
| --- | --- |
| .value[0].i32 | 字体粗细样式[ArkUI_FontWeight](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-text-h#arkui_fontweight)。 |
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 文本装饰线类型，具体枚举值请参考[ArkUI_TextDecorationType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-text-common-h#arkui_textdecorationtype)。默认值为ARKUI_TEXT_DECORATION_TYPE_NONE，无装饰线。 |
| .value[1]?.u32 | 可选值，装饰线颜色，0xargb格式，形如 0xFFFF0000 表示红色。默认值：0xFF000000，表示黑色。 |
| .value[2]?.i32 | 文本装饰线样式，具体枚举值请参考[ArkUI_TextDecorationStyle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-text-common-h#arkui_textdecorationstyle)。默认值为ARKUI_TEXT_DECORATION_STYLE_SOLID，实线装饰线。 |
...
| 类型 | 说明 |
| --- | --- |
| .value[0].i32 | 文本装饰线类型[ArkUI_TextDecorationType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-text-common-h#arkui_textdecorationtype)。 |
| .value[1].u32 | 装饰线颜色，0xargb格式。 |
| .value[2].i32 | 文本装饰线样式[ArkUI_TextDecorationStyle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-text-common-h#arkui_textdecorationstyle)。 |
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 表示文本大小写类型，具体枚举值请参考[ArkUI_TextCase](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-text-common-h#arkui_textcase)。默认值为ARKUI_TEXT_CASE_NORMAL，表示保持原样。 |

返回：

| 类型 | 说明 |
| --- | --- |
| .value[0].i32 | 表示文本大小写类型[ArkUI_TextCase](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-text-common-h#arkui_textcase)。 |
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 表示文本水平对齐方式，具体枚举值请参考[ArkUI_TextAlignment](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-text-common-h#arkui_textalignment)。默认值为ARKUI_TEXT_ALIGNMENT_START，表示水平对齐首部。 |

返回：

| 类型 | 说明 |
| --- | --- |
| .value[0].i32 | 表示文本水平对齐方式，取[ArkUI_TextAlignment](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-text-common-h#arkui_textalignment)枚举值。 |
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 表示文本超长时的显示方式，具体枚举值请参考[ArkUI_TextOverflow](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-text-common-h#arkui_textoverflow)。默认值为ARKUI_TEXT_OVERFLOW_NONE，表示文本超长时不裁剪显示。 |
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 复制粘贴方式，具体枚举值请参考[ArkUI_CopyOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-native-type-h#arkui_copyoptions)。默认值为ARKUI_COPY_OPTIONS_NONE，表示不支持复制。 |

返回：

| 类型 | 说明 |
| --- | --- |
| .value[0].i32 | 复制粘贴方式[ArkUI_CopyOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-native-type-h#arkui_copyoptions)。 |
...
| .value[1].i32 | 阴影类型，具体枚举值请参考[ArkUI_ShadowType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-native-type-visual-h#arkui_shadowtype)。默认值为ARKUI_SHADOW_TYPE_COLOR，表示颜色阴影。 |
...
| .value[1].i32 | 阴影类型[ArkUI_ShadowType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-native-type-visual-h#arkui_shadowtype)。 |
...
| .value[1]?.i32 | 可选值，文本的字体粗细，具体枚举值请参考[ArkUI_FontWeight](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-text-h#arkui_fontweight)。取值越大字体越粗。默认值为ARKUI_FONT_WEIGHT_NORMAL。 |
| .value[2]?.i32 | 可选值，字体样式，具体枚举值请参考[ArkUI_FontStyle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-text-h#arkui_fontstyle)。默认值为ARKUI_FONT_STYLE_NORMAL。 |
...
| .value[1].i32 | 文本的字体粗细，具体枚举值请参考[ArkUI_FontWeight](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-text-h#arkui_fontweight)。默认值为ARKUI_FONT_WEIGHT_NORMAL。 |
| .value[2].i32 | 字体样式，具体枚举值请参考[ArkUI_FontStyle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-text-h#arkui_fontstyle)。默认值为ARKUI_FONT_STYLE_NORMAL。 |
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 参数类型，具体枚举值请参考[ArkUI_TextHeightAdaptivePolicy](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-text-h#arkui_textheightadaptivepolicy)。默认值为ARKUI_TEXT_HEIGHT_ADAPTIVE_POLICY_MAX_LINES_FIRST，表示以MaxLines优先。 |

返回：

| 类型 | 说明 |
| --- | --- |
| .value[0].i32 | 获取的文本自适应高度方式的枚举值，参数类型[ArkUI_TextHeightAdaptivePolicy](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-text-h#arkui_textheightadaptivepolicy)。 |
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 参数类型，具体枚举值请参考[ArkUI_WordBreak](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-text-common-h#arkui_wordbreak)。默认值为ARKUI_WORD_BREAK_BREAK_WORD，对于Non-CJK的文本可在任意2个字符间断行，一行文本中有断行破发点（如空白符）时，优先按破发点换行。对于CJK的文本，换行效果与NORMAL效果保持一致。 |

返回：

| 类型 | 说明 |
| --- | --- |
| .value[0].i32 | 获取的文本断行规则枚举值，参数类型[ArkUI_WordBreak](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-text-common-h#arkui_wordbreak)。 |
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 参数类型，具体枚举值请参考[ArkUI_EllipsisMode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-text-common-h#arkui_ellipsismode)。默认值为ARKUI_ELLIPSIS_MODE_END，表示省略行末内容。 |

返回：

| 类型 | 说明 |
| --- | --- |
| .value[0].i32 | 获取的文本省略位置枚举值，参数类型[ArkUI_EllipsisMode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-text-common-h#arkui_ellipsismode)。 |
...
```
 设置文本特性效果。NODE_FONT_FEATURE是OpenType字体的高级排版能力，如支持连字、数字等宽等特性，一般用在自定义字体中，其能力需要字体本身支持。支持属性设置、属性重置和属性获取接口。
...
| 参数项 | 描述 |
| --- | --- |
| .string | 符合文本特性格式的字符串，格式为normal | 。 的格式为： [ | on | off ]。 的个数可以有多个，中间用','隔开，例如，使用等宽数字的输入格式为：ss01 on。 |
...
```
 设置是否使能文本实体识别，识别的实体类型可通过NODE_TEXT_ENABLE_DATA_DETECTOR_CONFIG属性配置。适用于识别文本中的特定实体类型（如电话号码、邮箱地址、网址链接等），实现点击跳转、智能交互等功能。
...
| 参数项 | 描述 |
| --- | --- |
| .value[0...].i32 | 实体类型数组，参数类型[ArkUI_TextDataDetectorType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-text-h#arkui_textdatadetectortype)。数组中可包含电话号码、URL、邮箱等实体类型，具体取值请参考枚举定义。本参数仅在NODE_TEXT_ENABLE_DATA_DETECTOR设置为1（开启文本实体识别）时生效。 |

返回：

| 类型 | 说明 |
| --- | --- |
| .value[0...].i32 | 实体类型数组，参数类型[ArkUI_TextDataDetectorType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-text-h#arkui_textdatadetectortype)。 |
...
```
 Text组件使用格式化字符串对象设置文本内容属性，支持属性设置、属性重置和属性获取接口。配置自定义[OH_Drawing_Typography](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-drawing-oh-drawing-typography)对象到Text组件，会跳过文本控件的布局测算阶段。注意事项：
...
| 参数项 | 描述 |
| --- | --- |
| .object | 表示 ArkUI_StyledString 格式化字符串数据，参数类型为[ArkUI_StyledString](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-styledstring)。 |
...
| .value[1].i32 | 线性渐变的方向[ArkUI_LinearGradientDirection](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-native-type-visual-h#arkui_lineargradientdirection)。设置除ARKUI_LINEAR_GRADIENT_DIRECTION_CUSTOM之外的线性渐变方向后，angle不生效。默认值：ARKUI_LINEAR_GRADIENT_DIRECTION_LEFT_BOTTOM。 |
...
| .value[1].i32 | 线性渐变的方向[ArkUI_LinearGradientDirection](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-native-type-visual-h#arkui_lineargradientdirection)。 |
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 文本内容垂直对齐方式[ArkUI_TextVerticalAlignment](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-text-common-h#arkui_textverticalalignment)，默认值：ARKUI_TEXT_VERTICAL_ALIGNMENT_BASELINE。 |

返回：

| 类型 | 说明 |
| --- | --- |
| .value[0].i32 | 文本内容垂直对齐方式[ArkUI_TextVerticalAlignment](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-text-common-h#arkui_textverticalalignment)。 |
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 文本内容区垂直对齐方式[ArkUI_TextContentAlign](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-text-common-h#arkui_textcontentalign)，默认值：ARKUI_TEXT_CONTENT_ALIGN_CENTER。 |

返回：

| 类型 | 说明 |
| --- | --- |
| .value[0].i32 | 文本内容区垂直对齐方式[ArkUI_TextContentAlign](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-text-common-h#arkui_textcontentalign)。 |
...
| 类型 | 说明 |
| --- | --- |
| .object | 文本布局管理器对象，参数类型为[ArkUI_TextLayoutManager](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-textlayoutmanager)。 |
...
| 参数项 | 描述 |
| --- | --- |
| .object | 文本菜单扩展项配置数据，参数类型为[ArkUI_TextEditMenuOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-texteditmenuoptions)。 |
...
| 参数项 | 描述 |
| --- | --- |
| .object | 自定义文本选择菜单配置数据，参数类型为[ArkUI_TextSelectionMenuOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-textselectionmenuoptions)。 |
...
| .object | 选择选项。参数类型为[ArkUI_SelectionOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-selectionoptions)。 |
...
```
 设置Text文本排版时是否使能孤字优化，设置后通过更高效地处理孤立字符（段落尾行首字符）来改善文本布局。使能后，它会调整换行点以尽可能避免孤立字符。孤字优化特性需在[ArkUI_WordBreak](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-text-common-h#arkui_wordbreak)属性为非ARKUI_WORD_BREAK_BREAK_ALL时生效。
...
| 参数项 | 描述 |
| --- | --- |
| .object | 文本跑马灯模式配置，参数类型为[ArkUI_TextMarqueeOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-textmarqueeoptions)。 |
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 表示文本的排版方向，取[ArkUI_TextDirection](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-text-common-h#arkui_textdirection)枚举值。默认值为ARKUI_TEXT_DIRECTION_DEFAULT，表示文本排版方向遵循组件布局。 |
...
| .value[2]?.i32 | 字体样式。可选。参数类型为[ArkUI_FontStyle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-text-h#arkui_fontstyle)。默认值为ARKUI_FONT_STYLE_NORMAL。 |
| .object? | 字体配置。可选，不设置时使用系统默认配置。参数类型为[OH_ArkUI_FontConfigs](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-oh-arkui-fontconfigs)。 |
...
| .value[2].i32 | 字体样式。参数类型为[ArkUI_FontStyle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-text-h#arkui_fontstyle)。 |
| .object | 字体配置。参数类型为[OH_ArkUI_FontConfigs](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-oh-arkui-fontconfigs)。 |
...
| .object? | 可选，文本字体粗细配置，不设置时使用默认字体粗细配置。参数类型为[OH_ArkUI_FontWeightConfigs](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-oh-arkui-fontweightconfigs)。 |
...
| .object | 文本字体粗细配置。参数类型为[OH_ArkUI_FontWeightConfigs](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-oh-arkui-fontweightconfigs)。 |
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 表示图片基于文本的对齐方式，取[ArkUI_ImageSpanAlignment](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-image-span-h#arkui_imagespanalignment)枚举值。默认值为ARKUI_IMAGE_SPAN_ALIGNMENT_BOTTOM，图片下边沿与文本下边沿对齐。 |

返回：

| 类型 | 说明 |
| --- | --- |
| .value[0].i32 | 表示图片基于文本的对齐方式，取[ArkUI_ImageSpanAlignment](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-image-span-h#arkui_imagespanalignment)枚举值。 |
...
| .size | 表示滤镜数组大小为5x4。 |
| .object | 颜色滤波器指针，参数类型为[OH_Drawing_ColorFilter](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-drawing-oh-drawing-colorfilter)。 .object和.size参数只能二选一，不可同时设置。 |
...
| .size | 表示滤镜数组大小为5x4。 |
| .object | 颜色滤波器指针，参数类型为[OH_Drawing_ColorFilter](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-drawing-oh-drawing-colorfilter)。 |
