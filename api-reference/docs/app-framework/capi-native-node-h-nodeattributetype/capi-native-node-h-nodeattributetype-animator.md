...
| 参数项 | 描述 |
| --- | --- |
| .value[0].f32 | 线性渐变的起始角度，单位度（°），当[ArkUI_LinearGradientDirection](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-native-type-visual-h#arkui_lineargradientdirection)为ARKUI_LINEAR_GRADIENT_DIRECTION_CUSTOM时，angle属性生效，否则按direction为主要布局方式。0点方向顺时针旋转为正向角度，默认值180。 |
| .value[1].i32 | 线性渐变的方向，设置为非ARKUI_LINEAR_GRADIENT_DIRECTION_CUSTOM的线性渐变方向时，angle不生效。数据类型[ArkUI_LinearGradientDirection](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-native-type-visual-h#arkui_lineargradientdirection)。 |
...
| 参数项 | 描述 |
| --- | --- |
| .value[0...15].f32 | 16个浮点数。此时[ArkUI_AttributeItem](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-attributeitem)中的size取值不应为0。 |
| .object | 是指向[ArkUI_Matrix4](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-matrix4)的指针，此时[ArkUI_AttributeItem](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-attributeitem)中的size取值为0。 |
...
| 参数项 | 描述 |
| --- | --- |
| .value[0]?.f32 | 阴影模糊半径，单位为px，默认值0.0。 |
...
| .value[1]?.i32 | 表示深浅色模式，取[ArkUI_ColorMode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-native-type-h#arkui_colormode)枚举值。 |
...
| 4.path类型 | .value[0].u32：填充颜色，0xargb类型； .value[1].u32：描边颜色，0xargb类型； .value[2].f32：描边宽度，单位为vp； .value[3].i32：遮罩类型，参数类型[ArkUI_MaskType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-native-type-visual-h#arkui_masktype)，遮罩类型枚举值为ARKUI_MASK_TYPE_PATH； .value[4].f32：路径宽度，单位为vp； .value[5].f32：路径高度，单位为vp； .string：路径绘制的命令字符串。 |
...
| 4.path类型 | .value[0].u32：填充颜色，0xargb类型； .value[1].u32：描边颜色，0xargb类型； .value[2].f32：描边宽度，单位为vp； .value[3].i32：遮罩类型； .value[4].f32：路径宽度，单位为vp； .value[5].f32：路径高度，单位为vp； .string：路径绘制的命令字符串。 |
