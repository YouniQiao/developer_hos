...
content_hash: "4a332716f282"
synced_at: "2026-09-23T18:54:32.066029"
---
...
| 参数项 | 描述 |
| --- | --- |
| .object | 参数格式为[ArkUI_ListChildrenMainSize](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-listchildrenmainsize)。 |
...
| 类型 | 说明 |
| --- | --- |
| .value[0].i32 | List组件走焦换行模式，参数类型[ArkUI_FocusWrapMode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-native-type-h#arkui_focuswrapmode)。 |
...
| 参数项 | 描述 |
| --- | --- |
| .object | 使用[ArkUI_ListItemSwipeActionOption](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-listitemswipeactionoption)对象构造。 |
...
| 参数项 | 描述 |
| --- | --- |
| .object | 使用[ArkUI_NodeHandle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-node8h)对象作为ListItemGroup头部组件。 |
...
| 参数项 | 描述 |
| --- | --- |
| .object | 使用[ArkUI_NodeHandle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-node8h)对象作为ListItemGroup尾部组件。 |
...
| 参数项 | 描述 |
| --- | --- |
| .object | 参数类型[ArkUI_NodeHandle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-node8h)。 |
...
| .object | 参数格式为[ArkUI_WaterFlowSectionOption](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-waterflowsectionoption)。 |

返回：

| 类型 | 说明 |
| --- | --- |
| .object | 返回值格式为[ArkUI_WaterFlowSectionOption](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-waterflowsectionoption)。 |
...
| 类型 | 说明 |
| --- | --- |
| .value[0].i32 | Grid组件走焦换行模式，参数类型[ArkUI_FocusWrapMode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-native-type-h#arkui_focuswrapmode)。 |
...
| 参数项 | 描述 |
| --- | --- |
| .object | 参数格式为[ArkUI_GridLayoutOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-gridlayoutoptions)。 |

返回：

| 类型 | 说明 |
| --- | --- |
| .object | 返回值格式为[ArkUI_GridLayoutOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-gridlayoutoptions)。 |
