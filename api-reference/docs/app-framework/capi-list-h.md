---
title: "list.h"
upstream_id: "harmonyos-references/capi-list-h"
catalog: "harmonyos-references"
content_hash: "f4e8e8e4011a"
synced_at: "2026-07-28T16:49:23.272029"
---
...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [ArkUI_ListChildrenMainSize](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-listchildrenmainsize) | ArkUI_ListChildrenMainSize | 定义List组件子组件的主轴尺寸信息。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI_ListChildrenMainSize](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-listchildrenmainsize)* option | ListChildrenMainSize实例。为空指针时返回ARKUI_ERROR_CODE_PARAM_INVALID。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI_ListChildrenMainSize](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-listchildrenmainsize)* option | ListChildrenMainSize实例。为空指针时不执行操作。 |
