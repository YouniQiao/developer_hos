...
content_hash: "7741af02fea6"
synced_at: "2026-07-28T16:49:19.974109"
---
...
| ARKUI_KEYCODE_BUTTON_A = 2301 | 游戏手柄按键'A'。 **起始版本：** 15 |
| ARKUI_KEYCODE_BUTTON_B = 2302 | 游戏手柄按键'B'。 **起始版本：** 15 |
| ARKUI_KEYCODE_BUTTON_X = 2304 | 游戏手柄按键'X'。 **起始版本：** 15 |
| ARKUI_KEYCODE_BUTTON_Y = 2305 | 游戏手柄按键'Y'。 **起始版本：** 15 |
| ARKUI_KEYCODE_BUTTON_L1 = 2307 | 游戏手柄按键'L1'。 **起始版本：** 15 |
| ARKUI_KEYCODE_BUTTON_R1 = 2308 | 游戏手柄按键'R1'。 **起始版本：** 15 |
| ARKUI_KEYCODE_BUTTON_L2 = 2309 | 游戏手柄按键'L2'。 **起始版本：** 15 |
| ARKUI_KEYCODE_BUTTON_R2 = 2310 | 游戏手柄按键'R2'。 **起始版本：** 15 |
| ARKUI_KEYCODE_BUTTON_SELECT = 2311 | 游戏手柄按键'Select'。 **起始版本：** 15 |
| ARKUI_KEYCODE_BUTTON_START = 2312 | 游戏手柄按键'Start'。 **起始版本：** 15 |
...
| 参数项 | 描述 |
| --- | --- |
| [const ArkUI_UIInputEvent](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-eventmodule-arkui-uiinputevent)* event | 按键输入事件指针，用于获取该事件对应的按键事件类型。 |
...
#### [h2]OH_ArkUI_KeyEvent_GetKeyCode()
...
| 参数项 | 描述 |
| --- | --- |
| [const ArkUI_UIInputEvent](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-eventmodule-arkui-uiinputevent)* event | 输入事件指针，用于获取该事件对应按键的键码。 |
...
#### [h2]OH_ArkUI_KeyEvent_GetKeyText()
...
| 参数项 | 描述 |
| --- | --- |
| [const ArkUI_UIInputEvent](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-eventmodule-arkui-uiinputevent)* event | 输入事件指针，用于获取该事件对应按键的键值文本。 |
...
#### [h2]OH_ArkUI_KeyEvent_GetKeySource()
...
| 参数项 | 描述 |
| --- | --- |
| [const ArkUI_UIInputEvent](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-eventmodule-arkui-uiinputevent)* event | 输入事件指针，用于获取触发该按键事件的输入设备类型。 |
...
#### [h2]OH_ArkUI_KeyEvent_StopPropagation()
...
| 参数项 | 描述 |
| --- | --- |
| [const ArkUI_UIInputEvent](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-eventmodule-arkui-uiinputevent)* event | 按键输入事件指针，表示需要设置冒泡传递行为的按键事件。 |
| bool stopPropagation | 表示是否阻止事件冒泡传递。true表示阻止事件冒泡传递，false表示不阻止事件冒泡传递。 |

#### [h2]OH_ArkUI_KeyEvent_GetKeyIntensionCode()
...
| 参数项 | 描述 |
| --- | --- |
| [const ArkUI_UIInputEvent](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-eventmodule-arkui-uiinputevent)* event | 输入事件指针，用于获取该事件对应按键的意图。 |
...
#### [h2]OH_ArkUI_KeyEvent_GetUnicode()
...
| 参数项 | 描述 |
| --- | --- |
| [const ArkUI_UIInputEvent](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-eventmodule-arkui-uiinputevent)* event | 输入事件指针，用于获取该事件对应按键的Unicode码值。 |
...
#### [h2]OH_ArkUI_KeyEvent_SetConsumed()
...
| 参数项 | 描述 |
| --- | --- |
| [const ArkUI_UIInputEvent](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-eventmodule-arkui-uiinputevent)* event | 输入事件指针，表示需要设置是否被当前回调消费的按键事件。 |
| bool isConsumed | 表示事件是否被该回调消费。true表示事件被消费，false表示事件未被消费。 |

#### [h2]OH_ArkUI_KeyEvent_Dispatch()
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI_NodeHandle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-node8h) node | 目标组件节点，用于接收分发的按键事件。取值原则：必须传入有效的非空ArkUI_NodeHandle节点句柄。 |
| [const ArkUI_UIInputEvent](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-eventmodule-arkui-uiinputevent)* event | 输入事件指针，表示需要分发到目标组件节点的按键事件。 |

#### [h2]OH_ArkUI_KeyEvent_IsNumLockOn()
...
| 参数项 | 描述 |
| --- | --- |
| [const ArkUI_UIInputEvent](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-eventmodule-arkui-uiinputevent)* event | 按键输入事件指针，用于获取按键事件发生时NumLock的状态。取值原则：必须为按键类型的UIInputEvent事件。 |
...
| 参数项 | 描述 |
| --- | --- |
| [const ArkUI_UIInputEvent](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-eventmodule-arkui-uiinputevent)* event | 按键输入事件指针，用于获取按键事件发生时CapsLock的状态。 |
...
| 参数项 | 描述 |
| --- | --- |
| [const ArkUI_UIInputEvent](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-eventmodule-arkui-uiinputevent)* event | 按键输入事件指针，用于获取按键事件发生时ScrollLock的状态。 |
