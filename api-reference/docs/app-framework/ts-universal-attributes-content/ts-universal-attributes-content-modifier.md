...
| 类型 | 说明 |
| --- | --- |
| [WrappedBuilder](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-wrapbuilder) | 组件的属性类，用来区别不同组件自定义内容区后所需要的不同信息，比如Button组件的ButtonConfiguration，Checkbox组件的CheckBoxConfiguration等。 |
...
| contentModifier | [ContentModifier](#contentmodifiert) | 否 | 否 | 用于将用户需要的组件信息发送到自定义内容区。 |
