...
content_hash: "32b6a70d1f2b"
synced_at: "2026-07-28T16:49:23.512956"
---
...
| 枚举项 | 描述 |
| --- | --- |
| ARKUI_SHADOW_STYLE_OUTER_DEFAULT_XS = 0 | 超小阴影。 ![](./img/zh-cn_image_0000002686088847.png) |
| ARKUI_SHADOW_STYLE_OUTER_DEFAULT_SM = 1 | 小阴影。 ![](./img/zh-cn_image_0000002685929015.png) |
| ARKUI_SHADOW_STYLE_OUTER_DEFAULT_MD = 2 | 中阴影。 ![](./img/zh-cn_image_0000002656009340.png) |
| ARKUI_SHADOW_STYLE_OUTER_DEFAULT_LG = 3 | 大阴影。 ![](./img/zh-cn_image_0000002655849418.png) |
| ARKUI_SHADOW_STYLE_OUTER_FLOATING_SM = 4 | 浮动小阴影。 ![](./img/zh-cn_image_0000002686088849.png) |
| ARKUI_SHADOW_STYLE_OUTER_FLOATING_MD = 5 | 浮动中阴影。 ![](./img/zh-cn_image_0000002685929017.png) |
...
| 枚举项 | 描述 |
| --- | --- |
| ARKUI_BLUR_STYLE_THIN = 0 | 轻薄材质模糊。 ![](./img/zh-cn_image_0000002656009342.png) |
| ARKUI_BLUR_STYLE_REGULAR = 1 | 普通厚度材质模糊。 ![](./img/zh-cn_image_0000002655849420.png) |
| ARKUI_BLUR_STYLE_THICK = 2 | 厚材质模糊。 ![](./img/zh-cn_image_0000002686088851.png) |
| ARKUI_BLUR_STYLE_BACKGROUND_THIN = 3 | 近距景深模糊。 ![](./img/zh-cn_image_0000002685929019.png) |
| ARKUI_BLUR_STYLE_BACKGROUND_REGULAR = 4 | 中距景深模糊。 ![](./img/zh-cn_image_0000002656009344.png) |
| ARKUI_BLUR_STYLE_BACKGROUND_THICK = 5 | 远距景深模糊。 ![](./img/zh-cn_image_0000002655849422.png) |
| ARKUI_BLUR_STYLE_BACKGROUND_ULTRA_THICK = 6 | 超远距景深模糊。 ![](./img/zh-cn_image_0000002686088853.png) |
| ARKUI_BLUR_STYLE_NONE = 7 | 关闭模糊。 ![](./img/zh-cn_image_0000002685929021.png) |
| ARKUI_BLUR_STYLE_COMPONENT_ULTRA_THIN = 8 | 组件超轻薄材质模糊。 ![](./img/zh-cn_image_0000002656009346.png) |
| ARKUI_BLUR_STYLE_COMPONENT_THIN = 9 | 组件轻薄材质模糊。 ![](./img/zh-cn_image_0000002655849424.png) |
| ARKUI_BLUR_STYLE_COMPONENT_REGULAR = 10 | 组件普通材质模糊。 ![](./img/zh-cn_image_0000002686088855.png) |
| ARKUI_BLUR_STYLE_COMPONENT_THICK = 11 | 组件厚材质模糊。 ![](./img/zh-cn_image_0000002685929023.png) |
| ARKUI_BLUR_STYLE_COMPONENT_ULTRA_THICK = 12 | 组件超厚材质模糊。 ![](./img/zh-cn_image_0000002656009348.png) |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI_Matrix4](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-matrix4)* | 返回通过指定矩阵元素创建的四阶矩阵对象。如果elements指针为空，函数将返回NULL。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI_Matrix4](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-matrix4)* | 返回四阶矩阵对象的副本对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI_Matrix4ScaleOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-matrix4scaleoptions)* | 返回指向新创建的[ArkUI_Matrix4ScaleOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-matrix4scaleoptions)的指针，用于配置矩阵运算的缩放参数。 |
...
获取矩阵运算的旋转参数对象x方向的方向向量。如果从未设置过x值，其值将处于未定义状态，此时函数将返回[ARKUI_ERROR_CODE_PARAM_INVALID](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-error-code-h#arkui_errorcode)。
...
获取矩阵运算的旋转参数对象y方向的方向向量。如果从未设置过y值，其值将处于未定义状态，此时函数将返回[ARKUI_ERROR_CODE_PARAM_INVALID](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-error-code-h#arkui_errorcode)。
...
获取矩阵运算的旋转参数对象z方向的方向向量。如果从未设置过z值，其值将处于未定义状态，此时函数将返回[ARKUI_ERROR_CODE_PARAM_INVALID](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-error-code-h#arkui_errorcode)。
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI_Matrix4TranslationOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-matrix4translationoptions)* | 返回指向新创建的[ArkUI_Matrix4TranslationOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-matrix4translationoptions)的指针，用于配置矩阵运算的平移参数。 |
...
| --- | --- |
| [ArkUI_MotionPathOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-motionpathoptions)* options | 指向路径动画的运动路径配置项[ArkUI_MotionPathOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-motionpathoptions)的指针。 |
| const float from | 路径动画的起点进度，取值范围为[0.0, 1.0]，且需满足from小于或等于终点进度to，否则将返回[ARKUI_ERROR_CODE_PARAM_OUT_OF_RANGE](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-error-code-h#arkui_errorcode)错误码。 to的含义参考[OH_ArkUI_MotionPathOptions_SetTo](#oh_arkui_motionpathoptions_setto)。 |

返回：

| 类型 | 说明 |
| --- | --- |
| int32_t | 错误码。 [ARKUI_ERROR_CODE_NO_ERROR](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-error-code-h#arkui_errorcode) 成功。 [ARKUI_ERROR_CODE_PARAM_INVALID](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-error-code-h#arkui_errorcode) 函数参数异常。 [ARKUI_ERROR_CODE_PARAM_OUT_OF_RANGE](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-error-code-h#arkui_errorcode) from超出[0.0, 1.0]范围，或from大于终点进度to。 |
...
| --- | --- |
| [ArkUI_MotionPathOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-motionpathoptions)* options | 指向路径动画的运动路径配置项[ArkUI_MotionPathOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-motionpathoptions)的指针。 |
| const float to | 路径动画的终点进度，取值范围为[0.0, 1.0]，且需满足to大于或等于起点进度from；否则将返回[ARKUI_ERROR_CODE_PARAM_OUT_OF_RANGE](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-error-code-h#arkui_errorcode)错误码。 from的含义参考[OH_ArkUI_MotionPathOptions_SetFrom](#oh_arkui_motionpathoptions_setfrom)。 |

返回：

| 类型 | 说明 |
| --- | --- |
| int32_t | 错误码。 [ARKUI_ERROR_CODE_NO_ERROR](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-error-code-h#arkui_errorcode) 成功。 [ARKUI_ERROR_CODE_PARAM_INVALID](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-error-code-h#arkui_errorcode) 函数参数异常。 [ARKUI_ERROR_CODE_PARAM_OUT_OF_RANGE](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-error-code-h#arkui_errorcode) to超出[0.0, 1.0]范围，或to小于起点进度from。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH_ArkUI_ShadowOptions*](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-oh-arkui-shadowoptions) | 指向新创建的[OH_ArkUI_ShadowOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-oh-arkui-shadowoptions)对象的指针，用于配置阴影的模糊半径、类型、颜色和偏移量等属性。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH_ArkUI_ShadowOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-oh-arkui-shadowoptions)* options | 指向新创建的[OH_ArkUI_ShadowOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-oh-arkui-shadowoptions)对象的指针，用于配置阴影的模糊半径、类型、颜色和偏移量等属性。 |
