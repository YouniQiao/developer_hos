...
重新调用[mmap](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fileiommap)/[mmapSync](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fileiommapsync)，将映射模式设置为读写模式或私有模式。

#### [h2]13900054 mmap缓冲区不可访问
...
重新调用[mmap](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fileiommap)/[mmapSync](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fileiommapsync)映射文件。

#### [h2]13900055 mmap映射类型不支持该操作
...
[msync](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#msync)写入磁盘时，映射区为只读模式或私有模式。

处理步骤

重新调用[mmap](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fileiommap)/[mmapSync](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fileiommapsync)，将映射模式设置为读写模式。

#### [h2]13900056 mmap不支持映射此文件
...
请使用[read](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fileioread)、[write](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fileiowrite)或[Stream](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#stream)等文件访问接口替代mmap。
...
#### [h2]14300003 查询server端ability信息失败
...
系统基础能力问题，请通过“华为开发者联盟官网”->“支持”，[在线提单](https://developer.huawei.com/consumer/cn/support/)方式获取支持。

#### [h2]14300004 js-server实际返回的结果异常
...
#### [h2]22400007 指定用于替换原始文件的历史版本文件不存在
