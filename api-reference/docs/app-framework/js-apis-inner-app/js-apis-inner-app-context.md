...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback | 是 | 回调函数，返回应用程序的本地根目录。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回应用程序的本地根目录。 |
...
| callback | AsyncCallback | 是 | 回调函数，返回权限验证结果，0有权限，-1无权限。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，如果pid和uid具有权限，则使用0进行异步回调；否则使用-1回调。 |
...
| resultCallback | AsyncCallback | 是 | 回调函数，返回授权结果信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback | 是 | 回调函数，返回当前应用程序的信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback | 是 | 回调函数，返回当前ability的Bundle名称。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回当前ability的Bundle名称。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback | 是 | 回调函数，返回屏幕显示方向。 |
...
![](./img/note_3.0-zh-cn.png) 从API version 7开始不再支持。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback | 是 | 回调函数，返回应用程序的缓存目录的绝对路径。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回应用程序的缓存目录的绝对路径。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| orientation | [bundle.DisplayOrientation](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-bundlemanager#displayorientation) | 是 | 表示屏幕方向。 |
| callback | AsyncCallback | 是 | 回调函数。当设置当前Ability的显示方向成功，err为undefined，否则为错误对象。 |
...
| callback | AsyncCallback | 是 | 回调函数。当设置每当显示锁屏时是否在锁屏顶部显示此功能并使该功能保持激活状态的操作成功，err为undefined，否则为错误对象。 |
...
| callback | AsyncCallback | 是 | 回调函数。当设置恢复此功能时是否唤醒屏幕成功，err为undefined，否则为错误对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback | 是 | 回调函数，返回当前进程的信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback | 是 | 回调函数，返回当前ability的ohos.bundleManager.ElementName对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回当前ability的ohos.bundleManager.ElementName对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback | 是 | 回调函数，返回当前进程的名称。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback | 是 | 回调函数，返回ability调用方的Bundle名称。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回ability调用方的Bundle名称。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback | 是 | 回调函数，返回该应用程序的缓存目录。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回该应用程序的缓存目录。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback | 是 | 回调函数，返回内部存储器上此应用程序的文件目录。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回内部存储器上此应用程序的文件目录。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback | 是 | 回调函数，返回Ability或应用的分布式文件路径。 若路径不存在，系统将创建一个路径并返回创建的路径。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回Ability或应用的分布式文件路径。若为首次调用，则将创建目录。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback | 是 | 回调函数，返回此应用程序的类型。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback | 是 | 回调函数，返回应用的ModuleInfo对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回应用的ModuleInfo对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback | 是 | 回调函数，返回应用版本信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback | 是 | 回调函数，返回当前归属Ability详细信息。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回当前归属Ability详细信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback | 是 | 回调函数，返回true表示该Ability的配置正在更改，否则返回false。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回true表示该Ability的配置正在更改，否则返回false。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback | 是 | 回调函数。当通知系统绘制此页面功能所需的时间成功，err为undefined，否则为错误对象。 |
...
| permissions | Array | 否 | 否 | 用户传入的权限。 |
| authResults | Array | 否 | 否 | 请求权限的结果。 |
