...
- CSS样式文件中通过url()函数创建数据类型，如：url(/common/test.png)。

![](./img/note_3.0-zh-cn.png) 当代码文件A需要引用代码文件B时：
...
FA卡片需要在应用配置文件config.json中进行配置。详细的配置内容请参考[应用配置文件概述（FA模型）](https://developer.huawei.com/consumer/cn/doc/lite-wearable-guides/application-configuration-file-overview-fa)。
