...
content_hash: "d705ebb3b7ad"
synced_at: "2026-07-28T16:43:43.365266"
---
...
该组件的父组件支持[List](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-list)、[WaterFlow](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-waterflow)、[FlowItem](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-flowitem)、[Scroll](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scroll)和[LazyColumnLayout](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-lazycolumnlayout)，也支持使用自定义组件或[NodeContainer](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-nodecontainer)组件封装后应用在上述组件中。

![](./img/note_3.0-zh-cn.png)

- 本模块接口仅可在Stage模型下使用。
- 该组件在不同父组件下的懒加载支持条件如下： 1. 在WaterFlow组件下，仅在WaterFlow组件的单列模式或分段布局中的单列分段场景下使用时支持懒加载。 2. 在List组件下，当[lanes](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-list#lanes9)大于1、[chainAnimation](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-list#chainanimation)设置为true或[scrollSnapAlign](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-list#scrollsnapalign10)设置为ScrollSnapAlign.NONE以外的值时，List不使用嵌套懒加载测量流程，该组件按普通子项测量，懒加载功能失效。 3. 在Scroll、List、WaterFlow组件下使用时，Scroll、List、WaterFlow的滚动方向（水平或垂直）必须和该组件布局方向相同，若布局方向不同会导致应用崩溃。
...
```
 ![](./img/zh-cn_image_0000002656008450.gif)
