...
upstream_id: "harmonyos-references/arkts-apis-uicontext-smartgesturecontroller"
catalog: "harmonyos-references"
content_hash: "b137cc048024"
synced_at: "2026-07-28T16:41:10.321322"
---
...
![](./img/note_3.0-zh-cn.png) 以下API需先使用UIContext中的[getSmartGestureController()](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-uicontext-uicontext#getsmartgesturecontroller)方法获取SmartGestureController实例，再通过该实例调用对应方法。
...
- 关闭后，组件侧[smartGestureShortcut](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-smart-gesture-shortcut#smartgestureshortcut)配置仍会保留，但不会响应智慧手势的敲一敲和划一划手势。
...
```
 ![](./img/zh-cn_image_0000002685927859.png)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| monitorCallback | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-types#callback12) | 是 | 智慧手势监听回调。回调参数为系统给出的默认动作处理，返回值用于声明是否消费当前智慧手势以及是否替换默认动作处理。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| monitorCallback | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-types#callback12) | 是 | 需要注销的智慧手势监听回调。 |
...
- 仅当目标组件满足以下全部条件时，请求才会生效：组件可以响应智慧手势，组件在屏幕内可见，且组件绑定了[onClick](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-events-click#onclick)或绑定了单击手势[TapGesture](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-gestures-tapgesture#接口)。
- 组件能否响应智慧手势由[smartGestureShortcut](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-smart-gesture-shortcut#smartgestureshortcut)中的enabled决定。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| id | string | 是 | 组件的[id](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-component-id#id)，该id对应的目标组件需满足：可以响应智慧手势、在屏幕内可见，且组件绑定了[onClick](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-events-click#onclick)或绑定了单击手势[TapGesture](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-gestures-tapgesture#接口)。 |
...
```
 ![](./img/zh-cn_image_0000002656008180.png)
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| action | [SmartGestureAction](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-appendix-enums#smartgestureaction) | 否 | 否 | 智慧手势最终执行动作。 |
| operateIntention | [OperateIntention](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-appendix-enums#operateintention) | 否 | 否 | 智慧手势底层操作意图。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| node | [FrameNode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-arkui-framenode#framenode-1) | 否 | 否 | 处理当前智慧手势的目标节点。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| node | [FrameNode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-arkui-framenode#framenode-1) | 是 | 响应点击动作的目标节点。 |
...
```
 ![](./img/zh-cn_image_0000002655848260.png)
...
```
 ![](./img/zh-cn_image_0000002686087689.png)
...
```
 ![](./img/zh-cn_image_0000002685927861.png)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| node | [FrameNode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-arkui-framenode#framenode-1) | 是 | 响应滚动动作的目标节点。 |
...
```
 ![](./img/zh-cn_image_0000002656008182.png)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| isConsumed | boolean | 是 | 是否消费当前智慧手势。 true表示消费当前智慧手势，此时如果未设置[selectedProposal](#属性-2)沿用系统默认动作处理，设置了[selectedProposal](#属性-2)以自定义动作处理。 false表示不消费，系统将本次智慧手势视为未处理。 |
...
| selectedProposal | [BaseGestureHandlingProposal](#basegesturehandlingproposal) | 否 | 是 | 用户指定的智慧手势处理行为。 当isConsumed为true时，如果未设置selectedProposal沿用系统默认动作处理，设置了selectedProposal以自定义动作处理。 当isConsumed为false时，selectedProposal设置不生效。 |

#### 示例

#### [h2]示例1（启用智慧手势并自定义动作处理）
...
```
 ![](./img/zh-cn_image_0000002655848262.png)
