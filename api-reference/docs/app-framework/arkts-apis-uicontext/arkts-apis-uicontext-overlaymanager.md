...
content_hash: "a559de005e3c"
synced_at: "2026-07-09T00:57:29.318873"
---
...
| index | number | 否 | 新增节点在OverlayManager上的层级位置。 **说明：** 当index ≥ 0时，越大，ComponentContent的层级越高；若多个ComponentContent的index相同，ComponentContent添加的时间越晚层级越高。 当index 示例：
...
```
 ![](./img/zh-cn_image_0000002661612247.gif)
...
```
 ![](./img/zh-cn_image_0000002631412956.gif)
