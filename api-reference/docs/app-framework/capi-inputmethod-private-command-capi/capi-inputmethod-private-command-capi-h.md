...
content_hash: "ee48a2607db0"
synced_at: "2026-07-09T00:59:04.676143"
---
...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [InputMethod_PrivateCommand](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-inputmethod-inputmethod-privatecommand) | InputMethod_PrivateCommand | 表示私有数据的结构体类型。输入框和输入法应用之间用于通信的私有数据。 |
