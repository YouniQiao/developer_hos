...
upstream_id: "harmonyos-references/js-apis-inputmethodengine"
catalog: "harmonyos-references"
content_hash: "50d18b8c9c22"
synced_at: "2026-08-29T18:16:13.509190"
---
...
| Interface/Class | 说明 |
| --- | --- |
| InputMethodAbility | 输入法能力对象，是输入法应用的核心入口。提供输入法生命周期事件订阅（绑定/解绑/键盘显示隐藏/子类型切换/安全模式变化等）、面板创建与销毁、安全模式获取等能力。通过getInputMethodAbility()获取实例。 |
| KeyboardDelegate | 键盘代理对象，提供物理键盘按键事件监听、光标位置变化监听、文本选择变化监听、文本内容变化监听、编辑框属性变化监听等能力。通过getKeyboardDelegate()获取实例。 |
| InputClient | 输入客户端对象，提供对编辑框的文本操作能力，包括插入文本、删除文本（前删/后删）、获取光标前后文本、移动光标、选中文本、发送功能键和扩展编辑动作、设置预览文本、发送私有数据、自定义消息通信等。通过订阅inputStart事件在回调中获取实例。 |
| KeyboardController | 键盘控制器对象，提供隐藏键盘、退出当前输入类型等能力。通过订阅inputStart事件在回调中获取实例。 |
...
| ENTER_KEY_TYPE_NEWLINE12+ | number | 8 | “换行”功能键。 |
...
获取输入法能力对象实例[InputMethodAbility](#inputmethodability)，仅支持输入法应用调用。
...
获取客户端编辑事件监听代理实例[KeyboardDelegate](#keyboarddelegate)（键盘代理对象）。
...
![](./img/note_3.0-zh-cn.png) 从 API version 8开始支持，从API version 9开始废弃。建议使用[inputMethodEngine.getInputMethodAbility()](#inputmethodenginegetinputmethodability9)替代。
...
![](./img/note_3.0-zh-cn.png) 从 API version 8开始支持，从API version 9开始废弃。建议使用[inputMethodEngine.getKeyboardDelegate()](#inputmethodenginegetkeyboarddelegate9)替代。
...
![](./img/note_3.0-zh-cn.png) 从 API version 8开始支持，从API version 23开始废弃。建议使用[InputMethodAbility](#inputmethodability)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8开始支持，API version 23开始废弃，建议使用[inputMethodEngine.InputMethodAbility.on](#oninputstart9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8开始支持，API version 23开始废弃，建议使用[inputMethodEngine.InputMethodAbility.off](#offinputstart9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8开始支持，API version 23开始废弃，建议使用[inputMethodEngine.InputMethodAbility.on](#onkeyboardshowkeyboardhide9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8开始支持，API version 23开始废弃，建议使用[inputMethodEngine.InputMethodAbility.off](#offkeyboardshowkeyboardhide9)替代。
...
| callback | Callback | 是 | 回调函数，返回当前输入法应用的安全模式。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 设置监听类型，固定取值为'securityModeChange'。 |
| callback | Callback | 否 | 取消订阅的回调函数。参数不填写时，取消订阅type对应的所有回调事件。 |
...
| callback | Callback> | 是 | 回调函数，返回向输入法应用发送的私有数据。 |
...
| callback | Callback | 是 | 回调函数，返回编辑框设置对应窗口屏幕ID。 |
...
![](./img/note_3.0-zh-cn.png) 单个输入法应用仅允许创建一个[软键盘类型](#paneltype10)和一个[状态栏类型](#paneltype10)的面板。
...
| callback | AsyncCallback | 是 | 回调函数。当输入法面板创建成功，err为undefined，data为获取到的Panel对象；否则为错误对象。 |
...
| callback | AsyncCallback | 是 | 回调函数。当输入法面板销毁成功，err为undefined，否则为错误对象。 |
...
| callback | AsyncCallback | 是 | 回调函数。当面板页面内容加载成功，err为undefined，否则err为错误对象。 |
...
![](./img/note_3.0-zh-cn.png) 面板宽度不超出屏幕宽度，面板高度不高于屏幕高度的0.7倍。
...
| callback | AsyncCallback | 是 | 回调函数。当面板大小改变成功，err为undefined，否则err为错误对象。 |
...
| callback | AsyncCallback | 是 | 回调函数。当面板位置移动成功，err为undefined，否则err为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象。返回窗口的displayId。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback | 是 | 回调函数。当面板显示成功，err为undefined，否则err为错误对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback | 是 | 回调函数。当面板隐藏成功，err为undefined，否则err为错误对象。 |
...
![](./img/note_3.0-zh-cn.png) 仅用于SOFT_KEYBOARD类型，状态为FLG_FIXED或FLG_FLOATING的面板。
...
![](./img/note_3.0-zh-cn.png) 仅用于SOFT_KEYBOARD类型，状态为FLG_FIXED或FLG_FLOATING的面板。此接口兼容[adjustPanelRect](#adjustpanelrect12)的调用方法，若入参rect仅填写属性landscapeRect和portraitRect，则默认调用[adjustPanelRect](#adjustpanelrect12)。
...
#### [h2]updatePanelRectSync

updatePanelRectSync(flag: PanelFlag, rect: PanelRect): void

预设置输入法应用横竖屏大小。

![](./img/note_3.0-zh-cn.png) 同步接口阻塞主线程，容易影响UI交互，需谨慎使用。建议优先使用对应的异步接口[updatePanelRect](#updatepanelrect)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| inputRegion | Array | 是 | 面板内接收输入事件的区域。 - 数组大小限制为[1, 4]。 - 传入的热区位置是相对于输入法面板窗口左顶点的位置。 |
...
![](./img/note_3.0-zh-cn.png) 仅用于SOFT_KEYBOARD类型，状态为FLG_FIXED或FLG_FLOATING的面板。输入法通过adjustPanelRect等接口对面板大小进行调节时，系统会根据一定规则校验计算出最终的数值（例如超出屏幕等场景），输入法应用可通过该回调获取的真实面板大小，完成最终的面板布局刷新。
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象。输入法键盘与系统面板的偏移区域。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback | 是 | 回调函数。当输入法隐藏成功，err为undefined，否则为错误对象。 |
...
![](./img/note_3.0-zh-cn.png) 从 API version 8开始支持，从API version 9开始废弃。建议使用[inputMethodEngine.KeyboardController.hide](#hide9)替代。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback | 是 | 回调函数。当退出当前输入类型成功，err为undefined，否则为错误对象。 |
...
![](./img/note_3.0-zh-cn.png) 开发者可通过注册此对象来接收已绑定当前输入法应用的编辑框应用所发送的自定义通信数据，接收到自定义通信数据时会触发此对象中[onMessage](#onmessage15)回调函数。
...
![](./img/note_3.0-zh-cn.png) 当已注册的[MessageHandler](#messagehandler15)接收到来自已绑定当前输入法应用的编辑框应用所发送的自定义通信数据时，会触发该回调函数。
...
![](./img/note_3.0-zh-cn.png) 当应用注册新的[MessageHandler](#messagehandler15)对象时，会触发上一个已注册[MessageHandler](#messagehandler15)对象的[onTerminated](#onterminated15)回调函数。
...
| callback | AsyncCallback | 是 | 回调函数。当功能键发送成功，err为undefined，data为true；当功能键发送失败，err为undefined，data为false；否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象。resolve返回true表示功能键发送成功；resolve返回false表示功能键发送失败；reject时抛出错误对象，表示执行过程中发生错误。 |
...
| callback | AsyncCallback | 是 | 回调函数。当光标前固定长度的文本获取成功，err为undefined，data为获取到的文本；否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回光标前固定长度的文本。 |
...
![](./img/note_3.0-zh-cn.png) 同步接口阻塞主线程，容易影响UI交互，需谨慎使用。建议优先使用对应的异步接口[getForward](#getforward9-1)。
...
| --- | --- | --- | --- |
| length | number | 是 | 文本长度。不能小于0。 |
| callback | AsyncCallback | 是 | 回调函数。当光标后固定长度的文本获取成功，err为undefined，data为获取到的文本；否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回光标后固定长度的文本。 |
...
![](./img/note_3.0-zh-cn.png) 同步接口阻塞主线程，容易影响UI交互，需谨慎使用。建议优先使用对应的异步接口[getBackward](#getbackward9)。
...
| --- | --- | --- | --- |
| length | number | 是 | 文本长度。不能小于0。 |
| callback | AsyncCallback | 是 | 回调函数。当光标前固定长度的文本删除成功，err为undefined，data为true；当光标前固定长度的文本删除失败，err为undefined，data为false；否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象。resolve返回true表示删除光标前固定长度的文本成功；resolve返回false表示删除光标前固定长度的文本失败；reject时抛出错误对象，表示执行过程中发生错误。 |
...
![](./img/note_3.0-zh-cn.png) 同步接口阻塞主线程，容易影响UI交互，需谨慎使用。建议优先使用对应的异步接口[deleteForward](#deleteforward9)。
...
| --- | --- | --- | --- |
| length | number | 是 | 文本长度。不能小于0。 |
| callback | AsyncCallback | 是 | 回调函数。当光标后固定长度的文本删除成功，err为undefined，data为true；否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象。resolve返回true表示删除光标后固定长度的文本成功；resolve返回false表示删除光标后固定长度的文本失败；reject时抛出错误对象，表示执行过程中发生错误。 |
...
![](./img/note_3.0-zh-cn.png) 同步接口阻塞主线程，容易影响UI交互，需谨慎使用。建议优先使用对应的异步接口[deleteBackward](#deletebackward9-1)。
...
| --- | --- | --- | --- |
| text | string | 是 | 文本内容。 |
| callback | AsyncCallback | 是 | 回调函数。当文本插入成功，err为undefined，data为true；否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象。resolve返回true表示插入文本成功；resolve返回false表示插入文本失败；reject时抛出错误对象，表示执行过程中发生错误。 |
...
![](./img/note_3.0-zh-cn.png) 同步接口阻塞主线程，容易影响UI交互，需谨慎使用。建议优先使用对应的异步接口[insertText](#inserttext9-1)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback | 是 | 回调函数。当编辑框属性值获取成功，err为undefined，data为编辑框属性值；否则为错误对象。 |
...
![](./img/note_3.0-zh-cn.png) 同步接口阻塞主线程，容易影响UI交互，需谨慎使用。建议优先使用对应的异步接口[getEditorAttribute](#geteditorattribute9)。
...
| callback | AsyncCallback | 是 | 回调函数。当光标移动成功，err为undefined，否则为错误对象。 |
...
![](./img/note_3.0-zh-cn.png) 同步接口阻塞主线程，容易影响UI交互，需谨慎使用。建议优先使用对应的异步接口[moveCursor](#movecursor9)。
...
| callback | AsyncCallback | 是 | 回调函数。当成功发送选中事件后，err为undefined，否则为错误对象。 |
...
![](./img/note_3.0-zh-cn.png) 同步接口阻塞主线程，容易影响UI交互，需谨慎使用。建议优先使用对应的异步接口[selectByRange](#selectbyrange10)。
...
![](./img/note_3.0-zh-cn.png) 同步接口阻塞主线程，容易影响UI交互，需谨慎使用。建议优先使用对应的异步接口[selectByMovement](#selectbymovement10-1)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback | 是 | 回调函数。当文本索引获取成功，err为undefined，index为光标所在处的文本索引；否则err为错误对象，index为undefined。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回光标所在处的文本索引。 |
...
![](./img/note_3.0-zh-cn.png) 同步接口阻塞主线程，容易影响UI交互，需谨慎使用。建议优先使用对应的异步接口[getTextIndexAtCursor](#gettextindexatcursor10)。
...
![](./img/note_3.0-zh-cn.png) 输入法应用调用该接口向编辑框发送扩展编辑操作，编辑框监听相应事件[on('handleExtendAction')](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-inputmethod#onhandleextendaction10)，从而进一步做出处理。
...
| callback | AsyncCallback | 是 | 回调函数。发送成功，err为undefined，否则为错误对象。 |
...
![](./img/note_3.0-zh-cn.png) 本接口仅适用于适配使用[Panel](#panel10)作为软键盘窗口的输入法应用。
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回拉起输入法的输入框所在应用窗口信息。 |
...
![](./img/note_3.0-zh-cn.png) 同步接口阻塞主线程，容易影响UI交互，需谨慎使用。建议优先使用对应的异步接口[setPreviewText](#setpreviewtext12)。
...
![](./img/note_3.0-zh-cn.png) 若当前输入框已有预上屏状态文本，调用此接口后，预上屏内容将被系统正式上屏。
...
![](./img/note_3.0-zh-cn.png) 同步接口阻塞主线程，容易影响UI交互，需谨慎使用。建议优先使用对应的异步接口[finishTextPreview](#finishtextpreview12)。
...
![](./img/caution_3.0-zh-cn.png) 从API version 20 开始，错误码801 Capability not supported.被移除。
...
| callback | Callback | 是 | 回调函数，返回绑定输入法时的附加选项。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 绑定输入法时的附加选项变更事件，固定取值为'attachOptionsDidChange'。 |
| callback | Callback | 否 | 取消订阅的回调函数。参数不填写时，默认取消订阅type对应的所有回调事件。 |
...
| landscapeInputRegion | Array | 否 | 是 | 横屏状态时，面板接收输入事件的区域。 - 数组大小限制为[1, 4]。默认值为横屏时的面板大小。 - 传入的热区位置是相对于输入法面板窗口左顶点的位置。 |
...
| portraitInputRegion | Array | 否 | 是 | 竖屏状态时，面板接收输入事件的区域。 - 数组大小限制为[1, 4]。默认值为竖屏时的面板大小。 - 传入的热区位置是相对于输入法面板窗口左顶点的位置。 |
...
![](./img/note_3.0-zh-cn.png) 从 API version 8开始支持，从API version 9开始废弃。建议使用[InputClient](#inputclient9)替代。
...
![](./img/note_3.0-zh-cn.png) 从 API version 8开始支持，从API version 9开始废弃。建议使用[inputMethodEngine.InputClient.getForward](#getforward9)替代。
...
![](./img/note_3.0-zh-cn.png) 从 API version 8开始支持，从API version 9开始废弃。建议使用[inputMethodEngine.InputClient.getForward](#getforward9-1)替代。
...
![](./img/note_3.0-zh-cn.png) 从 API version 8开始支持，从API version 9开始废弃。建议使用[inputMethodEngine.InputClient.getBackward](#getbackward9)替代。
...
![](./img/note_3.0-zh-cn.png) 从 API version 8开始支持，从API version 9开始废弃。建议使用[inputMethodEngine.InputClient.deleteForward](#deleteforward9)替代。
...
![](./img/note_3.0-zh-cn.png) 从 API version 8开始支持，从API version 9开始废弃。建议使用[inputMethodEngine.InputClient.deleteBackward](#deletebackward9)替代。
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象。返回true表示删除光标后固定长度的文本成功；返回false表示删除光标后固定长度的文本失败。 |
...
![](./img/note_3.0-zh-cn.png) 从 API version 8开始支持，从API version 9开始废弃。建议使用[inputMethodEngine.InputClient.sendKeyFunction](#sendkeyfunction9)替代。
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象。返回true表示发送功能键成功；返回false表示发送功能键失败。 |
...
![](./img/note_3.0-zh-cn.png) 从 API version 8开始支持，从API version 9开始废弃。建议使用[inputMethodEngine.InputClient.insertText](#inserttext9)替代。
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象。返回true表示插入文本成功；返回false表示插入文本失败。 |
...
![](./img/note_3.0-zh-cn.png) 从 API version 8开始支持，从API version 9开始废弃。建议使用[inputMethodEngine.InputClient.getEditorAttribute](#geteditorattribute9)替代。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback | 是 | 回调函数。当编辑框的属性值获取成功，err为undefined，data为编辑框属性值；否则为错误对象。 |
