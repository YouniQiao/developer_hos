...
upstream_id: "harmonyos-references/capi-background-process-manager-h"
catalog: "harmonyos-references"
content_hash: "26edaa09bd65"
synced_at: "2026-07-09T00:58:57.768850"
---
...
#### [h2]BackgroundProcessManager_ErrorCode
...
| 参数项 | 描述 |
| --- | --- |
| int pid | 需要被压制子进程的进程号，[OH_Ability_StartNativeChildProcess](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-native-child-process-h#oh_ability_startnativechildprocess)接口创建子进程后的pid参数，即为子进程进程号。 |
| [BackgroundProcessManager_ProcessPriority](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-background-process-manager-h#backgroundprocessmanager_processpriority) priority | 压制档位。 |

返回：

| 类型 | 说明 |
| --- | --- |
| int | 返回 [ERR_BACKGROUND_PROCESS_MANAGER_SUCCESS](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-background-process-manager-h#backgroundprocessmanager_errorcode)，表示压制参数发送成功。 返回 [ERR_BACKGROUND_PROCESS_MANAGER_INVALID_PARAM](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-background-process-manager-h#backgroundprocessmanager_errorcode)，表示参数检查失败。 |
...
| 参数项 | 描述 |
| --- | --- |
| int pid | 子进程的进程号，[OH_Ability_StartNativeChildProcess](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-native-child-process-h#oh_ability_startnativechildprocess)接口创建子进程后的pid参数，即为子进程进程号。 |

返回：

| 类型 | 说明 |
| --- | --- |
| int | 返回 [ERR_BACKGROUND_PROCESS_MANAGER_SUCCESS](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-background-process-manager-h#backgroundprocessmanager_errorcode)，表示压制参数发送成功。 |
