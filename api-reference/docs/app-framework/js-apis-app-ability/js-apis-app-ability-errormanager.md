...
| 类型 | 说明 |
| --- | --- |
| [ErrorObserver](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-inner-application-errorobserver) | ErrorObserver模块。 |
...
| 类型 | 说明 |
| --- | --- |
| [LoopObserver](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-inner-application-loopobserver) | LoopObserver模块。 |
