...
| --- | --- | --- | --- |
| [instanceId](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-app-ability-insightintentcontext#属性) | number | 是 | 意图实例唯一ID。 |
| result | [insightIntent.IntentResult](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-app-ability-insightintent#intentresultt20) | 是 | 返回意图执行结果，表示本次意图执行返回给系统入口的数据。 |
