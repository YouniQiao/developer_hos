...
content_hash: "8a37cc6ad151"
synced_at: "2026-07-28T16:40:36.915541"
---
...
| callback | AsyncCallback | 是 | 回调函数。当获取包名成功，err为undefined，data为获取的包名；否则err为错误对象。 |
...
| --- | --- | --- | --- |
| agent | WantAgent | 是 | WantAgent对象。 |
| callback | AsyncCallback | 是 | 回调函数。当取消WantAgent实例成功，err为undefined，data为undefined；否则err为错误对象。 |
...
| --- | --- | --- | --- |
| agent | WantAgent | 是 | WantAgent对象。 |
| callback | AsyncCallback | 是 | 回调函数。当获取OperationType信息成功，err为undefined，data为OperationType的数值；否则err为错误对象。 |
