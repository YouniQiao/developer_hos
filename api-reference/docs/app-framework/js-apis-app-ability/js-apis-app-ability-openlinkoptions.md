...
| parameters | Record | 否 | 是 | 表示WantParams参数。 **说明**：具体使用规则请参考[want](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-app-ability-want)中的parameters属性。 |
