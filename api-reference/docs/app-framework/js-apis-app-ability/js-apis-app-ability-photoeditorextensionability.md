...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| uri | string | 是 | 待编辑的原始图片[uri](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fileuri)，格式为file:///。 |
...
| 类型 | 说明 |
| --- | --- |
| void | Promise | 无返回结果或者无返回结果的Promise对象。 |
