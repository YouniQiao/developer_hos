...
content_hash: "d6fcfd4df11d"
synced_at: "2026-07-28T16:43:19.950309"
---
...
![](./img/note_3.0-zh-cn.png) RowSplit组件[形状裁剪](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-sharp-clipping)的默认值为true。
...
![](./img/note_3.0-zh-cn.png) 初始化后，动态修改margin、border、padding通用属性导致子组件宽度大于相邻分割线间距的异常情况下，不支持拖动分割线改变子组件的宽度。
...
![](./img/note_3.0-zh-cn.png) RowSplit的分割线可以改变左右两边子组件的宽度，子组件可改变宽度的范围取决于子组件的最大最小宽度。分割线拖动时，会实时计算子组件的宽度，当达到子组件设置的最小宽度或最大宽度限制时，分割线将停止移动。
...
```
 ![](./img/zh-cn_image_0000002656008394.gif)
