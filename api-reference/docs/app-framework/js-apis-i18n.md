...
upstream_id: "harmonyos-references/js-apis-i18n"
catalog: "harmonyos-references"
content_hash: "53ca9e388d44"
synced_at: "2026-07-09T00:59:07.739816"
---
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| country | string | 是 | 国家地区，要求是[合法的国家地区码](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/i18n-locale-culture#实现原理)。 |
| locale | string | 是 | [表示区域ID的字符串](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/i18n-locale-culture#实现原理)，由语言、脚本、国家地区组成。 |
...
![](./img/note_3.0-zh-cn.png) 890001的报错信息请以接口的实际报错为准。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| language | string | 是 | 语言，要求是[合法的语言ID](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/i18n-locale-culture#实现原理)。 |
| locale | string | 是 | [表示区域ID的字符串](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/i18n-locale-culture#实现原理)，由语言、脚本、国家地区组成。 |
| sentenceCase | boolean | 否 | true表示按照首字母大写的格式显示文本，false表示按照区域默认的大小写格式显示文本。默认值：true。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| language | string | 是 | [合法的语言ID](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/i18n-locale-culture#实现原理)。 |

返回值：

| 类型 | 说明 |
| --- | --- |
| Array | language参数指定的语言下，系统支持的国家/地区列表。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| language | string | 是 | [合法的语言ID](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/i18n-locale-culture#实现原理)，例如zh。 |
| region | string | 否 | [合法的国家地区码](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/i18n-locale-culture#实现原理)，例如CN。 默认值：SIM卡国家地区。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| language | string | 是 | [合法的语言ID](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/i18n-locale-culture#实现原理)或'default'。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| language | string | 否 | [合法的语言ID](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/i18n-locale-culture#实现原理)。默认值：系统语言。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| locale | string | 否 | [表示区域ID的字符串](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/i18n-locale-culture#实现原理)，由语言、脚本、国家地区组成，例如zh-Hans-CN。 默认值：系统当前区域ID。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| locale | string | 是 | [表示区域ID的字符串](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/i18n-locale-culture#实现原理)，由语言、脚本、国家地区组成，例如zh-Hans-CN。 |
| type | string | 否 | 表示历法，取值包括：buddhist, chinese, coptic, ethiopic, hebrew, gregory, indian, islamic_civil, islamic_tbla, islamic_umalqura, japanese, persian。 默认值：区域默认的历法。不同取值代表的含义和使用场景请参考[设置日历和历法](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/i18n-calendar)。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| country | string | 是 | 表示电话号码所属的国家地区代码，要求是[合法的国家地区码](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/i18n-locale-culture#实现原理)。 |
...
![](./img/note_3.0-zh-cn.png) 从API version 12开始，支持对拨号中的电话号码进行格式化。
...
![](./img/note_3.0-zh-cn.png) 从API version 23开始，支持对拨号中的电话号码实时获取归属地。
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| type | string | 否 | 是 | 表示对电话号码格式化的类型，取值包括：'E164', 'INTERNATIONAL', 'NATIONAL', 'RFC3966', 'TYPING'。 -在API version 8版本，type为必填项。 -API version 9版本开始，type为选填项。 -API version 12版本开始支持TYPING，表示对拨号中的电话号码实时格式化。 -API version 23版本开始，TYPING支持实时获取拨号中的电话号码的归属地。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| locale | string | 否 | [表示区域ID的字符串](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/i18n-locale-culture#实现原理)，由语言、脚本、国家地区组成。 默认值：系统当前区域ID。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| locale | string | 是 | [表示区域ID的字符串](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/i18n-locale-culture#实现原理)，由语言、脚本、国家地区组成。 生成的[BreakIterator](#breakiterator8)将按照指定区域的规则计算可换行点的位置。 |
...
| 类型 | 说明 |
| --- | --- |
| Array | 时区对象数组，数组中对象对应的时区为该地理位置推荐的时区。 |
...
#### [h2]setAppDefaultTimeZoneById

static setAppDefaultTimeZoneById(zoneID: string): void

设置当前应用的默认时区，在应用运行时生命周期内有效。

![](./img/note_3.0-zh-cn.png) 进行日期时间格式化时，若未指定时区，会优先使用应用设置的默认时区。
...
| locale | string | 是 | [表示区域ID的字符串](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/i18n-locale-culture#实现原理)，由语言、脚本、国家地区组成，如：zh-Hans-CN。 |
| style | string | 否 | 格式化使用的风格，取值包括：'long', 'short', 'narrow'。默认值：short。 不同取值显示效果请参考[数字与度量衡国际化](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/i18n-numbers-weights-measures)。 |
...
| locale | string | 否 | [表示区域ID的字符串](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/i18n-locale-culture#实现原理)，由语言、脚本、国家地区组成。如：zh-Hans-CN。 默认值：系统当前区域ID。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| locale | string | 是 | 待匹配的[区域ID字符串](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/i18n-locale-culture#实现原理)，如：zh-Hans-CN。 |
...
#### [h2]convertCanonicalLocaleIdentifier
...
| path | string | 是 | 待处理的路径，如：/data/out/tmp。 |
| delimiter | string | 否 | 路径分隔符，默认值：/。 |
| locale | [intl.Locale](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-intl#localedeprecated) | 否 | 区域对象，默认值：系统区域对象。 |
...
| localNames | Array | 否 | 是 | 节假日的本地名称列表。 |
...
#### [h2]SymbolDateTimeFormatOptions
...
#### [h2]ResolvedSymbolDateTimeFormatOptions
...
| 类型 | 说明 |
| --- | --- |
| [StyledString](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#styledstring) | 格式化后的富文本对象。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| year | [TextStyle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#textstyle) | 否 | 是 | 指定年的文本样式。默认值：StyledString默认的文本样式。 |
| month | [TextStyle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#textstyle) | 否 | 是 | 指定月的文本样式。默认值：StyledString默认的文本样式。 |
| day | [TextStyle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#textstyle) | 否 | 是 | 指定日的文本样式。默认值：StyledString默认的文本样式。 |
| hour | [TextStyle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#textstyle) | 否 | 是 | 指定时的文本样式。默认值：StyledString默认的文本样式。 |
| minute | [TextStyle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#textstyle) | 否 | 是 | 指定分的文本样式。默认值：StyledString默认的文本样式。 |
| second | [TextStyle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#textstyle) | 否 | 是 | 指定秒的文本样式。默认值：StyledString默认的文本样式。 |
| dayPeriod | [TextStyle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#textstyle) | 否 | 是 | 指定时段的文本样式。默认值：StyledString默认的文本样式。 |
| weekday | [TextStyle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#textstyle) | 否 | 是 | 指定星期的文本样式。默认值：StyledString默认的文本样式。 |
| era | [TextStyle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#textstyle) | 否 | 是 | 指定纪元的文本样式。默认值：StyledString默认的文本样式。 |
| timeZoneName | [TextStyle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#textstyle) | 否 | 是 | 指定时区名称的文本样式。默认值：StyledString默认的文本样式。 |
...
#### [h2]ResolvedSymbolNumberFormatOptions
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| numberFormat | [intl.NumberFormat](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-intl#numberformat) | [SimpleNumberFormat](#simplenumberformat18) | 是 | 用于格式化数字的对象。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| integer | [TextStyle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#textstyle) | 否 | 是 | 指定整数部分的文本样式。默认值：StyledString默认的文本样式。 |
| decimal | [TextStyle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#textstyle) | 否 | 是 | 指定小数点的文本样式。默认值：StyledString默认的文本样式。 |
| fraction | [TextStyle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#textstyle) | 否 | 是 | 指定小数部分的文本样式。默认值：StyledString默认的文本样式。 |
| unit | [TextStyle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#textstyle) | 否 | 是 | 指定单位部分的文本样式。默认值：StyledString默认的文本样式。 |
