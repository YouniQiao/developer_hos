...
content_hash: "367eaeca37f2"
synced_at: "2026-07-28T16:43:00.655919"
---
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| instance | T | 是 | 要检查的实例，T为继承自[通用属性](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-component-general-attributes)（CommonMethod）的组件属性类型。 |
