...
content_hash: "4256d8bc0764"
synced_at: "2026-07-28T16:42:24.457486"
---
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| motionBlur | Optional | 是 | 定义运动模糊参数。 当motionBlur的值为undefined时，维持之前取值。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| radius | number | 否 | 否 | 模糊半径，取值范围[0.0, ∞)，建议设置1.0以内来实现较为美观的效果。 |
...
```
 ![](./img/zh-cn_image_0000002656008304.gif)
