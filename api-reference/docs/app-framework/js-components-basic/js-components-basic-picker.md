...
content_hash: "ae3862ffbf8c"
synced_at: "2026-08-29T18:15:29.809548"
---
...
| letter-spacing | | 0 | 否 | 选择器的字符间距。见[text组件的letter-spacing样式属性](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-components-basic-text#样式)。 |
| text-decoration | string | - | 否 | 选择器的文本修饰。见[text组件的text-decoration样式属性](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-components-basic-text#样式)。 |
| font-style | string | normal | 否 | 选择器的字体样式。见[text组件的font-style样式属性](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-components-basic-text#样式)。 |
| font-weight | number | string | normal | 否 | 选择器的字体粗细。见[text组件的font-weight样式属性](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-components-basic-text#样式)。 |
| font-family | string | sans-serif | 否 | 选择器的字体列表，用逗号分隔，每个字体用字体名或者字体族名设置。列表中第一个系统中存在的或者通过[自定义字体](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-components-common-customizing-font)指定的字体，会被选中作为文本的字体。 |
| line-height | | 0px | 否 | 选择器的文本行高。 |
| column-height5+ | | - | 否 | 选择器的选择项列表高度。 |
...
```
 ![](./img/zh-cn_image_0000002701640242.gif)
