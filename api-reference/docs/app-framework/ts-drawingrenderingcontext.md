...
content_hash: "4f7960c1b5b8"
synced_at: "2026-07-28T16:46:33.585689"
---
...
| 类型 | 说明 |
| --- | --- |
| import('../api/@ohos.graphics.drawing').default.[Canvas](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-graphics-drawing-canvas) | 返回一个Canvas对象，可用于在DrawingRenderingContext绑定的Canvas组件上绘制形状、文本、图片等内容。 |
...
![](./img/zh-cn_image_0000002685928435.png)

图2 点击Clear按钮清空画布

![](./img/zh-cn_image_0000002656008758.png)
...
```
 ![](./img/zh-cn_image_0000002655848838.png)
