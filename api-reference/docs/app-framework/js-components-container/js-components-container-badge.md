---
title: "badge"
upstream_id: "harmonyos-references/js-components-container-badge"
catalog: "harmonyos-references"
content_hash: "c2b14a9edccc"
synced_at: "2026-07-09T00:58:20.246377"
---
...
![](./img/note_3.0-zh-cn.png) 仅支持单子组件节点，如果使用多子组件节点，默认使用第一个子组件节点。
...
| 名称 | 类型 | 默认值 | 必填 | 描述 |
| --- | --- | --- | --- | --- |
| badgeColor | | #fa2a2d | 否 | 新事件标记背景色。 |
| textColor | | #ffffff | 否 | 数字标记的数字文本颜色。 |
| textSize | | 10px | 否 | 数字标记的数字文本大小。 |
| badgeSize | | 6px | 否 | 圆点标记的默认大小。 |

#### 样式

支持[通用样式](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-components-common-styles)。

![](./img/note_3.0-zh-cn.png) badge组件的子组件大小不能超过badge组件本身的大小，否则子组件不会绘制。
...
```
 ![](./img/zh-cn_image_0000002661732999.png)
