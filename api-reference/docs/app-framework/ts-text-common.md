...
![](./img/note_3.0-zh-cn.png) 文本内容变更后，需等待布局完成才可获取到最新的布局信息。

#### [h2]导入对象

以Text组件为例，完整示例请参考Text组件的[示例10（获取文本信息）](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-text#示例10获取文本信息)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| menuItems | Array | 是 | 将要显示的菜单项。 **说明：** 对默认菜单项的名称、图标、快捷键提示修改不生效。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| fontWeightConfigs | [FontWeightConfigs](#fontweightconfigs24对象说明) | 否 | 是 | 字体粗细配置。默认值继承[FontWeightConfigs](#fontweightconfigs24对象说明)。 **模型约束：** 此接口仅可在Stage模型下使用。 |
...
| 类型 | 说明 |
| --- | --- |
| import('../api/@ohos.graphics.text').default.[LineMetrics](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-graphics-text#linemetrics) | 用于描述文本布局中单行文字的度量信息。 |
...
| 类型 | 说明 |
| --- | --- |
| import('../api/@ohos.graphics.text').default.[Affinity](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-graphics-text#affinity) | 位置亲和度枚举。 |
...
| 类型 | 说明 |
| --- | --- |
| import('../api/@ohos.graphics.text').default.[TextBox](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-graphics-text#textbox) | 文本矩形区域。 |
...
| 类型 | 说明 |
| --- | --- |
| import('../api/@ohos.graphics.text').default.[Paragraph](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-graphics-text#paragraph) | 保存文本内容及样式的载体，支持排版与绘制操作。 |
...
| 类型 | 说明 |
| --- | --- |
| import('../api/@ohos.graphics.text').default.[RectHeightStyle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-graphics-text#rectheightstyle) | 矩形区域高度规格枚举。 |
...
| 类型 | 说明 |
| --- | --- |
| import('../api/@ohos.inputMethod.ExtraConfig').[InputMethodExtraConfig](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-inputmethod-extraconfig#inputmethodextraconfig) | 输入法扩展信息。 |
