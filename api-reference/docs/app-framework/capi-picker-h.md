...
content_hash: "68b54643e571"
synced_at: "2026-07-28T16:49:23.642090"
---
...
| --- | --- |
| [ArkUI_TextCascadePickerRangeContentArray](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-textcascadepickerrangecontentarray)* handle | 指向ArkUI_TextCascadePickerRangeContentArray数组的指针。 |
| [ArkUI_TextCascadePickerRangeContentArray](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-textcascadepickerrangecontentarray)* child | 指向级联选择器指定位置子级数据列表的指针。 |
| int32_t index | 数组索引，取值范围为[0, 数组长度-1]，从0开始。 |
