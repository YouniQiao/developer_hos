---
title: "picker.h"
upstream_id: "harmonyos-references/capi-picker-h"
catalog: "harmonyos-references"
content_hash: "96ba7dba9df2"
synced_at: "2026-08-29T18:15:39.994763"
---
...
| [ArkUI_TextCascadePickerRangeContentArray](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-textcascadepickerrangecontentarray) | ArkUI_TextCascadePickerRangeContentArray | 定义多列联动数据选择器的列表。 |
...
创建[ArkUI_TextPickerRangeContentArray](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-textpickerrangecontentarray)数组的对象，用于构建单列滑动数据选择器的数据列表，常见于日期选择、时间选择、列表选择等场景。创建后必须在使用完毕后调用OH_ArkUI_TextPickerRangeContentArray_Destroy释放资源，否则会导致内存泄漏。
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI_TextPickerRangeContentArray](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-textpickerrangecontentarray)* | 返回指向ArkUI_TextPickerRangeContentArray数组对象的指针（数组长度由length参数指定）。如果返回空指针，表示创建失败。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI_TextPickerRangeContentArray](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-textpickerrangecontentarray)* handle | 指向ArkUI_TextPickerRangeContentArray数组的指针，需先通过OH_ArkUI_TextPickerRangeContentArray_Create创建。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI_TextPickerRangeContentArray](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-textpickerrangecontentarray)* handle | 指向ArkUI_TextPickerRangeContentArray数组的指针。 |
...
创建[ArkUI_TextCascadePickerRangeContentArray](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-textcascadepickerrangecontentarray)数组对象，用于构建多列联动数据选择器，常见于年月日联动选择、省市区三级联动选择等场景。创建后必须在使用完毕后调用OH_ArkUI_TextCascadePickerRangeContentArray_Destroy释放资源，否则会导致内存泄漏。
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI_TextCascadePickerRangeContentArray](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-textcascadepickerrangecontentarray)* | 返回指向ArkUI_TextCascadePickerRangeContentArray数组对象的指针（数组长度由length参数指定）。如果返回空指针，表示创建失败。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI_TextCascadePickerRangeContentArray](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-textcascadepickerrangecontentarray)* handle | 指向ArkUI_TextCascadePickerRangeContentArray数组的指针，需先通过OH_ArkUI_TextCascadePickerRangeContentArray_Create创建。 |
| char* text | 文本内容。 |
| int32_t index | 数组索引，取值范围为[0, 数组长度-1]，从0开始。超出范围时不生效。 |
...
| --- | --- |
| [ArkUI_TextCascadePickerRangeContentArray](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-textcascadepickerrangecontentarray)* handle | 指向ArkUI_TextCascadePickerRangeContentArray数组的指针，需先通过OH_ArkUI_TextCascadePickerRangeContentArray_Create创建。 |
| [ArkUI_TextCascadePickerRangeContentArray](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-textcascadepickerrangecontentarray)* child | 指向级联选择器指定位置子级数据列表的指针，需先通过OH_ArkUI_TextCascadePickerRangeContentArray_Create创建。 |
| int32_t index | 数组索引，取值范围为[0, 数组长度-1]，从0开始。超出范围时不生效。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI_TextCascadePickerRangeContentArray](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-textcascadepickerrangecontentarray)* handle | 指向ArkUI_TextCascadePickerRangeContentArray数组的指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI_PickerIndicatorStyle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-pickerindicatorstyle)* | ArkUI_PickerIndicatorStyle实例的指针。如果返回空指针，表示创建失败，失败原因可能是地址空间已满或类型不支持。 |
