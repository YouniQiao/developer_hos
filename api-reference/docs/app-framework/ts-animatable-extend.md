...
| 类型 | 说明 |
| --- | --- |
| [AnimatableArithmetic](#animatablearithmetict) | 加法运算的结果。 |
...
| 类型 | 说明 |
| --- | --- |
| [AnimatableArithmetic](#animatablearithmetict) | 减法运算的结果。 |
...
| 类型 | 说明 |
| --- | --- |
| [AnimatableArithmetic](#animatablearithmetict) | 乘法运算的结果。 |
