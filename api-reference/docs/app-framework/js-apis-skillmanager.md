...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回指定技能的SkillInfo。 |
...
![](./img/note_3.0-zh-cn.png) 跨用户查询时还需要 ohos.permission.INTERACT_ACROSS_LOCAL_ACCOUNTS。
...
| 类型 | 说明 |
| --- | --- |
| Promise> | Promise对象，返回指定应用的所有技能信息数组。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise> | Promise对象，返回所有应用的技能信息数组。 |
...
| 类型 | 说明 |
| --- | --- |
| [_SkillType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-bundlemanager-skillinfo#skilltype) | 技能类型的枚举。 |
