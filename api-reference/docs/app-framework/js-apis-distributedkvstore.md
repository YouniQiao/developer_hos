...
| value | Uint8Array | string | number | boolean | 否 | 否 | 键值对中的值。Uint8Array、string类型的长度不大于[MAX_VALUE_LENGTH](#constants)。 |
...
![](./img/note_3.0-zh-cn.png) 在单设备使用场景下，KV数据库支持修改securityLevel参数进行安全等级升级。升级操作需要注意以下几点：
...
| autoSync | boolean | 否 | 是 | 设置数据库是否支持跨设备自动同步。默认为false，即只支持手动同步。配置为true，即只支持在跨设备Call调用实现的多端协同中生效，其他场景无法生效。 **系统能力：** SystemCapability.DistributedDataManager.KVStore.Core **需要权限**： ohos.permission.DISTRIBUTED_DATASYNC |
| kvStoreType | [KVStoreType](#kvstoretype) | 否 | 是 | 设置要创建的数据库类型，默认为DEVICE_COLLABORATION，即多设备协同数据库。 **系统能力：** SystemCapability.DistributedDataManager.KVStore.Core |
| securityLevel | [SecurityLevel](#securitylevel) | 否 | 否 | 设置数据库安全级别。 **系统能力：** SystemCapability.DistributedDataManager.KVStore.Core |
| schema | [Schema](#schema) | 否 | 是 | 设置定义存储在数据库中的值，默认为undefined，即不使用Schema。 **系统能力：** SystemCapability.DistributedDataManager.KVStore.DistributedKVStore |
...
![](./img/caution_3.0-zh-cn.png) 在获取已有的分布式键值数据库时，如果数据库文件无法打开（例如文件头损坏），将触发自动重建逻辑，并返回新创建的分布式键值数据库实例。建议对重要且无法重新生成的数据使用备份恢复功能，以防止数据丢失。有关备份恢复的使用方法，请参阅[数据库备份与恢复](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/data-backup-and-restore)。
...
| callback | AsyncCallback | 是 | 回调函数。返回创建的分布式键值数据库实例（根据kvStoreType的不同，可以创建SingleKVStore实例和DeviceKVStore实例）。 |
...
![](./img/caution_3.0-zh-cn.png) 获取已有的分布式键值数据库时，如果数据库文件无法打开（如文件头损坏），将触发自动重建逻辑，并返回新创建的分布式键值数据库实例。建议对重要且无法重新生成的数据使用备份恢复功能，防止数据丢失。备份恢复的使用方法详见[数据库备份与恢复](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/data-backup-and-restore)。
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象。返回创建的分布式键值数据库实例（根据kvStoreType的不同，可以创建SingleKVStore实例和DeviceKVStore实例）。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象。返回所有创建的分布式键值数据库的storeId。 |
...
| deathCallback | Callback | 是 | 回调函数。订阅成功，err为undefined，否则为错误对象。 |
...
| deathCallback | Callback | 否 | 回调函数。如果该参数不填，那么会将之前订阅过的所有的deathCallback取消订阅。 |
...
![](./img/note_3.0-zh-cn.png) KVStoreResultSet的游标起始位置为-1。
...
![](./img/note_3.0-zh-cn.png) 使用equalTo时需要结合[Schema](#schema)使用。
...
![](./img/note_3.0-zh-cn.png) 使用notEqualTo时需要结合[Schema](#schema)使用。
...
![](./img/note_3.0-zh-cn.png) 使用greaterThan时需要结合[Schema](#schema)使用。
...
![](./img/note_3.0-zh-cn.png) 使用lessThan时需要结合[Schema](#schema)使用。
...
![](./img/note_3.0-zh-cn.png) 使用greaterThanOrEqualTo时需要结合[Schema](#schema)使用。
...
![](./img/note_3.0-zh-cn.png) 使用lessThanOrEqualTo时需要结合[Schema](#schema)使用。
...
![](./img/note_3.0-zh-cn.png) 使用isNull时需要结合[Schema](#schema)使用。
...
![](./img/note_3.0-zh-cn.png) 使用inNumber时需要结合[Schema](#schema)使用。
...
![](./img/note_3.0-zh-cn.png) 使用inString时需要结合[Schema](#schema)使用。
...
![](./img/note_3.0-zh-cn.png) 使用notInNumber时需要结合[Schema](#schema)使用。
...
![](./img/note_3.0-zh-cn.png) 使用notInString时需要结合[Schema](#schema)使用。
...
![](./img/note_3.0-zh-cn.png) 使用like时需要结合[Schema](#schema)使用。
...
![](./img/note_3.0-zh-cn.png) 使用unlike时需要结合[Schema](#schema)使用。
...
![](./img/note_3.0-zh-cn.png) 使用orderByAsc时需要结合[Schema](#schema)使用。
...
![](./img/note_3.0-zh-cn.png) 使用orderByDesc时需要结合[Schema](#schema)使用。
...
![](./img/note_3.0-zh-cn.png) 使用isNotNull时需要结合[Schema](#schema)使用。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| prefix | string | 是 | 表示指定的键前缀，长度不大于[MAX_KEY_LENGTH](#constants)，不能包含'^'。包含'^'将导致谓词失效，查询结果会返回数据库中的所有数据。 |
...
![](./img/note_3.0-zh-cn.png) 其中deviceId为[DeviceBasicInfo](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-distributeddevicemanager#devicebasicinfo)中的networkId，通过调用[deviceManager.getAvailableDeviceListSync](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-distributeddevicemanager#getavailabledevicelistsync)方法得到。
...
| value | Uint8Array | string | number | boolean | 是 | 要添加数据的value，支持Uint8Array、string、number、boolean，Uint8Array、string的长度不大于[MAX_VALUE_LENGTH](#constants)。 |
| callback | AsyncCallback | 是 | 回调函数。数据添加成功，err为undefined，否则为错误对象。 |
...
| callback | AsyncCallback | 是 | 回调函数。数据批量插入成功，err为undefined，否则为错误对象。 |
...
| callback | AsyncCallback | 是 | 回调函数。删除指定的数据成功，err为undefined，否则为错误对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| keys | string[] | 是 | 表示要批量删除的键名列表，不能为空，数组中每个元素的长度不大于[MAX_KEY_LENGTH](#constants)。 |
| callback | AsyncCallback | 是 | 回调函数。批量删除指定的数据成功，err为undefined，否则为错误对象。 |
...
| callback | AsyncCallback | 是 | 回调函数。删除指定设备的数据成功，err为undefined，否则为错误对象。 |
...
| callback | AsyncCallback | 是 | 回调函数。返回获取查询的值，值的类型取决于存储时的数据类型。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象。返回指定键对应的值，值的类型取决于存储时的数据类型。 |
...
| callback | AsyncCallback | 是 | 回调函数。返回匹配指定前缀的键值对列表。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象。返回匹配指定前缀的键值对列表。 |
...
| callback | AsyncCallback | 是 | 回调函数。返回与指定Query对象匹配的键值对列表。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象。返回与指定Query对象匹配的键值对列表。 |
...
| callback | AsyncCallback | 是 | 回调函数。返回具有指定前缀的结果集。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象。返回具有指定前缀的结果集。 |
...
| --- | --- | --- | --- |
| query | [Query](#query) | 是 | 表示查询对象。 |
| callback | AsyncCallback | 是 | 回调函数，获取与指定Query对象匹配的KVStoreResultSet对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象。获取与指定Query对象匹配的KVStoreResultSet对象。 |
...
| callback | AsyncCallback | 是 | 回调函数。关闭KVStoreResultSet对象成功，err为undefined，否则为错误对象。 |
...
| --- | --- | --- | --- |
| query | [Query](#query) | 是 | 表示查询对象。 |
| callback | AsyncCallback | 是 | 回调函数。返回与指定Query对象匹配的结果数。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象。获取与指定Query对象匹配的结果数。 |
...
| callback | AsyncCallback | 是 | 回调函数。当以指定名称备份数据库成功，err为undefined，否则为错误对象。 |
...
| callback | AsyncCallback | 是 | 回调函数。当从指定的数据库文件恢复数据库成功，err为undefined，否则为错误对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| files | Array | 是 | 删除备份文件所指定的名称，不能为空且长度不大于[MAX_KEY_LENGTH](#constants)。 |
| callback | AsyncCallback> | 是 | 回调函数，返回删除备份的文件名及其处理结果。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise> | Promise对象，返回删除备份的文件名及其处理结果。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback | 是 | 回调函数。启动SingleKVStore数据库中的事务成功，err为undefined，否则为错误对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback | 是 | 回调函数。提交SingleKVStore数据库中的事务成功，err为undefined，否则为错误对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback | 是 | 回调函数。SingleKVStore数据库中回滚事务成功，err为undefined，否则为错误对象。 |
...
| callback | AsyncCallback | 是 | 回调函数。设定成功，err为undefined，否则为错误对象。 |
...
| callback | AsyncCallback | 是 | 回调函数。设置成功，err为undefined，否则为错误对象。 |
...
![](./img/note_3.0-zh-cn.png) 设置默认延时后，调用[sync](#sync)接口不会立即触发端端同步，而是等待指定的延时时间后再执行。
...
![](./img/note_3.0-zh-cn.png) 其中deviceIds为[DeviceBasicInfo](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-distributeddevicemanager#devicebasicinfo)中的networkId, 通过调用[deviceManager.getAvailableDeviceListSync](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-distributeddevicemanager#getavailabledevicelistsync)方法得到。
...
| listener | Callback | 是 | 回调函数。成功返回数据变更时通知的对象。 |
...
| listener | Callback | 否 | 取消订阅的函数。如不设置callback，则取消所有已订阅的函数。 |
...
| syncCallback | Callback> | 否 | 取消订阅的同步完成回调函数。如果该参数不填，则取消所有已订阅的同步完成回调函数。如果存在同一个数据库的多个ArkTS实例(通过[getKVStore](#getkvstore)接口获取)分别注册监听了同步完成事件，则对于任意一个ArkTS实例取消其所有已订阅的同步完成回调函数时，其余ArkTS实例已订阅的所有同步完成回调函数也会被取消。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback | 是 | 回调函数。返回数据库的安全级别。 |
...
![](./img/note_3.0-zh-cn.png) rekey仅对创建时已启用加密的数据库有效，即Options中encrypt需设置为true，非加密数据库调用此接口将返回错误。
...
| --- | --- | --- | --- |
| key | string | 是 | 要查询数据的Key，不能为空且长度不大于[MAX_KEY_LENGTH](#constants)。 |
| callback | AsyncCallback | 是 | 回调函数。返回获取查询的值。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象。返回获取查询的值，值的类型取决于存储时的数据类型。 |
...
![](./img/note_3.0-zh-cn.png) 其中deviceId通过调用[deviceManager.getAvailableDeviceListSync](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-distributeddevicemanager#getavailabledevicelistsync)方法得到。
...
| callback | AsyncCallback | 是 | 回调函数。成功时返回匹配给定条件的字符串值（值的类型取决于存储时的数据类型），失败时返回错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象。返回匹配给定条件的字符串值，值的类型取决于存储时的数据类型。 |
...
| deviceId | string | 是 | 标识要查询其数据的设备。 |
| keyPrefix | string | 是 | 表示要匹配的键前缀。不能包含'^'，包含'^'将导致谓词失效，查询结果会返回数据库中的所有数据。 |
| callback | AsyncCallback | 是 | 回调函数，返回满足给定条件的所有键值对的列表。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象。返回匹配给定条件的所有键值对的列表。 |
...
| --- | --- | --- | --- |
| query | [Query](#query) | 是 | 表示要查询的对象。 |
| callback | AsyncCallback | 是 | 回调函数。返回本设备与指定Query对象匹配的键值对列表。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象。返回本设备与指定Query对象匹配的键值对列表。 |
...
| deviceId | string | 是 | 设备的networkId。 |
| query | [Query](#query) | 是 | 表示查询对象。 |
| callback | AsyncCallback | 是 | 回调函数。返回与指定设备ID和Query对象匹配的键值对列表。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象。返回与指定设备ID和Query对象匹配的键值对列表。 |
...
| deviceId | string | 是 | 标识要查询其数据的设备。 |
| keyPrefix | string | 是 | 表示要匹配的键前缀。不能包含'^'，包含'^'将导致谓词失效，查询结果会返回数据库中的所有数据。 |
| callback | AsyncCallback | 是 | 回调函数。返回与指定设备ID和Key前缀匹配的KVStoreResultSet对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象。返回与指定设备ID和Key前缀匹配的KVStoreResultSet对象。 |
...
| query | [Query](#query) | 是 | 表示查询对象。 |
| callback | AsyncCallback | 是 | 回调函数。返回与指定设备ID和Query对象匹配的KVStoreResultSet对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象。返回与指定设备ID和Query对象匹配的KVStoreResultSet对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象。获取与本设备指定Query对象匹配的KVStoreResultSet对象。 |
...
| --- | --- | --- | --- |
| query | [Query](#query) | 是 | 表示查询对象。 |
| callback | AsyncCallback | 是 | 回调函数。成功时返回与指定Query对象匹配的KVStoreResultSet对象，失败时返回错误对象。 |
...
| --- | --- | --- | --- |
| query | [Query](#query) | 是 | 表示查询对象。 |
| callback | AsyncCallback | 是 | 回调函数。返回与本设备指定Query对象匹配的结果数。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象。获取与本设备指定Query对象匹配的结果数。 |
...
| deviceId | string | 是 | KVStoreResultSet对象所属的设备ID。 |
| query | [Query](#query) | 是 | 表示查询对象。 |
| callback | AsyncCallback | 是 | 回调函数。返回与指定设备ID和Query对象匹配的结果数。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象。返回与指定设备ID和Query对象匹配的结果数。 |
