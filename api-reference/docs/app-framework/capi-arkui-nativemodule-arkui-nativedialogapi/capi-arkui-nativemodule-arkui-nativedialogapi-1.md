...
content_hash: "75d7a71dcf90"
synced_at: "2026-07-28T16:49:29.168849"
---
...
![](./img/note_3.0-zh-cn.png) create方法需要在调用[show](#show)方法之前调用。

返回：

| 类型 | 说明 |
| --- | --- |
| [ArkUI_NativeDialogHandle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-nativedialog8h) | 返回指向自定义弹窗的指针，如果创建失败，则返回空指针。 |
...
![](./img/note_3.0-zh-cn.png) setContent方法需要在调用[show](#show)方法之前调用。
...
| --- | --- |
| [ArkUI_NativeDialogHandle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-nativedialog8h) handle | 指向自定义弹窗控制器的指针。 |
| [ArkUI_NodeHandle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-node8h) content | 弹窗内容根节点指针。 |
...
![](./img/note_3.0-zh-cn.png) removeContent方法需要在调用[show](#show)方法之前调用。
...
![](./img/note_3.0-zh-cn.png) setContentAlignment方法需要在调用[show](#show)方法之前调用。
...
| --- | --- |
| [ArkUI_NativeDialogHandle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-nativedialog8h) handle | 指向自定义弹窗控制器的指针。 |
| int32_t alignment | 对齐方式，参数类型[ArkUI_Alignment](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-layout-h#arkui_alignment)。 |
...
![](./img/note_3.0-zh-cn.png) resetContentAlignment方法需要在调用[show](#show)方法之前调用。
...
![](./img/note_3.0-zh-cn.png) setModalMode方法需要在调用[show](#show)方法之前调用。
...
![](./img/note_3.0-zh-cn.png) setAutoCancel方法需要在调用[show](#show)方法之前调用。
...
![](./img/note_3.0-zh-cn.png) setMask方法需要在调用[show](#show)方法之前调用。
...
| const [ArkUI_Rect](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-rect)* maskRect | 遮罩层区域范围的指针，遮罩层区域内的事件不透传，在遮罩层区域外的事件透传。参数类型[ArkUI_Rect](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-rect)。 |
...
![](./img/note_3.0-zh-cn.png) setBackgroundColor方法需要在调用[show](#show)方法之前调用。
...
![](./img/note_3.0-zh-cn.png) setCornerRadius方法需要在调用[show](#show)方法之前调用。
...
![](./img/note_3.0-zh-cn.png) setGridColumnCount方法需要在调用[show](#show)方法之前调用。
...
| --- | --- |
| [ArkUI_NativeDialogHandle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-nativedialog8h) handle | 指向自定义弹窗控制器的指针。 |
| int32_t gridCount | 默认为按照窗口大小自适应，最大栅格数为[系统最大栅格数](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-layout-development-grid-layout#布局的总列数)。 取值范围：大于等于0的整数。 |
...
![](./img/note_3.0-zh-cn.png) enableCustomStyle方法需要在调用[show](#show)方法之前调用。
...
![](./img/note_3.0-zh-cn.png) enableCustomAnimation方法需要在调用[show](#show)方法之前调用。
...
![](./img/note_3.0-zh-cn.png) registerOnWillDismiss方法需要在调用[show](#show)方法之前调用。
...
| --- | --- |
| [ArkUI_NativeDialogHandle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-nativedialog8h) handle | 指向自定义弹窗控制器的指针。 |
| [ArkUI_OnWillDismissEvent](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-native-dialog-h#arkui_onwilldismissevent) eventHandler | 弹窗关闭的回调函数。 |
...
| 类型 | 说明 |
| --- | --- |
| int32_t | 错误码。 [ARKUI_ERROR_CODE_NO_ERROR](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-error-code-h#arkui_errorcode) 成功。此时仅表示关闭指令下发成功，不代表弹窗完全关闭。 [ARKUI_ERROR_CODE_PARAM_INVALID](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-error-code-h#arkui_errorcode) 函数参数异常。 |
