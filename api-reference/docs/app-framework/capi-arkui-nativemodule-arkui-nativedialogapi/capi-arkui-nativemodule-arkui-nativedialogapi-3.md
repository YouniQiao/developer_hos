...
| [int32_t (*setBackgroundBlurStyleOptions)(ArkUI_NativeDialogHandle handle, const ArkUI_AttributeItem* backgroundBlurStyleOptions)](#setbackgroundblurstyleoptions) | 设置自定义弹窗的背板模糊效果。 |
| [int32_t (*setBackgroundEffect)(ArkUI_NativeDialogHandle handle, const ArkUI_AttributeItem* backgroundEffect)](#setbackgroundeffect) | 设置自定义弹窗的背板效果参数。 |
...
![](./img/note_3.0-zh-cn.png) setLevelOrder方法需要在调用[show](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-nativedialogapi-1#show)之前调用。
...
![](./img/note_3.0-zh-cn.png) registerOnWillAppear方法需要在调用[show](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-nativedialogapi-1#show)之前调用。
...
![](./img/note_3.0-zh-cn.png) registerOnDidAppear方法需要在调用[show](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-nativedialogapi-1#show)之前调用。
...
![](./img/note_3.0-zh-cn.png) registerOnWillDisappear方法需要在调用[show](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-nativedialogapi-1#show)之前调用。
...
![](./img/note_3.0-zh-cn.png) registerOnDidDisappear方法需要在调用[show](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-nativedialogapi-1#show)之前调用。
...
![](./img/note_3.0-zh-cn.png) setBorderWidth方法需要在调用[show](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-nativedialogapi-1#show)之前调用。
...
![](./img/note_3.0-zh-cn.png) setBorderColor方法需要在调用[show](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-nativedialogapi-1#show)之前调用。
...
![](./img/note_3.0-zh-cn.png) setBorderStyle方法需要在调用[show](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-nativedialogapi-1#show)之前调用。
...
![](./img/note_3.0-zh-cn.png) setWidth方法需要在调用[show](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-nativedialogapi-1#show)之前调用。
...
![](./img/note_3.0-zh-cn.png) setHeight方法需要在调用[show](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-nativedialogapi-1#show)之前调用。
...
![](./img/note_3.0-zh-cn.png) setShadow方法需要在调用[show](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-nativedialogapi-1#show)之前调用。
...
| --- | --- |
| [ArkUI_NativeDialogHandle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-nativedialog8h) handle | 指向自定义弹窗控制器的指针。 |
| [ArkUI_ShadowStyle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-native-type-visual-h#arkui_shadowstyle) shadow | 背板阴影样式，枚举值。用于设置弹窗背板的阴影效果，不同枚举值提供不同深浅或漂浮样式的阴影。 |
...
![](./img/note_3.0-zh-cn.png) setCustomShadow方法需要在调用[show](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-nativedialogapi-1#show)之前调用。
...
![](./img/note_3.0-zh-cn.png) setBackgroundBlurStyle方法需要在调用[show](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-nativedialogapi-1#show)之前调用。
...
| --- | --- |
| [ArkUI_NativeDialogHandle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-nativedialog8h) handle | 指向自定义弹窗控制器的指针。 |
| [ArkUI_BlurStyle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-native-type-visual-h#arkui_blurstyle) blurStyle | 背板模糊材质，枚举值。用于设置弹窗背板的模糊效果，不同枚举值提供不同深度的材质感。 |
...
![](./img/note_3.0-zh-cn.png) setKeyboardAvoidMode方法需要在调用[show](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-nativedialogapi-1#show)之前调用。
...
| --- | --- |
| [ArkUI_NativeDialogHandle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-nativedialog8h) handle | 指向自定义弹窗控制器的指针。 |
| [ArkUI_KeyboardAvoidMode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-native-type-h#arkui_keyboardavoidmode) keyboardAvoidMode | 避让键盘模式，枚举值。用于设置键盘弹出时弹窗的避让行为。 |
...
![](./img/note_3.0-zh-cn.png) enableHoverMode方法需要在调用[show](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-nativedialogapi-1#show)之前调用。
...
![](./img/note_3.0-zh-cn.png) setHoverModeArea方法需要在调用[show](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-nativedialogapi-1#show)之前调用。
...
| --- | --- |
| [ArkUI_NativeDialogHandle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-nativedialog8h) handle | 指向自定义弹窗控制器的指针。 |
| [ArkUI_HoverModeAreaType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-native-type-h#arkui_hovermodeareatype) hoverModeAreaType | 悬停态区域，枚举值。用于设置悬停时弹窗默认展示的区域位置（上半屏或下半屏）。 |
...
![](./img/note_3.0-zh-cn.png) setFocusable方法需要在调用[show](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-nativedialogapi-1#show)之前调用。
...
![](./img/note_3.0-zh-cn.png) setBackgroundBlurStyleOptions方法需要在调用[show](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-nativedialogapi-1#show)之前调用。
...
![](./img/note_3.0-zh-cn.png) setBackgroundEffect方法需要在调用[show](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-nativedialogapi-1#show)之前调用。
