...
content_hash: "b08c8a38a124"
synced_at: "2026-08-29T18:15:55.943457"
---
...
1. Want参数配置错误；
2. type类型不一致，具体请参考EmbeddedComponent组件[接口](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-embedded-component#接口)；
3. 提供方应用未安装；
