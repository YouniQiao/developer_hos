...
content_hash: "d0d10569f396"
synced_at: "2026-08-29T18:12:56.199687"
---
...
| 类型 | 说明 |
| --- | --- |
| import('../api/@ohos.graphics.uiEffect').default.[Filter](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-uieffect#filter) | 用于将滤镜效果添加到指定的组件上。 |
...
| 类型 | 说明 |
| --- | --- |
| import('../api/@ohos.graphics.uiEffect').default.[VisualEffect](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-uieffect#visualeffect) | 用于将非滤镜视觉效果添加到指定的组件上。 |
...
```
 ![](./img/zh-cn_image_0000002701639518.jpg)
