...
content_hash: "db3ae1171e9b"
synced_at: "2026-08-29T18:16:11.529196"
---
...
| proxies10+ | Array | 否 | 是 | 卡片代理刷新的订阅信息，配置后会订阅代理刷新消息。默认为空数组，表示不订阅代理刷新消息。当需要使用卡片代理刷新功能时传入此参数，不传入时默认为空数组（不使用代理刷新）。 **模型约束：** 此接口仅可在Stage模型下使用。 |
