...
content_hash: "d6f26af13b2c"
synced_at: "2026-07-09T00:59:03.493490"
---
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| newStatus | Record | 是 | 请求修改的卡片标识和可见状态。 **说明：** number参数是取值范围[0, 2]的整数，0是未知类型，1是可见状态，2是不可见状态。 详细参考 [formInfo.VisibilityType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-app-form-forminfo#visibilitytype) |
