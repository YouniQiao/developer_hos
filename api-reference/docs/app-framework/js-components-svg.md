---
title: "svg"
upstream_id: "harmonyos-references/js-components-svg"
catalog: "harmonyos-references"
content_hash: "f874634879d5"
synced_at: "2026-07-09T00:58:24.161121"
---
...
| width | | | - | 否 | 设置组件的宽度。 |
| height | | | - | 否 | 设置组件的高度。 |
| x | | | - | 否 | 设置当前svg的x轴坐标，根svg节点无效。 |
| y | | | - | 否 | 设置当前svg的y轴坐标，根svg节点无效。 |
| viewBox | string | - | 否 | 设置当前svg的视口。支持的格式为，4个参数分别表示min-x, min-y, width and height，viewBox的宽高和svg的宽高不一致，会以中心对齐进行缩放。 |
...
```
 ![](./img/zh-cn_image_0000002631253942.png)
