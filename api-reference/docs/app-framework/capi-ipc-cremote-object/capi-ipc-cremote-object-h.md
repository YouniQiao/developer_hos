...
content_hash: "f9cd4d4d3edb"
synced_at: "2026-07-28T16:50:10.207849"
---
...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [OH_IPC_MessageOption](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-ohipcremoteobject-oh-ipc-messageoption) | - | IPC消息选项定义。 |
...
| [OHIPCParcel](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-ohipcparcel) *reply | 回应数据对象指针，不会为空，函数内不允许释放。如果函数返回错误，该值不允许写入数据。 |
