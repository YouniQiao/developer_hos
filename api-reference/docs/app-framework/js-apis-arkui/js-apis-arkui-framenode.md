...
| treeOperating | boolean | 否 | 是 | FrameNode是否支持跨ArkTS语言进行组件树操作。 true表示支持跨ArkTS语言进行组件树操作，false表示不支持跨ArkTS语言进行组件树操作。 默认值为false。 **起始版本：** 26.0.0 **元服务API：** 从API版本26.0.0开始，该接口支持在元服务中使用。 **说明：** 当FrameNode启用了跨ArkTS语言进行组件树操作的选项后，支持该FrameNode跨ArkTS语言调用[addChild](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-nativenodeapi-1#addchild)、[insertChildAfter](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-nativenodeapi-1#insertchildafter)、[insertChildAt](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-nativenodeapi-1#insertchildat)、[insertChildBefore](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-nativenodeapi-1#insertchildbefore)和[removeChild](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-nativenodeapi-1#removechild)。 |
...
| 名称 | 值 | 说明 |
| --- | --- | --- |
| NOT_EXPAND | 0 | 表示不展开当前FrameNode的子节点。如果FrameNode包含[LazyForEach](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-rendering-control-lazyforeach)子节点，获取在主节点树上的子节点时，不展开当前FrameNode的子节点。子节点序列号按在主节点树上的子节点计算。 使用场景：仅需获取主节点树上已展开子节点且不触发展开操作的场景。 **元服务API：** 从API version 15开始，该接口支持在元服务中使用。 |
| EXPAND | 1 | 表示展开当前FrameNode的子节点。如果FrameNode包含[LazyForEach](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-rendering-control-lazyforeach)子节点，获取所有子节点时，展开当前FrameNode的子节点。子节点序列号按所有子节点计算。 使用场景：需要获取包含懒加载在内的所有子节点的场景。 **元服务API：** 从API version 15开始，该接口支持在元服务中使用。 |
| LAZY_EXPAND | 2 | 表示按需展开当前FrameNode的子节点。如果FrameNode包含[LazyForEach](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-rendering-control-lazyforeach)子节点，获取在主节点树上的子节点时，不展开当前FrameNode的子节点；获取不在主节点树上的子节点时，展开当前FrameNode的子节点。子节点序列号按所有子节点计算。 使用场景：需要兼顾主节点树与非主节点树子节点按需获取的场景。 **元服务API：** 从API version 15开始，该接口支持在元服务中使用。 |
| LAZY_NOT_EXPAND | 3 | 表示不展开当前FrameNode的子节点，如果FrameNode包含[LazyForEach](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-rendering-control-lazyforeach)子节点，对于已经展开的子节点，可以直接返回，获取未展开的子节点时，仅创建对应位置的节点，而不展开所有子节点。子节点序列号按所有子节点计算。 使用场景：需要按位置精确获取子节点但不批量展开懒加载子节点的场景。 **起始版本：** 26.0.0 **元服务API：** 从API版本26.0.0开始，该接口支持在元服务中使用。 |
...
| 名称 | 值 | 说明 |
| --- | --- | --- |
| ALL_EXPAND | 0 | 计数展开模式。当遇到懒加载节点（如[LazyForEach](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-rendering-control-lazyforeach)）时，展开节点并返回所有子节点数量。 是否展开懒加载节点：是 使用场景：需要展开并返回所有子节点数量的场景。 |
...
| nodeEventRegistered | boolean | 否 | 否 | 是否以自定义组件节点的方式绑定事件，请参考[基础事件示例](#基础事件示例)。 true表示以自定义组件节点的方式绑定事件，false表示没有以自定义组件节点的方式绑定事件。 |
...
| PRESSED | 1 元服务API： 从API version 20开始，该接口支持在元服务中使用。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| node | [FrameNode](#framenode-1) | 是 | 需要添加的FrameNode。 node节点不可以为不可修改的FrameNode（例如通过getFrameNodeById等接口获取的声明式组件节点）。仅[BuilderNode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-arkui-buildernode)通过getFrameNode接口获取的FrameNode可作为声明式子节点添加。若子节点不符合规格，则抛出异常信息。 node节点不可以拥有父节点，否则抛出异常信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| child | [FrameNode](#framenode-1) | 是 | 需要添加的子节点。 child节点不可以为不可修改的FrameNode（例如通过getFrameNodeById等接口获取的声明式组件节点）。仅[BuilderNode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-arkui-buildernode)通过getFrameNode接口获取的FrameNode可作为声明式子节点添加。若子节点不符合规格，则抛出异常信息。 child节点不可以拥有父节点，否则抛出异常信息。 |
...
| --- | --- | --- | --- |
| index | number | 是 | 需要查询的子节点的序列号。 index取值范围为[0, +∞)，若当前节点有n个子节点，index取值有效范围为[0, n-1]。 |
| expandMode | [ExpandMode](#expandmode15) | 否 | 指定子节点展开模式。 默认值：ExpandMode.EXPAND |
...
#### [h2]getFirstChildIndexWithoutExpand15+
...
#### [h2]getLastChildIndexWithoutExpand15+
...
![](./img/note_3.0-zh-cn.png) 当前仅支持以下类型的[TypedFrameNode](#typedframenode12)进行移动操作：[Stack](#stack12)、[XComponent](#xcomponent12)。对于其他类型的节点，移动操作不会生效。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| targetParent | [FrameNode](#framenode-1) | 是 | 目标父节点。 targetParent节点不可以为声明式创建的节点，即不可修改的FrameNode。若目标父节点不符合规格，则抛出异常信息。 |
...
#### [h2]getGlobalPositionOnDisplay20+
...
#### [h2]getPositionToParentWithTransform12+
...
#### [h2]getPositionToWindowWithTransform12+
...
#### [h2]getPositionToScreenWithTransform12+
...
| 类型 | 说明 |
| --- | --- |
| [Edges](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-arkui-graphics#edgest12) | 用户设置的边框宽度。 |

示例：

请参考[节点操作示例](#节点操作示例)。

#### [h2]getUserConfigPadding12+
...
| 类型 | 说明 |
| --- | --- |
| [Edges](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-arkui-graphics#edgest12) | 用户设置的内边距。 |

示例：

请参考[节点操作示例](#节点操作示例)。

#### [h2]getUserConfigMargin12+
...
| 类型 | 说明 |
| --- | --- |
| [Edges](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-arkui-graphics#edgest12) | 用户设置的外边距。 |

示例：

请参考[节点操作示例](#节点操作示例)。

#### [h2]getUserConfigSize12+
...
| 类型 | 说明 |
| --- | --- |
| [SizeT](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-arkui-graphics#sizett12) | 用户设置的宽高。 |
...
获取节点的类型。系统组件类型为组件名称，例如，按钮组件[Button](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-button)的类型为Button。而对于自定义组件，若其有渲染内容，则其类型为__Common__。
...
![](./img/note_3.0-zh-cn.png) 根据组件设置的visibility属性值判断该节点是否可见。
...
![](./img/note_3.0-zh-cn.png) getInspectorInfo接口用于获取所有节点的信息，作为调试接口使用，频繁调用会导致性能下降。
...
![](./img/note_3.0-zh-cn.png) FrameNode的效果参考对齐方式为顶部起始端的[Stack](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-stack)容器组件。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| position | [Position](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-arkui-graphics#position) | 是 | 组件进行布局时使用的位置信息。单位为PX。 |

示例：

请参考[节点自定义示例](#节点自定义示例)。

#### [h2]setMeasuredSize12+
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| size | [Size](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-arkui-graphics#size) | 是 | FrameNode的测量后的尺寸，单位为PX。 |

示例：

请参考[节点自定义示例](#节点自定义示例)。

#### [h2]setLayoutPosition12+
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| position | [Position](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-arkui-graphics#position) | 是 | FrameNode的布局后的位置，单位为PX。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| content | [ComponentContent](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-arkui-componentcontent) | [ReactiveComponentContent](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-arkui-componentcontent#reactivecomponentcontent22)22+ | 是 | FrameNode节点中显示的组件内容。 |
...
#### [h2]getInteractionEventBindingInfo19+
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| eventType | [EventQueryType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-appendix-enums#eventquerytype19) | 是 | 要查询的交互事件类型。例如EventQueryType.ON_CLICK表示查询点击事件的绑定信息，各枚举值的具体含义请参考[EventQueryType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-appendix-enums#eventquerytype19)。 |
...
| 类型 | 说明 |
| --- | --- |
| number[] | 表示FrameNode上的属性值，返回的数组长度与属性枚举相关，异常时返回空数组。 对不同属性枚举的返回值格式： - 当节点已经释放，调用过[dispose](#dispose12)方法，或者属性枚举非法时，返回长度为0的空数组。 - 对于AnimationPropertyType.ROTATION，返回值为[rotationX, rotationY, rotationZ]，单位为度（°），表示绕x、y、z轴的旋转角。 - 对于AnimationPropertyType.TRANSLATION，返回值为[translateX, translateY]，单位为px，表示沿x、y轴的平移量。 - 对于AnimationPropertyType.SCALE，返回值为[scaleX, scaleY]，表示x、y方向的缩放比例。 - 对于AnimationPropertyType.OPACITY，返回值为[opacity]，表示不透明度。 1. 动画正常取消后，节点上的属性值被恢复为取消时的值，通过该接口可以获取取消后的显示值。 2. 动画期间该接口的返回值为该属性的终值，而不是动画过程的实时值。 |

示例：

请参考[动画创建与取消示例](#动画创建与取消示例)。

#### [h2]invalidateAttributes21+
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| position | [Position](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-arkui-graphics#position) | 是 | 当前节点坐标系中的相对坐标。单位为VP。 |
...
| 类型 | 说明 |
| --- | --- |
| [Position](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-arkui-graphics#position) | 目标节点局部坐标系中的转换坐标，单位为VP。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| positionByLocal | [Position](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-arkui-graphics#position) | 是 | 当前节点坐标系中的相对坐标。单位为VP。 |

返回值：

| 类型 | 说明 |
| --- | --- |
| [Position](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-arkui-graphics#position) | 当前节点所在窗口的坐标系中的转换坐标，单位为VP。 |
...
#### [h2]convertPositionFromWindow23+
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| positionByWindow | [Position](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-arkui-graphics#position) | 是 | 当前节点所在窗口的坐标系中的相对坐标。单位为VP。 |

返回值：

| 类型 | 说明 |
| --- | --- |
| [Position](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-arkui-graphics#position) | 当前节点坐标系中的转换坐标，单位为VP。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| id | string | 是 | 查询的子节点id，为通用属性设置的[组件标识](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-component-id)。 |
...
![](./img/note_3.0-zh-cn.png) [commonAttribute](#commonattribute12)仅在FrameNode上生效，TypedFrameNode上commonAttribute行为未定义。建议使用[attribute](#属性)接口而非[commonAttribute](#commonattribute12)接口进行通用属性设置，如node.attribute.backgroundColor(Color.Pink)。
...
| 类型 | 说明 |
| --- | --- |
| TypedFrameNode | 提供Text类型FrameNode节点。 TextInterface用于[TypedFrameNode](#typedframenode12)的[initialize](#属性)接口的入参，入参为Text组件的构造函数类型。 TextAttribute用于TypedFrameNode的[attribute](#属性)接口的返回值，返回Text组件的属性设置对象。 TextInterface表示Text的[接口](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-text#接口)，TextAttribute表示Text的[属性](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-text#属性)。 |

#### [h2]createNode('Text')12+
...
| 类型 | 说明 |
| --- | --- |
| TypedFrameNode | 提供Column类型FrameNode节点。 ColumnInterface用于[TypedFrameNode](#typedframenode12)的[initialize](#属性)接口的入参，入参为Column组件的构造函数类型。 ColumnAttribute用于TypedFrameNode的[attribute](#属性)接口的返回值，返回Column组件的属性设置对象。 ColumnInterface表示Column的[接口](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-column#接口)，ColumnAttribute表示Column的[属性](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-column#属性)。 |

#### [h2]createNode('Column')12+
...
| 类型 | 说明 |
| --- | --- |
| TypedFrameNode | 提供Row类型FrameNode节点。 RowInterface用于[TypedFrameNode](#typedframenode12)的[initialize](#属性)接口的入参，入参为Row组件的构造函数类型。 RowAttribute用于TypedFrameNode的[attribute](#属性)接口的返回值，返回Row组件的属性设置对象。 RowInterface表示Row的[接口](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-row#接口)，RowAttribute表示Row的[属性](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-row#属性)。 |

#### [h2]createNode('Row')12+
...
| 类型 | 说明 |
| --- | --- |
| TypedFrameNode | 提供Stack类型FrameNode节点。 StackInterface用于[TypedFrameNode](#typedframenode12)的[initialize](#属性)接口的入参，入参为Stack组件的构造函数类型。 StackAttribute用于TypedFrameNode的[attribute](#属性)接口的返回值，返回Stack组件的属性设置对象。 StackInterface表示Stack的[接口](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-stack#接口)，StackAttribute表示Stack的[属性](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-stack#属性)。 |

#### [h2]createNode('Stack')12+
...
| 类型 | 说明 |
| --- | --- |
| TypedFrameNode | 提供GridRow类型FrameNode节点。 GridRowInterface用于[TypedFrameNode](#typedframenode12)的[initialize](#属性)接口的入参，入参为GridRow组件的构造函数类型。 GridRowAttribute用于TypedFrameNode的[attribute](#属性)接口的返回值，返回GridRow组件的属性设置对象。 GridRowInterface表示GridRow的[接口](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-gridrow#接口)，GridRowAttribute表示GridRow的[属性](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-gridrow#属性)。 |

#### [h2]createNode('GridRow')12+
...
| 类型 | 说明 |
| --- | --- |
| TypedFrameNode | 提供GridCol类型FrameNode节点。 GridColInterface用于[TypedFrameNode](#typedframenode12)的[initialize](#属性)接口的入参，入参为GridCol组件的构造函数类型。 GridColAttribute用于TypedFrameNode的[attribute](#属性)接口的返回值，返回GridCol组件的属性设置对象。 GridColInterface表示GridCol的[接口](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-gridcol#接口)，GridColAttribute表示GridCol的[属性](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-gridcol#属性)。 |

#### [h2]createNode('GridCol')12+
...
| 类型 | 说明 |
| --- | --- |
| TypedFrameNode | 提供Flex类型FrameNode节点。 FlexInterface用于[TypedFrameNode](#typedframenode12)的[initialize](#属性)接口的入参，入参为Flex组件的构造函数类型。 FlexAttribute用于TypedFrameNode的[attribute](#属性)接口的返回值，返回Flex组件的属性设置对象。 FlexInterface表示Flex的[接口](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-flex#接口)，FlexAttribute表示Flex的[属性](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-flex#属性)。 |

#### [h2]createNode('Flex')12+
...
| 类型 | 说明 |
| --- | --- |
| TypedFrameNode | 提供Swiper类型FrameNode节点。 SwiperInterface用于[TypedFrameNode](#typedframenode12)的[initialize](#属性)接口的入参，入参为Swiper组件的构造函数类型。 SwiperAttribute用于TypedFrameNode的[attribute](#属性)接口的返回值，返回Swiper组件的属性设置对象。 SwiperInterface表示Swiper的[接口](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#接口)，SwiperAttribute表示Swiper的[属性](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#属性)。 |

#### [h2]createNode('Swiper')12+
...
| 类型 | 说明 |
| --- | --- |
| TypedFrameNode | 提供Progress类型FrameNode节点。 ProgressInterface用于[TypedFrameNode](#typedframenode12)的[initialize](#属性)接口的入参，入参为Progress组件的构造函数类型。 ProgressAttribute用于TypedFrameNode的[attribute](#属性)接口的返回值，返回Progress组件的属性设置对象。 ProgressInterface表示Progress的[接口](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-progress#接口)，ProgressAttribute表示Progress的[属性](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-progress#属性)。 |

#### [h2]createNode('Progress')12+
...
| 类型 | 说明 |
| --- | --- |
| TypedFrameNode | 提供Scroll类型FrameNode节点。 ScrollInterface用于[TypedFrameNode](#typedframenode12)的[initialize](#属性)接口的入参，入参为Scroll组件的构造函数类型。 ScrollAttribute用于TypedFrameNode的[attribute](#属性)接口的返回值，返回Scroll组件的属性设置对象。 ScrollInterface表示Scroll的[接口](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scroll#接口)，ScrollAttribute表示Scroll的[属性](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scroll#属性)。 |

#### [h2]createNode('Scroll')12+
...
| 类型 | 说明 |
| --- | --- |
| TypedFrameNode | 提供RelativeContainer类型FrameNode节点。 RelativeContainerInterface用于[TypedFrameNode](#typedframenode12)的[initialize](#属性)接口的入参，入参为RelativeContainer组件的构造函数类型。 RelativeContainerAttribute用于TypedFrameNode的[attribute](#属性)接口的返回值，返回RelativeContainer组件的属性设置对象。 RelativeContainerInterface表示RelativeContainer的[接口](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-relativecontainer#接口)，RelativeContainerAttribute表示RelativeContainer的[属性](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-relativecontainer#属性)。 |

#### [h2]createNode('RelativeContainer')12+
...
#### [h2]getAttribute('RelativeContainer')20+
...
| 类型 | 说明 |
| --- | --- |
| TypedFrameNode | 提供Divider类型FrameNode节点。 DividerInterface用于[TypedFrameNode](#typedframenode12)的[initialize](#属性)接口的入参，入参为Divider组件的构造函数类型。 DividerAttribute用于TypedFrameNode的[attribute](#属性)接口的返回值，返回Divider组件的属性设置对象。 DividerInterface表示Divider的[接口](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-divider#接口)，DividerAttribute表示Divider的[属性](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-divider#属性)。 |

#### [h2]createNode('Divider')12+
...
| 类型 | 说明 |
| --- | --- |
| TypedFrameNode | 提供LoadingProgress类型FrameNode节点。 LoadingProgressInterface用于[TypedFrameNode](#typedframenode12)的[initialize](#属性)接口的入参，入参为LoadingProgress组件的构造函数类型。 LoadingProgressAttribute用于TypedFrameNode的[attribute](#属性)接口的返回值，返回LoadingProgress组件的属性设置对象。 LoadingProgressInterface表示LoadingProgress的[接口](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-loadingprogress#接口)，LoadingProgressAttribute表示LoadingProgress的[属性](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-loadingprogress#属性)。 |

#### [h2]createNode('LoadingProgress')12+
...
#### [h2]getAttribute('LoadingProgress')20+
...
| 类型 | 说明 |
| --- | --- |
| TypedFrameNode | 提供Search类型FrameNode节点。 SearchInterface用于[TypedFrameNode](#typedframenode12)的[initialize](#属性)接口的入参，入参为Search组件的构造函数类型。 SearchAttribute用于TypedFrameNode的[attribute](#属性)接口的返回值，返回Search组件的属性设置对象。 SearchInterface表示Search的[接口](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-search#接口)，SearchAttribute表示Search的[属性](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-search#属性)。 |

#### [h2]createNode('Search')12+
...
| 类型 | 说明 |
| --- | --- |
| TypedFrameNode | 提供Blank类型FrameNode节点。 BlankInterface用于[TypedFrameNode](#typedframenode12)的[initialize](#属性)接口的入参，入参为Blank组件的构造函数类型。 BlankAttribute用于TypedFrameNode的[attribute](#属性)接口的返回值，返回Blank组件的属性设置对象。 BlankInterface表示Blank的[接口](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-blank#接口)，BlankAttribute表示Blank的[属性](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-blank#属性)。 |

#### [h2]createNode('Blank')12+
...
| 类型 | 说明 |
| --- | --- |
| TypedFrameNode | 提供Image类型FrameNode节点。 ImageInterface用于[TypedFrameNode](#typedframenode12)的[initialize](#属性)接口的入参，入参为Image组件的构造函数类型。 ImageAttribute用于TypedFrameNode的[attribute](#属性)接口的返回值，返回Image组件的属性设置对象。 ImageInterface表示Image的[接口](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-image#接口)，ImageAttribute表示Image的[属性](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-image#属性)。 |

#### [h2]createNode('Image')12+
...
| 类型 | 说明 |
| --- | --- |
| TypedFrameNode | 提供List类型FrameNode节点。 ListInterface用于[TypedFrameNode](#typedframenode12)的[initialize](#属性)接口的入参，入参为List组件的构造函数类型。 ListAttribute用于TypedFrameNode的[attribute](#属性)接口的返回值，返回List组件的属性设置对象。 ListInterface表示List的[接口](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-list#接口)，ListAttribute表示List的[属性](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-list#属性)。 |

#### [h2]createNode('List')12+
...
| 类型 | 说明 |
| --- | --- |
| TypedFrameNode | 提供ListItem类型FrameNode节点。 ListItemInterface用于[TypedFrameNode](#typedframenode12)的[initialize](#属性)接口的入参，入参为ListItem组件的构造函数类型。 ListItemAttribute用于TypedFrameNode的[attribute](#属性)接口的返回值，返回ListItem组件的属性设置对象。 ListItemInterface表示ListItem的[接口](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-listitem#接口)，ListItemAttribute表示ListItem的[属性](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-listitem#属性)。 |

#### [h2]createNode('ListItem')12+
...
| 类型 | 说明 |
| --- | --- |
| TypedFrameNode | 提供TextInput类型FrameNode节点。 TextInputInterface用于[TypedFrameNode](#typedframenode12)的[initialize](#属性)接口的入参，入参为TextInput组件的构造函数类型。 TextInputAttribute用于TypedFrameNode的[attribute](#属性)接口的返回值，返回TextInput组件的属性设置对象。 TextInputInterface表示TextInput的[接口](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-textinput#接口)，TextInputAttribute表示TextInput的[属性](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-textinput#属性)。 |

#### [h2]createNode('TextInput')12+
...
#### [h2]bindController('TextInput')20+
...
| 类型 | 说明 |
| --- | --- |
| TypedFrameNode | 提供Button类型FrameNode节点。 ButtonInterface用于[TypedFrameNode](#typedframenode12)的[initialize](#属性)接口的入参，入参为Button组件的构造函数类型。 ButtonAttribute用于TypedFrameNode的[attribute](#属性)接口的返回值，返回Button组件的属性设置对象。 接口入参label不为空时，以label模式创建Button组件，以此模式创建时无法包含子组件，并且不允许再设置子组件，否则会抛出异常。且label模式和子组件模式在第一次initialize创建之后无法在后续的initialize进行动态修改，如需要包含子组件，第一次initialize时不要设置label参数。 以子组件模式创建时，只能包含一个子组件，不能设置多个子组件，否则会抛出异常。 ButtonInterface表示Button的[接口](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-button#接口)，ButtonAttribute表示Button的[属性](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-button#属性)。 |

#### [h2]createNode('Button')12+
...
| 类型 | 说明 |
| --- | --- |
| TypedFrameNode | 提供ListItemGroup类型FrameNode节点。 ListItemGroupInterface用于[TypedFrameNode](#typedframenode12)的[initialize](#属性)接口的入参，入参为ListItemGroup组件的构造函数类型。 ListItemGroupAttribute用于TypedFrameNode的[attribute](#属性)接口的返回值，返回ListItemGroup组件的属性设置对象。 ListItemGroupInterface表示ListItemGroup的[接口](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-listitem#接口)，ListItemGroupAttribute表示ListItemGroup的[属性](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-listitem#属性)。 |

#### [h2]createNode('ListItemGroup')12+
...
#### [h2]getAttribute('ListItemGroup')20+
...
| 类型 | 说明 |
| --- | --- |
| TypedFrameNode | 提供[WaterFlow](#waterflow12)类型FrameNode节点。 WaterFlowInterface用于[TypedFrameNode](#typedframenode12)的[initialize](#属性)接口的入参，入参为WaterFlow组件的构造函数类型。 WaterFlowAttribute用于TypedFrameNode的[attribute](#属性)接口的返回值，返回WaterFlow组件的属性设置对象。 WaterFlowInterface表示WaterFlow的[接口](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-waterflow#接口)，WaterFlowAttribute表示WaterFlow的[属性](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-waterflow#属性)。 |

#### [h2]createNode('WaterFlow')12+
...
#### [h2]bindController('WaterFlow')20+
...
| 类型 | 说明 |
| --- | --- |
| TypedFrameNode | 提供FlowItem类型FrameNode节点。 FlowItemInterface用于[TypedFrameNode](#typedframenode12)的[initialize](#属性)接口的入参，入参为FlowItem组件的构造函数类型。 FlowItemAttribute用于TypedFrameNode的[attribute](#属性)接口的返回值，返回FlowItem组件的属性设置对象。 FlowItemInterface表示FlowItem的[接口](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-flowitem#接口)，FlowItemAttribute表示FlowItem的[属性](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-flowitem#属性)。 |

#### [h2]createNode('FlowItem')12+
...
| 类型 | 说明 |
| --- | --- |
| TypedFrameNode | 提供XComponent类型FrameNode节点。 XComponentInterface用于[TypedFrameNode](#typedframenode12)的[initialize](#属性)接口的入参，入参为XComponent组件的构造函数类型。 XComponentAttribute用于TypedFrameNode的[attribute](#属性)接口的返回值，返回XComponent组件的属性设置对象。 XComponentInterface表示XComponent的[接口](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-xcomponent#接口)，XComponentAttribute表示XComponent的[属性](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-xcomponent#属性)。 |

#### [h2]createNode('XComponent')12+
...
| 类型 | 说明 |
| --- | --- |
| TypedFrameNode | 提供QRCode类型FrameNode节点。 QRCodeInterface用于[TypedFrameNode](#typedframenode12)的[initialize](#属性)接口的入参，入参为QRCode组件的构造函数类型。 QRCodeAttribute用于TypedFrameNode的[attribute](#属性)接口的返回值，返回QRCode组件的属性设置对象。 QRCodeInterface表示QRCode的[接口](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-qrcode#接口)，QRCodeAttribute表示QRCode的[属性](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-qrcode#属性)。 |

#### [h2]createNode('QRCode')14+
...
| 类型 | 说明 |
| --- | --- |
| TypedFrameNode | 提供Badge类型FrameNode节点。 BadgeInterface用于[TypedFrameNode](#typedframenode12)的[initialize](#属性)接口的入参，入参为Badge组件的构造函数类型。 BadgeAttribute用于TypedFrameNode的[attribute](#属性)接口的返回值，返回Badge组件的属性设置对象。 BadgeInterface表示Badge的[接口](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-badge#接口)，BadgeAttribute表示Badge的[属性](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-badge#属性)。 |

#### [h2]createNode('Badge')14+
...
| 类型 | 说明 |
| --- | --- |
| TypedFrameNode | 提供Grid类型FrameNode节点。 GridInterface用于[TypedFrameNode](#typedframenode12)的[initialize](#属性)接口的入参，入参为Grid组件的构造函数类型。 GridAttribute用于TypedFrameNode的[attribute](#属性)接口的返回值，返回Grid组件的属性设置对象。 GridInterface表示Grid的[接口](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-grid#接口)，GridAttribute表示Grid的[属性](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-grid#属性)。 |

#### [h2]createNode('Grid')14+
...
| 类型 | 说明 |
| --- | --- |
| TypedFrameNode | 提供GridItem类型FrameNode节点。 GridItemInterface用于[TypedFrameNode](#typedframenode12)的[initialize](#属性)接口的入参，入参为GridItem组件的构造函数类型。 GridItemAttribute用于TypedFrameNode的[attribute](#属性)接口的返回值，返回GridItem组件的属性设置对象。 GridItemInterface表示GridItem的[接口](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-griditem#接口)，GridItemAttribute表示GridItem的[属性](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-griditem#属性)。 |

#### [h2]createNode('GridItem')14+
...
| 类型 | 说明 |
| --- | --- |
| TypedFrameNode | 提供TextClock类型FrameNode节点。 TextClockInterface用于[TypedFrameNode](#typedframenode12)的[initialize](#属性)接口的入参，入参为TextClock组件的构造函数类型。 TextClockAttribute用于TypedFrameNode的[attribute](#属性)接口的返回值，返回TextClock组件的属性设置对象。 TextClockInterface表示TextClock的[接口](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-textclock#接口)，TextClockAttribute表示TextClock的[属性](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-textclock#属性)。 |

#### [h2]createNode('TextClock')14+
...
| 类型 | 说明 |
| --- | --- |
| TypedFrameNode | 提供TextTimer类型FrameNode节点。 TextTimerInterface用于[TypedFrameNode](#typedframenode12)的[initialize](#属性)接口的入参，入参为TextTimer组件的构造函数类型。 TextTimerAttribute用于TypedFrameNode的[attribute](#属性)接口的返回值，返回TextTimer组件的属性设置对象。 TextTimerInterface表示TextTimer的[接口](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-texttimer#接口)，TextTimerAttribute表示TextTimer的[属性](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-texttimer#属性)。 |

#### [h2]createNode('TextTimer')14+
...
| 类型 | 说明 |
| --- | --- |
| TypedFrameNode | 提供Marquee类型FrameNode节点。 MarqueeInterface用于[TypedFrameNode](#typedframenode12)的[initialize](#属性)接口的入参，入参为Marquee组件的构造函数类型。 MarqueeAttribute用于TypedFrameNode的[attribute](#属性)接口的返回值，返回Marquee组件的属性设置对象。 MarqueeInterface表示Marquee的[接口](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-marquee#接口)，MarqueeAttribute表示Marquee的[属性](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-marquee#属性)。 |

#### [h2]createNode('Marquee')14+
...
| 类型 | 说明 |
| --- | --- |
| TypedFrameNode | 提供TextArea类型FrameNode节点。 TextAreaInterface用于[TypedFrameNode](#typedframenode12)的[initialize](#属性)接口的入参，入参为TextArea组件的构造函数类型。 TextAreaAttribute用于TypedFrameNode的[attribute](#属性)接口的返回值，返回TextArea组件的属性设置对象。 TextAreaInterface表示TextArea的[接口](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-textarea#接口)，TextAreaAttribute表示TextArea的[属性](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-textarea#属性)。 |

#### [h2]createNode('TextArea')14+
...
| 类型 | 说明 |
| --- | --- |
| TypedFrameNode | 提供SymbolGlyph类型FrameNode节点。 SymbolGlyphInterface用于[TypedFrameNode](#typedframenode12)的[initialize](#属性)接口的入参，入参为SymbolGlyph组件的构造函数类型。 SymbolGlyphAttribute用于TypedFrameNode的[attribute](#属性)接口的返回值，返回SymbolGlyph组件的属性设置对象。 SymbolGlyphInterface表示SymbolGlyph的[接口](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-symbolglyph#接口)，SymbolGlyphAttribute表示SymbolGlyph的[属性](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-symbolglyph#属性)。 |

#### [h2]createNode('SymbolGlyph')14+
...
| 类型 | 说明 |
| --- | --- |
| TypedFrameNode | 提供Checkbox类型FrameNode节点。 CheckboxInterface用于[TypedFrameNode](#typedframenode12)的[initialize](#属性)接口的入参，入参为Checkbox组件的构造函数类型。 CheckboxAttribute用于TypedFrameNode的[attribute](#属性)接口的返回值，返回Checkbox组件的属性设置对象。 CheckboxInterface表示Checkbox的[接口](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-checkbox#接口)，CheckboxAttribute表示Checkbox的[属性](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-checkbox#属性)。 |

#### [h2]createNode('Checkbox')18+
...
| 类型 | 说明 |
| --- | --- |
| TypedFrameNode | 提供CheckboxGroup类型FrameNode节点。 CheckboxGroupInterface用于[TypedFrameNode](#typedframenode12)的[initialize](#属性)接口的入参，入参为CheckboxGroup组件的构造函数类型。 CheckboxGroupAttribute用于TypedFrameNode的[attribute](#属性)接口的返回值，返回CheckboxGroup组件的属性设置对象。 CheckboxGroupInterface表示CheckboxGroup的[接口](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-checkboxgroup#接口)，CheckboxGroupAttribute表示CheckboxGroup的[属性](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-checkboxgroup#属性)。 |

#### [h2]createNode('CheckboxGroup')18+
...
| 类型 | 说明 |
| --- | --- |
| TypedFrameNode | 提供Rating类型FrameNode节点。 RatingInterface用于[TypedFrameNode](#typedframenode12)的[initialize](#属性)接口的入参，入参为Rating组件的构造函数类型。 RatingAttribute用于TypedFrameNode的[attribute](#属性)接口的返回值，返回Rating组件的属性设置对象。 RatingInterface表示Rating的[接口](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-rating#接口)，RatingAttribute表示Rating的[属性](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-rating#属性)。 |

#### [h2]createNode('Rating')18+
...
| 类型 | 说明 |
| --- | --- |
| TypedFrameNode | 提供Radio类型FrameNode节点。 RadioInterface用于[TypedFrameNode](#typedframenode12)的[initialize](#属性)接口的入参，入参为Radio组件的构造函数类型。 RadioAttribute用于TypedFrameNode的[attribute](#属性)接口的返回值，返回Radio组件的属性设置对象。 RadioInterface表示Radio的[接口](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-radio#接口)，RadioAttribute表示Radio的[属性](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-radio#属性)。 |

#### [h2]createNode('Radio')18+
...
| 类型 | 说明 |
| --- | --- |
| TypedFrameNode | 提供Slider类型FrameNode节点。 SliderInterface用于[TypedFrameNode](#typedframenode12)的[initialize](#属性)接口的入参，入参为Slider组件的构造函数类型。 SliderAttribute用于TypedFrameNode的[attribute](#属性)接口的返回值，返回Slider组件的属性设置对象。 SliderInterface表示Slider的[接口](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-slider#接口)，SliderAttribute表示Slider的[属性](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-slider#属性)。 |

#### [h2]createNode('Slider')18+
...
| 类型 | 说明 |
| --- | --- |
| TypedFrameNode | 提供Select类型FrameNode节点。 SelectInterface用于[TypedFrameNode](#typedframenode12)的[initialize](#属性)接口的入参，入参为Select组件的构造函数类型。 SelectAttribute用于TypedFrameNode的[attribute](#属性)接口的返回值，返回Select组件的属性设置对象。 SelectInterface表示Select的[接口](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-select#接口)，SelectAttribute表示Select的[属性](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-select#属性)。 |

#### [h2]createNode('Select')18+
...
| 类型 | 说明 |
| --- | --- |
| TypedFrameNode | 提供Toggle类型FrameNode节点。 ToggleInterface用于[TypedFrameNode](#typedframenode12)的[initialize](#属性)接口的入参，入参为Toggle组件的构造函数类型。 ToggleAttribute用于TypedFrameNode的[attribute](#属性)接口的返回值，返回Toggle组件的属性设置对象。 ToggleInterface表示Toggle的[接口](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-toggle#接口)，ToggleAttribute表示Toggle的[属性](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-toggle#属性)。 |

#### [h2]createNode('Toggle')18+
...
| options | [ToggleOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-toggle#toggleoptions18对象说明) | 否 | 创建Toggle节点的接口参数，仅可通过ToggleOptions中的type属性设置开关样式。不传入该参数时，需通过initialize接口设置Toggle的type属性。 |
...
![](./img/note_3.0-zh-cn.png) NodeAdapter各方法中的数值入参（如start、count、from、to）不能为负数，入参为负数时不做处理。
...
![](./img/note_3.0-zh-cn.png) 支持绑定的组件：Column、Row、Stack、GridRow、Flex、Swiper、RelativeContainer、List、ListItemGroup、WaterFlow、Grid。
