...
懒加载布局容器[LazyVGridLayout](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-lazyvgridlayout)、[LazyVWaterFlowLayout](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-lazyvwaterflowlayout)所显示的子组件索引发生变化时的回调类型。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| start | number | 是 | 可见区域起始位置的索引值。 取值范围：[0, 子节点总数-1] |
| end | number | 是 | 可见区域终止位置的索引值。 取值范围：[0, 子节点总数-1] |
