...
content_hash: "fa2894c1c9ac"
synced_at: "2026-07-09T00:57:49.013902"
---
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [LengthMetrics](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-arkui-graphics#lengthmetrics12) | 是 | 列与列的间距。 默认值：LengthMetrics.vp(0) |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [LengthMetrics](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-arkui-graphics#lengthmetrics12) | 是 | 行与行的间距。 默认值：LengthMetrics.vp(0) |
...
```
 ![](./img/zh-cn_image_0000002631413216.gif)
