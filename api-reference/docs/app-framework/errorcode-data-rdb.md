...
content_hash: "efd4bff32ff3"
synced_at: "2026-07-09T00:57:22.120335"
---
...
错误码排查请参考：[关系型数据库错误码常见场景及排查步骤](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/data-faq#关系型数据库错误码常见场景及排查步骤)。
...
1. **问题定位**：优先排查使用场景，再查看日志。可在日志中搜索"fdsan"进行排查，详见[fdsan使用指导](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/fdsan)。
2. **数据库恢复**：如果可以接受数据库数据丢失，则可尝试删除数据库后重新创建。否则，需要备份数据库以便恢复。具体操作可参考[数据库备份与恢复](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/data-backup-and-restore)。
