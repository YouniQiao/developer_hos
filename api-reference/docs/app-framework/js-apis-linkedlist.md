...
content_hash: "ca84f216d67c"
synced_at: "2026-07-09T00:57:26.030465"
---
...
![](./img/caution_3.0-zh-cn.png) 在LinkedList中使用[index]的方式获取元素可能导致未定义结果，推荐使用get()方法。
...
| LinkedList | LinkedList | 否 | 当前调用forEach方法的实例对象，默认值为当前实例对象。 |
