...
content_hash: "1815265aa31f"
synced_at: "2026-09-04T18:11:23.748640"
---
...
闪控球相关参数具体可见[FloatingBallParams](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-floatingball#floatingballparams)。
...
2.应用未申请ohos.permission.AUTO_RESTORE_MAIN_WINDOW权限的情况下，拉起应用窗口前未点击闪控球。
...
2.若希望不与用户交互直接拉起应用窗口，请申请ohos.permission.AUTO_RESTORE_MAIN_WINDOW权限。否则，请在点击闪控球之后再拉起应用窗口。
...
1. 建议通过[onStateChange](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-floatview#onstatechange)获取当前状态变化。启动闪控窗前，检查闪控窗是否处于已启动的状态。
2. 建议通过[onStateChange](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-floatview#onstatechange)获取当前状态变化。停止闪控窗前，检查闪控窗是否处于已停止的状态。
3. 注册闪控窗回调前，确保回调未注册。
...
使用了无效的窗口类型，有效的窗口类型见[WindowType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-window-e#windowtype7)。
