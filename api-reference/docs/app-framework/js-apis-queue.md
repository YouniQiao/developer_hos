...
upstream_id: "harmonyos-references/js-apis-queue"
catalog: "harmonyos-references"
content_hash: "cf4d70a0d335"
synced_at: "2026-07-28T16:40:57.816370"
---
...
| Queue | Queue | 否 | 当前调用forEach方法的实例对象，未指定时取当前实例对象。 |
...
| 类型 | 说明 |
| --- | --- |
| IterableIterator | 返回一个迭代器，用于遍历Queue中的所有元素。 |
