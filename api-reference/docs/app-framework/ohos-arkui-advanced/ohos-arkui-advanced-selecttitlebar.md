...
synced_at: "2026-08-29T18:15:15.481118"
---
...
| options | Array | 是 | - | 下拉菜单中的项目。 |
| menuItems | Array | 否 | - | 右侧菜单项目列表，定义标题栏右侧的菜单项目。需要在标题栏右侧添加菜单项目列表时传入此参数，缺省时不显示右侧菜单区域。 |
...
```
 ![](./img/zh-cn_image_0000002731519367.png)
...
```
 ![](./img/zh-cn_image_0000002701640168.png)
...
```
 ![](./img/zh-cn_image_0000002731359387.png)
