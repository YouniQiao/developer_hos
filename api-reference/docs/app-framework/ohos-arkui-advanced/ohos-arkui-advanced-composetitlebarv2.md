...
upstream_id: "harmonyos-references/ohos-arkui-advanced-composetitlebarv2"
catalog: "harmonyos-references"
content_hash: "a6742903b33d"
synced_at: "2026-07-28T16:48:08.289188"
---
...
![](./img/note_3.0-zh-cn.png) 入参不可为undefined，即ComposeTitleBarV2(undefined)。
...
| title | [ResourceStr](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-types#resourcestr) | 是 | @Param | 标题。 |
| subtitle | [ResourceStr](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-types#resourcestr) | 否 | @Param | 副标题。 |
| menuItems | Array | 否 | @Param | 右侧菜单项列表。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| value | [ResourceStr](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-types#resourcestr) | 否 | 否 | 图标资源。 **装饰器类型：** @Trace |
| symbolStyle | [SymbolGlyphModifier](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-attribute-symbolglyphmodifier#symbolglyphmodifier) | 否 | 是 | Symbol图标资源，优先级大于value，item左侧头像不支持设置该属性。 **装饰器类型：** @Trace |
| label | [ResourceStr](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-types#resourcestr) | 否 | 是 | 图标标签描述。 **装饰器类型：** @Trace |
| isEnabled | boolean | 否 | 是 | 是否启用，默认启用。 isEnabled为true时，表示启用。 isEnabled为false时，表示禁用。 item属性不支持触发isEnabled属性。 默认值：true。 **装饰器类型：** @Trace |
| action | [OnActionCallback](#onactioncallback) | 否 | 是 | 触发时的动作闭包，item属性不支持触发action事件。 **装饰器类型：** @Trace |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| value | [ResourceStr](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-types#resourcestr) | 否 | 否 | 图标资源。 |
| symbolStyle | [SymbolGlyphModifier](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-attribute-symbolglyphmodifier#symbolglyphmodifier) | 否 | 是 | Symbol图标资源，优先级大于value，item左侧头像不支持设置该属性。 |
| label | [ResourceStr](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-types#resourcestr) | 否 | 是 | 图标标签描述。 |
...
```
 ![](./img/zh-cn_image_0000002655848994.png)
...
```
 ![](./img/zh-cn_image_0000002686088425.png)
...
```
 ![](./img/zh-cn_image_0000002685928595.png)
