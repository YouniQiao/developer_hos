...
| [ArkUI_GuidelineOption](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-guidelineoption) | ArkUI_GuidelineOption | Guideline配置选项结构体，用于定义Guideline（RelativeContainer容器内的辅助线）的id、方向和位置。 |
...
| --- | --- |
| [ArkUI_GuidelineOption](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-guidelineoption)* guideline | 辅助线信息。 |
| [ArkUI_Axis](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-layout-h#arkui_axis) value | 方向。 |
| int32_t index | 辅助线索引值。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI_Axis](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-layout-h#arkui_axis) | 方向。 |
...
| --- | --- |
| [ArkUI_BarrierOption](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-barrieroption)* barrierStyle | 屏障信息。 |
| [ArkUI_BarrierDirection](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-layout-h#arkui_barrierdirection) value | 方向。 |
| int32_t index | 屏障索引值。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI_BarrierDirection](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-layout-h#arkui_barrierdirection) | 屏障的方向。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI_HorizontalAlignment](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-layout-h#arkui_horizontalalignment) | 参数的对齐方式。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI_HorizontalAlignment](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-layout-h#arkui_horizontalalignment) | 右对齐参数的对齐方式。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI_HorizontalAlignment](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-layout-h#arkui_horizontalalignment) | 横向居中对齐方式的参数的对齐方式。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI_VerticalAlignment](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-layout-h#arkui_verticalalignment) | 顶部对齐的参数的对齐方式。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI_VerticalAlignment](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-layout-h#arkui_verticalalignment) | 底部对齐的参数的对齐方式。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI_VerticalAlignment](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-layout-h#arkui_verticalalignment) | 纵向居中对齐方式的参数的对齐方式。 |
...
| 参数项 | 描述 |
| --- | --- |
| [const ArkUI_PositionEdges](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-positionedges)* edges | 指向PositionEdges对象的指针。 |
...
| 类型 | 说明 |
| --- | --- |
| int32_t | 错误码。 [ARKUI_ERROR_CODE_NO_ERROR](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-error-code-h#arkui_errorcode)成功。 [ARKUI_ERROR_CODE_PARAM_INVALID](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-error-code-h#arkui_errorcode) 函数参数无效。 |
...
| [ArkUI_PixelRoundCalcPolicy](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-layout-h#arkui_pixelroundcalcpolicy) value | PixelRoundPolicy对应方向的取整策略。 |
