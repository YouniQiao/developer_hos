...
content_hash: "9e8f069761dc"
synced_at: "2026-08-29T18:15:43.174599"
---
...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [ArkUI_UIInputEvent](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-eventmodule-arkui-uiinputevent) | ArkUI_UIInputEvent | ArkUI_UIInputEvent用于表示ArkUI中的UI输入事件，供ArkUI_EventModule模块中的事件接口传递和处理输入事件信息，适用于需要识别、分发或响应用户输入事件的场景。 |
| [ArkUI_CoastingAxisEvent](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-coastingaxisevent) | ArkUI_CoastingAxisEvent | 定义惯性滚动轴事件。当用户在触控板上用双指滑动时，系统会根据手指抬起时的速度，按照系统预设的衰减曲线构造滑动事件。可以监听此类事件，以便在常规轴事件之后立即处理惯性滚动效果。 仅当用户在触控板上双指抛滑，且指针位置下存在通过[registerNodeEvent](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-nativenodeapi-1#registernodeevent)注册了[NODE_ON_COASTING_AXIS_EVENT](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-native-node-h#arkui_nodeeventtype)事件的组件时，才能接收到此事件。不再需要监听此事件时，应通过[unregisterNodeEvent](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-nativenodeapi-1#unregisternodeevent)注销事件监听，避免回调持续触发。 |
| [ArkUI_TouchTestInfo](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-touchtestinfo) | ArkUI_TouchTestInfo | 定义触摸测试信息，用于在命中测试过程中获取触摸测试策略、参与命中测试的子组件ID及触摸测试信息项列表，适用于需要在子组件触摸事件中获取命中测试详细信息以自定义命中测试逻辑、优化触摸事件分发与响应的场景。 当用户通过[registerNodeEvent](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-nativenodeapi-1#registernodeevent)注册了[NODE_ON_CHILD_TOUCH_TEST](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-native-node-h#arkui_nodeeventtype)事件时，才能接收到此事件。触摸测试信息包含触摸测试策略、命中测试过程中需要参与命中测试的子组件ID和触摸测试信息项的列表。 |
| [ArkUI_TouchTestInfoItem](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-touchtestinfoitem) | ArkUI_TouchTestInfoItem | 定义触摸测试信息项。触摸测试信息项包含触摸测试中子组件的信息，适用于触摸测试过程中获取和识别子组件相关信息的场景，可以通过[OH_ArkUI_TouchTestInfoItem_GetX](#oh_arkui_touchtestinfoitem_getx)、[OH_ArkUI_TouchTestInfoItem_GetY](#oh_arkui_touchtestinfoitem_gety)等接口获取子组件信息，帮助开发者处理触摸测试结果。 |
| [ArkUI_TouchTestInfoItem*](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-touchtestinfoitemhandle) | ArkUI_TouchTestInfoItemHandle | 定义触摸测试信息项句柄，用于表示触摸测试流程中的触摸测试信息项；触摸测试接口请参见[ui_input_event.h](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-ui-input-event-h)。 |
| [ArkUI_TouchTestInfoItemHandle*](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-touchtestinfoitemhandlearray) | ArkUI_TouchTestInfoItemArray | 定义触摸测试信息项句柄数组，用于表示多个触摸测试信息项句柄。在触摸事件分发与测试过程中，可通过此数组类型统一管理和访问多个触摸测试结果，适用于需要同时处理多个触点测试信息的场景。 |
...
| [float OH_ArkUI_PointerEvent_GetCurrentLocalX(const ArkUI_UIInputEvent* event)](#oh_arkui_pointerevent_getcurrentlocalx) | 从[指向性输入事件](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-interaction-capability-overview#指向性事件)（如触摸事件、鼠标事件、轴事件）中根据实时位置获取相对于当前组件左上角的X坐标。 |
| [float OH_ArkUI_PointerEvent_GetCurrentLocalXByIndex(const ArkUI_UIInputEvent* event, uint32_t pointerIndex)](#oh_arkui_pointerevent_getcurrentlocalxbyindex) | 从[指向性输入事件](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-interaction-capability-overview#指向性事件)（如触摸事件、鼠标事件、轴事件）中根据实时位置获取特定接触点相对于当前组件左上角的X坐标。所有类型事件，pointerIndex为uint32_t，不存在小于0的取值。对于鼠标和轴事件，pointerIndex必须为0。对于触摸事件，pointerIndex必须小于当前事件的触点数量，根据给定的索引获取特定接触点相对于当前组件左上角的X坐标。 |
| [float OH_ArkUI_PointerEvent_GetCurrentLocalY(const ArkUI_UIInputEvent* event)](#oh_arkui_pointerevent_getcurrentlocaly) | 从[指向性输入事件](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-interaction-capability-overview#指向性事件)（如触摸事件、鼠标事件、轴事件）中根据实时位置获取相对于当前组件左上角的Y坐标。 |
| [float OH_ArkUI_PointerEvent_GetCurrentLocalYByIndex(const ArkUI_UIInputEvent* event, uint32_t pointerIndex)](#oh_arkui_pointerevent_getcurrentlocalybyindex) | 从[指向性输入事件](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-interaction-capability-overview#指向性事件)（如触摸事件、鼠标事件、轴事件）中根据实时位置获取特定接触点相对于当前组件左上角的Y坐标。所有类型事件，若传入的索引值小于0时为非法值。对于鼠标和轴事件，当索引值非0时为非法值。对于触摸事件，根据给定的索引获取特定接触点相对于当前组件左上角的Y坐标。 |
...
| [int32_t OH_ArkUI_UIInputEvent_GetModifierKeyStates(const ArkUI_UIInputEvent* event, uint64_t* keys)](#oh_arkui_uiinputevent_getmodifierkeystates) | 获取UI输入事件的修饰键状态。该接口会通过keys传出当前事件发生时所有修饰键的状态，应用可将keys与[ArkUI_ModifierKeyName](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-ui-input-event-h#arkui_modifierkeyname)中定义的修饰键类型进行位运算，以获取处于按下状态的修饰键。 |
...
| [ArkUI_CoastingAxisEvent* OH_ArkUI_UIInputEvent_GetCoastingAxisEvent(ArkUI_UIInputEvent* event)](#oh_arkui_uiinputevent_getcoastingaxisevent) | 从组件事件中获取惯性滚动轴事件，仅当用户在触控板上使用双指执行满足系统惯性滚动判定条件的抛滑操作，且指针位置下存在注册了[NODE_ON_COASTING_AXIS_EVENT](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-native-node-h#arkui_nodeeventtype)事件的组件时，才能获取到有效事件。在从[ArkUI_NodeEvent](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-nodeevent)对象获取到[ArkUI_UIInputEvent](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-eventmodule-arkui-uiinputevent)对象后调用此方法。惯性滚动轴事件仅在双指抛滑并离开触控板时触发，因此仅支持触控板。惯性滚动轴事件会在手指离开触控板后，根据抛滑速度产生轴值逐渐衰减的事件。由于刷新频率和性能的影响，当前事件轴值可能高于或低于上一个事件值。在惯性滚动轴事件期间，以下四种行为会中断事件，并立即收到[ARKUI_COASTING_AXIS_EVENT_PHASE_END](#arkui_coastingaxiseventphase)。1. 手指触摸触控板。2. 滚动鼠标滚轮。3. 手指或鼠标点击注册了惯性滚动轴事件的节点。需要注意的是，点击未注册此事件的节点不会产生任何效果。例如，A节点注册了惯性滚动轴事件，当事件发生时，让B节点滚动，但点击B节点不会中断此事件。点击事件的中断行为受[OH_ArkUI_PointerEvent_SetInterceptHitTestMode](#oh_arkui_pointerevent_setintercepthittestmode)的影响。此外，如果用户点击区域存在已收集的可响应惯性滚动轴事件的节点，本次惯性滚动轴事件会被强制终止。4. 应用休眠（例如最小化、锁屏）。 |
...
| 枚举项 | 描述 |
| --- | --- |
| UI_MOUSE_EVENT_ACTION_UNKNOWN = 0 | 无效行为。 **说明：** 此行为由系统侧处理，开发者无需关注。 |
...
#### [h2]ArkUI_CoastingAxisEventPhase
...
#### [h2]OH_ArkUI_UIInputEvent_GetAction()
...
#### [h2]OH_ArkUI_UIInputEvent_GetSourceType()
...
#### [h2]OH_ArkUI_UIInputEvent_GetToolType()
...
#### [h2]OH_ArkUI_UIInputEvent_GetEventTime()
...
#### [h2]OH_ArkUI_PointerEvent_GetPointerCount()
...
#### [h2]OH_ArkUI_PointerEvent_GetPointerId()
...
#### [h2]OH_ArkUI_PointerEvent_GetChangedPointerId()
...
| 类型 | 说明 |
| --- | --- |
| float | 返回当前指向性输入事件相对于当前组件左上角的X坐标。默认单位为vp，单位可跟随[setLengthMetricUnit](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-nativenodeapi-1#setlengthmetricunit)的设置而变化。如果参数异常则返回0.0f。 |

#### [h2]OH_ArkUI_PointerEvent_GetXByIndex()
...
| 类型 | 说明 |
| --- | --- |
| float | 返回指向性输入事件中特定接触点相对于当前组件左上角的X坐标。默认单位为vp，单位可跟随[setLengthMetricUnit](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-nativenodeapi-1#setlengthmetricunit)的设置而变化。如果参数异常则返回0.0f。 |

#### [h2]OH_ArkUI_PointerEvent_GetY()
...
| 类型 | 说明 |
| --- | --- |
| float | 返回当前指向性输入事件相对于当前组件左上角的Y坐标。默认单位为vp，单位可跟随[setLengthMetricUnit](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-nativenodeapi-1#setlengthmetricunit)的设置而变化。如果参数异常则返回0.0f。 |

#### [h2]OH_ArkUI_PointerEvent_GetYByIndex()
...
| 类型 | 说明 |
| --- | --- |
| float | 返回指向性输入事件中特定接触点相对于当前组件左上角的Y坐标。默认单位为vp，单位可跟随[setLengthMetricUnit](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-nativenodeapi-1#setlengthmetricunit)的设置而变化。如果参数异常则返回0.0f。 |

#### [h2]OH_ArkUI_PointerEvent_GetCurrentLocalX()
...
从[指向性输入事件](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-interaction-capability-overview#指向性事件)（如触摸事件、鼠标事件、轴事件）中根据实时位置获取相对于当前组件左上角的X坐标。
...
#### [h2]OH_ArkUI_PointerEvent_GetCurrentLocalXByIndex()
...
从[指向性输入事件](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-interaction-capability-overview#指向性事件)（如触摸事件、鼠标事件、轴事件）中根据实时位置获取特定接触点相对于当前组件左上角的X坐标。
...
| 类型 | 说明 |
| --- | --- |
| float | 返回特定接触点相对于当前组件左上角的X坐标。默认单位为vp，单位可跟随[setLengthMetricUnit](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-nativenodeapi-1#setlengthmetricunit)的设置而变化。如果参数异常则返回0.0f。 |

#### [h2]OH_ArkUI_PointerEvent_GetCurrentLocalY()
...
从[指向性输入事件](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-interaction-capability-overview#指向性事件)（如触摸事件、鼠标事件、轴事件）中根据实时位置获取相对于当前组件左上角的Y坐标。
...
#### [h2]OH_ArkUI_PointerEvent_GetCurrentLocalYByIndex()
...
从[指向性输入事件](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-interaction-capability-overview#指向性事件)（如触摸事件、鼠标事件、轴事件）中根据实时位置获取特定接触点相对于当前组件左上角的Y坐标。
...
| 类型 | 说明 |
| --- | --- |
| float | 返回特定接触点相对于当前组件左上角的Y坐标。默认单位为vp，单位可跟随[setLengthMetricUnit](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-nativenodeapi-1#setlengthmetricunit)的设置而变化。如果参数异常则返回0.0f。 |

#### [h2]OH_ArkUI_PointerEvent_GetWindowX()
...
| 类型 | 说明 |
| --- | --- |
| float | 返回当前指向性输入事件相对于当前应用窗口左上角的X坐标。默认单位为vp，单位可跟随[setLengthMetricUnit](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-nativenodeapi-1#setlengthmetricunit)的设置而变化。如果参数异常则返回0.0f。 |

#### [h2]OH_ArkUI_PointerEvent_GetWindowXByIndex()
...
| 类型 | 说明 |
| --- | --- |
| float | 返回指向性输入事件中特定接触点相对于当前应用窗口左上角的X坐标。默认单位为vp，单位可跟随[setLengthMetricUnit](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-nativenodeapi-1#setlengthmetricunit)的设置而变化。如果参数异常则返回0.0f。 |

#### [h2]OH_ArkUI_PointerEvent_GetWindowY()
...
| 类型 | 说明 |
| --- | --- |
| float | 返回当前指向性输入事件相对于当前应用窗口左上角的Y坐标。默认单位为vp，单位可跟随[setLengthMetricUnit](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-nativenodeapi-1#setlengthmetricunit)的设置而变化。如果参数异常则返回0.0f。 |

#### [h2]OH_ArkUI_PointerEvent_GetWindowYByIndex()
...
| 类型 | 说明 |
| --- | --- |
| float | 返回指向性输入事件中特定接触点相对于当前应用窗口左上角的Y坐标。默认单位为vp，单位可跟随[setLengthMetricUnit](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-nativenodeapi-1#setlengthmetricunit)的设置而变化。如果参数异常则返回0.0f。 |

#### [h2]OH_ArkUI_PointerEvent_GetDisplayX()
...
| 类型 | 说明 |
| --- | --- |
| float | 返回当前指向性输入事件相对于当前屏幕左上角的X坐标。默认单位为vp，单位可跟随[setLengthMetricUnit](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-nativenodeapi-1#setlengthmetricunit)的设置而变化。如果参数异常则返回0.0f。 |

#### [h2]OH_ArkUI_PointerEvent_GetDisplayXByIndex()
...
| 类型 | 说明 |
| --- | --- |
| float | 返回指向性输入事件中特定接触点相对于当前屏幕左上角的X坐标。默认单位为vp，单位可跟随[setLengthMetricUnit](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-nativenodeapi-1#setlengthmetricunit)的设置而变化。如果参数异常则返回0.0f。 |

#### [h2]OH_ArkUI_PointerEvent_GetDisplayY()
...
| 类型 | 说明 |
| --- | --- |
| float | 返回当前指向性输入事件相对于当前屏幕左上角的Y坐标。默认单位为vp，单位可跟随[setLengthMetricUnit](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-nativenodeapi-1#setlengthmetricunit)的设置而变化。如果参数异常则返回0.0f。 |

#### [h2]OH_ArkUI_PointerEvent_GetDisplayYByIndex()
...
| 类型 | 说明 |
| --- | --- |
| float | 返回指向性输入事件中特定接触点相对于当前屏幕左上角的Y坐标。默认单位为vp，单位可跟随[setLengthMetricUnit](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-nativenodeapi-1#setlengthmetricunit)的设置而变化。如果参数异常则返回0.0f。 |

#### [h2]OH_ArkUI_PointerEvent_GetGlobalDisplayX()
...
| 类型 | 说明 |
| --- | --- |
| float | 返回相对于全局显示的X坐标。默认单位为vp，单位可跟随[setLengthMetricUnit](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-nativenodeapi-1#setlengthmetricunit)的设置而变化。如果发生任何参数错误，例如传递的一个事件没有位置信息，则返回0.0f。 |

#### [h2]OH_ArkUI_PointerEvent_GetGlobalDisplayXByIndex()
...
| 类型 | 说明 |
| --- | --- |
| float | 返回指向性输入事件中特定接触点相对于全局显示的X坐标。默认单位为vp，单位可跟随[setLengthMetricUnit](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-nativenodeapi-1#setlengthmetricunit)的设置而变化。如果发生任何参数错误，则返回0.0f。 |

#### [h2]OH_ArkUI_PointerEvent_GetGlobalDisplayY()
...
| 类型 | 说明 |
| --- | --- |
| float | 返回相对于全局显示的Y坐标。默认单位为vp，单位可跟随[setLengthMetricUnit](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-nativenodeapi-1#setlengthmetricunit)的设置而变化。如果发生任何参数错误，例如传递的一个事件没有位置信息，则返回0.0f。 |

#### [h2]OH_ArkUI_PointerEvent_GetGlobalDisplayYByIndex()
...
| 类型 | 说明 |
| --- | --- |
| float | 返回相对于全局显示的Y坐标。默认单位为vp，单位可跟随[setLengthMetricUnit](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-nativenodeapi-1#setlengthmetricunit)的设置而变化。如果发生任何参数错误，则返回0.0f。 |

#### [h2]OH_ArkUI_PointerEvent_GetPressure()
...
#### [h2]OH_ArkUI_PointerEvent_GetTiltX()
...
#### [h2]OH_ArkUI_PointerEvent_GetTiltY()
...
#### [h2]OH_ArkUI_PointerEvent_GetRollAngle()
...
| 类型 | 说明 |
| --- | --- |
| int32_t | 错误码。 Returns [ARKUI_ERROR_CODE_NO_ERROR](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-error-code-h#arkui_errorcode) 成功。 Returns [ARKUI_ERROR_CODE_PARAM_INVALID](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-error-code-h#arkui_errorcode) 函数参数异常，可能是事件指针或rollAngle输出参数无效；请检查并传入有效参数。 |
...
#### [h2]OH_ArkUI_PointerEvent_GetTouchAreaHeight()
...
#### [h2]OH_ArkUI_PointerEvent_GetInteractionHand()
...
| 类型 | 说明 |
| --- | --- |
| int32_t | 返回结果。 如果操作成功，则返回[ARKUI_ERROR_CODE_NO_ERROR](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-error-code-h#arkui_errorcode)。 如果发生参数异常，例如事件指针、hand输出参数或pointerIndex无效，则返回[ARKUI_ERROR_CODE_PARAM_INVALID](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-error-code-h#arkui_errorcode)；请检查并传入有效参数。 |
...
| --- | --- |
| [const ArkUI_UIInputEvent](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-eventmodule-arkui-uiinputevent) *event | 表示指向当前UI输入事件的指针。 |
| int32_t pointerIndex | 表示多点触控数据列表中目标触控点的索引，有效值范围为[0, OH_ArkUI_PointerEvent_GetPointerCount(event) - 1]，不支持负索引；超出范围时返回[ARKUI_ERROR_CODE_PARAM_INVALID](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-error-code-h#arkui_errorcode)。 |
...
从[指向性输入事件](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-interaction-capability-overview#指向性事件)中获取历史事件数量。本接口支持的指向性输入事件仅包含触摸事件、鼠标事件。历史事件为此次事件与上一次事件之间发生的原始事件，仅在指向性输入事件的移动阶段（即触摸移动或鼠标移动）中适用，在其他状态中调用返回默认值0。从API version 12开始支持触摸事件，从API version 26.0.0开始支持鼠标事件。
...
#### [h2]OH_ArkUI_PointerEvent_GetHistoryEventTime()
...
#### [h2]OH_ArkUI_PointerEvent_GetHistoryPointerCount()
...
#### [h2]OH_ArkUI_PointerEvent_GetHistoryPointerId()
...
#### [h2]OH_ArkUI_PointerEvent_GetHistoryX()
...
#### [h2]OH_ArkUI_PointerEvent_GetHistoryY()
...
#### [h2]OH_ArkUI_PointerEvent_GetHistoryWindowX()
...
#### [h2]OH_ArkUI_PointerEvent_GetHistoryWindowY()
...
#### [h2]OH_ArkUI_PointerEvent_GetHistoryDisplayX()
...
#### [h2]OH_ArkUI_PointerEvent_GetHistoryDisplayY()
...
#### [h2]OH_ArkUI_PointerEvent_GetHistoryGlobalDisplayX()
...
#### [h2]OH_ArkUI_PointerEvent_GetHistoryGlobalDisplayY()
...
#### [h2]OH_ArkUI_PointerEvent_GetHistoryPressure()
...
| uint32_t historyIndex | 表示历史事件数据列表的序号，必须小于[OH_ArkUI_PointerEvent_GetHistorySize](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-ui-input-event-h#oh_arkui_pointerevent_gethistorysize)。 |
...
#### [h2]OH_ArkUI_PointerEvent_GetHistoryTiltX()
...
#### [h2]OH_ArkUI_PointerEvent_GetHistoryTiltY()
...
#### [h2]OH_ArkUI_PointerEvent_GetHistoryTouchAreaWidth()
...
#### [h2]OH_ArkUI_PointerEvent_GetHistoryTouchAreaHeight()
...
| --- | --- |
| [const ArkUI_UIInputEvent](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-eventmodule-arkui-uiinputevent)* event | 表示指向当前UI输入事件的指针。 |
| uint32_t pointerIndex | 表示多点触控数据列表中的序号，必须小于[OH_ArkUI_PointerEvent_GetHistorySize](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-ui-input-event-h#oh_arkui_pointerevent_gethistorysize)。 |
| uint32_t historyIndex | 表示历史事件数据列表的序号，必须小于[OH_ArkUI_PointerEvent_GetHistorySize](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-ui-input-event-h#oh_arkui_pointerevent_gethistorysize)。 |
...
#### [h2]OH_ArkUI_AxisEvent_GetVerticalAxisValue()
...
#### [h2]OH_ArkUI_AxisEvent_GetHorizontalAxisValue()
...
#### [h2]OH_ArkUI_AxisEvent_GetPinchAxisScaleValue()
...
#### [h2]OH_ArkUI_AxisEvent_GetAxisAction()
...
#### [h2]OH_ArkUI_PointerEvent_SetInterceptHitTestMode()
...
配置触摸测试模式，用于在接收基础触摸事件时控制组件自身、子组件、兄弟组件和祖先组件是否参与触摸命中测试，例如在需要调整触摸事件分发范围的场景中使用。仅适用于接收基础事件的场景，如使用NODE_ON_TOUCH接收触摸事件场景。对于通过[OH_ArkUI_GestureEvent_GetRawInputEvent](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-native-gesture-h#oh_arkui_gestureevent_getrawinputevent)接口从一个手势事件中获取到的ArkUI_UIInputEvent对象，无法使用该接口。
...
#### [h2]OH_ArkUI_MouseEvent_GetMouseButton()
...
#### [h2]OH_ArkUI_MouseEvent_GetMouseAction()
...
#### [h2]OH_ArkUI_PointerEvent_SetStopPropagation()
...
设置是否阻止事件冒泡，适用于当前组件已处理基础触摸事件且不希望事件继续传递给父组件或其他祖先组件的场景。仅适用于接收基础事件的场景，如使用NODE_ON_TOUCH接收触摸事件场景，不适用于轴事件。对于通过[OH_ArkUI_GestureEvent_GetRawInputEvent](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-native-gesture-h#oh_arkui_gestureevent_getrawinputevent)接口从一个手势事件中获取到的ArkUI_UIInputEvent对象，无法使用该接口。
...
#### [h2]OH_ArkUI_UIInputEvent_GetDeviceId()
...
#### [h2]OH_ArkUI_UIInputEvent_GetPressedKeys()
...
| 类型 | 说明 |
| --- | --- |
| int32_t | 错误码。 [ARKUI_ERROR_CODE_NO_ERROR](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-error-code-h#arkui_errorcode) 成功。 [ARKUI_ERROR_CODE_BUFFER_SIZE_NOT_ENOUGH](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-error-code-h#arkui_errorcode) 内存分配不足，请检查并增大pressedKeyCodes缓冲区容量。 [ARKUI_ERROR_CODE_PARAM_INVALID](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-error-code-h#arkui_errorcode) 函数参数异常，可能是事件指针、pressedKeyCodes或length无效；请检查参数并重试。 |
...
#### [h2]OH_ArkUI_FocusAxisEvent_SetStopPropagation()
...
| 类型 | 说明 |
| --- | --- |
| int32_t | 错误码。 [ARKUI_ERROR_CODE_NO_ERROR](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-error-code-h#arkui_errorcode) 成功。 [ARKUI_ERROR_CODE_PARAM_INVALID](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-error-code-h#arkui_errorcode) 参数异常。 |
...
| 类型 | 说明 |
| --- | --- |
| int32_t | 错误码。 [ARKUI_ERROR_CODE_NO_ERROR](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-error-code-h#arkui_errorcode) 成功。 [ARKUI_ERROR_CODE_PARAM_INVALID](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-error-code-h#arkui_errorcode) 函数参数异常，可能是事件指针或输出参数无效；请检查并传入有效参数。 |
...
#### [h2]OH_ArkUI_UIInputEvent_GetEventTargetWidth()
...
#### [h2]OH_ArkUI_UIInputEvent_GetEventTargetHeight()
...
#### [h2]OH_ArkUI_UIInputEvent_GetEventTargetPositionX()
...
#### [h2]OH_ArkUI_UIInputEvent_GetEventTargetPositionY()
...
#### [h2]OH_ArkUI_UIInputEvent_GetEventTargetGlobalPositionX()
...
#### [h2]OH_ArkUI_UIInputEvent_GetEventTargetGlobalPositionY()
...
#### [h2]OH_ArkUI_PointerEvent_GetPressedTimeByIndex()
...
#### [h2]OH_ArkUI_MouseEvent_GetRawDeltaX()
...
#### [h2]OH_ArkUI_MouseEvent_GetRawDeltaY()
...
| 类型 | 说明 |
| --- | --- |
| float | 返回鼠标设备在二维平面Y轴的移动增量，使用物理世界中鼠标移动的距离单位进行表示；如果发生任何参数错误，则返回0.0f。 **说明：** API版本26.0.0之前，返回值并非鼠标硬件的原始移动数据，而是原始数据缩小了Y倍，Y为系统的显示大小比例。API版本26.0.0开始，返回值为鼠标硬件的原始移动数据。 |

#### [h2]OH_ArkUI_MouseEvent_GetPressedButtons()
...
| 类型 | 说明 |
| --- | --- |
| int32_t | 返回结果代码。 如果操作成功，则返回[ARKUI_ERROR_CODE_NO_ERROR](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-error-code-h#arkui_errorcode)。 如果传入的缓冲区大小异常，则返回[ARKUI_ERROR_CODE_BUFFER_SIZE_ERROR](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-error-code-h#arkui_errorcode)。 |
...
#### [h2]OH_ArkUI_HoverEvent_IsHovered()
...
| --- | --- |
| [const ArkUI_UIInputEvent](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-eventmodule-arkui-uiinputevent)* event | ArkUI_UIInputEvent事件指针。 |
| [ArkUI_UIInputEvent](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-eventmodule-arkui-uiinputevent)** clonedEvent | 输出参数，由接口写入新创建的克隆ArkUI_UIInputEvent对象指针；使用完毕后应调用OH_ArkUI_PointerEvent_DestroyClonedEvent释放资源。 |

返回：

| 类型 | 说明 |
| --- | --- |
| int32_t | 返回结果代码。 如果操作成功，则返回[ARKUI_ERROR_CODE_NO_ERROR](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-error-code-h#arkui_errorcode)。 如果入参错误，则返回[ARKUI_ERROR_CODE_PARAM_INVALID](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-error-code-h#arkui_errorcode)。 |
...
| 类型 | 说明 |
| --- | --- |
| int32_t | 返回结果代码。 如果操作成功，则返回[ARKUI_ERROR_CODE_NO_ERROR](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-error-code-h#arkui_errorcode)。 如果入参错误，则返回[ARKUI_ERROR_CODE_PARAM_INVALID](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-error-code-h#arkui_errorcode)。 如果输入的事件指针不是克隆事件指针，则返回[ARKUI_ERROR_CODE_NOT_CLONED_POINTER_EVENT](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-error-code-h#arkui_errorcode)。 |
...
| 类型 | 说明 |
| --- | --- |
| int32_t | 返回结果代码。 如果操作成功，则返回[ARKUI_ERROR_CODE_NO_ERROR](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-error-code-h#arkui_errorcode)。 如果入参错误，则返回[ARKUI_ERROR_CODE_PARAM_INVALID](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-error-code-h#arkui_errorcode)。 如果输入的事件指针不是克隆事件指针，则返回[ARKUI_ERROR_CODE_NOT_CLONED_POINTER_EVENT](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-error-code-h#arkui_errorcode)。 如果组件状态异常，则返回[ARKUI_ERROR_CODE_POST_CLONED_COMPONENT_STATUS_ABNORMAL](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-error-code-h#arkui_errorcode)。 如果未命中可响应事件的组件，则返回[ARKUI_ERROR_CODE_POST_CLONED_NO_COMPONENT_HIT_TO_RESPOND_TO_THE_EVENT](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-error-code-h#arkui_errorcode)。 |

#### [h2]OH_ArkUI_PointerEvent_CreateClonedPointerEvent()
...
| --- | --- |
| [const ArkUI_UIInputEvent](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-eventmodule-arkui-uiinputevent)* event | ArkUI_UIInputEvent事件指针。 |
| [ArkUI_UIInputEvent](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-eventmodule-arkui-uiinputevent)** clonedEvent | 输出参数，用于接收创建成功后的ArkUI_UIInputEvent克隆事件指针；使用完毕后需调用OH_ArkUI_PointerEvent_DestroyClonedPointerEvent()释放该事件。 |

返回：

| 类型 | 说明 |
| --- | --- |
| [ArkUI_ErrorCode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-error-code-h#arkui_errorcode) | 返回结果代码。 如果操作成功，则返回[ARKUI_ERROR_CODE_NO_ERROR](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-error-code-h#arkui_errorcode)。 如果入参错误，则返回[ARKUI_ERROR_CODE_PARAM_INVALID](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-error-code-h#arkui_errorcode)。 |

#### [h2]OH_ArkUI_PointerEvent_CreatePointerEvent()
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI_UIInputEvent](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-eventmodule-arkui-uiinputevent)** event | 输出参数，用于接收新创建的ArkUI_UIInputEvent对象；使用完毕后需调用OH_ArkUI_PointerEvent_DestroyClonedPointerEvent()释放该事件。 |
...
#### [h2]OH_ArkUI_PointerEvent_DestroyClonedPointerEvent()
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI_ErrorCode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-error-code-h#arkui_errorcode) | 返回结果代码。 如果操作成功，则返回[ARKUI_ERROR_CODE_NO_ERROR](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-error-code-h#arkui_errorcode)。 如果入参错误，例如event无效或type不属于对应事件类型支持的动作类型，则返回[ARKUI_ERROR_CODE_PARAM_INVALID](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-error-code-h#arkui_errorcode)；请检查事件指针和动作类型参数。 如果输入的事件指针不是克隆事件指针，则返回[ARKUI_ERROR_CODE_NOT_CLONED_POINTER_EVENT](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-error-code-h#arkui_errorcode)。 |

#### [h2]OH_ArkUI_ClonedEvent_SetActionType()
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI_ErrorCode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-error-code-h#arkui_errorcode) | 返回结果代码。 如果操作成功，则返回[ARKUI_ERROR_CODE_NO_ERROR](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-error-code-h#arkui_errorcode)。 如果入参错误，则返回[ARKUI_ERROR_CODE_PARAM_INVALID](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-error-code-h#arkui_errorcode)。 如果输入的事件指针不是克隆事件指针，则返回[ARKUI_ERROR_CODE_NOT_CLONED_POINTER_EVENT](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-error-code-h#arkui_errorcode)。 |

#### [h2]OH_ArkUI_ClonedEvent_SetSourceType()
...
#### [h2]OH_ArkUI_ClonedEvent_SetToolType()
...
#### [h2]OH_ArkUI_ClonedEvent_SetPressure()
...
| --- | --- |
| [const ArkUI_UIInputEvent](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-eventmodule-arkui-uiinputevent)* event | ArkUI_UIInputEvent事件指针。 |
| float pressure | 应用于触摸屏的压力，通常取值范围为[0, 1]，包含0和1；部分设备可能支持大于1的值，具体范围以设备能力为准。传入不支持的值时返回[ARKUI_ERROR_CODE_PARAM_INVALID](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-error-code-h#arkui_errorcode)。 |

返回：

| 类型 | 说明 |
| --- | --- |
| [ArkUI_ErrorCode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-error-code-h#arkui_errorcode) | 返回结果代码。 如果操作成功，则返回[ARKUI_ERROR_CODE_NO_ERROR](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-error-code-h#arkui_errorcode)。 如果入参错误，例如event无效或pressure参数不符合要求，则返回[ARKUI_ERROR_CODE_PARAM_INVALID](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-error-code-h#arkui_errorcode)；请检查事件指针和压力参数。 如果输入的事件指针不是克隆事件指针，则返回[ARKUI_ERROR_CODE_NOT_CLONED_POINTER_EVENT](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-error-code-h#arkui_errorcode)。 如果事件类型不支持，可能是传入了非触摸事件；请传入触摸事件后重试。 |

#### [h2]OH_ArkUI_ClonedEvent_SetPressureByIndex()
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI_ErrorCode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-error-code-h#arkui_errorcode) | 返回结果代码。 如果操作成功，则返回[ARKUI_ERROR_CODE_NO_ERROR](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-error-code-h#arkui_errorcode)。 如果入参错误，则返回[ARKUI_ERROR_CODE_PARAM_INVALID](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-error-code-h#arkui_errorcode)。 如果输入的事件指针不是克隆事件指针，则返回[ARKUI_ERROR_CODE_NOT_CLONED_POINTER_EVENT](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-error-code-h#arkui_errorcode)。 如果事件类型不支持，则返回[ARKUI_ERROR_INPUT_EVENT_TYPE_NOT_SUPPORTED](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-error-code-h#arkui_errorcode)。 |

#### [h2]OH_ArkUI_ClonedEvent_SetEventTime()
...
#### [h2]OH_ArkUI_ClonedEvent_SetDeviceId()
...
#### [h2]OH_ArkUI_ClonedEvent_SetTargetDisplayId()
...
#### [h2]OH_ArkUI_ClonedEvent_SetChangedFingerId()
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI_ErrorCode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-error-code-h#arkui_errorcode) | 返回结果代码。 如果操作成功，则返回[ARKUI_ERROR_CODE_NO_ERROR](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-error-code-h#arkui_errorcode)。 如果入参错误，例如event无效或pointerIndex超出有效范围，则返回[ARKUI_ERROR_CODE_PARAM_INVALID](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-error-code-h#arkui_errorcode)；请检查事件指针和触摸点索引。 如果输入的事件指针不是克隆事件指针，则返回[ARKUI_ERROR_CODE_NOT_CLONED_POINTER_EVENT](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-error-code-h#arkui_errorcode)。 如果事件类型不支持，可能是传入了非触摸事件；请传入触摸事件后重试。 |

#### [h2]OH_ArkUI_ClonedEvent_SetFingerIdByIndex()
...
#### [h2]OH_ArkUI_ClonedEvent_SetChangedWindowPosition()
...
#### [h2]OH_ArkUI_ClonedEvent_SetWindowPositionByIndex()
...
#### [h2]OH_ArkUI_ClonedEvent_SetChangedScreenPosition()
...
#### [h2]OH_ArkUI_ClonedEvent_SetScreenPositionByIndex()
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI_ErrorCode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-error-code-h#arkui_errorcode) | 返回结果代码。 如果操作成功，则返回[ARKUI_ERROR_CODE_NO_ERROR](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-error-code-h#arkui_errorcode)。 如果入参错误，例如event无效、pointerIndex超出有效范围或坐标参数不符合要求，则返回[ARKUI_ERROR_CODE_PARAM_INVALID](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-error-code-h#arkui_errorcode)；请检查事件指针、触摸点索引和坐标参数。 如果输入的事件指针不是克隆事件指针，则返回[ARKUI_ERROR_CODE_NOT_CLONED_POINTER_EVENT](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-error-code-h#arkui_errorcode)。 如果事件类型不支持，可能是传入了非触摸事件；请传入触摸事件后重试。 |

#### [h2]OH_ArkUI_ClonedEvent_SetChangedGlobalDisplayPosition()
...
#### [h2]OH_ArkUI_ClonedEvent_SetGlobalDisplayPositionByIndex()
...
#### [h2]OH_ArkUI_ClonedEvent_SetHandleId()
...
#### [h2]OH_ArkUI_ClonedEvent_SetTiltAngle()
...
#### [h2]OH_ArkUI_ClonedEvent_SetRollAngle()
...
#### [h2]OH_ArkUI_ClonedEvent_SetPressedKeys()
...
| --- | --- |
| [const ArkUI_UIInputEvent](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-eventmodule-arkui-uiinputevent)* event | ArkUI_UIInputEvent事件指针。 |
| int32_t* pressedKeyCodes | 所有按下按键的键值数组，键值取值为[ArkUI_KeyCode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-native-key-event-h#arkui_keycode)。 |
...
#### [h2]OH_ArkUI_ClonedEvent_SetChangedTouchArea()
...
#### [h2]OH_ArkUI_ClonedEvent_SetTouchAreaByIndex()
...
#### [h2]OH_ArkUI_ClonedEvent_SetChangedInteractionHand()
...
#### [h2]OH_ArkUI_ClonedEvent_SetInteractionHandByIndex()
...
#### [h2]OH_ArkUI_ClonedEvent_SetPressedTimeByIndex()
...
#### [h2]OH_ArkUI_ClonedEvent_SetPinchAxisScaleValue()
...
#### [h2]OH_ArkUI_ClonedEvent_SetHorizontalAxisScaleValue()
...
#### [h2]OH_ArkUI_ClonedEvent_SetVerticalAxisScaleValue()
...
#### [h2]OH_ArkUI_ClonedEvent_SetScrollStep()
...
#### [h2]OH_ArkUI_ClonedEvent_SetMouseButton()
...
#### [h2]OH_ArkUI_ClonedEvent_SetRawDeltaX()
...
#### [h2]OH_ArkUI_ClonedEvent_SetRawDeltaY()
...
#### [h2]OH_ArkUI_ClonedEvent_SetPressedButtons()
...
#### [h2]OH_ArkUI_PointerEvent_PostClonedEventWithStrategy()
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI_ErrorCode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-error-code-h#arkui_errorcode) | 返回结果代码。 如果操作成功，则返回[ARKUI_ERROR_CODE_NO_ERROR](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-error-code-h#arkui_errorcode)。 如果入参错误，例如node、event或strategy无效，则返回[ARKUI_ERROR_CODE_PARAM_INVALID](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-error-code-h#arkui_errorcode)；请检查并传入有效节点、事件指针和竞争策略。 如果输入的事件指针不是克隆事件指针，则返回[ARKUI_ERROR_CODE_NOT_CLONED_POINTER_EVENT](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-error-code-h#arkui_errorcode)。 如果组件状态异常，则返回[ARKUI_ERROR_CODE_POST_CLONED_COMPONENT_STATUS_ABNORMAL](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-error-code-h#arkui_errorcode)。 如果未命中可响应事件的组件，则返回[ARKUI_ERROR_CODE_POST_CLONED_NO_COMPONENT_HIT_TO_RESPOND_TO_THE_EVENT](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-error-code-h#arkui_errorcode)。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI_ErrorCode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-error-code-h#arkui_errorcode) | 返回最近一次调用UIInput方法产生的结果代码。 |

#### [h2]OH_ArkUI_UIInputEvent_GetCoastingAxisEvent()
...
请在从[ArkUI_NodeEvent](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-nodeevent)对象获取[ArkUI_UIInputEvent](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-eventmodule-arkui-uiinputevent)对象后调用此方法，以获取惯性滚动轴事件。仅当用户在触控板上使用双指执行满足系统惯性滚动判定条件的抛滑操作，且指针位置下存在注册了[NODE_ON_COASTING_AXIS_EVENT](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-native-node-h#arkui_nodeeventtype)事件的组件时，才能获取有效事件。
...
#### [h2]OH_ArkUI_CoastingAxisEvent_GetEventTime()
...
#### [h2]OH_ArkUI_CoastingAxisEvent_GetPhase()
...
#### [h2]OH_ArkUI_CoastingAxisEvent_GetDeltaX()
...
#### [h2]OH_ArkUI_CoastingAxisEvent_SetPropagation()
...
| [ArkUI_TouchTestInfoItemArray](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-touchtestinfoitemhandlearray)* array | 输出参数，指向用于接收触摸测试信息项数组的指针，数组元素为触摸测试信息项，数组大小通过size参数返回。 |
...
| 类型 | 说明 |
| --- | --- |
| ArkUI_ErrorCode | 返回结果代码。 如果操作成功，则返回[ARKUI_ERROR_CODE_NO_ERROR](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-error-code-h#arkui_errorcode)。 如果入参错误，则返回[ARKUI_ERROR_CODE_PARAM_INVALID](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-error-code-h#arkui_errorcode)。 |
...
#### [h2]OH_ArkUI_TouchTestInfoItem_GetY()
...
#### [h2]OH_ArkUI_TouchTestInfoItem_GetWindowX()
...
#### [h2]OH_ArkUI_TouchTestInfoItem_GetWindowY()
...
#### [h2]OH_ArkUI_TouchTestInfoItem_GetXRelativeToParent()
...
#### [h2]OH_ArkUI_TouchTestInfoItem_GetYRelativeToParent()
...
#### [h2]OH_ArkUI_TouchTestInfoItem_GetChildRect()
...
| 类型 | 说明 |
| --- | --- |
| ArkUI_ErrorCode | 返回结果代码。 如果操作成功，则返回[ARKUI_ERROR_CODE_NO_ERROR](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-error-code-h#arkui_errorcode)。 如果入参错误，则返回[ARKUI_ERROR_CODE_PARAM_INVALID](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-error-code-h#arkui_errorcode)。 如果缓冲区空间不足，则返回[ARKUI_ERROR_CODE_BUFFER_SIZE_NOT_ENOUGH](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-error-code-h#arkui_errorcode)。 |
...
#### [h2]OH_ArkUI_DigitalCrownEvent_GetEventTime()
...
| 类型 | 说明 |
| --- | --- |
| int64_t | 返回UI输入事件发生的时间，如果参数有误，则返回**0**。 |

#### [h2]OH_ArkUI_DigitalCrownEvent_GetAngularVelocity()
...
| 类型 | 说明 |
| --- | --- |
| double | 返回UI输入事件发生的角速度，如果参数有误，则返回**0.0**。 |

#### [h2]OH_ArkUI_DigitalCrownEvent_GetDegree()
...
| 类型 | 说明 |
| --- | --- |
| double | 返回UI输入事件发生的旋转角度，如果参数有误，则返回**0.0**。 |

#### [h2]OH_ArkUI_DigitalCrownEvent_GetAction()
...
#### [h2]OH_ArkUI_DigitalCrownEvent_SetStopPropagation()
...
| 类型 | 说明 |
| --- | --- |
| [ArkUI_ErrorCode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-error-code-h#arkui_errorcode) | 错误码。 [ARKUI_ERROR_CODE_NO_ERROR](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-error-code-h#arkui_errorcode) 成功。 [ARKUI_ERROR_CODE_PARAM_INVALID](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-error-code-h#arkui_errorcode) 参数异常，可能是事件指针、pressedKeyCodes或length无效；请检查参数并重试。 |
