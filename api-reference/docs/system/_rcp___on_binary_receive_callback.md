...
| 名称 | 描述 |
| --- | --- |
| [Rcp_OnBinaryReceiveCallbackFunc](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/remote-communication-overview#rcp_onbinaryreceivecallbackfunc) [callback](#callback) | 请求过程中接收二进制数据的回调函数。 |
