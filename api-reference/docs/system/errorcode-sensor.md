...
当调用[getSingleSensor](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-sensor#sensorgetsinglesensor9)接口时，若设备不支持该传感器，会报此错误码，导致无法获取该传感器信息。此错误码表示请求的传感器类型在当前设备上不存在或未被支持。
