...
当调用[getSingleSensor](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-sensor#sensorgetsinglesensor9)接口时，若设备不支持该传感器，会报此错误码。
...
使用[getSingleSensor](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-sensor#sensorgetsinglesensor9)接口，返回14500102则表示设备不支持该传感器。
