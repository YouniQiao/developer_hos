...
| state | [ConnectionState](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-nearlink-constant#connectionstate) | 否 | 否 | 表示和远端设备的连接状态。 |
