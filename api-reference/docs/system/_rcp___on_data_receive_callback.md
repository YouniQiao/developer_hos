...
| 名称 | 描述 |
| --- | --- |
| [Rcp_OnDataReceiveCallbackFunc](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/remote-communication-overview#rcp_ondatareceivecallbackfunc) [callback](#callback) | 接收数据回调函数。 |
