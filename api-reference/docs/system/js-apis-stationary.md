...
content_hash: "55bef6ac7649"
synced_at: "2026-08-29T18:17:12.403819"
---
...
| callback | Callback | 是 | 回调函数，用于接收设备状态变化结果。 |
...
| --- | --- | --- | --- |
| activity | [ActivityType](#activitytype) | 是 | 设备状态类型。 |
| callback | Callback | 是 | 回调函数，用于接收设备状态查询结果。 |
...
| activity | [ActivityType](#activitytype) | 是 | 设备状态类型。 |
| event | [ActivityEvent](#activityevent) | 是 | 事件类型。 |
| callback | Callback | 否 | 要移除的回调函数。未传递callback参数或传递undefined时，移除该进程下订阅该类型的所有callback。 |
