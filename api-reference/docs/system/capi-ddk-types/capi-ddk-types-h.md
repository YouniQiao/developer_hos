...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [DDK_Ashmem](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-baseddk-ddk-ashmem) | DDK_Ashmem | 定义通过接口[OH_DDK_CreateAshmem](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-ddk-api-h#oh_ddk_createashmem)创建的共享内存，共享内存的缓冲区提供更好的性能。 |
