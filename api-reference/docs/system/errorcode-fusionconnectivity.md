...
content_hash: "3cf5028d00b8"
synced_at: "2026-07-28T16:50:40.135697"
---
...
该设备未发起测距，例如：在未调用[startRanging](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-fusionconnectivity-ranging#rangingstartranging)的情况下直接调用[stopRanging](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-fusionconnectivity-ranging#rangingstopranging)。

处理步骤

建议先调用[startRanging](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-fusionconnectivity-ranging#rangingstartranging)发起测距后再进行后续操作。
...
该设备已发起测距，例如：对同一设备重复调用[startRanging](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-fusionconnectivity-ranging#rangingstartranging)而未先调用[stopRanging](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-fusionconnectivity-ranging#rangingstopranging)停止之前的测距。

处理步骤

建议不要在已经发起测距后重复发起，可以先调用[stopRanging](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-fusionconnectivity-ranging#rangingstopranging)结束测距后再重新调用[startRanging](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-fusionconnectivity-ranging#rangingstartranging)发起测距。
...
该类型服务并不支持测距，请参考[RangingTypes](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-fusionconnectivity-ranging#rangingtypes)使用有效的测距类型。
