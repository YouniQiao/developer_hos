...
#### [h2]Input_InjectAuthorizeCallback()
...
| 类型 | 说明 |
| --- | --- |
| struct [Input_KeyState](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-input-input-keystate)* | 操作成功返回一个[Input_KeyState](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-input-input-keystate)指针对象；否则返回空指针。 |

#### [h2]OH_Input_DestroyKeyState()
...
| 类型 | 说明 |
| --- | --- |
| struct [Input_KeyEvent](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-input-input-keyevent)* | 如果操作成功返回一个[Input_KeyEvent](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-input-input-keyevent)指针对象，否则返回空指针。 |

#### [h2]OH_Input_DestroyKeyEvent()
...
#### [h2]OH_Input_SetKeyEventKeyCode()
...
#### [h2]OH_Input_GetKeyEventKeyCode()
...
#### [h2]OH_Input_SetKeyEventActionTime()
...
#### [h2]OH_Input_GetKeyEventActionTime()
...
#### [h2]OH_Input_SetKeyEventWindowId()
...
#### [h2]OH_Input_GetKeyEventWindowId()
...
#### [h2]OH_Input_GetKeyEventDisplayId()
...
#### [h2]OH_Input_SetKeyEventDisplayId()
...
| 类型 | 说明 |
| --- | --- |
| struct [Input_MouseEvent](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-input-input-mouseevent)* | 如果操作成功返回一个[Input_MouseEvent](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-input-input-mouseevent)指针对象，否则返回空指针。 |

#### [h2]OH_Input_DestroyMouseEvent()
...
#### [h2]OH_Input_SetMouseEventAction()
...
#### [h2]OH_Input_GetMouseEventAction()
...
#### [h2]OH_Input_SetMouseEventDisplayX()
...
#### [h2]OH_Input_GetMouseEventDisplayX()
...
#### [h2]OH_Input_SetMouseEventDisplayY()
...
#### [h2]OH_Input_GetMouseEventDisplayY()
...
#### [h2]OH_Input_SetMouseEventButton()
...
#### [h2]OH_Input_GetMouseEventButton()
...
#### [h2]OH_Input_SetMouseEventAxisType()
...
#### [h2]OH_Input_GetMouseEventAxisType()
...
#### [h2]OH_Input_SetMouseEventAxisValue()
...
#### [h2]OH_Input_SetMouseEventActionTime()
...
#### [h2]OH_Input_GetMouseEventActionTime()
...
#### [h2]OH_Input_SetMouseEventWindowId()
...
#### [h2]OH_Input_GetMouseEventWindowId()
...
#### [h2]OH_Input_SetMouseEventDisplayId()
...
| 类型 | 说明 |
| --- | --- |
| struct [Input_TouchEvent](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-input-input-touchevent)* | 如果操作成功返回一个[Input_TouchEvent](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-input-input-touchevent)指针对象，否则返回空指针。 |

#### [h2]OH_Input_DestroyTouchEvent()
...
#### [h2]OH_Input_SetTouchEventAction()
...
#### [h2]OH_Input_GetTouchEventAction()
...
#### [h2]OH_Input_SetTouchEventFingerId()
...
#### [h2]OH_Input_GetTouchEventFingerId()
...
#### [h2]OH_Input_SetTouchEventDisplayX()
...
#### [h2]OH_Input_GetTouchEventDisplayX()
...
#### [h2]OH_Input_SetTouchEventDisplayY()
...
#### [h2]OH_Input_GetTouchEventDisplayY()
...
#### [h2]OH_Input_SetTouchEventActionTime()
...
#### [h2]OH_Input_GetTouchEventActionTime()
...
#### [h2]OH_Input_GetTouchEventWindowId()
...
#### [h2]OH_Input_SetTouchEventDisplayId()
...
#### [h2]OH_Input_GetTouchEventDisplayId()
...
#### [h2]OH_Input_SetAxisEventAction()
...
#### [h2]OH_Input_GetAxisEventAction()
...
#### [h2]OH_Input_SetAxisEventDisplayX()
...
#### [h2]OH_Input_GetAxisEventDisplayX()
...
#### [h2]OH_Input_SetAxisEventDisplayY()
...
#### [h2]OH_Input_GetAxisEventDisplayY()
...
#### [h2]OH_Input_SetAxisEventAxisValue()
...
#### [h2]OH_Input_GetAxisEventAxisValue()
...
#### [h2]OH_Input_SetAxisEventActionTime()
...
#### [h2]OH_Input_GetAxisEventActionTime()
...
#### [h2]OH_Input_SetAxisEventSourceType()
...
#### [h2]OH_Input_GetAxisEventSourceType()
...
#### [h2]OH_Input_SetAxisEventWindowId()
...
#### [h2]OH_Input_GetAxisEventWindowId()
...
#### [h2]OH_Input_SetAxisEventDisplayId()
...
#### [h2]OH_Input_GetAxisEventDisplayId()
...
#### [h2]OH_Input_AddKeyEventMonitor()
...
创建[Input_Hotkey](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-input-input-hotkey)类型实例的数组。通过调用[OH_Input_GetAllSystemHotkeys](#oh_input_getallsystemhotkeys)获取有效的count参数。通过调用[OH_Input_DestroyAllSystemHotkeys](#oh_input_destroyallsystemhotkeys)销毁[Input_Hotkey](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-input-input-hotkey)实例数组并回收内存。
...
#### [h2]OH_Input_GetAllSystemHotkeys()
...
![](./img/note_3.0-zh-cn.png) 订阅快捷键事件时，对于preKeys和finalKey有以下约束：

1. preKeys：修饰键（包括 Ctrl、Shift 和 Alt）集合，数量范围[1, 4]，无顺序要求。例如，Ctrl+Shift+Esc中，Ctrl+Shift称为修饰键。
2. finalKey：被修饰键，除修饰键和Meta键以外的按键，详细按键介绍请参见[Input_KeyCode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-oh-key-code-h#input_keycode)。例如，Ctrl+Shift+Esc中，Esc称为被修饰键。
...
| 类型 | 说明 |
| --- | --- |
| [Input_Result](#input_result) | OH_Input_RemoveHotkeyMonitor 函数返回值。 [INPUT_SUCCESS](#input_result) 表示取消订阅组合按键成功。 [INPUT_PARAMETER_ERROR](#input_result) 参数检查失败。 |
...
| 类型 | 说明 |
| --- | --- |
| [Input_Result](#input_result) | OH_Input_UnregisterDeviceListeners 函数返回值。 [INPUT_SUCCESS](#input_result) 表示调用成功。 [INPUT_SERVICE_EXCEPTION](#input_result) 表示由于服务异常调用失败。 |
...
| 类型 | 说明 |
| --- | --- |
| [Input_Result](#input_result) | [INPUT_SUCCESS](#input_result) 表示操作成功。 [INPUT_PARAMETER_ERROR](#input_result) 表示deviceInfo为空指针或deviceId无效。 |
...
| 类型 | 说明 |
| --- | --- |
| int32_t | OH_Input_InjectTouchEvent 函数返回值。 [INPUT_SUCCESS](#input_result) 表示注入成功。 [INPUT_PARAMETER_ERROR](#input_result) 表示参数错误。 |
...
| 类型 | 说明 |
| --- | --- |
| int32_t | OH_Input_InjectMouseEvent 函数返回值。 [INPUT_SUCCESS](#input_result) 表示注入成功。 [INPUT_PARAMETER_ERROR](#input_result) 表示参数错误。 [INPUT_PERMISSION_DENIED](#input_result) 表示缺少权限。 |
...
#### [h2]OH_Input_QueryMaxTouchPoints()
...
#### [h2]OH_Input_GetMouseEventGlobalX()
...
#### [h2]OH_Input_SetMouseEventGlobalY()
...
#### [h2]OH_Input_GetMouseEventGlobalY()
...
#### [h2]OH_Input_InjectTouchEventGlobal()
...
#### [h2]OH_Input_GetTouchEventGlobalX()
...
#### [h2]OH_Input_SetTouchEventGlobalY()
...
#### [h2]OH_Input_GetTouchEventGlobalY()
...
#### [h2]OH_Input_SetAxisEventGlobalX()
...
| 参数项 | 描述 |
| --- | --- |
| struct [Input_AxisEvent](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-input-input-axisevent)* axisEvent | 轴事件对象，通过[OH_Input_CreateAxisEvent](#oh_input_createaxisevent)接口可以创建轴事件对象。 使用完需使用[OH_Input_DestroyAxisEvent](#oh_input_destroyaxisevent)接口销毁轴事件对象。 |
...
#### [h2]OH_Input_CustomCursor_Destroy()
...
#### [h2]OH_Input_CustomCursor_GetPixelMap()
...
#### [h2]OH_Input_CursorConfig_Destroy()
...
#### [h2]OH_Input_CursorConfig_IsFollowSystem()
...
#### [h2]OH_Input_CursorInfo_Destroy()
...
#### [h2]OH_Input_CursorInfo_IsVisible()
...
| --- | --- |
| [Input_CursorInfo](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-input-input-cursorinfo)* cursorInfo | 指定鼠标光标信息对象。可以通过[OH_Input_GetMouseEventCursorInfo](#oh_input_getmouseeventcursorinfo)查询指定鼠标事件的鼠标光标信息、或通过[OH_Input_GetCursorInfo](#oh_input_getcursorinfo)接口查询当前的鼠标光标信息。 |
| int32_t* sizeLevel | 鼠标光标信息的光标大小档位。取值范围为整数[1, 7]，数值越大则光标越大。应用自定义光标[DEVELOPER_DEFINED_ICON](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-oh-pointer-style-h#input_pointerstyle)请以实际位图大小为准。 |
...
#### [h2]OH_Input_SetTouchEventPressure()
...
#### [h2]OH_Input_GetTouchEventPressure()
...
#### [h2]OH_Input_SetTouchEventWindowX()
...
#### [h2]OH_Input_GetTouchEventWindowX()
...
#### [h2]OH_Input_SetTouchEventWindowY()
...
#### [h2]OH_Input_GetTouchEventWindowY()
...
#### [h2]OH_Input_SetTouchEventDownTime()
...
#### [h2]OH_Input_GetTouchEventDownTime()
...
#### [h2]OH_Input_SetTouchEventToolType()
...
#### [h2]OH_Input_GetTouchEventToolType()
...
#### [h2]OH_Input_BindInputDeviceToDisplay()
