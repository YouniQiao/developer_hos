...
upstream_id: "harmonyos-references/capi-usbddk-usbendpointdescriptor"
catalog: "harmonyos-references"
content_hash: "cf9d4d9815e5"
synced_at: "2026-08-29T18:17:11.678373"
---
...
| uint8_t bmAttributes | 端点属性，包括传输类型、同步类型和使用类型。 |
| uint16_t wMaxPacketSize | 该端点所能承载的最大包的大小，单位：Byte。 |
| uint8_t bInterval | 数据传输时轮询端点的时间间隔。 |
