...
1. [runApp](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/confidentialspace-confidentialspace#confidentialspacerunapp)方法抛出此错误，可能是： 数据应用文件未包含在HAP包中。
