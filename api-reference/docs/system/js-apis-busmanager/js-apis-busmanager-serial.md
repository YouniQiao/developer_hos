...
content_hash: "47901db830cb"
synced_at: "2026-07-28T16:50:56.188512"
---
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback | 否 | 回调函数。不传入callback时，清除所有串口数据接收监听。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback | 否 | 回调函数。不传入callback时，清除所有串口断开事件监听。 |
