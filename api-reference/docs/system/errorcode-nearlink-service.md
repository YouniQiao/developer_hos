...
调用[dataTransfer.destroyPort](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-nearlink-data-transfer-api#datatransferdestroyport)接口销毁对应UUID的端口通道，或请通过[在线提单](https://developer.huawei.com/consumer/cn/support/feedback/#/)提交问题。
...
调用[dataTransfer.destroyPort](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-nearlink-data-transfer-api#datatransferdestroyport)接口销毁其他已注册的端口通道，或请通过[在线提单](https://developer.huawei.com/consumer/cn/support/feedback/#/)提交问题。
...
在设备已配对的情况下再调用[startPairing](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-nearlink-remote-device#startpairing)发起配对，会返回该错误码。
