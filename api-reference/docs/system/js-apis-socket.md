...
content_hash: "7279fe6b677a"
synced_at: "2026-09-17T18:53:09.108266"
---
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback | 是 | 回调函数。关闭UDPSocket连接后触发回调函数。 |
...
![](./img/note_3.0-zh-cn.png) bind方法调用成功后，才可调用此方法。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback | 是 | 回调函数。成功返回UDPSocket状态信息，失败返回错误码、错误信息。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回获取UDPSocket状态的结果。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回Socket的文件描述符。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回获取本地socket地址的结果。 |
...
| callback | Callback | 是 | 回调函数。返回订阅某类事件后UDPSocket连接成功的状态信息。 |
...
| callback | Callback | 否 | 回调函数。可以指定传入on中的callback取消对应的订阅，也可以不指定callback清空所有订阅。 |
...
| callback | Callback | 是 | 回调函数。UDPSocket连接的某类数据包消息事件或关闭事件发生变化后触发回调函数。 |
...
| family | number | 否 | 否 | 网络协议类型，可选类型： - 1：IPv4。默认为1。 - 2：IPv6。地址为IPv6类型，该字段必须被显式指定为2。 - 3：Domain（从API version 18开始支持）。地址为Domain类型，该字段必须被显式指定为3。当前仅支持[TCPSocket.connect](#connect)和[TLSSocket.connect](#connect9)。 |
...
![](./img/note_3.0-zh-cn.png) 用于控制多播Socket绑定端口时是否开启地址复用能力。
...
![](./img/note_3.0-zh-cn.png) 多播使用的IP地址属于特定的范围（例如224.0.0.0到239.255.255.255）。
...
| callback | AsyncCallback | 是 | 回调函数。失败返回错误码、错误信息。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | 以Promise形式返回MulticastSocket加入多播组的行为结果。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | 以Promise形式返回MulticastSocket加入多播组的执行结果。 |
...
![](./img/note_3.0-zh-cn.png) 用于限制数据包在网络中传输时能够经过的最大路由器跳数的字段，TTL (Time to live)。
...
| 类型 | 说明 |
| --- | --- |
| Promise | 以Promise形式返回MulticastSocket设置TTL数值的结果。 |
...
![](./img/note_3.0-zh-cn.png) 用于设置环回模式，开启或关闭两种状态，默认为开启状态。
...
| 类型 | 说明 |
| --- | --- |
| Promise | 以Promise形式返回MulticastSocket设置环回模式的结果。 |
...
![](./img/note_3.0-zh-cn.png) 用于获取当前环回模式开启或关闭的状态。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback | 是 | 回调函数。返回值为环回模式状态，true表示环回模式开启，false表示环回模式关闭。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象。返回true表示环回模式开启，返回false表示环回模式关闭。 |
...
![](./img/note_3.0-zh-cn.png) bind方法如果因为端口冲突而执行失败，则会由系统随机分配端口号。
...
| --- | --- | --- | --- |
| address | [NetAddress](#netaddress) | 是 | 本端地址信息，参考[NetAddress](#netaddress)。 |
| callback | AsyncCallback | 是 | 回调函数。失败返回错误、错误信息。 |
...
![](./img/note_3.0-zh-cn.png) 在没有执行tcp.bind的情况下，也可以直接调用该接口完成与TCP服务端的连接
...
![](./img/note_3.0-zh-cn.png) connect方法调用成功后，才可调用此方法。该接口为耗时操作，请在Worker线程或taskpool线程调用该接口。
...
![](./img/note_3.0-zh-cn.png) connect方法调用成功后，才可调用此方法。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback | 是 | 回调函数。成功时返回对端Socket地址，失败时返回错误码、错误信息。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回获取对端socket地址的结果。 |
...
![](./img/note_3.0-zh-cn.png) bind或connect方法调用成功后，才可调用此方法。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback | 是 | 回调函数。成功时获取TCPSocket状态，失败时返回错误码、错误信息。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回获取TCPSocket状态的结果。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback | 是 | 回调函数，当成功时，返回socket的文件描述符，失败时，返回undefined。 |
...
| callback | AsyncCallback | 是 | 回调函数。失败时返回错误码、错误信息。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | 以Promise形式返回获取本地socket地址的结果。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 订阅的事件类型。'message'：接收消息事件。 |
| callback | Callback | 是 | 回调函数。返回TCPSocket连接信息。 |
...
| callback | Callback | 是 | 回调函数。TCPSocket的连接事件或关闭事件触发时调用回调函数。 |
...
![](./img/note_3.0-zh-cn.png) 服务端使用该方法完成bind，listen，accept操作，bind方法失败会由系统随机分配端口号。
...
![](./img/note_3.0-zh-cn.png) listen方法调用成功后，才可调用此方法。
...
| callback | Callback | 是 | 回调函数。失败时返回错误码、错误信息。 |
...
![](./img/note_3.0-zh-cn.png) 该方法不会关闭已有连接。如需关闭，请调用[TCPSocketConnection](#tcpsocketconnection10)的[close](#close10)方法。
...
![](./img/note_3.0-zh-cn.png) 客户端与服务端成功建立连接后，才能通过返回的TCPSocketConnection对象调用相应的接口。
...
![](./img/note_3.0-zh-cn.png) 与客户端建立连接后，才可调用此方法。
...
![](./img/note_3.0-zh-cn.png) bind方法可以使客户端确保有个明确的本地套接字路径，显式的绑定一个本地套接字文件。
...
![](./img/note_3.0-zh-cn.png) 在本文档的示例中，通过this.context来获取UIAbilityContext，其中this代表继承自UIAbility的UIAbility实例。如需在页面中使用UIAbilityContext提供的能力，请参见[获取UIAbility的上下文信息](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/uiability-usage#获取uiability的上下文信息)。
...
![](./img/note_3.0-zh-cn.png) 在没有执行localsocket.bind的情况下，也可以直接调用该接口完成与LocalSocket服务端的连接。
...
| 类型 | 说明 |
| --- | --- |
| Promise | 以Promise形式返回LocalSocket连接服务端的结果。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回获取LocalSocket状态的结果。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | 以Promise形式返回设置LocalSocket套接字属性的结果。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回设置LocalSocket套接字的属性。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 订阅的事件类型。'message'：接收消息事件。 |
| callback | Callback | 是 | 以callback的形式异步返回接收的消息。 |
...
| callback | Callback | 是 | 以callback的形式异步返回与服务端连接的结果。 |
...
| callback | Callback | 是 | 以callback的形式异步返回关闭localsocket的结果。 |
...
![](./img/note_3.0-zh-cn.png) 服务端使用该方法完成bind，listen，accept操作，传入套接字文件路径，调用此接口后会自动生成本地套接字文件。
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回获取LocalSocketServer状态的结果。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 订阅的事件类型。'connect'：连接事件。 |
| callback | Callback | 是 | 以callback的形式异步返回接收到客户端连接的结果。 |
...
![](./img/note_3.0-zh-cn.png) 该方法不会关闭已有连接。如需关闭，请调用[LocalSocketConnection](#localsocketconnection11)的[close](#close11-1)方法。
...
![](./img/note_3.0-zh-cn.png) 客户端与服务端成功建立连接后，才能通过返回的LocalSocketConnection对象调用相应的接口。
...
![](./img/note_3.0-zh-cn.png) 服务端与客户端建立连接后，服务端通过connect事件回调得到LocalSocketConnection连接对象后，才可使用连接对象调用此方法。
...
| --- | --- | --- | --- |
| type | string | 是 | 订阅的事件类型。'message'：接收消息事件。 |
| callback | Callback | 是 | 以callback的形式异步返回接收到的来自客户端的消息。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 订阅的事件类型。'close'：关闭事件。 |
| callback | Callback | 是 | 以callback的形式异步返回会话关闭的结果。 |
...
![](./img/note_3.0-zh-cn.png) 需要确保TCPSocket已连接，并且当前已经没有传输数据，再调用constructTLSSocketInstance升级TLSSocket。当升级成功后，无需对TCPSocket对象调用close方法。
...
![](./img/note_3.0-zh-cn.png) 如果TLSSocket对象是通过TCPSocket对象升级创建的，可以不用执行bind方法。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback | 是 | 回调函数。成功返回TLSSocket状态，失败返回错误码、错误信息。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回获取TLSSocket状态的结果。失败返回错误码，错误信息。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 订阅的事件类型。'message'：接收消息事件。 |
| callback | Callback | 是 | 回调函数。TLSSocket连接订阅某类接收消息事件触发的调用函数，返回TLSSocket连接信息。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 订阅的事件类型。'message'：接收消息事件。 |
| callback | Callback | 否 | 回调函数。TLSSocket连接取消订阅某类接收消息事件触发的调用函数，返回TLSSocket连接信息。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 订阅的事件类型。 - 'connect'：连接事件。 - 'close'：关闭事件。 |
| callback | Callback | 是 | 回调函数。TLSSocket连接订阅某类事件触发的调用函数。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 订阅的事件类型。 - 'connect'：连接事件。 - 'close'：关闭事件。 |
| callback | Callback | 否 | 回调函数。TLSSocket连接订阅某类事件触发的调用函数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback | 是 | 回调函数。成功返回对端的socket地址，失败返回错误码、错误信息。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回获取本地socket地址的结果。失败返回错误码，错误信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback | 是 | 回调函数，成功返回本地的证书，失败返回错误码、错误信息。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回本地的数字证书的结果。失败返回错误码，错误信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback | 是 | 回调函数，返回服务端的证书。失败返回错误码、错误信息。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回服务端的数字证书的结果。失败返回错误码，错误信息。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回通信的协议。失败返回错误码，错误信息。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise> | Promise对象，返回通信双方支持的加密套件。失败返回错误码，错误信息。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise> | Promise对象，返回获取到的双方支持的签名算法。 |
...
![](./img/note_3.0-zh-cn.png) 在TLSSocketServer通信连接成功之后，才可调用此方法。
...
| ALPNProtocols | Array | 否 | 是 | ALPN协议，支持["spdy/1", "http/1.1"]，默认为[]。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| ca | string | Array | 否 | 是 | 服务端的ca证书，用于认证校验服务端的数字证书。从API version 12开始，默认为系统预置CA证书。最多支持设置1000本证书。 |
| cert | string | Array | 否 | 是 | 本地客户端的数字证书。从API version 24开始支持传入数组，最多支持设置1000本证书。 |
| key | string | 否 | 是 | 本地数字证书的私钥。 |
| password | string | 否 | 是 | 读取私钥的密码。 |
| protocols | [Protocol](#protocol9) | Array | 否 | 是 | TLS的协议版本，默认为"TLSv1.2"。 |
...
![](./img/caution_3.0-zh-cn.png) IP地址设置为0.0.0.0时，可以监听本机所有地址。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback | 是 | 回调函数。成功返回TLSSocketServer状态，失败返回错误码、错误信息。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回获取TLSSocketServer状态的结果。失败返回错误码，错误信息。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 订阅的事件类型。'connect'：连接事件。 |
| callback | Callback | 否 | 回调函数。失败时返回错误码、错误信息。 |
...
![](./img/note_3.0-zh-cn.png) 该方法不会关闭已有连接。如需关闭，请调用[TLSSocketConnection](#tlssocketconnection10)的[close](#close10-2)方法。
...
![](./img/note_3.0-zh-cn.png) 客户端与服务端成功建立连接后，才能通过返回的TLSSocketConnection对象调用相应的接口。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback | 是 | 回调函数，返回对端的证书。失败返回错误码、错误信息。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回对端的数字证书的结果。失败返回错误码，错误信息。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 订阅的事件类型。'message'：接收消息事件。 |
| callback | Callback | 是 | 回调函数。成功时返回TLSSocketConnection连接信息，失败时返回错误码、错误信息。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 订阅的事件类型。'message'：接收消息事件。 |
| callback | Callback | 否 | 回调函数。成功时返回TLSSocketConnection连接信息，失败时返回错误码、错误信息。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 订阅的事件类型。'close'：关闭事件。 |
| callback | Callback | 是 | 回调函数。成功时返回空，失败时返回错误码、错误信息。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 订阅的事件类型。'close'：关闭事件。 |
| callback | Callback | 否 | 回调函数。成功时返回空，失败时返回错误码、错误信息。 |
