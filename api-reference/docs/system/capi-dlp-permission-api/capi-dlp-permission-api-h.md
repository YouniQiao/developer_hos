...
synced_at: "2026-06-24T20:50:33.979419"
---
...
| 类型 | 说明 |
| --- | --- |
| [DLP_ErrCode](#dlp_errcode) | 0 - 操作成功。 19100001 - 入参错误。 19100006 - 非DLP沙箱应用。 19100011 - 系统服务工作异常。 19100012 - 内存申请失败。 |
...
| 类型 | 说明 |
| --- | --- |
| [DLP_ErrCode](#dlp_errcode) | 0 - 操作成功。 19100001 - 入参错误。 19100012 - 内存申请失败。 |
...
| 类型 | 说明 |
| --- | --- |
| [DLP_ErrCode](#dlp_errcode) | 0 - 操作成功。 19100011 - 系统服务工作异常。 19100012 - 内存申请失败。 |
...
| 类型 | 说明 |
| --- | --- |
| [DLP_ErrCode](#dlp_errcode) | 0 - 操作成功。 19100001 - 入参错误。 19100007 - DLP沙箱应用不允许调用此接口。 19100011 - 系统服务工作异常。 19100018 - 应用未授权。 |
...
| 类型 | 说明 |
| --- | --- |
| [DLP_ErrCode](#dlp_errcode) | 0 - 操作成功。 19100011 - 系统服务工作异常。 19100012 - 内存申请失败。 19100018 - 应用未授权。 |
...
| 类型 | 说明 |
| --- | --- |
| [DLP_ErrCode](#dlp_errcode) | 0 - 操作成功。 19100007 - DLP沙箱应用不允许调用此接口。 19100011 - 系统服务工作异常。 19100018 - 应用未授权。 |
