...
content_hash: "4278b8869533"
synced_at: "2026-07-28T16:51:02.619029"
---
...
![](./img/note_3.0-zh-cn.png) 当前图标尺寸不做严格限制。
...
- 调用updateStatusBarMenuItem时，待更新的item的子菜单的menuCode不唯一。子菜单的各menuCode在当前菜单项中不唯一。
