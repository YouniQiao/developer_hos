...
content_hash: "77d1974b37d4"
synced_at: "2026-08-29T18:16:59.375988"
---
...
| 参数项 | 描述 |
| --- | --- |
| [Scan_ScannerDevice](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-oh-scan-scan-scannerdevice)** devices | 所有发现的扫描仪设备列表，devices 指针指向的内存将在回调函数结束时释放 |
...
| 类型 | 说明 |
| --- | --- |
| int32_t | [SCAN_ERROR_NONE](#scan_errorcode) 表示扫描服务成功启动 [SCAN_ERROR_NO_PERMISSION](#scan_errorcode) 表示无权限使用此接口 [SCAN_ERROR_RPC_FAILURE](#scan_errorcode) 表示 RPC 通信错误 [SCAN_ERROR_SERVER_FAILURE](#scan_errorcode) 表示扫描过程中发生错误 |
...
| 类型 | 说明 |
| --- | --- |
| int32_t | [SCAN_ERROR_NONE](#scan_errorcode) 表示成功开始扫描仪搜索 [SCAN_ERROR_NO_PERMISSION](#scan_errorcode) 表示无权限使用此接口 [SCAN_ERROR_RPC_FAILURE](#scan_errorcode) 表示 RPC 通信错误 [SCAN_ERROR_SERVER_FAILURE](#scan_errorcode) 表示扫描过程中发生错误 |
...
| 类型 | 说明 |
| --- | --- |
| int32_t | [SCAN_ERROR_NONE](#scan_errorcode) 表示扫描仪成功连接 [SCAN_ERROR_NO_PERMISSION](#scan_errorcode) 表示无权限使用此接口 [SCAN_ERROR_RPC_FAILURE](#scan_errorcode) 表示 RPC 通信错误 [SCAN_ERROR_SERVER_FAILURE](#scan_errorcode) 表示扫描过程中发生错误 [SCAN_ERROR_DEVICE_BUSY](#scan_errorcode) 表示扫描仪繁忙 [SCAN_ERROR_INVALID_PARAMETER](#scan_errorcode) 表示输入参数无效 [SCAN_ERROR_IO_ERROR](#scan_errorcode) 表示与扫描仪通信时发生错误 [SCAN_ERROR_NO_MEMORY](#scan_errorcode) 表示可用内存不足 |
...
| 类型 | 说明 |
| --- | --- |
| int32_t | [SCAN_ERROR_NONE](#scan_errorcode) 表示扫描仪连接成功关闭 [SCAN_ERROR_NO_PERMISSION](#scan_errorcode) 表示无权限使用此接口 [SCAN_ERROR_RPC_FAILURE](#scan_errorcode) 表示 RPC 通信错误 [SCAN_ERROR_SERVER_FAILURE](#scan_errorcode) 表示扫描过程中发生错误 [SCAN_ERROR_INVALID_PARAMETER](#scan_errorcode) 表示输入参数无效 |
...
| 类型 | 说明 |
| --- | --- |
| [Scan_ScannerOptions*](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-oh-scan-scan-scanneroptions) | 成功时返回扫描仪参数选项结构体指针，可用于获取和设置扫描仪参数选项；失败时返回 NULL。 |
...
| const char* value | 要设置的选项值，有效值从[Scan_ScannerOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-oh-scan-scan-scanneroptions)的 ranges 中获取。 |

返回：

| 类型 | 说明 |
| --- | --- |
| int32_t | [SCAN_ERROR_NONE](#scan_errorcode) 表示扫描仪参数设置成功 [SCAN_ERROR_NO_PERMISSION](#scan_errorcode) 表示无权限使用此接口 [SCAN_ERROR_RPC_FAILURE](#scan_errorcode) 表示 RPC 通信错误 [SCAN_ERROR_SERVER_FAILURE](#scan_errorcode) 表示扫描过程中发生错误 [SCAN_ERROR_INVALID_PARAMETER](#scan_errorcode) 表示输入参数无效 |
...
| 类型 | 说明 |
| --- | --- |
| int32_t | [SCAN_ERROR_NONE](#scan_errorcode) 表示扫描仪成功启动扫描任务 [SCAN_ERROR_NO_PERMISSION](#scan_errorcode) 表示无权限使用此接口 [SCAN_ERROR_RPC_FAILURE](#scan_errorcode) 表示 RPC 通信错误 [SCAN_ERROR_SERVER_FAILURE](#scan_errorcode) 表示扫描过程中发生错误 [SCAN_ERROR_JAMMED](#scan_errorcode) 表示文档进纸器卡纸 [SCAN_ERROR_NO_DOCS](#scan_errorcode) 表示文档进纸器缺纸 [SCAN_ERROR_COVER_OPEN](#scan_errorcode) 表示扫描仪盖板打开 [SCAN_ERROR_IO_ERROR](#scan_errorcode) 表示与扫描仪通信时发生错误 [SCAN_ERROR_NO_MEMORY](#scan_errorcode) 表示可用内存不足 [SCAN_ERROR_INVALID_PARAMETER](#scan_errorcode) 表示输入参数无效 [SCAN_ERROR_DEVICE_BUSY](#scan_errorcode) 表示扫描仪繁忙，应稍后重试操作 |
...
| 类型 | 说明 |
| --- | --- |
| int32_t | [SCAN_ERROR_NONE](#scan_errorcode) 表示扫描仪成功取消扫描任务 [SCAN_ERROR_NO_PERMISSION](#scan_errorcode) 表示无权限使用此接口 [SCAN_ERROR_INVALID_PARAMETER](#scan_errorcode) 表示输入参数无效 [SCAN_ERROR_RPC_FAILURE](#scan_errorcode) 表示 RPC 通信错误 [SCAN_ERROR_SERVER_FAILURE](#scan_errorcode) 表示扫描过程中发生错误 |
...
| [Scan_PictureScanProgress](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-oh-scan-scan-picturescanprogress)* prog | 扫描图片的[Scan_PictureScanProgress](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-oh-scan-scan-picturescanprogress)，必须传入非空值，扫描进度将写入 prog 指针指向的结构体。 |

返回：

| 类型 | 说明 |
| --- | --- |
| int32_t | [SCAN_ERROR_NONE](#scan_errorcode) 表示扫描仪成功查询到扫描图片的进度 [SCAN_ERROR_NO_PERMISSION](#scan_errorcode) 表示无权限使用此接口 [SCAN_ERROR_INVALID_PARAMETER](#scan_errorcode) 表示输入参数无效 [SCAN_ERROR_RPC_FAILURE](#scan_errorcode) 表示 RPC 通信错误 [SCAN_ERROR_SERVER_FAILURE](#scan_errorcode) 表示扫描过程中发生错误 [SCAN_ERROR_JAMMED](#scan_errorcode) 表示文档进纸器卡纸 [SCAN_ERROR_NO_DOCS](#scan_errorcode) 表示文档进纸器缺纸 [SCAN_ERROR_COVER_OPEN](#scan_errorcode) 表示扫描仪盖板打开 [SCAN_ERROR_IO_ERROR](#scan_errorcode) 表示与扫描仪通信时发生错误 [SCAN_ERROR_NO_MEMORY](#scan_errorcode) 表示可用内存不足 [SCAN_ERROR_DEVICE_BUSY](#scan_errorcode) 表示扫描仪繁忙，应稍后重试操作 |
...
| 类型 | 说明 |
| --- | --- |
| int32_t | [SCAN_ERROR_NONE](#scan_errorcode) 表示扫描服务成功退出 [SCAN_ERROR_NO_PERMISSION](#scan_errorcode) 表示无权限使用此接口 [SCAN_ERROR_RPC_FAILURE](#scan_errorcode) 表示 RPC 通信错误 [SCAN_ERROR_SERVER_FAILURE](#scan_errorcode) 表示扫描过程中发生错误 |
