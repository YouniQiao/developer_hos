...
| callback | Callback | 是 | 返回SE服务状态的回调 。 |
...
| **类型** | **说明** |
| --- | --- |
| Promise | 以Promise形式异步返回可用的SE服务实例。 |
...
| callback | Callback | 否 | 返回SE服务状态的回调。不填则取消订阅该type对应的所有回调。 |
...
| **类型** | **说明** |
| --- | --- |
| Promise | 以Promise形式异步返回可用的基础Channel对象实例。 |
...
| --- | --- | --- | --- |
| aid | number[] | 是 | 在此Channel上选择的Applet的AID或如果没有Applet被选择时空的数组。 |
| callback | AsyncCallback | 是 | 以callback形式异步返回可用的基础Channel对象实例。 |
...
| **类型** | **说明** |
| --- | --- |
| Promise | 以Promise形式异步返回可用的逻辑Channel对象实例。 |
...
| --- | --- | --- | --- |
| aid | number[] | 是 | 在此Channel上选择的Applet的AID或如果没有Applet被选择时空的数组。 |
| callback | AsyncCallback | 是 | 以callback形式异步返回可用的逻辑Channel对象实例。 |
...
| **类型** | **说明** |
| --- | --- |
| Promise | 以Promise形式异步返回可用的逻辑Channel实例对象。 |
...
| **类型** | **说明** |
| --- | --- |
| Promise | 以Promise形式异步返回接收到的响应APDU数据，number数组。若芯片捕获异常则返回全0。 |
...
| --- | --- | --- | --- |
| command | number[] | 是 | 需要发送到SE的APDU数据。 |
| callback | AsyncCallback | 是 | 返回接收到的响应APDU数据，number数组。若芯片捕获异常则返回全0。 |
