...
content_hash: "a2b9c91d0a02"
synced_at: "2026-08-29T18:16:54.532792"
---
...
| callback | Callback | 是 | 回调函数，返回网络状态对象。参考radio的[NetworkState](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-radio#networkstate)。 |
...
![](./img/note_3.0-zh-cn.png) 可以指定传入on中的callback取消一个订阅，也可以不指定callback清空所有订阅。
...
| --- | --- | --- | --- |
| type | string | 是 | 网络状态变化事件，参数固定为'networkStateChange'。 |
| callback | Callback | 否 | 回调函数，返回网络状态对象。参考radio的[NetworkState](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-radio#networkstate)。 |
...
| callback | Callback> | 是 | 回调函数，返回信号强度对象。参考radio的[SignalInformation](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-radio#signalinformation)。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 信号状态变化事件，参数固定为'signalInfoChange'。 |
| callback | Callback> | 否 | 回调函数，返回信号强度对象。参考radio的[SignalInformation](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-radio#signalinformation)。 |
...
| callback | Callback | 是 | 回调函数，返回通话状态信息对象。 应用可获取到CallStateInfo。 其中，三方应用仅能获取state通话状态。number受系统权限管控，仅面向系统应用开放。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 通话状态变化事件，参数固定为"callStateChange"。 |
| callback | Callback | 否 | 回调函数，返回通话状态信息对象。 其中，三方应用仅能获取state通话状态。number受系统权限管控，仅面向系统应用开放。 |
...
| callback | Callback | 是 | 回调函数，返回通话状态对象。 应用可获取到TelCallState。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 通话状态变化事件，参数固定为'callStateChangeEx'。 |
| callback | Callback | 否 | 回调函数，返回通话状态对象。参考call的[TelCallState](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-call#telcallstate21)。 |
...
| callback | Callback | 是 | 回调函数，返回蜂窝数据链路连接状态信息对象。参考data的[DataConnectState](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-telephony-data#dataconnectstate)，radio的[RadioTechnology](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-radio#radiotechnology)。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 蜂窝数据链路连接状态事件，参数固定为'cellularDataConnectionStateChange'。 |
| callback | Callback | 否 | 回调函数，返回蜂窝数据链路连接状态信息对象。参考data的[DataConnectState](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-telephony-data#dataconnectstate)，radio的[RadioTechnology](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-radio#radiotechnology)。 |
...
| callback | Callback | 是 | 回调函数，返回数据流状态对象。参考data的[DataFlowType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-telephony-data#dataflowtype)。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 蜂窝数据业务的上下行数据流状态事件，参数固定为'cellularDataFlowChange'。 |
| callback | Callback | 否 | 回调函数，返回数据流状态对象。参考data的[DataFlowType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-telephony-data#dataflowtype)。 |
...
![](./img/note_3.0-zh-cn.png) 此接口不包含SIM卡的激活状态，具体请参见[sim.isSimActive](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-sim#simissimactive7)接口。
...
| callback | Callback | 是 | 回调函数，返回卡状态数据对象。 |
...
| --- | --- | --- | --- |
| type | string | 是 | SIM卡状态更改事件，参数固定为"simStateChange"。 |
| callback | Callback | 否 | 回调函数，返回卡状态数据对象。 |
...
| callback | Callback | 是 | 回调函数。当卡账户变化时触发。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 卡账户变化事件，参数固定为"iccAccountInfoChange"。 |
| callback | Callback | 否 | 回调函数。当卡账户变化时触发。 |
...
| callback | Callback | 是 | 回调函数，返回SIM卡是否激活。 - true：激活。 - false：未激活。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback | 否 | 回调函数，返回SIM卡是否激活。 - true：激活。 - false：未激活。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback | 是 | 回调函数，返回通话状态信息对象。 应用可获取到CCallStateInfo。 |
| options | [ObserverOptions](#observeroptions11) | 否 | 电话相关事件订阅参数可选项，指定事件订阅的卡槽ID，默认为当前默认数据卡槽ID。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback | 否 | 回调函数，返回通话状态信息对象。 应用可获取到CCallStateInfo。 不传入此参数时，取消所有运营商通话状态的监听。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback | 是 | 回调函数。返回true表示5A状态为使能态；返回false表示5A状态为非使能态。 |
| options | [ObserverOptions](#observeroptions11) | 否 | 电话相关事件订阅参数可选项，指定事件订阅的卡槽ID，默认为当前默认数据卡槽ID。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| state | [CallState](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-call#callstate) | 否 | 否 | 通话状态。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| state | [CCallState](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-call#ccallstate23) | 否 | 否 | 通话状态。 |
