...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback | 是 | 回调函数，返回接收的数据。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback | 否 | 回调函数，返回接收的数据。如果传入了callback，则取消该callback的注册；如果参数为空，则取消所有callback的注册。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | ErrorCallback> | 是 | 回调函数，返回接收数据时发生的错误。 可能产生的错误码包括1028700009、1028700010、1028700011、1028700013、1028700014。详细介绍请参见[ArkTS API错误码](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/errorcode-confidentialspace)。 若错误码为1028700014，则回调函数接收到的BusinessError对象的data字段非空，为[DataAppErrorInfo](#dataapperrorinfo)类型，该对象的dataAppErrorCode字段是数据应用抛出的原始错误码。 若错误码不为1028700014，则回调函数接收到的BusinessError对象的data字段为undefined。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | ErrorCallback> | 否 | 回调函数，返回接收数据时发生的错误。如果传入了callback，则取消该callback的注册。如果传入参数为空，则取消所有callback的注册。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回新运行数据应用的句柄。 |
