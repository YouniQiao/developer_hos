...
content_hash: "6a6e328850e5"
synced_at: "2026-07-09T00:59:21.005555"
---
...
| 名称 | 描述 |
| --- | --- |
| [OH_Huks_Result](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-hukstypeapi-oh-huks-result) | 表示状态返回数据，包括返回码和消息。 |
| [OH_Huks_Blob](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-hukstypeapi-oh-huks-blob) | 定义存放数据的结构体类型。 |
| [OH_Huks_Param](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-hukstypeapi-oh-huks-param) | 定义参数集中的参数结构体类型。 |
| [OH_Huks_ParamSet](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-hukstypeapi-oh-huks-paramset) | 定义参数集的结构体类型。 |
| [OH_Huks_CertChain](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-hukstypeapi-oh-huks-certchain) | 定义证书链的结构体类型。 |
| [OH_Huks_KeyInfo](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-hukstypeapi-oh-huks-keyinfo) | 定义密钥信息的结构体类型。 |
| [OH_Huks_PubKeyInfo](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-hukstypeapi-oh-huks-pubkeyinfo) | 定义公钥信息的结构体类型。 |
| [OH_Huks_KeyMaterialRsa](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-hukstypeapi-oh-huks-keymaterialrsa) | 定义Rsa密钥的结构体类型。 |
| [OH_Huks_KeyMaterialEcc](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-hukstypeapi-oh-huks-keymaterialecc) | 定义Ecc密钥的结构体类型。 |
| [OH_Huks_KeyMaterialDsa](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-hukstypeapi-oh-huks-keymaterialdsa) | 定义Dsa密钥的结构体类型。 |
| [OH_Huks_KeyMaterialDh](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-hukstypeapi-oh-huks-keymaterialdh) | 定义Dh密钥的结构体类型。 |
| [OH_Huks_KeyMaterial25519](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-hukstypeapi-oh-huks-keymaterial25519) | 定义25519类型密钥的结构体类型。 |
| [OH_Huks_KeyAliasSet](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-hukstypeapi-oh-huks-keyaliasset) | 定义密钥别名集的结构体类型。 |
...
| MAX_AUTH_TIMEOUT_SECOND 60 | 最大用户认证超时时间。 **起始版本：** 9 |
...
![](./img/note_3.0-zh-cn.png) 业务在使用存储等级为ECE的密钥时，建议通过感知[锁屏事件](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/commoneventmanager-definitions#common_event_screen_locked)来清理使用该密钥创建的会话资源，以保证安全性。
...
| OH_HUKS_TAG_AE_TAG_LEN = OH_HUKS_TAG_TYPE_UINT | 521 | CCM模式下指定的AEAD长度。 **起始版本：** 22 |
...
| OH_HUKS_TAG_IS_DEVICE_PASSWORD_SET = OH_HUKS_TAG_TYPE_BOOL | 1012 | 表示密钥锁屏密码访问控制字段，可限制密钥只有在用户设置了锁屏密码时可用。 True表示只有在密码设置时才能生成和使用密钥。 **起始版本：** 11 |
