...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回当前的超级隐私模式状态。 |
...
| callback | Callback | 是 | 回调函数，返回调用结果。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| sensorType | [PrivacySensorType](#privacysensortype) | 否 | 否 | 策略应用的隐私传感器类型。 |
| sensorState | [PrivacySensorState](#privacysensorstate) | 否 | 否 | 策略中隐私传感器的状态。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| superPrivacyMode | [SuperPrivacyMode](#superprivacymode) | 否 | 否 | 超级隐私模式状态。 |
| superPrivacyPolicies | [SuperPrivacyPolicy](#superprivacypolicy)[] | 否 | 否 | 隐私传感器的超级隐私管控策略。数组长度必须为3。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回超级隐私管控策略信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback | 是 | 回调函数，返回超级隐私管控策略信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback | 否 | 回调函数，返回超级隐私管控策略信息。如果传入了callback，则取消该callback的订阅，否则取消所有callback的订阅。 |
