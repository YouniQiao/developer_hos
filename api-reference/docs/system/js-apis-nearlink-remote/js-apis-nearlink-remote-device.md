...
content_hash: "d44b25d35b1e"
synced_at: "2026-08-29T18:16:38.458756"
---
...
| 类型 | 说明 |
| --- | --- |
| [nearlinkConstant.PairingState](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-nearlink-constant#pairingstate) | 和远端设备的配对状态。 |
...
| 类型 | 说明 |
| --- | --- |
| [nearlinkConstant.DeviceClass](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-nearlink-constant#deviceclass) | 设备类型。 |
...
| 类型 | 说明 |
| --- | --- |
| [nearlinkConstant.AcbState](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-nearlink-constant#acbstate) | 和远端设备的逻辑链路连接状态。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback | 否 | 回调函数，返回订阅的配对状态变化结果。 填写该参数则取消当前callback订阅。不填写该参数则取消该事件对应的所有回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback | 否 | 回调函数，返回订阅的连接状态变化事件上报结果。 填写该参数则取消当前callback订阅。不填写该参数则取消该事件对应的所有回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback | 否 | 回调函数，返回订阅的逻辑链路连接状态变化事件上报结果。 填写该参数则取消当前callback订阅。不填写该参数则取消该事件对应的所有回调。 |
...
| 类型 | 说明 |
| --- | --- |
| [PairingState](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-nearlink-constant#pairingstate) | 和远端设备的配对状态。 |
...
| 类型 | 说明 |
| --- | --- |
| [DeviceClass](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-nearlink-constant#deviceclass) | 远端设备类型。 |
...
| 类型 | 说明 |
| --- | --- |
| [ConnectionState](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-nearlink-constant#connectionstate) | 本端设备和远端设备的连接状态。 |
...
| 类型 | 说明 |
| --- | --- |
| [AcbState](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-nearlink-constant#acbstate) | 和远端设备的逻辑链路连接状态。 |
...
| preState | [ConnectionState](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-nearlink-constant#connectionstate) | 否 | 否 | 本次上报之前的连接状态。 |
| state | [ConnectionState](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-nearlink-constant#connectionstate) | 否 | 否 | 当前连接状态。 |
...
| preState | [PairingState](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-nearlink-constant#pairingstate) | 否 | 否 | 本次上报之前的配对状态。 |
| state | [PairingState](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-nearlink-constant#pairingstate) | 否 | 否 | 当前配对状态。 |
| reason | [PairingReason](#pairingreason) | 否 | 否 | 原因值。 |
| reasonMsg | string | 否 | 是 | 原因详情。该字段仅用于日志信息，不应用于逻辑处理。无原因详情时，该字段默认为空字符串。 |

#### [h2]PairingRequestParam
...
| state | [AcbState](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-nearlink-constant#acbstate) | 否 | 否 | 当前逻辑链路连接状态。 |
