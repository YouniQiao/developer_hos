...
| 名称 | 描述 |
| --- | --- |
| [usb_serial_api.h](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-usb-serial-api-h) | 声明用于主机侧访问串口设备的USB Serial DDK接口。 |
| [usb_serial_types.h](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-usb-serial-types-h) | 提供USB Serial DDK中的枚举变量、结构体定义与宏定义。 |
