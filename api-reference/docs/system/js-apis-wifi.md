...
![](./img/note_3.0-zh-cn.png) 从API version 6开始支持，从API version 9开始废弃。建议使用[wifiManager.getScanInfoList](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-wifimanager#wifimanagergetscaninfolist10)替代。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback> | 是 | 回调函数。当成功时，err为0，data为扫描到的热点；否则err为非0值，data为空。 |
...
![](./img/note_3.0-zh-cn.png) 从API version 6开始支持，从API version 9开始废弃。建议使用[WifiSecurityType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-wifimanager#wifisecuritytype)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7开始支持，从API version 9开始废弃。建议使用[wifiManager.addCandidateConfig](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-wifimanager#wifimanageraddcandidateconfig)替代。
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象。表示操作结果，true: 成功， false: 失败。 |
...
![](./img/note_3.0-zh-cn.png) 从API version 7开始支持，从API version 9开始废弃。建议使用[wifiManager.addCandidateConfig](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-wifimanager#wifimanageraddcandidateconfig-1)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7开始支持，从API version 9开始废弃。建议使用[wifiManager.removeCandidateConfig](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-wifimanager#wifimanagerremovecandidateconfig)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7开始支持，从API version 9开始废弃。建议使用[wifiManager.removeCandidateConfig](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-wifimanager#wifimanagerremovecandidateconfig-1)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7开始支持，从API version 9开始废弃。建议使用[wifiManager.getCountryCode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-wifimanager#wifimanagergetcountrycode)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8开始支持，从API version 9开始废弃。建议使用[wifiManager.getP2pLinkedInfo](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-wifimanager#wifimanagergetp2plinkedinfo)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8开始支持，从API version 9开始废弃。建议使用[P2pConnectState](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-wifimanager#p2pconnectstate)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8开始支持，从API version 9开始废弃。建议使用[wifiManager.getP2pLinkedInfo](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-wifimanager#wifimanagergetp2plinkedinfo-1)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8开始支持，从API version 9开始废弃。建议使用[wifiManager.getCurrentGroup](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-wifimanager#wifimanagergetcurrentgroup)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8开始支持，从API version 9开始废弃。建议使用[wifiManager.getCurrentGroup](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-wifimanager#wifimanagergetcurrentgroup-1)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8开始支持，从API version 9开始废弃。建议使用[wifiManager.getP2pPeerDevices](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-wifimanager#wifimanagergetp2ppeerdevices)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8开始支持，从API version 9开始废弃。建议使用[wifiManager.getP2pPeerDevices](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-wifimanager#wifimanagergetp2ppeerdevices-1)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8开始支持，从API version 9开始废弃。建议使用[WifiP2pDevice](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-wifimanager#wifip2pdevice)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8开始支持，从API version 9开始废弃。建议使用[P2pDeviceStatus](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-wifimanager#p2pdevicestatus)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8开始支持，从API version 9开始废弃。建议使用[wifiManager.createGroup](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-wifimanager#wifimanagercreategroup)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8开始支持，从API version 9开始废弃。建议使用[WifiP2PConfig](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-wifimanager#wifip2pconfig)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8开始支持，从API version 9开始废弃。建议使用[GroupOwnerBand](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-wifimanager#groupownerband)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8开始支持，从API version 9开始废弃。建议使用[wifiManager.removeGroup](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-wifimanager#wifimanagerremovegroup)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8开始支持，从API version 9开始废弃。建议使用[wifiManager.p2pConnect](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-wifimanager#wifimanagerp2pconnect)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8开始支持，从API version 9开始废弃。建议使用[wifiManager.p2pCancelConnect](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-wifimanager#wifimanagerp2pcancelconnect)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8开始支持，从API version 9开始废弃。建议使用[wifiManager.startDiscoverDevices](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-wifimanager#wifimanagerstartdiscoverdevices)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8开始支持，从API version 9开始废弃。建议使用[wifiManager.stopDiscoverDevices](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-wifimanager#wifimanagerstopdiscoverdevices)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8开始支持，从API version 9开始废弃。建议使用[WifiP2pGroupInfo](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-wifimanager#wifip2pgroupinfo)替代。
...
| --- | --- | --- | --- |
| type | string | 是 | 固定填"wifiStateChange"字符串。 |
| callback | Callback | 否 | 状态改变回调函数。如果callback不填，将取消注册该事件关联的所有回调函数。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 固定填"wifiConnectionChange"字符串。 |
| callback | Callback | 否 | 连接状态改变回调函数。如果callback不填，将取消注册该事件关联的所有回调函数。 |
...
![](./img/note_3.0-zh-cn.png) 从API version 7开始支持，从API version 9开始废弃。建议使用[wifiManager.on](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-wifimanager#wifimanageronwifiscanstatechange)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7开始支持，从API version 9开始废弃。建议使用[wifiManager.off](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-wifimanager#wifimanageroffwifiscanstatechange)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7开始支持，从API version 9开始废弃。建议使用[wifiManager.on](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-wifimanager#wifimanageronwifirssichange)替代。
...
| callback | Callback | 是 | 状态改变回调函数，返回以dBm为单位的RSSI值。 |
...
![](./img/note_3.0-zh-cn.png) 从API version 7开始支持，从API version 9开始废弃。建议使用[wifiManager.off](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-wifimanager#wifimanageroffwifirssichange)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7开始支持，从API version 9开始废弃。建议使用[wifiManager.on](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-wifimanager#wifimanageronhotspotstatechange)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7开始支持，从API version 9开始废弃。建议使用[wifiManager.off](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-wifimanager#wifimanageroffhotspotstatechange)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7开始支持，从API version 9开始废弃。建议使用[wifiManager.on](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-wifimanager#wifimanageronp2pstatechange)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 7开始支持，从API version 9开始废弃。建议使用[wifiManager.off](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-wifimanager#wifimanageroffp2pstatechange)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8开始支持，从API version 9开始废弃。建议使用[wifiManager.on](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-wifimanager#wifimanageronp2pconnectionchange)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8开始支持，从API version 9开始废弃。建议使用[wifiManager.off](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-wifimanager#wifimanageroffp2pconnectionchange)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8开始支持，从API version 9开始废弃。建议使用[wifiManager.on](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-wifimanager#wifimanageronp2pdevicechange)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8开始支持，从API version 9开始废弃。建议使用[wifiManager.off](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-wifimanager#wifimanageroffp2pdevicechange)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8开始支持，从API version 9开始废弃。建议使用[wifiManager.on](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-wifimanager#wifimanageronp2ppeerdevicechange)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8开始支持，从API version 9开始废弃。建议使用[wifiManager.off](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-wifimanager#wifimanageroffp2ppeerdevicechange)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8开始支持，从API version 9开始废弃。建议使用[wifiManager.on](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-wifimanager#wifimanageronp2ppersistentgroupchange)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8开始支持，从API version 9开始废弃。建议使用[wifiManager.off](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-wifimanager#wifimanageroffp2ppersistentgroupchange)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8开始支持，从API version 9开始废弃。建议使用[wifiManager.on](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-wifimanager#wifimanageronp2pdiscoverychange)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8开始支持，从API version 9开始废弃。建议使用[wifiManager.off](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-wifimanager#wifimanageroffp2pdiscoverychange)替代。
