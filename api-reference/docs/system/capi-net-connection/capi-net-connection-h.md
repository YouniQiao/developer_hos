...
| [int32_t OH_NetConn_RefreshGlobalHttpProxyWithCallback(OH_NetConn_GlobalHttpProxyRefreshCallback callback, void *userContext)](#oh_netconn_refreshglobalhttpproxywithcallback) | 请求重新认证全局HTTP代理。调用本接口会触发一个异步重新认证请求，在认证完成后触发一次回调用于通知认证结果。 接口返回值为0表示请求已被接受，并不表示重新认证已成功，最终通过回调通知认证结果。若返回非零值，则不会触发回调。 |
...
| 参数项 | 描述 |
| --- | --- |
| [NetConn_NetHandle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-netconnection-netconn-nethandle) *netHandle | 存放网络ID。 |
...
| --- | --- |
| [NetConn_NetHandle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-netconnection-netconn-nethandle) *netHandle | 存放网络ID。 |
| [NetConn_ConnectionProperties](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-netconnection-netconn-connectionproperties) *prop | 存放链路信息。 |
...
| --- | --- |
| [NetConn_NetHandle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-netconnection-netconn-nethandle) *netHandle | 存放网络ID。 |
| [NetConn_NetCapabilities](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-netconnection-netconn-netcapabilities) *netCapabilities | 存放能力集。 |
...
| 参数项 | 描述 |
| --- | --- |
| [NetConn_HttpProxy](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-netconnection-netconn-httpproxy) *httpProxy | 存放代理配置信息。 |
...
| 参数项 | 描述 |
| --- | --- |
| [NetConn_NetHandleList](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-netconnection-netconn-nethandlelist) *netHandleList | 网络信息列表。 |
...
| 参数项 | 描述 |
| --- | --- |
| [OH_NetConn_CustomDnsResolver](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-net-connection-type-h#oh_netconn_customdnsresolver) resolver | 指向自定义DNS解析器的指针。 |
...
#### [h2]OH_NetConn_RegisterCustomDnsResolver()
...
| 类型 | 说明 |
| --- | --- |
| int32_t | 0 - 成功。 401 - 参数错误。 2101008 - 解析器已存在。 |

#### [h2]OH_NetConn_UnregisterCustomDnsResolver()
...
| [NetConn_NetHandle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-netconnection-netconn-nethandle) *netHandle | 指针类型，指向包含网络ID的网络句柄。 |
...
| 参数项 | 描述 |
| --- | --- |
| [NetConn_HttpProxy](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-netconnection-netconn-httpproxy) *httpProxy | 需要设置的http代理配置信息。 |
...
#### [h2]OH_NetConn_RefreshGlobalHttpProxyWithCallback()
...
| 参数项 | 描述 |
| --- | --- |
| [OH_NetConn_GlobalHttpProxyRefreshCallback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-net-connection-type-h#oh_netconn_globalhttpproxyrefreshcallback) callback | 用于接收重新认证结果的回调。若为NULL，则接口会返回401。 |
...
| 类型 | 说明 |
| --- | --- |
| int32_t | 0 - 成功。 201 - 缺少权限。 401 - 参数错误。 |

#### [h2]OH_NetConn_RegisterNetConnCallback()
...
| 类型 | 说明 |
| --- | --- |
| [NetConn_ErrorCode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-net-connection-type-h#netconn_errorcode) | 结果定义在 [NetConn_ErrorCode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-net-connection-type-h#netconn_errorcode)。 [NETCONN_SUCCESS](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-net-connection-type-h#netconn_errorcode) 成功。 [NETCONN_PERMISSION_DENIED](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-net-connection-type-h#netconn_errorcode) 缺少权限。 [NETCONN_PARAMETER_ERROR](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-net-connection-type-h#netconn_errorcode) 参数错误。 [NETCONN_OPERATION_FAILED](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-net-connection-type-h#netconn_errorcode) 无法连接到服务。 [NETCONN_INTERNAL_ERROR](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-net-connection-type-h#netconn_errorcode) 内部错误。 |
...
| 类型 | 说明 |
| --- | --- |
| [NetConn_ErrorCode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-net-connection-type-h#netconn_errorcode) | 结果定义在 [NetConn_ErrorCode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-net-connection-type-h#netconn_errorcode)。 [NETCONN_SUCCESS](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-net-connection-type-h#netconn_errorcode) 成功。 [NETCONN_PARAMETER_ERROR](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-net-connection-type-h#netconn_errorcode) 参数错误。 [NETCONN_OPERATION_FAILED](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-net-connection-type-h#netconn_errorcode) 无法连接到服务。 [NETCONN_INTERNAL_ERROR](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-net-connection-type-h#netconn_errorcode) 内部错误。 |
...
| [NetConn_ProbeResultInfo](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-netconnection-netconn-proberesultinfo) *probeResultInfo | 丢包率和往返时间（RTT）。 |
...
| [NetConn_TraceRouteOption](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-netconnection-netconn-tracerouteoption) *option | 路由参数选项。 |
| [NetConn_TraceRouteInfo](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-netconnection-netconn-tracerouteinfo) *traceRouteInfo | 路由结果。需传入数组指针，数组大小代表路由跳数，默认30跳。若自定义跳数，则需保证数组大小与option字段中的maxJumpNumber数值保持一致。 |
