...
content_hash: "43af826e43ea"
synced_at: "2026-07-28T16:51:09.160948"
---
...
| 类型 | 说明 |
| --- | --- |
| Promise | 无返回结果的Promise对象。当移除系统账号失败时，会抛出错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | 无返回结果的Promise对象。当切换系统账号失败时，会抛出错误对象。 |
