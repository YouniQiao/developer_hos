...
content_hash: "16f17af5e2b4"
synced_at: "2026-07-28T16:50:59.486913"
---
...
![](./img/note_3.0-zh-cn.png) 从API version 3 开始支持，从API version 9 开始废弃，建议使用[request.uploadFile](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-request#requestuploadfile9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 3 开始支持，从API version 9 开始废弃，建议使用[UploadConfig](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-request#uploadconfig)替代。

| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| url | string | 否 | 否 | 上传服务器地址。 |
| data | Array | 否 | 是 | 请求的表单数据。 |
| files | Array | 否 | 否 | 待上传文件列表。请使用multipart/form-data进行提交。 |
