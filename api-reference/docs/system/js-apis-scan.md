...
content_hash: "f678b5b8589f"
synced_at: "2026-08-29T18:16:55.847612"
---
...
| **类型** | **说明** |
| --- | --- |
| Promise | Promise对象，初始化扫描服务成功时resolve，失败时reject。 |
...
| **类型** | **说明** |
| --- | --- |
| Promise | Promise对象，退出扫描服务成功时resolve，失败时reject。 |
...
| **类型** | **说明** |
| --- | --- |
| Promise | Promise对象，开始发现扫描仪成功时resolve，失败时reject。 |
...
| **类型** | **说明** |
| --- | --- |
| Promise | Promise对象，打开扫描仪成功时resolve，失败时reject。 |
...
| **类型** | **说明** |
| --- | --- |
| Promise | Promise对象，关闭扫描仪成功时resolve，失败时reject。 |
...
| **类型** | **说明** |
| --- | --- |
| Promise | Promise对象，获取扫描仪参数成功时resolve并返回扫描仪参数数组，失败时reject。 |
...
| **类型** | **说明** |
| --- | --- |
| Promise | Promise对象，设置扫描仪参数成功时resolve，失败时reject。 |
...
| **类型** | **说明** |
| --- | --- |
| Promise | Promise对象，设置扫描选项为自动模式成功时resolve，失败时reject。 |
...
| **类型** | **说明** |
| --- | --- |
| Promise | Promise对象，获取当前扫描仪设置成功时resolve并返回扫描仪选项值，失败时reject。 |
...
| **类型** | **说明** |
| --- | --- |
| Promise | Promise对象，开始扫描成功时resolve，失败时reject。 |
...
| **类型** | **说明** |
| --- | --- |
| Promise | Promise对象，取消扫描成功时resolve，失败时reject。 |
...
| **类型** | **说明** |
| --- | --- |
| Promise | Promise对象，获取图片扫描进度成功时resolve并返回图片扫描进度信息，失败时reject。 |
...
| callback | Callback | 是 | 回调函数，返回扫描仪设备发现信息。 |
...
| --- | --- | --- | --- |
| type | 'scanDeviceFound' | 是 | 事件类型。 |
| callback | Callback | 否 | 需要取消注册的回调函数。若不传入，则取消调用方所有已注册的回调。 |
...
| callback | Callback | 是 | 回调函数，返回扫描仪设备同步信息。 |
