...
| --- | --- | --- | --- |
| type | string | 是 | 固定传入'sensorStatusChange',状态监听固定参数。 |
| callback | Callback | 否 | sensor.on传入的回调函数，不传则取消所有监听。 |
...
| callback | AsyncCallback | 是 | 回调函数，异步返回指定的气压值对应的海拔高度，单位为米。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，使用异步方式返回指定的气压值对应的海拔高度，单位为米。 |
...
| callback | AsyncCallback | 是 | 回调函数，异步返回地磁倾角，单位为弧度。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，使用异步方式返回地磁倾斜角，单位为弧度。 |
...
| callback | AsyncCallback> | 是 | 回调函数，异步返回绕z、x、y轴方向的旋转角度，单位度（°）。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise> | Promise对象，使用异步方式返回绕z、x、y轴方向的旋转角度，单位度（°）。 |
...
| callback | AsyncCallback> | 是 | 回调函数，异步返回围绕z、x、y轴方向的旋转角度，单位度（°）。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise> | Promise对象，使用异步方式返回围绕z、x、y轴方向的旋转角度，单位度（°）。 |
...
| callback | AsyncCallback | 是 | 异步返回设备所在的海拔高度，单位为米。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | 使用异步方式返回设备所在的海拔高度（单位：米）。 |
...
| callback | AsyncCallback | 是 | 异步返回地磁倾斜角，单位为弧度。 |
...
| callback | AsyncCallback> | 是 | 异步返回z、x、y轴方向的旋转角度变化，单位度（°）。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise> | 使用异步方式返回z、x、y轴方向的旋转角度变化，单位度（°）。 |
...
| callback | AsyncCallback> | 是 | 异步返回围绕z、x、y轴方向的旋转角度，单位度（°）。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise> | 使用异步方式返回围绕z、x、y轴方向的旋转角度，单位度（°）。 |
