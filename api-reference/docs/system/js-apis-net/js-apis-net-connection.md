...
content_hash: "64a628245131"
synced_at: "2026-07-28T16:50:42.735589"
---
...
![](./img/note_3.0-zh-cn.png) （1）设备从无网络状态转变为有网络状态时，将触发netAvailable事件、netCapabilitiesChange事件和netConnectionPropertiesChange事件；
...
![](./img/caution_3.0-zh-cn.png) 使用完register接口后需要及时调用unregister取消注册。
