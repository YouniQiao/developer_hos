...
upstream_id: "harmonyos-references/js-apis-net-mdns"
catalog: "harmonyos-references"
content_hash: "537ea35cd120"
synced_at: "2026-07-09T00:59:27.795553"
---
...
| callback | AsyncCallback | 是 | 回调函数。成功添加时error为undefined，data为添加到本地的MDNS服务信息。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | 以Promise形式返回添加的MDNS服务信息。 |
...
| context | Context | 是 | 应用的上下文。 FA模型的应用Context定义见[Context](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-inner-app-context)。 Stage模型的应用Context定义见[Context](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-inner-application-context)。 |
| serviceInfo | [LocalServiceInfo](#localserviceinfo) | 是 | MDNS服务的信息。 |
| callback | AsyncCallback | 是 | 回调函数。成功移除error为undefined，data为移除本地的MDNS服务信息。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | 以Promise形式返回移除的MDNS服务信息。 |
...
| context | Context | 是 | 应用的上下文。 FA模型的应用Context定义见[Context](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-inner-app-context)。 Stage模型的应用Context定义见[Context](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-inner-application-context)。 |
| serviceInfo | [LocalServiceInfo](#localserviceinfo) | 是 | MDNS服务的信息。 |
| callback | AsyncCallback | 是 | 回调函数。成功移除error为undefined，data为解析的MDNS服务信息。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | 以Promise形式返回解析的MDNS服务信息。 |
...
| callback | Callback | 是 | MDNS服务的信息和事件错误信息。 |
...
| callback | Callback | 否 | MDNS服务的信息和事件错误信息。可以指定传入on中的callback取消对应的订阅，也可以不指定callback清空所有订阅。 |
...
| callback | Callback | 是 | MDNS服务的信息，需调用resolveLocalService解析这个MDNS服务信息。 |
...
| callback | Callback | 否 | MDNS服务的信息。可以指定传入on中的callback取消对应的订阅，也可以不指定callback清空所有订阅。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| serviceType | string | 否 | 否 | MDNS服务的类型。格式：_.，name长度小于63字符并且不能包含字符'.'。 |
...
| serviceAttribute | Array | 否 | 是 | MDNS服务属性信息。 |
