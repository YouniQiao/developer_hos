...
在未调用或调用[bindDriverWithDeviceId](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-driver-devicemanager#devicemanagerbinddriverwithdeviceid19)接口失败的情况下，调用[unbindDriverWithDeviceId](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-driver-devicemanager#devicemanagerunbinddriverwithdeviceid19)接口。

处理步骤

请按照接口调用顺序，先调用[bindDriverWithDeviceId](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-driver-devicemanager#devicemanagerbinddriverwithdeviceid19)接口，并确认调用成功的情况下，调用[unbindDriverWithDeviceId](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-driver-devicemanager#devicemanagerunbinddriverwithdeviceid19)接口。
