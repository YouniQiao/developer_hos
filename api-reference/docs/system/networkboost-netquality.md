...
| callback | Callback> | 是 | 回调函数，返回网络Qos变化的详细信息。 |
...
| callback | Callback> | 否 | 需要取消注册的回调函数，需与订阅时传入的回调函数是同一个。若无此参数，则取消注册所有的回调函数。 |
...
| callback | Callback> | 是 | 回调函数，返回网络场景变化的详细信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| appQoe | [AppQoe](#appqoe) | 是 | 表示应用需要反馈的传输体验信息。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| serviceType | [ServiceType](#servicetype) | 否 | 否 | 应用的业务类型。 |
| qoeType | [QoeType](#qoetype) | 否 | 否 | 应用体验类型。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| pathType | [PathType](#pathtype) | 否 | 否 | 表明相应的数据路径上的网络质量信息。 |
| linkUpBandwidth | [RateBps](#ratebps) | 否 | 否 | 上行带宽信息，单位为bps。 |
...
| 'callSignaling' | 表示语音信令类型，值固定为'callSignaling'字符串。 |
...
| [BadQoeCause](#badqoecause) | 表示体验差类型。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| pathType | [PathType](#pathtype) | 否 | 否 | 表明相应的数据路径上的网络场景信息。 |
| scene | [Scene](#scene) | 否 | 否 | 场景状态。 |
| recommendedAction | [RecommendedAction](#recommendedaction) | 否 | 否 | 建议的数传策略。 |
| weakSignalPrediction | [WeakSignalPrediction](#weaksignalprediction) | 否 | 是 | 弱信号预测相关信息。 |
