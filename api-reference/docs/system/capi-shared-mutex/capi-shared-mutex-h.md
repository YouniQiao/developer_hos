...
| 参数项 | 描述 |
| --- | --- |
| [ffrt_rwlock_t](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-ffrt-ffrt-rwlock-t)* rwlock | rwlock指针。 |
| [const ffrt_rwlockattr_t](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-ffrt-ffrt-rwlockattr-t)* attr | rwlock属性指针，仅支持默认，即设定为空指针。 |
