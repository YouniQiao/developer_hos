...
content_hash: "59d59c47e031"
synced_at: "2026-07-28T16:50:25.837184"
---
...
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| maxSelectNumber | number | 否 | 是 | 最大可选项数。如果不传，则默认为50。取值范围为1~50，小于1或者大于50会抛出错误信息，错误码[401](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/errorcode-devicesecurity-antifraudpicker#section401-参数检查失败)。 |
...
| mmsAttachments | [MmsAttachmentInfo](#mmsattachmentinfo)[] | 否 | 是 | 彩信附件信息列表。该字段仅当消息类型为彩信时生效。 |
...
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| messageInfo | [SingleAntifraudMessageInfo](#singleantifraudmessageinfo)[] | 否 | 否 | 诈骗消息结果列表。 |
...
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| callLogInfo | [SingleAntifraudCallLogInfo](#singleantifraudcallloginfo)[] | 否 | 否 | 诈骗通话记录列表。 |
...
| options | [AntifraudMessageOptions](#antifraudmessageoptions) | 否 | 请求参数。如果不传，则最大可选项数默认为50。 |

返回值：

| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回诈骗消息结果。 |
...
| --- | --- | --- | --- |
| context | [common.Context](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-inner-application-context) | 是 | 应用上下文。 |
| options | [AntifraudCallLogOptions](#antifraudcalllogoptions) | 否 | 请求参数。如果不传，则最大可选项数默认为50。 |

返回值：

| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回诈骗通话记录结果。 |
...
| **名称** | **类型** | 只读 | 可选 | **说明** |
| --- | --- | --- | --- | --- |
| appInfo | [SingleAntifraudAppInfo](#singleantifraudappinfo)[] | 否 | 否 | 诈骗应用列表。 |
...
| --- | --- | --- | --- |
| context | [common.Context](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-inner-application-context) | 是 | 应用上下文。 |
| options | [AntifraudAppOptions](#antifraudappoptions) | 否 | 请求参数。如果不传，则最大可选项数默认为50。 |

返回值：

| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回诈骗应用结果。 |
