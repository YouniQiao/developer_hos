...
content_hash: "b3e51986b4b0"
synced_at: "2026-09-23T18:56:10.815158"
---
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象。返回true表示熄屏导航开关开启；返回false表示熄屏导航开关关闭。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback | 是 | 熄屏导航事件的回调函数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback | 否 | AOD交互事件的回调函数，如果不传则停止所有监听。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback | 是 | 返回累计爬升信息的回调函数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback | 否 | 回调函数，如果省略则移除所有回调。 |
