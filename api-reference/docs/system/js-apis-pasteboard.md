...
content_hash: "08827315713d"
synced_at: "2026-07-28T16:50:58.148262"
---
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| data | [Record](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/introduction-to-arkts#对象字面量) | 是 | Record对象，key为MIME类型，value为对应数据。详情见下文说明。 |
