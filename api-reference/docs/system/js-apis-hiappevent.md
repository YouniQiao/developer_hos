...
content_hash: "c33de4f706d2"
synced_at: "2026-07-28T16:51:21.544754"
---
...
- 本模块接口从API version 9开始废弃，建议使用新接口[@ohos.hiviewdfx.hiAppEvent](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-hiviewdfx-hiappevent)替代。
...
| callback | AsyncCallback | 是 | 事件回调函数。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，可以在其then()、catch()方法中分别对事件写入成功、写入异常的情况进行异步处理。 |
