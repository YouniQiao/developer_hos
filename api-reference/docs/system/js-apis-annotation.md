...
content_hash: "1e27edb05c54"
synced_at: "2026-08-29T18:16:57.427447"
---
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| rules | Array | 否 | 否 | 支持告警消除的规则集合，用于指定需要抑制的告警类型。可通过数组传入多个规则同时抑制多种告警。可选取值参见[SuppressWarningsType](#suppresswarningstype23)。 |
...
![](./img/note_3.0-zh-cn.png) 用于容器节点时，会屏蔽节点下子节点产生的告警。
...
![](./img/note_3.0-zh-cn.png) 仅支持单行注释(//)格式，示例：// @SuppressWarnings compatibility
