...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback | 是 | 以callback形式异步返回结果。 - 0：卡槽1。 - 1：卡槽2。 - 2：esim和天际通场景下，默认移动数据的slotId为2。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | 以Promise形式返回获取默认移动数据的SIM卡。 - 0：卡槽1。 - 1：卡槽2。 - 2：esim和天际通场景下，默认移动数据的slotId为2。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback | 是 | 以callback形式异步返回结果。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | 以Promise形式返回蜂窝网络的数据流类型（对应信号栏旁边的上下行箭头）。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | 以Promise形式返回获取PS域的连接状态。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback | 是 | 以callback形式异步返回结果。 true：蜂窝数据业务已启用。 false：蜂窝数据业务已禁用。 |
...
| callback | AsyncCallback | 是 | 以callback形式异步返回结果。 true：蜂窝数据业务已启用漫游。 false：蜂窝数据业务已禁用漫游。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise> | Promise对象，返回默认移动数据的SIM卡的APN信息列表。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise> | Promise对象，返回传入的ApnInfo对应的ApnId信息列表。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回设置的结果，在未插卡时会返回false。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回默认移动数据SIM卡对应的处于激活状态的数据业务APN name信息。 |
