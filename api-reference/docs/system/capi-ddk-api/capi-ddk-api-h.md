...
content_hash: "9058d85a040c"
synced_at: "2026-08-29T18:17:09.566882"
---
...
| [DDK_Ashmem](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-baseddk-ddk-ashmem) **ashmem | 用于输出创建的共享内存对象的指针。 |

返回：

| 类型 | 说明 |
| --- | --- |
| [DDK_RetCode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-ddk-types-h#ddk_retcode) | [DDK_SUCCESS](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-ddk-types-h#ddk_retcode) 调用接口成功。共享内存已成功创建并初始化完成。 [DDK_INVALID_PARAMETER](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-ddk-types-h#ddk_retcode) 入参name为空指针，size的大小为0或者入参ashmem是空指针。请检查传入的参数值。 [DDK_FAILURE](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-ddk-types-h#ddk_retcode) 创建共享内存失败或者创建结构体DDK_Ashmem失败。请检查申请的内存大小和权限。 |
...
| 参数项 | 描述 |
| --- | --- |
| [DDK_Ashmem](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-baseddk-ddk-ashmem) *ashmem | 要映射的共享内存描述符指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [DDK_RetCode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-ddk-types-h#ddk_retcode) | [DDK_SUCCESS](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-ddk-types-h#ddk_retcode) 调用接口成功。共享内存已映射到用户空间。 [DDK_NULL_PTR](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-ddk-types-h#ddk_retcode) 入参ashmem为空指针。请检查传入的参数值。 [DDK_FAILURE](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-ddk-types-h#ddk_retcode) 共享内存的文件描述符无效或未先创建共享内存。请检查共享内存是否已被创建、确保文件描述符未被关闭。 [DDK_INVALID_OPERATION](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-ddk-types-h#ddk_retcode) 调用接口映射共享内存失败。可能原因包括映射状态异常或权限不足，请检查共享内存的映射状态和权限后重试。 |
...
| 参数项 | 描述 |
| --- | --- |
| [DDK_Ashmem](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-baseddk-ddk-ashmem) *ashmem | 要取消映射的共享内存描述符指针。 |

返回：

| 类型 | 说明 |
| --- | --- |
| [DDK_RetCode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-ddk-types-h#ddk_retcode) | [DDK_SUCCESS](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-ddk-types-h#ddk_retcode) 调用接口成功。共享内存已成功从用户空间取消映射。 [DDK_NULL_PTR](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-ddk-types-h#ddk_retcode) 入参ashmem为空指针。请检查传入的参数值。 [DDK_FAILURE](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-ddk-types-h#ddk_retcode) 共享内存的文件描述符无效或未先执行映射。 |
...
| 参数项 | 描述 |
| --- | --- |
| [DDK_Ashmem](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-baseddk-ddk-ashmem) *ashmem | 要销毁的共享内存描述符指针。 |

返回：

| 类型 | 说明 |
| --- | --- |
| [DDK_RetCode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-ddk-types-h#ddk_retcode) | [DDK_SUCCESS](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-ddk-types-h#ddk_retcode) 调用接口成功。共享内存已成功销毁释放。 [DDK_NULL_PTR](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-ddk-types-h#ddk_retcode) 入参ashmem为空指针。请检查传入的参数值。 [DDK_FAILURE](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-ddk-types-h#ddk_retcode) 共享内存的文件描述符无效。可能原因包括共享内存已被释放或多次销毁，请检查其状态。 |
