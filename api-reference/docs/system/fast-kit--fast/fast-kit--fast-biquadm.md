---
title: "FAST_Biquadm"
upstream_id: "harmonyos-references/fast-kit--fast-biquadm"
catalog: "harmonyos-references"
content_hash: "ac05582929b5"
synced_at: "2026-07-09T00:59:46.340583"
---
...
| 名称 | 描述 |
| --- | --- |
| uint8_t* [activeFilters](#activefilters) | 活跃滤波器掩码数组。 |
| uint8_t [isInitialized](#isinitialized) | 初始化标志。 |
| float* [channelGains](#channelgains) | 每通道线性增益因子数组。 |
| FAST_BiquadCoefficients* [coefficients](#coefficients) | 滤波器系数数组。 |
| size_t [maxFrames](#maxframes) | 单次处理最大采样数。 |
| size_t [numChannels](#numchannels) | 音频或信号通道数。 |
| size_t [numSections](#numsections) | 每通道级联的 biquad 节数。 |
| FAST_BiquadState* [states](#states) | 滤波器状态数组。 |
