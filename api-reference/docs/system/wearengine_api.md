...
![](./img/note_3.0-zh-cn.png) 针对系统能力SystemCapability.Health.WearEngine，请先使用[canIUse()](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-syscap#caniuse)接口判断当前设备是否支持此syscap及对应接口。
...
| [1008509999](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/errorcode-wearengine#section1008509999-内部错误) | Internal error. |
...
| [1008500004](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/errorcode-wearengine#section1008500004-应用未申请wear-engine服务) | App has not applied for the Wear Engine service. |
| [1008500006](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/errorcode-wearengine#section1008500006-用户未同意隐私授权) | User privacy is not agreed. |
| [1008500007](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/errorcode-wearengine#section1008500007-穿戴设备侧能力不支持) | The device capability is not supported. |
| [1008500008](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/errorcode-wearengine#section1008500008-账号未登录) | Account error. The user has not logged in with HUAWEI ID. |
| [1008500009](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/errorcode-wearengine#section1008500009-账号异常) | Account error. Failed to obtain account information with HUAWEI ID. |
| [1008509999](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/errorcode-wearengine#section1008509999-内部错误) | Internal error. |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回是否支持指定能力的查询结果。 true：支持，false：不支持。 |
...
| [1008500003](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/errorcode-wearengine#section1008500003-设备未连接) | Device disconnected. |
| [1008500004](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/errorcode-wearengine#section1008500004-应用未申请wear-engine服务) | App has not applied for the Wear Engine service. |
| [1008500005](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/errorcode-wearengine#section1008500005-用户未授权) | The HUAWEI ID is not authorized. |
| [1008500006](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/errorcode-wearengine#section1008500006-用户未同意隐私授权) | User privacy is not agreed. |
| [1008500008](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/errorcode-wearengine#section1008500008-账号未登录) | Account error. The user has not logged in with HUAWEI ID. |
| [1008500009](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/errorcode-wearengine#section1008500009-账号异常) | Account error. Failed to obtain account information with HUAWEI ID. |
| [1008509999](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/errorcode-wearengine#section1008509999-内部错误) | Internal error. |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回查询的结果。不同状态返回值的含义请参考[MonitorItem](#monitoritem)。 |
...
| [1008500008](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/errorcode-wearengine#section1008500008-账号未登录) | Account error. The user has not logged in with HUAWEI ID. |
| [1008500009](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/errorcode-wearengine#section1008500009-账号异常) | Account error. Failed to obtain account information with HUAWEI ID. |
| [1008500010](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/errorcode-wearengine#section1008500010-无效设备id) | Device ID is invalid. |
| [1008509999](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/errorcode-wearengine#section1008509999-内部错误) | Internal error. |
...
| callback | Callback | 是 | 回调函数，返回设备对应状态变化后的信息。 状态发生变化后执行，建议保证回调函数的生命周期延长至取消监听时。 |
...
| [1008500009](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/errorcode-wearengine#section1008500009-账号异常) | Account error. Failed to obtain account information with HUAWEI ID. |
| [1008500010](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/errorcode-wearengine#section1008500010-无效设备id) | Device ID is invalid. |
| [1008500012](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/errorcode-wearengine#section1008500012-回调函数过多) | Too many callbacks of the same type. |
| [1008509999](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/errorcode-wearengine#section1008509999-内部错误) | Internal error. |
...
| callback | Callback | 是 | 回调函数，返回设备对应状态变化后的信息。 此处需保证传入的对象与调用[subscribeEvent](#subscribeevent)接口时传入的回调函数为同一个对象。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| code | number | 否 | 否 | 当使用[queryStatus](#querystatus)接口查询设备状态时，返回值含义请见[MonitorItem](#monitoritem)。 当使用[subscribeEvent](#subscribeevent)接口订阅监听时，返回值含义请见[MonitorEvent](#monitorevent)。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象。表示设备侧应用是否安装。true：已安装，false：未安装。 |
...
| message | [P2pMessage](#p2pmessage) | 是 | 需要传输的消息内容，取值范围：[1，4096)，单位Byte。 |
...
| [1008500009](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/errorcode-wearengine#section1008500009-账号异常) | Account error. Failed to obtain account information with HUAWEI ID. |
| [1008500010](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/errorcode-wearengine#section1008500010-无效设备id) | Device ID is invalid. |
| [1008500011](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/errorcode-wearengine#section1008500011-无效文件) | File is invalid. |
| [1008509999](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/errorcode-wearengine#section1008509999-内部错误) | Internal error. |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回P2p通信的结果。 属性中的code字段表示本次取消文件发送的结果。 |
...
| callback | Callback | 是 | 回调函数，返回对端设备应用发送的消息。 接收到设备侧应用发送的消息后执行的回调函数。 |
...
| deviceRandomId | string | 是 | [Device](#device)的随机标识符，用于指定本次订阅的设备。 |
| appParam | [P2pAppParam](#p2pappparam) | 是 | 设备侧应用参数。 |
| callback | Callback | 是 | 回调函数，返回对端设备应用发送的文件。 接收到设备侧应用发送的文件后执行的回调函数。 |
...
#### [h2]registerFileReceiverWithProgress
...
| deviceRandomId | string | 是 | [Device](#device)的随机标识符，用于指定本次订阅的设备。 |
| appParam | [P2pAppParam](#p2pappparam) | 是 | 设备侧应用参数。 |
| callback | Callback | 是 | 回调函数，返回对端设备应用发送的文件类。 接收到设备侧应用发送的文件或者传输进度后执行的回调函数。 |
...
| deviceRandomId | string | 是 | [Device](#device)的随机标识符，用于指定本次订阅的设备。 |
| appParam | [P2pAppParam](#p2pappparam) | 是 | 设备侧应用参数。 |
| callback | Callback | 是 | 回调函数，返回对端设备应用发送的消息。 需要同订阅监听时的回调函数为同一个对象。 |
...
| deviceRandomId | string | 是 | [Device](#device)的随机标识符，用于指定本次订阅的设备。 |
| appParam | [P2pAppParam](#p2pappparam) | 是 | 设备侧应用参数。 |
| callback | Callback | 是 | 回调函数，返回对端设备应用发送的文件。 需要同订阅监听时的回调函数为同一个对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回设备侧可用的传感器列表。 |
...
| callback | Callback | 是 | 回调函数，返回传感器上报结果。 用于处理传感器上报的数据。 |
...
| callback | Callback | 是 | 回调函数，返回传感器上报结果。 需要同订阅监听时的回调函数为同一个对象。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 监听的事件类型，仅支持serviceDie，表示服务端消亡事件。 |
| callback | Callback | 否 | 回调函数，无返回结果。 需要同订阅监听时的回调函数为同一个对象。 当该参数为空时，会取消掉之前所有的订阅。 |
