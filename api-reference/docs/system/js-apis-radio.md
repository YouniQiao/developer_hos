...
| callback | AsyncCallback | 是 | 回调函数。返回当前接入的CS域和PS域无线接入技术。其中，CS域为电路交换域，PS为分组交换域。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | 以Promise形式返回当前接入的CS域和PS域技术。CS域为电路交换域，PS为分组交换域。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback | 是 | 回调函数。返回当前网络状态。 |
...
| --- | --- | --- | --- |
| slotId | number | 是 | 卡槽ID。 - 0：卡槽1。 - 1：卡槽2。 |
| callback | AsyncCallback | 是 | 回调函数。返回当前选网模式。 |
...
| --- | --- | --- | --- |
| slotId | number | 是 | 卡槽ID。 - 0：卡槽1。 - 1：卡槽2。 |
| callback | AsyncCallback | 是 | 回调函数。返回国家码，例如：CN(中国)。如果设备没有注册任何网络，接口返回空字符串。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | 以Promise形式返回注册网络所在国家的ISO国家码，例如CN(中国)。如果设备没有注册任何网络，接口返回空字符串。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback | 是 | 回调函数。返回主卡所在卡槽的索引号。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | 以Promise形式返回设备主卡所在卡槽的索引号。 |
...
| --- | --- | --- | --- |
| slotId | number | 是 | 卡槽ID。 - 0：卡槽1。 - 1：卡槽2。 |
| callback | AsyncCallback> | 是 | 回调函数，返回从[SignalInformation](#signalinformation)中派生出的子类对象的数组。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise> | 以Promise形式返回网络信号强度[SignalInformation](#signalinformation)子类对象的数组。 |
...
| 类型 | 说明 |
| --- | --- |
| Array | 返回网络信号强度[SignalInformation](#signalinformation)子类对象的数组。 |
...
![](./img/note_3.0-zh-cn.png) 从 API version 7开始支持，从API version 9开始废弃。建议使用[isNRSupported](#radioisnrsupported9)替代。
...
![](./img/note_3.0-zh-cn.png) 从 API version 8开始支持，从API version 9开始废弃。建议使用[isNRSupported](#radioisnrsupported9-1)替代。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback | 是 | 回调函数。返回主卡的Radio状态。 - true：Radio打开。 - false：Radio关闭。 |
...
| --- | --- | --- | --- |
| slotId | number | 是 | 卡槽ID。 - 0：卡槽1。 - 1：卡槽2。 |
| callback | AsyncCallback | 是 | 回调函数。返回指定卡槽的Radio状态。 - true：Radio打开。 - false：Radio关闭。 |
