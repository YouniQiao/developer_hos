...
| struct [AuthenticationExtensionsClientOutputs](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/_authentication_extensions_client_outputs) | 身份认证扩展输出。 |
...
| typedef struct [AuthenticationExtensionsClientOutputs](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/_authentication_extensions_client_outputs) [AuthenticationExtensionsClientOutputs](#authenticationextensionsclientoutputs) | 身份认证扩展输出。 |
...
| [FIDO2_ErrorCode](#fido2_errorcode-1) [HMS_FIDO2_authenticate](#hms_fido2_authenticate) (const [FIDO2_CredentialRequestOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/_f_i_d_o2___credential_request_options) options, const [FIDO2_TokenBinding](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/_f_i_d_o2___token_binding) tokenBinding, const char *origin, [FIDO2_PublicKeyAssertionCredential](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/_f_i_d_o2___public_key_assertion_credential) **publicKeyAssertionCredential) | 通行密钥认证。 |
...
| 枚举值 | 描述 |
| --- | --- |
| FIDO2_NONE | 依赖方对认证者证明不感兴趣，默认值为FIDO2_NONE。 |
...
| 名称 | 描述 |
| --- | --- |
| options | 指向要初始化的[FIDO2_CredentialCreationOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/_f_i_d_o2___credential_creation_options)结构体的指针。 |
...
| 名称 | 描述 |
| --- | --- |
| options | 指向要初始化的[FIDO2_CredentialRequestOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/_f_i_d_o2___credential_request_options)结构体的指针。 |
...
| 名称 | 描述 |
| --- | --- |
| tokenBinding | 指向要初始化的[FIDO2_TokenBinding](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/_f_i_d_o2___token_binding)结构体的指针。 |
...
释放FIDO2_PublicKeyAssertionCredential的结构体。
...
| 名称 | 描述 |
| --- | --- |
| publicKeyAssertionCredential | 要释放的[FIDO2_PublicKeyAssertionCredential](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/_f_i_d_o2___public_key_assertion_credential)的结构体。 |
...
释放FIDO2_PublicKeyAttestationCredential的结构体。
...
| 名称 | 描述 |
| --- | --- |
| publicKeyAttestationCredential | 要释放的[FIDO2_PublicKeyAttestationCredential](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/_f_i_d_o2___public_key_attestation_credential)的结构体。 |
