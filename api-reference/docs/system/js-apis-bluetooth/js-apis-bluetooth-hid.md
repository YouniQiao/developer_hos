...
content_hash: "fe419c630f23"
synced_at: "2026-08-29T18:16:36.981261"
---
...
| 类型 | 说明 |
| --- | --- |
| HidHostProfile | 返回HID Host实例。 - 该类继承于[BaseProfile](#baseprofile)，因此可以使用其父类中的方法。 - 和该实例角色相对应的是[HID Device](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/terminology#hid-device)角色。 |
...
| 类型 | 说明 |
| --- | --- |
| [HidDeviceProfile](#hiddeviceprofile23) | 返回HID Device实例。 - 该类继承于[BaseProfile](#baseprofile)，因此可以使用其父类中的方法。 - 和该实例角色相对应的是[HID Host](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/terminology#hid-host)角色。 |
...
| callback | Callback | 是 | 回调函数。返回true表示HID设备当前为注册状态；返回false表示HID设备当前为解注册状态。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback | 是 | 回调函数，返回收到的报告数据。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback | 否 | 指定取消订阅的回调函数通知。若传参，则需与[onGetReport](#ongetreport23)中的回调函数一致；若无传参，则取消订阅所有回调函数通知。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback | 否 | 指定取消订阅的回调函数通知。若传参，则需与[onSetReport](#onsetreport23)中的回调函数一致；若无传参，则取消订阅所有回调函数通知。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback | 是 | 回调函数，返回收到的中断数据。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback | 否 | 指定取消订阅的回调函数通知。若传参，则需与[onInterruptDataReceived](#oninterruptdatareceived23)中的回调函数一致；若无传参，则取消订阅所有回调函数通知。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback | 是 | 回调函数。返回收到的协议数据。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback | 否 | 指定取消订阅的回调函数通知。若传参，则需与[onSetProtocol](#onsetprotocol23)中的回调函数一致；若无传参，则取消订阅所有回调函数通知。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback | 是 | 回调函数。当主机断开虚拟链路时返回。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback | 否 | 指定取消订阅的回调函数通知。若传参，则需与[onVirtualCableUnplug](#onvirtualcableunplug23)中的回调函数一致；若无传参，则取消订阅所有回调函数通知。 |
