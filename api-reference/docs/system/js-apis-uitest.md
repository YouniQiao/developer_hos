...
content_hash: "e674db557997"
synced_at: "2026-07-28T16:51:25.881655"
---
...
| REG_EXP18+ | 4 | 正则表达式匹配。 **元服务API：** 从API version 18开始，该接口支持在元服务中使用。 |
| REG_EXP_ICASE18+ | 5 | 正则表达式匹配，忽略大小写。 **元服务API：** 从API version 18开始，该接口支持在元服务中使用。 |
...
| actived(deprecated) | boolean | 否 | 是 | 窗口是否正与用户进行交互，true：交互状态，false：未交互状态，默认值为false。 从API version 9开始支持，从API version 11开始废弃，建议使用[active11+](#windowfilter9)替代。 |
...
| COMPONENT_TEXT_CHANGED | 5 | [输入框控件](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-common-components-text-input)文本变化事件。 |
...
| --- | --- | --- | --- | --- |
| timeout | number | 否 | 是 | 监听超时时间，取值范围：大于等于500的整数，默认值为10000，单位：ms。传入不在范围内的值抛出错误码。 |
| on | [On](#on9) | 否 | 是 | 监听目标控件的属性要求，默认监听所有控件。 **说明：** 仅支持监听指定属性要求的控件，不支持监听指定On.isBefore、On.isAfter、On.within等相对位置的控件。 |
...
| windowChangeType22+ | [WindowChangeType](#windowchangetype22) | 是 | 是 | 窗口变化事件类型，若非窗口变化事件返回[WindowChangeType](#windowchangetype22).WINDOW_UNDEFINED。 **元服务API：** 从API version 22开始，该接口支持在元服务中使用。 |
| componentEventType22+ | [ComponentEventType](#componenteventtype22) | 是 | 是 | 控件操作事件类型，若非控件操作事件返回[ComponentEventType](#componenteventtype22).COMPONENT_UNDEFINED。 **元服务API：** 从API version 22开始，该接口支持在元服务中使用。 |
...
| componentRect22+ | [Rect](#rect9) | 是 | 是 | 控件边框信息，若非控件操作事件则返回属性值均为0的[Rect](#rect9)对象。 **元服务API：** 从API version 22开始，该接口支持在元服务中使用。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| key1 | number | 否 | 是 | 操作时注入的第一个按键值，取值范围：[KeyCode键码值](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-keycode#keycode)。未设置时不注入按键事件。 |
| key2 | number | 否 | 是 | 操作时注入的第二个按键值，取值范围：[KeyCode键码值](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-keycode#keycode)。未设置时不注入按键事件。 **说明：** 仅设置key2而不设置key1时，将抛出17000007参数校验失败的错误。 |
...
![](./img/note_3.0-zh-cn.png) 如果控件的无障碍属性[accessibilityLevel](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-accessibility#accessibilitylevel)设置为'no'或'no-hide-descendants'，无法使用本接口指定目标控件的文本属性用于查找控件，可以使用[On.originalText()](#originaltext20)接口实现。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| b | boolean | 否 | 指定控件可滑动状态。true：可滑动。false：不可滑动。默认为true。可以借助[DevEco Testing](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/deveco-testing)中UiViewer获取控件节点属性。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| b | boolean | 否 | 指定控件获焦状态。true：获焦。false：未获焦。默认为true。可以借助[DevEco Testing](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/deveco-testing)中UiViewer获取控件节点属性。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| com | [Component](#component9) | 是 | 特征控件。 可以借助[DevEco Testing](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/deveco-testing)中UiViewer获取控件树，以判断控件间位置关系。 |
...
![](./img/note_3.0-zh-cn.png) 如果控件的无障碍属性[accessibilityLevel](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-accessibility#accessibilitylevel)设置为'no'或'no-hide-descendants'，可以使用本接口指定目标控件的文本属性用于查找控件，使用[On.text()](#text9)接口不生效。
...
![](./img/note_3.0-zh-cn.png) 如果控件的无障碍属性[accessibilityLevel](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-accessibility#accessibilitylevel)设置为'no'或'no-hide-descendants'，无法使用本接口获取控件的文本信息，可以使用[Component.getOriginalText()](#getoriginaltext20)获取控件的文本信息。
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回控件对象所占区域的中心点信息。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回控件对象是否可点击。true：可点击。false：不可点击。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回控件对象是否可长按点击。true：可长按点击。false：不可长按点击。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回控件对象被勾选状态。true：被勾选。false：未被勾选。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回控件对象能否被勾选属性。true：可被勾选。false：不可被勾选。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回控件对象是否可滑动。true：可滑动。false：不可滑动。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回控件使能状态。true：使能。false：未使能。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回控件对象获焦状态。true：获焦。false：未获焦。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回控件对象被选中状态。true：被选中。false：未被选中。 |
...
| --- | --- | --- | --- |
| text | string | 是 | 输入的文本信息，当前支持英文、中文和特殊字符。 |
| mode | [InputTextMode](#inputtextmode20) | 是 | 输入文本的方式，取值请参考[InputTextMode](#inputtextmode20)。 **说明：** [InputTextMode](#inputtextmode20).addition取值为true时，在控件已有文本末尾后追加指定文本。取值为false时，指定文本将覆盖控件已有文本。 当输入文本中包含中文、特殊字符或文本长度超过200字符时，无论[InputTextMode](#inputtextmode20).paste取值为何，均以复制粘贴方式输入。 |
...
![](./img/note_3.0-zh-cn.png) 本方法仅支持在主屏幕上模拟点击BACK键。如需在指定屏幕上模拟点击BACK键，请使用[pressBack(displayId: number)](#pressback20)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| keyCode | number | 是 | 指定的键码值，取值范围：[KeyCode键码值](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-keycode#keycode)。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| key0 | number | 是 | 指定的第一个键码值，取值范围：[KeyCode键码值](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-keycode#keycode)。 |
| key1 | number | 是 | 指定的第二个键码值，取值范围：[KeyCode键码值](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-keycode#keycode)。 |
| key2 | number | 否 | 指定的第三个键码值，取值范围：[KeyCode键码值](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-keycode#keycode)，默认值为0。 |
...
| to | [Point](#point9) | 是 | 以[Point](#point9)对象的形式传入终止点的坐标信息和所属屏幕ID。 **说明：** 应与起始点属于同一个屏幕，否则将抛出17000007异常。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回截图操作是否成功完成。true：成功完成，false：未成功完成。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| savePath | string | 是 | JSON文件保存路径。路径需为当前应用的[沙箱路径](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/app-sandbox-directory)。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回布局信息导出和文件存储是否成功完成。true：成功完成。false：未成功完成。 |
...
![](./img/note_3.0-zh-cn.png) 本方法仅支持获取主屏幕的显示方向。如需获取指定屏幕的显示方向，请使用[getDisplayRotation(displayId: number)](#getdisplayrotation20)。
...
![](./img/note_3.0-zh-cn.png) 本方法仅支持获取主屏幕的大小。如需获取指定屏幕的大小，请使用[getDisplaySize(displayId: number)](#getdisplaysize20)。
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回Point对象，当前设备屏幕的大小为Point.x * Point.y。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回Point对象，当前设备指定屏幕的大小为Point.x * Point.y。 |
...
![](./img/note_3.0-zh-cn.png) 本方法仅支持获取主屏幕的分辨率。如需获取指定屏幕的分辨率，请使用[getDisplayDensity(displayId: number)](#getdisplaydensity20)。
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回Point对象，当前设备屏幕的分辨率为Point.x*Point.y。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回Point对象，当前设备指定屏幕的分辨率为Point.x*Point.y。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回当前界面的所有控件是否已经空闲。true：已经空闲，false：不空闲。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回操作是否成功完成。true：成功完成，false：未成功完成。 |
...
| key1 | number | 否 | 指定的第一个键码值，取值范围：[KeyCode键码值](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-keycode#keycode)，默认值为0。 |
| key2 | number | 否 | 指定的第二个键码值，取值范围：[KeyCode键码值](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-keycode#keycode)，默认值为0。 |
...
| btnId | [MouseButton](#mousebutton10) | 是 | 按下的鼠标按钮。 |
| key1 | number | 否 | 指定的第一个键码值，取值范围：[KeyCode键码值](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-keycode#keycode)，默认值0。 |
| key2 | number | 否 | 指定的第二个键码值，取值范围：[KeyCode键码值](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-keycode#keycode)，默认值0。 |
...
| p | [Point](#point9) | 是 | 输入文本的坐标点。 |
| text | string | 是 | 输入的文本信息，当前支持英文、中文和特殊字符。 |
| mode | [InputTextMode](#inputtextmode20) | 是 | 输入文本的方式，取值请参考[InputTextMode](#inputtextmode20)。 **说明：** [InputTextMode](#inputtextmode20).addition取值为true时，将光标移动至文本末尾后输入指定文本。取值为false时，将在坐标点位置输入指定文本。 当输入文本中包含中文、特殊字符或文本长度超过200字符时，无论[InputTextMode](#inputtextmode20).paste取值为何，均以复制粘贴方式输入。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| pointers | [PointerMatrix](#pointermatrix9) | 是 | 滑动轨迹，包括操作手指个数和滑动坐标序列。 **说明**：当前仅支持单指操作，[PointerMatrix](#pointermatrix9)中的操作手指个数fingers必须设置为1。 |
| speed | number | 否 | 滑动速率，取值范围为200-40000的整数，默认值为600，单位：px/s。为不在范围内的非负数或为null/undefined时设为默认值600。为负数时抛出401错误码。 |
...
| options | [PenKeyOperationOptions](#penkeyoperationoptions) | 否 | 操作选项，包括可选的坐标点。默认值继承[PenKeyOperationOptions](#penkeyoperationoptions)各属性默认值。 **说明：** 当参数mode取值为[AIR_MOUSE](#penmode)且key取值为[AIR_MOUSE](#penkey)时，必须在options中设置point属性，否则将抛出17000007错误码。 |
...
![](./img/note_3.0-zh-cn.png) 若设备关闭了指关节手势，则调用本接口返回17000005错误码。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| pointers | Array | 是 | 指关节敲击屏幕坐标点的数组，数组长度取值为1或2。取值不在范围内抛出17000007错误码。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象。返回长按操作期间目标控件是否存在。true：存在；false：不存在。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象。返回拖拽操作期间目标控件是否存在。true：存在。false：不存在。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象。返回滑动操作期间目标控件是否存在。true：存在。false：不存在。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回窗口归属应用的包名信息。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回窗口对象是否获焦。true：获焦。false：未获焦。 |
...
![](./img/note_3.0-zh-cn.png) 从API version 9开始支持，从API version 11开始废弃，建议使用[isActive11+](#isactive11)替代。
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回窗口对象是否为用户正在交互窗口。true表示是交互窗口。false表示非交互窗口。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回窗口对象是否为用户正在交互窗口。true：交互窗口。false：非交互窗口。 |
...
| callback | Callback | 是 | 事件发生时执行的回调函数。 |
...
| callback | Callback | 是 | 事件发生时执行的回调函数，返回事件的相关信息。 |
...
![](./img/note_3.0-zh-cn.png) 从API version 8开始支持，从API version 9开始废弃，建议使用[On9+](#on9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8开始支持，从API version 9开始废弃，建议使用[text9+](#text9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8开始支持，从API version 9开始废弃，建议使用[id9+](#id9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8开始支持，从API version 9开始废弃，建议使用[type9+](#type9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8开始支持，从API version 9开始废弃，建议使用[clickable9+](#clickable9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8开始支持，从API version 9开始废弃，建议使用[scrollable9+](#scrollable9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8开始支持，从API version 9开始废弃，建议使用[enabled9+](#enabled9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8开始支持，从API version 9开始废弃，建议使用[focused9+](#focused9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8开始支持，从API version 9开始废弃，建议使用[selected9+](#selected9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8开始支持，从API version 9开始废弃，建议使用[isBefore9+](#isbefore9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8开始支持，从API version 9开始废弃，建议使用[isAfter9+](#isafter9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8开始支持，从API version 9开始废弃，建议使用[Component9+](#component9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8开始支持，从API version 9开始废弃，建议使用[click9+](#click9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8开始支持，从API version 9开始废弃，建议使用[doubleClick9+](#doubleclick9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8开始支持，从API version 9开始废弃，建议使用[longClick9+](#longclick9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8开始支持，从API version 9开始废弃，建议使用[getId9+](#getid9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8开始支持，从API version 9开始废弃，建议使用[getText9+](#gettext9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8开始支持，从API version 9开始废弃，建议使用[getType9+](#gettype9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8开始支持，从API version 9开始废弃，建议使用[isClickable9+](#isclickable9)替代。
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回控件对象可点击状态。true：可点击。false：不可点击。 |
...
![](./img/note_3.0-zh-cn.png) 从API version 8开始支持，从API version 9开始废弃，建议使用[isScrollable9+](#isscrollable9)替代。
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回控件对象可滑动状态。true：可滑动。false：不可滑动。 |
...
![](./img/note_3.0-zh-cn.png) 从API version 8开始支持，从API version 9开始废弃，建议使用[isEnabled9+](#isenabled9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8开始支持，从API version 9开始废弃，建议使用[isFocused9+](#isfocused9)替代。
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回控件对象是否获焦。true：获焦。false：未获焦。 |
...
![](./img/note_3.0-zh-cn.png) 从API version 8开始支持，从API version 9开始废弃，建议使用[isSelected9+](#isselected9)替代。
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回控件对象被选中的状态。true：被选中。false：未被选中。 |
...
![](./img/note_3.0-zh-cn.png) 从API version 8开始支持，从API version 9开始废弃，建议使用[scrollSearch9+](#scrollsearch9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8开始支持，从API version 9开始废弃，建议使用[Driver9+](#driver9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8开始支持，从API version 9开始废弃，建议使用[create9+](#create9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8开始支持，从API version 9开始废弃，建议使用[delayMs9+](#delayms9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8开始支持，从API version 9开始废弃，建议使用[findComponent9+](#findcomponent9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8开始支持，从API version 9开始废弃，建议使用[findComponents9+](#findcomponents9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8开始支持，从API version 9开始废弃，建议使用[assertComponentExist9+](#assertcomponentexist9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8开始支持，从API version 9开始废弃，建议使用[pressBack9+](#pressback9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8开始支持，从API version 9开始废弃，建议使用[triggerKey9+](#triggerkey9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8开始支持，从API version 9开始废弃，建议使用[swipe9+](#swipe9)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 8开始支持，从API version 9开始废弃，建议使用[screenCap9+](#screencap9)替代。
