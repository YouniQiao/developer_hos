...
content_hash: "50ef18cccd8c"
synced_at: "2026-08-29T18:16:37.382608"
---
...
![](./img/note_3.0-zh-cn.png) 从API version 7开始支持，从API version 9开始废弃，API version 26前建议使用[canIUse("SystemCapability.Communication.NFC.Core")](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/syscap__ndk_8h#caniuse) && nfcController.isNfcAvailable共同判断设备是否支持NFC，从API version 26开始，建议使用[canIUse("SystemCapability.Communication.NFC.Core")](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/syscap__ndk_8h#caniuse) && [nfcController.isNfcSupported](#nfccontrollerisnfcsupported) 替代。
...
![](./img/note_3.0-zh-cn.png) 从 API version 7 开始支持，从 API version 9 开始废弃，建议使用[enableNfc](#nfccontrollerenablenfc9)替代。
...
![](./img/note_3.0-zh-cn.png) 从 API version 7 开始支持，从 API version 9 开始废弃，建议使用[disableNfc](#nfccontrollerdisablenfc9)替代。
...
| callback | Callback | 是 | 回调函数，返回NFC状态的枚举值。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 固定填"nfcStateChange"字符串。 |
| callback | Callback | 否 | NFC状态改变回调函数，可以空缺不填。如果callback不填，将取消注册该事件关联的所有回调函数。 |
