...
synced_at: "2026-06-24T20:52:34.894146"
---
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| url8+ | string | 否 | 否 | 视频媒体URL，支持当前主流的视频格式(mp4、mpeg-ts、mkv)。 **支持路径示例**： 1. fd类型播放：fd://xx ![](./img/zh-cn_image_0000002626231556.png) 2. http网络播放: http://xx 3. https网络播放: https://xx 4. hls网络播放路径：http://xx或者https://xx 5. file类型: file://xx **说明：** 从API version 11开始不支持webm。 |
