...
| callback | AsyncCallback> | 是 | callback返回图片和视频检索结果集。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise> | Promise对象，返回图片和视频数据结果集。 |
...
| callback | AsyncCallback | 是 | callback返回创建的图片和视频的uri。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回创建的图片和视频的uri。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回创建的图片或视频的URL。 |
...
| callback | AsyncCallback> | 是 | callback返回获取相册的结果集。 |
...
| callback | Callback | 是 | 返回要监听的[ChangeData](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-photoaccesshelper-i#changedata)。注：uri可以注册多个不同的callback监听，[unRegisterChange](#unregisterchange)可以关闭该uri所有监听，也可以关闭指定callback的监听。 |
...
| --- | --- | --- | --- |
| uri | string | 是 | PhotoAsset的uri, Album的uri或[DefaultChangeUri](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-photoaccesshelper-e#defaultchangeuri)的值。 |
| callback | Callback | 否 | 取消[registerChange](#registerchange)注册时的callback的监听，不填时，取消该uri的所有监听。注：off指定注册的callback后不会进入此回调。 |
...
![](./img/note_3.0-zh-cn.png) 当传入URI为沙箱路径时，可正常保存图片/视频，但无界面预览。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| srcFileUris | Array | 是 | 需保存到媒体库中的图片/视频文件对应的[媒体文件URI](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/user-file-uri-intro#媒体文件uri)。 **注意：** - 一次弹窗最多保存100张图片。 - 仅支持处理图片、视频URI。 - 不支持手动拼接的URI，需调用接口获取，获取方式参考[媒体文件URI获取方式](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/user-file-uri-intro#媒体文件uri获取方式)。 |
| photoCreationConfigs | Array | 是 | 保存图片或视频到媒体库的配置，包括文件名等，与srcFileUris保持一一对应。 **注意：** 传入'subtype'选项，配置项不生效，仅支持保存DEFAULT类型图片。 |

返回值：

| 类型 | 说明 |
| --- | --- |
| Promise> | Promise对象，返回给应用的媒体库文件URI列表。URI已对应用授权，支持应用写入数据。如果生成URI异常，则返回批量创建错误码。 具体返回值情况如下： - 返回-3006表示不允许出现非法字符。 - 返回-2004表示图片类型和后缀不符。 - 返回-203表示文件操作异常。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| srcFileUris | Array | 是 | 需保存到媒体库中的图片或视频文件对应的[媒体文件URI](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/user-file-uri-intro#媒体文件uri)。 **注意：** - 一次弹窗最多保存100张图片。 - 仅支持处理图片和视频URI。 - 不支持手动拼接URI，需调用接口获取，具体请参考[媒体文件URI获取方式](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/user-file-uri-intro#媒体文件uri获取方式)。 |
| creationSettings | Array | 是 | 保存图片或视频到媒体库的配置，包括文件名等，与srcFileUris参数中的URI保持一一对应。 |

返回值：

| 类型 | 说明 |
| --- | --- |
| Promise> | Promise对象，返回给应用的媒体库文件URI列表。支持应用使用返回的URI写入数据。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回给应用的媒体库文件URI。URI已对应用授权，支持应用写入数据。如果生成URI异常，则返回批量创建错误码。 具体返回值情况如下： - 返回-3006表示不允许出现非法字符。 - 返回-2004表示图片类型和后缀不符。 - 返回-203表示文件操作异常。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回给应用的媒体库文件uri。uri已对应用授权，支持应用写入数据。如果生成uri异常，则返回批量创建错误码。 返回-3006表示不允许出现非法字符；返回-2004表示图片类型和后缀不符；返回-203表示文件操作异常。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回给应用的媒体库文件URI。支持应用使用返回的URI写入数据。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| srcFileUris | Array | 是 | 需进行授权的图片/视频文件对应的[媒体文件URI](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/user-file-uri-intro#媒体文件uri)。 **注意：** 仅支持处理图片、视频URI，且最大数量限制为100个。 |

返回值：

| 类型 | 说明 |
| --- | --- |
| Promise> | Promise对象，返回已授权的URI列表。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| srcFileUris | Array | 是 | 需进行授权的图片/视频文件对应的[媒体库uri](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/user-file-uri-intro#媒体文件uri)。 **注意：** 仅支持处理图片、视频uri，且最大数量限制为100个。 |

返回值：

| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回已授权的uri列表和无效的uri列表。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise> | Promise对象，返回支持的图片或者视频后缀列表。 |
...
| callback | Callback | 是 | 返回变更的媒体资产信息[PhotoAssetChangeInfos](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-photoaccesshelper-i#photoassetchangeinfos20)。 **注意：** 该接口可以注册多个不同的callback监听，[off('photoChange')](#offphotochange20)既可以关闭所有监听，也可以关闭指定callback监听。 |
...
| callback | Callback | 否 | 取消[on('photoChange')](#onphotochange20)注册时指定的callback监听；不填时，则取消对'photoChange'的所有监听。 **注意：** 取消注册的callback后，有资产发生变化时，不会进入此回调。 |
...
| callback | Callback | 是 | 返回变更的相册信息[AlbumChangeInfos](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-photoaccesshelper-i#albumchangeinfos20)。 **注意：** 该接口可以注册多个不同的callback监听，[off('photoAlbumChange')](#offphotoalbumchange20)既可以关闭所有监听，也可以关闭指定callback监听。 |
...
| callback | Callback | 否 | 取消[on('photoAlbumChange')](#onphotoalbumchange20)注册时指定的callback监听；不填时，则取消对'photoAlbumChange'的所有监听。 **注意：** 取消注册的callback后，有相册发生变化时，不会进入此回调。 |
...
![](./img/note_3.0-zh-cn.png) 从API version 10开始支持，从API version 11开始废弃。建议使用[MediaAssetChangeRequest.deleteAssets](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-photoaccesshelper-mediaassetchangerequest#deleteassets11-1)替代。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| uriList | Array | 是 | 待删除的媒体文件uri数组，最大删除数量300。 |
| callback | AsyncCallback | 是 | callback返回void。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回相册lpath对应的媒体库相册的ID。 |
...
| callback | Callback | 是 | 返回变更的媒体资产信息[PhotoAssetChangeInfos](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-photoaccesshelper-i#photoassetchangeinfos20)。 **注意：** 该接口可以注册多个不同的callback监听。 |
...
| callback | Callback | 否 | 用于取消订阅的回调。不携带时，取消asset参数下所有callback。 |
...
| callback | Callback | 是 | 返回变更的媒体相册信息[PhotoAssetChangeInfos](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-photoaccesshelper-i#photoassetchangeinfos20)。 **注意：** 该接口可以注册多个不同的callback监听。 |
...
| callback | Callback | 否 | 用于取消订阅的回调。不携带时，取消album参数下所有callback。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise> | Promise对象，返回URI与MediaAssetPermissionState的键值对集合。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback | 是 | 回调函数，返回媒体库可用性信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback | 否 | 回调函数，返回取消[onMediaLibraryAvailability](#onmedialibraryavailability)注册时指定的callback监听。不填时，则取消对媒体库可用性变化的所有监听。 |
