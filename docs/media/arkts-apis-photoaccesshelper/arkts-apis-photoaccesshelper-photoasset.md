...
synced_at: "2026-06-24T20:52:45.120408"
---
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback | 是 | 回调函数。当修改文件元数据成功，err为undefined，否则为错误对象。 |
...
![](./img/note_3.0-zh-cn.png) 从API version 10开始支持，从API version 11开始废弃，建议使用[fileIo.close](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fileioclose-1)替代。
...
| --- | --- | --- | --- |
| fd | number | 是 | 文件描述符。 |
| callback | AsyncCallback | 是 | 回调函数。当关闭当前文件成功，err为undefined，否则为错误对象。 |
...
![](./img/note_3.0-zh-cn.png) 从API version 10开始支持，从API version 11开始废弃，建议使用[fileIo.close](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fileioclose)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 10开始支持，从API version 11开始废弃，建议使用[fileIo.open](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fileioopen-1)替代。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback | 是 | 回调函数。当打开当前文件成功，err为undefined，data为文件描述符；否则为错误对象。 |
...
![](./img/note_3.0-zh-cn.png) 从API version 10开始支持，从API version 11开始废弃，建议使用[fileIo.open](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fileioopen)替代。
