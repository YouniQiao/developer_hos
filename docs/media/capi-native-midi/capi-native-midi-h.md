...
synced_at: "2026-06-24T20:51:57.091108"
---
...
![](./img/note_3.0-zh-cn.png) 如果蓝牙权限被拒绝，[OH_MIDIClient_OnDeviceOpened](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-native-midi-base-h#oh_midiclient_ondeviceopened)回调将以opened参数为false、device参数为null被调用。应用应检查opened参数后再尝试使用设备句柄。
