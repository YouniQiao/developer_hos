...
| [OH_AVErrCode OH_AVPlayer_Play(OH_AVPlayer *player)](#oh_avplayer_play) | - | 开始播放。 此函数必须在[OH_AVPlayer_Prepare](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-avplayer-h#oh_avplayer_prepare)之后调用。 如果播放器状态为，调用此函数开始播放。 |
