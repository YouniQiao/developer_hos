...
format: md
title: "三方SDK定制修改部分源码"
original_url: /docs/FAQ/faqs-deveco-studio/faqs-compiling-and-building/faqs-compiling-and-building-192
upstream_id: FAQ/faqs-deveco-studio/faqs-compiling-and-building/faqs-compiling-and-building-192
...
提供SDK（即[字节码HAR](/docs/tools/coding-debug/ide-hvigor-build-har#section16598338112415)包），并提供待修改部分的源码文件。
...
3. 如果工程中存在其他模块引用了提供方SDK，则需要在工程级别oh-package.json5文件中配置[overrides选项](/docs/tools/ohpm/ide-oh-package-json5#zh-cn_topic_0000001792256137_overrides)，改成本地依赖方式。
