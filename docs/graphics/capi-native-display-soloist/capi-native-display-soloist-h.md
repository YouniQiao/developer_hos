...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [DisplaySoloist_ExpectedRateRange](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-nativedisplaysoloist-displaysoloist-expectedraterange) | DisplaySoloist_ExpectedRateRange | 提供期望帧率范围结构体。 |
