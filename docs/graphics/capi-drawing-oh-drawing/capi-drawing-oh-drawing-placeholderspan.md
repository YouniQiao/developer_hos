...
| double width | 占位符宽度。 |
| double height | 占位符高度。 |
| [OH_Drawing_PlaceholderVerticalAlignment](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-drawing-text-typography-h#oh_drawing_placeholderverticalalignment) alignment | 占位符对齐方式。 |
| [OH_Drawing_TextBaseline](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-drawing-text-typography-h#oh_drawing_textbaseline) baseline | 占位符基线。 |
