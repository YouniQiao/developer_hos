...
| 参数项 | 描述 |
| --- | --- |
| [OH_Drawing_FontCollection](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-drawing-oh-drawing-fontcollection)* fontCollection | 指向字体集对象的指针。 |
