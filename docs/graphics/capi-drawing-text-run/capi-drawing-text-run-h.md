...
| 类型 | 说明 |
| --- | --- |
| [OH_Drawing_Array](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-drawing-oh-drawing-array)* | 返回字形的字符索引数组，不再需要[OH_Drawing_Array](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-drawing-oh-drawing-array)时，请使用[OH_Drawing_DestroyRunStringIndices](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-drawing-text-run-h#oh_drawing_destroyrunstringindices)接口释放该对象的指针。 |

#### [h2]OH_Drawing_GetRunStringIndicesByIndex()
...
#### [h2]OH_Drawing_DestroyRunStringIndices()
...
#### [h2]OH_Drawing_GetRunStringRange()
...
| 类型 | 说明 |
| --- | --- |
| [OH_Drawing_Rect](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-drawing-oh-drawing-rect)* | 返回指向渲染单元图像边界[OH_Drawing_Rect](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-drawing-oh-drawing-rect)对象的指针，不再需要[OH_Drawing_Rect](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-drawing-oh-drawing-rect)时，请使用[OH_Drawing_DestroyRunImageBounds](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-drawing-text-run-h#oh_drawing_destroyrunimagebounds)接口释放该对象的指针。 |

#### [h2]OH_Drawing_DestroyRunImageBounds()
...
| 参数项 | 描述 |
| --- | --- |
| [OH_Drawing_Rect](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-drawing-oh-drawing-rect)* rect | 指向渲染单元图像边界[OH_Drawing_Rect](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-drawing-oh-drawing-rect)对象的指针。 |

#### [h2]OH_Drawing_GetRunGlyphs()
...
| 类型 | 说明 |
| --- | --- |
| [OH_Drawing_Array](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-drawing-oh-drawing-array)* | 返回指向渲染单元字形数组[OH_Drawing_Array](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-drawing-oh-drawing-array)对象的指针，不再需要[OH_Drawing_Array](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-drawing-oh-drawing-array)时，请使用[OH_Drawing_DestroyRunGlyphs](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-drawing-text-run-h#oh_drawing_destroyrunglyphs)接口释放该对象的指针。 |

#### [h2]OH_Drawing_GetRunGlyphsByIndex()
...
| 类型 | 说明 |
| --- | --- |
| [OH_Drawing_Array](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-drawing-oh-drawing-array)* | 返回指向渲染单元字形位置数组[OH_Drawing_Array](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-drawing-oh-drawing-array)对象的指针，不再需要[OH_Drawing_Array](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-drawing-oh-drawing-array)时，请使用[OH_Drawing_DestroyRunPositions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-drawing-text-run-h#oh_drawing_destroyrunpositions)接口释放该对象的指针。 |

#### [h2]OH_Drawing_GetRunPositionsByIndex()
...
| 类型 | 说明 |
| --- | --- |
| [OH_Drawing_Point](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-drawing-oh-drawing-point)* | 返回指向渲染单元单个字形位置[OH_Drawing_Point](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-drawing-oh-drawing-point)对象的指针。 |

#### [h2]OH_Drawing_DestroyRunPositions()
...
#### [h2]OH_Drawing_GetRunGlyphCount()
...
#### [h2]OH_Drawing_GetRunTextDirection()
...
| 类型 | 说明 |
| --- | --- |
| [OH_Drawing_Array](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-drawing-oh-drawing-array)* | 返回指向渲染单元字形宽度数组[OH_Drawing_Array](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-drawing-oh-drawing-array)对象的指针，不再需要[OH_Drawing_Array](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-drawing-oh-drawing-array)时，请使用[OH_Drawing_DestroyRunGlyphAdvances](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-drawing-text-run-h#oh_drawing_destroyrunglyphadvances)接口释放该对象的指针。 |

#### [h2]OH_Drawing_GetRunGlyphAdvanceByIndex()
...
| 类型 | 说明 |
| --- | --- |
| [OH_Drawing_Point](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-drawing-oh-drawing-point)* | 返回指向渲染单元单个字形宽度[OH_Drawing_Point](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-drawing-oh-drawing-point)对象的指针。其中，[OH_Drawing_Point](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-drawing-oh-drawing-point)对象的x值代表渲染单元单个字形宽度，y值为保留字段，默认返回0。 |

#### [h2]OH_Drawing_DestroyRunGlyphAdvances()
