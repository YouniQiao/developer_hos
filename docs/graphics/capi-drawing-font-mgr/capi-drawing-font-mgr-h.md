...
| 类型 | 说明 |
| --- | --- |
| char* | 返回索引值对应的字体家族名称，不再需要时，请使用[OH_Drawing_FontMgrDestroyFamilyName](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-drawing-font-mgr-h#oh_drawing_fontmgrdestroyfamilyname)释放该对象指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH_Drawing_Typeface](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-drawing-oh-drawing-typeface)* | 返回对应的字型对象[OH_Drawing_Typeface](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-drawing-oh-drawing-typeface)。 |
...
| 类型 | 说明 |
| --- | --- |
| [OH_Drawing_Typeface](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-drawing-oh-drawing-typeface)* | 如果成功，返回对应的字型对象[OH_Drawing_Typeface](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-drawing-oh-drawing-typeface); 如果失败，返回nullptr。 |
