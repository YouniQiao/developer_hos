...
1. 导入[minorsProtection](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/account-api-minorsprotection)模块及相关公共模块。
   ...
   ```
2. 订阅系统未成年人模式开启或关闭事件、获取未成年人模式的开启状态，以及年龄段信息请参考元服务与系统联动切换未成年人模式章节的[开发步骤](/docs/dev/atomic-dev/account-follow-atomic-minorsprotection/account-system-atomic-minorsprotection#开发步骤)。当查询到未成年人模式已关闭或订阅系统未成年人模式关闭事件，需要记录单独关闭的标记为false。
