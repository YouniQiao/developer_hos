...
元服务通过分包页面路由跳转时，系统将动态加载分包，加载完成后启动对应页面。若开发者希望优化分包加载速度，可参照[预加载](https://developer.huawei.com/consumer/cn/doc/atomic-guides/atomic-preparing-for-loading)进行配置。
...
1. 创建Stage模型的元服务：详情请见[元服务工程](https://developer.huawei.com/consumer/cn/doc/atomic-guides/atomic-service-create-project)。
