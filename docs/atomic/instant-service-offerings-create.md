...
| skuAttrs | 否 | JSONObject | SKU属性，详见[SKU属性](https://developer.huawei.com/consumer/cn/doc/atomic-guides/instant-service-offerings-attributes#section168311654415)。 |
