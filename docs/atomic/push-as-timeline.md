...
| --- | --- | --- | --- | --- |
| ![](./img/73209ff0.png "点击放大") | ![](./img/2ddf4813.png "点击放大") | 胶囊状态：  ![](./img/ab81897d.png "点击放大")  悬浮卡片：  ![](./img/b9c40c10.png "点击放大") | ![](./img/3436d777.png "点击放大") | ![](./img/520af920.png "点击放大") |
...
4. 推送服务动态消息，还需同时申请“图片资源托管”子能力（服务动态消息卡片右侧展示的图片）。详情可以查看[表 未命名](#table489064954413)中的效果图。
