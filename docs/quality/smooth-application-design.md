...
<MergedTable
  headers={['一级指标', '二级指标', '推荐指标']}
  rows={[
    [{ text: '完成时延', rowSpan: 5 }, '控件响应完成时延', { text: 't完成时延≤600ms', rowSpan: 2 }],
    ['控件出现完成时延'],
    ['第三方应用启动完成时延', { text: 't完成时延≤1100ms', rowSpan: 2 }],
    ['第三方应用页面切换完成时延'],
...
<MergedTable
  headers={['一级指标', '二级指标', '启动方式', '示例任务']}
  rows={[
    [{ text: '完成时延', rowSpan: 4 }, '第三方应用启动', '冷启动', '社交软件启动、支付软件启动等'],
...
<MergedTable
  headers={['一级指标', '二级指标', '推荐指标']}
  rows={[
    [{ text: '点击响应时延', rowSpan: 3 }, '应用启动响应时延', { text: 't响应时延≤100ms', rowSpan: 3 }],
    ['页面切换响应时延'],
    ['控件出现响应时延'],
    [{ text: '滑动响应时延', rowSpan: 2 }, '抛滑响应时延', 't响应时延≤80ms'],
    ['拖滑响应时延', 't响应时延≤60ms']
  ]}
/>
...
<MergedTable
  headers={['一级指标', '二级指标', '启动方式', '示例任务']}
  rows={[
    [{ text: '点击响应时延', rowSpan: 3 }, '应用启动响应时延', '冷启动', '三方应用启动'],
    ['页面切换响应时延', '首次启动', '三方应用页面跳转'],
    ['控件出现响应时延', '首次启动', '短消息对话内输入法键盘弹出'],
    [{ text: '滑动响应时延', rowSpan: 2 }, '抛滑', '首次启动', '列表上下抛滑'],
    ['拖滑', '首次启动', '列表上下拖滑']
  ]}
/>
