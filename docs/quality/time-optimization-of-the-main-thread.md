---
title: "主线程耗时操作优化"
source_url: https://developer.huawei.com/consumer/cn/doc/best-practices/bpta-time-optimization-of-the-main-thread
---
...
![](./img/072dd489.png "点击放大")

**图3** 案例二onWillScroll事件回调耗时
![](./img/9a6284ad.png "点击放大")

* 帧率对比

**图4** onWillScroll执行耗时操作的丢帧率
![](./img/3128af35.png "点击放大")

**图5** onWillScroll不执行耗时操作的丢帧率
![](./img/0dffb16d.png "点击放大")

**图6** 首帧Trace详细信息
![](./img/b0847c6d.png "点击放大")
...
![](./img/43b9f97f.png "点击放大")

**图8** 正例滑动时单个aboutToReuse耗时
![](./img/f3bd1b1d.png "点击放大")
...
**图11** 通过资源对象获取数据的耗时
![](./img/1c4b33b8.png "点击放大")

**图12** 通过资源id获取数据的耗时
![](./img/b2d03556.png "点击放大")
...
<SourceLink name="主线程耗时操作优化指导" url="https://gitcode.com/harmonyos_samples/BestPracticeSnippets/tree/master/AvoidTimeComsume" />
