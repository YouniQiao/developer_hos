...
original_url: https://developer.huawei.com/consumer/cn/doc/best-practices/bpta-stability-ide-static-detection
format: md
---
...
单击![](./img/04ee2260.png)图标，查看可修复的代码规则，点击![](./img/7f5aa491.png)代码修复图标，可以一键式批量修复告警，并刷新检查结果。

![](./img/e1b3f54f.png)屏蔽告警信息：

* 在某些特殊场景下，若扫描结果中出现误报，点击单条告警结果后的![](./img/16baaf37.png)Ignore图标，可以忽略对告警所在行的code linter检查；或勾选文件名称或多条待屏蔽的告警，点击左侧工具面板Ignore图标批量执行操作；
...
导出检查结果：点击工具面板左侧![](./img/621c75e1.png)导出按钮，即可导出检查结果到excel文件，包含告警所在行，告警明细，告警级别等信息。
