...
```
<div class="source-link-wrapper"><a class="source-link" href="https://gitcode.com/HarmonyOS_Samples/BestPracticeSnippets/blob/master/TaskPoolPractice/entry/src/main/ets/pages/sample7/LightArt.ets#L16-L80">LightArt.ets</a></div>
...
1. 抽取网络库相关配置并封装为一个Sendable类。
   ...
   ```
<div class="source-link-wrapper"><a class="source-link" href="https://gitcode.com/HarmonyOS_Samples/BestPracticeSnippets/blob/master/TaskPoolPractice/entry/src/main/ets/pages/sample7/AxiosConfig.ets#L16-L72">AxiosConfig.ets</a></div>
...
2. 结合配置类生成Axios对象。
   ...
   ```
<div class="source-link-wrapper"><a class="source-link" href="https://gitcode.com/HarmonyOS_Samples/BestPracticeSnippets/blob/master/TaskPoolPractice/entry/src/main/ets/pages/sample7/AxiosAdapter.ets#L16-L51">AxiosAdapter.ets</a></div>
...
3. 对相关类进行Sendable改造。
   ...
   ```
<div class="source-link-wrapper"><a class="source-link" href="https://gitcode.com/HarmonyOS_Samples/BestPracticeSnippets/blob/master/TaskPoolPractice/entry/src/main/ets/pages/sample7/Interceptor.ets#L16-L42">Interceptor.ets</a></div>
...
4. 在子线程中执行相关逻辑。
   ...
   ```
<div class="source-link-wrapper"><a class="source-link" href="https://gitcode.com/HarmonyOS_Samples/BestPracticeSnippets/blob/master/TaskPoolPractice/entry/src/main/ets/pages/sample7/Sample7.ets#L16-L77">Sample7.ets</a></div>
