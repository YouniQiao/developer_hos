---
title: "地址越界检测能力概述"
original_url: https://developer.huawei.com/consumer/cn/doc/best-practices/bpta-stability-address-sanitizer-overview
format: md
---
...
| **优势** | 检测能力较强，覆盖类型多。 | 1. 与ASan相比，HWASan无需安全区来检测buffer overflow，这不仅显著减少了工具对内存的消耗，还避免了ASan中某些overflow无法检测的问题。 2. HWASan也不需要隔离区来检测UseAfterFree，因此不会出现ASan中某些UseAfterFree检测不到的情况。 3. 对于内存的二次释放free场景，启用HWASan后，无需代码插桩即可进行检测。 4. HWASan还能检测返回后的堆栈使用情况。 | 无需应用适配。 | 1. 无需应用适配。 2. &lt;5%性能影响，很轻量。 |
