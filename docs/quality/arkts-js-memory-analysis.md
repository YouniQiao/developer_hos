---
title: "分析ArkTS/JS内存"
original_url: /docs/quality/arkts-js-memory-analysis
format: md
upstream_id: /docs/quality/arkts-js-memory-analysis
...
DevEco Studio中Profiler Snapshot模板支持采集堆内存快照和对比功能，且每次采集快照前都会触发垃圾回收（GC），操作步骤参考[Snapshot模板基本操作](/docs/tools/coding-debug/ide-snapshot-basic-operations)。
...
录制好的Snapshot如下图4，对象的reference层层展开就是一条引用链。这里建议阅读[ArkTS内存泄漏分析](/docs/tools/coding-debug/ide-arkts-memory-leak-analysis)，文中针对快照中的一些类型作出了说明，对于后续分析有很大帮助。

**图4** **快照对比页面概览**
![](./img/77eb42ed.png "点击放大")
