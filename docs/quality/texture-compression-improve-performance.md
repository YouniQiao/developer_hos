...
![](./img/277c1af8.png "点击放大")

![](./img/d975b60e.png "点击放大")

![](./img/432ccaa4.png "点击放大")
...
* 优化使用前的图片资源：
  ...
  预压缩到实际UI尺寸，包括[使用图像编辑工具压缩](#section16467122642119)、[GIF图片降低分辨率](#section1797994818210)；
...
![](./img/2b5d1c32.gif "点击放大")

**耗时对比**

点击切换示例测试耗时时长，查看压缩前后的图片读取耗时情况。相关数据如下图所示：

![](./img/2b8c825c.png "点击放大")![](./img/b22c760e.png "点击放大")
...
![](./img/400f7cb6.png "点击放大")

![](./img/191e23bd.png "点击放大")
