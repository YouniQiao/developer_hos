...
2. **体检报告导入AppAnalyzer**
   ...
   ![](./img/322f3bc6.png "点击放大")

   点击“导入报告”，即可将Testing测试诊断出的体检文件导入体检工具进行解析。

   ![](./img/c676efc5.png "点击放大")

   ![](./img/9f8302ea.png "点击放大")

   ![](./img/11fdf77a.png "点击放大")
