...
![](./img/fcc64cac.png)往前推6s左右，可以看到在14:40:53.498左右，有一个点击事件发给了scb。

![](./img/57da2560.png)这之间的6s存在大量的scb日志，判断是在进行更新渲染。

![](./img/11f8f0c7.png)

查看对应时间点的trace：

![](./img/276dac82.png)发现scb主线程被占满，非常繁忙。耗时较长的任务是**CustomNodeUpdate SwiperPage**，后续需排查该组件里为何一直在刷新。
