...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6f/v3/0IlfyxYoTjKm5ougbGHdoQ/zh-cn_image_0000002229450445.png?HW-CC-KV=V1&HW-CC-Date=20260529T080656Z&HW-CC-Expire=86400&HW-CC-Sign=18B39D15B6339B2F25EABC90785DC233C537D1125671570D3F6F6E3D59377AB2 "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1c/v3/i546OVrEQZa5VUA_Ndjslg/zh-cn_image_0000002229335969.png?HW-CC-KV=V1&HW-CC-Date=20260529T080656Z&HW-CC-Expire=86400&HW-CC-Sign=6E47ED7838AD8BED9C13B1925CA8C4BE853D77A13809F2805827854E0A2A4D6F)

按照个人数据分类分级规范要求，可将数据分为S1、S2、S3、S4四个安全等级。

<strong>表2</strong> 数据安全等级
...
* el2，用户级加密区：设备开机后，需要至少一次解锁对应用户的锁屏界面（密码、指纹、人脸等方式或无密码状态）后，才能够访问的加密数据区。
  ...
  应用如无特殊需要，应将数据存放在el2加密目录下，以尽可能保证数据安全。但是对于某些场景，一些应用文件需要在用户解锁前就可被访问，例如时钟、闹铃、壁纸等，此时应用需要将这些文件存放到设备级加密区（el1）。切换应用文件加密类型目录的方法请参见[获取和修改加密分区](/docs/dev/app-dev/application-framework/ability-kit/stage-model-development/stage-model-application-components/application-context-stage#获取和修改加密分区)。

应用文件目录的详细介绍请参考[应用文件目录与应用文件路径](/docs/dev/app-dev/application-framework/core-file-kit/app-file/app-sandbox-directory#应用文件目录与应用文件路径)。
...
使用数据加密算法实现数据加密请参考[Universal Keystore Kit简介](/docs/dev/app-dev/system/system-security/huks-kit/huks-overview)。
...
<strong>图1</strong> 场景设计图
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f3/v3/hcNvHNWNRgK4cr9yFqYOrw/zh-cn_image_0000002193850580.png?HW-CC-KV=V1&HW-CC-Date=20260529T080656Z&HW-CC-Expire=86400&HW-CC-Sign=637FA89CA4920F4D4E0DAB5D157ED0E701D4BB65E63C95424A34EDC4B6C382AF "点击放大")
