---
title: "应用隐私保护"
source_url: https://developer.huawei.com/consumer/cn/doc/best-practices/bpta-app-privacy-protection
format: md
---
...
| target API level | <strong>申请位置权限</strong> | 申请结果 | 位置的精确度 |
| --- | --- | --- | --- |
