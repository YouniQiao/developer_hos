...
![](./img/app-privacy-protection/app-privacy-protection-01.png "点击放大")
...
![](./img/app-privacy-protection/app-privacy-protection-02.png "点击放大")
...
```
   ...
   [module.json5](https://gitcode.com/harmonyos_samples/BestPracticeSnippets/blob/master/AppPrivacyProtection/entry/src/main/module.json5#L2-L82)
2. 在需要使用位置信息的代码块中，动态申请 ohos.permission.APPROXIMATELY_LOCATION权限。
...
![](./img/app-privacy-protection/app-privacy-protection-03.png "点击放大")
...
[应用数据安全](https://developer.huawei.com/consumer/cn/doc/best-practices/bpta-app-data-security "应用数据安全")