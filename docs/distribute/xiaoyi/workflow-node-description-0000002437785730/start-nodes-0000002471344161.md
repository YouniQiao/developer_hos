...
3、EVENT\_INPUT：接收触发智能体的事件消息，在动态快捷指令（详解参考[动态快捷指令](https://developer.huawei.com/consumer/cn/doc/service/quick-instructions-0000002471344125#section114821593712)），或Webhook事件触发器执行工作流任务时使用（详解参考[触发器](https://developer.huawei.com/consumer/cn/doc/service/trigger-webhook-0000002525203283)）。
