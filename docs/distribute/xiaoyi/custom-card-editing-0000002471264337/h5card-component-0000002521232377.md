...
| <strong>邮件内容</strong> | 申请目的：创建H5卡片；  账号基本信息：[填入注册账号时使用的手机号或邮箱]；  域名：[卡片上需要展示的页面的域名]；  意图框架调试ID：[按照[文档教程](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/intents-appendix-a-get-uid)获取到的uid]。 |
