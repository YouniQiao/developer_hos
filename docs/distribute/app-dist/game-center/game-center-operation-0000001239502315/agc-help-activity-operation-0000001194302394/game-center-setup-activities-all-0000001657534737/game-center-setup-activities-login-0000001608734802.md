...
![](./img/1519208362dd.png)

## 接入流程

![](./img/289488a056ad.png "点击放大")
...
2. 新增奖品。
   ...
   ![](./img/234eacfa2494.png)

3. 填写奖品信息，完成后点击右上角“提交”提交审核。

   ![](./img/7ab605ed54f2.png)
...
2. 新建活动。
   ...
   ![](./img/1cd10ad24847.png)
3. 配置活动规则。

   ![](./img/86eb79ea78c7.jpg)
4. 下滑页面至“活动奖品配置”区域配置活动奖品（若“活动形式”选择“无奖品H5”无需配置，不展示该内容）。

   ![](./img/82cf7d302fb2.png)
5. 配置活动落地页及其它信息。

   ![](./img/a7d8fa532838.png)
6. 审核与上架。

   点击页面右上角“提交审核”提交审核后，华为工作人员审核活动申请预计需要1~3个工作日，请耐心等待。审核结果可在状态栏查看。

   ![](./img/65ed29d0f0ff.png)

   ![](./img/9323a744380f.png)
