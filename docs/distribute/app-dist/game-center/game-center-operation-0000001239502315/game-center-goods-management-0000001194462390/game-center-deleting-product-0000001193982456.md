...
format: md
upstream_id: distribute/app-dist/game-center/game-center-operation-0000001239502315/game-center-goods-management-0000001194462390/game-center-deleting-product-0000001193982456
...
4. 在商品列表中，点击待删除商品对应“操作”列下的“编辑”。
   ...
   ![](./img/5c3383be3641.png)
5. 点击“编辑商品”页面右上角的“删除商品”。

   ![](./img/1fb3fcbbd34f.png)

6. 在弹框中，点击“确认”。

   ![](./img/b82c6b92cfd8.png)
...
4. 点击页面右上角![](./img/82162b78863e.png)下拉选项中“还原商品”。
   ...
   ![](./img/dd1e034d32bb.png)
5. 在查询框中输入商品ID或商品标题，点击“确定”进行查询。

   ![](./img/1eaa7248ba23.png)
6. 点击待还原商品“操作”列的“还原”，即可成功还原该商品。

   ![](./img/614bff6042b6.png "点击放大")