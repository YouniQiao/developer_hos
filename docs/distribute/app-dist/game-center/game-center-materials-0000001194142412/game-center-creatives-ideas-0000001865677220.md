...
在玩魔方创意是为[在玩服务](https://developer.huawei.com/consumer/cn/doc/app/game-center-playing-operation-0000001870290961)提供的在线制作、轻松上手、简单轻量的设计网站。该网站支持一键预览，支持复杂的交互或跳转，您可以自由搭配组件，一键复用优质内容，轻松设计在玩的可视化H5落地页。

## 编辑器界面

![](./img/ffa924e3341c.jpg)
...
1. 跳转至“魔方创意”网站后，请在自动弹出的“创建页面”窗口中选择页面：
   ...
   * 您可以使用空白页面。
   ...
   ![](./img/ba6a8ba2a579.png)
2. 根据需求使用网站组件并设置对应的组件属性，点击“保存”随时保存已完成的页面设计。

   ![](./img/c307c3ef947b.png)

## 预览H5页面

页面编辑过程中可点击顶部菜单导航“预览”对页面效果进行预览，魔方创意提供多种方式预览：

* 您可以点击 ![](./img/a4119eba2427.png) 或 ![](./img/cc835801c870.png) 直接查看手机模拟器中的展示效果。
* 您可以复制一键生成的链接，前往移动端查看展示效果。
* 您可以直接扫描二维码查看展示效果。

  ![](./img/9d42c1074aba.png)

## 提交审核

完成页面所有编辑或修改操作，对页面样式满意后，保存内容，然后需返回原来的[AGC在玩配置](https://developer.huawei.com/consumer/cn/doc/app/game-center-playing-operation-0000001870290961#ZH-CN_TOPIC_0000001870290961__li2237119133517)页面，对在玩头图和H5页面进行提交，最终客户端呈现的tab页样式会是头图+H5页面拼接的效果。
...
* 组件介绍
  ...
  ![](./img/293a6bdc6a55.png)

  当版本更新时可以使用，展示最新资讯。

* 组件配置

  ![](./img/8485320ffe04.png)
...
* 组件介绍
  ...
  ![](./img/3cdcbeaca62d.png)

  可配置多个图标，默认4个，只能在3~5个之间。

* 组件配置

  ![](./img/a6f9158bb277.png)
...
* 组件介绍
  ...
  ![](./img/cd7d275b4b4d.png)

  该组件可平铺展示多个内容。

* 组件配置

  ![](./img/5586e1ae02db.png)
...
* 组件介绍
  ...
  ![](./img/3d25b8f3fb9a.png)

  页签容器可配置多个页签图标。必须与内容平铺搭配使用。

* 组件配置

  ![](./img/969cb3687a22.png)
  ...
  ![](./img/36bb814a79cf.png)

  多个页签需点击对应页签分别配置关联内容平铺组件。

  ![](./img/5618de2ed224.png)

  ![](./img/2c0cc024060a.png)
...
* 组件介绍
  ...
  ![](./img/f98b2e0be7e6.png)

  瀑布流是由多个单卡片组成的竖滑组件，每个卡片承载一个内容，放置在页面底部。

* 组件配置

  ![](./img/a7980f6132dc.png)
