...
[处理退款](`https://developer.huawei.com/consumer/cn/doc/app/refund-management-0000002084083100#section2066554763917`)有两种方式：
...
1. 通过系统设置找到应用订单后申请退款，请参考[用户申请退款操作指引](`https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/iap-refund#section435204014114`)。
2. 在您的应用[集成应用内接入退款入口](`https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/iap-refund#section13850184720182`) ，方便用户可直接在应用内申请退款
