...
![](../img/agc-help-anaiyze-app-usage-0000002236492392_0.png)
...
2. 从列表中选择您的应用，点击“分发分析 > 下载安装”。
   ...
   ![](../img/agc-help-anaiyze-app-usage-0000002236492392_1.png)

   * 点击“展示依据”，选择“应用版本”、“机型”、“国家/地区”、“省份”、“城市”，下方列表将展示对应维度的详细报表数据。
   * 在“添加过滤器”中：
     + 点击“国家/地区”，可选择不同国家或地区查看对应的数据。

       ![](../img/agc-help-anaiyze-app-usage-0000002236492392_2.png)
...
![](../img/agc-help-anaiyze-app-usage-0000002236492392_3.png)
...
2. 从列表中选择您的应用，点击“分发分析 > 游戏新增与留存”。
   ...
   ![](../img/agc-help-anaiyze-app-usage-0000002236492392_4.png)
...
![](../img/agc-help-anaiyze-app-usage-0000002236492392_5.png)
...
* 点击“展示依据”，选择“应用版本”、“机型”、“国家/地区”、“省份”、“城市”，下方列表将展示对应维度的详细报表数据。
  ...
  ![](../img/agc-help-anaiyze-app-usage-0000002236492392_6.png)

  选择“账号维度统计”时，不支持按照“机型”展示数据。
* 在“添加过滤器”中：
  + 点击“国家/地区”，可选择不同国家或地区查看对应的数据。

    ![](../img/agc-help-anaiyze-app-usage-0000002236492392_7.png)

    当您在“选择国家及地区”中勾选“中国”时，支持选择不同省市查看对应的数据。
  + 点击“应用版本”，可选择不同应用版本查看对应的数据。
  + 点击“机型”，可选择不同的设备类型及设备型号查看对应的数据。

    ![](../img/agc-help-anaiyze-app-usage-0000002236492392_8.png)
...
![](../img/agc-help-anaiyze-app-usage-0000002236492392_9.png)
...
* 在“添加过滤器”中：
  + 点击“国家/地区”，可选择不同国家或地区查看对应的数据。
    ...
    ![](../img/agc-help-anaiyze-app-usage-0000002236492392_10.png)
...
![](../img/agc-help-anaiyze-app-usage-0000002236492392_11.png)
...
* 在“添加过滤器”中：
  + 点击“国家/地区”，可选择不同国家或地区查看对应的数据。
    ...
    ![](../img/agc-help-anaiyze-app-usage-0000002236492392_12.png)
...
1. 在[AppGallery Connect](https://developer.huawei.com/consumer/cn/service/josp/agc/index.html)首页，点击“分析”。
2. 从列表中选择您的应用，点击“分发分析 > 行为分析”。

   “行为分析”报表展示“[启动](#section12707182117231)”、“[访问时长](#section17266181514268)”模块的图表及详细报表数据，帮助您了解应用的使用频次、使用时段、使用时长等，以及评估应用内容对用户的吸引力。

#### [h2]启动

“启动”模块展示“启动次数明细”和“启动时段分布明细”的指标数据。

![](../img/agc-help-anaiyze-app-usage-0000002236492392_13.png)

用户打开应用一次就会上报一次，不涉及打开应用的时长。

![](../img/agc-help-anaiyze-app-usage-0000002236492392_14.png)![](../img/agc-help-anaiyze-app-usage-0000002236492392_15.png)

* “启动次数明细”表示启动应用的次数所对应的启动人数明细，包括启动应用1/2/3/4/5/6/7/8-12/12+次的用户数和百分比数据、启动应用的总次数、人均启动应用的次数。

  ![](../img/agc-help-anaiyze-app-usage-0000002236492392_16.png)

  “1次”列的百分比数据表示：启动应用1次的用户数占启动应用1/2/3/4/5/6/7/8-12/12+次的总用户数的比率。
* “启动时段分布明细”表示时间段内启动次数的分布情况明细，包括每个时间段启动应用的次数和百分比数据。

  ![](../img/agc-help-anaiyze-app-usage-0000002236492392_17.png)

  “[00:00 02:00]”列的百分比数据表示：在[00:00 02:00]时段启动应用的次数占全天24小时启动应用总次数的比率。
* 点击“展示依据”，选择“国家/地区”、“应用版本”、“机型”，下方列表将展示对应维度的详细报表数据，而柱状图表不受该展示依据的影响。
* 在“添加过滤器”中：
  + 点击“国家/地区”，可选择不同国家或地区查看对应的数据。
  + 点击“机型”，可选择不同的设备类型及设备型号查看对应的数据。
  + 点击“应用版本”，可选择不同应用版本查看对应的数据。

* 在右上角选择日期范围。可以选择预定时间段（例如，过去7天）或输入自定义范围，时间跨度不得超过180天。
* 点击图表右上方的“123”或“%”，可以切换图表按照数量或百分比展示。
* 点击表格上方的“下载”，可以将数据下载到本地。

#### [h2]访问时长

“访问时长”模块展示“访问时长明细”的指标数据。

![](../img/agc-help-anaiyze-app-usage-0000002236492392_18.png)

* “访问时长明细”包括应用访问时长在0-3s/4-10s/11-30s/31-60s/1-3min/3-10min/10-30min/30+min内的设备数和百分比数据、访问总时长、人均访问时长。

  ![](../img/agc-help-anaiyze-app-usage-0000002236492392_19.png)

  “0-3s”列的百分比数据表示：应用访问时长在0-3s内的设备数占当天访问应用的总设备数的比率。
