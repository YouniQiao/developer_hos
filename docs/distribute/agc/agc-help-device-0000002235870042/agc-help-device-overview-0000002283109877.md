...
当后续不再使用某个已注册的设备时，您可以[将该设备从列表中删除](https://developer.huawei.com/consumer/cn/doc/app/agc-help-delete-device-0000002248111074)。如设备在添加后一年内被删除，该设备将置灰显示且不再可用，但其仍会占用这一年的设备数量限额。当设备添加的时间满一年后，被删除的设备会自动被清除，同时也不再占用年度的设备数量限额。
