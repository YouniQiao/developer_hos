...
您需要在您的应用程序中编写一段调用[获取Token](/docs/distribute/agc/agc-help-connect-api-0000002236015554/agc-help-connect-api-obtain-server-auth-0000002271134661#section12242154616187)接口的代码来获取Access Token。
...
获取到鉴权通过后的Access Token，您即可以调用对应的设备管理API来完成相应的功能开发，详细的调用方法请参见[API定义](/docs/distribute/agc/agc-help-beacon-regist-by-api-0000002382718889/agc-help-beacon-regist-api-0000002348998430)。
...
Beacon设备准备就绪或采购完成后，您即可调用[同步设备信息](/docs/distribute/agc/agc-help-beacon-regist-by-api-0000002382718889/agc-help-beacon-regist-api-0000002348998430)接口注册一个或多个Beacon信标设备至AGC。
...
信标设备注册完成后，若您需要修改信标设备的某些信息，可以调用[同步设备信息](/docs/distribute/agc/agc-help-beacon-regist-by-api-0000002382718889/agc-help-beacon-regist-api-0000002348998430)接口进行修改，系统根据您传入的locationDeviceId确定要修改的目标信标设备。
