...
![](../img/agc-help-maintain-transfer-0000002236494390_0.png "点击放大")

![](../img/agc-help-maintain-transfer-0000002236494390_1.png)
...
* 当前[In-house应用](/docs/distribute/agc/agc-help-release-0000002235870050/agc-help-inhouse-0000002281532696)不支持转移。
* 当前支持转移的设备类型：手机、平板、PC/2in1、智慧屏、智能手表、运动手表。

* 待转移应用状态不能在审核中，需属于“准备提交”、“待上架”、“已上架”、“待修改”、“已撤销上架”或“被开发者下架”中的一种。
* 若应用开通了HealthServiceKit服务，请先完成转入方开发者资质审核，具体请参见运动健康服务《[应用开发者申请资质说明](/docs/dev/app-dev/application-services/health-service-kit-guide/health-application-qualifications)》。
...
* 若计划转移的应用已接入数字商品服务，请完成以下操作：
  1. 在应用转移完成之前，转入方开发者主体需[签署《华为数字商品及联运服务协议》](/docs/distribute/app-dist/app-services/intermodal-transport-services-0000001933253576/digital-products-0000002005836556/guidance-document-0000001933094208/business-activation-0000001958955081#section104021121114213)，以确保转移后的结算准确无误。
  2. 应用转移完成后，需要登录转入方开发者账号，在[AppGallery Connect](https://developer.huawei.com/consumer/cn/service/josp/agc/index.html#/)的“开发与服务”中选择该转移应用，然后在“应用内购买服务（HarmonyOS NEXT）”菜单页面中重新为该应用[激活开通服务](/docs/distribute/app-dist/app-services/intermodal-transport-services-0000001933253576/digital-products-0000002005836556/guidance-document-0000001933094208/digital-products-serve-0000001931836308/parameters-0000001931995692)。服务开通后，该应用的关键事件通知地址将自动关联转移前的配置。此外，需要在该开发者账号下生成新的[服务端密钥](https://developer.huawei.com/consumer/cn/doc/app/key-management-0000001931836312)，后续发起的服务端API请求应使用新生成的密钥。

#### 操作流程

![](../img/agc-help-maintain-transfer-0000002236494390_2.png)
...
3. 点击页面底部的“应用转移”，系统会自动检测应用是否符合转移条件。
   ...
   ![](../img/agc-help-maintain-transfer-0000002236494390_3.png)

   如果您的应用在转移流程中，则不能再申请应用转移。点击“应用转移”仅用于申请操作，若您想要查看审核情况，请参见“[查看应用转移进度](#section897674113113)”。

   ![](../img/agc-help-maintain-transfer-0000002236494390_4.png)
4. 若应用不符合转移条件，需根据提示进行处理，可参考[前提条件](#section1511853114505)排查原因。

   ![](../img/agc-help-maintain-transfer-0000002236494390_5.png)
5. 若应用符合转移条件，则进入“应用（含游戏）转移申请”页面，填写完成后点击“提交”。
   * 转入者ID：接收应用的开发者账号。
   * 转入者名称：接收应用的开发者名称。

     ![](../img/agc-help-maintain-transfer-0000002236494390_6.png)

     您可以在“[管理中心 > 开发者信息](https://developer.huawei.com/consumer/cn/console/setting/profile)”页面查看转入者的名称。个人开发者应填写“个人基本信息”模块的“真实姓名”，企业开发者应填写“账号持有者信息”模块的“名称”。
   * 转移原因：申请应用转移的原因（最多200字）。
   * 附件：补充应用转移原因的附件（大小在100MB以内的zip格式文件）。

   ![](../img/agc-help-maintain-transfer-0000002236494390_7.png)
...
2. 选择“应用审核”，点击“应用转移接受确认”，在对话界面点击“查看转移申请”。
   ...
   ![](../img/agc-help-maintain-transfer-0000002236494390_8.png)
3. 在弹出的“转入方确认”框中，您可以同意或拒绝接收应用。

   ![](../img/agc-help-maintain-transfer-0000002236494390_9.png)
   * 如果您同意接收应用：
     1. 在“是否接收”处选择“同意”。
     2. 在“版权资质文件”处上传版权和版号资质（大小在100MB以内的zip格式文件）。具体请参见《[应用资质审核要求](/docs/distribute/app-dist/app-market/x50000/x80301)》和《[元服务资质审核要求](/docs/distribute/app-dist/app-market/x50000/x80302)》。

        ![](../img/agc-help-maintain-transfer-0000002236494390_10.png)
   ...
   * 如果您拒绝接收应用：
     ...
     ![](../img/agc-help-maintain-transfer-0000002236494390_11.png)
...
* 当应用转移申请状态处于“审核中”时，如果转入方还未确认接收，转出方可以通过点击“取消转移”来撤回应用转移申请。
  ...
  ![](../img/agc-help-maintain-transfer-0000002236494390_12.png)
* 当应用转移申请状态处于“检测通过”时，表示转入方已经确认接收。
* 当应用转移申请状态处于“资质审核中”时，表示转入方已经提交资质审核。

  ![](../img/agc-help-maintain-transfer-0000002236494390_13.png)
...
![](../img/agc-help-maintain-transfer-0000002236494390_14.png)

#### FAQ

#### [h2]Mac电脑的Safari浏览器阻止打开应用转移页面，如何处理？

**现象描述：**使用Mac电脑进行应用转移，点击“应用转移”按钮时，Safari浏览器会阻止打开应用转移页面。

![](../img/agc-help-maintain-transfer-0000002236494390_15.png)

取消阻止后，打开的应用转移页面没有展示应用相关信息。

![](../img/agc-help-maintain-transfer-0000002236494390_16.png)

**解决方案：**请重新点击“应用转移”按钮，进入应用转移页面；或者更换为Chrome浏览器进行应用转移操作。

#### [h2]应用转移后正在使用的服务/开放能力可以继续使用吗？
...
| 推送服务 | 否，需要重新配置/接入/集成，同时需要开通新项目下的推送服务权益。 |
| Push用户增长 | 否，需要重新配置/接入/集成，同时需要开通新项目下的推送服务权益。 |
| 社区管理 | 是 |
...
1. [In-house账号](/docs/distribute/agc/agc-help-release-0000002235870050/agc-help-inhouse-0000002281532696)无法接收应用。
2. 若您的应用为[非公开发布](/docs/distribute/agc/agc-help-release-0000002235870050/agc-help-non-public-release-0000002278016482)等特殊发布类型，转入方需要提前申请权限，否则无法接收应用。

#### [h2]推广应用转移后，账户仍有余额，如何处理？
