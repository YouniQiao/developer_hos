...
3. 在左侧导航栏选择“应用上架/元服务上架 > 版本历史记录”，进入“版本历史记录”页面，该页面默认展示应用的各个历史版本信息。
   ...
   ![](../img/agc-help-maintain-version-history-0000002236334582_0.png "点击放大")

   * 您可以点击“隐藏详细信息”，隐藏应用软件包的详细信息。

     ![](../img/agc-help-maintain-version-history-0000002236334582_1.png "点击放大")
   * 您可以点击历史版本，查看历史版本相应的信息。

     ![](../img/agc-help-maintain-version-history-0000002236334582_2.png "点击放大")
   * 您可以点击附件链接查看审核附件内容。

     ![](../img/agc-help-maintain-version-history-0000002236334582_3.png "点击放大")
   * 您可以点击右下角的下拉框选择每页展示的版本条数。支持分页展示，且每页最多展示50个版本。

     ![](../img/agc-help-maintain-version-history-0000002236334582_4.png)
