...
3. 在“版本信息”页面的右上角点击“升级”，左侧导航栏新增“新版本 - 准备提交”页面。
   ...
   ![](../img/agc-help-maintain-update-0000002271413697_1.png)

4. 点击左侧导航栏“应用信息”，更新应用详情，完成后点击“下一步”，系统进入“新版本 - 准备提交”页面。

   ![](../img/agc-help-maintain-update-0000002271413697_2.png "点击放大")
...
6. （可选）设置软件包是否加密。
   ...
   * 不加密：用户在客户端安装的软件包为不加密的，应用的启动速率较快。
   ...
   ![](../img/agc-help-maintain-update-0000002271413697_5.png)
...
8. 应用版本信息更新完成后，点击右上角“提交审核”，系统提示当前版本提交软件包versionCode与在架版本versionCode相同，点击“确认”。
   ...
   ![](../img/agc-help-maintain-update-0000002271413697_6.png)
