...
3. 点击右上角的“申请下架”。
   ...
   ![](../img/agc-help-maintain-remove-0000002274058145_2.png)
4. 在弹出对话框中填写下架原因、备注（可选）后，点击“确认”。
   * 分阶段发布（7天内自动更新）版本

     ![](../img/agc-help-maintain-remove-0000002274058145_3.png)

     下架分阶段发布（7天内自动更新）版本的申请审核通过后，将无任何在架版本供用户下载，请您谨慎操作。

     ![](../img/agc-help-maintain-remove-0000002274058145_4.png)
   * 非分阶段发布（7天内自动更新）版本

     ![](../img/agc-help-maintain-remove-0000002274058145_5.png)
5. 针对游戏应用，点击“申请下架”后，在弹出对话框中填写下架原因，并选择是否停服。
   * 如果“是否停服”参数您选择“否”，请输入客服联系方式以及不停服原因，点击“确认”完成游戏下架申请。

     ![](../img/agc-help-maintain-remove-0000002274058145_6.png)
   * 如果“是否停服”参数您选择“是”，请填写下方相关信息，包括关闭服务器时间、发布停服公告时间等。填写完成后，点击“确认”完成游戏下架申请。

     ![](../img/agc-help-maintain-remove-0000002274058145_7.png)
     ...
     ![](../img/agc-help-maintain-remove-0000002274058145_8.png)
6. 应用下架申请提交成功后，应用状态更新为“下架处理中”，华为方会在提交审核后的1-2个工作日内处理。

   ![](../img/agc-help-maintain-remove-0000002274058145_9.png)

   审核通过后，应用状态将变为“被开发者下架”。

   ![](../img/agc-help-maintain-remove-0000002274058145_10.png)
...
1. 在版本信息页面，点击右上方的“催审”。
   ...
   ![](../img/agc-help-maintain-remove-0000002274058145_11.png)
...
1. 在版本信息页面，点击右上方的“撤销下架申请”。
   ...
   ![](../img/agc-help-maintain-remove-0000002274058145_12.png)
2. 在弹出对话框中，点击“确认”。
...
![](../img/agc-help-maintain-remove-0000002274058145_13.png)
...
1. 在版本信息页面，点击右上方的“撤销上架”。
   ...
   ![](../img/agc-help-maintain-remove-0000002274058145_14.png)
2. 在弹出对话框中，点击“确认”。

   ![](../img/agc-help-maintain-remove-0000002274058145_15.png)

   如果撤销上架的应用再次申请上架，需要重新提交审核，请确认后再进行撤销操作。

   ![](../img/agc-help-maintain-remove-0000002274058145_16.png)
3. 撤销上架操作提交成功后，应用状态更新为“已撤销上架”。

   ![](../img/agc-help-maintain-remove-0000002274058145_17.png)

#### 重新上架已撤销上架应用

应用撤销上架后，会进入“已撤销上架”状态。您可以直接在此应用版本基础上编辑、修改，然后点击“提交审核”申请重新上架应用。待审核通过后，应用将重新上架。

![](../img/agc-help-maintain-remove-0000002274058145_18.png)
