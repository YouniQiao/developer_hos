...
下文以“旅游”垂域下的“查看旅游攻略”意图场景为例，意图调用字段定义请参考[查看意图Schema](https://developer.huawei.com/consumer/cn/doc/app/agc-help-confirm-intent-name-beacon-0000002443645837#section1557310291856)附件中的旅游垂类Schema。
