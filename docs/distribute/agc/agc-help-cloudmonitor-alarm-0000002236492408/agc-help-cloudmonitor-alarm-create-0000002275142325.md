...
4. 进入“新建告警”页面，配置告警参数。
   ...
   | 告警级别 | 根据告警的严重程度不同，分为：普通告警、重要告警、严重告警。  选择不同的告警级别，系统将根据相应的告警通知模板发送告警通知。告警通知模板由系统通知模块管理，模板详情请参考[告警通知](https://developer.huawei.com/consumer/cn/doc/app/agc-help-cloudmonitor-alarm-notice-0000002240103334)。 |
