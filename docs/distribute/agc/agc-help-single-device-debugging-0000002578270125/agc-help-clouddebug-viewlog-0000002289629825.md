...
1. 调试设备申请成功后，进入调试页面，点击“HiLog”页签。
   ...
   ![](../img/agc-help-clouddebug-viewlog-0000002289629825_0.png "点击放大")

2. 日志信息可以按照日志类型分为verbose、debug、info、warn、error和assert，您可通过点击日志类型下拉框选择相应的日志类型后，点击“获取日志”。

   ![](../img/agc-help-clouddebug-viewlog-0000002289629825_1.png)

   日志可实时展示500条，下载15000条。

   ![](../img/agc-help-clouddebug-viewlog-0000002289629825_2.png)

   您也可在关键字输入框中输入关键字后，点击“获取日志”。

   ![](../img/agc-help-clouddebug-viewlog-0000002289629825_3.png)
3. （可选）获取到相关日志信息后，您可点击“导出日志”，将获取的日志保存至本地。

   ![](../img/agc-help-clouddebug-viewlog-0000002289629825_4.png)
4. （可选）点击“清空”，即可一键清除已获取的日志。

   ![](../img/agc-help-clouddebug-viewlog-0000002289629825_5.png)
