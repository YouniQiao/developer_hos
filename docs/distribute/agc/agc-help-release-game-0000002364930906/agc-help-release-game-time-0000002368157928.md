---
title: "配置上架时间"
original_url: https://developer.huawei.com/consumer/cn/doc/app/agc-help-release-game-time-0000002368157928
---
...
3. 进入右侧页面的“上架”区域，设置游戏的上架时间：
   ...
   * **指定时间**：选择您的本地时间后，系统将自动转换成UTC标准时间，并显示在时间框后。若后续需要在指定时间前上架，可以[手动发布待上架游戏](#section9890195515586)。
   ...
   ![](../img/agc-help-release-game-time-0000002368157928_0.png)
...
2. 左侧导航栏选择“应用上架 > 版本信息”下待发布的版本，在右侧页面点击右上角的“手动发布”。
   ...
   ![](../img/agc-help-release-game-time-0000002368157928_1.png)
