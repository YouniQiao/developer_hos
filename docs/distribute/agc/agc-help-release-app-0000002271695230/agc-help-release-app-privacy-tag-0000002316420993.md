...
4. 进入“隐私标签信息录入”区域，根据实际情况配置内容。
   ...
   * 如果涉及收集用户的信息数据，“是否涉及个人信息收集”选择“是”，继续配置。
   ...
   ![](../img/agc-help-release-app-privacy-tag-0000002316420993_0.png)
5. 选择业务场景，最多支持同时勾选六种业务场景。

   ![](../img/agc-help-release-app-privacy-tag-0000002316420993_1.png)
...
7. 配置完所有业务场景的数据项后，可到“关联到用户数据汇总”页签查看全部数据。
   ...
   ![](../img/agc-help-release-app-privacy-tag-0000002316420993_4.png)

   每个业务场景下的数据项不能为空，如果存在未配置数据项的业务场景，相应业务场景页签左上角将有红点提示。

   ![](../img/agc-help-release-app-privacy-tag-0000002316420993_5.png)
