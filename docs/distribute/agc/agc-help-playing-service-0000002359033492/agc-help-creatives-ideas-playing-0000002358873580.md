...
format: md
upstream_id: distribute/agc/agc-help-playing-service-0000002359033492/agc-help-creatives-ideas-playing-0000002358873580
...
![](../img/agc-help-creatives-ideas-playing-0000002358873580_0.jpg)
...
1. 跳转至“魔方创意”网站后，请在自动弹出的“创建页面”窗口中选择页面：
   ...
   * 您可以使用空白页面。
   ...
   ![](../img/agc-help-creatives-ideas-playing-0000002358873580_1.png)
2. 根据需求使用网站组件并设置对应的组件属性，点击“保存”随时保存已完成的页面设计。

   ![](../img/agc-help-creatives-ideas-playing-0000002358873580_2.png)

#### 预览H5页面

页面编辑过程中可点击顶部菜单导航“预览”对页面效果进行预览，魔方创意提供多种方式预览：

* 您可以点击 ![](../img/agc-help-creatives-ideas-playing-0000002358873580_3.png) 或 ![](../img/agc-help-creatives-ideas-playing-0000002358873580_4.png) 直接查看手机模拟器中的展示效果。
* 您可以复制一键生成的链接，前往移动端查看展示效果。
* 您可以直接扫描二维码查看展示效果。

  ![](../img/agc-help-creatives-ideas-playing-0000002358873580_5.png)
...
* 组件介绍
  ...
  ![](../img/agc-help-creatives-ideas-playing-0000002358873580_6.png)

  当版本更新时可以使用，展示最新资讯。

* 组件配置

  ![](../img/agc-help-creatives-ideas-playing-0000002358873580_7.png)
...
* 组件介绍
  ...
  ![](../img/agc-help-creatives-ideas-playing-0000002358873580_8.png)

  可配置多个图标，默认4个，只能在3~5个之间。

* 组件配置

  ![](../img/agc-help-creatives-ideas-playing-0000002358873580_9.png)
...
* 组件介绍
  ...
  ![](../img/agc-help-creatives-ideas-playing-0000002358873580_10.png)

  穿插 banner 组件是一种支持配置单个宽型 banner 的组件。穿插 banner 位置较为灵活，可以穿插在组件之间丰富页面样式。

* 组件配置

  ![](../img/agc-help-creatives-ideas-playing-0000002358873580_11.png)
...
* 组件介绍
  ...
  ![](../img/agc-help-creatives-ideas-playing-0000002358873580_12.png)

  该组件可平铺展示多个内容。

* 组件配置

  ![](../img/agc-help-creatives-ideas-playing-0000002358873580_13.png)
...
* 组件介绍
  ...
  ![](../img/agc-help-creatives-ideas-playing-0000002358873580_14.png)

  页签容器可配置多个页签图标。必须与内容平铺搭配使用。

* 组件配置

  ![](../img/agc-help-creatives-ideas-playing-0000002358873580_15.png)
  ...
  ![](../img/agc-help-creatives-ideas-playing-0000002358873580_16.png)

  多个页签需点击对应页签分别配置关联内容平铺组件。

  ![](../img/agc-help-creatives-ideas-playing-0000002358873580_17.png)

  ![](../img/agc-help-creatives-ideas-playing-0000002358873580_18.png)
...
* 组件介绍
  ...
  ![](../img/agc-help-creatives-ideas-playing-0000002358873580_19.png)

  瀑布流是由多个单卡片组成的竖滑组件，每个卡片承载一个内容，放置在页面底部。

* 组件配置

  ![](../img/agc-help-creatives-ideas-playing-0000002358873580_20.png)
