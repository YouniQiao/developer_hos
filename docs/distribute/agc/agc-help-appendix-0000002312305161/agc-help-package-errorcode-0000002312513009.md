---
title: "软件包解析错误码"
original_url: /docs/distribute/agc/agc-help-appendix-0000002312305161/agc-help-package-errorcode-0000002312513009
format: md
upstream_id: distribute/agc/agc-help-appendix-0000002312305161/agc-help-package-errorcode-0000002312513009
last_sync: 2026-06-07
sync_hash: 63efd737
upstream_hash: a0ffc4552c37
---
...
* 如果以上文件中不存在“isDefault”字段，说明未创建默认卡片。在entry上右键选择“New > Service Widget”，补充创建一张默认卡片，具体操作请参见[创建服务卡片](/docs/tools/coding-debug/ide-service-widget)。

#### 错误码：6，表示：软件包无效，缺少预加载模块

出现此错误，原因是软件包缺少预加载模块。请参考[预加载](/docs/dev/atomic-dev/atomic-subpackage-loading/atomic-preparing-for-loading)添加预加载模块后重新打包上传。
...
* 单个包加上其采用dependency方式依赖的[动态共享包（Harmony Shared Package, HSP）](/docs/tools/coding-debug/ide-hsp)，总大小不超过2MB。
...
出现此错误，表示软件包中卡片与快照不符合上述要求，请前往存放快照的EntryCard目录修改后重新打包上传。关于创建元服务卡片的更多信息，请参见[新建元服务卡片](/docs/dev/atomic-dev/develop-first-atomic-service/atomic-service-create-page)。
...
* 原因一：软件包使用的Profile已被删除，即“证书、APP ID和Profile > Profile”页面没有对应应用的Profile。您需要[重新申请发布Profile](/docs/distribute/agc/agc-help-profile-0000002270709473/agc-help-release-profile-0000002248341090)，然后重新打包上传。
...
* 原因三：软件包使用的Profile已失效。
  ...
  2. 如显示“失效”，请点击“操作”列“查看”按钮，查看Profile归属的证书状态。
     + 如果“归属证书状态”栏显示“已删除”，表示证书文件已被删除，导致Profile同步失效。请删除当前失效Profile，申请[新的发布证书](/docs/distribute/agc/agc-help-cert-0000002270829389/agc-help-release-cert-0000002283336729)和[新的发布Profile](/docs/distribute/agc/agc-help-profile-0000002270709473/agc-help-release-profile-0000002248341090)，然后重新打包上传。

       ![](../img/agc-help-package-errorcode-0000002312513009_10.png)
     + 如果“归属证书状态”栏显示“失效”，表示证书文件已失效，导致Profile同步失效。请分别删除已失效的证书和Profile，申请[新的发布证书](/docs/distribute/agc/agc-help-cert-0000002270829389/agc-help-release-cert-0000002283336729)和[新的发布Profile](/docs/distribute/agc/agc-help-profile-0000002270709473/agc-help-release-profile-0000002248341090)，然后重新打包上传。

       ![](../img/agc-help-package-errorcode-0000002312513009_11.png)
* 原因四：软件包使用的是自动签名，请使用[发布Profile](/docs/distribute/agc/agc-help-profile-0000002270709473/agc-help-release-profile-0000002248341090)进行[手动签名](/docs/tools/coding-debug/ide-publish-app#section280162182818)。
...
出现此错误，可能您的软件包使用的是调试证书和调试Profile，正式上架应用市场时，需使用[发布证书](/docs/distribute/agc/agc-help-cert-0000002270829389/agc-help-release-cert-0000002283336729)和[发布Profile](/docs/distribute/agc/agc-help-profile-0000002270709473/agc-help-release-profile-0000002248341090)。请更换正确的证书和Profile后重新上传。
...
4. 申请[新的发布Profile](/docs/distribute/agc/agc-help-profile-0000002270709473/agc-help-release-profile-0000002248341090)。
5. 在DevEco Studio中[配置新的签名信息](/docs/tools/coding-debug/ide-publish-app#section280162182818)，编译新的应用包。
6. 在AGC上传新的软件包。
...
3. 申请[新的发布证书](/docs/distribute/agc/agc-help-cert-0000002270829389/agc-help-release-cert-0000002283336729)和[新的发布Profile](/docs/distribute/agc/agc-help-profile-0000002270709473/agc-help-release-profile-0000002248341090)。
4. 在DevEco Studio中[配置新的签名信息](/docs/tools/coding-debug/ide-publish-app#section280162182818)，编译新的应用包。
5. 在AGC上传新的软件包。
...
* 原因一：软件包使用的证书文件已被删除。
  ...
  请删除当前失效的Profile后，申请[新的发布证书](/docs/distribute/agc/agc-help-cert-0000002270829389/agc-help-release-cert-0000002283336729)和[新的发布Profile](/docs/distribute/agc/agc-help-profile-0000002270709473/agc-help-release-profile-0000002248341090)，然后重新打包上传。
* 原因二：软件包使用的证书文件已被吊销。
  ...
  3. 分别删除当前已吊销的证书和Profile，申请[新的发布证书](/docs/distribute/agc/agc-help-cert-0000002270829389/agc-help-release-cert-0000002283336729)和[新的发布Profile](/docs/distribute/agc/agc-help-profile-0000002270709473/agc-help-release-profile-0000002248341090)，然后重新打包上传。
...
出现此错误，原因是使用了指定设备发布Profile打包。指定设备发布Profile专用于指定设备发布，不支持上架到应用市场。如您需要将软件包上架到应用市场，请使用[发布证书](/docs/distribute/agc/agc-help-cert-0000002270829389/agc-help-release-cert-0000002283336729)和[发布Profile](/docs/distribute/agc/agc-help-profile-0000002270709473/agc-help-release-profile-0000002248341090)打包。如还有疑问，请通过[提交工单](https://developer.huawei.com/consumer/cn/support/feedback/#/)的方式联系华为技术支持解决。
