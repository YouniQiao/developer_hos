...
可通过[应用程序包基础知识](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/application-package-fundamentals)了解相关信息。
...
相关配置可参考[app.json5配置](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/app-configuration-file)。
...
相关配置可参考[module.json5配置](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/module-configuration-file)。
