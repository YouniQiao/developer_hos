...
2. 进入“HarmonyOS”页签，您可通过包名、应用名称、应用类型等信息进行筛选，然后在应用列表中点击您的应用/元服务名称。
   ...
   ![](../img/agc-help-beacon-create-teststate-service-0000002456705197_1.png)
3. 左侧菜单栏选择“近场服务 > 近场管理”，进入近场管理主界面。选择“服务管理”页签，点击“新建”。

   ![](../img/agc-help-beacon-create-teststate-service-0000002456705197_2.png "点击放大")

#### 配置服务基本信息

进入“新建服务”页面，在“基本信息”区域配置服务基本信息。

![](../img/agc-help-beacon-create-teststate-service-0000002456705197_3.png)
...
![](../img/agc-help-beacon-create-teststate-service-0000002456705197_4.png)

* POI列表中仅展示状态为“已激活”且使用场景为“测试”的POI。
* 被其他已上线全网态近场服务使用的POI，不展示在POI待选列表中。

![](../img/agc-help-beacon-create-teststate-service-0000002456705197_5.png)
...
![](../img/agc-help-beacon-create-teststate-service-0000002456705197_6.png)
...
* 模板卡片-图文版（适合信息量少，有1个跳转热区的卡片）
  ...
  ![](../img/agc-help-beacon-create-teststate-service-0000002456705197_7.png)
...
* 模板卡片-单按钮版（适合有1个跳转热区的卡片）
  ...
  ![](../img/agc-help-beacon-create-teststate-service-0000002456705197_9.png)
...
* 预置卡片
  ...
  ![](../img/agc-help-beacon-create-teststate-service-0000002456705197_10.png)
...
* 模板卡片-图文版
  ...
  ![](../img/agc-help-beacon-create-teststate-service-0000002456705197_11.png)
* 模板卡片-双按钮版

  ![](../img/agc-help-beacon-create-teststate-service-0000002456705197_12.png)
* 模板卡片-单按钮版

  ![](../img/agc-help-beacon-create-teststate-service-0000002456705197_13.png)
* 预置卡片

  ![](../img/agc-help-beacon-create-teststate-service-0000002456705197_14.png)

#### [h2]时段设置

默认选择“不启用”，全时段推送服务内容。如果您希望根据用户行为习惯，在指定的时间段内推送服务内容，可以选择“启用”前的单选框以开启定时推送功能。这样，在非指定时间段内，系统将不会向用户推送服务内容，从而避免打扰用户。

![](../img/agc-help-beacon-create-teststate-service-0000002456705197_15.png)
...
![](../img/agc-help-beacon-create-teststate-service-0000002456705197_16.png)

“开放范围”为“测试”的近场服务自更新时间起，若超过90天，将自动下线，且该服务关联的测试任务将被全部删除。

1. 服务配置完成后，点击页面顶部的“提交”。

   ![](../img/agc-help-beacon-create-teststate-service-0000002456705197_17.png)
2. 测试态服务不需要审核，服务状态为“已上线”，点击“前往测试”即可进入近场测试服务界面开始测试。

   ![](../img/agc-help-beacon-create-teststate-service-0000002456705197_18.png)
