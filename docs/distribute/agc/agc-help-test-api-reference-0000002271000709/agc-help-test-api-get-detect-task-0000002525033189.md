...
| versionId | M | String(32) | 测试版本ID。  可从[新建测试版本](/docs/distribute/agc/agc-help-test-api-reference-0000002271000709/agc-help-test-api-add-test-version-0000002236041526#section9752647125217)接口返回的versionId参数中获取。 |
