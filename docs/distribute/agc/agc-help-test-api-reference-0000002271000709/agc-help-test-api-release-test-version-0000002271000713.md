---
title: "更新测试生效版本"
original_url: /docs/distribute/agc/agc-help-test-api-reference-0000002271000709/agc-help-test-api-release-test-version-0000002271000713
format: md
upstream_id: distribute/agc/agc-help-test-api-reference-0000002271000709/agc-help-test-api-release-test-version-0000002271000713
last_sync: 2026-06-07
sync_hash: 805ebd81
---
#### 功能介绍

此接口用于将公开测试版本转为全网版本或者分阶段版本。
...
| 承载协议 | HTTPS PUT |
| 接口方向 | 开发者服务器 -> 华为服务器 |
| 接口URL | https://connect-api.cloud.huawei.com/api/publish/v2/test/version/release |
...
![](../img/agc-help-test-api-release-test-version-0000002271000713_0.png)
...
请求Body中使用JSON格式携带需要转正的测试版本信息，参数如下表所示。

| 参数名称 | 必选(M)/可选(O) | 类型 | 参数说明 |
| --- | --- | --- | --- |
| versionId | M | String(32) | 需要转为全网版本或者分阶段版本的测试版本ID。 |
| releaseType | M | Integer(32) | 发布方式。  取值范围：   * 1：全网发布。  * 2：分阶段发布。   默认值：1 |
| releaseTime | O | Integer(64) | 发布时间。  时间为毫秒数。   * 0，则表示立即上架。 * 非0，则表示指定时间上架，只对转全网生效。 |
| phasedReleaseInfo | O | [PhasedReleaseInfo](/docs/distribute/agc/agc-help-test-api-data-0000002237336484/agc-help-test-api-data-phasedreleaseinfo-0000002237496320) | 分阶段发布信息。  说明：  releaseType为2时，该参数必填。 |

#### 请求示例

```
 PUT /api/publish/v2/test/version/release?appId=6917********72 HTTP/1.1
 ...
 Authorization: Bearer *******
{
    ...
    "releaseType": 2,
    "phasedReleaseInfo": {
        "phasedReleaseStartTime": "1727******95",
        "phasedReleaseEndTime": "1727******000",
        "phasedReleasePercent": "20",
        "phasedReleaseDescription": "测试*****"
    }
}
```
