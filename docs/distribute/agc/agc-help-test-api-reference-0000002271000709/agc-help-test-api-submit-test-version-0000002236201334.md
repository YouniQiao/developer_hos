---
title: "提交测试版本"
original_url: https://developer.huawei.com/consumer/cn/doc/app/agc-help-test-api-submit-test-version-0000002236201334
---
...
| 承载协议 | HTTPS POST |
| 接口方向 | 开发者服务器 -> 华为服务器 |
| 接口URL | https://connect-api.cloud.huawei.com/api/publish/v2/test/app/version/submit |
...
![](../img/agc-help-test-api-submit-test-version-0000002236201334_0.png)
...
```
 POST /api/publish/v2/test/app/version/submit?appId=6917********65 HTTP/1.1
