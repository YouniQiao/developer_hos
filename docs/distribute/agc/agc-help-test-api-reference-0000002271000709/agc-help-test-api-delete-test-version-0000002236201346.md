---
title: "删除测试版本"
original_url: https://developer.huawei.com/consumer/cn/doc/app/agc-help-test-api-delete-test-version-0000002236201346
format: md
---
...
![](../img/agc-help-test-api-delete-test-version-0000002236201346_0.png)
...
| 参数名称 | 必选(M)/可选(O) | 类型 | 参数说明 |
| --- | --- | --- | --- |
| versionId | M | String | 测试版本ID。 |
| appId | M | String | 应用ID |

#### 请求示例

```
 DELETE /api/publish/v2/test/app/version?versionId=142******36&appId=5765********59 HTTP/1.1
