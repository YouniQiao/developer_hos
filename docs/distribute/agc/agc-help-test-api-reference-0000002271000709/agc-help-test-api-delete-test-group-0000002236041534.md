...
| 承载协议 | HTTPS DELETE |
| 接口方向 | 开发者服务器 -> 华为服务器 |
| 接口URL | https://connect-api.cloud.huawei.com/api/app-test/v1/publish-api/test-group |
...
![](../img/agc-help-test-api-delete-test-group-0000002236041534_0.png)
...
![](../img/agc-help-test-api-delete-test-group-0000002236041534_1.png)
...
```
 DELETE /api/app-test/v1/publish-api/test-group?groupId=761e********08 HTTP/1.1
