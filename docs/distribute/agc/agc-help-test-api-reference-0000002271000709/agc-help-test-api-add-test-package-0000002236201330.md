---
title: "添加软件包"
original_url: https://developer.huawei.com/consumer/cn/doc/app/agc-help-test-api-add-test-package-0000002236201330
format: md
---
...
由于软件包解析采用异步方式，建议在上传软件包后轮询[查询软件包编译状态](https://developer.huawei.com/consumer/cn/doc/app/agc-help-publish-api-query-compile-status-0000002236041434)，确认包解析完成后，再调用[更新测试版本](https://developer.huawei.com/consumer/cn/doc/app/agc-help-test-api-modify-test-version-0000002271160657)接口绑定软件包。
...
| file | M | [FileInfo](https://developer.huawei.com/consumer/cn/doc/app/agc-help-test-api-data-fileinfo-0000002272575549) | 文件信息。 |
