---
title: "删除测试群组成员"
original_url: /docs/distribute/agc/agc-help-test-api-reference-0000002271000709/agc-help-test-api-delete-test-group-user-0000002271000721
format: md
upstream_id: distribute/agc/agc-help-test-api-reference-0000002271000709/agc-help-test-api-delete-test-group-user-0000002271000721
...
![](../img/agc-help-test-api-delete-test-group-user-0000002271000721_0.png)
...
| 参数名称 | 必选(M)/可选(O) | 类型 | 参数说明 |
| --- | --- | --- | --- |
| deleteTesterIds | M | `List&lt;String(100)>` | 需要删除的测试成员的ID列表。  数组长度不超过100。 |
| groupId | M | String(32) | 测试群组ID。 |

#### 请求示例

```
DELETE /api/publish/v2/test/user HTTP/1.1
