...
您已成功[创建游戏预约申请](/docs/dev/game-dev/games-center-pre-order-applyfor-0000002286057048#ZH-CN_TOPIC_0000002348293852)。

#### 操作流程

![](../img/agc-help-big-event-first-exposure-0000002392555597_0.png)
...
2. 选择“运营 > 内容运营 > 游戏大事件”，进入游戏大事件页面，点击“新建大事件”。
   ...
   ![](../img/agc-help-big-event-first-exposure-0000002392555597_1.png)
3. 填写基本信息。

   ![](../img/agc-help-big-event-first-exposure-0000002392555597_2.png)
4. 配置落地页。

   落地页是大事件的详细介绍页，用户点击事件标题后可跳转。

   ![](../img/agc-help-big-event-first-exposure-0000002392555597_3.png)

   相关参数如下表所示。

   | 参数 | 说明 |
   | --- | --- |
   | 是否配置落地页 | 大事件类型为“首曝”时，可选择是否配置相应的落地页。 |
...
5. 上传外显素材（可选）。
   ...
   ![](../img/agc-help-big-event-first-exposure-0000002392555597_4.png)

   ![](../img/agc-help-big-event-first-exposure-0000002392555597_5.png)
...
6. 填写完成后点击“提交审核”。提交审核后，华为工作人员审核大事件申请预计需要1~3个工作日，请耐心等待。审核结果可在游戏大事件列表内“任务状态”列查看。
   ...
   ![](../img/agc-help-big-event-first-exposure-0000002392555597_6.png)

   ![](../img/agc-help-big-event-first-exposure-0000002392555597_7.png)
