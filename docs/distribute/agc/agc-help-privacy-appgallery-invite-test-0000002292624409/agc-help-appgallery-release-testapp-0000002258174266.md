...
format: md
upstream_id: distribute/agc/agc-help-privacy-appgallery-invite-test-0000002292624409/agc-help-appgallery-release-testapp-0000002258174266
...
* 不允许两个在架测试版本的VersionName、VersionCode和构建版本完全一致。
  ...
  ![](../img/agc-help-appgallery-release-testapp-0000002258174266_0.png)
...
1. 在左侧导航栏选择“应用测试/元服务测试 > 版本列表”，进入“版本列表”页面，点击右上角“创建测试版本”。
   ...
   ![](../img/agc-help-appgallery-release-testapp-0000002258174266_1.png)
2. 在弹出的“创建测试版本”窗口，选择“邀请测试”，并按下表配置版本相关信息，点击“确定”。

   ![](../img/agc-help-appgallery-release-testapp-0000002258174266_2.png "点击放大")

   | 参数 | 说明 |
   | --- | --- |
   | 版本描述 | 自定义测试版本描述，以便于您区分不同的测试版本，不会向用户展示。不超过30个字符。 |
3. 系统自动进入版本信息配置页面，您可以开始配置版本基础信息。

   ![](../img/agc-help-appgallery-release-testapp-0000002258174266_3.png)
...
4. 配置软件版本。
   ...
   ![](../img/agc-help-appgallery-release-testapp-0000002258174266_4.png)
...
5. 配置测试信息。
   ...
   ![](../img/agc-help-appgallery-release-testapp-0000002258174266_5.png)
...
6. 配置隐私声明。
   ...
   * 自定义隐私政策
     ...
     ![](../img/agc-help-appgallery-release-testapp-0000002258174266_6.png)
   ...
   * 使用隐私声明托管服务生成隐私声明
     ...
     ![](../img/agc-help-appgallery-release-testapp-0000002258174266_7.png)
7. 配置联系方式。

   账号归属地为中国大陆地区的开发者，还需预留应用负责人的联系方式，以便于华为审核人员与您联系沟通。

   ![](../img/agc-help-appgallery-release-testapp-0000002258174266_8.png "点击放大")
8. 配置应用审核信息。

   ![](../img/agc-help-appgallery-release-testapp-0000002258174266_9.png)
9. 配置上架自检信息。

   ![](../img/agc-help-appgallery-release-testapp-0000002258174266_10.png "点击放大")

   若您具有自检报告通知功能，可勾选发送自检报告通知，若自检不通过将通过邮件和互动中心向您发送自检报告。

   ![](../img/agc-help-appgallery-release-testapp-0000002258174266_11.png "点击放大")

   | 参数 | 说明 |
   | --- | --- |
   | 上架自检 | * 选择“是”，将提交邀请测试并按照正式上架的审核要求自检，上架自检预计1天内完成。 * 选择“否”，将仅提交邀请测试审核，不进行正式上架自检。 * 上架自检不影响您邀请测试的上架结果。 * 一个应用仅支持同时存在一个上架自检中的任务，已存在上架自检任务时，再次创建邀请测试将不会展示上架自检选项。 |
   | 自检报告通知 | 仅自检不通过时有报告。 |
10. “配置测试版本信息”完成，点击右上角“下一步”进入“选择测试用户”步骤。

    ![](../img/agc-help-appgallery-release-testapp-0000002258174266_12.png "点击放大")

    | 参数 | 说明 |
    | --- | --- |
    | 测试用户 | 选择需要参加邀请测试的测试群组。测试群组不超过300个，参与的测试用户不超过10000个。  点击“管理测试用户”，还可快捷前往“测试用户”菜单新增、修改或删除测试群组。 |
11. 选择测试群组，点击“提交审核”进入“发布测试版本”页面。

    ![](../img/agc-help-appgallery-release-testapp-0000002258174266_13.png)

    ![](../img/agc-help-appgallery-release-testapp-0000002258174266_14.png)

    | 参数 | 说明 |
    | --- | --- |
    | 版本状态 | 显示当前版本状态。 |
    | 版本分享链接 | 测试版本提交审核后，分享链接会显示在此处，该链接可直接打开AppGallery应用尝鲜的测试应用详情页。您可以通过分享链接邀请已录入测试群组的用户参与测试。测试版本审核通过后，支持通过分享链接拼接邀请码，邀请外部测试用户参与测试。 |
12. 提交成功后，可在“版本列表”页面查看版本审核状态和上架自检结果。

    ![](../img/agc-help-appgallery-release-testapp-0000002258174266_15.png)![](../img/agc-help-appgallery-release-testapp-0000002258174266_16.png "点击放大")
    ...
    * 上架自检通过
    ...
    当上架自检结果为“测试完成”或“上架自检不通过”时，您可点击“上架自检报告”按钮，查看详细的自检报告。（只提交预审检测的报告按钮为“查看报告”）

    ![](../img/agc-help-appgallery-release-testapp-0000002258174266_17.png "点击放大")

    ![](../img/agc-help-appgallery-release-testapp-0000002258174266_18.png "点击放大")
    ...
    * 每个“VersionName”栏下展示各个测试版本的VersionCode和构建版本。**不允许两个在架测试版本的VersionName、VersionCode和构建版本完全一致。**
    ...
    ![](../img/agc-help-appgallery-release-testapp-0000002258174266_19.png "点击放大")

    已失效状态的测试版本可批量删除，勾选需要删除的邀请测试版本后点击“批量删除”。

    ![](../img/agc-help-appgallery-release-testapp-0000002258174266_20.png "点击放大")
...
2. 在“基础信息”栏，点击“测试时间”后的“修改”。
   ...
   ![](../img/agc-help-appgallery-release-testapp-0000002258174266_21.png)
3. 在弹出的“修改测试时间”窗口，选择新的测试开始时间和测试结束时间，点击“保存”。

   ![](../img/agc-help-appgallery-release-testapp-0000002258174266_22.png)

   ![](../img/agc-help-appgallery-release-testapp-0000002258174266_23.png)
...
![](../img/agc-help-appgallery-release-testapp-0000002258174266_24.png)

![](../img/agc-help-appgallery-release-testapp-0000002258174266_25.png)
