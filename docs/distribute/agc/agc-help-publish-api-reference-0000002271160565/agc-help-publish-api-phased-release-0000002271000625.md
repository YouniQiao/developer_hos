---
title: "更新分阶段发布"
original_url: https://developer.huawei.com/consumer/cn/doc/app/agc-help-publish-api-phased-release-0000002271000625
---
...
| 参数名称 | 必选(M)/可选(O) | 类型 | 参数说明 |
| --- | --- | --- | --- |
| versionId | M | String(32) | 版本ID。  可从[查询应用所有版本类型的版本列表](https://developer.huawei.com/consumer/cn/doc/app/agc-help-publish-api-query-brief-info-list-0000002236201254)接口返回的[versionId](https://developer.huawei.com/consumer/cn/doc/app/agc-help-publish-api-data-briefversioninfo-0000002271000657#ZH-CN_TOPIC_0000002271000657__zh-cn_topic_0000002083443972_p898319283710)参数中获取。 |
