---
title: "撤销资质审核任务"
original_url: /docs/distribute/agc/agc-help-publish-api-reference-0000002271160565/agc-help-publish-api-cancel-qualification-review-0000002236201258
format: md
upstream_id: distribute/agc/agc-help-publish-api-reference-0000002271160565/agc-help-publish-api-cancel-qualification-review-0000002236201258
...
| 承载协议 | HTTPS PUT |
| 接口方向 | 开发者服务器 -> 华为服务器 |
| 接口URL | https://connect-api.cloud.huawei.com/api/publish/v2/qualification-review-task/cancel |
...
![](../img/agc-help-publish-api-cancel-qualification-review-0000002236201258_0.png)
...
| 参数名称 | 必选(M)/可选(O) | 类型 | 参数说明 |
| --- | --- | --- | --- |
| taskId | M | String(32) | 资质审核任务ID。 |

#### 请求示例

```
PUT /api/publish/v2/qualification-review-task/cancel HTTP/1.1
