...
| pkgIds | M | String(500) | 待查询的软件包ID。  多个ID之间用英文逗号分隔。  可从[更新应用软件包信息](/docs/distribute/agc/agc-help-publish-api-reference-0000002271160565/agc-help-publish-api-app-package-info-update-0000002236201250#section19172900)接口返回的packageId参数中获取。 |
...
| pkgStateList | M | `List&lt;[PackageStates](/docs/distribute/agc/agc-help-publish-api-data-0000002236201266/agc-help-publish-api-data-packagestates-0000002271160601)>` | 软件包列表。 |
