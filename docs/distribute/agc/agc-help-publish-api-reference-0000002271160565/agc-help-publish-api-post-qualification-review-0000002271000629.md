...
![](../img/agc-help-publish-api-post-qualification-review-0000002271000629_0.png)

应用设备类型仅选择智能手表或运动手表时，不支持提交资质审核任务。
...
![](../img/agc-help-publish-api-post-qualification-review-0000002271000629_1.png)
...
| 参数名称 | 必选(M)/可选(O) | 类型 | 参数说明 |
| --- | --- | --- | --- |
| tagQualInfos | M | `List&lt;[TagQualInfo](/docs/distribute/agc/agc-help-publish-api-data-0000002236201266/agc-help-publish-api-data-tagqualinfo-0000002236041478)>` | 标签和标签对应的资质信息列表。  数组长度不超过5。 |

#### 请求示例

```
POST /api/publish/v2/qualification-review-task HTTP/1.1
