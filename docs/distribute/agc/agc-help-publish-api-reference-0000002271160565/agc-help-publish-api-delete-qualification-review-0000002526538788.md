...
如果元服务资质审核已通过，但在提交上架时因资质问题被驳回，需要先调用该接口移除旧的资质材料，然后重新[提交资质审核任务](https://developer.huawei.com/consumer/cn/doc/app/agc-help-publish-api-post-qualification-review-0000002271000629)。
...
| 参数名称 | 必选(M)/可选(O) | 类型 | 参数说明 |
| --- | --- | --- | --- |
| tagIds | M | `List&lt;String(64)>` | 需要删除的资质审核标签ID列表，逗号分隔。  数组长度不超过5。  说明：  具体取值请参见[元服务](https://developer.huawei.com/consumer/cn/doc/app/agc-help-connect-api-appendix-apptype-0000002271160689#section06007445916)的“标签ID”列。 |
