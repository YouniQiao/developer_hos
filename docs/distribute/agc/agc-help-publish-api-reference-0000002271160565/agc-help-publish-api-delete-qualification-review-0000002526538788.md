...
![](../img/agc-help-publish-api-delete-qualification-review-0000002526538788_0.png)

如果元服务资质审核已通过，但在提交上架时因资质问题被驳回，需要先调用该接口移除旧的资质材料，然后重新[提交资质审核任务](/docs/distribute/agc/agc-help-publish-api-reference-0000002271160565/agc-help-publish-api-post-qualification-review-0000002271000629)。
...
![](../img/agc-help-publish-api-delete-qualification-review-0000002526538788_1.png)
...
| 参数名称 | 必选(M)/可选(O) | 类型 | 参数说明 |
| --- | --- | --- | --- |
| tagIds | M | `List&lt;String(64)>` | 需要删除的资质审核标签ID列表，逗号分隔。  数组长度不超过5。  说明：  具体取值请参见[元服务](/docs/distribute/agc/agc-help-connect-api-appendix-0000002271000741/agc-help-connect-api-appendix-apptype-0000002271160689#section06007445916)的“标签ID”列。 |

#### 请求示例

```
DELETE /api/publish/v2/qualification-review-task HTTP/1.1
