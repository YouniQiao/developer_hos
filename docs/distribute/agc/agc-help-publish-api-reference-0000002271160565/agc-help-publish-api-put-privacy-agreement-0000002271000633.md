---
title: "提交隐私政策协议"
original_url: https://developer.huawei.com/consumer/cn/doc/app/agc-help-publish-api-put-privacy-agreement-0000002271000633
format: md
---
...
| 承载协议 | HTTPS PUT |
| 接口方向 | 开发者服务器 -> 华为服务器 |
| 接口URL | https://connect-api.cloud.huawei.com/api/publish/v2/agreement/submit |
...
![](../img/agc-help-publish-api-put-privacy-agreement-0000002271000633_0.png)
...
| requireConfirm | O | Integer(32) | 是否弹窗确认。  取值范围：   * 1：是 * 0：否 |

#### 请求示例

```
PUT /api/publish/v2/agreement/submit HTTP/1.1
