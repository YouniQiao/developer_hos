...
1. 登录[AppGallery Connect](https://developer.huawei.com/consumer/cn/service/josp/agc/index.html)，点击“快速开始”中的“元服务一站式平台”卡片。
   ...
   ![](../img/agc-help-petalmap-create-formalstate-poi-0000002407634113_1.png)
2. 在左上角的下拉列表中选择您的元服务。

   ![](../img/agc-help-petalmap-create-formalstate-poi-0000002407634113_2.png)
3. 左侧菜单栏选择“基础服务 > 近场服务 > 近场管理”，进入近场管理主界面。
4. 选择“POI管理”页签，点击“新建”。

   ![](../img/agc-help-petalmap-create-formalstate-poi-0000002407634113_3.png)
5. 在“新建POI”页面，“使用场景”选择“全网”，“位置名称”处输入位置关键词，选择您需要的地点，并根据需要设置该POI位置的“位置标识”（需确保在App中全局唯一），然后点击“发布”。发布后，该POI为“已激活”状态，可以被近场服务关联使用。若点击“保存”，该POI为“草稿”状态，将无法被近场服务关联使用。
...
1. 进入“POI管理”页面，点击“导入”。
   ...
   ![](../img/agc-help-petalmap-create-formalstate-poi-0000002407634113_8.png "点击放大")
2. 在“导入”弹框中，点击“下载导入模板”将模板Excel文件下载到本地。

   ![](../img/agc-help-petalmap-create-formalstate-poi-0000002407634113_9.png)
3. 按照模板文件中列出的字段和配置要求，填写要导入的POI信息。

   ![](../img/agc-help-petalmap-create-formalstate-poi-0000002407634113_10.png)

   * 模板中的所有字段都必须以文本形式填写。
   * 每个模板文件中填写的POI总数最多支持500个。

   ![](../img/agc-help-petalmap-create-formalstate-poi-0000002407634113_11.png)
...
5. 系统对导入的POI数据进行校验，预计耗时5分钟。
   * 如果您要导入的POI总数超过500，可点击“继续导入”，在模板中填写剩余的POI信息并完成导入。
     ...
     ![](../img/agc-help-petalmap-create-formalstate-poi-0000002407634113_14.png)
   * 如果POI导入完成或暂不打算继续导入其他POI，可点击“查看结果”或弹窗右上角的![](../img/agc-help-petalmap-create-formalstate-poi-0000002407634113_15.png)，返回到POI列表查看导入的POI信息。此时，可看到已导入POI的状态为“激活中”。

     ![](../img/agc-help-petalmap-create-formalstate-poi-0000002407634113_16.png "点击放大")
6. 当系统确认导入的POI为合法数据时，会将POI的状态更新为“已激活”，并同步更新POI的位置ID、城市名称、具体地址等信息。

   ![](../img/agc-help-petalmap-create-formalstate-poi-0000002407634113_17.png "点击放大")

   当系统判断导入的POI数据不合法或POI已被其他应用使用时，会将POI的状态更新为“激活失败”。您可点击“激活失败”旁的![](../img/agc-help-petalmap-create-formalstate-poi-0000002407634113_18.png)查看报错信息。如果POI某些信息设置有误，请刷新模板文件后再次尝试导入。

   ![](../img/agc-help-petalmap-create-formalstate-poi-0000002407634113_19.png "点击放大")
7. 如果导入POI出现其他问题，请参考如下方法解决。
   * 出现下图中报错，可能原因有两种：
     + 模板文件中的POI数量超过500。请将多余的POI数据拆分至另一个模板文件中，分批导入。
     + 模板文件格式错误导致系统解析失败。请检查模板文件是否包含非法的列或Sheet页。

     ![](../img/agc-help-petalmap-create-formalstate-poi-0000002407634113_20.png)
   * 模板文件中的某些字段为空或格式错误。请点击“下载”下载表格查看失败原因。

     ![](../img/agc-help-petalmap-create-formalstate-poi-0000002407634113_21.png)

     根据“失败原因”列的描述，如下图所示，修改存在问题的字段后，再次尝试导入。

     ![](../img/agc-help-petalmap-create-formalstate-poi-0000002407634113_22.png "点击放大")
   * POI总数已超过2000上限。请核对POI列表中是否存在冗余的POI。

     ![](../img/agc-help-petalmap-create-formalstate-poi-0000002407634113_23.png)
   * 系统校验POI数据时出现异常。请稍后再尝试导入。

     ![](../img/agc-help-petalmap-create-formalstate-poi-0000002407634113_24.png)
...
1. 进入“POI管理”页面，根据需要筛选需要查看的POI。
   * 在搜索框中输入POI位置名称关键词进行模糊筛选。
     ...
     ![](../img/agc-help-petalmap-create-formalstate-poi-0000002407634113_25.png "点击放大")
   * 选择POI的使用场景或状态进行筛选。

     ![](../img/agc-help-petalmap-create-formalstate-poi-0000002407634113_26.png "点击放大")
2. 完成POI筛选后，点击“导出”。

   ![](../img/agc-help-petalmap-create-formalstate-poi-0000002407634113_27.png "点击放大")
