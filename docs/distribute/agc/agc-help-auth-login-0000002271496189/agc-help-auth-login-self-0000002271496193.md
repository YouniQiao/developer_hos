...
2. 使用从自有账号获取的JWT信息生成credentialInfo，并调用[Auth.signIn](https://developer.huawei.com/consumer/cn/doc/app/agc-help-auth-api-auth-0000002273777093#section136957141012)实现登录。
