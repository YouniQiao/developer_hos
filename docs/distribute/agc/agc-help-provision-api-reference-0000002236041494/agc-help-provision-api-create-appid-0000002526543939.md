---
title: "创建APP ID"
original_url: https://developer.huawei.com/consumer/cn/doc/app/agc-help-provision-api-create-appid-0000002526543939
format: md
---
...
| 参数名称 | 必选(M)/可选(O) | 类型 | 参数说明 |
| --- | --- | --- | --- |
| projectId | M | String | 项目ID，获取方法请参见[查看应用信息](https://developer.huawei.com/consumer/cn/doc/app/agc-help-view-app-info-0000002282674569)。 |
