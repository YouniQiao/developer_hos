---
title: "删除证书"
original_url: https://developer.huawei.com/consumer/cn/doc/app/agc-help-provision-api-delete-cent-0000002271000685
---
...
| 承载协议 | HTTPS POST |
| 接口方向 | 开发者服务器 -> 华为服务器 |
| 接口URL | https://connect-api.cloud.huawei.com/api/publish/v2/cert/delete |
...
![](../img/agc-help-provision-api-delete-cent-0000002271000685_0.png)
...
| 参数名称 | 必选(M)/可选(O) | 类型 | 参数说明 |
| --- | --- | --- | --- |
| certIds | M | `List&lt;String(32)>` | 证书ID列表。  数组长度为1~100。 |

#### 请求样例

```
POST /api/publish/v2/cert/delete HTTP/1.1
...
```
public static JSONObject deleteCert(String domain, String clientId, String token, List<String> certIds) {
     HttpPost post = new HttpPost(domain + "/publish/v2/cert/delete");
