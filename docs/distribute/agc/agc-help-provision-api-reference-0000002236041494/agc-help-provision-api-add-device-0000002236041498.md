...
| 参数名称 | 必选(M)/可选(O) | 类型 | 参数说明 |
| --- | --- | --- | --- |
| deviceList | M | `List&lt;[AddDeviceInfo](/docs/distribute/agc/agc-help-provision-api-data-0000002271160637/agc-help-provision-api-data-adddeviceinfo-0000002236201314)>` | 添加调试/测试设备的信息列表。  数组长度不超过1000。  说明：  支持重新添加在过去一年内被删除的设备，只需输入新的deviceName，并输入原始的udid即可。 |
...
| failedAddDeviceDetail | O | `List&lt;[AddDeviceResult](/docs/distribute/agc/agc-help-provision-api-data-0000002271160637/agc-help-provision-api-data-adddeviceresult-0000002271160641)>` | 添加失败的设备详情。 |
