...
original_url: https://developer.huawei.com/consumer/cn/doc/service/create-service-0000002105172798
---
...
5. 设置AirTouch服务基本信息。
   ...
   * 回调地址：伙伴提供给华为的地址，用于华为反向回调开发者获取标签跳转链接参数。如果商户在[设置跳转参数来源](#ZH-CN_TOPIC_0000002105172798__li20667114554214)中选择“根据TagId查询参数”则该地址必须填写，否则无须填写。
     ...
     HarmonyOS 5.0及以上版本不支持回调地址，HarmonyOS 3.1/4.0及以下版本回调实现请参见[参数回调接口](https://developer.huawei.com/consumer/cn/doc/service/callback-0000002148323061)
