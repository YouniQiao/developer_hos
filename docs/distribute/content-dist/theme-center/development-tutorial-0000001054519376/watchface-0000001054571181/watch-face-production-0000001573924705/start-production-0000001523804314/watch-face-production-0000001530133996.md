...
original_url: https://developer.huawei.com/consumer/cn/doc/content/watch-face-production-0000001530133996
---
...
每种控件的功能与使用方法，我们将结合[制作实例](https://developer.huawei.com/consumer/cn/doc/content/production-example-0000001530293740)详细讲解。

每类分辨率支持的控件类型及其对应的版本号，详见：

* [466\*466控件类型](https://developer.huawei.com/consumer/cn/doc/content/466-capability-0000001881726154#section1921412381417)
* [390\*390/454\*454控件类型](https://developer.huawei.com/consumer/cn/doc/content/454-capability-0000001580733885#section9686121420109)
* [280\*456/336\*480控件类型](https://developer.huawei.com/consumer/cn/doc/content/280-capability-0000001592176765#section387762991810)
* [194\*368控件类型](https://developer.huawei.com/consumer/cn/doc/content/194-capability-0000001591976781#section387762991810)
...
容器变为特定数据容器后，点击当前容器的范围，可跳转至相关应用。哪些容器支持跳转？点击查看[跳转应用](https://developer.huawei.com/consumer/cn/doc/content/value-type-0000001529974532#section1743413371488)。
...
每个控件图层都有一系列可编辑的属性，我们将结合[制作实例](https://developer.huawei.com/consumer/cn/doc/content/production-example-0000001530293740)详细讲解。
...
表盘支持的所有数值类型及其介绍，详见[数值类型](https://developer.huawei.com/consumer/cn/doc/content/value-type-0000001529974532)。

常用的数值类型制作方法，我们将结合[制作实例](https://developer.huawei.com/consumer/cn/doc/content/production-example-0000001530293740)详细讲解。

每类分辨率支持的数值类型及其对应的版本号，详见：

* [466\*466数值类型](https://developer.huawei.com/consumer/cn/doc/content/466-capability-0000001881726154#section1462914111857)
* [390\*390/454\*454数值类型](https://developer.huawei.com/consumer/cn/doc/content/454-capability-0000001580733885#section1781115539139)
* [280\*456/336\*480数值类型](https://developer.huawei.com/consumer/cn/doc/content/280-capability-0000001592176765#section322152141813)
* [194\*368数值类型](https://developer.huawei.com/consumer/cn/doc/content/194-capability-0000001591976781#section322152141813)
...
请对照[表盘主题测试规范](https://developer.huawei.com/consumer/cn/doc/content/sportwatch-test-0000001057059331)进行测试。
...
1. 由于表盘预览图上必须统一显示默认数值（详见[表盘主题测试规范](https://developer.huawei.com/consumer/cn/doc/content/sportwatch-test-0000001057059331)），因此必须先在动态预览区点击 ![](./img/050bf6e45b69.png "点击放大") 将数据恢复至默认状态，再“截屏生成展示图”。
...
* 版本号（Theme Studio自动生成，详见[表盘版本号](https://developer.huawei.com/consumer/cn/doc/content/resolution-version-0000001252603441#section14815328193116)说明）。
