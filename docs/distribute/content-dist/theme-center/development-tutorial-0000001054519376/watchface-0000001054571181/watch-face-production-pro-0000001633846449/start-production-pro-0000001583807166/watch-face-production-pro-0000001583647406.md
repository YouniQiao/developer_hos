...
original_url: https://developer.huawei.com/consumer/cn/doc/content/watch-face-production-pro-0000001583647406
---
...
每种元素的功能与使用方法，我们将结合[制作实例](https://developer.huawei.com/consumer/cn/doc/content/production-example-pro-0000001633927109)详细讲解。

每类分辨率支持的元素类型及其对应的版本号，详见：

* [466\*466元素类型](https://developer.huawei.com/consumer/cn/doc/content/466-capability-0000001881726154#section1921412381417)
...
容器变为数据容器后，点击当前容器的范围，可跳转至相关应用。哪些容器支持跳转？点击查看[跳转应用](https://developer.huawei.com/consumer/cn/doc/content/value-type-pro-0000001583966586#section1743413371488)。因此，多个数据容器的范围不可重叠，避免出现“点击重叠区域，跳转失误”的问题。
...
每个元素图层都有一系列可编辑的属性，我们将结合[制作实例](https://developer.huawei.com/consumer/cn/doc/content/production-example-pro-0000001633927109)详细讲解。
...
常用的数据类型制作方法，我们将结合[制作实例](https://developer.huawei.com/consumer/cn/doc/content/production-example-pro-0000001633927109)详细讲解。
...
* 支持画布自由缩放。
* 优化表盘预览方式和效果。点击![](./img/ca535ac977c8.png "点击放大")自动运行表盘，以测试表盘在不同数值下的显示效果。同时支持倍速预览、拉动进度条预览。请对照[表盘主题测试规范](https://developer.huawei.com/consumer/cn/doc/content/sportwatch-test-0000001057059331)进行预览测试。
...
* 版本号（Theme Studio Pro自动生成，详见[表盘版本号](https://developer.huawei.com/consumer/cn/doc/content/resolution-version-0000001252603441#section14815328193116)说明）。
