...
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides-V5/ide-faultlog-cppcrash
format: md
---
...
1. 打开FaultLog窗口，双击cppcrash日志，<strong>Fault Info</strong>右侧会出现<strong>Fault Analysis</strong>页签。

   ![](./img/zh-cn_image_0000002571387094.png)
2. 点击<strong>Fault Analysis</strong>页签，会展示结构化的日志信息。
   ...
   * 页面下方包含Stacks和Logs两个页签。
     + <strong>Stacks</strong>：展示线程的堆栈信息，具体请参考[查看堆栈信息](#section145813141354)。
     + <strong>Logs</strong>：展示FaultLog中的HiLog日志，具体请查看[查看HiLog日志](#section656352444818)。

   ![](./img/zh-cn_image_0000002571546730.png "点击放大")
...
![](./img/zh-cn_image_0000002602186263.png "点击放大")
...
![](./img/zh-cn_image_0000002602186265.png "点击放大")
