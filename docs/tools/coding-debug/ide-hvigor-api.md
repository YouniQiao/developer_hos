...
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides-V5/ide-hvigor-api
format: md
---
...
| 类型 | 说明 |
| --- | --- |
| [HvigorNode](#section14832104719474) | hvigor根节点对象 |
...
| 类型 | 说明 |
| --- | --- |
| [HvigorNode](#section14832104719474)[] | hvigor所有节点对象的数组 |
...
| 类型 | 说明 |
| --- | --- |
| [HvigorNode](#section14832104719474) | undefined | 根据名称找到的节点对象，如果不存在则返回undefined |
...
| 类型 | 说明 |
| --- | --- |
| [HvigorConfig](#section7253174081515) | HvigorConfig对象 |
...
| 类型 | 说明 |
| --- | --- |
| [Parameter](#section18886457152915) | Parameter对象 |
...
<strong>起始版本：</strong>Hvigor 6.22.3
...
<strong>起始版本：</strong>Hvigor 4.0.2
...
<strong>示例：</strong>判断是否是assembleHap任务并打印出来。
...
| 类型 | 说明 |
| --- | --- |
| [HvigorNode](#section14832104719474) | undefined | hvigor节点对象，如果入参scriptPath未指向本工程内的hvigorfile.ts则返回undefined |

<strong>示例：</strong>获取当前节点对象。
...
<strong>起始版本：</strong>Hvigor 5.0.10
...
| 类型 | 说明 |
| --- | --- |
| [HvigorNodeDescriptor](#section1914012226435) | 根节点的节点描述对象 |

<strong>示例：</strong>获取构建的所有节点描述对象。
...
| 类型 | 说明 |
| --- | --- |
| [HvigorNodeDescriptor](#section1914012226435)[] | 所有节点的节点描述对象 |
...
| 类型 | 说明 |
| --- | --- |
| [HvigorNodeDescriptor](#section1914012226435) | 根据名称获取的节点描述对象 |
...
<strong>示例2：</strong>添加一个名为exampleNodeName且附带targets信息的node。
...
| 类型 | 说明 |
| --- | --- |
| [HvigorNodeDescriptor](#section1914012226435)[] | undefined | 所有的子节点描述对象，不存在子节点则返回undefined |
...
| 类型 | 说明 |
| --- | --- |
| [Product](#section1553414254713) | 当前构建target应用的Product对象 |
...
<strong>起始版本：</strong>Hvigor 4.1.2
...
<strong>起始版本：</strong>Hvigor 5.10.3
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| task | [HvigorTask](#section2386634104512) | 是 | HvigorTask的实现 |

<strong>示例：</strong>自定义任务注册。
...
| 类型 | 说明 |
| --- | --- |
| [Task](#section2055582515349) | undefined | Task对象或undefined。当前节点未找到指定taskName的已注册任务时，返回值为undefined。 |
...
| 类型 | 说明 |
| --- | --- |
| [HvigorNode](#section14832104719474) | undefined | 节点对象或undefined |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callbackfn | (node: [HvigorNode](#section14832104719474)) =&gt; void | 是 | 入参类型为HvigorNode，返回类型为void的函数 |
...
| 类型 | 说明 |
| --- | --- |
| [NormalizedFile](#section281448112713) | 当前节点的根目录的NormalizedFile对象 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| node | [HvigorNode](#section14832104719474) | 是 | hvigor节点对象 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| input | [TaskInput](#section425723621113) | 是 | 控制任务增量的输入条件实现对象 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| output | [TaskOutput](#section135442202125) | 是 | 控制任务增量的输出条件实现对象 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| taskContext | [HvigorTaskContext](#section17880854104213) | 否 | 接口中默认注入的公共信息类型 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| taskContext | [HvigorTaskContext](#section17880854104213) | 否 | 接口中默认注入的公共信息 |
...
| 类型 | 说明 |
| --- | --- |
| [TaskInput](#section425723621113) | 当前控制任务增量的输入条件对象，用于链式调用 |
...
| 类型 | 说明 |
| --- | --- |
| [TaskOutput](#section135442202125) | 当前控制任务增量的输出条件对象，用于支持链式调用 |
...
| 类型 | 说明 |
| --- | --- |
| [TaskOutput](#section135442202125) | 控制任务增量的输出条件对象，用于支持链式调用 |
...
<strong>起始版本：</strong>Hvigor 6.0.4
...
| 类型 | 说明 |
| --- | --- |
| [NormalizedFile](#section281448112713) | 在原有的NormalizedFile对象的路径链式拼接所得到NormalizedFile对象 |
...
| 类型 | 说明 |
| --- | --- |
| [NormalizedFile](#section281448112713)[] | NormalizedFile对象下深层递归的目录与文件NormalizedFile[]，包含它本身 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| file | string | [NormalizedFile](#section281448112713) | 是 | 文件路径字符串或者是NormalizedFile对象 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| file | string | [NormalizedFile](#section281448112713) | 是 | json5文件路径或者NormalizedFile对象 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| node | [HvigorNode](#section14832104719474) | 是 | worker归属的任务对应的节点。 |
| taskName | string | 是 | 向线程池提交worker的任务名称。 |
| workPath | string | 是 | 要执行的worker的文件路径，可以拼接函数名称，例如D:/xx/a.js/run是指运行a.js的run方法。 |
| workerOption | [WorkerOption](#section2701859185318) | 是 | worker配置。 |

<strong>返回值：</strong>

| 类型 | 说明 |
| --- | --- |
| [TCB](#section282818554815) | 提交的worker的状态。 |

<strong>示例：</strong>在hap模块的自定义任务中，向线程池提交一个worker。
...
| priority | priority?: [Priority](#section162915519616); | 设置线程执行的优先级。 |
...
| getPriority | getPriority(): [Priority](#section162915519616); | 获取优先级。 |
