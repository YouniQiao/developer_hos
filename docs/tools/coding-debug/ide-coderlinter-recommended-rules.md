...
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides-V5/ide-coderlinter-recommended-rules
format: md
---
...
| @performance/bad-deep-clone-check | 避免使用不合理深拷贝，如JSON.parse(JSON.stringify(foo))和\_.cloneDeep(foo)。 |
