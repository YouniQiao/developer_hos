...
先配置[环境变量](./ide-environment-config#zh-cn_topic_0000001056725590_li1012418311835)，再打开[命令行工具](../cli-tools/ide-commandline-get#section21298572437)，执行 ohpm install 命令，会生成oh\_modules文件夹和oh-package-lock.json5文件。
...
请参考[离线部署模拟器](./ide-emulator-no-network)。
