...
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides-V5/ide-hvigor-dependencies
format: md
---
...
依赖设置完成后，需要执行<strong>ohpm install</strong>命令安装依赖包，依赖包会存储在对应模块的oh\_modules目录下。
...
![](./img/zh-cn_image_0000002571547090.png)
...
<strong>表1</strong> 编译行为差异说明

| 依赖项 | | | 编译HAP | 编译HSP | 编译未开启 bundledDependencies 的字节码HAR | 编译开启 bundledDependencies 的字节码HAR |
| --- | --- | --- | --- | --- | --- | --- |
| 源码HAR | 三方包依赖 | devDependencies | 1 | 1 | <strong>2</strong> | 1 |
| 工程级的dependencies | / | / | <strong>3</strong> | <strong>3</strong> |
| 本地依赖 | devDependencies | 1 | 1 | <strong>2</strong> | 1 |
| 工程级的dependencies | / | 1 | <strong>2</strong> | 1 |
| 字节码HAR | 三方包依赖 | devDependencies | <strong>2</strong> | <strong>2</strong> | <strong>4</strong><strong>5</strong> | <strong>6</strong><strong>7</strong> |
| 工程级的dependencies | / | / | <strong>3</strong> | <strong>3</strong> |
| HSP | 三方包依赖 | devDependencies | 1 | 1 | <strong>2</strong> | <strong>2</strong><strong>3</strong> |
| 工程级的dependencies、dynamicDependencies | / | / | / | / | / |
| 本地依赖 | devDependencies | <strong>1</strong> | <strong>2</strong><strong>3</strong> | <strong>4</strong><strong>5</strong> | <strong>6</strong><strong>7</strong> |
| 工程级的dependencies、dynamicDependencies | / | 1 | <strong>2</strong> | <strong>2</strong><strong>3</strong> |
...
针对以上几类编译/运行时可能异常的场景，从DevEco Studio 5.1.1 Beta1版本开始，hvigor-config.json5文件提供一个字段ohos.byteCodeHar.integratedOptimization，开启后，可以优化表格中<strong>加粗符号</strong>对应的场景。
