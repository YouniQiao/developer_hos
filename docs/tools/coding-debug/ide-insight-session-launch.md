...
启动模式分为![](./img/zh-cn_image_0000002602186087.png "点击放大")自动启动和![](./img/zh-cn_image_0000002602186093.png "点击放大")手动启动，可点击图标切换两种不同模式：
...
2. 单击单个静态资源库色块，或框选多个静态资源库，下方的“Details”区域展示所选对象的耗时统计信息。
   ...
   ![](./img/zh-cn_image_0000002571386920.png "点击放大")
...
2. 单击单个进程色块，或框选多个进程，下方的“Details”区域展示所选对象的运行情况统计信息。
   ...
   ![](./img/zh-cn_image_0000002571546558.png "点击放大")
...
2. 单击单个切片色块，或框选多个切片，可查看所选对象的详情。
   ...
   * “Load Statistics”区域展示所选对象的中载重载信息。
   ...
   ![](./img/zh-cn_image_0000002571386916.png "点击放大")
