...
在DevEco Studio菜单栏点击<strong>View &gt; Tool Windows &gt; Operation Analyzer</strong>，进入运维服务页面。

![](./img/zh-cn_image_0000002602186809.png)

点击<strong>Add account</strong>按钮，登录华为账号并授权后，可以查看当前账号下应用异常情况。

![](./img/zh-cn_image_0000002571387644.png)
...
1. 菜单栏：
   ...
   3. 3号区域：Metrics区域展示Crash，Frame Loss，Launch， Battery Usage异常数据的变化趋势<strong>。</strong>
2. 内容展示区顶部可选择配置项包含：
...
![](./img/zh-cn_image_0000002571547278.png)
...
* 3号区域：当前选中的问题有多个不同的异常点，通过分页切换具体定位<strong>。</strong>
* 4号区域：符号表配置按钮。点击按钮将当前选中的堆栈还原为原始代码，选中带有路径的代码行，然后可以点击最右侧的<strong>Open in project</strong>按钮跳转到应用中问题所在位置。
* 5号区域：展示当前设备信息。
...
![](./img/zh-cn_image_0000002602186811.png)![](./img/zh-cn_image_0000002602066761.png)

![](./img/zh-cn_image_0000002571387650.png)
...
![](./img/zh-cn_image_0000002602066753.png)
...
![](./img/zh-cn_image_0000002571387648.png)
...
![](./img/zh-cn_image_0000002602066765.png)![](./img/zh-cn_image_0000002602186817.png)
...
![](./img/zh-cn_image_0000002602186813.png)
