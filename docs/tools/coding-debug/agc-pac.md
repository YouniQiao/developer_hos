...
* 开发App情况下，选中AppScope目录新建pac.json5文件。
  ...
  ![](./img/zh-cn_image_0000002602186271.png)

* 开发HSP或HAR情况下，选中HSP或HAR模块目录新建pac.json5文件。

  ![](./img/zh-cn_image_0000002571387102.png)
...
<strong>表1</strong> pac.json5隐私清单文件字段说明

| 字段名称 | 可选/必选 | 类型 | 含义 |
| --- | --- | --- | --- |
| [dataProcess](#section82051543115414) | 可选 | 数组 | 声明应用收集的个人数据。 |
| [specialAPIs](#section26881432131216) | 可选 | 数组 | 声明应用调用的可用于生成设备指纹的API信息。 |
...
<strong>表2</strong> dataProcess

| 字段名称 | 可选/必选 | 类型 | 含义 |
| --- | --- | --- | --- |
| [dataType](#table176277269236) | 必选 | 字符串 | 应用收集个人数据的类型。 |
| [dataLabels](#section13345163017127) | 必选 | 数组 | 应用收集的个人数据项和目的。 |

<strong>表3</strong> dataType
...
<strong>表4</strong> dataLabels

| 字段名称 | 可选/必选 | 类型 | 含义 |
| --- | --- | --- | --- |
| [label](#table202051420105216) | 必选 | 字符串 | 应用收集的个人数据项。 |
| [purposes](#table1292433153213) | 必选 | 数组 | 应用收集个人数据的目的。 |
| userLinked | 可选 | 布尔 | 应用收集的个人数据是否用于用户关联。 |
| tracking | 可选 | 布尔 | 应用收集的个人数据是否用于用户追踪。 |

<strong>表5</strong> label
...
<strong>表7</strong> specialAPIs

| 字段名称 | 可选/必选 | 类型 | 含义 |
| --- | --- | --- | --- |
| [apiType](#table53349541435) | 必选 | 字符串 | API类型 |
| [reasons](#table178321910193719) | 必选 | 数组 | API调用原因 |

<strong>表8</strong> apiType
