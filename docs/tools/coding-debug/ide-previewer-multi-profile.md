...
original_url: /docs/tools/coding-debug/ide-previewer-multi-profile
format: md
upstream_id: tools/coding-debug/ide-previewer-multi-profile
...
3. 在Previewer窗口中，打开Profile Manager中的<strong>Multi-profile preview</strong>开关，同时查看多设备上的应用/元服务运行效果。

   ![](./img/note_3.0-zh-cn.png)

   多端设备预览不支持动画的预览，如果需要查看动画在设备上的预览效果，请关闭Multi-profile preview功能后在单设备预览界面进行查看。

   ![](./img/zh-cn_image_0000002571387226.png)

   多设备预览效果如下图所示：

   ![](./img/zh-cn_image_0000002602066343.gif "点击放大")
