...
* 通过DevEco Studio菜单栏构建：
  + 点击<strong>File &gt;</strong> <strong>Settings</strong>（macOS为<strong>DevEco Studio &gt; Preferences/Settings</strong>） <strong>&gt; Build, Execution, Deployment &gt; Build Tools &gt; Hvigor</strong>，勾选或取消勾选字段<strong>Enable the Daemon for tasks</strong>。
* 通过命令行构建：
