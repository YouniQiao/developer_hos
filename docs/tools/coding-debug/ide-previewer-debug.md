...
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides-V5/ide-previewer-debug
format: md
---
...
<strong>表1</strong> 普通预览与预览调试能力对比

|  |  |  |  |
| --- | --- | --- | --- |
| <strong>功能</strong> | <strong>普通预览</strong> | <strong>预览调试</strong> | |
| <strong>页面预览</strong> | <strong>运行模式</strong> | <strong>调试模式</strong> |
| ets页面预览 | 支持 | 支持 | 支持 |
| 动态预览 | 支持 | 支持 | 支持 |
| 指定页面文件预览 | 支持 | 不支持 | 不支持 |
