...
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides-V5/ide-ohpm-convert
format: md
---
...
![](../../img/zh-cn_image_0000002602186785.png)

<strong>转换本地node\_modules目录中的包</strong>

执行npm install uuid后，转换本地node\_modules目录中的包，执行以下命令：

![](../../img/zh-cn_image_0000002602186787.png)
...
![](../../img/zh-cn_image_0000002571387616.png)