...
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides-V5/ide-ohpm-list
format: md
---
...
* 查看当前项目安装的<strong>所有</strong>三方库及依赖关系。
  ...
  ![](../../img/zh-cn_image_0000002602186513.png)
* 查看当前项目安装的<strong>某个</strong>三方库的依赖关系
  ...
  ![](../../img/zh-cn_image_0000002571387344.png)
* 查看当前项目所有module安装的<strong>所有</strong>三方库及依赖关系。
...
* 指定target\_path选项时，查看当前项目所有module安装的<strong>所有</strong>三方库及依赖关系。
