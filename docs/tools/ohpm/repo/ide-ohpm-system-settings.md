...
title: "系统设置"
format: md
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides-V5/ide-ohpm-system-settings
---
...
![](./img/0f1d540b.png "点击放大")

## 系统安全

系统安全页面中有两部分配置项：重置系统密钥和配置是否支持匿名访问。页面效果如下图所示：

![](./img/364be9bb.png "点击放大")
