...
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides-V5/app-check-tool
format: md
---
...
![](./img/zh-cn_image_0000002581274686.png)
...
<strong>表4 扫描超出指定大小的文件的指令参数说明</strong>
...
<strong>表5 扫描超出指定大小的文件字段信息</strong>
...
<strong>表6 超出指定大小的文件统计结果字段信息</strong>
...
<strong>表7 统计各类型文件大小占比指令参数说明</strong>
...
<strong>表8 统计各类型文件大小占比字段信息</strong>
...
<strong>表9 各类型文件大小占比统计结果字段信息</strong>
...
<strong>表10 同类型文件的对应路径和大小字段信息</strong>
