...
* 显示匹配name的系统参数信息，命令格式如下：
  ...
  ![](./img/zh-cn_image_0000002611754541.png)

  ![](./img/zh-cn_image_0000002581434604.png)

  ![](./img/zh-cn_image_0000002611834435.png)
...
* 获取指定name系统参数的值，命令格式如下：
  ...
  ![](./img/zh-cn_image_0000002581274688.png)
...
* 设置指定name系统参数的值为value，命令格式如下：
  ...
  ![](./img/zh-cn_image_0000002611754543.png)
...
* 同步等待指定name系统参数与指定值value匹配，命令格式如下：
  ...
  ![](./img/zh-cn_image_0000002581434606.png)
...
* 保存persist(可持久化)参数到工作空间，命令格式如下：
  ...
  ![](./img/zh-cn_image_0000002611834437.png)

### 系统参数错误码说明

<strong>错误码说明</strong>

错误码详情参考[系统参数](https://gitcode.com/openharmony/docs/blob/weekly_20260309/zh-cn/device-dev/subsystems/subsys-boot-init-sysparam.md)文档描述