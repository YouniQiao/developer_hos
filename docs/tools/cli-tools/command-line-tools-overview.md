...
* 通过SDK获取相关工具。其中SDK已嵌入[DevEco Studio](./ide-software-install.md)中，无需额外下载配置。SDK位于DevEco Studio的安装位置下的sdk目录中。
* 通过[Command Line Tools](./ide-commandline-get.md)工具中的sdk文件夹获取相关工具。
