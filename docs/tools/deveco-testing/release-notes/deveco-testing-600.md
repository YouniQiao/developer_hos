...
format: md
original_url: /docs/tools/deveco-testing/release-notes/deveco-testing-600
...
新增“应用上架预检（本地）”测试服务。具体请参考[应用上架预检](/docs/dev/testing/publish-testing#section214991410293)。

探索测试服务支持用户自定义场景进行压测。具体请参考[应用探索测试](/docs/dev/testing/exploratory-testing#section12324184817324)。

支持部分测试任务在模拟器上执行。

新增应用图谱管理工具、性能报告自动分析工具、性能测试报告对比工具。具体请参考[实用工具](/docs/dev/testing/tool)。
...
| [实用工具](/docs/dev/testing/tool) | UIViewer | 不支持 | 支持 |
| [实用工具](/docs/dev/testing/tool) | 应用图谱管理工具 | 不支持 | 不支持 |
| [实用工具](/docs/dev/testing/tool) | 性能报告自动分析 | 不支持 | / |
| [实用工具](/docs/dev/testing/tool) | 性能测试报告对比 | 不支持 | / |
