...
* 开发App情况下，选中AppScope目录新建pac.json5文件。
  ...
  ![](./img/8737618643fe.png)

* 开发HSP或HAR情况下，选中HSP或HAR模块目录新建pac.json5文件。

  ![](./img/202b4fd5fcd0.png)
...
| 字段名称 | 可选/必选 | 类型 | 含义 |
| --- | --- | --- | --- |
| [dataProcess](#dataprocess) | 可选 | 数组 | 声明应用收集的个人数据。 |
| [specialAPIs](#specialapis) | 可选 | 数组 | 声明应用调用的可用于生成设备指纹的API信息。 |

![](./img/0ee63c21c17e.png) 
...
| 字段名称 | 可选/必选 | 类型 | 含义 |
| --- | --- | --- | --- |
| [dataType](#dataprocess) | 必选 | 字符串 | 应用收集个人数据的类型。 |
| [dataLabels](#datalabels) | 必选 | 数组 | 应用收集的个人数据项和目的。 |
...
| 字段名称 | 可选/必选 | 类型 | 含义 |
| --- | --- | --- | --- |
| [label](#datalabels) | 必选 | 字符串 | 应用收集的个人数据项。 |
| [purposes](#datalabels) | 必选 | 数组 | 应用收集个人数据的目的。 |
...
| 字段名称 | 可选/必选 | 类型 | 含义 |
| --- | --- | --- | --- |
| [apiType](#specialapis) | 必选 | 字符串 | API类型 |
| [reasons](#specialapis) | 必选 | 数组 | API调用原因 |
