...
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides-V5/agc-harmonyos-clouddev-invokecloudobj
format: md
---
...
请确保[云对象已正确开发并部署](./agc-harmonyos-clouddev-deploycloudobj)。
