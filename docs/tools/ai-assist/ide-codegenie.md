...
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides-V5/ide-codegenie
format: md
---
...
![](./img/zh-cn_image_0000002571387554.png)
...
1. 在DevEco Studio菜单栏，点击<strong>File > Settings</strong>（macOS为<strong>DevEco Studio > Preferences/Settings</strong>）<strong>> Plugins</strong>，点击![](./img/zh-cn_image_0000002571547186.png) <strong>> Install Plugin from Disk…</strong>安装本地插件。

   ![](./img/zh-cn_image_0000002571387552.png)
2. 在弹出的文件选择窗口中，选择<strong>未解压的插件包</strong>的存放位置，点击<strong>OK</strong>确认安装插件。

   ![](./img/zh-cn_image_0000002602066669.png)
3. 点击<strong>Restart IDE</strong>，重新启动DevEco Studio。

   ![](./img/zh-cn_image_0000002602186721.png)
