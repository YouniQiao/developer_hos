...
![](./img/caution_3.0-zh-cn_d5e90737a8a5.png) 
...
| pricingType | M | String | 计费类型。本场景下固定配置为<strong>CPC</strong>。枚举值说明如下：CPC：按点击次数计费 |
...
| clickAdMonitorReportUrl | O | String | 点击上报监控链接。格式和样例参考[impAdMonitorReportUrl](/docs/monetize/promotion/mktapi-adtask-top-sys-cpd-0000001313837264#ZH-CN_TOPIC_0000001741282852__zh-cn_topic_0000001176165925_p24321722553)参数。 |
...
![](./img/caution_3.0-zh-cn_49a7e22df7cd.png) 
...
| subTaskUserGroupId | M | String | 子任务对应的定向ID，只能选择已启动定向。说明定向ID请从[新增标签定向](/docs/monetize/promotion/marketapi-addtag-0000001181826407)或者[查询定向列表](/docs/monetize/promotion/marketapi-querytaglist-0000001181946327)接口中获取。 |
