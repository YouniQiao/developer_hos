...
original_url: https://developer.huawei.com/consumer/cn/doc/promotion/ads_azyytg-0000001058818923
---
# Android应用推广

## 概述

Android应用推广指的是在展示广告网络的资源上对您的应用进行推广，吸引更多用户下载安装应用或促进应用用户活跃度。
...
1. 创建广告计划。
   ...
   ![](./img/zh-cn_image_0000002313598252_14259ca30d5f.png "点击放大")

   方式二：也可以单击“推广”按钮进入推广页面，然后选择“创建计划”。

   ![](./img/zh-cn_image_0000002313438492_eec3ca6297d7.png "点击放大")

   ![](./img/zh-cn_image_0000002593784921_34b33610721b.png)
   ...
   - <strong>推广产品：</strong>选择“Android应用”，详情参考[推广产品](https://developer.huawei.com/consumer/cn/doc/promotion/ads_toufang01-0000001057732432#ZH-CN_TOPIC_0000001057732432__zh-cn_topic_0000001205953939_zh-cn_topic_0000001105216776_li8342416193416)<strong>。</strong>
...
2. 创建广告任务。
   ...
   ![](./img/zh-cn_image_0000002561027604_cab2584ff68c.png)
   ...
   - <strong>推广产品详情：</strong>请填写您所需投放的Android应用ID/包名。（应用ID格式：Cxxxxxxxx，请前往华为应用市场页面查看。例如：应用地址为``https://appgallery.huawei.com/app/C12345678``，则其ID为“C12345678”。应用包名例如：com.huawei.xxxxx）
   - <strong>推广目的：</strong>
   ...
   - <strong>定向：</strong>详情参考[定向设置](https://developer.huawei.com/consumer/cn/doc/promotion/ads_dingxiang-0000001532239189)。
     ...
     ![](./img/note_3.0-zh-cn_f55e93c83c41.png) 

     定向设置中“APP安装”选项，如需提升应用的下载量，请选择“未安装”，如需提升应用活跃用户数，请选择“已安装”。
   - <strong>版位</strong>：支持选择通用版位或自动版位。

     ![](./img/zh-cn_image_0000002313598260_1c16a92f31a0.png "点击放大")
     ...
     - 自动版位：自动版位表示系统自动为您选择效果较佳的位置进行展示广告，您只需要添加元素，系统会根据您提供的图片、视频等素材，为您自动生成多个版位的创意。
       ...
       ![](./img/note_3.0-zh-cn_9ed88e33f694.png) 
...
3. 添加广告创意。
   ...
   - <strong>创意制作：</strong>您需要先选择创意样式及尺寸，并添加对应的创意图片或视频、设置品牌名称和描述信息等，详情参见[版位规则](https://developer.huawei.com/consumer/cn/doc/promotion/ads-bwgz-0000002505500133)。
     ...
     ![](./img/zh-cn_image_0000002313438496_cc2f6a2bbfa1.png)
   ...
   - <strong>点击按钮：</strong>您可以根据实际情况选择所需展示的按钮名称。
...
4. 提交预览，如确认无误单击确认即可完成创意创建。
   ...
   ![](./img/zh-cn_image_0000002347477237_1eaf3a0b6029.png)
