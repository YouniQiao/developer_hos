...
2. 点击“工具”页签，选择“资产管理 &gt; 数据资产”，进入“数据资产”页面。
   ...
   ![](./img/7921bb75459e.png "点击放大")
3. 点击“新建数据源”，配置相关任务设置项。

   ![](./img/348eebb0a4c9.png) 

   如您对接的归因方式为“智能分包”或“监测链接”，归因方式选择“自归因”。

   ![](./img/a38d81b64868.png "点击放大")
...
4. 点击“提交”按钮完成数据源创建。
   ...
   ![](./img/f7c68d4b9e6e.png "点击放大")

   ![](./img/185782590531.png "点击放大")
