...
3. 上传创意（以应用为例）。
   ...
   - <strong>应用直达链接</strong> <strong>：</strong>如果您投放的是应用促活广告，此字段必填，指定应用内内容的链接，如果您想获取应用首页，获取方式请参考<strong>[应用直达链接获取工具](/docs/monetize/promotion/overview-cjjjgg-0000001182873508#section19208102614323)；</strong>如果您想获取应用直达链接的指定页面，请联系您的研发同事获取。
