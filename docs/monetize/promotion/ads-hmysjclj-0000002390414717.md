...
format: md
upstream_id: monetize/promotion/ads-hmysjclj-0000002390414717
...
1. <strong>新建资产</strong>
   ...
   - 可选字段：
     ...
     您可以自定义宏参数名称，宏参数的明细字段，请参照<strong>[配置监测链接](/docs/monetize/promotion/ads_gongjujiance_yy-0000001458784668#配置监测链接)</strong> <strong>。</strong>
