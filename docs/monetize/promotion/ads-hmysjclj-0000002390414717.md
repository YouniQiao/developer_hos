...
original_url: https://developer.huawei.com/consumer/cn/doc/promotion/ads-hmysjclj-0000002390414717
---
# 监测链接跟踪
...
1. <strong>新建资产</strong>
   ...
   - 可选字段：
     ...
     您可以自定义宏参数名称，宏参数的明细字段，请参照<strong>[配置监测链接](https://developer.huawei.com/consumer/cn/doc/promotion/ads_gongjujiance_yy-0000001458784668#section19201181219)</strong> <strong>。</strong>
