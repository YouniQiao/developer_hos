...
1. 注册/登录华为账号。
   ...
   当前广告开户将无需实名认证，若您的广告任务在审核时被鲸鸿动能广告平台判定为涉及[受限内容](/docs/monetize/promotion/industry-admission-rules-0000001189244454#section71534582218)，或者您要使用企业信用卡、线上充值功能，您必须完成实名认证再进行广告投放，如何完成实名认证请参考[实名认证](/docs/monetize/promotion/basic-account-information-0000001224473383#ZH-CN_TOPIC_0000001224473383__zh-cn_topic_0000001160593954_li10577143072315)。
