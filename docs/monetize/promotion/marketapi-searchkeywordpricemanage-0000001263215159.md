...
original_url: /docs/monetize/promotion/marketapi-searchkeywordpricemanage-0000001263215159
format: md
upstream_id: monetize/promotion/marketapi-searchkeywordpricemanage-0000001263215159
...
![](./img/caution_3.0-zh-cn_a06e5a1eb2c3.png) 
...
| 参数 | 必选(M)/可选(O) | 类型 | 描述 |
| --- | --- | --- | --- |
| taskSearchKeyWord | M | List&lt;[SearchKeyWord](/docs/monetize/promotion/marketapi-modle-searchkeyword-0000001181826457)&gt; | 需要修改的任务关键词。 |
