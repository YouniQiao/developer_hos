...
original_url: https://developer.huawei.com/consumer/cn/doc/promotion/adjust-0000001121931660
---
# Adjust
...
2. 关联鲸鸿动能，获取监测链接。
   ...
   3. 选择您想发送至鲸鸿动能的转化事件，点击‘Map event’具体可参考[事件映射](https://developer.huawei.com/consumer/cn/doc/promotion/tracking-shu-0000001139892541)；如需回传付费事件请打开‘In-app revenue’和‘Parameters’。
...
1. 在鲸鸿动能关联事件资产。
   ...
   3. 如果您想在广告投放前对您创建的转化事件进行测试，那您可以进行[手动测试](https://developer.huawei.com/consumer/cn/doc/promotion/tracking-app-overview-0000001209244840#section152255480210)。如果测试失败可参考[常见问题](https://developer.huawei.com/consumer/cn/doc/promotion/faq2-0000001168892523)。
2. 在广告投放中关联监测配置。
