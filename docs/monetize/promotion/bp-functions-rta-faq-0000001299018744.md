...
不是。系统投放和内容推荐投放模式下也可以设置RTA ID，具体要看创建子任务时是否支持设置RTA ID即可。详细支持RTA的任务请参见[支持RTA的任务类型说明](https://developer.huawei.com/consumer/cn/doc/promotion/bp-functions-rta-create-0000001351897861#section3451122195920)。
