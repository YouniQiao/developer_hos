...
format: md
upstream_id: monetize/promotion/bp-functions-rta-faq-0000001299018744
last_sync: 2026-06-07
sync_hash: 0d877bcc
upstream_hash: e5acc9ae0316
---
...
开发者可以与对口的行业运营沟通，提供RTA接口地址，进行时延测试，请注意RTA接口需为HTTPS协议，同时请确保接口响应符合[响应参数定义](/docs/monetize/promotion/bp-functions-rta-interface-request-0000001299178600#响应参数)。
...
不是。系统投放和内容推荐投放模式下也可以设置RTA ID，具体要看创建子任务时是否支持设置RTA ID即可。详细支持RTA的任务请参见[支持RTA的任务类型说明](/docs/monetize/promotion/bp-functions-rta-create-0000001351897861#支持rta的任务类型说明)。
