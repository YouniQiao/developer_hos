...
开发者可以与对口的行业运营沟通，提供RTA接口地址，进行时延测试，请注意RTA接口需为HTTPS协议，同时请确保接口响应符合[响应参数定义](/docs/monetize/promotion/bp-functions-rta-interface-request-0000001299178600#section21761435152419)。
