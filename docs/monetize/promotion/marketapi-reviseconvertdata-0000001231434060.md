---
title: "使用转化行为数据修改人群定向"
displayed_sidebar: promotionSidebar
original_url: https://developer.huawei.com/consumer/cn/doc/promotion/marketapi-reviseconvertdata-0000001231434060
---
# 使用转化行为数据修改人群定向
...
![](./img/caution_3.0-zh-cn_dc0f1ec796f4.png) 
...
| groupId | M | String | 定向包ID，由使用转化行为数据[创建人群定向](https://developer.huawei.com/consumer/cn/doc/promotion/marketapi-useconvertdata-0000001231274168)或[修改人群定向](https://developer.huawei.com/consumer/cn/doc/promotion/marketapi-reviseconvertdata-0000001231434060)时返回。 |
...
| msg | M | String | 返回描述。 |
| groupId | O | String | 修改人群定向后的groupId。 |
...
```
“Curl”
curl -X POST https://connect-api.cloud.huawei.com/api/marketing-api/v2/group/lookalike -H "client_id:***" -H "Authorization:Bearer ***" -H "Content-type: application/json" -d '{"customerId": "200000061","groupId": "1366360** **8563627","groupName": "修改示例转化行为人群名称","condition": "{\"forecast_age_dev\": \"16\"}"}'
```
