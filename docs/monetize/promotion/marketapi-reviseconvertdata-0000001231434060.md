...
| groupId | M | String | 定向包ID，由使用转化行为数据[创建人群定向](/docs/monetize/promotion/marketapi-useconvertdata-0000001231274168)或[修改人群定向](/docs/monetize/promotion/marketapi-reviseconvertdata-0000001231434060)时返回。 |
