...
original_url: /docs/monetize/promotion/marketapi-taskpricemanage-0000001263095175
format: md
upstream_id: monetize/promotion/marketapi-taskpricemanage-0000001263095175
...
| 承载协议 | HTTPS PUT |
| 接口方向 | 开发者服务器-&gt;推广平台服务端 |
| 接口URL | https://connect-api.cloud.huawei.com/api/marketing-api/v2/task/price |
...
![](./img/caution_3.0-zh-cn_56c6c73b6f98.png) 
...
```
PUT https://connect-api.cloud.huawei.com/api/marketing-api/v2/task/price
...
```
“Curl”
curl -X PUT https://connect-api.cloud.huawei.com/api/marketing-api/v2/task/price  -H "Authorization:Bearer   ***" -H "client_id:***" -H "Content-type: application/json" -d '{"taskIds":[200052125, 200052153],"price":20}'
```
