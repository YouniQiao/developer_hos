...
original_url: /docs/monetize/promotion/marketapi-updatebudget-0000001135467044
format: md
upstream_id: monetize/promotion/marketapi-updatebudget-0000001135467044
...
![](./img/caution_3.0-zh-cn_a0795a5fc00e.png) 
...
| budget | M | Double | 预算。限制每天的花费，请填写整数，最低100元，最高 10,000,000元（允许为0，代表不限制日预算）。每天的实际消耗超过预算后，系统会自动停止推广，第二天再推广。  修改后的任务日预算，不能低于当前已经消费金额的105%，以整数为单位向上取整。 |
