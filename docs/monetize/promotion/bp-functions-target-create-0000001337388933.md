...
original_url: /docs/monetize/promotion/bp-functions-target-create-0000001337388933
format: md
upstream_id: monetize/promotion/bp-functions-target-create-0000001337388933
...
3. 在“场景投放”设置模块，点击子任务的操作按钮“编辑”，进入页面：新建用户定向任务。
   ...
   ![](./img/zh-cn_image_0000002556097707_331997e53458.png "点击放大")

   根据需要，新建标签定向包、文件定向包，或选择已有定向。新建的标签定向包、文件定向包，可同时保存到工具定向列表。

   ![](./img/zh-cn_image_0000002525057790_5ec566aee65e.png "点击放大")
