...
![](./img/caution_3.0-zh-cn_9da5ee817ca7.png) 
...
| subTaskUserGroupId | O | String | 子任务对应的定向ID，只能选择已启动定向。说明定向ID请从[新增标签定向](/docs/monetize/promotion/marketapi-addtag-0000001181826407)或者[查询定向列表](/docs/monetize/promotion/marketapi-querytaglist-0000001181946327)接口中获取。 |
