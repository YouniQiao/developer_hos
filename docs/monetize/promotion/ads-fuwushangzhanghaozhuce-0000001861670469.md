...
![](./img/zh-cn_image_0000002507058385_172fd44727fd.png "点击放大")

## 开户步骤

![](./img/note_3.0-zh-cn_f29e7c78b55a.png) 
...
1. <strong>注册华为账号</strong>
   ...
   ![](./img/zh-cn_image_0000002488282204_774917bf665f.png "点击放大")
   ...
   ![](./img/zh-cn_image_0000002548042639_db61cf5c3adc.png "点击放大")

   3）账号登录成功后，跳转至“<strong>选择投放区域</strong>”界面，请选择“<strong>中国大陆</strong>”区域 。

   ![](./img/zh-cn_image_0000002547967121_d81583c04cca.png "点击放大")

   4）区域选择完成后，跳转至“<strong>选择账户类</strong> <strong>型</strong>”界面，请选择“<strong>一级服务商</strong>”账户类型

   ![](./img/zh-cn_image_0000002547967137_38a43b907410.png "点击放大")

   5）选择推广类型&签署协议，选择“展示广告网络”类型的服务商，根据实际情况勾选服务商类型，完成后勾选相关协议，单击“确定进入认证中心”

   ![](./img/zh-cn_image_0000002548049071_f4da08789b92.png "点击放大")
...
2. <strong>实名认证</strong>
   ...
   ![](./img/zh-cn_image_0000002516371056_8d9594307f59.png "点击放大")
3. <strong>开票信息</strong>，<strong>投放前需要补充开票信息。</strong>
   - 发票信息

   根据实际情况，填写发票信息。

   ![](./img/zh-cn_image_0000002516540704_f01741fd53d5.png "点击放大")

   - 邮寄信息

   根据页面信息，填写邮寄信息。

   ![](./img/zh-cn_image_0000002548060609_01b44376de3d.png "点击放大")
