...
- <strong>请求参数：</strong>
  ...
  | product\_type | string | 否 | 推广产品类型，详见[推广产品类型](/docs/monetize/promotion/marketing-api-appendix1-0000001174597591#推广产品类型)。 |
  ...
  - 响应字段
    ...
    | creative\_size\_element\_name | string | 详见[版位元素类型](/docs/monetize/promotion/marketing-api-appendix5-0000001338486113#版位元素类型)，其他为无效的类型，请丢弃。 |
