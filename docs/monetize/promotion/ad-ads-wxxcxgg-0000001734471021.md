...
original_url: https://developer.huawei.com/consumer/cn/doc/promotion/ad-ads-wxxcxgg-0000001734471021
format: md
---
...
微信小程序广告推广指的是在展示广告网络的资源上对您的微信小程序进行推广。
...
1. 创建广告计划。
   ...
   ![](./img/zh-cn_image_0000002313439888_a61f4d38db17.png "点击放大")

   方式二：也可以单击“推广”按钮进入推广页面，然后选择“创建计划”。

   ![](./img/zh-cn_image_0000002347478641_8ad0deb2db65.png "点击放大")

   ![](./img/zh-cn_image_0000002555780686_d07b25e82c70.png "点击放大")
   ...
   - <strong>推广产品：</strong>选择“微信小程序”，详情参考[推广产品](https://developer.huawei.com/consumer/cn/doc/promotion/ads_toufang01-0000001057732432#ZH-CN_TOPIC_0000001057732432__zh-cn_topic_0000001205953939_zh-cn_topic_0000001105216776_li8342416193416)<strong>。</strong>
...
2. 创建广告任务。
   ...
   ![](./img/zh-cn_image_0000002313599704_442733111e71.png)
   ...
   - <strong>推广产品详情：</strong>请填写您所需投放的微信小程序名称、链接以及ID。
   ...
   - <strong>版位</strong>：支持选择通用版位或自动版位。
     ...
     ![](./img/zh-cn_image_0000002313439932_56180596e9c6.png "点击放大")
     ...
     - 自动版位：自动版位表示系统自动为您选择效果较佳的位置进行展示广告，您只需要添加元素，系统会根据您提供的图片、视频等素材，为您自动生成多个版位的创意。
       ...
       ![](./img/note_3.0-zh-cn_9ab19a1fb059.png) 
...
3. 添加广告创意。
   ...
   - <strong>创意制作：</strong>您需要先选择创意样式及尺寸，并添加对应的创意图片或视频、设置品牌名称和描述信息等，详情参见[版位规则](https://developer.huawei.com/consumer/cn/doc/promotion/ads-bwgz-0000002505500133)。
     ...
     ![](./img/zh-cn_image_0000002347478697_8c17c5c7eb96.png)
...
4. 提交预览，如确认无误单击确认即可完成创意创建。
   ...
   ![](./img/zh-cn_image_0000002347358893_e46ffeef9860.png)
