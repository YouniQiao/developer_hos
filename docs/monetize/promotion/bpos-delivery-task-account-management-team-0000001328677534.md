...
- 账号持有者只能邀请管理员，管理员可以邀请优化师和数据分析师。每个管理员只能管理自己所邀请的成员，账号持有者可以管理账号内的所有成员。
  ...
  ![](./img/6f24c418309b.png)

![](./img/293fd3628299.png) 
...
2. 团队成员接受邀请。
   ...
   ![](./img/d1e3e1700c9f.png "点击放大")

   - 如果您加入了两个团队，登录之后可以点击右上角“<strong>切换团队</strong>”，示意图如下：

     ![](./img/9e6ffd3a5bfb.png "点击放大")
