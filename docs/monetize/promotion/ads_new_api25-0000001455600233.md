...
| product\_type | string | 否 | 详见[【推广产品】](/docs/monetize/promotion/ads_meijuzhi-0000001510863205#推广产品) |
| objective\_type | string | 否 | 详见[【推广目的】](/docs/monetize/promotion/ads_meijuzhi-0000001510863205#推广目的) |
...
| creative\_size\_element\_name | string | 详见[【版位元素类型】](/docs/monetize/promotion/ads_api721-0000001641010849#版位元素类型)  其他为无效的类型，请丢弃 |
...
| text | string | 按钮文案文本 |
| support\_product\_type | string | 支持的推广产品，多值以逗号分隔  取值见[【推广产品】](/docs/monetize/promotion/ads_meijuzhi-0000001510863205#推广产品)枚举值 |
| support\_objective\_type | string | 支持的应用推广目的，多值以逗号分隔。推广产品为应用时有效  取值见[【推广目的】](/docs/monetize/promotion/ads_meijuzhi-0000001510863205#推广目的)枚举值 |
...
| --- | --- | --- |
| 参数名称 | 类型 | 描述 |
| element\_type | string | 元素类型  详见[【元素类型】](/docs/monetize/promotion/ads_meijuzhi-0000001510863205#元素类型) |
...
| has\_cover | string | 视频是否有封面  video使用  详见[【视频是否有封面】](/docs/monetize/promotion/ads_meijuzhi-0000001510863205#视频是否有封面) |
...
| shape | string | 元素形状  详见[【元素形状】](/docs/monetize/promotion/ads_meijuzhi-0000001510863205#元素形状) |
...
| --- | --- | --- |
| 参数名称 | 类型 | 描述 |
| product\_type | string | 推广产品  详见[【推广产品】](/docs/monetize/promotion/ads_meijuzhi-0000001510863205#推广产品) |
| objective\_type | string | 推广目的  详见[【推广产品】](/docs/monetize/promotion/ads_meijuzhi-0000001510863205#推广产品) |
