...
format: md
upstream_id: monetize/promotion/marketing-api-data-campaign-0000001128597860
...
![](./img/note_3.0-zh-cn_64bc16e348de.png) 

本接口不支持查询合约数据。

- <strong>请求地址：</strong>请根据您的就近区域进行选择

  <strong>亚非拉：</strong>https://ads-dra.cloud.huawei.com/openapi/v2/reports/campaign/query

  <strong>俄罗斯：</strong>https://ads-drru.cloud.huawei.ru/openapi/v2/reports/campaign/query

  <strong>欧洲：</strong>https://ads-dre.cloud.huawei.com/openapi/v2/reports/campaign/query
...
- <strong>请求示例</strong>
  ...
  POST openapi/v2/reports/campaign/query HTTP/1.1
...
- <strong>响应</strong>参数
  ...
  | campaign\_id | string | 是 | 推广计划ID。 |
  | campaign\_name | string | 是 | 推广计划名称。 |
