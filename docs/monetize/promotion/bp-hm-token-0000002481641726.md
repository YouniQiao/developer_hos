...
original_url: /docs/monetize/promotion/bp-hm-token-0000002481641726
format: md
upstream_id: monetize/promotion/bp-hm-token-0000002481641726
...
| client\_id | M | String(256) | 客户端ID，即[创建API客户端](/docs/monetize/promotion/bp-hm-callback-0000002513681587#section1040426172715)中生成的“客户端ID”。 |
| client\_secret | M | String(2048) | 客户端密钥，即[创建API客户端](/docs/monetize/promotion/bp-hm-callback-0000002513681587#section1040426172715)中生成的“密钥”。 |
