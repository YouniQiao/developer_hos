...
| client\_id | M | String(256) | 客户端ID，即[创建API客户端](/docs/monetize/promotion/bp-hm-callback-0000002513681587#h2创建api客户端)中生成的“客户端ID”。 |
| client\_secret | M | String(2048) | 客户端密钥，即[创建API客户端](/docs/monetize/promotion/bp-hm-callback-0000002513681587#h2创建api客户端)中生成的“密钥”。 |
