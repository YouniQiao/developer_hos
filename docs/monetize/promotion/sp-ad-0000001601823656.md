...
4. 上传元素<strong>。</strong>
   ...
   - 如果您选择的推广产品为应用，则需要填写如下信息：
     ...
     - <strong>应用直达链接</strong> <strong>：</strong>应用下载选填，应用促活必填，指定应用内内容的详情页，如果您想获取应用首页，获取方式请参考<strong>[应用直达链接获取工具](/docs/monetize/promotion/overview-cjjjgg-0000001182873508#section19208102614323)；</strong>如果您想获取应用直达链接的指定页面，请联系您的研发同事获取。
