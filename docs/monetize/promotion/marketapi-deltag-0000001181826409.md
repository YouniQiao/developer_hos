...
original_url: /docs/monetize/promotion/marketapi-deltag-0000001181826409
format: md
upstream_id: monetize/promotion/marketapi-deltag-0000001181826409
...
| 承载协议 | HTTPS DELETE |
| 接口方向 | 开发者服务器-&gt;推广平台服务端 |
| 接口URL | https://connect-api.cloud.huawei.com/api/marketing-api/v2/group |
...
![](./img/caution_3.0-zh-cn_ffbbae1cbd32.png) 
...
```
DELETE https://connect-api.cloud.huawei.com/api/marketing-api/v2/group
...
```
“Curl”
curl -X DELETE -H "Authorization:Bearer ***" -H "client_id:***" -H "Content-type: application/json"  -d '{"groupId":"792323491122256116"}' https://connect-api.cloud.huawei.com/api/marketing-api/v2/group
```
