...
original_url: https://developer.huawei.com/consumer/cn/doc/promotion/marketapi-bidstatus-0000001181826433
format: md
---
...
| 承载协议 | HTTPS POST |
| 接口方向 | 开发者服务器-&gt;推广平台服务端 |
| 接口URL | https://connect-api.cloud.huawei.com/api/marketing-api/v2/task/bidstatus |
...
![](./img/caution_3.0-zh-cn_aa4170a8f3e4.png) 
...
```
POST  https://connect-api.cloud.huawei.com/api/marketing-api/v2/task/bidstatus
...
| msg | M | String | 返回描述。 |
| bidDetails | O | List&lt;[BidDetail](https://developer.huawei.com/consumer/cn/doc/promotion/marketapi-modle-biddetail-0000001181826449)&gt; | 竞价详情。 |
...
```
{
  ...
  "bidDetails":{
      "taskId":200052093,
      "promoteDay":"2021-03-04",
      "isProxyBid":"N",
      "proxyMaxPrice":"137.00",
      "bidStatus":"LEAD",
      "price":42.00,
      "bidTime":"2021-02-24 16:53:14",
      "backwardReason":"200052093"
   }
}
```
...
```
“Curl”
curl -X POST  https://connect-api.cloud.huawei.com/api/marketing-api/v2/task/bidstatus  -H "Authorization:Bearer   ***" -H "client_id:***" -H "Content-type: application/json" -d '{ "taskIds":[200052202,200052192]}'
```
