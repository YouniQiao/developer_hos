...
upstream_id: monetize/promotion/tracking-js-0000001140151431
...
在同一个广告账户中，您使用DTM跟踪第一个网页链接并手动测试成功后，如果您再次跟踪相同域名的网页链接时（例如: www.<strong>example.com</strong>/test/create中加粗部分），无需再次[手动测试](/docs/monetize/promotion/manual-conversion-testing-0000001221434335#网页测试)，系统默认测试成功，您创建的转化指标状态会自动变为”已启用“。
