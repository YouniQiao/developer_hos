...
original_url: https://developer.huawei.com/consumer/cn/doc/promotion/marketapi-delmaterial-0000001181946333
---
# 删除素材
...
![](./img/caution_3.0-zh-cn_df4a7b046086.png) 
...
| 参数 | 必选(M)/可选(O) | 类型 | 描述 |
| --- | --- | --- | --- |
| ids | M | List&lt;Long&gt; | 素材ID。  集合长度最大100。 |
...
```
DELETE https://connect-api.cloud.huawei.com/api/marketing-api/v2/material
...
| msg | M | String | 返回描述。 |
| failedIds | O | List&lt;Long&gt; | 删除失败素材ID列表。 |
...
```
“Curl”
curl -X DELETE https://connect-api.cloud.huawei.com/api/marketing-api/v2/material  -H "Authorization:Bearer ***" -H "client_id:***" -H "Content-type: application/json"-d '{"ids":[34,35]}'
```
