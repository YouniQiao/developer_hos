...
2. 调用ContentResolver.query接口，第1个参数传入Uri对象，第4个参数传入应用包名。
   ...
   ![](./img/0000000000011111111.20251117124640.11560116434532877772803144174863:50001231000000:2800:6A7C1419B0BC0B022CBF032DAC9FB9AC33542DA03C6B3D74C4AD9A606671FD75_3796298005f7.png) 
...
3. 解析ContentResolver.query接口返回的“Cursor”字段值。
   ...
   - 如果“Cursor”字段值不为空，请进一步解析数据。
     ...
     ![](./img/0000000000011111111.20251117124640.59524627108043553760624502747536:50001231000000:2800:97E0131C5C4C8C9FACD9FB54510D7F4D942B695209764D4FECE83A42C95200BD_614804ff839e.png) 
...
5. 完成客户端新版本开发后，打包新版本应用进行调测，详情请参考[功能调试](https://developer.huawei.com/consumer/cn/doc/promotion/bp-functions-intelligent-subcontract-debug-0000001284968724)。
   ...
   ![](./img/0000000000011111111.20251117124640.32542177979143765848509402397251:50001231000000:2800:9CD9EC79DEE5AA98E65DDC743E0FEEB403F973643C7ECD79B8B9A57BD14BA0EC_37f7e6917020.png) 
