...
original_url: https://developer.huawei.com/consumer/cn/doc/promotion/ads-spcxhhtg-0000002313600784
---
# 促销活动推广
...
1. 创建广告计划。
   ...
   ![](./img/zh-cn_image_0000002347362557_31e682d7e66b.png "点击放大")

   方式二：也可以单击“推广”按钮进入推广页面，然后选择“创建计划”。

   ![](./img/zh-cn_image_0000002313603404_0e42424fa6fa.png "点击放大")

   ![](./img/zh-cn_image_0000002313443652_8b94faed653c.png)

   - <strong>营销目标：</strong>选择“商品销售”，详情参考[营销目标](https://developer.huawei.com/consumer/cn/doc/promotion/ads_toufang01-0000001057732432#ZH-CN_TOPIC_0000001057732432__zh-cn_topic_0000001205953939_zh-cn_topic_0000001105216776_li07111843183611)。
   ...
   - <strong>推广产品：</strong>选择“促销活动”，详情参考[推广产品](https://developer.huawei.com/consumer/cn/doc/promotion/ads_toufang01-0000001057732432#ZH-CN_TOPIC_0000001057732432__zh-cn_topic_0000001205953939_zh-cn_topic_0000001105216776_li8342416193416)<strong>。</strong>
...
2. 创建广告任务。
   ...
   ![](./img/zh-cn_image_0000002347482401_b79850a1514b.png)
   ...
   - <strong>广告投放类型</strong>：选择“正式投放”。如果您希望在正式投放之前对投放进行测试，您可以创建[试投放](https://developer.huawei.com/consumer/cn/doc/promotion/afs-stfgg-0000002347483153)任务。
   - <strong>推广产品详情：</strong>请填写您所需投放的Android应用包名或ID。（应用ID格式：Cxxxxxxxx，请前往华为应用市场页面查看。例如：应用地址为&lt;https://appgallery.huawei.com/&gt;app/C12345678，则其ID为“C12345678”。应用包名例如：com.huawei.xxxxx）
   ...
   - <strong>版位</strong>：支持选择通用版位或自动版位。
     ...
     ![](./img/zh-cn_image_0000002347362565_f3cca239106b.png "点击放大")
     ...
     - 自动版位：自动版位表示系统自动为您选择效果较佳的位置进行展示广告，您只需要添加元素，系统会根据您提供的图片、视频等素材，为您自动生成多个版位的创意。
       ...
       ![](./img/note_3.0-zh-cn_1548743b57bf.png) 
...
3. 添加广告创意。
   ...
   - <strong>创意制作：</strong>您需要先选择创意样式及尺寸，并添加对应的创意图片或视频、设置品牌名称和描述信息等，详情参见[版位规则](https://developer.huawei.com/consumer/cn/doc/promotion/ads-bwgz-0000002505500133)。
     ...
     ![](./img/zh-cn_image_0000002313603408_fb655182023e.png)
   ...
   - <strong>落地页链接：</strong>落地页链接是您想要推广内容的信息承载页面，用户点击广告创意时，会优先打开落地页，再进行下载安装如果您选择了默认落地页，则使用平台默认的落地页链接针对全网通投任务，如果您使用落地页，在展示广告网络以及搜索广告网络会使用您的落地页，应用市场网络会使用应用市场详情页作为承接页面。
...
4. 提交预览，如确认无误单击确认即可完成创意创建。
   ...
   ![](./img/zh-cn_image_0000002313443656_edaca9da3e54.png)
