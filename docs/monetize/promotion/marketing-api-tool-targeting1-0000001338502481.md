...
- <strong>请求参数：</strong>
  ...
  | current\_custom\_location\_struct | Struct2 | 否 | 自定义地理位置-当前-包含，详见[海外地域字典数据](/docs/monetize/promotion/marketing-api-tool-targeting7-0000001286343134#ZH-CN_TOPIC_0000001286343134__li1079145116117)。 |
  | not\_current\_custom\_location\_struct | Struct2 | 否 | 自定义地理位置-当前-排除，详见[海外地域字典数据](/docs/monetize/promotion/marketing-api-tool-targeting7-0000001286343134#ZH-CN_TOPIC_0000001286343134__li1079145116117)。 |
