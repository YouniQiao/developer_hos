...
original_url: /docs/monetize/promotion/ads_youhua_dpa15-0000001888130718
format: md
upstream_id: monetize/promotion/ads_youhua_dpa15-0000001888130718
...
您可通过Marketing API接口查询商品库、创建商品库、更新商品库、删除商品库、查询商品库筛选条件取值、查询符合条件的商品数量、查询商品库入库失败记录、更新商品价格、批量下架商品、查询商品库动态模板。接口详情可参考[Marketing API 使用指南&gt;DPA商品库](/docs/monetize/promotion/ads_mapi_spk04-0000001195380810)。
