...
1. 根据[创建API客户端](#h2创建api客户端)中获取的“客户端ID”和“密钥”调用[获取Token](/docs/monetize/promotion/bp-hm-token-0000002481641726)接口到华为[AppGallery Connect平台](https://developer.huawei.com/consumer/cn/service/josp/agc/index.html#/)进行鉴权，鉴权通过后将获得用于访问AppGallery Connect API的Access Token。
