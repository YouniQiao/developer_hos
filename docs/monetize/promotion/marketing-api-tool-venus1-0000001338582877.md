...
- <strong>请求参数：</strong>
  ...
  | landing\_page\_style | string | 否 | 落地页风格，详见[维纳斯落地页风格类型](/docs/monetize/promotion/marketing-api-appendix1-0000001174597591#维纳斯落地页风格类型)。 |
  | landing\_page\_type | string | 否 | 落地页类型，详见[维纳斯落地页类型](/docs/monetize/promotion/marketing-api-appendix1-0000001174597591#维纳斯落地页类型)。 |
  ...
  - 响应字段
    ...
    | landing\_page\_style | string | 落地页风格，详见[维纳斯落地页风格类型](/docs/monetize/promotion/marketing-api-appendix1-0000001174597591#维纳斯落地页风格类型)。 |
    | landing\_page\_type | string | 落地页类型，详见[维纳斯落地页类型](/docs/monetize/promotion/marketing-api-appendix1-0000001174597591#维纳斯落地页类型)。 |
