...
使用搜索投放建议词功能，系统会根据应用属性、投放潜力、未来搜索量、转化数据等维度为您定制好搜索建议词列表，实现高效选词。按优质、行业、热门、潜力四个推荐理由类型进行搜索建议词推荐，同时根据流行度进行排序作为参考，提供搜索投放的新思路，找到更多适合投放的关键词，拉升搜索投放效果，帮助APP精细化运营。

搜索投放建议词功能支持系统搜索、搜索大卡，焦点展台任务类型。
