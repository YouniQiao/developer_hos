...
original_url: /docs/monetize/promotion/marketapi-deltask-0000001135467042
format: md
upstream_id: monetize/promotion/marketapi-deltask-0000001135467042
...
| msg | M | String | 返回描述。 |
| failedTasks | O | List&lt;[TaskFailedDetail](/docs/monetize/promotion/marketapi-modle-taskfaileddetail-0000001135626864)&gt; | 删除失败任务列表。 |
