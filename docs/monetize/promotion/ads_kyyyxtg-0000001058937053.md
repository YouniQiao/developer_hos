...
original_url: https://developer.huawei.com/consumer/cn/doc/promotion/ads_kyyyxtg-0000001058937053
format: md
---
...
快应用/快游戏推广指的是在展示广告网络的资源上对您的快应用/快游戏进行推广。
...
1. 创建广告计划。
   ...
   ![](./img/zh-cn_image_0000002313439272_251ff4795787.png "点击放大")

   方式二：也可以单击“推广”按钮进入推广页面，然后选择“创建计划”。

   ![](./img/zh-cn_image_0000002347478013_afef48bba1e8.png "点击放大")

   ![](./img/zh-cn_image_0000002347358237_62fde58073c7.png)

   - <strong>营销目标：</strong>选择“微服务推广”，详情参考[营销目标](https://developer.huawei.com/consumer/cn/doc/promotion/ads_toufang01-0000001057732432#ZH-CN_TOPIC_0000001057732432__zh-cn_topic_0000001205953939_zh-cn_topic_0000001105216776_li07111843183611)。
   ...
   - <strong>推广产品：</strong>选择“快应用/快游戏”，详情参考[推广产品](https://developer.huawei.com/consumer/cn/doc/promotion/ads_toufang01-0000001057732432#ZH-CN_TOPIC_0000001057732432__zh-cn_topic_0000001205953939_zh-cn_topic_0000001105216776_li8342416193416)<strong>。</strong>
...
2. 创建广告任务。
   ...
   ![](./img/zh-cn_image_0000002313599072_da392db8663e.png)
   ...
   - <strong>推广产品详情：</strong>请填写您所需投放的快应用/快游戏包名和链接，链接由系统根据包名自动生成，默认跳转快应用/快游戏首页，广告主也可修改为指定的快应用/快游戏内详情页面。链接支持的格式为hap://app/&lt;package&gt;/[path][?key=value],需以"/"结尾。
   ...
   - <strong>版位</strong>：支持选择通用版位或自动版位。
     ...
     ![](./img/zh-cn_image_0000002313439288_f7b8c87c0886.png "点击放大")
     ...
     - 自动版位：自动版位表示系统自动为您选择效果较佳的位置进行展示广告，您只需要添加元素，系统会根据您提供的图片、视频等素材，为您自动生成多个版位的创意。
       ...
       ![](./img/note_3.0-zh-cn_a71112a39746.png) 
...
3. 添加广告创意。
   ...
   - <strong>创意制作：</strong>您需要先选择创意样式及尺寸，并添加对应的创意图片或视频、设置品牌名称和描述信息等，详情参见[版位规则](https://developer.huawei.com/consumer/cn/doc/promotion/ads-bwgz-0000002505500133)。
     ...
     ![](./img/zh-cn_image_0000002347478021_f526807377ac.png)
...
4. 提交预览，如确认无误单击确认即可完成创意创建。
   ...
   ![](./img/zh-cn_image_0000002347358241_16d25d7d6baf.png)
