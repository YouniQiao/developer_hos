...
2. 点击上侧“解决方案”页签，点击“卸载召回”，进入卸载召回页面。
   ...
   ![](./img/9908aef14682.png)
3. 点击“召回效果”页签，在左上角选择对应的应用，以及查询时间段，点击右侧“查询”，即可查看到此应用的卸载用户各项数据。

   ![](./img/0a97203087bc.png "点击放大")

   在“召回趋势”统计图区域，可以点击![](./img/1a5ee6bd7a87.png)将展示图切换为折线图，点击![](./img/189401854c38.png)将展示图切换为柱状图，点击![](./img/4863b8728e0a.png)将展示图还原清空。
