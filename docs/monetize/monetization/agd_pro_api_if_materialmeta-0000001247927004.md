...
| creative | O | [AdCreative](/docs/monetize/monetization/agd_pro_api_if_adcreative-0000001294886337) | 原生广告物料。  说明：  仅原生广告会返回，其他类型的展示位无需关注该字段。 |
| appInfo | O | [AdAppInfo](/docs/monetize/monetization/agd_pro_api_if_adappinfo-0000001248246048) | 应用信息。 |
...
| trackUrls | O | List [EventTrack](/docs/monetize/monetization/agd_pro_api_if_eventtrack-0000001248086780) | 其他事件跟踪上报地址。  具体请参见[EventTrack](/docs/monetize/monetization/agd_pro_api_if_eventtrack-0000001248086780)。 |
