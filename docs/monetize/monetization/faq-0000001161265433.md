...
original_url: https://developer.huawei.com/consumer/cn/doc/monetize/faq-0000001161265433
format: md
---
...
部分国家和地区（例如中国大陆）暂时不支持接入流量变现服务，各国家或地区（以账号注册地为准）的情况请参考：[受限说明](https://developer.huawei.com/consumer/cn/doc/monetize/restriction-0000001061730052)

**Q5：想注册为企业开发者，但是注册为了个人开发者。该怎么办？**

A**：**目前不支持更改开发者账号类型。若您的华为账号/开发者账号没有关联其他业务，建议您先注销这个账号（此操作会同步删除您华为账号下关联的所有其他信息，如华为开发者联盟华为账号、应用市场华为账号、云空间存储的信息等等，请谨慎操作。详情请参考：[注销账号](https://developer.huawei.com/consumer/cn/doc/start/account-management-0000001052865467#section18429256122617)）,再重新注册新的账号，注册流程可查看此文档：[账号注册-接入流程-变现接入-鲸鸿动能流量变现（非中国大陆区） - 华为HarmonyOS开发者](https://developer.huawei.com/consumer/cn/doc/monetize/registration-0000001061752683)
