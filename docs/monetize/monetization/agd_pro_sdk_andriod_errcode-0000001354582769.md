...
| **1013** | DEVICE\_NO\_PERMISSION | 媒体无权访问。  **如果使用测试状态的展示位调试，需要在接入测试中配置设备的OAID，否则会上报此错误码。**  具体配置请参见[接入测试](/docs/monetize/monetization/agd_pro_sdk_andriod_commission-0000001461023573#接入测试)。 |
