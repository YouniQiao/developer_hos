...
| --- | --- | --- | --- |
| 测试 | 编辑、查看报告、删除 | 不可见 | 仅测试设备上的展示位为此状态。  如需将“测试”状态的展示位用于请求调试，请将测试设备的OAID添加到AGC页面的“接入测试”菜单中，否则将报错1013错误，具体可参见[接入测试](/docs/monetize/monetization/agd_pro_sdk_andriod_commission-0000001461023573#接入测试)。 |
