...
format: md
upstream_id: monetize/monetization/agd_pro_sdk_andriod_get-report-0000001505520645
...
| 参数名称 | 必选(M)/可选(O) | 类型 | 参数说明 |
| --- | --- | --- | --- |
| rtnCode | M | `Integer` | 返回码。  具体返回码请参见[报表接口错误码](/docs/monetize/monetization/agd_pro_sdk_andriod_errcode-0000001354582769#报表接口错误码)。 |
