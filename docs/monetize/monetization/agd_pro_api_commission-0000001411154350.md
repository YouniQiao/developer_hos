...
original_url: /docs/monetize/monetization/agd_pro_api_commission-0000001411154350
format: md
upstream_id: monetize/monetization/agd_pro_api_commission-0000001411154350
...
3. 点击右侧“添加设备”，填写“设备OAID”和设备“国家/地区”。
   ...
   ![](./img/agd_pro_api_commission-0000001411154350_0.png "点击放大")
...
3. 点击右侧“新建屏蔽规则”。
   ...
   ![](./img/agd_pro_api_commission-0000001411154350_1.png)

   在“屏蔽规则设置”页面，设置规则名称、屏蔽关键词、屏蔽包名、屏蔽广告行业，设置完成后点击“提交”。

   ![](./img/agd_pro_api_commission-0000001411154350_2.png)

   “屏蔽关键词”和“屏蔽包名”最多配置100个，请按要求进行配置。

   ![](./img/agd_pro_api_commission-0000001411154350_3.png)
