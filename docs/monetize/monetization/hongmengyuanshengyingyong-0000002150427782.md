...
提示：接入开发时需注意申请OAID权限，调用getOAID接口需要申请ohos.permission.APP\_TRACKING\_CONSENT权限，并获取用户授权（默认开启权限），详情请查看[《Ads Kit广告标识服务》](/docs/dev/app-dev/application-services/ads-kit-guide/oaid-service)。
