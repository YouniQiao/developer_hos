...
[](https://contentcenter-videovali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_300_3/c1/v3/Y3tm89YXTTWath4WFfYf7w/zh-cn_attachment_0000002594167112.mp4?HW-CC-KV=V1&HW-CC-Date=20260723T090136Z&HW-CC-Expire=86400&HW-CC-Sign=63D1E0166C2C30BEA112C77CAB5F928908F565266E5D95AA4FFF626ABFB70F63)

![](./img/zh-cn_image_0000002594327132.png "点击放大")

### 用户体验与个性定义

![](./img/zh-cn_image_0000002594327256.png "点击放大")
...
![](./img/zh-cn_image_0000002616101407.png "点击放大")
...
![](./img/zh-cn_image_0000002585668690.png "点击放大")

不同位置或存在方式的交互组件推荐使用不同的材质档位，保障在应用界面中呈现出最佳的视觉效果。

|  |  |
| --- | --- |
| ![](./img/zh-cn_image_0000002585668944.png "点击放大")  当组件在顶部悬浮时，推荐使用 ULTRA\_THIN 枚举参数，并结合渐变模糊效果延展顶部内容展示空间，增强沉浸感和精致感。 | ![](./img/zh-cn_image_0000002585669780.png "点击放大")  当组件在底部悬浮时，推荐使用 THIN 枚举参数，并结合渐变颜色蒙层延展底部内容展示空间，增强沉浸感和精致度。 |
| ![](./img/zh-cn_image_0000002585509920.png "点击放大")  当组件非常驻在页面之上，且可能会在任意位置弹出时，建议适配 THICK 枚举参数，以确保复杂场景下内容的可读性。 | ![](./img/zh-cn_image_0000002616030155.png "点击放大")  半模态、弹出框组件通常占据面积较大，内容丰富度更强，推荐使用 ULTRA\_THICK 枚举参数，以确保在复杂场景下内容的可读性。 |