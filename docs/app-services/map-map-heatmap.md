...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| color | Record | 是 | 热力图颜色。 - key：数据密度，取值范围[0, 1]。 - value：颜色渐变值，ARGB格式。 异常值不处理。 |
...
| 类型 | 说明 |
| --- | --- |
| Record | 热力图颜色。 - key：数据密度，取值范围[0, 1]。 - value：颜色渐变值，ARGB格式。 |
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| intensity | number | Record | 是 | 热力图强度，如果是number类型，所有层级使用同一个强度。 - key：层级，取值范围[2, 20]。 - value：热力图强度，取值范围大于0。 异常值不处理。 |
...
| 类型 | 说明 |
| --- | --- |
| number | Record | 热力图强度，如果是number类型，所有层级使用同一个强度。 - key：层级，取值范围[2, 20]。 - value：热力图强度，取值范围大于0。 |
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| opacity | number | Record | 是 | 热力图透明度，如果是number类型，所有层级使用同一个透明度。 - key：层级，取值范围[2, 20]。 - value：热力图透明度，取值范围[0, 1]，0表示完全不透明，1表示完全透明。 异常值不处理。 |
...
| 类型 | 说明 |
| --- | --- |
| number | Record | 热力图透明度，如果是number类型，所有层级使用同一个透明度。 - key：热力图颜色渐变层级，取值范围[2, 20]。 - value：热力图透明度，取值范围[0, 1]，0表示完全不透明，1表示完全透明。 |
...
| **参数名** | **类型** | 必填 | **说明** |
| --- | --- | --- | --- |
| radius | number | Record | 是 | 热力图半径，如果是number类型，所有层级使用同一个半径。 - key：层级，取值范围[2, 20]。 - value：热力图半径，取值范围：[1, +∞)。 异常值不处理。 |
...
| 类型 | 说明 |
| --- | --- |
| number | Record | 热力图半径，如果是number类型，所有层级使用同一个半径。 - key：层级，取值范围[2, 20]。 - value：热力图半径，取值范围：[1, +∞)。 |
