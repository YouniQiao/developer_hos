...
- **承载协议：** HTTPS POST
- **接口方向：** 开发者服务器 -> 华为支付服务器
- **接口URL：** https://petalpay-developer.cloud.huawei.com.cn/api/v1/realname/auth/result
...
| 参数 | 是否必选 | 类型 | 说明 |
| --- | --- | --- | --- |
| realNameAuthId | 是 | String | 实名信息授权ID。[应用端接口](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/payment-realnameservice#startrealnameauth)用户授权实名信息时返回的授权ID，长度范围为1-10。 |
