...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回一个[NotificationExtensionSubscriptionInfo[]](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-inner-notificationextensionsubscriptioninfo)对象数组，表示应用的订阅信息。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象。返回true表示功能已启用；返回false表示功能未启用。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回获取指定应用中“已获取的本机通知”通知开关开启的应用列表。 |
...
| 类型 | 说明 |
| --- | --- |
| [_NotificationExtensionSubscriptionInfo](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-inner-notificationextensionsubscriptioninfo) | 用于描述通知扩展订阅的信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [_UserGrantSetting](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-inner-notification-notificationcommondef#usergrantsetting) | 用户授权的设置信息。 |
