...
![](./img/note_3.0-zh-cn.png) 相关参数获取及详细说明参见运营机构或受理服务机构（客服热线956196）提供的开发指引。
...
| orderInfo | [EcnyOrderInfo](#ecnyorderinfo) | 是 | 拉起收银台传入的订单信息。不传会报401参数错误。 |

返回值：

| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象。返回支付结果信息。 |
