...
2. 账单下载后，建议遍历附件目录以获取csv后缀的文件进行解析。
...
- **承载协议：** HTTPS GET
- **接口方向：** 开发者服务器 -> 华为支付服务器
- **接口URL：** https://petalpay-developer.cloud.huawei.com.cn/api/v1/partner/bill/trade-bill/downloadInfo?billDate=xxxxxx[&subMercNo=xxxxxx]
