...
| API使用情况举例 | 使用的最高版本API为5.0.0(12)。 | 使用的最高版本API为5.0.1(13)。 | 使用的最高版本API为5.0.1(13)。  应用使用到的某个API在5.0.2(14)进行了行为变更，变更要求应用适配并且未做[版本隔离](/docs/design/app-compatibility/app-compatibility-influence-factor#section84462041135416)。 | 使用的最高版本API为5.0.1(13)。  应用使用到的某个API在5.0.2(14)进行了行为变更，变更要求应用适配，但变更在5.0.2(14)进行[版本隔离](/docs/design/app-compatibility/app-compatibility-influence-factor#section84462041135416)。 |
...
- ****[API兼容性保护和告警屏蔽](/docs/dev/release-notes/app-compatibility-apis-compatibility)****
- ****[CAPI兼容性保护高阶用法](/docs/design/app-compatibility/c-api-compatibility-warning)****
- ****[应用升级targetSDKVersion兼容低版本指导](/docs/design/app-compatibility/app-compatibility-upgrade)****
- ****[应用集成三方库（har包）的兼容性指导](/docs/design/app-compatibility/app-compatibility-third-har)****
- ****[应用集成“集成态hsp”的兼容性指导](/docs/design/app-compatibility/app-compatibility-share-hsp)****
- ****[UI自定义组件兼容性指导](/docs/design/app-compatibility/app-compatibility-ui-component)****
