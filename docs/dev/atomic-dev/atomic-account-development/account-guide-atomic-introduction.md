...
| --- | --- |
| [获取头像昵称](https://developer.huawei.com/consumer/cn/doc/atomic-guides/account-guide-atomic-get-avatar-nickname-overview) | Phone、Tablet、PC/2in1、Car |
| [获取手机号](https://developer.huawei.com/consumer/cn/doc/atomic-guides/account-guide-atomic-get-phone-overview) | Phone、Tablet、PC/2in1、Car |
| [获取收货地址](https://developer.huawei.com/consumer/cn/doc/atomic-guides/account-guide-atomic-choose-address) | Phone、Tablet、PC/2in1、Car |
...
| [获取风险等级](https://developer.huawei.com/consumer/cn/doc/atomic-guides/account-guide-atomic-get-risklevel) | Phone、Tablet、PC/2in1、Car |
...
* 模拟器仅支持应用统一认证服务[authentication](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/account-api-authentication)的登录和授权能力。
* 不支持Wearable设备模拟器。
