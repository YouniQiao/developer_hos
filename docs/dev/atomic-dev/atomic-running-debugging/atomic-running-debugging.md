...
* **[使用元服务体检工具](https://developer.huawei.com/consumer/cn/doc/atomic-guides/atomic-service-appanalyzer)**
* **[元服务上架审核预检](https://developer.huawei.com/consumer/cn/doc/atomic-guides/atomic-service-check)**
