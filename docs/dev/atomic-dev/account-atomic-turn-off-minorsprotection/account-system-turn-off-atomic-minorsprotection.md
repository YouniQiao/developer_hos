---
title: "关闭系统的未成年人模式"
original_url: https://developer.huawei.com/consumer/cn/doc/atomic-guides/account-system-turn-off-atomic-minorsprotection
---
...
元服务可调用系统的未成年人模式关闭接口[leadToTurnOffMinorsMode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/account-api-minorsprotection#leadtoturnoffminorsmode)，验证家长密码后关闭系统的未成年人模式。

![](./img/2319b5af.png)

用户在元服务内操作时，预期可能是关闭元服务的未成年人模式，而非关闭整个系统的未成年人模式（其他元服务的未成年人模式也会随之关闭）。如果开发者选择这种接入方式，建议在界面上告知用户即将关闭系统的未成年人模式。
...
2. 当系统未成年人模式已开启，且用户需要在元服务内关闭未成年人模式时，元服务可调用[leadToTurnOffMinorsMode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/account-api-minorsprotection#leadtoturnoffminorsmode)引导关闭系统未成年人模式流程，关闭整个系统的未成年人模式。
...
4. 在元服务内调用开启或关闭系统未成年人模式接口，如元服务需弹出toast或弹框告知用户“未成年人模式已开启或关闭”，须在接口执行完成之后，在接口的then方法里面弹出toast或弹框，否则可能出现因系统页面未完全关闭，导致toast无法正常展示的情况。
...
3. 当系统未成年人模式已开启，且用户主动关闭元服务内未成年人模式时，元服务需要调用[leadToTurnOffMinorsMode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/account-api-minorsprotection#leadtoturnoffminorsmode)引导用户关闭系统的未成年人模式。
