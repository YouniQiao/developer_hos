...
通过[has.request](/docs/dev/atomic-dev/ascf/apis-network/apis-request#hasrequest)发起一个数据请求，支持常见的GET、POST、OPTIONS、HEAD、PUT、DELETE、TRACE、CONNECT方法。
...
使用[has.connectSocket](/docs/dev/atomic-dev/ascf/apis-network/apis-websocket#hasconnectsocket)创建一个新的WebSocket实现连接，并且收发数据：
