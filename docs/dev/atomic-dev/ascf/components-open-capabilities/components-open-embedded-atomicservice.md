...
* [has.setScreenBrightness](/docs/dev/atomic-dev/ascf/apis-device/apis-screen#hassetscreenbrightness)、[has.onUserCaptureScreen](/docs/dev/atomic-dev/ascf/apis-device/apis-screen#hasonusercapturescreen)和[has.setKeepScreenOn](/docs/dev/atomic-dev/ascf/apis-device/apis-screen#hassetkeepscreenon)接口会失效。
* [has.getSystemInfo](/docs/dev/atomic-dev/ascf/apis-basis/apis-system-info#hasgetsysteminfo)接口会失效，[has.getSystemInfoSync](/docs/dev/atomic-dev/ascf/apis-basis/apis-system-info#hasgetsysteminfosync)和[has.getWindowInfo](/docs/dev/atomic-dev/ascf/apis-basis/apis-system-info#hasgetwindowinfo)接口无法获取到正确的安全区域和窗口宽高。
* [video](/docs/dev/atomic-dev/ascf/components-media-components/components-video)组件设置全屏方向相关属性会失效。
* [has.requestSubscribeMessage](/docs/dev/atomic-dev/ascf/apis-open-apis/apis-message-subscription#hasrequestsubscribemessage)接口会失效。
* [has.onWindowResize](/docs/dev/atomic-dev/ascf/apis-page/apis-window#hasonwindowresize)接口无法获取正确的窗口宽高。
