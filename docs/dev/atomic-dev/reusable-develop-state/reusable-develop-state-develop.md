...
9. 实现元服务的所有页面。
   ...
   在hsp模块的resources/base/profile/router\_map.json配置[系统路由表](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-navigation-jump#配置路由表)信息：
