...
推荐应用开发者在服务器端完成安全地理位置的签名验证，请参考“[Device Certificate Kit 设备真实性证明服务器端开发](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/device-attestation-servers)”。
