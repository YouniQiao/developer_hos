...
当元服务需要完善用户个人资料（头像昵称、手机号、收货地址、发票抬头）时，可通过Account Kit提供的相关能力，引导用户填写、管理相关信息并完成授权。获取头像昵称、手机号、收货地址、发票抬头详细接入体验可参考Account Kit提供的[SampleCode示例工程](https://gitcode.com/HarmonyOS_Samples/account-kit-samplecode-clientdemo-for-atomicservice-arkts)。
