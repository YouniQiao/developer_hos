...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/traffic-v1_1-ts_74-0000002407696246
---
...
1. 检查PersistentStorage存储的Token信息是否持久化在本地。检查“/data/app/el2/100/base/包名/haps/entry/files/persistent\_storage”文件，发现Token信息已经持久化。

   ![](./img/3eff18af.png "点击放大")
