...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/common-v1_26-ts_c220-0000002565329649
...
2. HSP模块HspIndexPage页面->HSP模块HspPage页面->HAR模块HarPage页面，推荐使用Navigation实现。
   1. 在对应的模块内oh-package.json5文件中配置依赖，参考示例如下所示：
      ...
      ```
   2. 在HSP和HAR模块内的配置系统路由表：详情可参考[系统路由表](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-navigation-navigation#系统路由表)。
