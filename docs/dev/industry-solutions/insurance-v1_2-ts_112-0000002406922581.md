...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/insurance-v1_2-ts_112-0000002406922581
---
...
* **方案二**：使用onWillDelete和onDidDelete回调，监听键盘的删除操作。
  ...
  ![](./img/53fa9bc5.gif "点击放大")

  ![](./img/2d9c16f8.png "点击放大")
