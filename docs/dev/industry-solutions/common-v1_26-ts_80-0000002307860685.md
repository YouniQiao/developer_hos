...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/common-v1_26-ts_80-0000002307860685
---
...
* **场景一**：
  ...
  客户端发送普通字符串数据，且服务端接收普通字符串，可直接调用[send](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-socket#send)接口发送。
* **场景二**：
...
* **场景五**：
  ...
  客户端需要发送复合类型的数据，如对象、数组等，可在Socket发送前使用JSON.stringify()转为string类型，若服务端接收普通字符串请参考场景一，若服务端接收二进制流数据请参考场景二。
