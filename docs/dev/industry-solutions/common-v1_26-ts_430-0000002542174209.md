...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/common-v1_26-ts_430-0000002542174209
---
...
class TC_001(TestCase):
    ...
    def process(self):
        ...
        # 方法四,通过模拟屏幕边缘向右或向右滑动手势返回，设置起点的相对坐标尽量靠近屏幕边缘，防止操作页面内的控件左滑或右滑
        self.driver.start_app("com.huawei.hmos.browser")
        self.driver.wait(3)
