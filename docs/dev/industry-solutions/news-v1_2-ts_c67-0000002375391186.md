...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/news-v1_2-ts_c67-0000002375391186
---
...
![](./img/7bfb1d70.png "点击放大")

## 背景知识

* 下拉刷新效果可通过如下方式实现：

  [Refresh](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-refresh)组件可以进行页面下拉操作并显示刷新动效，并通过[onRefreshing](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-refresh#onrefreshing)方法在进入刷新状态时触发回调。
* [Video](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-media-components-video)为用于播放视频文件并控制其播放状态的组件。

## 问题定位

1. 使用DevEco Testing查看列表组件和视频组件，列表组件为Refresh组件，视频组件为Video组件。![](./img/77bfa1a6.png "点击放大")![](./img/aeea5622.png "点击放大")
