---
title: "rcp如何实现流式传输"
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/common-v1_26-ts_c129-0000002524725978
---
...
* **场景1：实时数据流上传**
  ...
  3. 将数据写入缓存区中实时上传。
     ...
     ![](./img/afb91a0c.png "点击放大")
* **场景2：实时数据流获取**

  实时数据流获取能力经常应用于大模型对话场景，将本地用户数据向服务端对应大模型API接口发起post请求后，实时获取数据流数据，实现流式输出效果。
