...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/office-v1_2-ts_30-0000002367617298
---
...
DevEco Studio 6.0.0之前的版本可以手动修改模拟器配置文件config.ini(默认地址为C:\Users\${user}\AppData\Local\Huawei\Emulator\deployed\Huawei\_Phone)来自定义屏幕尺寸。
