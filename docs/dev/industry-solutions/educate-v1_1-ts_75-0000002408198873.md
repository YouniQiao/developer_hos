...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/educate-v1_1-ts_75-0000002408198873
---
...
3. 页面装饰器与路由机制冲突：
   ...
   @Entry装饰器误用：只有被@Entry装饰的组件才能触发onPageShow，但若页面通过NavDestination定义且已包含路由机制，则需使用[onShown](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-navdestination#onshown10)替代onPageShow。此时若错误添加@Entry可能导致生命周期混乱。
