...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/news-v1_2-ts_c152-0000002396788324
---
...
2. 使用DevEco Testing中的UIViewer工具，查看全屏状态下熄屏前后以及小屏状态下的页面布局，发现重新亮屏后的页面布局小屏状态一致。
   * 小屏时页面布局：
     ...
     ![](./img/13a205c1.png "点击放大")
   * 全屏时页面布局：

     ![](./img/688d9d45.png "点击放大")
   * 熄屏后重新亮起时页面布局：

     ![](./img/e073bd6b.png "点击放大")
