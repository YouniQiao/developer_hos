...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/common-v1_26-ts_c243-0000002538292644
---
...
* 场景一：[ohos.permission.READ\_WRITE\_USER\_FILE](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/restricted-permissions#ohospermissionread_write_user_file)允许应用访问并修改用户目录下的文件，是受限权限。排查代码发现，访问文件路径存在问题，未通过指定接口获取。
