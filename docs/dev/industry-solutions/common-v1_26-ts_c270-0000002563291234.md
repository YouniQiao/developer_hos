...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/common-v1_26-ts_c270-0000002563291234
---
...
* **场景三**：
  ...
  1. 主线程的快照文件。
  2. 对比两次dump的子线程快照文件，找出文件大小变化最大和node\_count变化最大的子线程对应的快照文件，当node\_count持续增长而业务没有大量新创建对象时，很有可能存在内存泄露。
