...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/audio-v1_2-ts_54-0000002409151362
---
...
1. 实现PinchGestureExample子组件，Image添加放大缩放手势。
2. 使用addBuilderSpan自定义布局，将PinchGestureExample添加到addBuilderSpan方法中。
