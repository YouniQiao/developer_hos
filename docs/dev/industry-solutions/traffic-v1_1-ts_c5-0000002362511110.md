...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/traffic-v1_1-ts_c5-0000002362511110
---
...
* 可通过以下方法实现页面滑动时的相关功能：
  ...
  | 方法 | 说明 |
  | --- | --- |
  | [onActionStart](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-gestures-pangesture#onactionstart) | Pan手势识别成功回调。 |
  ...
  | [onActionEnd](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-gestures-pangesture#onactionend) | Pan手势识别成功，手指抬起后触发回调。 |
