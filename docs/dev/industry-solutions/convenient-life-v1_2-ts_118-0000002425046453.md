...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/convenient-life-v1_2-ts_118-0000002425046453
---
...
1. 半模态页面实现：使用Stack容器层叠布局两个组件，通过@State变量动态控制组件显隐状态，采用条件渲染实现组件切换。
