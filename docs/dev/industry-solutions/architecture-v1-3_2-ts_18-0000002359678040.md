---
title: "图片尺寸约束"
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/architecture-v1-3_2-ts_18-0000002359678040
---
...
* **场景一**：通过将Image的fitoriginalsize属性设为true，可以在Image组件未设置宽高的情况下适应图源尺寸。具体参考[Column宽高自适应背景图片大小](https://developer.huawei.com/consumer/cn/doc/architecture-guides/educate-v1_1-ts_69-0000002406921685)。
* **场景二**：定义[DecodingOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-image-i#decodingoptions7)，通过[ImageSource](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-image-imagesource)构建PixelMap对象，并基于目标尺寸计算缩放比例后调用scaleSync方法实现动态图片缩放。
