...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/socialcontact-v1_2-ts_c14-0000002442581365
---
...
* [voipCall.on('voipCallUiEvent')](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/call-voipcall#section7587131203319)：订阅[voipCallUiEvent](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/call-voipcall#section26961727970)事件。
  + VOIP\_CALL\_EVENT\_VOICE\_ANSWER：通话语音接听事件。
  + VOIP\_CALL\_EVENT\_VIDEO\_ANSWER：通话视频接听事件。
* [voipCall.reportCallStateChange](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/call-voipcall#section491515915329)：通知应用内通话状态变化，并指定通话类型。
  + 通话状态可以参考[VoipCallState](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/call-voipcall#section24523814719)。
  + 通话类型可以参考[VoipCallType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/call-voipcall#section0933646875)。
...
* 建议在应用内通话中调用[voipCall.on('voipCallUiEvent')](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/call-voipcall#section7587131203319)监听通话事件，当监听到通话视频接听事件时，调用[voipCall.reportCallStateChange](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/call-voipcall#section491515915329)通知通话状态变化，并更新页面UI通话状态显示“通话中。
* 构建上报去电的参数，向Call Service Kit上报去电，参考[voipCall.reportOutgoingCall](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/call-voipcall#section148731244182011)。
