...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/common-v1_26-ts_121-0000002367467374
---
...
1. 本地文件指存储在应用沙箱目录或公共目录中的文件。
   ...
   * 沙箱目录文件预览，代码示例如下：
     ...
     ```
2. rawfile文件预览：预览时需要先将rawfile导入至沙箱路径。代码示例如下：
   ...
   ```
3. 网络文件预览：需要将网络文件先下载到本地，再进行本地文件预览。代码示例如下：
...
1. **统一接口**：无论文件来源如何，都可使用filePreview.[openPreview](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/preview-arkts#section144826162913)接口。
