...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/tools-v1_2-ts_33-0000002343525373
---
...
1. 查看手机设备内存大小。
2. 调用相关API获取相应大小。
3. 对比设备内存大小与API接口返回的大小是否一致。
4. 确认API接口返回的内存值是属于哪一部分的内存。
