...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/tools-v1_2-ts_c59-0000002419301025
---
...
2. 以上日志信息中有存储的文件路径信息：/data/storage/el2/base/haps/entry/files，该文件路径为文件沙箱目录。
