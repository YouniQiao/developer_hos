...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/common-v1_26-ts_c248-0000002540861044
---
...
* 通过命令安装应用。
  1. 获取关联手机的[手动签名](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ide-signing#section297715173233)（调试签名），并配置。
  2. 打包HAP以及依赖的HSP。
