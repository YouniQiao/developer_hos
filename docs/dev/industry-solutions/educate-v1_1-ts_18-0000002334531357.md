...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/educate-v1_1-ts_18-0000002334531357
---
...
* **场景一**：WebviewController相关接口调用时机过早。
...
* **场景二**：
  ...
  使用WebviewController相关接口前调用[getAttachState](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-webview-webviewcontroller#getattachstate20)查询当前controller是否是绑定状态，只有在绑定状态下才能调用相关方法（静态方法除外）。
