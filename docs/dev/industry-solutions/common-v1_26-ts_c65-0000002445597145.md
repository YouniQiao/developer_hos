...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/common-v1_26-ts_c65-0000002445597145
---

## 问题现象

* 场景一：页面切换时，顶部按钮的突出显示未跟随页面滑动进行切换。

  问题现象如下：

  ![](./img/1cb19932.png "点击放大")
* 场景二：拖动顶部页签按钮进行滑动切换时，Tabs页面未同步切换。

  问题现象如下：

  ![](./img/b974dc88.png "点击放大")
