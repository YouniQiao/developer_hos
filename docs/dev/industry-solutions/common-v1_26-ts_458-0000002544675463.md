...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/common-v1_26-ts_458-0000002544675463
---
...
* [序列化支持类型](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-worker#序列化支持类型)包括：

  1.除Symbol之外的基础类型、Date、String、RegExp、Array、Map、Set、ArrayBuffer、TypedArray。
