...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/traffic-v1_1-ts_36-0000002379840716
---
...
![](./img/eb927f1a.png "点击放大")

## 效果预览

可以看到图片一直处于居中，不会出现图片下移的情况。

![](./img/2d7168a0.gif "点击放大")
