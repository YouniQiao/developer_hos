...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/common-v1_26-ts_300-0000002533939207
---
...
* [loginType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/account-api-component-manager#section79023235528)：是LoginWithHuaweiIDButton中标识华为账号登录类型的属性，默认是LoginType.ID，一键登录对应的值是LoginType.QUICK\_LOGIN。
