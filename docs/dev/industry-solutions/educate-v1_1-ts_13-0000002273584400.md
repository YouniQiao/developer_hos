...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/educate-v1_1-ts_13-0000002273584400
---
...
* 方案二：拦截整个默认菜单并使用自定义bindContextMenu代替。
  1. 令Array<TextMenuItem>返回空数组，从而拦截整个editMenu。
...
* 方案三：禁用editMenuOptions的参数editMenu的菜单选项。
  1. 以禁止粘贴为例，定义onCreateMenu方法，使用filter函数切除Array<TextMenuItem>中的粘贴选项。
...
| --- | --- | --- |
| ![](./img/6a7be940.png "点击放大") | ![](./img/af911e7b.png "点击放大") | ![](./img/cbc77108.png "点击放大") |
