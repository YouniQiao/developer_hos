...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/common-v1_26-ts_94-0000002344063425
---
...
1. 代理配置问题：
   * 代理设置错误或未生效：
     ...
     表现：[环境诊断](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ide-environment-config#section1912218441119)报错。
...
3. 服务端与本地环境问题：
   * ohpm服务端暂时不可用：
     ...
     表现：`https://ohpm.openharmony.cn`无法打开，或返回5xx/4xx错误。
