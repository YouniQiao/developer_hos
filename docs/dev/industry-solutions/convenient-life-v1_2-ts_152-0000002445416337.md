...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/convenient-life-v1_2-ts_152-0000002445416337
---
...
![](./img/abd31599.png "点击放大")

## 常见FAQ

Q：热部署没成功就点击运行，会报如下错误：

![](./img/e26db34a.png "点击放大")
