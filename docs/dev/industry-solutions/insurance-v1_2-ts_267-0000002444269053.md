...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/insurance-v1_2-ts_267-0000002444269053
---
...
![](./img/b22be7fd.gif "点击放大")

## 效果预览

![](./img/0749232a.gif "点击放大")
...
2. 给该状态变量添加@Watch装饰器可知，每次滚动后该状态变量被赋值为初始值，可知onAreaChange重复触发。
