...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/common-v1_26-ts_228-0000002430031681
---
...
* 修改IDE的设置，可以通过settings-editor-inspections-JavaScript typescript ArkTS中取消unregister function in native declaration file设置。示例如下图：![](./img/36c09fd6.png "点击放大")
