...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/common-v1_26-ts_525-0000002518367242
---
...
* [OH\_LOG\_SetCallback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-log-h#oh_log_setcallback)：调用此函数后，用户实现的回调函数可以接收当前进程的所有HiLog日志。回调函数里不允许在调用HiLog接口打印日志会死循环。
