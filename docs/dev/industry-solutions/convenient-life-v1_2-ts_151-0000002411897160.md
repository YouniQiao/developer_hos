...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/convenient-life-v1_2-ts_151-0000002411897160
---
...
4. 完整示例参考如下：
   ...
   |  | 优化前 | 优化后 |
   | --- | --- | --- |
   | 丢帧数与卡顿 | ![](./img/528426da.png "点击放大") | ![](./img/ac59abbc.png "点击放大") |
