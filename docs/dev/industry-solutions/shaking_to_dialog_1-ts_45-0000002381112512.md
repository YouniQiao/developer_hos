---
title: "如何统计单元测试的覆盖率"
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/shaking_to_dialog_1-ts_45-0000002381112512
---
...
在执行![](./img/4a3db501.png)run with coverage之后，会在对应模块的“.test/default/intermediates/test”文件夹路径下生成js\_coverage.json和init\_coverage.json文件，供后续生成覆盖率报告使用。

![](./img/fb827f3a.png "点击放大")
...
![](./img/97baa416.png "点击放大")

## 常见FAQ

Q：多个测试产生的类似bjc\_cov\_1742528669171.json、bjc\_cov\_1742528671121.json这样的覆盖率文件，如何合并生成总的覆盖率数据？

A：可参考[黑盒覆盖率测试](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ide-ui-test)，在多模块相互跳转的场景下，取各模块的init\_coverage.json文件路径，与bjc\_cov\_1742528669171.json、bjc\_cov\_1742528671121.json文件通过#拼接生成coverageFile参数。
...
A：右击ohosTest目录下的test文件夹，选择![](./img/1c2f5e17.png)，可以统计全部测试用例的覆盖率。
