...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/traffic-v1_1-ts_c28-0000002442375953
---
...
2. 排查该XComponent组件的相关设置，全屏时XComponent组件的尺寸重新变化后才触发去除视频上方的标题栏。
   ...
   class CustomXComponentController extends XComponentController {
     onSurfaceChanged(surfaceId: string, rect: SurfaceRect): void {
       ...
       if (rect.surfaceWidth > 2000) {
         AppStorage.setOrCreate('title', false); // 转为横屏后不显示标题栏
       } else {
         AppStorage.setOrCreate('title', true); // 转为竖屏后显示标题栏
       }
     }
   }
   ...
   struct Index {
     ...
     @StorageLink('title') showTitle: boolean = true; // 控制标题栏显隐
...
aboutToAppear() {
  ...
  this.listener.on('change', portraitFunc); // 监听屏幕旋转
}
...
struct XComponentTranslation {
  ...
  fileName: string = 'video3.mp4'; // 'video.mp4'需要在src/main/resources/rawfile中替换为开发者需要的视频资源文件
  ...
  listener: mediaquery.MediaQueryListener =
    this.getUIContext().getMediaQuery().matchMediaSync('(orientation: landscape)'); //监听横屏事件
      ...
      if (interruptEvent.forceType === audio.InterruptForceType.INTERRUPT_FORCE) {
        ...
        switch (interruptEvent.hintType) {
          case audio.InterruptHint.INTERRUPT_HINT_PAUSE:
            this.isPaused = true; // 应用切换至音频暂停状态
          ...
          case audio.InterruptHint.INTERRUPT_HINT_STOP:
            ...
            this.isPaused = true; // 此句为简化处理，代表应用切换至音频暂停状态的若干操作。
            break;
          default:
            break;
        }
        ...
        Column() {
          ...
          Column() {
            Row() {
              Row() {
                // 播放、暂停键
                // $r('app.media.ic_video_play')和$r('app.media.ic_video_pause')需要更换为用户需要的图片资源
              ...
              Image(this.isFull ? $r('app.media.out') : $r('app.media.full'))
                ...
                .onClick(() => {
                  this.isFull = !this.isFull; // 点击全屏按钮横向全屏或退出全屏
                })
                .margin({ left: 5 });
            }
