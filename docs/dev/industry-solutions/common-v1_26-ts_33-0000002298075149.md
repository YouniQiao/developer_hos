...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/common-v1_26-ts_33-0000002298075149
---
...
2. **检查密钥：**
   ...
   检查密钥生成器的配置参数是否正确，即参数要写成“DH\_modp1536”。
