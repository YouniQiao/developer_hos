...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/common-v1_26-ts_605-0000002526529094
---
...
* **场景一**：Navigation导航下的实现方式。
  ...
  参考官网[示例13（自定义转场动画）](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-navigation#示例13自定义转场动画)，通过from，to的方式即可根据不同的路由来源执行不同的转场动画。
* **场景二**：Router导航下的实现方式。
