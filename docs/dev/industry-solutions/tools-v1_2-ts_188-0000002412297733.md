...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/tools-v1_2-ts_188-0000002412297733
---
...
* 如果使用的Allocation模板，修改JSAllocationUsage字段下的restrainedDuration的值，根据需要调整（单位：秒）。
