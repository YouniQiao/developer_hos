...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/tools-v1_2-ts_221-0000002416349485
---
...
当前申请的ACCESS\_BLUETOOTH和USE\_BLUETOOTH权限，只有ACCESS\_BLUETOOTH是需要用户授权的，[USE\_BLUETOOTH](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/permissions-for-all#ohospermissionuse_bluetooth)是通过系统授权。
