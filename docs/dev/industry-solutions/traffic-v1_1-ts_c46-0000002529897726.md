---
title: "地图视野范围如何设置"
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/traffic-v1_1-ts_c46-0000002529897726
---
...
A：3D状态下，传统2D覆盖物（如点、线、图片覆盖物）不会被渲染，只有当地图放大到2D平面模式（缩放级别较高）时，这些覆盖物才会重新显示。当地图需要显示覆盖物时，通过[setSphereEnabled](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-map-mapcomponentcontroller#section67801022102716)动态关闭3D效果。
