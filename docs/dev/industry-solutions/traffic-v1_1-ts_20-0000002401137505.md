...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/traffic-v1_1-ts_20-0000002401137505
---
...
A：connectToCandidateConfigWithUserAction方法是在API20才开始支持的，低于API20无法使用该方法。
