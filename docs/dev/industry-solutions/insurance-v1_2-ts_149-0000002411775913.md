...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/insurance-v1_2-ts_149-0000002411775913
---
...
* 主要思路：HAR通过提供接口的方式，将相关功能模块开放给HAP使用。在HAP包中调用这些接口方法，将所需数据传递至HAR，从而实现数据交互与共享。
  ...
  实现步骤：
  1. 通过AppStorage.setAndLink存储WindowStage。可参考[如何在Page中获取WindowStage实例](https://developer.huawei.com/consumer/cn/doc/harmonyos-faqs/faqs-arkui-298)。
