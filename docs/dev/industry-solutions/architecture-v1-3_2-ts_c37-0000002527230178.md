...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/architecture-v1-3_2-ts_c37-0000002527230178
---
...
* **开发前查询**
  ...
  2. 输入指令：hidumper -s 3601 -a -l可查看设备具备的所有传感器，根据设备具备的传感器进行开发。![](./img/d492dfd4.png "点击放大")
* **使用前查询**
