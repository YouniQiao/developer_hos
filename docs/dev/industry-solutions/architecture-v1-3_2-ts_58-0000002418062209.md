...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/architecture-v1-3_2-ts_58-0000002418062209
---
...
当AudioCapturer的采样格式为SAMPLE\_FORMAT\_S16LE时，根据PCM音频数据计算音量分贝大小的参考代码如下：
