---
title: "rcp如何实现文件上传"
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/socialcontact-v1_2-ts_c23-0000002521673498
---
  ...
  + **场景1：使用应用沙箱文件路径上传表单文件。**
    ...
    4. 新建rcp会话实例，发起请求。
       ...
       **场景1运行效果：**
       ...
       ![](./img/83f1142f.png "点击放大")
  + **场景2：使用文件数据上传表单文件。**
    1. 基于文件URI将文件数据读取到ArrayBuffer中，并构建类型为FileContent的contentOrPath参数。
