...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/common-v1_26-ts_213-0000002393511532
---
...
2. 配置环境变量，根据ohpm存放地址路径，在Path中添加bin目录。![](./img/f1186eaa.png "点击放大")
