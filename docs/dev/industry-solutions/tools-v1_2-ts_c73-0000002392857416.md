---
title: "权限申请和使用的顺序不合理"
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/tools-v1_2-ts_c73-0000002392857416
---
...
* 获取步数时，使用[Sensor Service Kit（传感器服务）](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/sensor-service-kit)能力。订阅计步器传感器数据，需要配置权限[ohos.permission.ACTIVITY\_MOTION](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/permissions-for-all-user#ohospermissionactivity_motion)。
