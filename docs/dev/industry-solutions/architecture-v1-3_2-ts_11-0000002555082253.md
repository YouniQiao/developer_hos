...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/architecture-v1-3_2-ts_11-0000002555082253
---
...
| 存储格式 | 存储顺序简介 | 存储顺序图例 |
| --- | --- | --- |
| NV16 | NV16是YUV422Semi-Planar的一种，Y分量单独存放，UV分量交错存放。UV在排列的时候，从U开始，总长度为w＊h＊2。 | ![](./img/c5b61c86.png) |
| YUYV | YUYV属于YUV422Interleaved的一种。事实上，Interleaved是属于Packed的，但是在422中，用Interleaved更加形象一些。在Packed内部，YUV的排列顺序是YUVY，两个Y共用一组UV。 | ![](./img/b667f444.png) |
