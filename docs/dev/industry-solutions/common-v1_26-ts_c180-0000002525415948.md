...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/common-v1_26-ts_c180-0000002525415948
---
...
2. 检查到问题日志：
   ...
   ![](./img/86a6922c.png "点击放大")
3. 通过在Windows系统做启动时长测试，配置越好，启动越快。

   参考配置：Windows 10+32G内存(i7+10700)，启动时长在35s左右。
