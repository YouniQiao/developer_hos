...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/common-v1_26-ts_182-0000002417090153
---
...
2. 需要权限：ohos.permission.GET\_WIFI\_INFO。
3. 当macType是1时，获取macAddress还需申请[ohos.permission.GET\_WIFI\_LOCAL\_MAC](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/restricted-permissions#ohospermissionget_wifi_local_mac)权限（API8-15仅面向系统应用开放。从API 16开始，在PC/2in1设备上面向普通应用开放，在其余设备上仍仅面向系统应用开放），无该权限时，macAddress返回随机MAC地址。可申请此权限的特殊场景与功能包括：
...
开发前需要在module.json5文件中的requestPermissions字段添加{"name": "ohos.permission.GET\_WIFI\_INFO"}申请权限，当macType是1时，获取macAddress还需申请ohos.permission.GET\_WIFI\_LOCAL\_MAC权限。
