---
title: "无线投屏时不能切换声音输出"
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/audio-v1_2-ts_c97-0000002396789980
---
...
可见，应用的音频流类型：streamUsage:0，进一步查看[音频流使用类型的枚举](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-audio-e#streamusage)。根据枚举类型查阅，STREAM\_USAGE\_UNKNOWN的值是0，属于未知类型的音频流。可见应用使用的音频流类型为未知类型。
