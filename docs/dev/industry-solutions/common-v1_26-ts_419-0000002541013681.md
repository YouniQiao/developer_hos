...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/common-v1_26-ts_419-0000002541013681
---
...
* 应用通过订阅系统未成年人模式开启广播事件[COMMON\_EVENT\_MINORSMODE\_ON](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/commoneventmanager-definitions#common_event_minorsmode_on12)和系统未成年人模式关闭广播事件[COMMON\_EVENT\_MINORSMODE\_OFF](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/commoneventmanager-definitions#common_event_minorsmode_off12)来实现应用内未成年人模式的切换。在EntryAbility的onCreate()生命周期函数中订阅未成年人模式开启/关闭事件。
