...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/common-v1_26-ts_260-0000002410677822
---
...
![](./img/62d1155d.gif "点击放大")

方案二：设置异形TabBar达到不均匀分布的效果。

1. 左右四栏设置宽度占比18%，中间构造异形导航宽度占比28%。
