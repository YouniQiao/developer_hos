---
title: "如何正确关闭释放相机流"
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/architecture-v1-3_2-ts_10-0000002363076293
---
...
* 完整示例代码如下：
  ...
  参考[声明权限](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/declare-permissions)文档，需要先在module.json5文件中声明ohos.permission.CAMERA权限。
