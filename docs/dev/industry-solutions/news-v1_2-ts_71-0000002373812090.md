---
title: "如何实现文字多选框效果"
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/news-v1_2-ts_71-0000002373812090
---
...
* **方案二：attributeModifier动态属性设置多态样式：****具体操作步骤如下**：
  ...
  **详细代码示例如下：**
  ...
  @ObservedV2
  class TextCustomStyle implements AttributeModifier<TextAttribute> {
    // 动态属性值
