...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/common-v1_26-ts_c254-0000002442357097
---
...
struct Index {
  ...
  private fileName: string = 'video3.mp4'; // 'video3.mp4'需要在src/main/resources/rawfile中替换为开发者需要的视频资源文件
