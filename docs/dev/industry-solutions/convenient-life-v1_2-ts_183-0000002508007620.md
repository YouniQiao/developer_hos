...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/convenient-life-v1_2-ts_183-0000002508007620
---
...
从问题代码可知，参数priority值为geoLocationManager.LocationRequestPriority.FIRST\_FIX，而参数maxAccuracy值为4。
...
根据官方参考文档中的参数说明，当priority设置为LOW\_POWER/FIRST\_FIX时，可将maxAccuracy设置大于100的值。因此这里建议将maxAccuracy的值设定为100。代码可参考[getCurrentLocation](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-geolocationmanager#geolocationmanagergetcurrentlocation)接口示例代码的方式一，将其中maxAccuracy值改为100即可。
