...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/convenient-life-v1_2-ts_38-0000002378026793
---
...
* aad附加认证数据，不加密但参与完整性校验，长度为0~INT\_MAX字节，常用为16字节。
