...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/photo-v1_2-ts_20-0000002401147029
---
...
避免将获得的PixelMap转换成JPEG，可考虑转换成PNG等支持透明通道的格式，例如上方问题代码里就转换成了JPEG格式。可以修改为其他格式，如PNG，完整示例参考如下：
