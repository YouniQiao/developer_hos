...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/food-v1_2-ts_c9-0000002392857608
---

## 问题现象

应用在首次启动后，通过自定义弹框实现用户隐私协议授权页面，侧滑返回时弹框直接消失，导致应用无法正常进入主页面，不符合预期。
...
[route\_map.json配置如下](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-navigation-navigation#系统路由表)：
