...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/purchase-v1_2-ts_58-0000002447836645
---
...
2. 通过图片旋转模拟Loading效果。
   ...
   ![](./img/5daf4d39.png "点击放大")

3. 自定义LoadingView，供全局调用。
   * 自定义LoadingView.ets。
