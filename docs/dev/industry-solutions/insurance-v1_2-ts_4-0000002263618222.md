...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/insurance-v1_2-ts_4-0000002263618222
---
...
使用napi\_get\_boolean即可实现将C++中的bool类型转换为napi。
