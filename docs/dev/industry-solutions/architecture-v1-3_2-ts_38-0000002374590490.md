...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/architecture-v1-3_2-ts_38-0000002374590490
---
...
* **方案一**：采用[hideNavBar](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-navigation#hidenavbar9)隐藏导航页。
...
* **方案二**：修改pushPath等入栈方法属性。
  ...
  2. pushPath入参[NavPathInfo](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-navigation#navpathinfo10)可以设置isEntry属性，该参数表示是否作为首页推送子页，当该参数设置为true时，从该页面按返回键会自动返回桌面。
...
请参考[系统路由表](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-navigation-navigation#系统路由表)的配置方法，两种方案运行还需在模块的module.json5文件中添加路由表配置"routerMap": "$profile:route\_map"，并在工程resources/base/profile中创建route\_map.json文件。添加如下配置信息：
