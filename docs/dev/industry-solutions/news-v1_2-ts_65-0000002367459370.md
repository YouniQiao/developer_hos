...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/news-v1_2-ts_65-0000002367459370
---
...
* Page1.ets。
  ...
  ```
* router\_map：参考[routerMap标签](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/module-configuration-file#routermap标签)配置，在module.json5中的module字段里配置"routerMap": "$profile:router\_map"。
