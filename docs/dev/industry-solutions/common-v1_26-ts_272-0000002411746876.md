...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/common-v1_26-ts_272-0000002411746876
---
...
A：该问题是由于默认情况下文本是以字为单位，英文以单词为单位进行截断，当截断处的英文单词过长时被省略后会导致出现留白。可设置属性[wordBreak](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-text#wordbreak11)为WordBreak.BREAK\_ALL使英文单词按字母截断，从而解决以上问题。
