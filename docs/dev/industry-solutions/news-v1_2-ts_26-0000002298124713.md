...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/news-v1_2-ts_26-0000002298124713
---
...
![](./img/5e72e128.png "点击放大")

## 效果预览

![](./img/f67ce930.png "点击放大")
...
2. 重写play()方法为需要传参的函数。
   ...
   export default player as AVPlayer;
   ```
3. 将状态变量playInfo传入，实现点击修改，并刷新UI界面。
