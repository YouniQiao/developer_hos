...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/common-v1_26-ts_c273-0000002593930677
---
...
* **方案二：**
  ...
  可以在onTouch触摸回调中按下时添加定时器，抬起时间隔小于500ms或者滑动，取消定时器不显示气泡。参考代码如下：
