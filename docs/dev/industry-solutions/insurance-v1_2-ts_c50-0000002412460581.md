...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/insurance-v1_2-ts_c50-0000002412460581
---
...
1. 使用DevEco Testing查看该页面的组件，跳转前后的页面分别通过不同的Web组件显示。
   ...
   ![](./img/e530954d.png "点击放大")

   ![](./img/b40e7dc0.png "点击放大")
