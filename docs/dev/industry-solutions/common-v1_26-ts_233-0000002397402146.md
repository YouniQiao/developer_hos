...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/common-v1_26-ts_233-0000002397402146
---
...
* Windows环境：存放在node目录下。

  ide.node.location= node路径
* MacOS环境：存放在node/bin目录下。

  ide.node.location= node路径/bin
