---
title: "如何生成DH密钥"
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/insurance-v1_2-ts_31-0000002346517921
---
...
* DH算法相关接口介绍。
  ...
  | 名称 | 接口 |
  | --- | --- |
  | 指定DH算法公共参数。 | [DHCommonParamsSpec](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-cryptoframework#dhcommonparamsspec11) |
  | 指定DH算法私钥参数。 | [DHPriKeySpec](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-cryptoframework#dhprikeyspec11) |
  | 指定DH算法公钥参数。 | [DHPubKeySpec](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-cryptoframework#dhpubkeyspec11) |
  | 指定DH算法全量参数。 | [DHKeyPairSpec](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-cryptoframework#dhkeypairspec11) |
  | 通过指定密钥参数，创建非对称密钥生成器。 | [createAsyKeyGeneratorBySpec](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-cryptoframework#cryptoframeworkcreateasykeygeneratorbyspec10) |
  | 通过指定算法名称的字符串，创建非对称密钥生成器。 | [createAsyKeyGenerator](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-cryptoframework#cryptoframeworkcreateasykeygenerator) |
...
* 场景一：调用createAsyKeyGenerator接口通过DH字符串参数生成DH密钥对.
  ...
  ```
* 场景二：使用密钥参数生成DH密钥。
  1. 调用DHCommonParamsSpec接口通过p、g、l参数生成密钥公共参数DHCommonParamsSpec。
