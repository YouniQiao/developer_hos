...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/educate-v1_1-ts_30-0000002358826161
---
...
* **方案一**：
  1. textOverflow仅在内联模式的编辑态、非编辑态下支持，需设置style属性。
  ...
  ![](./img/90f11206.png "点击放大")

* **方案二**：
  1. 失焦时，使用Text覆盖TextInput，textOverflow设置为Ellipsis，超出正常文本宽度显示省略号。
