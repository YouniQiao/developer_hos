...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/common-v1_26-ts_30-0000002263991836
---
...
![](./img/686e7263.png "点击放大") ![](./img/39341b1c.png "点击放大")
...
* 场景二：键盘弹出时控制组件是否避让。
  ...
  ![](./img/9326dbbd.png "点击放大") ![](./img/e84b2b2e.png "点击放大")
* 场景三：通过监听键盘高度或安全区域高度变化，自定义处理UI布局。

  自定义处理UI布局时，注意容器组件的高度是否为固定高度，推荐使用layoutWeight属性自适应容器或组件高度。当页面释放时，注意关闭键盘事件监听。

  ![](./img/1ff638f9.png "点击放大")
