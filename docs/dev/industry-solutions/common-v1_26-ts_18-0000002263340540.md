...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/common-v1_26-ts_18-0000002263340540
---
...
|  |  |
| --- | --- |
| ![](./img/0e284c1f.png "点击放大") | ![](./img/d20263d6.png "点击放大") |
       ...
       onWindowStageCreate(windowStage: window.WindowStage): void {
         ...
         windowStage.loadContent('pages/XxxPage3', (err) => {
           ...
           windowClass.setWindowLayoutFullScreen(isLayoutFullScreen).then(() => {
             ...
             console.info('erro in setting the window layout to full-screen mode.', err.message);
           });
