---
title: "视频播放花屏"
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/audio-v1_2-ts_c25-0000002391490017
...
* 以NV12图像为例，width、height、wStride和hStride图像排列参考下图：
  ...
  + OH\_MD\_KEY\_VIDEO\_SLICE\_HEIGHT表示hStride。
    ...
    ![](./img/226ec761.png "点击放大")

## 问题定位

1. 视频播放花屏排查流程图如下：

   ![](./img/54b48f9f.png "点击放大")
