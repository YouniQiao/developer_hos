...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/insurance-v1_2-ts_50-0000002358873469
---
...
* **方案一**：使用路由模式保留页面实例。
  ...
  ![](./img/9a794f44.gif "点击放大")
* **方案二**：手动保存与恢复滚动状态。

  若必须销毁页面，可通过以下步骤实现状态持久化：
