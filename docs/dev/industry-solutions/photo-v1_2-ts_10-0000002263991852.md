...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/photo-v1_2-ts_10-0000002263991852
---
...
![](./img/a26a2637.png "点击放大")

通过API获取到的视频高为1080，宽为1920，API获取的值宽高与实际相反。

![](./img/3700da3d.png "点击放大")
