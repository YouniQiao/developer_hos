...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/convenient-life-v1_2-ts_48-0000002359672776
---
...
* 需要在展示所有相册文件（即MIMETYPE设置为IMAGE\_VIDEO\_TYPE）的场景下，根据用户首次选择的文件类型，实现图片与视频分开选择。在官网[示例](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ohos-file-photopickercomponent#示例)的基础上，规定最大图片数量maxPhotoSelectNumber与最大视频数量maxVideoSelectNumber。
...
A：设置[PickerOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ohos-file-photopickercomponent#pickeroptions).MIMEType属性值为IMAGE\_VIDEO\_TYPE。
