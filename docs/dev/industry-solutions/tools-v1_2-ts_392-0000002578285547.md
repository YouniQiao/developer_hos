...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/tools-v1_2-ts_392-0000002578285547
---
...
1. 应用安装：
   * 连接设备，DevEco Testing选择实用工具-设备投屏。
     ...
     ![](./img/66b339c5.png "点击放大")
   * 点击开始投屏，然后工具栏点击安装应用。

     ![](./img/e6fdc4f9.png "点击放大")
   * 本地文件路径点击选择，弹框可选择应用包的类型。

     ![](./img/3c39caa6.png "点击放大")
   * 选择安装包，点击确定，执行日志可以看到安装成功，如果安装失败，可以看到报错信息。

     ![](./img/32c30848.png "点击放大")
2. 应用卸载：
   * 连接设备，DevEco Testing选择实用工具-设备投屏，工具栏点击卸载应用。

     ![](./img/c6fe42f2.png "点击放大")
   * 下拉框选择对应的应用，点击确定。

     ![](./img/e7574bb3.png "点击放大")
   * 弹出的对话框，点击确定卸载。

     ![](./img/2be5f202.png "点击放大")
   * toast提示应用卸载成功。

     ![](./img/844193c6.png "点击放大")
