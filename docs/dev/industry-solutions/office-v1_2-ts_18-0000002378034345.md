...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/office-v1_2-ts_18-0000002378034345
---
...
* **方案二：采用CustomBuilder自定义。**

  采用@Builder封装UI构件，通过三目运算实现点击聚焦功能。
