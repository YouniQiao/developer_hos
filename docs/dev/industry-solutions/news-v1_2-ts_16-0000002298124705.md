...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/news-v1_2-ts_16-0000002298124705
---
...
3. 窗口方向（横屏）、窗口沉浸式设置，示例代码如下：
   ...
   ```
4. 在module.json5配置文件中abilities标签下的preferMultiWindowOrientation属性增加“landscape\_auto”，示例代码如下：
...
![](./img/9ea54cfc.png "点击放大") ![](./img/9e626011.png "点击放大") ![](./img/7f1102e4.png "点击放大")
