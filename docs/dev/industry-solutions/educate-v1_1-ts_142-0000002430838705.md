...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/educate-v1_1-ts_142-0000002430838705
---
...
* **场景二：为整个应用设置护眼模式。**
  + 方案一：Navigation组件与护眼组件重叠。
    ...
    该方案与下文方案二省略路由表配置步骤，Navigation路由表配置详见官方文档：[系统路由表](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-navigation-navigation#系统路由表)。
  + 方案二：Navigation设置[overlay](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-overlay#overlay)浮层。
