...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/common-v1_26-ts_424-0000002541823869
---
...
* [setWindowTopmost](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-window-window#setwindowtopmost14)方法：将窗口置于其他应用窗口之上不被遮挡。使用该接口需要配置权限：[ohos.permission.WINDOW\_TOPMOST](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/permissions-for-all#ohospermissionwindow_topmost)。
...
方法一：可以参考官方文档[设置全局悬浮窗（受限开放）](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/application-window-stage#设置全局悬浮窗受限开放)，需要申请受限权限[ohos.permission.SYSTEM\_FLOAT\_WINDOW](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/restricted-permissions#ohospermissionsystem_float_window)。
...
1. 新建独立窗口的代码“src/main/ets/pages/pageTwo.ets”并在配置文件“src/main/resources/base/profile/main\_pages.json”中新增路径：
