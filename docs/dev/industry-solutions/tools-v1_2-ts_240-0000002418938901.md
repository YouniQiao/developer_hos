...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/tools-v1_2-ts_240-0000002418938901
---
...
* [OH\_AudioRenderer\_SetVolume](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-native-audiorenderer-h#oh_audiorenderer_setvolume)可以设置当前音频流音量值。
* [OH\_AudioRenderer\_SetDefaultOutputDevice()](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-native-audiorenderer-h#oh_audiorenderer_setdefaultoutputdevice)可以设置默认本机内置发声设备。
...
* 开发者可使用OH\_AudioRenderer\_SetVolume接口设置当前音频流音量值，1.0为最大值。
  ...
  ```
* 当音频流类型[OH\_AudioStream\_Usage](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-native-audiostream-base-h#oh_audiostream_usage)为语音消息、VoIP语音通话或者VoIP视频通话的场景时可以使用OH\_AudioRenderer\_SetDefaultOutputDevice()方法设置本机内置发声设备为扬声器获得最大音量的效果。
