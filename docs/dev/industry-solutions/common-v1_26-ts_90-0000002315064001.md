...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/common-v1_26-ts_90-0000002315064001
---
...
| 场景 | 涉及权限 | 备注 |
| --- | --- | --- |
| 模糊位置 | [ohos.permission.APPROXIMATELY\_LOCATION](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/permissions-for-all-user#ohospermissionapproximately_location) | 精确度为5公里。 |
| 精确位置 | [ohos.permission.LOCATION](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/permissions-for-all-user#ohospermissionlocation) | 精确度为米级，需要与ohos.permission.APPROXIMATELY\_LOCATION同时申请。 |
| 后台位置 | [ohos.permission.LOCATION\_IN\_BACKGROUND](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/permissions-for-all-user#ohospermissionlocation_in_background) | 先获取前台位置权限，再配合[长时任务](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/continuous-task)使用。 |

![](./img/62d2a3d1.png)

* 精确位置：关闭“精确位置”的开关后，无法通过[requestPermissionsFromUser()](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-abilityaccessctrl#requestpermissionsfromuser9)再次拉起弹框获取授权。需要用户手动在设置中开启，或者使用[requestPermissionOnSetting()](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-abilityaccessctrl#requestpermissiononsetting12)接口[二次向用户申请授权](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/request-user-authorization-second)。
* 后台位置：申请后台权限前，必须先申请前台位置权限。前台位置权限的申请有两种允许情况：
  + 申请前台模糊位置权限：ohos.permission.APPROXIMATELY\_LOCATION。
  + 申请前台精确位置权限：ohos.permission.APPROXIMATELY\_LOCATION和ohos.permission.LOCATION。

## 解决方案

* **场景一****：****代码引导用户开启“精确位置”**。
  1. 使用[checkAccessTokenSync()](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-abilityaccessctrl#checkaccesstokensync10)接口判断ohos.permission.LOCATION是否授权的方式，确认当前应用是否开启“精确位置”开关。
  ...
  3. 使用[requestPermissionOnSetting()](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-abilityaccessctrl#requestpermissiononsetting12)接口向用户二次申请“精确位置”授权。
     ...
     ![](./img/439a1b9a.png "点击放大")
* **场景二：代码引导用户开启“后台位置”。**

  确认完成前台位置权限授权后，使用[requestPermissionOnSetting()](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-abilityaccessctrl#requestpermissiononsetting12)接口向用户申请后台位置授权：
  ...
  ![](./img/f018c8fe.png "点击放大")
* **场景三：代码引导用户开启“系统位置”功能开关。**

  使用[isLocationEnabled()](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-geolocationmanager#geolocationmanagerislocationenabled)检查当前系统位置功能是否被禁用。如果位置功能被禁用则无法获取位置信息，需要调用[requestGlobalSwitch()](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-abilityaccessctrl#requestglobalswitch12)拉起半模态对话框打开位置开关。
  ...
  ![](./img/3d087e43.png "点击放大")

完整代码如下，使用前请先在module.json5中声明ohos.permission.APPROXIMATELY\_LOCATION、ohos.permission.LOCATION和ohos.permission.LOCATION\_IN\_BACKGROUND权限：
...
A：ohos.permission.LOCATION不可以单独申请，需要与模糊位置权限ohos.permission.APPROXIMATELY\_LOCATION同时申请。
