...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/common-v1_26-ts_2-0000002266726412
---

## 问题现象

应用提交审核时提示：检测到当前软件包的user\_grant类型权限与隐私声明不一致，请修改后重新提交。
...
2. 排查是否使用了已废弃权限，例如[ohos.permission.WRITE\_MEDIA](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/permissions-for-all-user#ohospermissionwrite_media)权限。需要根据文档说明使用替换方案。
