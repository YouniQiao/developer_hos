...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/common-v1_26-ts_67-0000002298188225
---
...
1. **为什么要校验profile中的包名**？
   ...
   ![](./img/1c15640e.png "点击放大")

   此校验过程在搭建流水过程中下图的红框部分，构建后签名前的校验脚本中。

   ![](./img/62194568.png "点击放大")
2. **签名的作用**。
...
3. **Profile文件**。
   ...
   ![](./img/45035cea.png "点击放大")
4. **[搭建流水线](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ide-command-line-building-app)**。
