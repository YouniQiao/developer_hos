...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/insurance-v1_2-ts_217-0000002393023576
---
...
4. 实现效果：
   * 点击**查看U盘文件并导入到沙箱**按钮后，拉起了DocumentViewPicker。
     ...
     ![](./img/e2086733.png "点击放大")
   * 点击**MyUSB**后可以浏览我的U盘。选中要拷贝的文件。

     ![](./img/d6a445a3.png "点击放大")
   * 点击**完成**后，成功将U盘中的两个文件拷贝到了沙箱。

     ![](./img/d7a555b2.png "点击放大")
...
2. 通过DocumentViewPicker（无需额外申请权限）来拉起访问文件管理，选择存储位置（如U盘），然后把需要存储的沙箱文件写入到对应的设备位置中。
