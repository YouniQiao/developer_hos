---
title: "如何实现类似雷达扫描的效果"
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/office-v1_2-ts_48-0000002380415382
---
  ...
  + 雷达扫描方案一：通过Stack组件叠加静态底图与动态旋转扇形图，并配合animation设置无限循环的线性动画（iterations: -1），使扇形图持续旋转实现。
    ...
    struct RadarScan2 {
      ...
      build() {
        ...
        .justifyContent(FlexAlign.Center)
        .backgroundColor(0x111111) // 深色背景增强视觉效果
        .width('100%')
        .height('100%');
      }
    }
