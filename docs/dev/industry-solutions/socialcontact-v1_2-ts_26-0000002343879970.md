...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/socialcontact-v1_2-ts_26-0000002343879970
---
...
本示例涉及用户指纹认证，需要申请权限[ohos.permission.ACCESS\_BIOMETRIC](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/permissions-for-all#ohospermissionaccess_biometric)，允许应用使用生物特征识别能力进行身份认证。
