---
title: "段落如何居中画布"
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/tools-v1_2-ts_325-0000002444273337
---

## 问题现象

参考案例[自定义字体的注册和使用（ArkTS）](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/custom-font-arkts#完整示例)，使用text.Paragraph绘制文本段落时，文本无法在画布中水平和垂直居中。通过paint()方法绘制文本，但未正确计算居中坐标，导致文本位置偏移。

问题效果预览：

![](./img/75d09e48.png "点击放大")

## 效果预览

![](./img/d65055dc.png "点击放大")
...
1. text.Paragraph布局机制：
   ...
   * 关键方法：[getMaxWidth](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-graphics-text#getmaxwidth)获取文本实际宽度（可能小于布局宽度）；[getHeight](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-graphics-text#getheight)获取文本总高度（含多行行高）。
