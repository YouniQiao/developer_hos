---
title: "自定义字体的注册和使用"
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/common-v1_26-ts_c176-0000002556032899
---
...
1. 注册自定义字体。
   ...
   应用若需全局使用自定义字体，请在EntryAbility.ets文件的onWindowStageCreate生命周期中，通过windowStage.loadContent回调注册。参考：[自定义字体无法全局使用如何处理](https://developer.huawei.com/consumer/cn/doc/architecture-guides/news-v1_2-ts_37-0000002263667832)。
