...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/news-v1_2-ts_87-0000002415689069
---
...
2. SecondPage.ets。
   ...
   ![](./img/2e0c3ee7.gif "点击放大")

## 效果预览

在切换动画完成后进行跳转则正常展示。

![](./img/a6c796e9.gif "点击放大")
