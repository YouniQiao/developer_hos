...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/news-v1_2-ts_52-0000002371749641
---
...
* **上下堆叠实现。**
  ...
  ![](./img/44e66c6e.gif "点击放大")

* **左右堆叠实现。**

  和上下堆叠实现类似，只需微调SwiperStackComponent代码即可。
