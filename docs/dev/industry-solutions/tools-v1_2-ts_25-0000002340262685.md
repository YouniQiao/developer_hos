...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/tools-v1_2-ts_25-0000002340262685
---
...
* 方案一：通过给组件设置浮层显示字符计数器来实现。
  ...
  ```
* 方案二：使用Stack层叠布局，使Text覆盖在TextArea右下角，实现字符计数显示。
