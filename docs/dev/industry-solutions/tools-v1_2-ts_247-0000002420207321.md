...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/tools-v1_2-ts_247-0000002420207321
---
...
4. 最终可以确认getCertSerialNumber()获取的是前面的10进制数据，而预期获取的是后面的16进制数据。
