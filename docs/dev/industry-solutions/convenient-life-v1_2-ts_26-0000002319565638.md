---
title: "List展示不全"
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/convenient-life-v1_2-ts_26-0000002319565638
---
...
![](./img/a4858772.png "点击放大")

## 效果预览

![](./img/ce91f596.gif "点击放大")
...
* **方案四：使用Flex布局。**
  ...
  ```
* **方案五：给List组件设置contentEndOffset属性。**
