...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/insurance-v1_2-ts_246-0000002397240358
---
...
* 在三种不同屏幕下的运行效果图如下：
  + 手机设备下对应span参数值为sm，可显示两列：
    ...
    ![](./img/4981623e.png "点击放大")
  + 折叠屏设备下对应span参数值为md，可显示四列：

    ![](./img/7757e416.png "点击放大")
  + 平板设备下对应span参数值为lg，可显示六列：

    ![](./img/4e509fa3.png "点击放大")
