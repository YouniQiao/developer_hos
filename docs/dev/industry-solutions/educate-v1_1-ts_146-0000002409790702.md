...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/educate-v1_1-ts_146-0000002409790702
---
...
| --- | --- | --- | --- | --- | --- |
| pdfDocument.convertToImage | pdfService | 整个PDF文件 | 转换PDF文档为图片。 | 5.0.0(12) | 入参path为文件夹路径。转换后的图片以PDF文件的页码为名，每页生成一张图片。 此API不支持自定义图片名，若需重命名，待图片生成后使用[@ohos.file.fs (文件管理)](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs)的能力修改。 |
