---
title: "如何给视频背景添加高斯模糊"
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/insurance-v1_2-ts_114-0000002406762713
---
...
![](./img/6caca00c.png "点击放大")

## 效果预览

![](./img/7a6b413c.png "点击放大")

## 背景知识

* [模糊](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-blur-effect)可以用来体现界面空间的纵深感，区分前后元素的层级关系。[blur](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-image-effect#blur)方法可以为组件添加内容模糊效果。当模糊内容和模糊半径都不需要变化时，建议使用静态模糊接口blur。

  而高斯模糊属于模糊的一种，能够更好地保留边缘，使模糊效果更平滑自然，在[BlurStyle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-background#blurstyle9)中选择景深模糊即为高斯模糊，包括BACKGROUND\_THIN、BACKGROUND\_REGULAR、BACKGROUND\_THICK等。
