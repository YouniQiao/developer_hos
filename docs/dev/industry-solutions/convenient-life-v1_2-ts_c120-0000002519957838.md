---
title: "Checkbox更改样式"
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/convenient-life-v1_2-ts_c120-0000002519957838
---
...
* 场景一：通过contentModifier属性自定义圆形选择框样式，使用Circle组件重绘选择框，设置strokeWidth属性可修改边框宽度。
  ...
  ![](./img/39893ed0.png "点击放大")

* 场景二：通过contentModifier属性自定义圆形选择框样式，传入未选中时的默认背景图片，在点击事件中对当前背景图片进行取反，且使用CheckBoxConfiguration的triggerChange方法触发多选框选中状态变化从而实现背景的修改。
...
Q：已经通过shape([CheckBoxShape](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-appendix-enums#checkboxshape11).ROUNDED\_SQUARE)属性给Checkbox设置了圆角方形，如何改变圆角大小？
