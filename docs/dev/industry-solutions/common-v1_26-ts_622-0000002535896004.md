...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/common-v1_26-ts_622-0000002535896004
---
...
![](./img/ccc917e3.png "点击放大")

* XPath语法定位控件。

  使用BY.xpath匹配器可以支持通过XPath语法来查找控件。注意XPath不能和其他匹配器一起使用。
  ...
  ```
* UiViewer提供的path路径定位控件。

  UiViewer提供的path路径定位控件可以在不同的API中使用，API参数path为UiViewer查看的路径。

  ![](./img/c9f0ab26.png "点击放大")
