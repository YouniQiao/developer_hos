...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/traffic-v1_1-ts_9-0000002359346489
---
...
* 不依靠装饰器传值，使用代理类的替代方案：
  1. 定义一个controller类，在controller类中定义和子组件中类型相同的属性，在子组件中将实际封装的属性给到controller。
