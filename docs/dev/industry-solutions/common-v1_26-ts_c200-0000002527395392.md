...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/common-v1_26-ts_c200-0000002527395392
---
...
* **方案一：TabBar叠加overlay浮层效果。**
  ...
  ![](./img/459d26cd.png "点击放大")
* **方案二：利用Stack组件，在自定义TabBar上堆叠其他组件**。

  利用堆叠容器，在原本的TabBar基础上放置其他组件，原理如下图：

  ![](./img/9faf4b9f.png "点击放大")
