---
title: "应用启动时页面周边有白边"
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/insurance-v1_2-ts_c60-0000002385689612
---
...
1. 根据entry\src\main\module.json5配置文件中startWindowIcon设置的图片资源，查看该图片资源的大小。
   ...
   ![](./img/84d79c72.png "点击放大")
2. 在系统设置中查看屏幕的尺寸，启动页图片的大小与屏幕尺寸不一致。

   ![](./img/663ad79b.png "点击放大")
