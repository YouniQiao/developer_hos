...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/common-v1_26-ts_c147-0000002521485286
---
...
1. 创建PageA页面，调用setRenderProcessMode将Web组件设置为多渲染子进程模式。
   ...
   ```
2. 创建PageB页面，制造一个渲染进程异常退出的场景，触发onRenderExited回调。
