---
title: "如何分析BLE广播信息"
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/socialcontact-v1_2-ts_c24-0000002554111987
---
...
* 日志获取：
  1. 蓝牙HCI日志：hdc file recv /data/log/bt。
...
* 在BLE技术中，广播包是设备被发现和建立连接的核心载体，其设计兼顾了低功耗与信息传递效率。BLE广播发送时，可以通过[AdvertiseSetting](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-bluetooth-ble#advertisesetting)设置广播的发送参数，包括：
  1. 广播发送间隔interval，控制广播间隔时间，直接影响设备被发现的速度。
...
![](./img/eb1052e0.png "点击放大")

## 分析结论

![](./img/d6fc9769.png "点击放大")
