...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/educate-v1_1-ts_12-0000002312334553
---
...
1. 实现可拖动Text组件：
   ...
   为了使Text组件可拖动，可以使用Scroll组件嵌套Text组件。原理如下：

   ![](./img/ac0fef19.png "点击放大")
