...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/common-v1_26-ts_c275-0000002595255451
---
...
* 场景四：给Canvas组件设置expandSafeArea属性，Canvas绘制内容无法扩展至底部导航条。
  ...
  解决方案：将Canvs的高度设置为固定高度，具体值为屏幕高度，即上述示例代码中的this.screenHeight。

  实现效果如下：

  ![](./img/5f2f08af.png "点击放大")
