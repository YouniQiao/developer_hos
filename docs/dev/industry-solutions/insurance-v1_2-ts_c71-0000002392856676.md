...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/insurance-v1_2-ts_c71-0000002392856676
---
...
1. 通过[getSelfPermissionStatus](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-abilityaccessctrl#getselfpermissionstatus20)接口查询应用权限状态。参考代码：
   ...
   ```
2. 当结果为NOT\_DETERMINED时，表示未操作。应用声明用户授权权限，暂未调用[requestPermissionsFromUser](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-abilityaccessctrl#requestpermissionsfromuser9)接口请求用户授权，或用户在设置中将权限状态修改为每次询问，此时可以调用请求用户授权接口进行授权，参考代码：
