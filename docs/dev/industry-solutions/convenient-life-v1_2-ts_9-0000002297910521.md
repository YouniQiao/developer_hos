...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/convenient-life-v1_2-ts_9-0000002297910521
---
...
struct tabTopScroll {
  ...
  build() {
    Column() {
      ...
      .backgroundColor(`rgba(70,130,180,${this.opacityNum})`) //使用rgba格式设置背景色，通过调整背景色的透明度来实现标题栏渐变。
      .position({ x: 0, y: 0 })
      .zIndex(99);
