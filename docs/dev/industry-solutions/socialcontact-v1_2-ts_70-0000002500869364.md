...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/socialcontact-v1_2-ts_70-0000002500869364
---
...
* UUID类型有16字节、4字节、2字节三种：

  0000xxxx-0000-1000-8000-00805f9b34fb：2字节。
