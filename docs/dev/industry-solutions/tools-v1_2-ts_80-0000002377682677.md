...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/tools-v1_2-ts_80-0000002377682677
---
...
1. 打开蓝牙连接。
   ...
   当回调状态为1时表示正在连接，当状态返回2时表明已连接，所以是两次回调。
...
2. 关闭蓝牙连接。
   ...
   当回调状态为3时表示正在断连，当状态返回0时表明已断开，所以是两次回调。
