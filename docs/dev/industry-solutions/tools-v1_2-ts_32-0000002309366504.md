...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/tools-v1_2-ts_32-0000002309366504
---
...
4. 关闭并行模式：
   ...
   打开菜单栏：File->Settings->Build, Execution, Deployment->Build Tools->Hvigor，取消勾选Execute tasks in parallel mode。
