...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/educate-v1_1-ts_71-0000002373804518
---
...
* **方案一：push方法推送默认页面。**
  1. 编写默认页面，并重写[onBackPressed](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-navdestination#onbackpressed10)返回，当在该页面返回时直接退出软件。
  2. Navigation主页执行aboutToAppear，将默认页面加入页面栈进行默认显示。
     ...
     ![](./img/c43b278d.png "点击放大")
* **方案二：采用API20中的splitPlaceholder属性。**

  详情参考：[示例14](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-navigation#示例14设置navigation双栏模式)。
