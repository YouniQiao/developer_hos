...
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/office-v1_2-ts_10-0000002312678750
---
...
* 场景一：如何使用ForEach循环渲染实现刻度尺的效果，如下图所示：
  ...
  ![](./img/5f189d88.png "点击放大")
* 场景二：如何实现一个横向的刻度选择器，支持横向滑动的效果？

  ![](./img/75c4a877.png "点击放大")
