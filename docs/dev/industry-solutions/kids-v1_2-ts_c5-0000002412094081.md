---
title: "更换头像时头像资源加载异常"
original_url: https://developer.huawei.com/consumer/cn/doc/architecture-guides/kids-v1_2-ts_c5-0000002412094081
---
...
1. 通过[getRawFd()](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-resource-manager#getrawfd9)获取rawfile/apps.zip所在hap包的descriptor信息。
2. 使用buffer将rawfile/apps.zip文件内容复制到沙箱临时文件路径。
3. 使用[zlib.decompressFile()](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-zlib#zlibdecompressfile9)解压zip文件至沙箱通用文件路径。
