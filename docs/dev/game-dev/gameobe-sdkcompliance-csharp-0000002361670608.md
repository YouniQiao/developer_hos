---
title: "C#"
original_url: /docs/dev/game-dev/gameobe-sdkcompliance-csharp-0000002361670608
format: md
upstream_id: dev/game-dev/gameobe-sdkcompliance-csharp-0000002361670608
...
* 以文字方式向用户告知
  ...
  **隐私政策链接：**[SDK隐私声明](/docs/dev/game-dev/gameobe-sdksecurity-csharp-0000002361670604)

* 以表格方式向用户告知

  | 第三方SDK名称 | 第三方公司名称 | 收集个人信息类型 | 使用目的 | 隐私政策链接 |
  | --- | --- | --- | --- | --- |
  | GameOBEForUnitySDK | 华为软件技术有限公司 | 应用使用信息、IP地址或IP归属地、大致位置信息、华为账号信息、第三方账号信息、视频信息 | 提供联机、对战录像查询与回放功能。如果您只使用部分SDK功能，则可以根据实际功能进行裁剪。 | [SDK隐私声明](/docs/dev/game-dev/gameobe-sdksecurity-csharp-0000002361670604) |
