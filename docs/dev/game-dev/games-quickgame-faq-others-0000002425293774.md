...
如果所有分包加载不成功，请检查分包配置是否正确，详细参见“[分包加载](https://developer.huawei.com/consumer/cn/doc/games-guides/games-quickgame-subpackage-0000002317894828)” 。
...
该功能适用不需要接入华为账号和支付的场景，主要用于海外版本快应用，如果快游戏要接入账号和支付，参见“[开发指导](https://developer.huawei.com/consumer/cn/doc/games-guides/games-quickgame-dev-runtimegame-guide-0000002317894824)”。
