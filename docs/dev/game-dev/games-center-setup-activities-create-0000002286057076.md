...
通过各类运营活动，为用户提供活动奖励，以直接发奖形式向用户发放奖品，需先配置可添加至运营活动的活动奖品，配置活动奖品操作步骤如下。文中具体参数说明请参见[参数说明](https://developer.huawei.com/consumer/cn/doc/games-guides/games-center-setup-activities-param-0000002320553297#ZH-CN_TOPIC_0000002382054357)。
...
配置活动奖品并提交审核后，您可按如下步骤创建活动。文中具体参数说明请参见[参数说明](https://developer.huawei.com/consumer/cn/doc/games-guides/games-center-setup-activities-param-0000002320553297#ZH-CN_TOPIC_0000002382054357)。
