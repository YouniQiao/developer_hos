...
format: md
upstream_id: dev/game-dev/games-gamemme-sdkcompliance-csharp-minigame-0000002359547190
...
2. App首次运行收集、处理个人信息前需要以醒目方式提示用户阅读隐私政策。隐私政策需方便用户查看，例如用户在App主功能界面中通过4次以内的点击或滑动操作可访问。
...
为了避免您的应用在未获取用户的同意前SDK提前处理用户的个人信息。我们提供了SDK初始化的接口[Create](https://developer.huawei.com/consumer/cn/doc/games-references/gamemediaengineforminigames-csharp-minigame-0000002358963772#section8688204817219)，请保证您的应用获取用户同意后才能调用此接口初始化SDK。
