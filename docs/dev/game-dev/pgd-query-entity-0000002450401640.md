---
title: "实体迭代"
original_url: /docs/dev/game-dev/pgd-query-entity-0000002450401640
format: md
upstream_id: dev/game-dev/pgd-query-entity-0000002450401640
...
* 创建的Query应该进行缓存，而非每次迭代时重复创建，创建Query会缓存Archetype等查询信息，有显著开销。详情请参见[查询中的结构性修改](/docs/dev/game-dev/pgd-query-faq-0000002483641113#section14451028173215)。
