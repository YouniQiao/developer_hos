...
format: md
upstream_id: dev/game-dev/ailod-sdkcompliance-0000002508726159
...
此文档用于帮助您更好地了解AILOD SDK并合规使用AILOD SDK服务，仅适用于开发者的业务区域为中国大陆地区的场景。
...
在您接入、使用AILOD SDK服务前，我们要求您在隐私政策中向用户告知我们SDK的名称、SDK提供方名称、收集个人信息类型、使用目的、隐私政策链接，并获取用户的同意或取得其他合法性基础，在提供AILOD SDK服务时，涉及处理敏感个人信息，建议您单独弹框获取用户的单独同意。您可以参考如下方式提供条款内容：
