...
format: md
upstream_id: dev/game-dev/games-gamemme-sdkcompliance-csharp-native-0000002393267049
...
为了避免您的应用在未获取用户的同意前SDK提前处理用户的个人信息。我们提供了SDK初始化的接口[Create](https://developer.huawei.com/consumer/cn/doc/games-references/gamemme-gamemediaengine-csharp-native-0000002392723521#section8688204817219)，请保证您的应用获取用户同意后才能调用此接口初始化SDK。
