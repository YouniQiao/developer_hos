...
| 适用平台 | 文件夹 | 包含文件 |
| --- | --- | --- |
| HarmonyOS 5.0及以上系统 | trigger\_for\_ohos\_on\_windows | trigger.bat  trigger-x86\_64-windows-gnu.exe |

![](./img/6966792a.png)

* 当前工具最新版本号为2.0.0.200。
* 请及时更新并使用最新版本工具。旧版本不再支持，如继续使用可能出现采集失败。具体版本号请在工具获取处[其他工具](https://developer.huawei.com/consumer/cn/doc/AppGallery-connect-Guides/smartperf-tool-others-0000001543310926)查看。
