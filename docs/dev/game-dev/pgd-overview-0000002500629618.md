---
title: "PGD概述"
original_url: https://developer.huawei.com/consumer/cn/doc/games-guides/pgd-overview-0000002500629618
...
| 辅助工具 | [Relationship Window](https://developer.huawei.com/consumer/cn/doc/games-guides/pgd-tool-window-0000002526353161) | 实时展示System、Component、Entity三者逻辑依赖与数据变化的可视化调试工具。 |
| [PGD Profiler](https://developer.huawei.com/consumer/cn/doc/games-guides/pgd-tool-profiler-0000002526433123) | 集成于引擎Profiler中的System维度PGD数据监控工具。 |
...
| [PGD Editor](https://developer.huawei.com/consumer/cn/doc/games-guides/pgd-tool-editor-0000002494193498) | 以引擎编辑器为核心的PGD构建工具。 |
...
| 步骤 | 操作 | 说明 |
| --- | --- | --- |
| 1 | [导入Package](https://developer.huawei.com/consumer/cn/doc/games-guides/pgd-import-0000002500629620) | 在团结Editor中导入PGD Package，为后续的游戏开发做准备。 |
| 2 | 开发指导 | * [PGD API 开发指导](https://developer.huawei.com/consumer/cn/doc/games-guides/pgd-development-0000002428270706)：在团结Editor中使用PGD Package开发游戏重载场景。 * [PGD辅助工具操作指导](https://developer.huawei.com/consumer/cn/doc/games-guides/pgd-tool-0000002494193496)：在团结Editor中使用辅助工具提升PGD开发效率。 |
