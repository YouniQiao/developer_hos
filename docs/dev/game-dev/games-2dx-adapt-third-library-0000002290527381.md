---
title: "三方库适配"
original_url: /docs/dev/game-dev/games-2dx-adapt-third-library-0000002290527381
format: md
upstream_id: dev/game-dev/games-2dx-adapt-third-library-0000002290527381
...
三方库集成编译主要有两种方式：源码集成和库文件集成方式。下面以Cocos2d-x引擎引入三方库为例说明这两种编译方式的差异。
