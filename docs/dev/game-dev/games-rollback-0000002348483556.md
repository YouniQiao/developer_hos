---
title: "回退版本"
original_url: /docs/dev/game-dev/games-rollback-0000002348483556
format: md
upstream_id: dev/game-dev/games-rollback-0000002348483556
...
3. 点击右上角的“版本回退”，在弹出框中填写回退原因，并点击“确认”。
   ...
   当您的应用从版本2回退到版本1后，如果您想再次对版本1升级，您需要确保您提交的应用签名与版本2的应用签名一致，否则选取软件包时会弹出错误提示框。相关内容请参见[软件包签名不一致如何处理](/docs/dev/game-dev/games-center-upgrade-version-0000002320626341#section17520173352618)。
