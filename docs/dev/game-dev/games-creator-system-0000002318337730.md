...
* HarmonyOS ArkTS接口：游戏替换对应能力时，您可以通过[Node-API框架](/docs/dev/ndk-dev/using-napi-interaction-with-cpp)使用C++/JS调用系统接口，ArkTS API参考请参见[ArkTS API参考](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ability-arkts) 。
...
本文示范了本地工程模块的两种场景，其他场景可参阅详细说明[napi\_load\_module\_with\_info支持的场景](https://gitee.com/link?target=/docs/dev/ndk-dev/use-napi-load-module-with-info#napi_load_module_with_info%25E6%2594%25AF%25E6%258C%2581%25E7%259A%2584%25E5%259C%25BA%25E6%2599%25AF)。
