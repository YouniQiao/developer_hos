---
title: "自定义频道属性"
original_url: https://developer.huawei.com/consumer/cn/doc/games-guides/games-gamemme-channelproperties-csharp-minigame-0000002359547146
format: md
---
...
1. 调用[GameMediaEngineForMiniGames.SetRtmChannelProperties](https://developer.huawei.com/consumer/cn/doc/games-references/gamemediaengineforminigames-csharp-minigame-0000002358963772#section17441854005)方法，设置频道自定义属性。
   ...
   ```
2. 当设置频道自定义属性时，您可进行相关回调处理。由于游戏多媒体SDK已对回调函数[OnSetRtmChannelProperties](https://developer.huawei.com/consumer/cn/doc/games-references/igamemmeeventhandlerforminigames-csharp-minigame-0000002392643789#section34195712402)进行了封装，只需注册OnSetRtmChannelPropertiesEvent事件监听，并实现OnSetRtmChannelPropertiesCallback委托函数即可。
...
1. 调用[GameMediaEngineForMiniGames.GetRtmChannelProperties](https://developer.huawei.com/consumer/cn/doc/games-references/gamemediaengineforminigames-csharp-minigame-0000002358963772#section239317269112)方法，查询频道自定义属性。
   ...
   ```
2. 当查询频道自定义属性时，您可进行相关回调处理。由于游戏多媒体SDK已对回调函数[OnGetRtmChannelProperties](https://developer.huawei.com/consumer/cn/doc/games-references/igamemmeeventhandlerforminigames-csharp-minigame-0000002392643789#section31161736105311)进行了封装，只需注册OnGetRtmChannelPropertiesEvent事件监听，并实现OnGetRtmChannelPropertiesCallback委托函数即可。
...
1. 调用[GameMediaEngineForMiniGames.DeleteRtmChannelProperties](https://developer.huawei.com/consumer/cn/doc/games-references/gamemediaengineforminigames-csharp-minigame-0000002358963772#section16880155412115)方法，删除频道自定义属性。
   ...
   ```
2. 当删除频道自定义属性时，您可进行相关回调处理。由于游戏多媒体SDK已对回调函数[OnDeleteRtmChannelProperties](https://developer.huawei.com/consumer/cn/doc/games-references/igamemmeeventhandlerforminigames-csharp-minigame-0000002392643789#section28041345520)进行了封装，只需注册OnDeleteRtmChannelPropertiesEvent事件监听，并实现OnDeleteRtmChannelPropertiesCallback委托函数即可。
