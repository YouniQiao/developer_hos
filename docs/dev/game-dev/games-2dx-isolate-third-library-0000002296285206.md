...
* C/C++语言
  + 有源码的SDK，请参考[三方库适配](https://developer.huawei.com/consumer/cn/doc/games-guides/games-2dx-adapt-third-library-0000002290527381)，编译后即可正常使用，无需拆分。
  + 闭源SDK，联系华为技术支持统一跟踪推动HarmonyOS 5.0及以上的系统的适配，代码先隔离。

* JS/TS语言
  + 有源码的SDK，请参考[开发共享包](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/application-package-overview)，将其改造成HAR/HSP使用，无需拆分。
  + 闭源SDK，联系华为技术支持统一跟踪推动HarmonyOS 5.0及以上的系统的适配，代码先隔离。
* 其他SDK（Java）
