---
title: "使用LTO优化编译"
original_url: https://developer.huawei.com/consumer/cn/doc/games-guides/pga-lto-0000002415677696
format: md
---
...
* 您可以选择单独使用LTO优化编译，或者和[PGO](https://developer.huawei.com/consumer/cn/doc/games-guides/pga-pgo-0000002415517840)结合使用。与PGO结合使用时，必须要将编译器替换为BiSheng编译器。
...
1. 点击“Jobs &gt; PGA &gt; PGA Settings”，进入“PGA AOT Settings”页面。
   ...
   ![](./img/8ff71f62.png)
2. 勾选“Enable LTO”，然后前往“Build Settings”页面[打包](https://developer.huawei.com/consumer/cn/doc/games-guides/pga-package-0000002089873625)即可，PGA会默认开启thin模式。
