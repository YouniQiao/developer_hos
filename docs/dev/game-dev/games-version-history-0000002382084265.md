...
format: md
upstream_id: dev/game-dev/games-version-history-0000002382084265
...
3. 在左侧导航栏选择“应用上架/元服务上架 &gt; 版本历史记录”，进入“版本历史记录”页面，该页面默认展示应用的所有历史版本信息。

   ![](./img/93429388.png "点击放大")

   * 您可以点击“隐藏详细信息”，隐藏应用软件包的详细信息。

     ![](./img/77ea03f6.png "点击放大")
   * 您可以点击历史版本，查看历史版本相应的信息。

     ![](./img/d14a288c.png "点击放大")
   * 您可以点击附件链接查看审核附件内容。

     ![](./img/3f3eb859.png "点击放大")
