---
title: "Device"
original_url: /docs/dev/game-dev/games-hismartperf-device-0000002286844738
format: md
upstream_id: dev/game-dev/games-hismartperf-device-0000002286844738
last_sync: 2026-06-07
sync_hash: 6e8cd291
upstream_hash: cce65bd0cfba
---
...
1. [下载HiSmartPerf-Device](/docs/dev/game-dev/games-hismartperf-download-0000002321404201)
...
3. 连接手机设备
   * USB 连接
     ...
     参考[手机设备如何成功连接电脑](/docs/dev/game-dev/games-hismartperf-faq-0000002286844742#section935516916145)连接工具和手机。
   * Wi-Fi 连接
