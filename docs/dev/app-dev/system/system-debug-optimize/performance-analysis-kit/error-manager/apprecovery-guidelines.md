...
由于上述接口可能在故障处理时使用，所以不会返回异常，需要开发者熟悉使用的场景。具体其各参数定义详见[应用故障恢复](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-app-ability-apprecovery)。
...
| --- | --- | --- | --- | --- |
| [JS\_CRASH](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-faultlogger#faulttype) | 支持 | 支持 | 支持 | 支持 |
| [APP\_FREEZE](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-faultlogger#faulttype) | API18及以上支持 | 支持 | 支持 | 支持 |
| [CPP\_CRASH](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-faultlogger#faulttype) | 不支持 | 不支持 | API24及以上支持 | 支持 |
