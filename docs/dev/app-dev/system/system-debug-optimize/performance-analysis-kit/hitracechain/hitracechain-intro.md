...
| 场景 | 异步任务 | 跨线程 | 跨进程 | 跨设备 |
| --- | --- | --- | --- | --- |
| 支持HiTraceChain自动传递的机制 | [async/await](/docs/dev/app-dev/application-framework/arkts/arkts-concurrency/async-concurrency-overview#asyncawait)  [Promise](/docs/dev/app-dev/application-framework/arkts/arkts-concurrency/async-concurrency-overview#promise) | [HiAppEvent](/docs/dev/app-dev/system/system-debug-optimize/performance-analysis-kit/hiappevent/hiappevent-intro)  [napi\_async\_work](/docs/dev/ndk-dev/use-napi-asynchronous-task)  [FFRT](/docs/dev/app-dev/system/system-basicfun/ffrt-kit/ffrt-overview) | [IPC](/docs/dev/app-dev/application-framework/ipc-kit/ipc-rpc-overview) | [RPC](/docs/dev/app-dev/application-framework/ipc-kit/ipc-rpc-overview) |
| 不支持HiTraceChain自动传递的机制 | 宏任务及其异步任务（例如[setTimeout](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-timer#settimeout)、[setInterval](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-timer#setinterval)等） | [TaskPool](/docs/dev/app-dev/application-framework/arkts/arkts-concurrency/multithread-concurrency/taskpool-introduction)  [Worker](/docs/dev/app-dev/application-framework/arkts/arkts-concurrency/multithread-concurrency/worker-introduction)  C++标准库std::thread、pthread\_create、std::async等创建的线程 | [Socket](/docs/dev/app-dev/system/system-network/network-kit/network-kit-data-transmission/socket-connection)  [Ashmem](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-rpc#ashmem8) | - |
