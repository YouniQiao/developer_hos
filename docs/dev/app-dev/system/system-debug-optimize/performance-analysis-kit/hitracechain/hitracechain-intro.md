...
| 场景 | 异步任务 | 跨线程 | 跨进程 | 跨设备 |
| --- | --- | --- | --- | --- |
| 支持HiTraceChain自动传递的机制 | [async/await](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/async-concurrency-overview#asyncawait)  [Promise](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/async-concurrency-overview#promise) | [HiAppEvent](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/hiappevent-intro)  [napi\_async\_work](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/use-napi-asynchronous-task)  [FFRT](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ffrt-overview) | [IPC](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ipc-rpc-overview) | [RPC](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ipc-rpc-overview) |
| 不支持HiTraceChain自动传递的机制 | 宏任务及其异步任务（例如[setTimeout](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-timer#settimeout)、[setInterval](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-timer#setinterval)等） | [TaskPool](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/taskpool-introduction)  [Worker](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/worker-introduction)  C++标准库std::thread、pthread\_create、std::async等创建的线程 | [Socket](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/socket-connection)  [Ashmem](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-rpc#ashmem8) | - |
