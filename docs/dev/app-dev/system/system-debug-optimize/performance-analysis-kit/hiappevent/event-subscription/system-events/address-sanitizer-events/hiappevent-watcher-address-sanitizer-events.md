...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| addressSanitizerPolicy | [AddressSanitizerPolicy](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-hiviewdfx-hiappevent#addresssanitizerpolicy24) | 否 | 是 | 地址越界事件配置策略。 |
