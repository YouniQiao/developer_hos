...
| [InstantShapeGenerator](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/pen-instantsshapegenerator) | [onShapeRecognized](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/pen-instantsshapegenerator#onshaperecognized) | 注册识别完成时的回调方法。使用callback异步回调。 |
