...
format: md
upstream_id: dev/app-dev/system/system-hardware/sensor-service-kit/sensorservice-kit-intro
...
Sensor（传感器）模块支持模拟器，但与真机存在差异，详情请参见“[模拟器与真机的差异](/docs/tools/coding-debug/ide-emulator-specification)”。

Vibrator（振动）模块暂不支持模拟器。
