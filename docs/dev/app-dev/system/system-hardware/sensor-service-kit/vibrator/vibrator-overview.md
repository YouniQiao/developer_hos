...
title: "振动开发概述"
original_url: /docs/dev/app-dev/system/system-hardware/sensor-service-kit/vibrator/vibrator-overview
format: md
upstream_id: dev/app-dev/system/system-hardware/sensor-service-kit/vibrator/vibrator-overview
