...
* **[设备状态感知开发指导](/docs/dev/app-dev/system/system-hardware/multimodal-awareness-kit/devicestatus-guidelines)**
* **[用户状态感知开发指导](/docs/dev/app-dev/system/system-hardware/multimodal-awareness-kit/userstatus-guidelines)**
* **[记忆链接开发指导](/docs/dev/app-dev/system/system-hardware/multimodal-awareness-kit/metadatabinding-guidelines)**
