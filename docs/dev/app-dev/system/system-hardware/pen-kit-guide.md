...
* **[手写功能开发指导（C/C++）](/docs/dev/app-dev/system/system-hardware/pen-kit-guide/pen-introduction-c)**
* **[Pen Kit常见问题](/docs/dev/app-dev/system/system-hardware/pen-kit-guide/pen-faq)**
