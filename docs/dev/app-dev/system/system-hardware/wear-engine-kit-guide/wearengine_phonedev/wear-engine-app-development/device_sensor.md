...
| 传感器类型 | 申请权限 |
| --- | --- |
| ECG、PPG、HR | [HEALTH\_SENSOR](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/wearengine_api#permission)人体传感器 |
| ACC、GYRO、MAG | [MOTION\_SENSOR](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/wearengine_api#permission)运动传感器 |
