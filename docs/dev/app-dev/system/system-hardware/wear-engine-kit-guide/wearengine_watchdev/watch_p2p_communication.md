...
6. 调用[sendMessage](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/wearengine_api#sendmessage)方法，从穿戴侧应用发送简短消息到对端应用。对端应用已注册监听消息接收后，即可收到穿戴侧应用发送的消息。
...
5. 调用[getP2pClient](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/wearengine_api#wearenginegetp2pclient)方法，获取[P2pClient](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/wearengine_api#p2pclient)对象。
6. 调用[transferFile](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/wearengine_api#transferfile)方法，从穿戴侧应用发送文件到对端应用。
...
5. 调用[registerMessageReceiver](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/wearengine_api#registermessagereceiver)方法，订阅监听消息接收事件。
   ...
   ```
6. 调用[unregisterMessageReceiver](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/wearengine_api#unregistermessagereceiver)方法，穿戴侧应用取消接收对端应用发过来的消息，需要传入订阅监听时的同一个回调函数对象。
...
5. 调用[registerFileReceiver](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/wearengine_api#registerfilereceiver)方法，订阅监听文件接收事件。
   ...
   ```
6. 调用[unregisterFileReceiver](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/wearengine_api#unregisterfilereceiver)方法，穿戴侧应用取消接收对端应用发过来的文件，需要传入订阅监听时的同一个回调函数对象。
...
5. 调用[startRemoteApp](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/wearengine_api#startremoteapp-1)方法，指定需要拉起对端侧应用包名和对端侧应用的服务类型与名称。
