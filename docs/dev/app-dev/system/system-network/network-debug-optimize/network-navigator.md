...
title: "使用网络领航员进行网络模拟"
original_url: /docs/dev/app-dev/system/system-network/network-debug-optimize/network-navigator
format: md
upstream_id: dev/app-dev/system/system-network/network-debug-optimize/network-navigator
...
同时，网络领航员还提供这些网络场景下的数据传输优化建议，App接入华为[Network Boost Kit](/docs/dev/app-dev/system/system-network/network-boost-kit-guide)，实现应用和OS跨层协同，提升应用的上网流畅度。
...
下面介绍通过设置界面使用网络领航员的方法，通过HDC命令行的使用方法见[netcopilot工具](/docs/dev/app-dev/system/network-netcopilot)。

当您首次使用该功能时，可根据 **[开启开发者选项](/docs/tools/coding-debug/ide-developer-mode#section530763213432)** 指引先开启设备的开发者模式，然后点击**设置** -> **系统** -> **开发者选项** -> **网络领航员**即可进入网络领航员页面。
...
如果您需要停止网络模拟场景，可点击右侧的![](./img/407e136d.png)，然后点击退出该网络模拟场景即可退出模拟。
...
自定义场景暂未接入Network Boost Kit，若开发者想模拟网络场景的注册回调，可使用[预置的网络模拟场景](#预置网络模拟使用简介)。
