...
original_url: /docs/dev/app-dev/system/system-network/distributed-service-kit
format: md
...
* **[应用跨设备连接管理](/docs/dev/app-dev/system/system-network/distributed-service-kit/abilityconnect-distributed)**
