...
* [Stage模型](/docs/dev/app-dev/application-framework/ability-kit/application-models#应用模型概况)示例：
  ...
  ```
* [FA模型](/docs/dev/app-dev/application-framework/ability-kit/application-models#应用模型概况)示例：
...
| --pkg-context-path | 否 | NA | 可指定语境信息表文件路径，文件名必须为pkgContextInfo.json。当app.json5配置文件中bundleType取值不是appPlugin，且module.json5配置文件中requestPermissions取值包含"ohos.permission.kernel.SUPPORT\_PLUGIN"时，该参数必填。 |
...
* module.json文件为DevEco Studio编译构建产物，其中的字段与配置文件的对应关系，请参考[表1 module.json与配置文件属性的对照表](/docs/dev/app-dev/system/packing-tool)。
...
| --- | --- | --- | --- |
| --mode | 是 | appqf | 打包类型。 |
| --hqf-list | 是 | NA | [HQF文件](/docs/dev/app-dev/system/packing-tool#hqf打包指令)路径，多个HQF以英文逗号隔开。 |
...
| --bundle-name | 否 | 包名 | 指定的Bundle名称，传入的包的Bundle名称会被修改为该Bundle名称。指定的值不能为空，该字段的详细定义和规格请参考[app.json5](/docs/dev/app-dev/getting-started/dev-fundamentals/app-configuration-file#配置文件标签)中的bundleName字段。 |
| --version-code | 否 | 版本号 | 指定的版本号，传入的包的版本号会被修改为该版本号。取值范围为0~2147483647的整数，指定的值不能为空值，该字段的详细定义和规格请参考[app.json5](/docs/dev/app-dev/getting-started/dev-fundamentals/app-configuration-file#配置文件标签)中的versionCode字段。 |
| --version-name | 否 | 版本名称 | 指定的版本名称，传入的包的版本名称会被修改为该版本名称。指定的值不能为空，该字段的详细定义和规格请参考[app.json5](/docs/dev/app-dev/getting-started/dev-fundamentals/app-configuration-file#配置文件标签)中的versionName字段。 |
| --min-compatible-version-code | 否 | 能够兼容的最低历史版本号 | 指定的最低历史版本号，传入的包的最低历史版本号会被修改为该版本号。取值范围为0~2147483647的整数，指定的值不能为空值，该字段的详细定义和规格请参考[app.json5](/docs/dev/app-dev/getting-started/dev-fundamentals/app-configuration-file#配置文件标签)中的minCompatibleVersionCode字段。 |
| --min-api-version | 否 | SDK的API最小版本 | 指定的SDK的API最小版本，传入的包的SDK的API最小版本会被修改为该版本。取值范围为0~2147483647的整数，指定的值不能为空值，该字段的详细定义和规格请参考[app.json5](/docs/dev/app-dev/getting-started/dev-fundamentals/app-configuration-file#配置文件标签)中的minAPIVersion字段。 |
| --target-api-version | 否 | API目标版本 | 指定的API目标版本，传入的包的API目标版本会被修改为该版本。取值范围为0~2147483647的整数，指定的值不能为空值，该字段的详细定义和规格请参考[app.json5](/docs/dev/app-dev/getting-started/dev-fundamentals/app-configuration-file#配置文件标签)中的targetAPIVersion字段。 |
| --api-release-type | 否 | API目标版本的类型 | 指定的API目标版本的类型，传入的包的API目标版本的类型会被修改为该类型。指定的值不能为空，该字段的详细定义和规格请参考[app.json5](/docs/dev/app-dev/getting-started/dev-fundamentals/app-configuration-file#配置文件标签)中的apiReleaseType字段。 |
| --bundle-type | 否 | Bundle类型 | 指定的Bundle类型，传入的包的Bundle类型会被修改为该类型。指定的值不能为空，该字段的详细定义和规格请参考[app.json5](/docs/dev/app-dev/getting-started/dev-fundamentals/app-configuration-file#配置文件标签)中的bundleType字段。 |
| --installation-free | 否 | 是否支持免安装特性 | 指定的免安装特性，传入的包的免安装特性会被修改为该类型。指定的值不能为空，该字段的详细定义和规格请参考Stage模型[module.json5](/docs/dev/app-dev/getting-started/dev-fundamentals/module-configuration-file#配置文件标签)/FA模型[config.json](/docs/dev/app-dev/getting-started/dev-fundamentals/application-configuration-file-overview-fa)中的installationFree字段。 |
| --delivery-with-install | 否 | 当前HAP是否在用户主动安装HAP所在应用的时候一起安装 | 指定的HAP是否需要一起安装，传入的包的deliveryWithInstall会被修改为该类型。指定的值不能为空，该字段的详细定义和规格参考Stage模型[module.json5](/docs/dev/app-dev/getting-started/dev-fundamentals/module-configuration-file#配置文件标签)/FA模型[config.json](/docs/dev/app-dev/getting-started/dev-fundamentals/application-configuration-file-overview-fa)中的deliveryWithInstall字段。 |
...
| --build-version | 否 | 构建版本号 | 指定的构建版本号，传入的包的构建版本号会被修改为该版本号。指定的值不能为空值，该字段的详细定义和规格请参考[app.json5](/docs/dev/app-dev/getting-started/dev-fundamentals/app-configuration-file#配置文件标签)中的buildVersion字段。 |
...
通过[app打包指令](#app打包指令)、[fastApp打包指令](#fastapp模式打包指令)或[多工程打包指令](#多工程打包指令)打包生成App包时，设置--stat-duplicate为true开启扫描重复so文件，系统将在打包成功后生成扫描报告。识别重复so后，开发者可根据实际需求减小包大小。扫描报告将存放在打包生成的App包所在目录下的scan\_report目录中。扫描报告的内容结构如表16所示，重复so文件的特征信息结构如表17所示。扫描报告的示例如下：
...
1. 根据报错信息检查[app.json5](/docs/dev/app-dev/getting-started/dev-fundamentals/app-configuration-file)和[module.json5](/docs/dev/app-dev/getting-started/dev-fundamentals/module-configuration-file)中的配置项是否准确。当有多条报错信息时，优先根据第一条报错信息进行排查。
...
检查[app.json5](/docs/dev/app-dev/getting-started/dev-fundamentals/app-configuration-file)，修改asanEnabled和tsanEnabled，确保二者不会同时为true。
...
检查[app.json5](/docs/dev/app-dev/getting-started/dev-fundamentals/app-configuration-file)，确保asanEnabled、tsanEnabled、GWPAsanEnabled三项的中任一项与hwasanEnabled，不会同时配置为true。
...
1. 检查[module.json5](/docs/dev/app-dev/getting-started/dev-fundamentals/module-configuration-file)，确保module.json5文件中正确配置了abilities标签，并且至少包含一个ability，详细请参见[abilities标签](/docs/dev/app-dev/getting-started/dev-fundamentals/module-configuration-file#abilities标签)。
2. 检查module.json5和[app.json5](/docs/dev/app-dev/getting-started/dev-fundamentals/app-configuration-file)，当bundleType为atomicService时，确保installationFree配置为true，反之，需要配置为false。
...
修改continueBundleName，确保其与[app.json5](/docs/dev/app-dev/getting-started/dev-fundamentals/app-configuration-file)中的bundleName不同。
...
1. 检查[module.json5](/docs/dev/app-dev/getting-started/dev-fundamentals/module-configuration-file)，确保targetModuleName和requestPermissions不会同时出现。
2. 检查module.json5，确保targetModuleName和name不同。
3. 检查module.json5，确保配置targetPriority时，同时配置了targetModuleName。
4. 检查[app.json5](/docs/dev/app-dev/getting-started/dev-fundamentals/app-configuration-file)和module.json5，确保配置targetBundleName时，同时配置了targetModuleName。
...
2. JDK 20对zip64扩展数据字段校验存在已知缺陷，当zip包（如HAP、HSP或任何zip64文件）的目录中zip64扩展字段长度异常时，解析会抛出Invalid CEN header (invalid zip64 extra data field size)异常。
...
构建[bundleType](/docs/dev/app-dev/getting-started/dev-fundamentals/app-configuration-file#配置文件标签)为shared的App包时，检查HSP包无效。

**可能原因**

1. 存在两个以上的[HSP包](/docs/dev/app-dev/getting-started/dev-fundamentals/in-app-hsp)。例如下图使用DevEco Studio构建App时，工程中包含了两个HSP包library和library1，此时打包APP包失败。
...
2. 检查打包文件，删除HSP包中[module.json5](/docs/dev/app-dev/getting-started/dev-fundamentals/module-configuration-file)配置的dependencies。
...
1. 参考[asanEnabled配置错误码](#section10012004-检查参数asanenabled失败)、[hwasanEnabled配置错误码](#section10012005-检查参数hwasanenabled失败)、[atomicService配置错误码](#section10012006-检查atomicservice失败)、[continueBundleName配置错误码](#section10012007-检查continuebundlename无效)，更改配置项。
2. 参考[检查overlay失败](#section10012008-检查overlay失败)，更改配置项。
...
5. --json-path指定的module.json文件中bundleType是appPlugin时，module.json文件不包含[ohos.permission.kernel.SUPPORT\_PLUGIN](/docs/dev/app-dev/system/system-security/access-control/app-permission-mgmt/app-permissions/restricted-permissions#ohospermissionkernelsupport_plugin)权限。
...
HSP/HAP在[module.json5](/docs/dev/app-dev/getting-started/dev-fundamentals/module-configuration-file)配置了应用内可执行二进制文件的路径信息[executableBinaryPaths](/docs/dev/app-dev/getting-started/dev-fundamentals/module-configuration-file#executablebinarypaths标签)且存在二进制文件，但配置为以不解压libs库的方式进行安装。
...
1. 模块的[app.json5](/docs/dev/app-dev/getting-started/dev-fundamentals/app-configuration-file)配置文件中bundleType为app，但[module.json5](/docs/dev/app-dev/getting-started/dev-fundamentals/module-configuration-file)中的installationFree属性值为true。
...
检查[module.json5](/docs/dev/app-dev/getting-started/dev-fundamentals/module-configuration-file)，确保Entry类型包abilities正确配置了ability。
...
1. 检查[app.json5](/docs/dev/app-dev/getting-started/dev-fundamentals/app-configuration-file)，确保bundleType设置为app，atomicService，shared之一。
2. 如果bundleType为shared，确保[module.json5](/docs/dev/app-dev/getting-started/dev-fundamentals/module-configuration-file)中的installationFree设置为false。
...
4. 当前参与打包的HAP或HSP中，存在模块的apiReleaseType（[app.json5](/docs/dev/app-dev/getting-started/dev-fundamentals/app-configuration-file)配置文件中的属性）与其他模块不一致。
...
检查分发策略相关配置，确保policy的值为include或exclude，value取值参见[distributionFilter标签](/docs/dev/app-dev/getting-started/dev-fundamentals/module-configuration-file#distributionfilter标签)。
...
根据报错信息检查[app.json5](/docs/dev/app-dev/getting-started/dev-fundamentals/app-configuration-file)和[module.json5](/docs/dev/app-dev/getting-started/dev-fundamentals/module-configuration-file)中的配置项是否准确。当有多条报错信息时，优先根据第一条报错信息进行排查。
...
1. 检查[module.json5](/docs/dev/app-dev/getting-started/dev-fundamentals/module-configuration-file)中的dependencies，删除循环依赖，确保App中不存在循环依赖。
...
检查[module.json5](/docs/dev/app-dev/getting-started/dev-fundamentals/module-configuration-file)中的[preloads属性](/docs/dev/app-dev/getting-started/dev-fundamentals/module-configuration-file#atomicservice标签)下的moduleName，不能配置为自身模块module.json5中的name，且moduleName对应的模块必须存在。
...
检查[module.json5](/docs/dev/app-dev/getting-started/dev-fundamentals/module-configuration-file)中元服务[preloads属性](/docs/dev/app-dev/getting-started/dev-fundamentals/module-configuration-file#atomicservice标签)，确保没有配置重复的模块，配置所有的模块都存在且不能配置自身的模块名。
...
检查targetModuleName配置项，确保其正确配置（详细请参见[module.json5配置文件标签](/docs/dev/app-dev/getting-started/dev-fundamentals/module-configuration-file#配置文件标签)及targetModuleName属性），必要时创建目标模块。
...
检查[module.json5](/docs/dev/app-dev/getting-started/dev-fundamentals/module-configuration-file)，删除proxyData中重复的uri，确保每个uri都是唯一的（详细请参见[proxyData标签](/docs/dev/app-dev/getting-started/dev-fundamentals/module-configuration-file#proxydata标签)）。
...
检查[module.json5](/docs/dev/app-dev/getting-started/dev-fundamentals/module-configuration-file)，删除continueType或deviceType重复的配置项。
...
检查Entry模块分发策略是否正确配置，例如policy的值应为exclude或include，详细请参考[distributionFilter标签](/docs/dev/app-dev/getting-started/dev-fundamentals/module-configuration-file#distributionfilter标签)。
...
1. 传入的参数类型错误。
2. 传入参数范围错误。
3. 传入HAP或HSP包不完整，缺少json文件（json文件配置请参考Stage模型[module.json5](/docs/dev/app-dev/getting-started/dev-fundamentals/module-configuration-file#配置文件标签)/FA模型[config.json](/docs/dev/app-dev/getting-started/dev-fundamentals/application-configuration-file-overview-fa)）。
