...
title: "进程信息查询场景（C/C++）"
original_url: /docs/dev/app-dev/system/system-security/device-security-kit-guide/devicesecurity-audit/devicesecurity-audit-queryproc-c
format: md
upstream_id: dev/app-dev/system/system-security/device-security-kit-guide/devicesecurity-audit/devicesecurity-audit-queryproc-c
