...
* **[查询需要用户认证的关键资产(ArkTS)](/docs/dev/app-dev/system/system-security/asset-store-kit/asset-arkts/asset-js-query-auth)**
* **[管理群组关键资产(ArkTS)](/docs/dev/app-dev/system/system-security/asset-store-kit/asset-arkts/asset-js-group-access-control)**
* **[同步（备份恢复）关键资产(ArkTS)](/docs/dev/app-dev/system/system-security/asset-store-kit/asset-arkts/asset-js-sync)**
