...
3. Provider注册和注销有权限管控，需申请[ohos.permission.CRYPTO\_EXTENSION\_REGISTER](/docs/dev/app-dev/system/system-security/access-control/app-permission-mgmt/app-permissions/restricted-permissions#ohospermissioncrypto_extension_register)权限。
