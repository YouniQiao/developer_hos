...
HUKS提供PIN码认证能力和认证状态查询能力。应用PIN码认证之前，可以先查询认证状态。如果需要PIN码认证，则需要拉起[证书管理应用](/docs/dev/app-dev/system/system-security/device-certificate-kit/certmanager/certmanager-overview)，完成PIN码认证。
