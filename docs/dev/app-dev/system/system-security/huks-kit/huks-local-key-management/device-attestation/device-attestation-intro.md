...
密钥证明证书链同时还包含了应用公钥，对应的私钥存储在基于硬件的安全环境中，您可以使用此私钥对重要的业务请求进行签名，以此**识别通过抓包等方法篡改或伪造应用请求**的攻击场景。
...
| 接口 | 配额 | 配额说明 |
| --- | --- | --- |
| 密钥证明接口 | 35次/秒/应用 | 默认情况下，每个应用调用密钥证明接口（[anonAttestKeyItem](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-huks#huksanonattestkeyitem11) / [OH\_Huks\_AnonAttestKeyItem](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-native-huks-api-h#oh_huks_anonattestkeyitem)）的瞬时流量每秒不超过35次请求。如果应用需要修改服务配额，请通过[在线提单](https://developer.huawei.com/consumer/cn/support/feedback/#/)申请修改配额。 |
