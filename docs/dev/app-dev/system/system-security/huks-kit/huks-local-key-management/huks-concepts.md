...
其中，密钥算法的值取自枚举类[HuksKeyAlg](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-huks#hukskeyalg)。
...
* RSA密钥对材料格式：
  ...
  | 密钥  算法 | 密钥  大小 | 模数n  长度Ln | 公钥指数e  长度Le | 私钥指数d  长度Ld | n | e | d |
  | --- | --- | --- | --- | --- | --- | --- | --- |
  | 4字节 | 4字节 | 4字节 | 4字节 | 4字节 | Ln字节 | Le字节 | Ld字节 |
* ECC密钥对材料格式：

  | 密钥  算法 | 密钥  大小 | 坐标x  长度Lx | 坐标y  长度Ly | 坐标z  长度Lz | x | y | z |
  | --- | --- | --- | --- | --- | --- | --- | --- |
  | 4字节 | 4字节 | 4字节 | 4字节 | 4字节 | Lx字节 | Ly字节 | Lz字节 |
* DH密钥对材料格式：

  | 密钥  算法 | 密钥  大小 | 公钥pk  长度Lpk | 私钥sk  长度Lsk | 保留  字段 | pk | sk |
  | --- | --- | --- | --- | --- | --- | --- |
