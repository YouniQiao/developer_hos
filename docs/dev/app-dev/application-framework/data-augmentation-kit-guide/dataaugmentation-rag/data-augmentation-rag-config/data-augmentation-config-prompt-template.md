...
在应用[资源目录](/docs/dev/app-dev/getting-started/resource-access/resource-categories-and-access#资源目录)的rawfile/arkdata/rag下创建prompt\_template.json文件，若工程中无目标目录则递归创建。
