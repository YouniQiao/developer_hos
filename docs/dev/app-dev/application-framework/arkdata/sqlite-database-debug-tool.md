---
title: "SQLite调试工具指导"
original_url: /docs/dev/app-dev/application-framework/arkdata/sqlite-database-debug-tool
format: md
upstream_id: dev/app-dev/application-framework/arkdata/sqlite-database-debug-tool
...
* 开发者也可以通过DevEco Studio调试数据库，具体操作方式请参考[访问应用数据库](/docs/tools/coding-debug/ide-database-inspector)。

## 环境要求

* 开发者在使用本工具前需开启[开发者模式](/docs/tools/coding-debug/ide-developer-mode#section530763213432)，且需要获取[hdc工具](/docs/dev/app-dev/system/hdc)，执行hdc shell。
* 连接设备。
