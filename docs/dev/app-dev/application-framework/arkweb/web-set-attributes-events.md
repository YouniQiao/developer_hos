...
* **[在新窗口中打开页面](/docs/dev/app-dev/application-framework/arkweb/web-set-attributes-events/web-open-in-new-window)**
* **[管理位置权限](/docs/dev/app-dev/application-framework/arkweb/web-set-attributes-events/web-geolocation-permission)**
* **[使用隐私模式](/docs/dev/app-dev/application-framework/arkweb/web-set-attributes-events/web-incognito-mode)**
* **[使用运动和方向传感器监测设备状态](/docs/dev/app-dev/application-framework/arkweb/web-set-attributes-events/web-sensor)**
