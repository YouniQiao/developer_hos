...
客户端和服务端开发步骤详见：[客户端应用开发](/docs/dev/app-dev/application-framework/content-embed-kit/content-embed-client-guidelines)和[服务端应用开发](/docs/dev/app-dev/application-framework/content-embed-kit/content-embed-server-guidelines)。

![](./img/b41b90c3.jpg)

1. 创建[OE文档](/docs/dev/app-dev/application-framework/content-embed-kit/content-embed-kit-terminology#oe文档)：客户端创建OE文档有三种方式：基于[OEID](/docs/dev/app-dev/application-framework/content-embed-kit/content-embed-kit-terminology#oeid)创建OE文档，基于文件创建OE文档，基于[OE格式文件](/docs/dev/app-dev/application-framework/content-embed-kit/content-embed-kit-terminology#oe格式文件)加载OE文档。
2. 创建[客户端OE对象](/docs/dev/app-dev/application-framework/content-embed-kit/content-embed-kit-terminology#客户端oe对象)：客户端基于OE文档创建客户端OE对象，实现OE文档与客户端OE对象的关联，并用于与服务端通信。创建客户端OE对象完成后需注册该对象回调以响应OE服务端通知。
...
5. 注册[服务端OE对象](/docs/dev/app-dev/application-framework/content-embed-kit/content-embed-kit-terminology#服务端oe对象)回调：当OE服务端应用的OE Extension组件启动后，客户端OE对象将会与服务端OE对象绑定，此时需注册服务端OE对象回调函数，以响应OE客户端的请求。
