...
format: md
upstream_id: dev/app-dev/application-framework/content-embed-kit/content-embed-client-guidelines
...
OE客户端应用指嵌入其它文档的应用，通过调用[OE框架层接口](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-content-embed-proxy-h)实现嵌入外部文档、展示文档快照，以及按需启动OE服务端应用编辑文档的功能。
