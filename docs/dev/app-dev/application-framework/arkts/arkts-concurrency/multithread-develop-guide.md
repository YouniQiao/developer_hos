...
* **[常驻任务并发场景](/docs/dev/app-dev/application-framework/arkts/arkts-concurrency/multithread-develop-guide/resident-task)**
* **[应用多线程开发实践案例](/docs/dev/app-dev/application-framework/arkts/arkts-concurrency/multithread-develop-guide/multithread-develop-case)**
