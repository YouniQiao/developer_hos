...
* **[应用共享目录配置](/docs/dev/app-dev/application-framework/core-file-kit/app-file/share-app-file-configuration)**
* **[应用数据备份恢复](/docs/dev/app-dev/application-framework/core-file-kit/app-file/app-file-backup-restore)**
