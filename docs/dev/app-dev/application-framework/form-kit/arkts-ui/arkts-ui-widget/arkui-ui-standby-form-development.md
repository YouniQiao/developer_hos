...
1. 登录AppGallery Connect，选择“开发与服务”。
   ...
   ![](./img/eca82640.png "点击放大")
2. 在项目列表中找到您的项目，并点击选择需开启开放能力的应用/元服务。

   ![](./img/b9b10419.png "点击放大")
3. 在“开放能力管理”页面，点击待机屏保卡片对应的申请按钮。

   ![](./img/8550d520.png "点击放大")
