...
* **[拉起系统应用](/docs/dev/app-dev/application-framework/ability-kit/stage-model-development/inter-app-redirection/system-app-startup)**
* **[应用间跳转典型场景](/docs/dev/app-dev/application-framework/typical-scenarios-for-inter-app-jumping)**
