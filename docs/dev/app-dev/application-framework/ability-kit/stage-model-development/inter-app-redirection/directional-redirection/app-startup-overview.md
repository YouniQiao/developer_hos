...
* openLink方式启动其他应用：API version 21版本之前，不支持取消弹框提示。从API version 21版本开始，可以将OpenLinkOptions中的hideFailureTipDialog字段设置为true，取消弹框提示。
  ...
  ```
* startAbility隐式启动其他应用：可以通过将Want中的[flags字段](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-app-ability-wantconstant#flags)设置为FLAG\_START\_WITHOUT\_TIPS，取消弹框提示。
