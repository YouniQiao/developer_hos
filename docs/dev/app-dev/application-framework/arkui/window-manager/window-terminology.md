...
format: md
upstream_id: dev/app-dev/application-framework/arkui/window-manager/window-terminology
...
| --- | --- |
| ![](./img/553e10f3.png) | ![](./img/d979c2fd.png) |

自由窗口可以通过隐藏装饰栏进入沉浸式布局。

| 自由窗口的非沉浸式布局示意 | 自由窗口的沉浸式布局示意 |
| --- | --- |
| ![](./img/5cf5b820.png) | ![](./img/d5920ade.png) |
