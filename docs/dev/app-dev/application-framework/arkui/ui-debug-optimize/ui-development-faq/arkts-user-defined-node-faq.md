...
* 步骤一：如果传递给BuilderNode的参数持有了BuilderNode对象，当不再需要一个BuilderNode节点时，使用[update](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-arkui-buildernode#update)接口更新参数，解除参数对象对BuilderNode的引用。从API version 24版本开始，步骤一可被省略。
