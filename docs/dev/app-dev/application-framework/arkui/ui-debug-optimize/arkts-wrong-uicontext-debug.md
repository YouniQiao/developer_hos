...
| 描述 | 说明 |
| --- | --- |
| The instance is determined by the caller. | 在调用过程中显式指定了实例ID。应用侧通常是通过[UIContext](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-uicontext)接口进行指定。 |
