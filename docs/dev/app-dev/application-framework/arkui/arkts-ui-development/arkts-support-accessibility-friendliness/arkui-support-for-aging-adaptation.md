...
format: md
upstream_id: dev/app-dev/application-framework/arkui/arkts-ui-development/arkts-support-accessibility-friendliness/arkui-support-for-aging-adaptation
...
| --- | --- |
| ![](./img/80f4f43e.png) | ![](./img/f171b414.png) |
...
| 系统字体为一倍（适老化能力开启前） | 系统字体为1.75倍（适老化能力开启后） |
| --- | --- |
| ![](./img/8f7d65c8.png) | ![](./img/5d06af54.png) |
