...
original_url: /docs/dev/app-dev/application-framework/accessibility-kit/accessibilitykit-overview
format: md
upstream_id: dev/app-dev/application-framework/accessibility-kit/accessibilitykit-overview
