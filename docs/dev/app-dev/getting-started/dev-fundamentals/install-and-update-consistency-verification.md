...
| apl | 表示应用程序的[APL等级](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/app-permission-mgmt-overview#权限机制中的基本概念)，系统定义的apl包括：normal、system\_basic和system\_core。 | 是 | 更新不同版本时无校验，同版本有校验。 |
