...
|  |  |
| --- | --- |
| 隔空传送分享文件 | 通过隔空传送手势触发文件分享，接收端为phone、tablet设备会将媒体文件存储至图库，非媒体文件存储至文件管理器，接收端为PC/2in1设备则会将媒体以及非媒体文件存储至文件管理器。  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/92/v3/AvzLHXtlQxaoG8xpTwGZrA/zh-cn_image_0000002497204225.gif?HW-CC-KV=V1&HW-CC-Date=20260606T073954Z&HW-CC-Expire=86400&HW-CC-Sign=18EF1465999CA0EA3B4FEE62AB6067A5E476138A0492A1CE3D3ECF40CA5F2F2E "点击放大") |
| 隔空传送分享链接 | 通过隔空传送手势触发分享App Linking链接，接收端已安装应用可直接打开应用查看内容。  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/13/v3/xSIeodBJTh6ZcNcyvhBQBg/zh-cn_image_0000002464284810.gif?HW-CC-KV=V1&HW-CC-Date=20260606T073954Z&HW-CC-Expire=86400&HW-CC-Sign=7D1D726E8A7ADDE24996EB9E1CE1ECFB3EB994634EF88F9627CF37BB6F57C2D6 "点击放大") |

## 实现原理

###关键技术

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/dc/v3/rY_5QZKKRTSsisMzJML8Iw/zh-cn_image_0000002464125198.jpg?HW-CC-KV=V1&HW-CC-Date=20260606T073954Z&HW-CC-Expire=86400&HW-CC-Sign=5AFBB394E01063D824DB58B8EC8517C0FEDCB3A342175D13DFCEE291A0EA74ED "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a4/v3/0ilsOIodQkGhO0E0a_tH5Q/zh-cn_image_0000002497324205.jpg?HW-CC-KV=V1&HW-CC-Date=20260606T073954Z&HW-CC-Expire=86400&HW-CC-Sign=0E3CE79DA64A088844154150947FE8E849FAA51EED6A3183343FDFE1BD5F9BA8 "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3c/v3/WDIk1NQ-RqeI3fz1H4zvbA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260606T073954Z&HW-CC-Expire=86400&HW-CC-Sign=E4EF1F11EA66048A483AF182205162AF68B2693D0983FD3F14893CD4871D5EED)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/db/v3/Pwz97hBlQsm-zFGHP8NqAA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260606T073954Z&HW-CC-Expire=86400&HW-CC-Sign=D9500BA531911044B5AA5D239C3BC35A5708B3DB4E65DF47926684B44C3204EB)

隔空传送监听方法：

on(event: 'gesturesShare', capability: SendCapabilityRegistry, callback: Callback<SharableTarget>): void

该方法需传入capability参数，类型为[SendCapabilityRegistry](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/share-harmony-share#sendcapabilityregistry)，继承自[BaseCapabilityRegistry](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/share-harmony-share#basecapabilityregistry)。其包含windowId属性，需要传入当前应用的窗口ID。在PC/2in1或平板自由窗口模式中，系统会根据窗口ID判断当前应用是否获取了窗口焦点。只有在获取焦点后，当用户触发隔空传送事件时，才会触发应用注册的隔空传送方法。
...
<div class="source-link-wrapper"><a href="https://gitcode.com/harmonyos_samples/GesturesShare/blob/master/feature/share/src/main/ets/model/ShareModel.ets#L17-L24" target="_blank" rel="noopener noreferrer" class="source-link"><svg class="source-link-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" /><polyline points="15 3 21 3 21 9" /><line x1="10" y1="14" x2="21" y2="3" /></svg> 查看源码：ShareModel.ets</a></div>
...
<div class="source-link-wrapper"><a href="https://gitcode.com/harmonyos_samples/GesturesShare/blob/master/feature/share/src/main/ets/model/ShareModel.ets#L55-L93" target="_blank" rel="noopener noreferrer" class="source-link"><svg class="source-link-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" /><polyline points="15 3 21 3 21 9" /><line x1="10" y1="14" x2="21" y2="3" /></svg> 查看源码：ShareModel.ets</a></div>
...
<div class="source-link-wrapper"><a href="https://gitcode.com/harmonyos_samples/GesturesShare/blob/master/feature/share/src/main/ets/view/FileSharePageComponent.ets#L17-L153" target="_blank" rel="noopener noreferrer" class="source-link"><svg class="source-link-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" /><polyline points="15 3 21 3 21 9" /><line x1="10" y1="14" x2="21" y2="3" /></svg> 查看源码：FileSharePageComponent.ets</a></div>
...
<div class="source-link-wrapper"><a href="https://gitcode.com/harmonyos_samples/GesturesShare/blob/master/feature/share/src/main/ets/model/ShareModel.ets#L118-L154" target="_blank" rel="noopener noreferrer" class="source-link"><svg class="source-link-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" /><polyline points="15 3 21 3 21 9" /><line x1="10" y1="14" x2="21" y2="3" /></svg> 查看源码：ShareModel.ets</a></div>
...
<div class="source-link-wrapper"><a href="https://gitcode.com/harmonyos_samples/GesturesShare/blob/master/feature/share/src/main/ets/model/ShareModel.ets#L103-L114" target="_blank" rel="noopener noreferrer" class="source-link"><svg class="source-link-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" /><polyline points="15 3 21 3 21 9" /><line x1="10" y1="14" x2="21" y2="3" /></svg> 查看源码：ShareModel.ets</a></div>
...
<div class="source-link-wrapper"><a href="https://gitcode.com/harmonyos_samples/GesturesShare/blob/master/feature/share/src/main/ets/view/LinkSharePageComponent.ets#L17-L159" target="_blank" rel="noopener noreferrer" class="source-link"><svg class="source-link-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" /><polyline points="15 3 21 3 21 9" /><line x1="10" y1="14" x2="21" y2="3" /></svg> 查看源码：LinkSharePageComponent.ets</a></div>
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c3/v3/IsNTyJmISr2KjCbMtazqkQ/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260606T073954Z&HW-CC-Expire=86400&HW-CC-Sign=21016F62A6F8BBAD3F73FEE789BC5A6FC011A8C59A0F368EB40C10F40C37D0F3)
...
<div class="source-link-wrapper"><a href="https://gitcode.com/harmonyos_samples/GesturesShare/blob/master/feature/share/src/main/ets/model/ShareModel.ets#L162-L179" target="_blank" rel="noopener noreferrer" class="source-link"><svg class="source-link-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" /><polyline points="15 3 21 3 21 9" /><line x1="10" y1="14" x2="21" y2="3" /></svg> 查看源码：ShareModel.ets</a></div>
...
<div class="source-link-wrapper"><a href="https://gitcode.com/harmonyos_samples/GesturesShare/blob/master/product/entry/src/main/module.json5#L2-L74" target="_blank" rel="noopener noreferrer" class="source-link"><svg class="source-link-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" /><polyline points="15 3 21 3 21 9" /><line x1="10" y1="14" x2="21" y2="3" /></svg> 查看源码：module.json5</a></div>
...
<div class="source-link-wrapper"><a href="https://gitcode.com/harmonyos_samples/GesturesShare/blob/master/product/entry/src/main/ets/entryability/EntryAbility.ets#L28-L43" target="_blank" rel="noopener noreferrer" class="source-link"><svg class="source-link-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" /><polyline points="15 3 21 3 21 9" /><line x1="10" y1="14" x2="21" y2="3" /></svg> 查看源码：EntryAbility.ets</a></div>
...
<div class="source-link-wrapper"><a href="https://gitcode.com/harmonyos_samples/GesturesShare/blob/master/product/entry/src/main/ets/entryability/EntryAbility.ets#L47-L53" target="_blank" rel="noopener noreferrer" class="source-link"><svg class="source-link-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" /><polyline points="15 3 21 3 21 9" /><line x1="10" y1="14" x2="21" y2="3" /></svg> 查看源码：EntryAbility.ets</a></div>
...
<div class="source-link-wrapper"><a href="https://gitcode.com/harmonyos_samples/GesturesShare/blob/master/product/entry/src/main/ets/entryability/EntryAbility.ets#L57-L73" target="_blank" rel="noopener noreferrer" class="source-link"><svg class="source-link-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" /><polyline points="15 3 21 3 21 9" /><line x1="10" y1="14" x2="21" y2="3" /></svg> 查看源码：EntryAbility.ets</a></div>
...
<div class="source-link-wrapper"><a href="https://gitcode.com/harmonyos_samples/GesturesShare/blob/master/product/entry/src/main/ets/pages/Index.ets#L37-L41" target="_blank" rel="noopener noreferrer" class="source-link"><svg class="source-link-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" /><polyline points="15 3 21 3 21 9" /><line x1="10" y1="14" x2="21" y2="3" /></svg> 查看源码：Index.ets</a></div>
