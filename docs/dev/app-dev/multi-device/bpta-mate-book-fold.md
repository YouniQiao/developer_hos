...
original_url: https://developer.huawei.com/consumer/cn/doc/best-practices/bpta-mate-book-fold
format: md
---
...
本文聚焦于折叠电脑应用体验提升的开发指导。如需多设备开发的基础通用能力指导，请参考“[一次开发，多端部署概览](https://developer.huawei.com/consumer/cn/doc/best-practices/bpta-multi-device-overview)”系列文章。
