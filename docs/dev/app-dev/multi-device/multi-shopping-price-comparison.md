...
电商购物类的多设备响应式设计指南，[点击访问](/docs/design/app-design-practices/ecommerce)。
...
| 区域编号 | 简介 | 实现方案 |
| --- | --- | --- |
| 1 | 底部/侧边页签 | 借助[栅格](/docs/dev/app-dev/multi-device/bpta-multi-device-responsive-layout#section1061332817545)布局监听断点变化改变位置。 |
...
| 4 | 商品小图 | 使用[List组件](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-list)+[栅格](/docs/dev/app-dev/multi-device/bpta-multi-device-responsive-layout#section1061332817545)布局实现每行显示固定个数的商品图。 |
