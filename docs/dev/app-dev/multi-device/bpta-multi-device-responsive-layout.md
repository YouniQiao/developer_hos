...
**图1** 响应式布局示意图1
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/53/v3/v_-LmFk-QGa_-7wHgwEJuA/zh-cn_image_0000002355146009.png?HW-CC-KV=V1&HW-CC-Date=20260606T074229Z&HW-CC-Expire=86400&HW-CC-Sign=882274D1EA1833B71998C92553478ABD6F5E368163898F9E74709D33B6584820 "点击放大")

**图2** 响应式布局示意图2
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/df/v3/5a_ZIxfcSSmP1eWyes7zeg/zh-cn_image_0000002321147306.png?HW-CC-KV=V1&HW-CC-Date=20260606T074229Z&HW-CC-Expire=86400&HW-CC-Sign=818EDF769A425D49109D6FD7F90AD9A21AD8000AE8F21798F567660FA535EE7F "点击放大")

本文将详细介绍实现响应式布局的四种响应式布局能力，帮助开发者实现响应式布局效果。

| 响应式布局能力 | 简介 |
| --- | --- |
| [断点](#section1532120147301) | 将窗口宽度划分为不同的范围（即断点），监听窗口尺寸变化，当断点改变时同步调整页面布局。 |
| [媒体查询](#section1950102518311) | 媒体查询支持监听窗口宽度、横竖屏、深浅色、设备类型等多种媒体特征，当媒体特征发生改变时同步调整页面布局。 |
| [栅格](#section1061332817545) | 栅格组件将其所在的区域划分为有规律的多列，通过调整不同断点下的栅格组件的参数以及其子组件占据的列数等，实现不同的布局效果。 |
| [响应式组件](#section1914110349546) | HarmonyOS提供的一些组件支持响应式布局，例如： Tabs、Swiper、Grid、List、GridRow，通过断点设置可以实现不同的展示效果。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/93/v3/5MmtwQQYTKaF-SUcUGMlpA/zh-cn_image_0000002583460597.png?HW-CC-KV=V1&HW-CC-Date=20260606T074229Z&HW-CC-Expire=86400&HW-CC-Sign=60C6F4767CABDE63DCCFF0008BEABEA66BD9D8AE43F6257B6699AEDAF6380BF1 "点击放大")

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/67/v3/2n1iNjUyTIij5s93f2ZJhQ/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260606T074229Z&HW-CC-Expire=86400&HW-CC-Sign=492548F64D605024AC033C5B64C3A42A69FD9E91CA1528E2C97D03307535F9BC)

1. 由于官网无法涵盖所有产品的断点区间，说明中提供补充方法：开发者可通过[display](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-display)模块接口获取屏幕宽高属性，自行判断当前设备所属的横纵断点区间。
2. 断点面向窗口而非设备类型，相同断点区间的窗口展示相同的页面布局。同一设备上的不同窗口形态（例如全屏显示、分屏显示、自由窗口等）可能落入不同的断点区间，展示不同布局。
3. 部分手机、小折叠屏机型横屏/反向横屏时横向断点会落入lg，包括Pura70 Pro和Pocket2。
...
<div class="source-link-wrapper"><a href="https://gitcode.com/HarmonyOS_Samples/ResponsiveLayout/blob/master/entry/src/main/ets/utils/WindowUtil.ets#L362-L385" target="_blank" rel="noopener noreferrer" class="source-link"><svg class="source-link-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" /><polyline points="15 3 21 3 21 9" /><line x1="10" y1="14" x2="21" y2="3" /></svg> 查看源码：WindowUtil.ets</a></div>
...
<div class="source-link-wrapper"><a href="https://gitcode.com/HarmonyOS_Samples/ResponsiveLayout/blob/master/entry/src/main/ets/utils/WindowUtil.ets#L31-L358" target="_blank" rel="noopener noreferrer" class="source-link"><svg class="source-link-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" /><polyline points="15 3 21 3 21 9" /><line x1="10" y1="14" x2="21" y2="3" /></svg> 查看源码：WindowUtil.ets</a></div>
...
<div class="source-link-wrapper"><a href="https://gitcode.com/HarmonyOS_Samples/ResponsiveLayout/blob/master/entry/src/main/ets/entryability/EntryAbility.ets#L42-L72" target="_blank" rel="noopener noreferrer" class="source-link"><svg class="source-link-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" /><polyline points="15 3 21 3 21 9" /><line x1="10" y1="14" x2="21" y2="3" /></svg> 查看源码：EntryAbility.ets</a></div>
...
<div class="source-link-wrapper"><a href="https://gitcode.com/HarmonyOS_Samples/ResponsiveLayout/blob/master/entry/src/main/ets/pages/GridLayout.ets#L25-L46" target="_blank" rel="noopener noreferrer" class="source-link"><svg class="source-link-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" /><polyline points="15 3 21 3 21 9" /><line x1="10" y1="14" x2="21" y2="3" /></svg> 查看源码：GridLayout.ets</a></div>
...
| sm | md | lg |
| --- | --- | --- |
| ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5c/v3/xOqGT-vvRAKLAbYGBq3_kg/zh-cn_image_0000002321307158.png?HW-CC-KV=V1&HW-CC-Date=20260606T074229Z&HW-CC-Expire=86400&HW-CC-Sign=6C84F4C154C0054D0A94BD542FA23AEFB6FBCB8CB0717E108B10BEEFEB9117E0 "点击放大") | ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/94/v3/px1ZGcNNTn6Q5j9xLv5kig/zh-cn_image_0000002355146041.png?HW-CC-KV=V1&HW-CC-Date=20260606T074229Z&HW-CC-Expire=86400&HW-CC-Sign=8D00E9D54156D1D9F8AAB59F36298791680F81F457C9A1BE1249251AABB85C14 "点击放大") | ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/21/v3/VGaaMtD5RZqbOsCSMfilbQ/zh-cn_image_0000002321147338.png?HW-CC-KV=V1&HW-CC-Date=20260606T074229Z&HW-CC-Expire=86400&HW-CC-Sign=F824BA32F5C06D2B13D0314D528E46C5F903D78FE3A48918F18A5C2DAD817818 "点击放大") |
...
<div class="source-link-wrapper"><a href="https://gitcode.com/harmonyos_samples/ResponsiveLayout/blob/master/entry/src/main/ets/utils/WidthBreakpointType.ets#L17-L43" target="_blank" rel="noopener noreferrer" class="source-link"><svg class="source-link-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" /><polyline points="15 3 21 3 21 9" /><line x1="10" y1="14" x2="21" y2="3" /></svg> 查看源码：WidthBreakpointType.ets</a></div>
...
<div class="source-link-wrapper"><a href="https://gitcode.com/HarmonyOS_Samples/BestPracticeSnippets/blob/master/ResponsiveLayout/entry/src/main/ets/pages/VideoExample.ets#L87-L88" target="_blank" rel="noopener noreferrer" class="source-link"><svg class="source-link-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" /><polyline points="15 3 21 3 21 9" /><line x1="10" y1="14" x2="21" y2="3" /></svg> 查看源码：VideoExample.ets</a></div>
...
<div class="source-link-wrapper"><a href="https://gitcode.com/HarmonyOS_Samples/BestPracticeSnippets/blob/master/ResponsiveLayout/entry/src/main/ets/pages/UpdateWidthExample.ets#L23-L24" target="_blank" rel="noopener noreferrer" class="source-link"><svg class="source-link-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" /><polyline points="15 3 21 3 21 9" /><line x1="10" y1="14" x2="21" y2="3" /></svg> 查看源码：UpdateWidthExample.ets</a></div>
...
| 窗口类型 | 横向窗口 | 类方形窗口 |
| --- | --- | --- |
| 效果图 | ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/94/v3/aCS_Pmt-RsyIlOfVWV3q8g/zh-cn_image_0000002355265889.png?HW-CC-KV=V1&HW-CC-Date=20260606T074229Z&HW-CC-Expire=86400&HW-CC-Sign=361507C8E5A9822D910803DAA622F2B27660798A4845FE8412A1394CBBF1DB43 "点击放大") | ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ea/v3/Z-rTqAq1TbGWHYZgt6fbFQ/zh-cn_image_0000002321307194.png?HW-CC-KV=V1&HW-CC-Date=20260606T074229Z&HW-CC-Expire=86400&HW-CC-Sign=D0312452A5FA8E017C4A6D3C787B767E87ABAC0D986A4C22C10E07A28C02838C) |
...
<div class="source-link-wrapper"><a href="https://gitcode.com/HarmonyOS_Samples/BestPracticeSnippets/blob/master/ResponsiveLayout/entry/src/main/ets/pages/VideoExample.ets#L39-L48" target="_blank" rel="noopener noreferrer" class="source-link"><svg class="source-link-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" /><polyline points="15 3 21 3 21 9" /><line x1="10" y1="14" x2="21" y2="3" /></svg> 查看源码：VideoExample.ets</a></div>
...
<div class="source-link-wrapper"><a href="https://gitcode.com/HarmonyOS_Samples/BestPracticeSnippets/blob/master/ResponsiveLayout/entry/src/main/ets/pages/VideoExample.ets#L52-L58" target="_blank" rel="noopener noreferrer" class="source-link"><svg class="source-link-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" /><polyline points="15 3 21 3 21 9" /><line x1="10" y1="14" x2="21" y2="3" /></svg> 查看源码：VideoExample.ets</a></div>
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d9/v3/4PFT8OTXSDqvEqYTYSSklQ/zh-cn_image_0000002321147370.jpg?HW-CC-KV=V1&HW-CC-Date=20260606T074229Z&HW-CC-Expire=86400&HW-CC-Sign=9F4E2F9C68004728AD99DC669F40B90D3393B7B1A5F51AD90C52EF51A8BE53FF "点击放大")
...
2. 使用@Watch装饰器监听状态变量isFullScreen的变化，以判断视频是否全屏播放，并在显示或隐藏时同步修改窗口方向。全屏播放时，未使用断点的窗口设置逻辑如下：需要将窗口设置为AUTO\_ROTATION\_LANDSCAPE属性的情况包括手机、双折叠屏（X 系列）的折叠态与半折态。
   ...
   **图4** **手机效果图**
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1a/v3/F9qhMR4sTBGnmJwlWyM6WQ/zh-cn_image_0000002355265933.jpg?HW-CC-KV=V1&HW-CC-Date=20260606T074229Z&HW-CC-Expire=86400&HW-CC-Sign=78DE526CC630A034563C0F4C751BCAC99679E7E397982048713C5714538AB381 "点击放大")

   **图5** **双折叠屏（X系列）半折态**
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8d/v3/Ygl8oUYxSLi74zOZCdtESw/zh-cn_image_0000002321307226.jpg?HW-CC-KV=V1&HW-CC-Date=20260606T074229Z&HW-CC-Expire=86400&HW-CC-Sign=0C59A976C11DDF4137CCE90A32531DF625BC178EC3F0D0B83691D09D4EA22734 "点击放大")
...
<div class="source-link-wrapper"><a href="https://gitcode.com/HarmonyOS_Samples/BestPracticeSnippets/blob/master/ResponsiveLayout/entry/src/main/ets/pages/VideoExample.ets#L61-L80" target="_blank" rel="noopener noreferrer" class="source-link"><svg class="source-link-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" /><polyline points="15 3 21 3 21 9" /><line x1="10" y1="14" x2="21" y2="3" /></svg> 查看源码：VideoExample.ets</a></div>
   ...
   * 手机与双折叠屏（X系列）折叠态横屏时的横向断点为md，纵向断点为sm，此时如果退出全屏播放，则竖屏展示布局。将窗口显示方向设置为PORTRAIT。
     ...
     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7b/v3/bDb09ZRlRdGZiQaF7q_1ug/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260606T074229Z&HW-CC-Expire=86400&HW-CC-Sign=1352ADAC6B145F000F526EACE3111CBDBD880CEAC50C9D88F0EEB350012A5BCD)
...
<div class="source-link-wrapper"><a href="https://gitcode.com/HarmonyOS_Samples/BestPracticeSnippets/blob/master/ResponsiveLayout/entry/src/main/ets/pages/VideoExample.ets#L120-L156" target="_blank" rel="noopener noreferrer" class="source-link"><svg class="source-link-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" /><polyline points="15 3 21 3 21 9" /><line x1="10" y1="14" x2="21" y2="3" /></svg> 查看源码：VideoExample.ets</a></div>
...
| sm | md | lg |
| --- | --- | --- |
| ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/96/v3/y66DzoTARaS_6mRWDV_7YA/zh-cn_image_0000002355146105.jpg?HW-CC-KV=V1&HW-CC-Date=20260606T074229Z&HW-CC-Expire=86400&HW-CC-Sign=77AC0D86CCBAC7F0AE0153263A0EFB965D2E62EA4582695A9A64F6B8E5265E99 "点击放大") | ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c4/v3/7FnjVb_uRpeNhc-FgjdmQA/zh-cn_image_0000002321147406.jpg?HW-CC-KV=V1&HW-CC-Date=20260606T074229Z&HW-CC-Expire=86400&HW-CC-Sign=BC51B4A2E076098530A48530FCE9A5C477D65504AB70B2769E3E3EAEC9334E7E "点击放大") | ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/91/v3/TbYQZGIIQ_CD0R8DOFuzlQ/zh-cn_image_0000002355265965.jpg?HW-CC-KV=V1&HW-CC-Date=20260606T074229Z&HW-CC-Expire=86400&HW-CC-Sign=4158DD8B83BE55D5B64095A12D95D416C9620F2666EBDBEC18101793B50248F2 "点击放大") |
...
<div class="source-link-wrapper"><a href="https://gitcode.com/harmonyos_samples/BestPracticeSnippets/blob/master/AdaptiveCapabilities/entry/src/main/ets/pages/responsiveLayout/breakpoint/Breakpoint.ets#L17-L129" target="_blank" rel="noopener noreferrer" class="source-link"><svg class="source-link-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" /><polyline points="15 3 21 3 21 9" /><line x1="10" y1="14" x2="21" y2="3" /></svg> 查看源码