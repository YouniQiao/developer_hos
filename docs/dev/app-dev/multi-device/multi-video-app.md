...
| --- | --- | --- | --- | --- |
| 推荐页-精选页Tab | ![](./img/f927ba14.png "点击放大") | ![](./img/c74b1d49.png "点击放大") | ![](./img/379c61f6.png "点击放大") | ![](./img/31cb7df3.png "点击放大") |
...
| 区域编号 | 简介 | 实现方案 |
| --- | --- | --- |
| 1 | Banner图 | 使用响应式组件[Swiper](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper)实现。通过[displayCount](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#displaycount8)属性，控制视窗内显示元素数量。在横向断点为sm或md时，视窗内显示1个元素；在横向断点为lg或xl时，视窗内显示2个元素。结合[aspectRatio](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-layout-constraints#aspectratio)属性，实现Banner图在不同断点下的自适应缩放。 |
| 2 | 图标列表 | 使用响应式组件[List](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-list)实现。通过监听断点变化，动态调整图标间距。 |
| 3 | 热播视频 | 使用网格容器[Grid](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-grid)实现。通过[columnsTemplate](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-grid#columnstemplate)属性，动态调整不同断点下的显示列数。结合[aspectRatio](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-layout-constraints#aspectratio)属性，实现视频预览图在不同断点下的自适应缩放。 |
| 4 | 新片发布 |
| 5 | 每日佳片 | 使用响应式布局的栅格系统实现。通过挪移布局，实现不同断点下“上下布局”与“左右布局”之间的自适应切换。结合[aspectRatio](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-layout-constraints#aspectratio)属性，实现视频预览图在不同断点下的自适应缩放。 |
| 6 | 往期回顾 |
...
* 社区页签沉浸式设计
  ...
  | 横向（/纵向）断点 | sm/md | sm/lg | md | lg、xl |
  | --- | --- | --- | --- | --- |
  | 推荐页-社区页Tab | ![](./img/62a9cadc.png "点击放大") | ![](./img/24f939e5.png "点击放大") | ![](./img/36ab497d.png "点击放大") | ![](./img/f71b08b9.png "点击放大") |
* Banner图创新排版

  | 横向（/纵向）断点 | sm/md | sm/lg | md | lg、xl |
  | --- | --- | --- | --- | --- |
  | 推荐页-视频页Tab | ![](./img/315c5cce.png "点击放大") | ![](./img/0f222fdb.png "点击放大") | ![](./img/83e4d816.png "点击放大") | ![](./img/848726f9.png "点击放大") |
...
* 热播视频区域长按预览
  ...
  长视频应用移动端实现了手机和平板设备的适配，支持的输入设备包括触控屏、手写笔和鼠标。
  ...
  | --- | --- | --- | --- |
  | 推荐页-热播视频长按预览 | ![](./img/c6e9a2a4.png "点击放大") | ![](./img/69e41737.png "点击放大") | ![](./img/561a76cd.png "点击放大") |
* 热播视频区域缩放控制
  ...
  | 横向断点 | md | lg、xl |
  | --- | --- | --- |
  | 推荐页-热播视频区域缩放 | ![](./img/c3115daa.png "点击放大") | ![](./img/fd527bc0.png "点击放大") |
...
| 横向（/纵向）断点 | sm/md | sm/lg | md | lg、xl |
| --- | --- | --- | --- | --- |
| 搜索页 | ![](./img/f9e1b4f5.png "点击放大") | ![](./img/9698ed14.png "点击放大") | ![](./img/03abca59.png "点击放大") | ![](./img/88683e62.png "点击放大") |
| 搜索页-智能提示 | ![](./img/274f5f68.png "点击放大") | ![](./img/aa446766.png "点击放大") | ![](./img/fbcbb976.png "点击放大") | ![](./img/7b3062c7.png "点击放大") |
| 搜索页-搜索结果 | ![](./img/7aab77b7.png "点击放大") | ![](./img/23120d93.png "点击放大") | ![](./img/61f1f380.png "点击放大") | ![](./img/7087f6c6.png "点击放大") |
...
| 3 | 热搜 | 使用响应式组件[List](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-list)实现。通过[lanes](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-list#lanes9)属性控制列数：在sm横向断点下1列显示；在md横向断点下2列显示；在lg和xl横向断点下3列显示。随断点变化自适应调整顶部页签的间距。 |
...
| 5 | 搜索结果 | 使用响应式栅格系统实现。通过挪移布局实现“上下布局”与“左右布局”切换。同时，结合[aspectRatio](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-layout-constraints#aspectratio)属性，实现视频预览图的自适应缩放。 |
...
| 横向（/纵向）断点 | sm/md | sm/lg | md | lg、xl |
| --- | --- | --- | --- | --- |
| 视频详情页-边看边评 | ![](./img/140c8ba9.png "点击放大") | ![](./img/53196c21.png "点击放大") | ![](./img/8ff79e41.png "点击放大") | ![](./img/ae50f234.png "点击放大") |
...
| 区域编号 | 简介 | 实现方案 |
| --- | --- | --- |
| 1 | 视频播放 | 使用[AVPlayer](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-media-avplayer)和[XComponent](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-xcomponent)等视频播放相关组件实现。具体实现逻辑可查看[示例代码](#section18854194463114)。 |
...
| 4 | 写评论 | 使用[TextInput](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-textinput)组件实现。通过[layoutWeight](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-size#layoutweight)属性实现自适应拉伸，实现输入框在不同断点下均横向占满容器的剩余空间。 |
| 5 | 视频简介 | 视频简介区域的图标使用[Row](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-row)组件实现。通过将[justifyContent](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-row#justifycontent8)属性设置为FlexAlign.SpaceBetween实现图标均分排列。选集列表和周边视频区域通过[List](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-list)组件实现延伸能力，横向显示相关内容。在sm和md横向断点下，隐藏该区域；在lg和xl断点下，显示该区域。 |
...
| 横向（/纵向）断点 | sm/md | sm/lg | md | lg、xl |
| --- | --- | --- | --- | --- |
| 视频详情页-全屏播放 | ![](./img/84a11765.png "点击放大") | ![](./img/4bb02855.png "点击放大") | ![](./img/f4b2110a.png "点击放大") | ![](./img/faa893aa.png "点击放大") |
| 视频详情页-选集 | ![](./img/84f0ddd2.png "点击放大") | ![](./img/0d6f2f01.png "点击放大") | ![](./img/a6087f4f.png "点击放大") | ![](./img/18ae1e77.png "点击放大") |
...
| 区域编号 | 简介 | 实现方案 |
| --- | --- | --- |
| 1 | 全屏视频播放 | 使用[AVPlayer](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-media-avplayer)和[XComponent](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-xcomponent)等视频播放相关组件实现，具体实现逻辑可查看[示例代码](#section18854194463114)。 |
| 2 | 进度条及工具栏 | 进度条使用[Slider](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-slider)组件实现。通过[layoutWeight](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-size#layoutweight)属性，控制进度条在不同断点下均横向占满父组件剩余空间。 |
| 3 | 选集列表 | 使用响应式组件[List](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-list)实现。通过[lanes](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-list#lanes9)属性控制选集列表的列数在不同断点下自适应变化。在不同断点下，该区域切换为侧边显示或底部显示。断点变化时，该区域尺寸支持两种配置方式：设置为固定大小，或通过[layoutWeight](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-size#layoutweight)属性实现与区域1、区域2按固定占比分配空间。 |
...
| 区域编号 | 简介 | 实现方案 |
| --- | --- | --- |
| 1 | Banner图 | 与移动端[推荐页](#section109591922155720)区域1-6复用布局实现方案。 |
| 2 | 图标列表 |
| 3 | 热播视频 |
| 4 | 新片发布 |
| 5 | 每日佳片 |
...
* 社区页签沉浸式设计
  ...
  ![](./img/96eb869d.png "点击放大")
* Banner图创新排版

  ![](./img/166554d7.png "点击放大")
...
| 交互功能 | 效果图 |
| --- | --- |
| 热播视频区域长按预览 | ![](./img/b483e0df.png "点击放大") |
| 热播视频区域缩放控制 | ![](./img/c37be4d6.png "点击放大") |
...
|  |  |
| --- | --- |
| 搜索页 | ![](./img/ad01a7d2.png "点击放大") |
| 搜索页-智能提示 | ![](./img/1a0e0cf7.png "点击放大") |
| 搜索页-搜索结果 | ![](./img/d0c8fb85.png "点击放大") |
...
| 区域编号 | 简介 | 实现方案 |
| --- | --- | --- |
| 1 | 搜索框 | 与移动端[搜索页](#section1733591819510)区域1-5复用布局实现方案。 |
| 2 | 搜索发现 |
| 3 | 热搜 |
| 4 | “华”搜索智能提示 |
| 5 | 搜索结果 |
...
| 区域编号 | 简介 | 实现方案 |
| --- | --- | --- |
| 1 | 视频播放 | 与移动端[边看边评页](#li790319142255)区域1-5复用布局实现方案。 |
| 2 | 相关列表 |
| 3 | 全部评论 |
| 4 | 写评论 |
| 5 | 视频简介 |
...
|  |  |
| --- | --- |
| 视频详情页-全屏播放 | ![](./img/e055a95a.png "点击放大") |
| 视频详情页-选集 | ![](./img/7c691963.png "点击放大") |
...
| 区域编号 | 简介 | 实现方案 |
| --- | --- | --- |
| 1 | 全屏视频播放 | 与移动端[全屏播放页](#li3446284253)区域1-3复用布局实现方案。 |
| 2 | 进度条及工具栏 |
| 3 | 选集列表 |
...
| 区域编号 | 简介 | 实现方案 |
| --- | --- | --- |
| 1 | Banner图 | 使用响应式组件[Swiper](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper)实现。通过[displayCount](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#displaycount8)属性控制视窗内同时显示5个元素，当视窗内元素发生位置变换时，呈现不同的布局效果，提升视觉交互体验。 |
| 2 | 顶部页签 | 使用响应式组件[List](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-list)实现。通过index变化实现下方区域显示内容的切换。 |
| 3 | 热播视频 | 与移动端设备复用布局方案，同移动端[推荐页](#section109591922155720)区域3、4的布局实现方案。 |
| 4 | 新片发布 |
| 5 | 每日佳片 | 与移动端设备复用布局方案，同移动端[推荐页](#section109591922155720)区域5、6的布局实现方案。 |
| 6 | 往期回顾 |
...
|  |  |
| --- | --- |
| 搜索页 | ![](./img/625ba868.png "点击放大") |
| 搜索页-搜索结果 | ![](./img/67948cd7.png "点击放大") |
...
| 区域编号 | 简介 | 实现方案 |
| --- | --- | --- |
| 1 | 搜索框 | 使用[TextInput](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-textinput)组件实现。设置为固定宽度，并在窗口水平方向居中显示。 |
| 2 | 自定义键盘 | 使用栅格组件[Grid](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-grid)分别实现字母输入和数字输入两个自定义键盘。 |
| 3 | 搜索智能提示 | 使用响应式组件[List](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-list)实现。 |
| 4 | 搜索推荐 | 上方标题栏使用[Text](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-text)或响应式组件[List](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-list)实现，下方视频区域使用响应式组件[List](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-list)实现，在相同布局区域进行复用。 |
| 5 | 搜索结果 |
...
|  |  |
| --- | --- |
| 视频详情页 | ![](./img/3bb70d75.png "点击放大") |
| 视频详情页-全屏播放 | ![](./img/e39c93dd.png "点击放大") |
| 视频详情页-选集 | ![](./img/6ab8f2c1.png "点击放大") |
...
| --- | --- | --- |
| 1 | 视频播放 | 使用[AVPlayer](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-media-avplayer)和[XComponent](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-xcomponent)等视频播放相关组件实现。具体实现逻辑可查看[示例代码](#section18854194463114)。 |
| 2 | 标题栏 | 在父组件[Row](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-row)中分别实现标题和选集两个功能区。通过[Stack](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-stack)组件控制视频详情页组件层级，确保标题栏始终显示在视频详情页最上层。 |
...
| 4 | 选集列表 | 使用响应式组件[List](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-list)实现。进入视频详情页时默认显示该区域，视频播放时自动隐藏该区域；用户执行选集操作时，重新显示该区域。 |
| 5 | 进度条 | 使用[Slider](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-slider)组件实现。进入视频详情页时默认隐藏该区域，视频播放时自动显示该区域；用户执行选集操作时，重新隐藏该区域。 |
| 6 | 视频推荐 | 上方标题栏使用[Text](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-text)组件实现，下方视频区域使用响应式组件[List](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-list)实现。进入视频详情页时默认显示该区域，视频播放时自动隐藏该区域；用户退出视频播放时，重新显示该区域。 |
