...
| --- | --- | --- | --- | --- |
| 效果图 | ![](./img/b5e898e5.png "点击放大") | ![](./img/3bf34839.png "点击放大") | ![](./img/618d17c9.png "点击放大") | ![](./img/1996ca58.png "点击放大") |
...
| 区域编号 | 简介 | 实现方案 |
| --- | --- | --- |
| 1 | 侧边导航栏 | 使用[HdsNavigation](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdsnavigation)组件实现，通过窗口宽度与高宽比，控制窗口变化时，修改mode单双栏显示。 |
| 2 | 顶部标题栏 | 使用[HdsNavDestination](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdsnavdestination)组件设置[titleBar](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdsnavigation#titlebar)属性实现。在不同的设备宽度下组件自适应占满一屏。 |
| 3 | 底部导航栏 | 使用[HdsTabs](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdstabs)组件实现，通过[barFloatingStyle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdstabs#barfloatingstyle)属性设置页签悬浮样式。 |
| 4 | 图片内容区 | 使用[Grid](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-grid)组件实现，通过[@Env环境变量](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-env-system-property)修改不同断点下columnsTemplate，显示不同的列数，并设置图片的[aspectioRatio](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-layout-constraints#aspectratio)属性固定宽高比。 |
...
| --- | --- | --- | --- | --- |
| 消息页 | ![](./img/92981243.png "点击放大") | ![](./img/e401d169.png "点击放大") | ![](./img/a62f5f79.png "点击放大") | ![](./img/ecf07957.png "点击放大") |
...
| 区域编号 | 简介 | 实现方案 |
| --- | --- | --- |
| 1 | 顶部标题栏 | 使用[Row](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-row)组件自定义TitleView实现。在不同的设备宽度下组件自适应占满一屏。 |
| 2 | 底部/侧边工具栏 | 使用[Flex](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-flex)组件实现，通过窗口宽度与高宽比，控制窗口变化时，子组件排列方向为Row或Column。 |
| 3 | 图片内容区 | 使用堆叠容器[Stack](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-stack)组件嵌套[Image](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-image)组件实现，设置图片的[aspectioRatio](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-layout-constraints#aspectratio)属性固定宽高比。并通过监听断点变化，动态调整两侧边距。 |
| 4 | 警告弹窗 | 使用[警告弹窗AlertDialog](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-methods-alert-dialog-box)实现，仅在PuraX外屏等小屏场景弹出。 |
...
| 区域编号 | 简介 | 实现方案 |
| --- | --- | --- |
| 1 | 侧边导航栏 | 同移动端[照片浏览页](#section6120145294418)对应区域的布局实现方案一致。 |
| 2 | 顶部标题栏 |
| 3 | 图片内容区 |
...
| 区域编号 | 简介 | 实现方案 |
| --- | --- | --- |
| 1 | 顶部标题栏 | 同移动端[照片编辑页](#section36831643877)对应区域的布局实现方案一致。 |
| 2 | 底部/侧边工具栏 |
| 3 | 图片内容区 |
