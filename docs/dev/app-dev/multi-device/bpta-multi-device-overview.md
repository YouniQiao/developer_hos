...
本系列文章聚焦于多设备适配的通用基础指导。若需深入了解特定设备的硬件参数与体验提升设计，请参考“[多端设备体验提升](https://developer.huawei.com/consumer/cn/doc/best-practices/bpta-cell-phone)”专题。
...
* [从一个例子开始](/docs/dev/app-dev/multi-device/bpta-multi-device-start)：通过示例介绍“一多”应用的开发过程，让开发者对“一多”有个直观认识。
* [多设备体验设计](/docs/dev/app-dev/multi-device/bpta-multi-device-design-principles)：介绍了应用UX设计理念，重点阐述了设计初期的原则与要点，思考多设备设计中的差异性、一致性、灵活性与兼容性。
* [多设备界面开发](https://developer.huawei.com/consumer/cn/doc/best-practices/bpta-multi-device-page)和[多设备功能开发](/docs/dev/app-dev/multi-device/bpta-multi-device-function)：介绍了“一多”能力，其中每个能力都提供了代码示例和UX效果，让开发者可以快速学习“一多”能力。
* [多设备工程部署](/docs/dev/app-dev/multi-device/bpta-multi-device-ide)：介绍了从工程角度如何开始开发应用，让开发者可以直接上手创建多设备应用的工程，是后面学习“一多”能力的上手基础。
...
一多开发中的UX体验设计详细内容，可参见[多设备体验设计](/docs/dev/app-dev/multi-device/bpta-multi-device-design-principles)。
...
架构设计的详细原理，可参见[分层架构设计](https://developer.huawei.com/consumer/cn/doc/best-practices/bpta-layered-architecture-design)和[模块化设计](https://developer.huawei.com/consumer/cn/doc/best-practices/bpta-modular-design)。
...
* 窗口适配
  ...
  ![](./img/d2a3050c.png "点击放大")

  在本文的[多设备窗口形态](https://developer.huawei.com/consumer/cn/doc/best-practices/bpta-multi-device-window)章节，有详细的开发实践原理和步骤。
* 断点和响应式布局
  ...
  ![](./img/456086ce.png "点击放大")

  在本文的[响应式布局](/docs/dev/app-dev/multi-device/bpta-multi-device-responsive-layout)章节，详细介绍了如何实现界面响应式布局变化。
* 交互归一
  ...
  ![](./img/43d59c97.png "点击放大")

  在本文的[多设备交互](/docs/dev/app-dev/multi-device/bpta-multi-interaction)章节，将详细介绍交互事件的开发实践。
...
在本文的[多设备功能开发](/docs/dev/app-dev/multi-device/bpta-multi-device-function)章节，有详细的多设备功能开发实践介绍。
...
* 影音娱乐类
  ...
  ![](./img/7dd8d1c1.png "点击放大")

  场景案例最佳实践：[多设备长视频界面](/docs/dev/app-dev/multi-device/multi-video-app)。
* 社交通讯类
  ...
  ![](./img/f1224cc8.png "点击放大")

  场景案例最佳实践：[多设备即时通讯界面](/docs/dev/app-dev/multi-device/multi-communication-app)。
* 新闻阅读类

  新闻阅读类应用，本质是信息的聚合。首页和详情页是此类应用的典型核心场景。在宽屏设备中，首页需要进行延伸布局、重复布局等适配，以确保浏览效率更高；详情页使用左右布局往往能获得更舒适的阅读方式，达到边看边评的效果。

  ![](./img/b928b022.png "点击放大")

  ![](./img/189e72e9.jpg "点击放大")

  场景案例最佳实践：[多设备新闻阅读界面](/docs/dev/app-dev/multi-device/multi-news-read)。
* 电商购物类
  ...
  ![](./img/bf37bb22.png "点击放大")

  场景案例最佳实践：[多设备购物比价界面](/docs/dev/app-dev/multi-device/multi-shopping-price-comparison)。
* 便捷生活类

  便捷生活类场景主要包括点餐、观影、看攻略等。此类场景在宽屏上可以让用户拥有更高效和流畅的使用体验。

  ![](./img/e6f834a1.png "点击放大")

  场景案例最佳实践：[多设备便捷生活界面](/docs/dev/app-dev/multi-device/multi-convenient-life)。
* 旅游住宿类

  旅游住宿、订票类场景通常包含火车/飞机订票、订酒店、查询票务信息等核心功能，围绕此核心功能，此类场景旨在让用户拥有流畅沉浸的用户体验，提供更轻便高效的交互体验。

  ![](./img/3cfbd6e9.png "点击放大")

  场景案例最佳实践：[多设备旅行订票界面](/docs/dev/app-dev/multi-device/multi-travel-accommodation)。
* 出行导航类
  ...
  ![](./img/24c7b3c6.png "点击放大")

  场景案例最佳实践：[多设备地图导航界面](/docs/dev/app-dev/multi-device/multi-travel-navigation)。
...
* 折叠屏适配
  ...
  ![](./img/f9bd8196.png "点击放大")![](./img/47294c6b.png "点击放大")
  ...
  ![](./img/5211f267.png "点击放大")

  折叠屏适配的详细开发步骤，请参见[折叠屏悬停态](/docs/dev/app-dev/multi-device/bpta-folded-hover)和设备场景[双折叠应用开发](/docs/dev/app-dev/multi-device/bpta-foldable-guide)。
* 多端设备支持
  ...
  设备维度的特性适配，具体的开发步骤可参见多端设备支持相关内容：[手机](https://developer.huawei.com/consumer/cn/doc/best-practices/bpta-cell-phone)、[平板](https://developer.huawei.com/consumer/cn/doc/best-practices/bpta-tablet-pc)、[电脑](https://developer.huawei.com/consumer/cn/doc/best-practices/bpta-pc)和[穿戴](https://developer.huawei.com/consumer/cn/doc/best-practices/bpta-wear)。
...
[方舟开发框架](/docs/dev/app-dev/application-framework/arkui/arkui-overview)（简称：ArkUI）提供开发者进行应用UI开发时所必须的能力。
...
* 整个代码工程最终构建出一个[应用程序包](/docs/dev/app-dev/getting-started/dev-fundamentals/application-package-overview)，发布到应用市场中。
* 参考链接：[分层架构设计](https://developer.huawei.com/consumer/cn/doc/best-practices/bpta-layered-architecture-design)。
...
* “Ability”类型的Module编译后生成[HAP包](/docs/dev/app-dev/getting-started/dev-fundamentals/hap-package)。
* “Library”类型的Module编译后生成[HAR包](/docs/dev/app-dev/getting-started/dev-fundamentals/har-package)或[HSP包](/docs/dev/app-dev/getting-started/dev-fundamentals/in-app-hsp)。
...
关于Entry类型的HAP包、Feature类型的HAP包、HAR包、HSP包以及APP Pack的详细介绍请参考[Stage模型应用程序包结构](/docs/dev/app-dev/getting-started/dev-fundamentals/application-package-structure-stage)。
