...
original_url: https://developer.huawei.com/consumer/cn/doc/best-practices/bpta-multi-device-overview
format: md
---
...
一多开发中的UX体验设计详细内容，可参见[多设备体验设计](https://developer.huawei.com/consumer/cn/doc/best-practices/bpta-multi-device-design-principles)。
...
* 断点和响应式布局
  ...
  在本文的[响应式布局](https://developer.huawei.com/consumer/cn/doc/best-practices/bpta-multi-device-responsive-layout)章节，详细介绍了如何实现界面响应式布局变化。
* 交互归一
  ...
  在本文的[多设备交互](https://developer.huawei.com/consumer/cn/doc/best-practices/bpta-multi-interaction)章节，将详细介绍交互事件的开发实践。
...
在本文的[多设备功能开发](https://developer.huawei.com/consumer/cn/doc/best-practices/bpta-multi-device-function)章节，有详细的多设备功能开发实践介绍。
...
* 折叠屏适配
  ...
  折叠屏适配的详细开发步骤，请参见[折叠屏悬停态](https://developer.huawei.com/consumer/cn/doc/best-practices/bpta-folded-hover)和设备场景[双折叠应用开发](https://developer.huawei.com/consumer/cn/doc/best-practices/bpta-foldable-guide)。
* 多端设备支持
...
[方舟开发框架](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkui-overview)（简称：ArkUI）提供开发者进行应用UI开发时所必须的能力。
