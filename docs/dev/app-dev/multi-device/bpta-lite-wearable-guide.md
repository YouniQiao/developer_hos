...
original_url: /docs/dev/app-dev/multi-device/bpta-lite-wearable-guide
format: md
upstream_id: dev/app-dev/multi-device/bpta-lite-wearable-guide
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b4/v3/07cdY6mBQ4GqRUS9rA3DmQ/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260606T074218Z&HW-CC-Expire=86400&HW-CC-Sign=2EE6E2613EB343E6E27DDCC5C4469425E6D39E58CF501D846E9985999268F6EC)

本文档适用于轻量级智能穿戴应用开发，针对智能穿戴应用请参考[智能穿戴](/docs/dev/app-dev/multi-device/bpta-smartwatch)。

## 体验应用

###搭建环境和创建项目

* 搭建环境：请参考[安装DevEco Studio](/docs/tools/coding-debug/ide-software-install)，配置开发环境。
* 创建项目：请参考[创建一个新的工程](/docs/tools/coding-debug/ide-create-new-project)，模板选择“[Lite]Empty Ability”，设备类型选择“Lite Wearable”。

  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/70/v3/LAeFcNHWRUyXdAP7MeJgrw/zh-cn_image_0000002230878012.png?HW-CC-KV=V1&HW-CC-Date=20260606T074218Z&HW-CC-Expire=86400&HW-CC-Sign=14229D84D952AD0333F911325F1C44DBEEE82B960FF54A8D32FD414CF3B5C069 "点击放大")

###工程目录介绍

HelloWorld工程目录如下图所示：

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f0/v3/B18Q4R__R8mF7Hqx_19BIA/zh-cn_image_0000002231037832.png?HW-CC-KV=V1&HW-CC-Date=20260606T074218Z&HW-CC-Expire=86400&HW-CC-Sign=A84AB7CF33E68F275C2B87B76DFFCEE26BAED569959E98D6DE6843AE18ADA39D "点击放大")
...
<div class="source-link-wrapper"><a href="https://gitcode.com/harmonyos_samples/BestPracticeSnippets/blob/master/LiteWearable/entry/src/main/js/MainAbility/initpage/initpage.hml#L2-L7" target="_blank" rel="noopener noreferrer" class="source-link"><svg class="source-link-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" /><polyline points="15 3 21 3 21 9" /><line x1="10" y1="14" x2="21" y2="3" /></svg> 查看源码：initpage.hml</a></div>
...
<div class="source-link-wrapper"><a href="https://gitcode.com/harmonyos_samples/BestPracticeSnippets/blob/master/LiteWearable/entry/src/main/js/MainAbility/initpage/initpage.js#L2-L6" target="_blank" rel="noopener noreferrer" class="source-link"><svg class="source-link-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" /><polyline points="15 3 21 3 21 9" /><line x1="10" y1="14" x2="21" y2="3" /></svg> 查看源码：initpage.js</a></div>
...
使用预览器查看效果，请参考[查看ArkTS/JS预览效果](/docs/tools/coding-debug/ide-previewer-arkts-js)。

在Lite Wearable中运行应用/服务，依赖HarmonyOS 5版本以前的华为手机上的**运动健康**和**应用调测助手**APP辅助进行。

**前提条件**

* 已将**运动健康APP**升级至最新版本。
* **手机已安装应用调测助手APP**，该应用支持通过华为应用市场安装。
* 在Lite Wearable中运行应用/服务，需要根据[应用/元服务签名](/docs/tools/coding-debug/ide-signing)，提前对应用/服务进行签名。

  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e2/v3/TGZ56EPZQeieGFuIVblnMw/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260606T074218Z&HW-CC-Expire=86400&HW-CC-Sign=1BEBA650FA2392B92F4DD17C4002628E2A5F1B74B81172618886C2DB58DF67FD)

  因Lite Wearable设备无法与DevEco Studio进行连接，因此在对Lite Wearable应用/服务签名时，不能采用自动化签名方案，只能使用[手动签名](/docs/tools/coding-debug/ide-signing#section297715173233)，然后再手动配置签名信息。
...
5. 打开**应用调测助手**APP，界面会显示已经与华为手机连接的Lite Wearable。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/70/v3/fIZk3oYGRyeZvWlmvKp-OQ/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260606T074218Z&HW-CC-Expire=86400&HW-CC-Sign=941F8383C45D933ABBBAFA749BC2248553BC9195913A5B845B2E6832AE6E8722)

   * 如果Lite Wearable与华为手机未连接，请单击**应用调测助手**APP界面的**连接设备**按钮，手机会自动打开**运动健康**APP添加Lite Wearable。
   * [申请调试Profile](/docs/distribute/agc/agc-help-profile-0000002270709473/agc-help-debug-profile-0000002248181278)时，需先[注册设备](/docs/distribute/agc/agc-help-device-0000002235870042/agc-help-add-device-0000002283189937)，再选择调试设备。
...
* 是否需要容器组件
  ...
  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/08/v3/B9QEgAQiRZCfsJA-jOf0SA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260606T074218Z&HW-CC-Expire=86400&HW-CC-Sign=35F4BD17FA0833FAB2029870E564123A5BAF23D2A7AC8889DAB911D8D0BFDB75)
...
<div class="source-link-wrapper"><a href="https://gitcode.com/HarmonyOS_Samples/BestPracticeSnippets/blob/master/LiteWearable/entry/src/main/js/MainAbility/style2/style2.hml#L2-L10" target="_blank" rel="noopener noreferrer" class="source-link"><svg class="source-link-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" /><polyline points="15 3 21 3 21 9" /><line x1="10" y1="14" x2="21" y2="3" /></svg> 查看源码：style2.hml</a></div>
...
<div class="source-link-wrapper"><a href="https://gitcode.com/HarmonyOS_Samples/BestPracticeSnippets/blob/master/LiteWearable/entry/src/main/js/MainAbility/style3/style3.hml#L2-L9" target="_blank" rel="noopener noreferrer" class="source-link"><svg class="source-link-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" /><polyline points="15 3 21 3 21 9" /><line x1="10" y1="14" x2="21" y2="3" /></svg> 查看源码：style3.hml</a></div>
...
<div class="source-link-wrapper"><a href="https://gitcode.com/HarmonyOS_Samples/BestPracticeSnippets/blob/master/LiteWearable/entry/src/main/js/MainAbility/style4/style4.hml#L2-L7" target="_blank" rel="noopener noreferrer" class="source-link"><svg class="source-link-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" /><polyline points="15 3 21 3 21 9" /><line x1="10" y1="14" x2="21" y2="3" /></svg> 查看源码：style4.hml</a></div>
...
<div class="source-link-wrapper"><a href="https://gitcode.com/HarmonyOS_Samples/BestPracticeSnippets/blob/master/LiteWearable/entry/src/main/js/MainAbility/style4/style4.js#L2-L8" target="_blank" rel="noopener noreferrer" class="source-link"><svg class="source-link-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" /><polyline points="15 3 21 3 21 9" /><line x1="10" y1="14" x2="21" y2="3" /></svg> 查看源码：style4.js</a></div>
...
<div class="source-link-wrapper"><a href="https://gitcode.com/HarmonyOS_Samples/BestPracticeSnippets/blob/master/LiteWearable/entry/src/main/js/MainAbility/event/event.hml#L2-L8" target="_blank" rel="noopener noreferrer" class="source-link"><svg class="source-link-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" /><polyline points="15 3 21 3 21 9" /><line x1="10" y1="14" x2="21" y2="3" /></svg> 查看源码：event.hml</a></div>
...
<div class="source-link-wrapper"><a href="https://gitcode.com/HarmonyOS_Samples/BestPracticeSnippets/blob/master/LiteWearable/entry/src/main/js/MainAbility/event/event.js#L2-L12" target="_blank" rel="noopener noreferrer" class="source-link"><svg class="source-link-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" /><polyline points="15 3 21 3 21 9" /><line x1="10" y1="14" x2="21" y2="3" /></svg> 查看源码：event.js</a></div>
...
1. 在“pages”目录右键，选择“New > Page”，将“Page name”设置为“details”。如果使用其他方式添加页面，则在添加页面后需要修改配置文件config.json中的pages标签。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/81/v3/K4rK-G9XScabPc_7FRmYoA/zh-cn_image_0000002266037277.png?HW-CC-KV=V1&HW-CC-Date=20260606T074218Z&HW-CC-Expire=86400&HW-CC-Sign=64D749D522247807881E992B17AC3E19A8F86C64F3893CDF3985DA372F511603 "点击放大")
...
<div class="source-link-wrapper"><a href="https://gitcode.com/HarmonyOS_Samples/BestPracticeSnippets/blob/master/LiteWearable/entry/src/main/js/MainAbility/detail/detail.hml#L2-L8" target="_blank" rel="noopener noreferrer" class="source-link"><svg class="source-link-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" /><polyline points="15 3 21 3 21 9" /><line x1="10" y1="14" x2="21" y2="3" /></svg> 查看源码：detail.hml</a></div>
...
<div class="source-link-wrapper"><a href="https://gitcode.com/HarmonyOS_Samples/BestPracticeSnippets/blob/master/LiteWearable/entry/src/main/js/MainAbility/details/details.hml#L2-L8" target="_blank" rel="noopener noreferrer" class="source-link"><svg class="source-link-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" /><polyline points="15 3 21 3 21 9" /><line x1="10" y1="14" x2="21" y2="3" /></svg> 查看源码：details.hml</a></div>
...
<div class="source-link-wrapper"><a href="https://gitcode.com/HarmonyOS_Samples/BestPracticeSnippets/blob/master/LiteWearable/entry/src/main/js/MainAbility/detail/detail.js#L2-L11" target="_blank" rel="noopener noreferrer" class="source-link"><svg class="source-link-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" /><polyline points="15 3 21 3 21 9" /><line x1="10" y1="14" x2="21" y2="3" /></svg> 查看源码：detail.js</a></div>
...
<div class="source-link-wrapper"><a href="https://gitcode.com/HarmonyOS_Samples/BestPracticeSnippets/blob/master/LiteWearable/entry/src/main/js/MainAbility/details/details.js#L2-L11" target="_blank" rel="noopener noreferrer" class="source-link"><svg class="source-link-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" /><polyline points="15 3 21 3 21 9" /><line x1="10" y1="14" x2="21" y2="3" /></svg> 查看源码：details.js</a></div>

6. 使用Preview预览效果，详情请参考[查看ArkTS/JS预览效果](/docs/tools/coding-debug/ide-previewer-arkts-js)。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/16/v3/7gqzTR0fSyeuYBjqvFdCmA/zh-cn_image_0000002265917341.png?HW-CC-KV=V1&HW-CC-Date=20260606T074218Z&HW-CC-Expire=86400&HW-CC-Sign=0C8EDEC2C4FDF3009A4A7F8E13DB3377B13FE060063E35B1CC213CA1BD1613CE)
...
<div class="source-link-wrapper"><a href="https://gitcode.com/harmonyos_samples/BestPracticeSnippets/blob/master/LiteWearable/entry/src/main/js/MainAbility/exit/exit.hml#L2-L8" target="_blank" rel="noopener noreferrer" class="source-link"><svg class="source-link-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" /><polyline points="15 3 21 3 21 9" /><line x1="10" y1="14" x2="21" y2="3" /></svg> 查看源码：exit.hml</a></div>
...
<div class="source-link-wrapper"><a href="https://gitcode.com/harmonyos_samples/BestPracticeSnippets/blob/master/LiteWearable/entry/src/main/js/MainAbility/exit/exit.js#L2-L21" target="_blank" rel="noopener noreferrer" class="source-link"><svg class="source-link-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" /><polyline points="15 3 21 3 21 9" /><line x1="10" y1="14" x2="21" y2="3" /></svg> 查看源码：exit.js</a></div>
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/35/v3/YWp442uETvmqras2gKBMEg/zh-cn_image_0000002230878016.png?HW-CC-KV=V1&HW-CC-Date=20260606T074218Z&HW-CC-Expire=86400&HW-CC-Sign=C3807EC01515750FA97E7CE8DE15A34D4F3CCFBDADE29E3FCB5F6285FEEE9390 "点击放大")
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a2/v3/lRr6TZC6TYORHXO4wgx0GA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260606T074218Z&HW-CC-Expire=86400&HW-CC-Sign=64113CB8B1082BB411FE1DB93DDB450EAF50044DD0AF59D0F652C5C963250A6D)
...
<div class="source-link-wrapper"><a href="https://gitcode.com/HarmonyOS_Samples/BestPracticeSnippets/blob/master/LiteWearable/entry/src/main/js/MainAbility/pages/index/index.hml#L2-L8" target="_blank" rel="noopener noreferrer" class="source-link"><svg class="source-link-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" /><polyline points="15 3 21 3 21 9" /><line x1="10" y1="14" x2="21" y2="3" /></svg> 查看源码：index.hml</a></div>
...
4. 在preview中预览在轻量级智能穿戴上的显示效果，如下图所示。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c9/v3/dFeHC4PARRyZeYWV4oR1sg/zh-cn_image_0000002231037836.png?HW-CC-KV=V1&HW-CC-Date=20260606T074218Z&HW-CC-Expire=86400&HW-CC-Sign=0396B3AB477388FCF09D087B291085C546A8A18918AF3682DE18CAA84C446C14 "点击放大")

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ae/v3/wVELI5_kQvqA8XwnM23OnQ/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260606T074218Z&HW-CC-Expire=86400&HW-CC-Sign=DF357D1C79CDA0AEC956FFA7669D67FAD1F024E82FBA5B5BC02710EB97C6D8E0)
...
3. 参考绘制样式章节，将方表对应的页面布局参数修改为408\*480或百分比。修改完成后，点击“File -> Sync And Refresh Project”重新同步工程。
   ...
   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/de/v3/1qqnxNPWQAOlStJvCrUnEg/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260606T074218Z&HW-CC-Expire=86400&HW-CC-Sign=8C0FBBD733D35DE15B3CA6F1E815A5CE24B8ADA32D94F0CCE10A0B611CF75B40)
...
1. 多语言资源文件放在[文件组织](/docs/dev/app-dev/application-framework/arkui/ui-js-dev/js-framework-overview/js-framework-file)中指定的i18n文件夹内，命名规则为：语言-国家/地区.json，如zh-CN.json为简体中文，en-US.json为英文。限制词取值要求可参考[定义资源文件](/docs/dev/app-dev/application-framework/arkui/ui-js-dev/js-framework-overview/js-framework-multiple-languages#定义资源文件)。

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9e/v3/husgj2MNSAaFNfqx3chkbQ/zh-cn_image_0000002505798198.png?HW-CC-KV=V1&HW-CC-Date=20260606T074218Z&HW-CC-Expire=86400&HW-CC-Sign=F9C9F40D8AE796374C1B0040FE6C2B911537C3BE784225316326305E7BCE9897)

   ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/98/v3/J8nIGQBYRtyxKW3piN5fCQ/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260606T074218Z&HW-CC-Expire=86400&HW-CC-Sign=0F492E000F3F22FFBEA2F8F9B71B6BC5012B760060260F5894F57D7A513A0D61)
...
2. 创建语言资源文件后，在配置文件中配置索引和语言的映射关系，格式为："key值索引": "语言文本"，如下所示。
   ...
   ```
3. 配置好语言资源文件后，可在hml文件或js文件中使用$t方法引用资源，详细请参考[引用资源](/docs/dev/app-dev/application-framework/arkui/ui-js-dev/js-framework-overview/js-framework-multiple-languages#引用资源)中的简单格式化方法。

## 安全接口的使用

轻量级智能穿戴设备应用开发的安全相关接口，包含通用密钥库系统、加解密算法库框架和锁屏管理。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/33/v3/faRyaFevRSSs6_NiDXCF2Q/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260606T074218Z&HW-CC-Expire=86400&HW-CC-Sign=6D4695FD1015CF1DFB9C8AD8EE0DA721FCA82997EB12A8A5C2449706E28E3EDD)
...
<div class="source-link-wrapper"><a href="https://gitcode.com/HarmonyOS_Samples/BestPracticeSnippets/blob/master/LiteWearable/entry/src/main/js/MainAbility/security/DES.js#L2-L56" target="_blank" rel="noopener noreferrer" class="source-link"><svg class="source-link-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" /><polyline points="15 3 21 3 21 9" /><line x1="10" y1="14" x2="21" y2="3" /></svg> 查看源码：DES.js</a></div>
...
<div class="source-link-wrapper"><a href="https://gitcode.com/HarmonyOS_Samples/BestPracticeSnippets/blob/master/LiteWearable/entry/src/main/js/MainAbility/security/DES.js#L5-L191" target="_blank" rel="noopener noreferrer" class="source-link"><svg class="source-link-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" /><polyline points="15 3 21 3 21 9" /><line x1="10" y1="14" x2="21" y2="3" /></svg> 查看源码：DES.js</a></div>
...
<div class="source-link-wrapper"><a href="https://gitcode.com/HarmonyOS_Samples/BestPracticeSnippets/blob/master/LiteWearable/entry/src/main/js/MainAbility/security/DES.js#L6-L305" target="_blank" rel="noopener noreferrer" class="source-link"><svg class="source-link-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" /><polyline points="15 3 21 3 21 9" /><line x1="10" y1="14" x2="21" y2="3" /></svg> 查看源码：DES.js</a></div>
...
1. 生成RSA算法密钥：定义一个getRSAGenProperties()的函数，用于生成一个包含 RSA加密算法相关属性的数组。这些属性用于配置加密操作的参数，并在generateRSAKey()方法中生成密钥。
...
<div class="source-link-wrapper"><a href="https://gitcode.com/harmonyos_samples/BestPracticeSnippets/blob/master/LiteWearable/entry/src/main/js/MainAbility/security/RSA.js#L2-L56" target="_blank" rel="noopener noreferrer" class="source-link"><svg class="source-link-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" /><polyline points="15 3 21 3 21 9" /><line x1="10" y1="14" x2="21" y2="3" /></svg> 查看源码：RSA.js</a></div>
...
<div class="source-link-wrapper"><a href="https://gitcode.com/harmonyos_samples/BestPracticeSnippets/blob/master/LiteWearable/entry/src/main/js/MainAbility/security/RSA.js#L6-L174" target="_blank" rel="noopener noreferrer" class="source-link"><svg class="source-link-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" /><polyline points="15 3 21 3 21 9" /><line x1="10" y1="14" x2="21" y2="3" /></svg> 查看源码：RSA.js</a></div>
...
<div class="source-link-wrapper"><a href="https://gitcode.com/HarmonyOS_Samples/BestPracticeSnippets/blob/master/LiteWearable/entry/src/main/js/MainAbility/security/RSA.js#L3-L285" target="_blank" rel="noopener noreferrer" class="source-link"><svg class="source-link-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" /><polyline points="15 3 21 3 21 9" /><line x1="10" y1="14" x2="21" y2="3" /></svg> 查看源码：RSA.js</a></div>
...
1. 生成HMAC密钥：定义一个getHMACGenProperties()的函数，用于生成一个包含HMAC加密算法相关属性的数组。这些属性用于配置加密操作的参数，并在generateHMACKey()方法中生成密钥。
...
<div class="source-link-wrapper"><a href="https://gitcode.com/HarmonyOS_Samples/BestPracticeSnippets/blob/master/LiteWearable/entry/src/main/js/MainAbility/security/HMAC.js#L2-L50" target="_blank" rel="noopener noreferrer" class="source-link"><svg class="source-link-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" /><polyline points="15 3 21 3 21 9" /><line x1="10" y1="14" x2="21" y2="3" /></svg> 查看源码：HMAC.js</a></div>
...
<div class="source-link-wrapper"><a href="https://gitcode.com/HarmonyOS_Samples/BestPracticeSnippets/blob/master/LiteWearable/entry/src/main/js/MainAbility/security/HMAC.js#L3-L165" target="_blank" rel="noopener noreferrer" class="source-link"><svg class="source-link-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" /><polyline points="15 3 21 3 21 9" /><line x1="10" y1="14" x2="21" y2="3" /></svg> 查看源码：HMAC.js</a></div>
...
<div class="source-link-wrapper"><a href="https://gitcode.com/HarmonyOS_Samples/BestPracticeSnippets/blob/master/LiteWearable/entry/src/main/js/MainAbility/security/KeyAlias.js#L2-L74" target="_blank" rel="noopener noreferrer" class="source-link"><svg class="source-link-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" /><polyline points="15 3 21 3 21 9" /><line x1="10" y1="14" x2="21" y2="3" /></svg> 查看源码：KeyAlias.js</a></div>
...
<div class="source-link-wrapper"><a href="https://gitcode.com/HarmonyOS_Samples/BestPracticeSnippets/blob/master/LiteWearable/entry/src/main/js/MainAbility/security/KeyAlias.js#L3-L92" target="_blank" rel="noopener noreferrer" class="source-link"><svg class="source-link-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" /><polyline points="15 3 21 3 21 9" /><line x1="10" y1="14" x2="21" y2="3" /></svg> 查看源码：KeyAlias.js</a></div>
...
<div class="source-link-wrapper"><a href="https://gitcode.com/harmonyos_samples/BestPracticeSnippets/blob/master/LiteWearable/entry/src/main/js/MainAbility/security/DesCBC64.js#L2-L22" target="_blank" rel="noopener noreferrer" class="source-link"><svg class="source-link-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" /><polyline points="15 3 21 3 21 9" /><line x1="10" y1="14" x2="21" y2="3" /></svg> 查看源码：DesCBC64.js</a></div>
...
<div class="source-link-wrapper"><a href="https://gitcode.com/harmonyos_samples/BestPracticeSnippets/blob/master/LiteWearable/entry/src/main/js/MainAbility/security/DesCBC64.js#L3-L38" target="_blank" rel="noopener noreferrer" class="source-link"><svg class="source-link-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" /><polyline points="15 3 21 3 21 9" /><line x1="10" y1="14" x2="21" y2="3" /></svg> 查看源码：DesCBC64.js</a></div>
...
<div class="source-link-wrapper"><a href="https://gitcode.com/harmonyos_samples/BestPracticeSnippets/blob/master/LiteWearable/entry/src/main/js/MainAbility/cryptoFramework/cryptoFramework.js#L2-L55" target="_blank" rel="noopener noreferrer" class="source-link"><svg class="source-link-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" /><polyline points="15 3 21 3 21 9" /><line x1="10" y1="14" x2="21" y2="3" /></svg> 查看源码：cryptoFramework.js</a></div>


  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9f/v3/BKPPqa6bTN2Km7Y5ikRH8A/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260606T074218Z&HW-CC-Expire=86400&HW-CC-Sign=EE6905837CA646C5D113B48631ADDAD1316B901D5387074B0CB0BF69E5997AE9)
...
<div class="source-link-wrapper"><a href="https://gitcode.com/HarmonyOS_Samples/BestPracticeSnippets/blob/master/LiteWearable/entry/src/main/js/MainAbility/cryptoFramework/cryptoFramework.js#L58-L92" target="_blank" rel="noopener noreferrer" class="source-link"><svg class="source-link-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" /><polyline points="15 3 21 3 21 9" /><line x1="10" y1="14" x2="21" y2="3" /></svg> 查看源码：cryptoFramework.js</a></div>


  ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ea/v3/L4Om85eaRxCpcxDkfBQj0w/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260606T074218Z&HW-CC-Expire=86400&HW-CC-Sign=904812453FE38FBF830CD4E8B21BB4FD101E1F8A3B8C0AB091B40E5A8050598C)
...
<div class="source-link-wrapper"><a href="https://gitcode.com/harmonyos_samples/BestPracticeSnippets/blob/master/LiteWearable/entry/src/main/js/MainAbility/screenLock/screenLock.js#L2-L27" target="_blank" rel="noopener noreferrer" class="source-link"><svg class="source-link-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" /><polyline points="15 3 21 3 21 9" /><line x1="10" y1="14" x2="21" y2="3" /></svg> 查看源码：screenLock.js</a></div>
...
<div class="source-link-wrapper"><a href="https://gitcode.com/harmonyos_samples/BestPracticeSnippets/blob/master/LiteWearable/entry/src/main/js/MainAbility/screenLock/screenLock.js#L30-L42" target="_blank" rel="noopener noreferrer" class="source-link"><svg class="source-link-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" /><polyline points="15 3 21 3 21 9" /><line x1="10" y1="14" x2="21" y2="3" /></svg> 查看源码：screenLock.js</a></div>
...
<div class="source-link-wrapper"><a href="https://gitcode.com/harmonyos_samples/BestPracticeSnippets/blob/master/LiteWearable/entry/src/main/js/MainAbility/screenLock/screenLock.js#L45-L57" target="_blank" rel="noopener noreferrer" class="source-link"><svg class="source-link-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" /><polyline points="15 3 21 3 21 9" /><line x1="10" y1="14" x2="21" y2="3" /></svg> 查看源码：screenLock.js</a></div>
...
4. 错误码34：内部错误
5. 错误码10：安装过程中发生内存分配失败
6. 错误码15：系统中已安装的三方应用数量达到上限
7. 错误码16：尝试安装的应用版本号低于当前已安装的版本
8. 错误码30：签名数据不完整，证书获取失败或解析异常
...
1. 检查签名中是否添加了手表的udid，udid操作请参考[注册设备](/docs/distribute/agc/agc-help-device-0000002235870042/agc-help-add-device-0000002283189937)。
2. 检查添加的udid是否超过10个。
3. 检查签名证书是否过期。
4. 手动签名详情请参考[手动签名](/docs/tools/coding-debug/ide-signing#section297715173233)。
...
解决：重启手表释放系统内存，确保安装过程中有足够的内存空间。

**错误码15：系统中已安装的三方应用数量达到上限**

解决：卸载不需要的三方应用后再安装。

**错误码16：尝试安装的应用版本号低于当前已安装的版本**

解决：更改当前安装应用的版本号，或卸载已安装的同应用。

**错误码30：签名数据不完整，证书获取失败或解析异常**

解决：确认生成csr证书内填写的相关信息是否正确，并且不超过256字节，生成证书账号内个人或公司名称是否超过256字节。
