...
original_url: /docs/dev/app-dev/graphics/arkgraphics-2d/text/draw-text-display/text-custom-c
format: md
upstream_id: dev/app-dev/graphics/arkgraphics-2d/text/draw-text-display/text-custom-c
