...
* **[使用主题字体（C/C++）](/docs/dev/app-dev/graphics/arkgraphics-2d/text/font-manager/theme-font-c)**
* **[自定义字体的注册和使用（C/C++）](/docs/dev/app-dev/graphics/arkgraphics-2d/text/font-manager/custom-font-c)**
* **[系统字体的信息获取和使用（C/C++）](/docs/dev/app-dev/graphics/arkgraphics-2d/text/font-manager/system-font-c)**
