...
* 通过NativeVsync在Native侧申请独立的绘制帧率，用于非UI线程的绘制，具体可见[NativeDisplaySoloist开发指导 (C/C++)](/docs/dev/app-dev/graphics/arkgraphics-2d/displaysync/displaysoloist-native-guidelines)。
