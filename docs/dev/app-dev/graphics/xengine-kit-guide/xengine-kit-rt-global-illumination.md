...
3. 创建动态漫反射全局光照使用的创建信息，调用[HMS\_XEG\_CreateRTGI](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/xengine-kit-xengine#hms_xeg_creatertgi)接口创建动态漫反射全局光照实例。
...
3. 创建神经网络全局光照使用的创建信息，调用[HMS\_XEG\_CreateRTGI](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/xengine-kit-xengine#hms_xeg_creatertgi)接口创建神经网络全局光照实例。
