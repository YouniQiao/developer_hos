...
title: "概述"
original_url: /docs/dev/app-dev/graphics/graphics-accelerate-fg-extrapolation-overview
format: md
upstream_id: dev/app-dev/graphics/graphics-accelerate-fg-extrapolation-overview
