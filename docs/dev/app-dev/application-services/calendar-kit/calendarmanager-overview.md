...
original_url: /docs/dev/app-dev/application-services/calendar-kit/calendarmanager-overview
format: md
upstream_id: dev/app-dev/application-services/calendar-kit/calendarmanager-overview
...
* 使用Calendar Kit的相关能力，需要获取读取或写入日历、日程的权限。具体指导可见[声明权限](/docs/dev/app-dev/system/system-security/access-control/app-permission-mgmt/request-app-permissions/declare-permissions)。
