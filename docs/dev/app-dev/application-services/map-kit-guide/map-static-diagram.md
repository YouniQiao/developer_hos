...
1. 导入相关模块。
   ...
   ```
2. 创建静态图初始化参数，调用[getMapImage](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-staticmap#getmapimage)方法获取静态图，效果如下图。
