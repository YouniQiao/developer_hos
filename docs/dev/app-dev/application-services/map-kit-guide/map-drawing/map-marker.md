...
![](./img/f0069df8.jpg "点击放大")

**图2** 隐藏Marker文字之后

![](./img/420eca02.jpg "点击放大")
...
2. 调用[on(type: 'markerDragStart' , callback: Callback<Marker>)](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-map-mapeventmanager#onmarkerdragstart)方法监听标记是否开始拖拽。
3. 调用[on(type: 'markerDrag' , callback: Callback<Marker>)](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-map-mapeventmanager#onmarkerdrag)，监听标记拖动过程。
4. 调用[on(type: 'markerDragEnd' , callback: Callback<Marker>)](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-map-mapeventmanager#onmarkerdragend)，监听标记拖动结束事件。
