...
3. 检查“我的位置”功能是否成功启用。
   ...
   “我的位置”按钮![](./img/73c9258a.png)默认显示在地图的右下角。点击“我的位置”按钮![](./img/69c48bab.png)，将会在屏幕中心显示当前定位，以蓝色圆点的形式呈现，效果如下图所示，效果根据获取到的用户位置会有变化。

   ![](./img/8134faf4.jpg "点击放大")
4. 获取用户位置坐标并设置用户的位置。
