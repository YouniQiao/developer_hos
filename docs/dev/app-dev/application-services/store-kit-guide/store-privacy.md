...
1. 导入privacyManager模块及相关公共模块。
   ...
   ```
2. 调用[getAppPrivacyMgmtInfo](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/store-privacymanager#privacymanagergetappprivacymgmtinfo)方法查询隐私链接信息。
...
1. 导入privacyManager模块及相关公共模块。
   ...
   import { hilog } from '@kit.PerformanceAnalysisKit';
   ```
2. 调用[getAppPrivacyResult](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/store-privacymanager#privacymanagergetappprivacyresult)方法查询隐私签署状态。
...
1. 导入privacyManager模块及相关公共模块。
   ...
   import { hilog } from '@kit.PerformanceAnalysisKit';
   ```
2. 调用[disableService](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/store-privacymanager#privacymanagerdisableservice)方法撤销同意记录。
...
1. 导入privacyManager模块及相关公共模块。
   ...
   ```
2. 调用[requestAppPrivacyConsent](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/store-privacymanager#privacymanagerrequestappprivacyconsent)方法拉起标准化隐私弹框请求用户同意。
