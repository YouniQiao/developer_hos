...
title: "个人数据处理说明"
original_url: /docs/dev/app-dev/application-services/scenario-fusion-personal-data
format: md
upstream_id: dev/app-dev/application-services/scenario-fusion-personal-data
...
| 个人数据清单 | 使用目的 |
| --- | --- |
| 个人基本资料 | 通过智能填充服务获取姓名用于给用户提供表单填充推荐。 |
...
* **存留期**
  ...
  1. 在表单中填写过的信息保存至历史表单后，可前往“设置 > 隐私和安全 > 智能填充 > 历史表单输入”删除保存的历史表单输入记录。
  2. 可前往“设置”>“隐私和安全”>“智能填充”关闭“华为账号”开关，在“智能填充”缓存的华为账号相关数据会自动删除。
* **指导开发者如何帮助最终用户实现对数据的控制**
