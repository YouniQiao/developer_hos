...
* **[添加卡券时商户服务器主要需要执行哪些步骤？](/docs/dev/app-dev/application-services/wallet-kit-guide/wallet-kit-faq/wallet-faq-5)**
* **[如何查看已添加卡券？](/docs/dev/app-dev/application-services/wallet-kit-guide/wallet-kit-faq/wallet-faq-6)**
* **[用户领取了同一商户的多张卡券，但是打开华为钱包后只显示一张卡券](/docs/dev/app-dev/application-services/wallet-kit-guide/wallet-kit-faq/wallet-faq-7)**
* **[用户删卡时会删除哪些信息？](/docs/dev/app-dev/application-services/wallet-kit-guide/wallet-kit-faq/wallet-faq-8)**
