...
* **[判断PDF文档是否加密及删除加密](/docs/dev/app-dev/application-services/pdf-kit-guide/pdf-pdfservice-implements/pdf-isencrypt-removesecurity)**
* **[添加、删除书签](/docs/dev/app-dev/application-services/pdf-kit-guide/pdf-pdfservice-implements/pdf-add-bookmark)**
* **[添加、删除页眉页脚](/docs/dev/app-dev/application-services/pdf-kit-guide/pdf-pdfservice-implements/pdf-add-headerfooter)**
* **[添加、删除水印](/docs/dev/app-dev/application-services/pdf-kit-guide/pdf-pdfservice-implements/pdf-add-watermark)**
* **[添加、删除背景](/docs/dev/app-dev/application-services/pdf-kit-guide/pdf-pdfservice-implements/pdf-add-background)**
