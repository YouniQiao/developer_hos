...
| --- | --- | --- |
| ![](./img/b6f9f6a3.jpg) | ![](./img/f05cc0fe.jpg) | ![](./img/4c496682.jpg) |
| **通话中** | **锁屏语音来电** | **锁屏视频来电** |
| ![](./img/6cc52bc7.jpg) | ![](./img/e9d695d3.jpg) | ![](./img/3ae3842c.jpg) |
...
4. 接收到来电之后，用户可以选择接听或拒接。
   ...
   * 上报两次状态（推荐）。
     ...
     | **正在接通** | **接通后** |
     | --- | --- |
     | ![](./img/65ace76f.jpg) | ![](./img/7550906f.jpg) |
...
5. 在通话过程中，用户可以根据需要，可以静音或解除静音。
   ...
   | **静音** | **解除静音** |
   | --- | --- |
   | ![](./img/4b4ed8ec.jpg) | ![](./img/346df12e.jpg) |
