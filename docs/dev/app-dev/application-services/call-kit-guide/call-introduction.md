...
当应用在后台时，如果有来电，需要[Push Kit（推送服务）](/docs/dev/app-dev/application-services/push-kit-guide/push-kit-introduction)先拉起应用主进程，应用才能给Call Service Kit上报来电。
...
由于Call Service Kit依赖Push Kit，还需要参考[Push Kit的约束和限制](/docs/dev/app-dev/application-services/push-kit-guide/push-kit-introduction#约束和限制)。
