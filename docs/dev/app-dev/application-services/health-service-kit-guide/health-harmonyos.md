...
* **[Wearable应用开发](/docs/dev/app-dev/application-services/health-service-kit-guide/health-harmonyos/health-wearable-app-dev)**
* **[LiteWearable应用开发](/docs/dev/app-dev/application-services/health-litewearable-app-dev)**
* **[数据类型](/docs/dev/app-dev/application-services/health-service-kit-guide/health-harmonyos/health-data-type)**
* **[申请验证获取正式权限](/docs/dev/app-dev/application-services/health-service-kit-guide/health-harmonyos/health-verification)**
* **[个人数据处理说明](/docs/dev/app-dev/application-services/health-personal-data-processing)**
