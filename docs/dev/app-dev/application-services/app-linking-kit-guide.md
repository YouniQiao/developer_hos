...
* **[通过直达应用市场能力跳转至应用市场下载详情页](/docs/dev/app-dev/application-services/app-linking-kit-guide/applinking-direct-to-ag)**
* **[通过延迟链接跳转至应用详情页](/docs/dev/app-dev/application-services/app-linking-kit-guide/applinking-deferredlink)**
* **[通过聚合链接按指定方式跳转至应用](/docs/dev/app-dev/application-services/app-linking-kit-guide/applinking-cross-platform)**
