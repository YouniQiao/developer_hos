...
original_url: /docs/dev/app-dev/application-services/scenario-fusion-kit-guide/scenario-fusion-introduction
format: md
upstream_id: dev/app-dev/application-services/scenario-fusion-kit-guide/scenario-fusion-introduction
...
| 场景化API | 请参见[支持的国家/地区](/docs/dev/app-dev/application-services/store-kit-guide/store-attribution-appendix/appgallery-support-regions)。 |
...
* 本Kit支持模拟器开发，通用差异可参考[模拟器与真机的差异](/docs/tools/coding-debug/ide-emulator-specification#section1227613205203)。
