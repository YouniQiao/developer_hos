...
| 名称 | 说明 |
| --- | --- |
| 数据源推荐优先级 | 多输入框场景数据源推荐优先级：剪贴板>历史表单输入>华为账号>联系人。  单输入框场景数据源推荐优先级：剪贴板>日程>华为账号。 |
...
| 名称 | 说明 |
| --- | --- |
| 主动推荐 | 1. 点击输入组件时，智能填充将主动提供填充建议。  2. 最多展示2条推荐数据。 |
| 匹配推荐 | 1. 根据输入组件中已经输入的字符进行数据源匹配，智能填充将匹配到的数据提供填充建议。  2. 最多展示3条推荐数据。 |
