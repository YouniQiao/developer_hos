...
接口返回值返回形式为Promise。具体API说明详见[接口文档](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/payment-ecnypaymentservice)。
...
商户客户端使用[orderInfo](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/payment-ecnypaymentservice#ecnyorderinfo)作为参数调用[requestEcnyPayment](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/payment-ecnypaymentservice#requestecnypayment)接口拉起数字人民币收银台。
