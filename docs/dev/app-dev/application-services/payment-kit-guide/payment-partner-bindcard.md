...
1. 商户客户端调用[requestBindCard](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/payment-paymentservice#requestbindcard)接口拉起用户绑卡页面。
...
拉起用户绑卡页面接口。具体API说明详见[接口文档](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/payment-paymentservice#requestbindcard)。
...
商户客户端调用[requestBindCard](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/payment-paymentservice#requestbindcard)接口拉起用户绑卡页面。
