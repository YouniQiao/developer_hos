...
title: "IAP Kit简介"
original_url: /docs/dev/app-dev/application-services/iap-kit-guide/iap-introduction
format: md
upstream_id: dev/app-dev/application-services/iap-kit-guide/iap-introduction
...
[华为IAP范围覆盖](/docs/dev/app-dev/application-services/iap-kit-guide/iap-appendix/iap-appendix-coverage)中的国家/地区（不包括中国境内（香港特别行政区、澳门特别行政区、中国台湾除外））仅支持Wearable设备。
