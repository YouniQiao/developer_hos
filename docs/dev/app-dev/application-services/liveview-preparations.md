...
* **[开通实况窗服务权益](/docs/dev/app-dev/application-services/live-view-kit-guide/liveview-preparations/liveview-rights)**
* **[接入联调测试](/docs/dev/app-dev/application-services/live-view-kit-guide/liveview-preparations/liveview-joint-commission-test)**
* **[申请实况窗正式权限](/docs/dev/app-dev/application-services/live-view-kit-guide/liveview-preparations/liveview-formal-authority)**
