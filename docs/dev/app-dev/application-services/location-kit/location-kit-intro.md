...
original_url: /docs/dev/app-dev/application-services/location-kit/location-kit-intro
format: md
upstream_id: dev/app-dev/application-services/location-kit/location-kit-intro
...
支持的设备中Wearable设备支持以下[支持的国家/地区](/docs/dev/app-dev/application-services/location-kit-appendix#支持的国家地区)，其他设备仅支持中国境内（不包含中国香港、中国澳门、中国台湾）。
