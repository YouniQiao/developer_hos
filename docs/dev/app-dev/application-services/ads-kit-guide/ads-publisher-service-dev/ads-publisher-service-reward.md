...
title: "激励广告"
original_url: /docs/dev/app-dev/application-services/ads-kit-guide/ads-publisher-service-dev/ads-publisher-service-reward
format: md
upstream_id: dev/app-dev/application-services/ads-kit-guide/ads-publisher-service-dev/ads-publisher-service-reward
...
2. （可选）设置自定义数据customData和userId。
   ...
   您在[展示广告第2点](/docs/dev/app-dev/application-services/ads-kit-guide/ads-publisher-service-dev/ads-publisher-service-reward#展示广告)之前可以设置自定义数据customData和userId。示例代码如下所示：
