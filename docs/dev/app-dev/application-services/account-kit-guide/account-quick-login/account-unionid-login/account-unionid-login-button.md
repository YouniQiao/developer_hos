...
1. 调用登录按钮展示登录页阶段（序号1-3）：
   ...
   1. 用户打开应用进行登录，应用设置[LoginType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/account-api-component-manager#logintype)类型为LoginType.ID后拉起应用自己的登录页并展示“华为账号登录”按钮，用户点击按钮，请求华为账号授权信息。
2. 用户点击登录阶段（序号4-6）：
