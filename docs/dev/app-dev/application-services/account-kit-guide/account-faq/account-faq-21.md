...
1. 在进行华为账号一键登录功能开发时，登录按钮的[LoginWithHuaweiIDButtonParams.loginType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/account-api-component-manager#loginwithhuaweiidbuttonparams)属性未设置为LoginType.QUICK\_LOGIN。
