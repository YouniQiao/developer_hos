...
format: md
upstream_id: dev/app-dev/application-services/account-kit-guide/account-faq/account-faq-12
...
public class IDTokenParser {
    ...
    /**
     * 从`https://oauth-login.cloud.huawei.com/oauth2/v3/certs`获取jwt公钥信息jwk
