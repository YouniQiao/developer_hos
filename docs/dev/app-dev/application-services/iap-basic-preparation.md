...
* **[（可选）申请嵌入式收银台开放能力权限](/docs/dev/app-dev/application-services/iap-kit-guide/iap-preparations/iap-basic-preparation/iap-apply-for-open-capabilities)**
* **[（可选）配置应用内购买服务参数](/docs/dev/app-dev/application-services/iap-kit-guide/iap-preparations/iap-basic-preparation/iap-set-necessary-parameters)**
