...
2. 构造分享数据，可添加多条分享记录。
   ...
   ```
3. 启动分享面板，并配置不显示打印快捷操作。如需屏蔽其他系统级快捷操作，请参考[ShareAbilityType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/share-system-share#shareabilitytype)介绍。
