...
应用发送的实况窗需遵循《[实况窗设计规范](/docs/dev/app-dev/application-services/live-view-kit-guide/liveview-design-formula)》，不符合设计规范的方案将不被予以开通正式权限。同时若应用实况窗上线后出现违反实况窗设计规范的行为，将被视为[违规](/docs/dev/app-dev/application-services/live-view-kit-guide/liveview-introduction#违规处罚)。
