...
* 开通推送服务后，开发者可[通过Push Kit更新实况窗](/docs/dev/app-dev/application-services/live-view-kit-guide/liveview-scenes/liveview-update-by-push)，或使用Push Token添加调测设备调测实况窗。
