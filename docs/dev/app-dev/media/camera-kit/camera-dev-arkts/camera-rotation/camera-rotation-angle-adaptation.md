...
| --- | --- | --- |
| **设备条件：**  手机竖屏、充电口向下。  使用后置相机拍摄。  **可得：**  - 后置相机镜头角度 = 90°  - 屏幕旋转角度 = 0°，[Display.rotation](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-display#属性) = 0  - **图像预览旋转角度 = 0°+90° = 90°** | ![](./img/8380ce42.png) | 出图与最终成像有90度夹角，布局宽高与图像宽高交换。 |
| **设备条件：**  手机横屏、充电口向右。  使用后置相机拍摄。  **可得：**  - 后置相机镜头角度 = 90°  - 屏幕旋转角度 = 270°，[Display.rotation](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-display#属性) = 3  - **图像预览旋转角度 = 270°+90° = 360° = 0°** | ![](./img/47b6546e.png) | 出图与最终成像有0度夹角，布局与图像宽高比一致。 |
