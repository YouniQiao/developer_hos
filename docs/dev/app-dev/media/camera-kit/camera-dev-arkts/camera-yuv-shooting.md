...
format: md
upstream_id: dev/app-dev/media/camera-kit/camera-dev-arkts/camera-yuv-shooting
...
详细的相机功能API说明请参考Camera模块描述[OH\_Camera](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-camera)。
