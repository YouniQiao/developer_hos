...
original_url: /docs/dev/app-dev/media/ringtone-kit-guide/ringtone-introduction
format: md
upstream_id: dev/app-dev/media/ringtone-kit-guide/ringtone-introduction
