...
format: md
upstream_id: dev/app-dev/media/avcodec-kit/audio-video-codec/synchronous-audio-decoding
...
4. 调用OH\_AudioCodec\_Configure()配置解码器。
   ...
   从API version 20开始，支持通过[OH\_AVCapability\_GetAudioSupportedSampleRateRanges](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-native-avcapability-h#oh_avcapability_getaudiosupportedsamplerateranges)接口进行采样率范围能力查询，以下几种音频解码类型支持对范围内的任意采样率进行解码：
