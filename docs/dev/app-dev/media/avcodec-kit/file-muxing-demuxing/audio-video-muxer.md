...
详细的API说明请参考[native\_avmuxer.h](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-native-avmuxer-h)。
...
7. 添加辅助轨。
   ...
   设置OH\_MD\_KEY\_TRACK\_DESCRIPTION时，值必须为"com.openharmony."开头且长度不超过256个字符的字符串。
