...
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/image-region-and-downsampling-c
format: md
---
...
1. 参考[使用Image\_NativeModule完成图片解码](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/image-source-c)创建OH\_ImageSourceNative实例。
...
1. 参考[图片开发指导(C/C++)](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/image-source-c)创建OH\_ImageSourceNative实例。
