...
OHAudio的开发指南请参考：[推荐使用OHAudio开发音频录制功能(C/C++)](/docs/dev/app-dev/media/audio-kit/audio-recording/using-ohaudio-for-recording)。
...
* **HarmonyOS上支持的SLInterfaceID：**
  ...
  | SLInterfaceID | 说明 |
  | --- | --- |
  | SL\_IID\_ENGINE | 通用引擎，提供创建录音对象接口。 |
  | SL\_IID\_RECORD | 提供录音状态接口。 |
  | SL\_IID\_OH\_BUFFERQUEUE | 提供音频录制流数据回调注册接口。 |
