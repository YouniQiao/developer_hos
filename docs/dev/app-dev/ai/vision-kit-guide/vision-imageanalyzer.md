...
1. 将AI识图控件相关的类添加。
   ...
   ```
2. 初始化[VisionImageAnalyzerController](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/vision-image-analyzer#visionimageanalyzercontroller)对象。
   ...
   ```
3. 判断设备是否支持AI识图相关功能，若支持，添加订阅事件和取消事件监听方法。
   ...
   ```
4. 绑定[VisionImageAnalyzerController](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/vision-image-analyzer#visionimageanalyzercontroller)对象，可以控制识图相关的交互。
