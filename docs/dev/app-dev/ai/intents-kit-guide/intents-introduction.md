...
为了满足更细粒度的分发诉求，每类特性类别下提供多个具体特性，具体特性的分发系统入口、开发依赖见[各垂域的智慧分发特性列表](/docs/distribute/xiaoyi/intents-kit-0000001677103865/intents-ai-distribution-characteristic-0000001901922213#section2656133582215)。具体特性开发依赖的意图相关字段见[各垂域意图Schema](/docs/distribute/xiaoyi/intents-kit-0000001677103865/intents-schema-0000001901962713)。
