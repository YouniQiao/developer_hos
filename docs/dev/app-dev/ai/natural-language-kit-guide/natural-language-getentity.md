...
2. 配置输入文本框。
   ...
   ```
3. 配置按钮，调用实体抽取[textProcessing.getEntity](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/natural-language-text-processing-api#textprocessinggetentity)接口。
