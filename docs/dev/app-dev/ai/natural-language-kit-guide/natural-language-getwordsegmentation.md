...
1. 引用相关类添加至工程。
   ...
   ```
2. 配置输入文本框和按钮，调用分词[textProcessing.getWordSegment](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/natural-language-text-processing-api#textprocessinggetwordsegment)接口。
   ...
   ```
3. 在界面上展示分词结果[WordSegment](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/natural-language-text-processing-api#wordsegment)。
