...
参考[量化参数提取导出](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/cannkit-plug-in-quantification#量化参数提取导出)。量化参数导出的作用是输出量化文件和导出onnx所用的fake\_quant\_weight.pth。
