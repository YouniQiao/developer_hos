...
针对数据格式，包括CubeFormat::ND, CubeFormat::NZ, CubeFormat::ND\_ALIGN三种，ND和NZ格式在[数据格式](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/cannkit-basic-knowledge#数据格式)章节已经介绍。
