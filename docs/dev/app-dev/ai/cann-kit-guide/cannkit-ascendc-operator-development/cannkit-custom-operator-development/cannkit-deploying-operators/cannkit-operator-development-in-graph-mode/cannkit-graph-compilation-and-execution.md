...
命令行参数详见[NPU调测参数](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/cannkit-cli-parameters#npu调测参数)，会在${debug\_workspace} /${op\_type} /npu/src下生成验证样例工程，代码工程目录结构如下。
