...
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/cannkit-pipebarrier
---
...
| 参数名 | 描述 |
| --- | --- |
| pipe | 模板参数，表示阻塞的流水类别。  支持的流水参考表2。  如果不关注流水类别，希望阻塞所有流水，可以传入PIPE\_ALL。 |
