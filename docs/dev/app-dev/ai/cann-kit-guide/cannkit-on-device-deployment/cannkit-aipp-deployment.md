...
5. 将AIPP配置设置到[NN\_Tensor](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-neuralnetworkruntime-nn-tensor)。
   ...
   通过构造输入输出Tensor后，调用[HMS\_HiAITensor\_SetAippParams](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/cannkit#hms_hiaitensor_setaippparams)给输入Tensor设置AIPP参数。
6. 执行模型推理。
