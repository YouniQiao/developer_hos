---
title: "Init"
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/cannkit-matmul-init
---
...
| 参数名 | 输入/输出 | 描述 |
| --- | --- | --- |
| cubeTiling | 输入 | Matmul tiling参数，TCubeTiling结构体定义请参见[TCubeTiling结构体](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/cannkit-tcubetiling-structure)表1。  Tiling参数可以通过host侧GetTiling接口获取，并传递到kernel侧使用。 |
| tpipe | 输入 | Tpipe对象。 |
