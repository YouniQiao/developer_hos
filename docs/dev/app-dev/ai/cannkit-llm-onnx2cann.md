...
original_url: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/cannkit-llm-onnx2cann
---
...
模型转换需要使用tools/tools\_omg/omg工具，继承量化环节的[DDK工具环境](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/cannkit-llm-usage-environmental-preparation)。
