---
title: "OpenMP简介"
original_url: /docs/dev/ndk-dev/openmp-overview
format: md
upstream_id: dev/ndk-dev/openmp-overview
...
HarmonyOS应用中使用OpenMP请参考[OpenMP应用构建和运行指南](/docs/dev/ndk-dev/openmp-guideline)。
