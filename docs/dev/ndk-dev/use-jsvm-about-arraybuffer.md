...
original_url: /docs/dev/ndk-dev/use-jsvm-about-arraybuffer
format: md
upstream_id: dev/ndk-dev/use-jsvm-about-arraybuffer
...
JSVM-API 接口开发流程参考[使用JSVM-API实现JS与C/C++语言交互开发流程](/docs/dev/ndk-dev/use-jsvm-process)，本文仅对接口对应 C++ 相关代码进行展示。
