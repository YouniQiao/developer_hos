...
original_url: /docs/dev/ndk-dev/use-napi-life-cycle
format: md
upstream_id: dev/ndk-dev/use-napi-life-cycle
...
[生命周期管理](/docs/dev/ndk-dev/napi-guidelines#生命周期管理)

关于典型错误使用方法的代码部分也可参考下面链接:

[典型错误场景](/docs/dev/ndk-dev/napi-faq-about-stability#napi_open_handle_scope与napi_close_handle_scope进行生命周期相关开发典型错误场景)
