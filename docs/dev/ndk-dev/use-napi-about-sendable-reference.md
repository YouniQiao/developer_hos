...
| 接口 | 描述 |
| --- | --- |
| [napi\_create\_strong\_sendable\_reference](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/napi#napi_create_strong_sendable_reference) | 创建指向Sendable ArkTS对象的Sendable强引用。 |
| [napi\_delete\_strong\_sendable\_reference](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/napi#napi_delete_strong_sendable_reference) | 删除Sendable强引用。 |
| [napi\_get\_strong\_sendable\_reference\_value](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/napi#napi_get_strong_sendable_reference_value) | 根据Sendable强引用获取其关联的ArkTS对象值。 |
