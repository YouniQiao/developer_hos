...
![](./img/7adcc991.png "点击放大")

场景压测执行页面：

![](./img/f792add8.png "点击放大")
...
![](./img/6a17f5c0.png "点击放大")

场景压测报告页面：

![](./img/ffcdb137.png "点击放大")
...
问题列表：对测试过程中产生问题信息的分类统计。点击列表中![](./img/fde0929d.png)符号能够对指定列的数据进行筛选，点击列表中![](./img/0f68bfd4.png)三角符号可以对指定列进行正序或倒序的排序，默认按照发生时间的正序排序。点击概要信息列查看按钮对应故障的概要信息，点击定位日志列查看按钮跳转到存放faultlog日志及故障发生时段hilog日志的文件夹。

问题详情：

![](./img/e0d024be.png "点击放大")

故障概要信息：

![](./img/ea6758b2.png "点击放大")

定位日志：

![](./img/540674bc.png "点击放大")
