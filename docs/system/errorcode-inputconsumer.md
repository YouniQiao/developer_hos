...
可以通过[getAllSystemHotkeys](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-inputconsumer#inputconsumergetallsystemhotkeys)接口查询所有的系统快捷键。
