...
synced_at: "2026-06-24T20:50:58.703681"
---
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回可用于发出URPC请求的对象。 |
...
| request | object | 是 | URPC请求对象。对象体积最大值为1MB。如果超出最大值，抛出错误码[1007910001](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/errorcode-remote-communication#section1007910001-请求数据传输错误)。 |
| returnValue | object | 是 | URPC响应对象。对象体积最大值为100KB。如果超出最大值，抛出错误码[1007910006](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/errorcode-remote-communication#section1007910006-请求大小达到上限)。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| promise | Promise | 否 | 否 | URPC请求的响应对象。 |
