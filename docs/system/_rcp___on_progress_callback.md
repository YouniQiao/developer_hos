...
| 名称 | 描述 |
| --- | --- |
| [Rcp_OnProgressCallbackFunc](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/remote-communication-overview#rcp_onprogresscallbackfunc) [callback](#callback) | 收发过程中的回调函数。 |
