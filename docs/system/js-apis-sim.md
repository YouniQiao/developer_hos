...
synced_at: "2026-06-24T20:51:05.023981"
---
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback | 是 | 回调函数。 - 0：卡槽1。 - 1：卡槽2。 - -1：未设置或服务不可用。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | 以Promise形式返回默认语音业务的卡槽ID。 - 0：卡槽1。 - 1：卡槽2。 - -1：未设置或服务不可用。 |
...
| --- | --- | --- | --- |
| slotId | number | 是 | 卡槽ID。 - 0：卡槽1。 - 1：卡槽2。 |
| callback | AsyncCallback | 是 | 回调函数。 返回检查应用（调用者）是否已被授予运营商权限。 - true：授权。 - false：未授权（未插入SIM卡或停用）。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | 以Promise形式返回检查应用(调用者)是否已被授予运营商权限。 - true：授权。 - false：未授权（未插入SIM卡或停用）。 |
...
| --- | --- | --- | --- |
| slotId | number | 是 | 卡槽ID。 - 0：卡槽1。 - 1：卡槽2。 |
| callback | AsyncCallback | 是 | 回调函数。返回指定卡槽SIM卡的归属PLMN号。 |
...
| --- | --- | --- | --- |
| slotId | number | 是 | 卡槽ID。 - 0：卡槽1。 - 1：卡槽2。 |
| callback | AsyncCallback | 是 | 回调函数。返回指定卡槽SIM卡的SPN。 |
...
| --- | --- | --- | --- |
| slotId | number | 是 | 卡槽ID。 - 0：卡槽1。 - 1：卡槽2。 |
| callback | AsyncCallback | 是 | 回调函数。参考[SimState](#simstate)。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | 以Promise形式返回获取指定卡槽的SIM卡状态。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | 以Promise形式返回指定卡槽SIM卡的卡类型。 |
...
![](./img/note_3.0-zh-cn.png) 获取ICCID和号码信息时需要GET_TELEPHONY_STATE权限，ICCID和号码信息为敏感数据，不向三方应用开放。调用接口时，获取到的ICCID和号码信息为空。
...
| --- | --- | --- | --- |
| slotId | number | 是 | 卡槽ID。 - 0：卡槽1。 - 1：卡槽2。 |
| callback | AsyncCallback | 是 | 回调函数。返回指定卡槽SIM卡的账户信息。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | 以Promise形式返回指定卡槽SIM卡的账户信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback> | 是 | 回调函数。返回激活SIM卡账户信息列表。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise> | 以Promise形式返回激活卡槽SIM卡的账户信息列表。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | 以Promise形式返回指定卡槽中SIM卡的OpName。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback | 是 | 回调函数。 与SIM卡绑定，从1开始递增。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | 以Promise形式返回默认语音业务的SIM卡ID。 与SIM卡绑定，从1开始递增。 |
...
| --- | --- | --- | --- |
| slotId | number | 是 | 卡槽ID。 - 0：卡槽1。 - 1：卡槽2。 |
| callback | AsyncCallback | 是 | 回调函数。获取SIM卡标签信息。 |
