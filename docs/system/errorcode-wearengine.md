...
使用的华为账号注册地非中国境内（香港特别行政区、澳门特别行政区、中国台湾除外）。
...
调用[getConnectedDevices](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/wearengine_api#getconnecteddevices)接口重新获取设备ID。
