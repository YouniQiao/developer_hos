...
synced_at: "2026-06-24T20:49:05.807299"
---
...
| menuoptions5+ | Array | - | 否 | 设置文本选择弹框点击更多按钮之后显示的菜单项。 |
...
| 名称 | 类型 | 默认值 | 必填 | 描述 |
| --- | --- | --- | --- | --- |
| color | | #e6000000 | 否 | 单行输入框或者按钮的文本颜色。 |
| font-size | | 16px | 否 | 单行输入框或者按钮的文本尺寸。 |
...
| placeholder-color | | #99000000 | 否 | 单行输入框的提示文本的颜色，type为text | email | date | time | number | password时生效。 |
...
```
 ![](./img/zh-cn_image_0000002656350303.png)
2. type为button 
```
<!-- xxx.hml -->
...
```
 ![](./img/zh-cn_image_0000002626230890.png)
3. type为checkbox 
```
<!-- xxx.hml -->
<div class="content">
...
```
 ![](./img/zh-cn_image_0000002626070980.png)
4. type为radio 
```
<!-- xxx.hml -->
<div class="content">
...
```
 ![](./img/zh-cn_image_0000002656470257.png)
