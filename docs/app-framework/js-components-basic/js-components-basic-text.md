...
synced_at: "2026-06-24T20:49:07.968060"
---
...
| word-spacing7+ | | | string | normal | 否 | 设置文本之间的间距，string可选值为： normal：默认的字符间距。 |
...
| line-height | | 7+ | string7+ | 0px1-6 normal7+ | 否 | 设置文本的文本行高，设置为0px时，不限制文本行高，自适应字体大小。string可选值为： normal7+：默认的行高。 |
...
```
 ![](./img/zh-cn_image_0000002626070990.png)
