...
synced_at: "2026-06-24T20:48:55.715766"
---
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| fontColor | Array | 否 | 是 | 设置[SymbolGlyph](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-symbolglyph)颜色。 默认值：不同渲染策略下默认值不同。 |
...
```
 ![](./img/zh-cn_image_0000002626070922.png)
