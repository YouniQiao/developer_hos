...
| 名称 | 类型 | 必填 | 装饰器类型 | 说明 |
| --- | --- | --- | --- | --- |
| primary | Callback | 是 | [@BuilderParam](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-builderparam) | 主要区域回调函数。 |
| secondary | Callback | 是 | [@BuilderParam](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-builderparam) | 次要区域回调函数。 |
| extra | Callback | 否 | [@BuilderParam](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-builderparam) | 扩展区域回调函数，不传入的情况，没有对应区域。 |
...
![](./img/note_3.0-zh-cn.png) 1.在悬停状态下，设备存在避让区域，布局计算时需考虑该区域的影响。
