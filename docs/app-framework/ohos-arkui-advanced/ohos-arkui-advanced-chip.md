...
synced_at: "2026-06-24T20:48:51.056761"
---
...
| suffixSymbolOptions14+ | [ChipSuffixSymbolGlyphOptions](#chipsuffixsymbolglyphoptions14) | 否 | 是 | symbol类型后缀图标属性的无障碍朗读功能属性。 默认值：不显示后缀图标。 值为undefined时，按默认值处理。 **元服务API：** 从API version 14开始，该接口支持在元服务中使用。 |
...
```
 ![](./img/zh-cn_image_0000002626070880.png)
...
```
 ![](./img/zh-cn_image_0000002656470157.png)
...
```
 ![](./img/zh-cn_image_0000002656350205.png)
...
```
 ![](./img/zh-cn_image_0000002626230792.gif)
...
```
 ![](./img/zh-cn_image_0000002626070882.gif)
...
```
 ![](./img/zh-cn_image_0000002656470159.png)
...
```
 ![](./img/zh-cn_image_0000002656350207.png)
