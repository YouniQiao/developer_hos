...
![](./img/note_3.0-zh-cn.png) 依赖全景多窗特性，只有当前设备及屏幕状态支持全景多窗，才支持设置此功能。目前支持全景多窗的设备形态有：
...
![](./img/note_3.0-zh-cn.png) width、height、size属性暂不支持百分比。
...
![](./img/note_3.0-zh-cn.png) 该组件暂不支持onClick事件，如要监听点击请使用onTouch事件。
