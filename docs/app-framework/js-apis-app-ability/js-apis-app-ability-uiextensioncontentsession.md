...
synced_at: "2026-06-24T20:46:48.001047"
---
...
| --- | --- | --- | --- |
| isPrivacyMode | boolean | 是 | 表示是否开启隐私模式。true表示开启；false表示关闭。 |
| callback | AsyncCallback | 是 | 回调函数。当设置成功，err为undefined，否则为错误对象。 |
...
| wantParam | Record | 是 | 表示启动UIExtensionAbility组件时传递的参数。 |
...
#### [h2]getUIExtensionWindowProxy12+
