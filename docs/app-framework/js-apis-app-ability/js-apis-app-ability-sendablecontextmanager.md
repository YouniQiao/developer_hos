...
synced_at: "2026-06-24T20:46:47.958346"
---
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| context | [common.Context](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-inner-application-context) | 是 | Context对象。其中，EventHub支持传递的序列化数据类型参见[序列化支持类型](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-taskpool#序列化支持类型)，数据大小不超过16MB。 |
