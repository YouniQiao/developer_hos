...
- Configuration对象中每个属性的“只读”列值为“否”，表示开发者可以在代码中对这些属性进行赋值操作，但这仅是修改Configuration对象实例的属性值，并不会改变应用的运行环境或系统设置。若需设置应用的语言、深浅色模式、字体大小等环境变量，应使用对应的API接口（如[setLanguage](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-inner-application-applicationcontext#applicationcontextsetlanguage11)、[setColorMode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-inner-application-applicationcontext#applicationcontextsetcolormode11)、[setFontSizeScale](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-inner-application-applicationcontext#applicationcontextsetfontsizescale13)等）。
