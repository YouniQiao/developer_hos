...
synced_at: "2026-06-24T20:46:47.371498"
---
...
| 类型 | 说明 |
| --- | --- |
| [insightIntent.ExecuteResult](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-app-ability-insightintent#executeresult) | Promise | 返回意图执行结果或返回带有意图执行结果的Promise对象，表示本次意图执行返回给系统入口的数据。 |
