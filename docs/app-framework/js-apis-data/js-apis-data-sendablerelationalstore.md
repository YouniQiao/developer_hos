...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| values | [collections.Array](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-arkts-collections-array) | 是 | 可跨线程传递的数组数据。 |
...
| 类型 | 说明 |
| --- | --- |
| [collections.Array](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-arkts-collections-array) | 可跨线程传递的数组数据。 |
...
| status | number | 否 | 是 | 资产的状态，取值与[relationalStore.AssetStatus](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-data-relationalstore-e#assetstatus10)枚举值保持一致，默认值为relationalStore.AssetStatus.ASSET_NORMAL。 |
...
| 类型 | 说明 |
| --- | --- |
| [collections.Array](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-arkts-collections-array) | 用于并发场景的Asset附件数据集合。 |
...
| string | 表示值类型为字符串。 |
| boolean | 表示值类型为布尔值。 |
| [collections.Uint8Array](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-arkts-collections-uint8array) | 表示值类型为Uint8类型的数组。 |
| [Asset](#asset) | 表示值类型为附件Asset。 当字段类型是Asset时，在创建表的sql语句中，类型应当为：ASSET。 |
| [Assets](#assets) | 表示值类型为附件数据集合Assets。 当字段类型是Assets时，在创建表的sql语句中，类型应当为：ASSETS。 |
| [collections.Float32Array](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-arkts-collections-float32array) | 表示值类型为浮点数组。 当字段类型是collections.Float32Array时，在创建表的sql语句中，类型应当为：floatvector(128)。 |
...
| 类型 | 说明 |
| --- | --- |
| [collections.Map](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-arkts-collections-map) | 并发场景的键值对数据存储，其中，键的类型为string，值的类型为ValueType。 |
...
| 类型 | 说明 |
| --- | --- |
| [relationalStore.ValuesBucket](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-data-relationalstore-t#valuesbucket) | 非并发场景的键值对数据存储。 |
...
| 类型 | 说明 |
| --- | --- |
| Array | 非并发场景的数组数据存储，值的类型为ValueType。 |
...
| 类型 | 说明 |
| --- | --- |
| [relationalStore.Asset](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-data-relationalstore-i#asset10) | 非并发场景的资产附件数据存储。 |
