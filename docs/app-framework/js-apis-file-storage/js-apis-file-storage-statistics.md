...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象，返回指定卷上的应用存储空间大小（单位为Byte）。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback | 是 | 获取指定卷上的应用存储空间大小之后的回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback | 是 | 获取内置存储的总空间大小之后的回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback | 是 | 获取内置存储的可用空间大小之后的回调。 |
