...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [ArkUI_ExpectedFrameRateRange](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-expectedframeraterange) | ArkUI_ExpectedFrameRateRange | 设置动画的期望帧率。 |
...
| [ArkUI_KeyframeAnimateOption](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-keyframeanimateoption) | ArkUI_KeyframeAnimateOption | 定义关键帧动画参数对象。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI_AnimateOption](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-animateoption)* option | 设置动画效果相关参数。 option为NULL时，操作无效。 |
...
| 参数项 | 描述 |
| --- | --- |
| [ArkUI_AnimateOption](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-animateoption)* option | 设置动画效果相关参数。 option为NULL时，返回NULL。 |
...
![](./img/note_3.0-zh-cn.png) keyframeSize大于0时，动画插值起点默认是0，动画插值终点模式值是1。不支持设置。
