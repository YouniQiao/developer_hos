...
synced_at: "2026-06-24T20:49:25.930642"
---
...
| grid-[columns|rows]-gap | | 0 | 否 | 用于设置行与行的间距或者列与列的间距，也可以支持通过grid-gap设置相同的行列间距，仅当display为grid时生效。 |
...
```
 **2*4卡片** ![](./img/zh-cn_image_0000002656350537.png)
2. Flex Wrap样式 
```
<!-- xxx.hml -->
<div class="container">
...
```
 **4*4卡片** ![](./img/zh-cn_image_0000002626231124.png)
