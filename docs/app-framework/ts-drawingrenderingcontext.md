...
![](./img/note_3.0-zh-cn.png) 从API version 12开始支持。后续版本如有新增内容，则采用上角标单独标记该内容的起始版本。
...
| 类型 | 说明 |
| --- | --- |
| import('../api/@ohos.graphics.drawing').default.[Canvas](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-graphics-drawing-canvas) | 返回一个Canvas对象。 |
