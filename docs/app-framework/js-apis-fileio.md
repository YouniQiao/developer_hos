...
![](./img/note_3.0-zh-cn.png) 从API version 9开始废弃，请使用[fileIo.stat](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fileiostat)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 9开始废弃，请使用[fileIo.stat](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fileiostat-1)替代。
...
| --- | --- | --- | --- |
| path | string | 是 | 待获取文件的应用沙箱路径。 |
| callback | AsyncCallback | 是 | 异步获取文件的信息之后的回调。 |
...
![](./img/note_3.0-zh-cn.png) 从API version 9开始废弃，请使用[fileIo.statSync](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fileiostatsync)替代。
...
| --- | --- | --- | --- |
| path | string | 是 | 待打开文件目录的应用沙箱路径。 |
| callback | AsyncCallback | 是 | 异步打开文件目录之后的回调。 |
...
![](./img/note_3.0-zh-cn.png) 从API version 9开始废弃，请使用[fileIo.access](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fileioaccess)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 9开始废弃，请使用[fileIo.access](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fileioaccess-1)替代。
...
| path | string | 是 | 待访问文件的应用沙箱路径。 |
| mode | number | 否 | 访问文件时的选项，可给定如下选项，以按位或的方式使用多个选项，默认给定0。 确认当前进程是否具有对应权限： - 0：确认文件是否存在。 - 1：确认当前进程是否具有可执行权限。 - 2：确认当前进程是否具有写权限。 - 4：确认当前进程是否具有读权限。 |
| callback | AsyncCallback | 是 | 异步检查当前进程是否可访问某文件之后的回调。 |
...
![](./img/note_3.0-zh-cn.png) 从API version 9开始废弃，请使用[fileIo.accessSync](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fileioaccesssync)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 9开始废弃，请使用[fileIo.close](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fileioclose)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 9开始废弃，请使用[fileIo.close](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fileioclose-1)替代。
...
| --- | --- | --- | --- |
| fd | number | 是 | 待关闭文件的文件描述符。 |
| callback | AsyncCallback | 是 | 异步关闭文件之后的回调。 |
...
![](./img/note_3.0-zh-cn.png) 从API version 9开始废弃，请使用[fileIo.closeSync](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fileioclosesync)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 9开始废弃，请使用[fileIo.copyFile](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fileiocopyfile)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 9开始废弃，请使用[fileIo.copyFile](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fileiocopyfile-1)替代。
...
| dest | string|number | 是 | 目标文件路径或目标文件描述符。 |
| mode | number | 否 | mode提供覆盖文件的选项，当前仅支持0，且默认为0。 0：完全覆盖目标文件，未覆盖部分将被裁切掉。 |
| callback | AsyncCallback | 是 | 异步复制文件之后的回调。 |
...
![](./img/note_3.0-zh-cn.png) 从API version 9开始废弃，请使用[fileIo.copyFileSync](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fileiocopyfilesync)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 9开始废弃，请使用[fileIo.mkdir](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fileiomkdir)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 9开始废弃，请使用[fileIo.mkdir](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fileiomkdir-1)替代。
...
| path | string | 是 | 待创建目录的应用沙箱路径。 |
| mode | number | 否 | 创建目录的权限，可给定如下权限，以按位或的方式追加权限，默认给定0o775。 - 0o775：所有者具有读、写及可执行权限，其余用户具有读及可执行权限。 - 0o700：所有者具有读、写及可执行权限。 - 0o400：所有者具有读权限。 - 0o200：所有者具有写权限。 - 0o100：所有者具有可执行权限。 - 0o070：所有用户组具有读、写及可执行权限。 - 0o040：所有用户组具有读权限。 - 0o020：所有用户组具有写权限。 - 0o010：所有用户组具有可执行权限。 - 0o007：其余用户具有读、写及可执行权限。 - 0o004：其余用户具有读权限。 - 0o002：其余用户具有写权限。 - 0o001：其余用户具有可执行权限。 |
| callback | AsyncCallback | 是 | 异步创建目录操作完成之后的回调。 |
...
![](./img/note_3.0-zh-cn.png) 从API version 9开始废弃，请使用[fileIo.mkdirSync](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fileiomkdirsync)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 9开始废弃，请使用[fileIo.open](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fileioopen)替代。
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象。返回打开文件的文件描述符。 |
...
![](./img/note_3.0-zh-cn.png) 从API version 9开始废弃，请使用[fileIo.open](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fileioopen-1)替代。
...
| flags | number | 否 | 打开文件的选项，必须指定如下选项中的一个，默认以只读方式打开： - 0o0：只读打开。 - 0o1：只写打开。 - 0o2：读写打开。 同时，也可给定如下选项，以按位或的方式追加，默认不给定任何额外选项： - 0o100：若文件不存在，则创建文件。使用该选项时必须指定第三个参数 mode。 - 0o200：如果追加了0o100选项，且文件已经存在，则出错。 - 0o1000：如果文件存在且文件具有写权限，则将其长度裁剪为零。 - 0o2000：以追加方式打开，后续写将追加到文件末尾。 - 0o4000：如果path指向FIFO、块特殊文件或字符特殊文件，则本次打开及后续 IO 进行非阻塞操作。 - 0o200000：如果path不指向目录，则出错。 - 0o400000：如果path指向符号链接，则出错。 - 0o4010000：以同步IO的方式打开文件。 |
| mode | number | 否 | 若创建文件，则指定文件的权限，可给定如下权限，以按位或的方式追加权限，默认给定0o660。 - 0o660：所有者具有读、写权限，所有用户组具有读、写权限。 - 0o700：所有者具有读、写及可执行权限。 - 0o400：所有者具有读权限。 - 0o200：所有者具有写权限。 - 0o100：所有者具有可执行权限。 - 0o070：所有用户组具有读、写及可执行权限。 - 0o040：所有用户组具有读权限。 - 0o020：所有用户组具有写权限。 - 0o010：所有用户组具有可执行权限。 - 0o007：其余用户具有读、写及可执行权限。 - 0o004：其余用户具有读权限。 - 0o002：其余用户具有写权限。 - 0o001：其余用户具有可执行权限。 |
| callback | AsyncCallback | 是 | 异步打开文件之后的回调，返回打开文件的文件描述符。 |
...
![](./img/note_3.0-zh-cn.png) 从API version 9开始废弃，请使用[fileIo.openSync](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fileioopensync)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 9开始废弃，请使用[fileIo.read](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fileioread)替代。
...
| options | Object | 否 | 支持如下选项： - offset，number类型，表示将数据读取到缓冲区的位置，即相对于缓冲区首地址的偏移，单位为Byte。可选，默认为0。 - length，number类型，表示期望读取数据的长度。可选，默认缓冲区长度减去偏移长度，单位为Byte。 - position，number类型，表示期望读取文件的位置。可选，默认从当前位置开始读，单位为Byte。 约束：offset+length返回值：

| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象。返回读取的结果。 |
...
![](./img/note_3.0-zh-cn.png) 从API version 9开始废弃，请使用[fileIo.read](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fileioread-1)替代。
...
| fd | number | 是 | 待读取文件的文件描述符。 |
| buffer | ArrayBuffer | 是 | 用于保存读取到的文件数据的缓冲区。 |
| options | Object | 否 | 支持如下选项： - offset，number类型，表示将数据读取到缓冲区的位置，单位为Byte，即相对于缓冲区首地址的偏移。可选，默认为0。 - length，number类型，表示期望读取数据的长度，单位为Byte。可选，默认缓冲区长度减去偏移长度。 - position，number类型，表示期望读取文件的位置，单位为Byte。可选，默认从当前位置开始读。 约束：offset+length | 是 | 异步读取数据之后的回调。 |
...
![](./img/note_3.0-zh-cn.png) 从API version 9开始废弃，请使用[fileIo.readSync](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fileioreadsync)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 9开始废弃，请使用[fileIo.rmdir](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fileiormdir)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 9开始废弃，请使用[fileIo.rmdir](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fileiormdir-1)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 9开始废弃，请使用[fileIo.rmdirSync](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fileiormdirsync)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 9开始废弃，请使用[fileIo.unlink](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fileiounlink)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 9开始废弃，请使用[fileIo.unlink](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fileiounlink-1)替代。
...
| --- | --- | --- | --- |
| path | string | 是 | 待删除文件的应用沙箱路径。 |
| callback | AsyncCallback | 是 | 异步删除文件之后的回调。 |
...
![](./img/note_3.0-zh-cn.png) 从API version 9开始废弃，请使用[fileIo.unlinkSync](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fileiounlinksync)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 9开始废弃，请使用[fileIo.write](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fileiowrite)替代。
...
| options | Object | 否 | 支持如下选项： - offset，number类型，表示期望写入数据的位置相对于数据首地址的偏移，单位为Byte。可选，默认为0。 - length，number类型，表示期望写入数据的长度，单位为Byte。可选，默认缓冲区长度减去偏移长度。 - position，number类型，表示期望写入文件的位置，单位为Byte。可选，默认从当前位置开始写。 - encoding，string类型，当数据是string类型时有效，表示数据的编码方式，默认 'utf-8'。仅支持 'utf-8'。 约束：offset+length返回值：

| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象。返回实际写入的长度，单位为Byte。 |
...
![](./img/note_3.0-zh-cn.png) 从API version 9开始废弃，请使用[fileIo.write](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fileiowrite-1)替代。
...
| fd | number | 是 | 待写入文件的文件描述符。 |
| buffer | ArrayBuffer|string | 是 | 待写入文件的数据，可来自缓冲区或字符串。 |
| options | Object | 否 | 支持如下选项： - offset，number类型，表示期望写入数据的位置相对于数据首地址的偏移，单位为Byte。可选，默认为0。 - length，number类型，表示期望写入数据的长度，单位为Byte。可选，默认缓冲区长度减去偏移长度。 - position，number类型，表示期望写入文件的位置，单位为Byte。可选，默认从当前位置开始写。 - encoding，string类型，当数据是string类型时有效，表示数据的编码方式，默认 'utf-8'。仅支持 'utf-8'。 约束：offset+length | 是 | 异步将数据写入完成后执行的回调函数。返回实际写入的长度，单位为Byte。 |
...
![](./img/note_3.0-zh-cn.png) 从API version 9开始废弃，请使用[fileIo.writeSync](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fileiowritesync)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 9开始废弃，请使用[hash.hash](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-hash#hashhash)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 9开始废弃，请使用[hash.hash](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-hash#hashhash-1)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 9开始废弃。
...
| path | string | 是 | 所需变更权限的文件的应用沙箱路径。 |
| mode | number | 是 | 改变文件权限，可给定如下权限，以按位或的方式追加权限。 - 0o700：所有者具有读、写及可执行权限。 - 0o400：所有者具有读权限。 - 0o200：所有者具有写权限。 - 0o100：所有者具有可执行权限。 - 0o070：所有用户组具有读、写及可执行权限。 - 0o040：所有用户组具有读权限。 - 0o020：所有用户组具有写权限。 - 0o010：所有用户组具有可执行权限。 - 0o007：其余用户具有读、写及可执行权限。 - 0o004：其余用户具有读权限。 - 0o002：其余用户具有写权限。 - 0o001：其余用户具有可执行权限。 |
| callback | AsyncCallback | 是 | 异步改变文件权限之后的回调。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象。返回表示文件状态的具体信息。 |
...
| --- | --- | --- | --- |
| fd | number | 是 | 待获取文件状态的文件描述符。 |
| callback | AsyncCallback | 是 | 异步获取文件状态信息之后的回调。 |
...
![](./img/note_3.0-zh-cn.png) 从API version 9开始废弃，请使用[fileIo.truncate](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fileiotruncate)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 9开始废弃，请使用[fileIo.truncate](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fileiotruncate-1)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 9开始废弃，请使用[fileIo.truncateSync](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fileiotruncatesync)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 9开始废弃，请使用[fileIo.readText](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fileioreadtext)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 9开始废弃，请使用[fileIo.readText](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fileioreadtext-1)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 9开始废弃，请使用[fileIo.readTextSync](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fileioreadtextsync)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 9开始废弃，请使用[fileIo.lstat](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fileiolstat)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 9开始废弃，请使用[fileIo.lstat](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fileiolstat-1)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 9开始废弃，请使用[fileIo.lstatSync](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fileiolstatsync)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 9开始废弃，请使用[fileIo.rename](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fileiorename)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 9开始废弃，请使用[fileIo.rename](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fileiorename-1)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 9开始废弃，请使用[fileIo.renameSync](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fileiorenamesync)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 9开始废弃，请使用[fileIo.fsync](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fileiofsync)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 9开始废弃，请使用[fileIo.fsync](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fileiofsync-1)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 9开始废弃，请使用[fileIo.fsyncSync](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fileiofsyncsync)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 9开始废弃，请使用[fileIo.fdatasync](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fileiofdatasync)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 9开始废弃，请使用[fileIo.fdatasync](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fileiofdatasync-1)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 9开始废弃，请使用[fileIo.fdatasyncSync](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fileiofdatasyncsync)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 9开始废弃，请使用[fileIo.symlink](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fileiosymlink)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 9开始废弃，请使用[fileIo.symlink](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fileiosymlink-1)替代。
...
| target | string | 是 | 目标文件的应用沙箱路径。 |
| srcPath | string | 是 | 符号链接文件的应用沙箱路径。 |
| callback | AsyncCallback | 是 | 异步创建符号链接信息之后的回调。 |
...
![](./img/note_3.0-zh-cn.png) 从API version 9开始废弃，请使用[fileIo.symlinkSync](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fileiosymlinksync)替代。
...
| uid | number | 是 | 新的UID。 |
| gid | number | 是 | 新的GID。 |
| callback | AsyncCallback | 是 | 异步改变文件所有者之后的回调。 |
...
![](./img/note_3.0-zh-cn.png) 从API version 9开始废弃，请使用[fileIo.mkdtemp](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fileiomkdtemp)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 9开始废弃，请使用[fileIo.mkdtemp](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fileiomkdtemp-1)替代。
...
| --- | --- | --- | --- |
| prefix | string | 是 | 用随机产生的字符串替换以“XXXXXX”结尾目录路径。 |
| callback | AsyncCallback | 是 | 异步创建临时目录之后的回调。 |
...
![](./img/note_3.0-zh-cn.png) 从API version 9开始废弃，请使用[fileIo.mkdtempSync](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fileiomkdtempsync)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 9开始废弃，请使用[fileIo.createStream](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fileiocreatestream)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 9开始废弃，请使用[fileIo.createStream](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fileiocreatestream-1)替代。
...
| path | string | 是 | 待打开文件的应用沙箱路径。 |
| mode | string | 是 | - r：打开只读文件，该文件必须存在。 - r+：打开可读写的文件，该文件必须存在。 - w：打开只写文件，若文件存在则文件长度清0，即该文件内容会消失。若文件不存在则建立该文件。 - w+：打开可读写文件，若文件存在则文件长度清0，即该文件内容会消失。若文件不存在则建立该文件。 - a：以附加的方式打开只写文件。若文件不存在，则会建立该文件，如果文件存在，写入的数据会被加到文件尾，即文件原先的内容会被保留。 - a+：以附加方式打开可读写的文件。若文件不存在，则会建立该文件，如果文件存在，写入的数据会被加到文件尾后，即文件原先的内容会被保留。 |
| callback | AsyncCallback | 是 | 异步打开文件流之后的回调。 |
...
![](./img/note_3.0-zh-cn.png) 从API version 9开始废弃，请使用[fileIo.createStreamSync](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fileiocreatestreamsync)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 9开始废弃，请使用[fileIo.fdopenStream](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fileiofdopenstream)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 9开始废弃，请使用[fileIo.fdopenStream](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fileiofdopenstream-1)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 9开始废弃，请使用[fileIo.fdopenStreamSync](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fileiofdopenstreamsync)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 10开始废弃。
...
![](./img/note_3.0-zh-cn.png) 从API version 9开始废弃，请使用[fileIo.Stat](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#stat)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 9开始废弃，请使用[fileIo.Stat.isBlockDevice](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#isblockdevice)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 9开始废弃，请使用[fileIo.Stat.isCharacterDevice](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#ischaracterdevice)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 9开始废弃，请使用[fileIo.Stat.isDirectory](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#isdirectory)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 9开始废弃，请使用[fileIo.Stat.isFIFO](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#isfifo)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 9开始废弃，请使用[fileIo.Stat.isFile](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#isfile)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 9开始废弃，请使用[fileIo.Stat.isSocket](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#issocket)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 9开始废弃，请使用[fileIo.Stat.isSymbolicLink](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#issymboliclink)替代。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback | 是 | 以异步方法关闭watcher监听之后的回调。 |
...
![](./img/note_3.0-zh-cn.png) 从API version 9开始废弃，请使用[fileIo.Stream](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#stream)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 9开始废弃，请使用[fileIo.Stream.close](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#close)替代。
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象。返回表示异步关闭文件流的结果。 |
...
![](./img/note_3.0-zh-cn.png) 从API version 9开始废弃，请使用[fileIo.Stream.close](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#close-1)替代。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback | 是 | 异步关闭文件流之后的回调。 |
...
![](./img/note_3.0-zh-cn.png) 从API version 9开始废弃，请使用[fileIo.Stream.closeSync](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#closesync)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 9开始废弃，请使用[fileIo.Stream.flush](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#flush)替代。
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象。返回表示异步刷新文件流的结果。 |
...
![](./img/note_3.0-zh-cn.png) 从API version 9开始废弃，请使用[fileIo.Stream.flush](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#flush-1)替代。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback | 是 | 异步刷新文件流后的回调函数。 |
...
![](./img/note_3.0-zh-cn.png) 从API version 9开始废弃，请使用[fileIo.Stream.flushSync](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#flushsync)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 9开始废弃，请使用[fileIo.Stream.write](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#write)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 9开始废弃，请使用[fileIo.Stream.write](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#write-1)替代。
...
| --- | --- | --- | --- |
| buffer | ArrayBuffer|string | 是 | 待写入文件的数据，可来自缓冲区或字符串。 |
| options | Object | 否 | 支持如下选项： - offset，number类型，表示期望写入数据的位置相对于数据首地址的偏移，单位为Byte。可选，默认为0。 - length，number类型，表示期望写入数据的长度，单位为Byte。可选，默认缓冲区长度减去偏移长度。 - position，number类型，表示期望写入文件的位置，单位为Byte。可选，默认从当前位置开始写。 - encoding，string类型，当数据是string类型时有效，表示数据的编码方式，默认 'utf-8'。仅支持 'utf-8'。 约束：offset+length | 是 | 异步写入完成后执行的回调函数，返回实际写入的长度，单位为Byte。 |
...
![](./img/note_3.0-zh-cn.png) 从API version 9开始废弃，请使用[fileIo.Stream.writeSync](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#writesync)替代。
...
| --- | --- | --- | --- |
| buffer | ArrayBuffer|string | 是 | 待写入文件的数据，可来自缓冲区或字符串。 |
| options | Object | 否 | 支持如下选项： - offset，number类型，表示期望写入数据的位置相对于数据首地址的偏移，单位为Byte。可选，默认为0。 - length，number类型，表示期望写入数据的长度。可选，默认缓冲区长度减去偏移长度。 - position，number类型，表示期望写入文件的位置，单位为Byte。可选，默认从当前位置开始写。 - encoding，string类型，当数据是string类型时有效，表示数据的编码方式，默认 'utf-8'。仅支持 'utf-8'。 约束：offset+length返回值：
...
![](./img/note_3.0-zh-cn.png) 从API version 9开始废弃，请使用[fileIo.Stream.read](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#read)替代。
...
![](./img/note_3.0-zh-cn.png) 从API version 9开始废弃，请使用[fileIo.Stream.read](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#read-1)替代。
...
| --- | --- | --- | --- |
| buffer | ArrayBuffer | 是 | 用于读取文件的缓冲区。 |
| options | Object | 否 | 支持如下选项： - offset，number类型，表示将数据读取到缓冲区的位置，即相对于缓冲区首地址的偏移，单位为Byte。可选，默认为0。 - length，number类型，表示期望读取数据的长度，单位为Byte。可选，默认缓冲区长度减去偏移长度。 - position，number类型，表示期望读取文件的位置，单位为Byte。可选，默认从当前位置开始读。 约束：offset+length | 是 | 异步从流文件读取数据之后的回调。 |
...
![](./img/note_3.0-zh-cn.png) 从API version 9开始废弃，请使用[fileIo.Stream.readSync](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#readsync)替代。
...
| --- | --- | --- | --- |
| buffer | ArrayBuffer | 是 | 用于读取文件的缓冲区。 |
| options | Object | 否 | 支持如下选项： - offset，number类型，表示将数据读取到缓冲区的位置，即相对于缓冲区首地址的偏移，单位为Byte。可选，默认为0。 - length，number类型，表示期望读取数据的长度。可选，默认缓冲区长度减去偏移长度，单位为Byte。 - position，number类型，表示期望读取文件的位置，单位为Byte。可选，默认从当前位置开始读。 约束：offset+length返回值：
...
| 类型 | 说明 |
| --- | --- |
| Promise | Promise对象。返回表示异步读取目录项的结果。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback | 是 | 异步读取下一个目录项之后的回调。 |
