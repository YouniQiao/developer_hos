...
synced_at: "2026-06-24T20:48:23.186433"
---
...
| 提升前 | 提升后 |
| --- | --- |
| 系统会把8位的十六进制颜色当#ARGB格式解析并显示。 例如fill="#ff000030"的矩形显示效果。 ![](./img/zh-cn_image_0000002656469907.png) | 系统会把8位的十六进制颜色当#RGBA格式解析并显示。 例如fill="#ff000030"的矩形显示效果。 ![](./img/zh-cn_image_0000002656349955.png) |
...
| 提升前 | 提升后 |
| --- | --- |
| 系统会把7位的十六进制颜色当#ARGB格式解析并显示。 例如fill="#BB88990"的矩形显示效果。 ![](./img/zh-cn_image_0000002626230542.png) | 系统会把7位十六进制颜色解析成默认黑色并显示。 例如fill="#BB88990"的矩形显示效果。 ![](./img/zh-cn_image_0000002626070632.png) |
...
| 提升前 | 提升后 |
| --- | --- |
| 系统会把4位的十六进制颜色当#ARGB格式解析并显示。 例如fill="#8888"的矩形显示效果。 ![](./img/zh-cn_image_0000002656469909.png) | 系统会把4位的十六进制颜色当#RGBA解析并显示。 例如fill="#0000"的矩形显示效果（全透明）。 ![](./img/zh-cn_image_0000002656349957.png) |
...
| 原始图源 | 提升前 | 提升后 |
| --- | --- | --- |
| ![](./img/zh-cn_image_0000002626230544.png) | Image组件的colorFilter属性只对图源的stroke边框起作用。 ![](./img/zh-cn_image_0000002626070634.png) | Image组件的colorFilter属性对整个SVG图源起作用。 ![](./img/zh-cn_image_0000002656469911.png) |
...
| 提升前 | 提升后 |
| --- | --- |
| Image组件的fillColor属性只对SVG图源中fill='none'的元素仍然填充颜色。 ![](./img/zh-cn_image_0000002656349959.png) | Image组件的fillColor属性对SVG图源中fill='none'的元素不填充颜色。 ![](./img/zh-cn_image_0000002626230546.png) |
...
| transform属性设置rotate旋转功能，同时配置transform-origin属性。 全局中心点值为图形元素右下角，如:'transform="rotate(30)" transform-origin="150 150"'。 | ![](./img/zh-cn_image_0000002626070636.png) | ![](./img/zh-cn_image_0000002656469913.png) |
| transform属性设置scale缩放功能，同时配置transform-origin属性。 全局中心点值为图形元素右下角，如:'transform="scale(0.77)" transform-origin="150 150"'。 | ![](./img/zh-cn_image_0000002656349961.png) | ![](./img/zh-cn_image_0000002626230548.png) |
| transform属性设置skewX按x轴倾斜的功能，同时配置transform-origin属性。 全局中心点值为图形元素右下角，如:'transform="skewX(30)" transform-origin="150 150"'。 | ![](./img/zh-cn_image_0000002626070638.png) | ![](./img/zh-cn_image_0000002656469915.png) |
| transform属性设置skewY按y轴倾斜的功能，同时配置transform-origin属性。 全局中心点值为图形元素右下角，如:'transform="skewY(30)" transform-origin="150 150"'。 | ![](./img/zh-cn_image_0000002656349963.png) | ![](./img/zh-cn_image_0000002626230550.png) |
| transform属性设置translate平移功能，同时配置transform-origin属性。 全局中心点值为图形元素右下角，如:'transform="translate(30,30)" transform-origin="150 150"'。 | ![](./img/zh-cn_image_0000002626070640.png) | ![](./img/zh-cn_image_0000002656469917.png) |
| transform属性链式调用多个功能，同时配置transform-origin属性。 全局中心点值为图形元素右下角，如:transform='"translate(10,10) rotate(10) scale(0.5) skewX(10)" transform-origin="150 150"'。 | ![](./img/zh-cn_image_0000002656349965.png) | ![](./img/zh-cn_image_0000002626230552.png) |
...
| SVG场景 | 扩展前 | 扩展后 |
| --- | --- | --- |
| SVG基本图形同时配置两个属性： 局部中心点和transform-origin，如'transform="rotate(30, -10, -10)" transform-origin="150 150"'。 | 按照局部中心点：rotate功能的最后2个参数指定的坐标偏移(x,y)作为变换中心点进行旋转。 ![](./img/zh-cn_image_0000002626070642.png) | 按照全局中心点transform-origin属性指定的坐标偏移(x,y)加局部中心点坐标偏移的和作为变换中心点进行旋转。 ![](./img/zh-cn_image_0000002656469919.png) |
...
| SVG场景 | 扩展前 | 扩展后 |
| --- | --- | --- |
| transform属性设置matrix矩阵变换，同时配置transform-origin属性。 全局中心点值为图形元素右下角，如:'transform="matrix(0.812,0.278,0.139,0.763,5.000,5.000" transform-origin="150 150"')。 | ![](./img/zh-cn_image_0000002656349967.png) | ![](./img/zh-cn_image_0000002626230554.png) |
...
| SVG场景 | 扩展前 | 扩展后 |
| --- | --- | --- |
| 当变形功能参数为非法值，如rotate旋转功能的角度参数为非法值：'transform="rotate(30deg)"'。 | 按照第一个参数可解析出的数值(30)作为旋转角度进行旋转。 ![](./img/zh-cn_image_0000002626070644.png) | 不做旋转。 ![](./img/zh-cn_image_0000002656469921.png) |
| 当变形功能参数为非法值，如rotate旋转功能的局部中心点参数为非法：'transform="rotate(30,abc,abc)"'。 | 按照SVG的ViewPort左上角坐标点(0,0)作为变换中心点，并根据旋转角度30度进行旋转。 ![](./img/zh-cn_image_0000002656349969.png) | 不做旋转。 ![](./img/zh-cn_image_0000002626230556.png) |
| 当变形功能参数数量为非法时，如scale功能的参数个数为非法：'transform="scale(0.5, 0.5, 0.5)"'。 | 取前2个合法参数作为x轴和y轴的缩放比例(0.5,0.5)缩放。 ![](./img/zh-cn_image_0000002626070646.png) | 不做变形。 ![](./img/zh-cn_image_0000002656469923.png) |
| 当链式调用多个变形功能，其中某个功能参数为非法，如'transform="rotate(30) skewX(abc) scale(0.5, 0.5)"'。 | 不处理非法的变形功能skewX，处理合法的变形功能rotate和scale。 ![](./img/zh-cn_image_0000002656349971.png) | 所有的变形功能均不处理。 ![](./img/zh-cn_image_0000002626230558.png) |
...
| 扩展前 | 扩展后 |
| --- | --- |
| ![](./img/zh-cn_image_0000002626070648.png) | ![](./img/zh-cn_image_0000002656469925.png) |
...
| 扩展前 | 扩展后 |
| --- | --- |
| ![](./img/zh-cn_image_0000002656349973.png) | ![](./img/zh-cn_image_0000002626230560.png) |
...
| 扩展前 | 扩展后 |
| --- | --- |
| ![](./img/zh-cn_image_0000002626070650.png) | ![](./img/zh-cn_image_0000002656469927.png) |
...
| 参数值 | 扩展前 | 扩展后 |
| --- | --- | --- |
| none | 按宽高比最小值进行统一缩放。 同时将SVG元素的viewBox属性的X的中点值与视图的X的中点值对齐， 将SVG元素的viewBox属性的Y的中点值与视图的Y的中点值对齐。 ![](./img/zh-cn_image_0000002656349975.png) | 缩放元素的图形内容，使元素的边界完全匹配视图矩形。 ![](./img/zh-cn_image_0000002626230562.png) |
...
| 参数值 | 扩展前 | 扩展后 |
| --- | --- | --- |
| xMinYMin meet | 按宽高比最小值进行统一缩放。 SVG元素的viewBox属性的X的中点值与视图的X的中点值对齐， SVG元素的viewBox属性的Y的中点值与视图的Y的中点值对齐。 ![](./img/zh-cn_image_0000002626070652.png) | 按宽高比最小值进行统一缩放。 SVG元素的viewBox属性的X的最小值与视图的X的最小值对齐， SVG元素的viewBox属性的Y的最小值与视图的Y的最小值对齐。 ![](./img/zh-cn_image_0000002656469929.png) |
| xMaxYMin meet | 按宽高比最小值进行统一缩放。 SVG元素的viewBox属性的X的中点值与视图的X的中点值对齐， SVG元素的viewBox属性的Y的中点值与视图的Y的中点值对齐。 ![](./img/zh-cn_image_0000002656349977.png) | 按宽高比最小值进行统一缩放。 SVG元素的viewBox属性的X的最小值+元素的宽度与视图的X的最大值对齐， SVG元素的viewBox属性的Y的最小值与视图的Y的最小值对齐。 ![](./img/zh-cn_image_0000002626230564.png) |
| xMinYMid meet | 按宽高比最小值进行统一缩放。 SVG元素的viewBox属性的X的中点值与视图的X的中点值对齐， SVG元素的viewBox属性的Y的中点值与视图的Y的中点值对齐。 ![](./img/zh-cn_image_0000002626070654.png) | 按宽高比最小值进行统一缩放。 SVG元素的viewBox属性的X的最小值与视图的X的最小值对齐， SVG元素的viewBox属性的Y的中点值与视图的Y的中点值对齐。 ![](./img/zh-cn_image_0000002656469931.png) |
| xMaxYMid meet | 按宽高比最小值进行统一缩放。 SVG元素的viewBox属性的X的中点值与视图的X的中点值对齐， SVG元素的viewBox属性的Y的中点值与视图的Y的中点值对齐。 ![](./img/zh-cn_image_0000002656349979.png) | 按宽高比最小值进行统一缩放。 SVG元素的viewBox属性的X的最小值+元素的宽度与视图的X的最大值对齐， SVG元素的viewBox属性的Y的中点值与视图的Y的中点值对齐。 ![](./img/zh-cn_image_0000002626230566.png) |
| xMinYMax meet | 按宽高比最小值进行统一缩放。 SVG元素的viewBox属性的X的中点值与视图的X的中点值对齐， SVG元素的viewBox属性的Y的中点值与视图的Y的中点值对齐。 ![](./img/zh-cn_image_0000002626070656.png) | 按宽高比最小值进行统一缩放。 SVG元素的viewBox属性的X的最小值与视图的X的最小值对齐， SVG元素的viewBox属性的Y的最小值+元素的高度与视图的Y的最大值对齐。 ![](./img/zh-cn_image_0000002656469933.png) |
| xMaxYMax meet | 按宽高比最小值进行统一缩放。 SVG元素的viewBox属性的X的中点值与视图的X的中点值对齐， SVG元素的viewBox属性的Y的中点值与视图的Y的中点值对齐。 ![](./img/zh-cn_image_0000002656349981.png) | 按宽高比最小值进行统一缩放。 SVG元素的viewBox属性的X的最小值+元素的宽度与视图的X的最大值对齐， SVG元素的viewBox属性的Y的最小值+元素的高度与视图的Y的最大值对齐。 ![](./img/zh-cn_image_0000002626230568.png) |
| xMinYMin slice | 按宽高比最小值进行统一缩放。 SVG元素的viewBox属性的X的中点值与视图的X的中点值对齐， SVG元素的viewBox属性的Y的中点值与视图的Y的中点值对齐。 ![](./img/zh-cn_image_0000002626070658.png) | 按宽高比最大值进行统一缩放。 SVG元素的viewBox属性的X的最小值与视图的X的最小值对齐， SVG元素的viewBox属性的Y的最小值与视图的Y的最小值对齐。 ![](./img/zh-cn_image_0000002656469935.png) |
| xMidYMin slice | 按宽高比最小值进行统一缩放。 SVG元素的viewBox属性的X的中点值与视图的X的中点值对齐， SVG元素的viewBox属性的Y的中点值与视图的Y的中点值对齐。 ![](./img/zh-cn_image_0000002656349983.png) | 按宽高比最大值进行统一缩放。 SVG元素的viewBox属性的X的中点值与视图的X的中点值对齐， SVG元素的viewBox属性的Y的最小值与视图的Y的最小值对齐。 ![](./img/zh-cn_image_0000002626230570.png) |
| xMaxYMin slice | 按宽高比最小值进行统一缩放。 SVG元素的viewBox属性的X的中点值与视图的X的中点值对齐， SVG元素的viewBox属性的Y的中点值与视图的Y的中点值对齐。 ![](./img/zh-cn_image_0000002626070660.png) | 按宽高比最大值进行统一缩放。 SVG元素的viewBox属性的X的最小值+元素的宽度与视图的X的最大值对齐， SVG元素的viewBox属性的Y的最小值与视图的Y的最小值对齐。 ![](./img/zh-cn_image_0000002656469937.png) |
| xMinYMid slice | 按宽高比最小值进行统一缩放。 SVG元素的viewBox属性的X的中点值与视图的X的中点值对齐， SVG元素的viewBox属性的Y的中点值与视图的Y的中点值对齐。 ![](./img/zh-cn_image_0000002656349985.png) | 按宽高比最大值进行统一缩放。 SVG元素的viewBox属性的X的最小值与视图的X的最小值对齐， SVG元素的viewBox属性的Y的中点值与视图的Y的中点值对齐。 ![](./img/zh-cn_image_0000002626230572.png) |
| xMidYMid slice | 按宽高比最小值进行统一缩放。 SVG元素的viewBox属性的X的中点值与视图的X的中点值对齐， SVG元素的viewBox属性的Y的中点值与视图的Y的中点值对齐。 ![](./img/zh-cn_image_0000002626070662.png) | 按宽高比最大值进行统一缩放。 SVG元素的viewBox属性的X的中点值与视图的X的中点值对齐， SVG元素的viewBox属性的Y的中点值与视图的Y的中点值对齐。 ![](./img/zh-cn_image_0000002656469939.png) |
| xMaxYMid slice | 按宽高比最小值进行统一缩放。 SVG元素的viewBox属性的X的中点值与视图的X的中点值对齐， SVG元素的viewBox属性的Y的中点值与视图的Y的中点值对齐。 ![](./img/zh-cn_image_0000002656349985.png) | 按宽高比最大值进行统一缩放。 SVG元素的viewBox属性的X的最小值+元素的宽度与视图的X的最大值对齐， SVG元素的viewBox属性的Y的中点值与视图的Y的中点值对齐。 ![](./img/zh-cn_image_0000002656349987.png) |
| xMinYMax slice | 按宽高比最小值进行统一缩放。 SVG元素的viewBox属性的X的中点值与视图的X的中点值对齐， SVG元素的viewBox属性的Y的中点值与视图的Y的中点值对齐。 ![](./img/zh-cn_image_0000002626230574.png) | 按宽高比最大值进行统一缩放。 SVG元素的viewBox属性的X的最小值与视图的X的最小值对齐， SVG元素的viewBox属性的Y的最小值+元素的高度与视图的Y的最大值对齐。 ![](./img/zh-cn_image_0000002626070664.png) |
| xMidYMax slice | 按宽高比最小值进行统一缩放。 SVG元素的viewBox属性的X的中点值与视图的X的中点值对齐， SVG元素的viewBox属性的Y的中点值与视图的Y的中点值对齐。 ![](./img/zh-cn_image_0000002656469941.png) | 按宽高比最大值进行统一缩放。 SVG元素的viewBox属性的X的中点值与视图的X的中点值对齐， SVG元素的viewBox属性的Y的最小值+元素的高度与视图的Y的最大值对齐。 ![](./img/zh-cn_image_0000002656349989.png) |
| xMaxYMax slice | 按宽高比最小值进行统一缩放。 SVG元素的viewBox属性的X的中点值与视图的X的中点值对齐， SVG元素的viewBox属性的Y的中点值与视图的Y的中点值对齐。 ![](./img/zh-cn_image_0000002626230576.png) | 按宽高比最大值进行统一缩放。 将SVG元素的viewBox属性的X的最小值+元素的宽度与视图的X的最大值对齐， SVG元素的viewBox属性的Y的最小值+元素的高度与视图的Y的最大值对齐。 ![](./img/zh-cn_image_0000002626070666.png) |
...
| 扩展前 | 扩展后 |
| --- | --- |
| ![](./img/zh-cn_image_0000002656469943.png) | ![](./img/zh-cn_image_0000002656349991.png) |
...
| 扩展前 | 扩展后 |
| --- | --- |
| ![](./img/zh-cn_image_0000002626230578.png) | ![](./img/zh-cn_image_0000002626070668.png) |
...
| 扩展前 | 扩展后 |
| --- | --- |
| ![](./img/zh-cn_image_0000002656469945.png) | ![](./img/zh-cn_image_0000002656349993.png) |
...
| 扩展前 | 扩展后 |
| --- | --- |
| ![](./img/zh-cn_image_0000002626230580.png) | ![](./img/zh-cn_image_0000002626070670.png) |
...
| 扩展前 | 扩展后 |
| --- | --- |
| ![](./img/zh-cn_image_0000002656469947.png) | ![](./img/zh-cn_image_0000002656349995.png) |
...
| 扩展前 | 扩展后 |
| --- | --- |
| ![](./img/zh-cn_image_0000002626230582.png) | ![](./img/zh-cn_image_0000002626070672.png) |
...
| 扩展前 | 扩展后 |
| --- | --- |
| ![](./img/zh-cn_image_0000002656469949.png) | ![](./img/zh-cn_image_0000002656349997.png) |
...
| 扩展前 | 扩展后 |
| --- | --- |
| ![](./img/zh-cn_image_0000002626230584.png) | ![](./img/zh-cn_image_0000002626070674.png) |
...
| 扩展前 | 扩展后 |
| --- | --- |
| 图案不支持重复平铺。 ![](./img/zh-cn_image_0000002656469951.png) | 图案支持重复平铺 ![](./img/zh-cn_image_0000002656349999.png) |
...
| 扩展前 | 扩展后 |
| --- | --- |
| ![](./img/zh-cn_image_0000002626230586.png) | ![](./img/zh-cn_image_0000002626070676.png) |
...
| 扩展前 | 扩展后 |
| --- | --- |
| ![](./img/zh-cn_image_0000002656469953.png) | ![](./img/zh-cn_image_0000002656350001.png) |
...
| 扩展前 | 扩展后 |
| --- | --- |
| ![](./img/zh-cn_image_0000002626230588.png) | ![](./img/zh-cn_image_0000002626070678.png) |
...
| 扩展前 | 扩展后 |
| --- | --- |
| ![](./img/zh-cn_image_0000002656469955.png) | ![](./img/zh-cn_image_0000002656350003.png) |
...
| 扩展前 | 扩展后 |
| --- | --- |
| ![](./img/zh-cn_image_0000002626230590.png) | ![](./img/zh-cn_image_0000002626070680.png) |
