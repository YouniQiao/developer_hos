...
| Assets10+ | 表示值类型为附件数组[Assets](#assets10)。 当字段类型是Assets时，在创建表的sql语句中，类型应当为：ASSETS。 |
...
| 类型 | 说明 |
| --- | --- |
| Map | 键是数据库表某一行的主键，值表示该行的最后修改时间，用UTC格式表示。 |
...
| 类型 | 说明 |
| --- | --- |
| Array | 表示[ValueType](#valuetype)类型的数组。 |
...
| 类型 | 说明 |
| --- | --- |
| Array | 表示[RowData](#rowdata23)类型的数组。 |
