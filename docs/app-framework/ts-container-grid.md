...
synced_at: "2026-06-24T20:47:55.334428"
---
...
![](./img/zh-cn_image_0000002626230300.png)
...
```
 ![](./img/zh-cn_image_0000002626070390.gif)
...
```
 ![](./img/zh-cn_image_0000002656469667.gif)
...
```
 ![](./img/zh-cn_image_0000002656349715.gif)
...
```
 ![](./img/zh-cn_image_0000002626230302.gif)
...
![](./img/zh-cn_image_0000002626070392.png)

网格子组件拖拽过程中：

![](./img/zh-cn_image_0000002656469669.png)

网格子组件1与子组件6拖拽交换位置后：

![](./img/zh-cn_image_0000002656349717.png)

拖拽动画：

![](./img/zh-cn_image_0000002626230304.gif)
...
```
 ![](./img/zh-cn_image_0000002626070394.gif)
...
```
 ![](./img/zh-cn_image_0000002656469671.gif)
...
```
 ![](./img/zh-cn_image_0000002656349719.png)
...
```
 ![](./img/zh-cn_image_0000002626230306.png)
...
```
 ![](./img/zh-cn_image_0000002626070396.gif)
...
```
 ![](./img/zh-cn_image_0000002656469673.gif)
...
```
 ![](./img/zh-cn_image_0000002656349721.gif)
...
```
 ![](./img/zh-cn_image_0000002626230308.gif)
...
```
 ![](./img/zh-cn_image_0000002626070398.gif)
...
```
 ![](./img/zh-cn_image_0000002656469675.gif)
...
```
 ![](./img/zh-cn_image_0000002656349723.gif)
...
![](./img/zh-cn_image_0000002626230310.png)

Grid宽度属于md断点区间时显示3列。

![](./img/zh-cn_image_0000002626070400.png)

Grid宽度属于lg及更大的断点区间时显示5列。

![](./img/zh-cn_image_0000002656469677.png)
...
```
 ![](./img/zh-cn_image_0000002656349725.gif)
...
```
 ![](./img/zh-cn_image_0000002626230312.gif)
